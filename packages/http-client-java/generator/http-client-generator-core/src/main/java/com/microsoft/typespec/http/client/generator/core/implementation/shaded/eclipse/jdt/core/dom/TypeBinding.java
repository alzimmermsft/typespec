...
class TypeBinding implements ITypeBinding {
	...
	public TypeBinding(BindingResolver resolver, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding binding) {
		this.binding = binding;
		this.resolver = resolver;
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding compilerPrototype = binding.prototype();
	...
	private IAnnotationBinding[] resolveAnnotationBindings(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] internalAnnotations, boolean isTypeUse) {
		...
		if (this.binding.isCapture()) {
			...
			switch(declaring.kind()) {
				case org.eclipse.jdt.internal.compiler.lookup.Binding.METHOD :
					...
					break;
				default :
					org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding = (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding) declaring;
	...
	public synchronized IVariableBinding[] getDeclaredFields() {
		...
		try {
			 ...
			 */
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declared fields"); //$NON-NLS-1$
		}
		return this.fields = NO_VARIABLE_BINDINGS;
	}
	...
	public synchronized IMethodBinding[] getDeclaredMethods() {
		...
		try {
			 ...
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declared methods"); //$NON-NLS-1$
		}
		return this.methods = NO_METHOD_BINDINGS;
	}
	...
	public synchronized IMethodBinding getDeclaringMethod() {
		if (this.binding instanceof org.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding) {
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding localTypeBinding = (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding) this.binding;
			...
			if (methodBinding != null) {
				try {
					 ...
					 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
					 */
					com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declaring method"); //$NON-NLS-1$
				}
			}
		} else if (this.binding.isTypeVariable()) {
			TypeVariableBinding typeVariableBinding = (TypeVariableBinding) this.binding;
		...
		if (isClass() || isInterface() || isEnum()) {
			...
			if (referenceBinding.isNestedType()) {
				try {
					 ...
					 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
					 */
					com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declaring class"); //$NON-NLS-1$
				}
			}
		} else if (this.binding.isTypeVariable()) {
			TypeVariableBinding typeVariableBinding = (TypeVariableBinding) this.binding;
	...
	public synchronized ITypeBinding[] getInterfaces() {
		...
		try {
			 ...
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve interfaces"); //$NON-NLS-1$
		}
	...
	private JavaElement getUnresolvedJavaElement(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding ) {
	...
	public synchronized ITypeBinding getSuperclass() {
		...
		try {
			 ...
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve superclass"); //$NON-NLS-1$
	...
	public ITypeBinding[] getTypeArguments() {
		...
		if (this.binding.isParameterizedTypeWithActualArguments()) {
			ParameterizedTypeBinding parameterizedTypeBinding = (ParameterizedTypeBinding) this.binding;
			final com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding[] arguments = parameterizedTypeBinding.arguments;
	...
	public ITypeBinding[] getTypeBounds() {
		...
		if (this.binding instanceof TypeVariableBinding) {
			...
			if (typeVariableBinding == null) {
				com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding allBounds = wildcardBinding.allBounds();
		...
		if (typeVariableBinding != null) {
			...
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding firstClassOrArrayBound = typeVariableBinding.firstBound;
			int boundsLength = 0;
			if (firstClassOrArrayBound == null) {
				...
				if (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding.equalsEquals(firstClassOrArrayBound, varSuperclass)) {
					boundsLength++;
	...
	public boolean isCastCompatible(ITypeBinding type) {
		try {
			...
			if (scope == null) return false;
			if (!(type instanceof TypeBinding)) return false;
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding expressionType = ((TypeBinding) type).binding;
	...
	public boolean isEqualTo(IBinding other) {
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding otherBinding = ((TypeBinding) other).binding;
		if (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding.equalsEquals(otherBinding.unannotated(), this.binding.unannotated())) {
			return true;
		}
		// check return type
	...
	public boolean isFromSource() {
		if (isClass() || isInterface() || isEnum()) {
			...
			if (referenceBinding.isRawType()) {
				...
				com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding erasure = parameterizedTypeBinding.erasure();
			...
			if (declaringElement instanceof MethodBinding) {
				...
				final com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding = (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding) declaringElement;
				if (typeBinding instanceof ReferenceBinding) {
					...
					final com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding leafComponentType = arrayBinding.leafComponentType;
	...
	public boolean isNullType() {
		return this.binding == com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding.NULL;
	}
		...
		switch (this.binding.kind()) {
			...
			case Binding.TYPE_PARAMETER:
				if (this.binding instanceof CaptureBinding18) {
					...
					com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding upperBound = captureBinding18.upperBound();
