...
public interface NtDll extends StdCallLibrary {
     ...
     */
    public int ZwQueryKey(HANDLE KeyHandle, int KeyInformationClass, Structure KeyInformation, int Length,
     ...
     * Pointer to a caller-allocated variable that receives the number of bytes required to store the copied security
     * descriptor.
     * @return
     * NtQuerySecurityObject returns STATUS_SUCCESS or an appropriate error status.
     */
    public int NtQuerySecurityObject(HANDLE handle, int SecurityInformation, Pointer SecurityDescriptor, int Length,
        IntByReference LengthNeeded);
     ...
     * @return The function returns the corresponding system error code. ERROR_MR_MID_NOT_FOUND is returned when the
