...
public class EquinoxLogServices {
	static final String EQUINOX_LOGGER_NAME = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.equinox.logger"; //$NON-NLS-1$
	static final String PERF_LOGGER_NAME = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.performance.logger"; //$NON-NLS-1$
	...
	public EquinoxLogServices(EquinoxConfiguration environmentInfo) {
        ...
        LogServiceManager logServiceManager = new LogServiceManager(logHistoryMax, defaultLevel, environmentInfo,
            logWriter, perfWriter);
