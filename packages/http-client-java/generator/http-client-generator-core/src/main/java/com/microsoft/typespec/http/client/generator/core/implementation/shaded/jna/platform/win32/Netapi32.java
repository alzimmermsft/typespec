...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.DsGetDC.PDOMAIN_CONTROLLER_INFO;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Guid.GUID;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.NTSecApi.PLSA_FOREST_TRUST_INFORMATION;
...
public interface Netapi32 extends StdCallLibrary {
     ...
     */
    public int NetLocalGroupEnum(String serverName, int level, PointerByReference bufptr, int prefmaxlen,
        IntByReference entriesread, IntByReference totalentries, IntByReference resume_handle);
     ...
     * If the function succeeds, the return value is NERR_Success.
     */
    public int NetGroupEnum(String servername, int level, PointerByReference bufptr, int prefmaxlen,
        IntByReference entriesread, IntByReference totalentries, IntByReference resume_handle);
     ...
     * If the function succeeds, the return value is NERR_Success.
     */
    public int NetUserEnum(String servername, int level, int filter, PointerByReference bufptr, int prefmaxlen,
        IntByReference entriesread, IntByReference totalentries, IntByReference resume_handle);
     ...
     * If the function succeeds, the return value is NERR_Success.
     */
    public int NetUserGetGroups(String servername, String username, int level, PointerByReference bufptr,
     ...
     * If the function succeeds, the return value is NERR_Success.
     */
    public int NetUserGetLocalGroups(String servername, String username, int level, int flags,
        PointerByReference bufptr, int prefmaxlen, IntByReference entriesread, IntByReference totalentries);
     ...
     */
    public int DsGetDcName(String ComputerName, String DomainName, GUID DomainGuid, String SiteName, int Flags,
     ...
     */
    public int DsEnumerateDomainTrusts(String serverName, int Flags, PointerByReference Domains,
     ...
     * 2 Return detailed information and additional attributes about the user account. The bufptr parameter points to a
     * USER_INFO_2 structure.
     * 3 Return detailed information and additional attributes about the user account. This level is valid only on
     * servers. The bufptr parameter points to a USER_INFO_3 structure. Note that it is recommended that you use
     * USER_INFO_4 instead.
     * 4 Return detailed information and additional attributes about the user account. This level is valid only on
     * servers. The bufptr parameter points to a USER_INFO_4 structure. Windows 2000: This level is not supported.
     ...
     * 20 Return the user's name and identifier and various account attributes. The bufptr parameter points to a
     * USER_INFO_20 structure. Note that on Windows XP and later, it is recommended that you use USER_INFO_23 instead.
     * 23 Return the user's name and identifier and various account attributes. The bufptr parameter points to a
     * USER_INFO_23 structure. Windows 2000: This level is not supported.
     * @param bufptr
     ...
     *
     * @param servername [in]
     * Pointer to a string that specifies the DNS or NetBIOS name of the remote server on which the function is to
     * execute.
     * If this parameter is NULL, the local computer is used.
     * @param level [in]
     * Specifies the information level of the data. This parameter can be one of the following values:
     * 2 - Specifies information about the shared resource, including the name of the resource, type and permissions,
     * and number of connections.
     * The buf parameter points to a SHARE_INFO_2 structure.
     * 502 - Specifies information about the shared resource, including the name of the resource, type and permissions,
     * number of connections, and other pertinent information.
     * The buf parameter points to a SHARE_INFO_502 structure.
     * 503 - Specifies information about the shared resource, including the name of the resource, type and permissions,
     * number of connections, and other pertinent information.
     * The buf parameter points to a SHARE_INFO_503 structure.
     * @param buf [in]
     * Pointer to the buffer that specifies the data. The format of this data depends on the value of the
     * <code>level</code> parameter.
     * For more information, see Network Management Function Buffers
     * (https://msdn.microsoft.com/en-us/library/windows/desktop/aa370676(v=vs.85).aspx)
     * @param parm_err [out]
     * Pointer to a value that receives the index of the first member of the share information structure that causes the
     * ERROR_INVALID_PARAMETER error. If this parameter is NULL, the
     * index is not returned on error. For more information, see the NetShareSetInfo function.
     * @return If the function succeeds, the return value is NERR_Success. If the function fails, the return value can
     * be an error code as seen on MSDN.
     */
