...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.ToStringSorter.Pair;
...
public class LRUCache<K, V> implements Cloneable {
    ...
    protected String toStringContents() {
        ...
        ToStringSorter<K> sorter
            = new ToStringSorter<>(o -> o instanceof JavaElement ? ((JavaElement) o).getElementName() : o.toString());
