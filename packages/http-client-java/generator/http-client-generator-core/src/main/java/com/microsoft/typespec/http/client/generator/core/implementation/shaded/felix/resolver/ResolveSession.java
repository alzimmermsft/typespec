...
class ResolveSession implements Runnable {
    ...
    private final Map<Resource, Boolean> m_validRelatedResources = new HashMap<>(0);
    // keeps track of related resources for each resource
    private final Map<Resource, Collection<Resource>> m_relatedResources = new HashMap<>(0);
