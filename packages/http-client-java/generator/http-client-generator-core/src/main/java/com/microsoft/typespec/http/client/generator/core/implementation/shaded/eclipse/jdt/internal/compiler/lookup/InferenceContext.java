...
public class InferenceContext {
    ...
    boolean hasExplicitExpectedType; // indicates whether the expectedType (if set) was explicit in code, or set by
                                     // default
    ...
    public void recordSubstitute(TypeVariableBinding typeVariable, TypeBinding actualType, int constraint) {
        ...
        insertLoop: {
            ...
            if (constraintSubstitutes == null) {
                ...
                System.arraycopy(constraintSubstitutes, 0, constraintSubstitutes = new TypeBinding[length + 1], 0,
                    length);
            }
    ...
    public String toString() {
        ...
        buffer.append("\n\t[collected={");//$NON-NLS-1$
        for (int i = 0, length = this.collectedSubstitutes == null ? 0 : this.collectedSubstitutes.length; i < length;
            i++) {
