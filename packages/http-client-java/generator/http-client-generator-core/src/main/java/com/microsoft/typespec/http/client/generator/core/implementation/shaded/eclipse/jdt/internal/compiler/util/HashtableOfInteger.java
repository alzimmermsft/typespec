...
public final class HashtableOfInteger {
    ...
    public boolean containsKey(int key) {
        ...
        int length = this.keyTable.length, index = intKey.hashCode() % length;
        Integer currentKey;
    ...
    private void rehash() {
        ...
        HashtableOfInteger newHashtable = new HashtableOfInteger(this.elementSize * 2);		// double the number of
                                                                                       		// expected elements
        Integer currentKey;
        for (int i = this.keyTable.length; --i >= 0;)
