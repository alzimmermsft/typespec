...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.DefaultTypeMapper;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.EnumConverter;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinUser.HMONITOR;
 ...
 */
public interface Dxva2 extends StdCallLibrary, PhysicalMonitorEnumerationAPI, HighLevelMonitorConfigurationAPI,
     ...
     */
    BOOL GetMonitorCapabilities(HANDLE hMonitor, DWORDByReference pdwMonitorCapabilities,
     ...
     * 
     * @param hMonitor Handle to a physical monitor. To get the monitor handle, call GetPhysicalMonitorsFromHMONITOR
     * @param pdtyDisplayTechnologyType Receives the technology type as defined in {@link MC_DISPLAY_TECHNOLOGY_TYPE}.
     * @return If the function succeeds, the return value is TRUE. If the function fails, the return value is FALSE.
     */
     ...
     * 
     * @param hMonitor Handle to a physical monitor.
     * @param dtDriveType A member of the MC_DRIVE_TYPE enumeration, specifying whether to retrieve the red, green, or
     * blue drive value.
     ...
     * GetMonitorCapabilities function returns the MC_CAPS_RED_GREEN_BLUE_GAIN flag. This function takes about 40
     * milliseconds to return.
     * The gain settings are continuous monitor settings.</p>
     * 
     * @param hMonitor Handle to a physical monitor.
     * @param gtGainType A member of the MC_GAIN_TYPE enumeration, specifying whether to retrieve the red, green, or
     * blue gain value.
     ...
     * 
     * @param hMonitor Handle to a physical monitor.
     * @param dwNewBrightness Brightness value. To get the monitor's minimum and maximum brightness values, call
     ...
     * 
     * @param hMonitor Handle to a physical monitor.
     * @param dwNewContrast Contrast value. To get the monitor's minimum and maximum contrast values, call
     * GetMonitorContrast.
     * @return If the function succeeds, the return value is TRUE. If the function fails, the return value is FALSE
     */
     ...
     * 
     * @param hMonitor Handle to a physical monitor.
     * @param ctCurrentColorTemperature Color temperature, specified as a member of the MC_COLOR_TEMPERATURE
     * enumeration.
     * @return If the function succeeds, the return value is TRUE. If the function fails, the return value is FALSE
     */
     ...
     * This function takes about 40 milliseconds to return. The width and height settings are continuous monitor
     * settings. </p>
     * 
     * @param hMonitor Handle to a physical monitor. To get the monitor handle, call GetPhysicalMonitorsFromHMONITOR
     ...
     * <p>
     * If this function is supported, the GetMonitorCapabilities function returns the MC_CAPS_DISPLAY_AREA_POSITION
     * flag.
     * This function takes about 40 milliseconds to return. The horizontal and vertical position are continuous monitor
     * settings.</p>
     * 
     * @param hMonitor Handle to a physical monitor. To get the monitor handle, call GetPhysicalMonitorsFromHMONITOR
     * @param ptPositionType A member of the MC_POSITION_TYPE enumeration, specifying whether to retrieve the horizontal
     * position or the vertical position.
    ...
    BOOL GetMonitorDisplayAreaPosition(HANDLE hMonitor, MC_POSITION_TYPE ptPositionType,
        DWORDByReference pdwMinimumPosition, DWORDByReference pdwCurrentPosition, DWORDByReference pdwMaximumPosition);

    /**
     * Sets the width or height of a monitor's display area.
     * <p>
     * If this function is supported, the GetMonitorCapabilities function returns the MC_CAPS_DISPLAY_AREA_SIZE flag.
     * This function takes about 50 milliseconds to return. The width and height settings are continuous monitor
     * settings.</p>
     * 
     * @param hMonitor Handle to a physical monitor. To get the monitor handle, call GetPhysicalMonitorsFromHMONITOR
     * @param stSizeType A member of the MC_SIZE_TYPE enumeration, specifying whether to set the width or the height.
     * @param dwNewDisplayAreaWidthOrHeight Display area width or height. To get the minimum and maximum width and
     * height,
     ...
     * If this function is supported, the GetMonitorCapabilities function returns the MC_CAPS_DISPLAY_AREA_POSITION
     * flag.
     * This function takes about 50 milliseconds to return. The horizontal and vertical position are continuous monitor
     * settings. </p>
     * 
     * @param hMonitor Handle to a physical monitor. To get the monitor handle, call GetPhysicalMonitorsFromHMONITOR
     * @param ptPositionType A member of the MC_POSITION_TYPE enumeration, specifying whether to set the horizontal
     * position or the vertical position.
     * @param dwNewPosition Horizontal or vertical position. To get the minimum and maximum position, call
     ...
     * @param pvct Receives the VCP code type, as a member of the MC_VCP_CODE_TYPE enumeration. This parameter can be
     * NULL.
     ...
     * 
     * @param hMonitor Handle to a physical monitor. To get the monitor handle, call GetPhysicalMonitorsFromHMONITOR
     * @param pdwCapabilitiesStringLengthInCharacters Receives the length of the capabilities string, in characters,
