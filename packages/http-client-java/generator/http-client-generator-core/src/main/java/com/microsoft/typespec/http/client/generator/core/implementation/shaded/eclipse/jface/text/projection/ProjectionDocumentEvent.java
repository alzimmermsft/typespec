...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jface.text.SlaveDocumentEvent;

/**
 * This event is sent out by an
 * {@link ProjectionDocument}when it is
 ...
 * created by {@link ProjectionDocument}
...
public class ProjectionDocumentEvent extends SlaveDocumentEvent {
     ...
     */
    public ProjectionDocumentEvent(IDocument doc, int offset, int length, String text, int masterOffset,
        int masterLength) {
     ...
     */
    public ProjectionDocumentEvent(IDocument doc, int offset, int length, String text, int masterOffset,
        int masterLength, DocumentEvent masterEvent) {
        super(doc, offset, length, text, masterEvent);
        fChangeType = PROJECTION_CHANGE;
        fMasterOffset = masterOffset;
        fMasterLength = masterLength;
