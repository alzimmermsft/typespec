...
public class TypeParameter extends ASTNode {
    ...
    /**
     * The "modifiers" structural property of this node type (element type: {@link IExtendedModifier}) (added in JLS8
     * API).
     * 
     * @since 3.10
     */
     ...
     */
    private final NodeList typeBounds = new NodeList(TYPE_BOUNDS_PROPERTY);
    ...
    int treeSize() {
        return memSize() + (this.modifiers == null ? 0 : this.modifiers.listSize())
            + (this.typeVariableName == null ? 0 : getName().treeSize()) + this.typeBounds.listSize();
    }
}
