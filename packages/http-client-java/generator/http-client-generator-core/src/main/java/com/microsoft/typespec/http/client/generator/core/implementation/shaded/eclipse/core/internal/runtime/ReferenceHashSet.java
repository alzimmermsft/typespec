...
public class ReferenceHashSet<T> {
	...
	private static class HashableWeakReference<U> extends WeakReference<U> implements HashedReference<U> {
		public int hashCode;
	...
	private static class HashableSoftReference<U> extends SoftReference<U> implements HashedReference<U> {
		public int hashCode;
