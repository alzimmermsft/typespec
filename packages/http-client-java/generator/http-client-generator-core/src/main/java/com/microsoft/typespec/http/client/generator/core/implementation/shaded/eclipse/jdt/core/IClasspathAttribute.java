 ...
 * can be created using the factory method {@link JavaCore#newClasspathAttribute(String, String)
...
public interface IClasspathAttribute {
     ...
     *
     * <ul>
     * <li> Encoding explicitly set on the source file (java or zip), i.e.
     * <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.resources.IFile#getCharset(false)</code>
     * </li>
