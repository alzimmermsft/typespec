...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache.CacheBuilder;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache.CacheLoader;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache.LoadingCache;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.primitives.Primitives;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.reflect.TypeToken;
        ...
        for (Class<?> supertype : supertypes) {
            for (Method method : supertype.getDeclaredMethods()) {
                if (method.isAnnotationPresent(Subscribe.class) && !method.isSynthetic()) {
                    ...
                    checkArgument(!parameterTypes[0].isPrimitive(),
