...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.element.Modifier;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.element.PackageElement;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.element.TypeParameterElement;
...
public class Factory {
    ...
    public <A extends Annotation> A[] getAnnotationsByType(AnnotationBinding[] annoInstances,
    ...
    private <A extends Annotation> A[] getAnnotations(AnnotationBinding[] annoInstances, Class<A> annotationClass,
        ...
        for (AnnotationBinding annoInstance : annoInstances) {
            ...
            if (annoMirror != null) {
                list.add((A) Proxy.newProxyInstance(annotationClass.getClassLoader(), new Class[] { annotationClass },
                    annoMirror));
                if (justTheFirst)
                    break;
            }
    ...
    public static Set<Modifier> getModifiers(int modifiers, ElementKind kind, boolean isFromBinary) {
        ...
        switch (kind) {
            ...
            case METHOD:
                ...
                decodeModifiers(result, modifiers,
                    new int[] {
            ...
            case MODULE:
                decodeModifiers(result, modifiers,
                    new int[] { ClassFileConstants.ACC_OPEN, ClassFileConstants.ACC_TRANSITIVE });
                break;
     ...
     * will be converted into the expected type by the {@link Proxy}.
     ...
     */
    public static Object performNecessaryPrimitiveTypeConversion(final Class<?> expectedType, final Object value,
            ...
            for (int j = i + 1; j < length; j++) {
                ...
                if (otherAnnotation.getAnnotationType() == annotationType) { //$IDENTITY-COMPARISON$
                    if (repackagedBindings == annotations)
                        System.arraycopy(repackagedBindings, 0, repackagedBindings = new AnnotationBinding[length], 0,
                            length);
    ...
    /*
     * Unwrap container annotations into the repeated annotations, return an array of bindings that includes the
