...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.INamingRequestor;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.InternalNamingConventions;
...
public final class NamingConventions {
    static class NamingRequestor implements INamingRequestor {
        ...
        public void acceptNameWithoutPrefixAndSuffix(char[] name, int reusedCharacters) {
            ...
            if (length == this.otherResultsCount) {
                System.arraycopy(this.otherResults, 0, this.otherResults = new char[length * 2][], 0, length);
            }
        ...
        public void acceptNameWithPrefix(char[] name, boolean isFirstPrefix, int reusedCharacters) {
            if (isFirstPrefix) {
                ...
                if (length == this.firstPrefixResultsCount) {
                    System.arraycopy(this.firstPrefixResults, 0, this.firstPrefixResults = new char[length * 2][], 0,
                        length);
                }
        ...
        public void acceptNameWithPrefixAndSuffix(char[] name, boolean isFirstPrefix, boolean isFirstSuffix,
            ...
            if (isFirstPrefix && isFirstSuffix) {
                ...
                if (length == this.firstPrefixAndFirstSuffixResultsCount) {
                    System.arraycopy(this.firstPrefixAndFirstSuffixResults, 0,
                        this.firstPrefixAndFirstSuffixResults = new char[length * 2][], 0, length);
                }
                ...
                if (length == this.firstPrefixAndSuffixResultsCount) {
                    System.arraycopy(this.firstPrefixAndSuffixResults, 0,
                        this.firstPrefixAndSuffixResults = new char[length * 2][], 0, length);
                }
                ...
                if (length == this.prefixAndFirstSuffixResultsCount) {
                    System.arraycopy(this.prefixAndFirstSuffixResults, 0,
                        this.prefixAndFirstSuffixResults = new char[length * 2][], 0, length);
                }
                ...
                if (length == this.prefixAndSuffixResultsCount) {
                    System.arraycopy(this.prefixAndSuffixResults, 0,
                        this.prefixAndSuffixResults = new char[length * 2][], 0, length);
                }
        ...
        public void acceptNameWithSuffix(char[] name, boolean isFirstSuffix, int reusedCharacters) {
            if (isFirstSuffix) {
                ...
                if (length == this.firstSuffixResultsCount) {
                    System.arraycopy(this.firstSuffixResults, 0, this.firstSuffixResults = new char[length * 2][], 0,
                        length);
                }
                ...
                if (length == this.suffixResultsCount) {
                    System.arraycopy(this.suffixResults, 0, this.suffixResults = new char[length * 2][], 0, length);
                }
        ...
        public char[][] getResults() {
            int count = this.firstPrefixAndFirstSuffixResultsCount + this.firstPrefixAndSuffixResultsCount
                + this.prefixAndFirstSuffixResultsCount + this.prefixAndSuffixResultsCount
                + this.firstPrefixResultsCount + this.prefixResultsCount + this.firstSuffixResultsCount
                + this.suffixResultsCount + this.otherResultsCount;

            char[][] results = new char[count][];

            int index = 0;
            System.arraycopy(this.firstPrefixAndFirstSuffixResults, 0, results, index,
                this.firstPrefixAndFirstSuffixResultsCount);
            index += this.firstPrefixAndFirstSuffixResultsCount;
            System.arraycopy(this.firstPrefixAndSuffixResults, 0, results, index,
                this.firstPrefixAndSuffixResultsCount);
            index += this.firstPrefixAndSuffixResultsCount;
            System.arraycopy(this.prefixAndFirstSuffixResults, 0, results, index,
     ...
     * @see JavaCore#getDefaultOptions()
     *
     * @deprecated Use {@link #getBaseName(int, String, IJavaProject)} instead with {@link #VK_PARAMETER} as variable
     * kind.
     */
     ...
     * {@link JavaCore#CODEASSIST_FIELD_SUFFIXES} for instance field and
     * {@link JavaCore#CODEASSIST_STATIC_FIELD_PREFIXES},
     ...
     * <p>
     * e.g.<br>
     * If the variable is a {@link #VK_LOCAL} and the variable name is <code>variableName</code> then the base name will
     * be <code>variableName</code>.<br>
     * If the variable is a {@link #VK_STATIC_FINAL_FIELD} and the variable name is <code>VARIABLE_NAME</code> then the
     * base name will be <code>variableName</code>.<br>
     * </p>
     * <p>
     ...
     * <ul>
     * <li>{@link #VK_PARAMETER}: {@link JavaCore#CODEASSIST_ARGUMENT_PREFIXES} and
     * {@link JavaCore#CODEASSIST_ARGUMENT_SUFFIXES}</li>
     * <li>{@link #VK_LOCAL}: {@link JavaCore#CODEASSIST_LOCAL_PREFIXES} and
     * {@link JavaCore#CODEASSIST_LOCAL_SUFFIXES}</li>
     * <li>{@link #VK_INSTANCE_FIELD}: {@link JavaCore#CODEASSIST_FIELD_PREFIXES} and
     * {@link JavaCore#CODEASSIST_FIELD_SUFFIXES}</li>
     * <li>{@link #VK_STATIC_FIELD}: {@link JavaCore#CODEASSIST_STATIC_FIELD_PREFIXES} and
     * {@link JavaCore#CODEASSIST_STATIC_FIELD_SUFFIXES}</li>
     * <li>{@link #VK_STATIC_FINAL_FIELD}: {@link JavaCore#CODEASSIST_STATIC_FINAL_FIELD_PREFIXES} and
     * {@link JavaCore#CODEASSIST_STATIC_FINAL_FIELD_SUFFIXES}</li>
     * </ul>
     * <p>
     * e.g.<br>
     * If the variable is a {@link #VK_LOCAL}, the variable name is <code>preVariableNamesuf</code>, a possible prefix
     * is <code>pre</code> and a possible suffix is <code>suf</code>
     * then the base name will be <code>variableName</code>.<br>
     * </p>
     *
     * @param variableKind specifies what type the variable is: {@link #VK_LOCAL}, {@link #VK_PARAMETER},
     * {@link #VK_STATIC_FIELD},
     * {@link #VK_INSTANCE_FIELD} or {@link #VK_STATIC_FINAL_FIELD}.
     * @param variableName a variable name
     * @param javaProject project which contains the variable or <code>null</code> to take into account only workspace
     * settings.
     *
     * @see #suggestVariableNames(int, int, String, IJavaProject, int, String[], boolean)
     * @since 3.5
     ...
     */
    public static char[][] suggestArgumentNames(IJavaProject javaProject, char[] packageName, char[] qualifiedTypeName,
        int dim, char[][] excludedNames) {
     ...
     * with {@link #VK_PARAMETER} as variable kind.
     */
    public static String[] suggestArgumentNames(IJavaProject javaProject, String packageName, String qualifiedTypeName,
        int dim, String[] excludedNames) {
     ...
     * <p>
     * This method is affected by the following JavaCore options : {@link JavaCore#CODEASSIST_FIELD_PREFIXES},
     * {@link JavaCore#CODEASSIST_FIELD_SUFFIXES} and for instance field and
     * {@link JavaCore#CODEASSIST_STATIC_FIELD_PREFIXES},
     * {@link JavaCore#CODEASSIST_STATIC_FIELD_SUFFIXES} for static field.
     * </p>
     * <p>
    ...
    public static char[][] suggestFieldNames(IJavaProject javaProject, char[] packageName, char[] qualifiedTypeName,
        ...
        NamingRequestor requestor = new NamingRequestor();
        InternalNamingConventions.suggestVariableNames(Flags.isStatic(modifiers) ? VK_STATIC_FIELD : VK_INSTANCE_FIELD,
            BK_TYPE_NAME, typeName, javaProject, dim, null, excludedNames, true, requestor);
     ...
     * <code>getFieldName</code> for others. If there is no prefix and suffix the proposal is
     * <code>isPreFieldNamesuf</code>
    ...
    public static char[] suggestGetterName(IJavaProject project, char[] fieldName, int modifiers, boolean isBoolean,
        ...
        if (isBoolean) {
            char[] name
                = InternalNamingConventions.getBaseName(getFieldVariableKind(modifiers), project, fieldName, false);
            ...
            return suggestNewName(CharOperation.concat(GETTER_NAME, suggestAccessorName(project, fieldName, modifiers)),
                excludedNames);
        }
    }
     ...
     *
     * @deprecated Use {@link #suggestVariableNames(int, int, String, IJavaProject, int, String[], boolean)} instead
     * with {@link #VK_LOCAL} as variable kind.
     */
    ...
    public static char[] suggestSetterName(IJavaProject project, char[] fieldName, int modifiers, boolean isBoolean,
        ...
        if (isBoolean) {
            ...
            if (CharOperation.prefixEquals(GETTER_BOOL_NAME, name)
                ...
                return suggestNewName(CharOperation.concat(SETTER_NAME, suggestAccessorName(project, name, modifiers)),
                    excludedNames);
            } else {
                return suggestNewName(
            ...
            return suggestNewName(CharOperation.concat(SETTER_NAME, suggestAccessorName(project, fieldName, modifiers)),
                excludedNames);
        }
    }
     ...
     * Some different kinds of base names are possible and each kind is associated to a different heuristic to compute
     * variable names.<br>
     * The heuristic depends also on the kind of the variable. Each kind of variable is identified by a constant
     * starting with <code>VK_</code>.<br>
     * When a prefix and a suffix can be added then all combinations of prefix and suffix are suggested.
     * If the name is <code>name</code>, the prefix is <code>pre</code> and the suffix is <code>suf</code> then the
     * suggested names will be
     * <code>prenamesuf</code>, <code>prename</code>, <code>namesuf</code> and <code>name</code>.<br>
     * <br>
     * The different kinds of base names are:
     * <ul>
     * <li>{@link #BK_NAME}: the base name is a Java name and the whole base name is considered to compute the variable
     * names. A prefix and a suffix can be added.<br>
     ...
     * In this case all letters of the name will be converted to upper case and words will be separated by an underscore
     * (<code>"_"</code>).<br>
     * If the base name is <code>SimpleName</code> then the suggested name will be <code>SIMPLE_NAME</code>.</li>
     * </ul></li>
     * <li>{@link #BK_TYPE_NAME}: the base name is a Java simple type name (e.g. <code>HashMap</code>) and all the words
     * of the base name are considered to compute the variable names. A prefix and a suffix can be added to these
     * names.<br>
     * There is a heuristic by variable kind.
     * <ul>
     * <li>{@link #VK_PARAMETER}, {@link #VK_LOCAL}, {@link #VK_INSTANCE_FIELD} and {@link #VK_STATIC_FIELD}:<br>
     * In this case a variable name will contain some words of the base name and the first word will be converted to
     * lower case.<br>
     * If the type is <code>TypeName</code> then the suggested names will be <code>typeName</code> and
     * <code>name</code>.</li>
     * <li>{@link #VK_STATIC_FINAL_FIELD} :<br>
     * In this case a variable name will contain some words of the base name, all letters of the name will be converted
     * to upper case and segments will be separated by a underscore (<code>"_"</code>).<br>
     * If the base name is <code>TypeName</code> then the suggested name will be <code>TYPE_NAME</code> and
     * <code>NAME</code>.</li>
     * </ul></li>
     * </ul>
     ...
     * To programmatically change these options, see {@link JavaCore#setOptions(java.util.Hashtable)} and
     * {@link IJavaProject#setOptions(java.util.Map)}
     * </p>
     * <p>
     ...
     * @param evaluateDefault if <code>true</code>, the result is guaranteed to contain at least one result. If
     * <code>false</code>, the result can be an empty array.
    ...
    public static String[] suggestVariableNames(int variableKind, int baseNameKind, String baseName,
        ...
        NamingRequestor requestor = new NamingRequestor();
        InternalNamingConventions.suggestVariableNames(variableKind, baseNameKind, baseName.toCharArray(), javaProject,
            dim, null, convertStringToChars(excluded), evaluateDefault, requestor);
