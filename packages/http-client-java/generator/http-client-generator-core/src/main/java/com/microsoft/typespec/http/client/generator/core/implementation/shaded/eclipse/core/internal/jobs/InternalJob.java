 ...
 * directly. All jobs must be subclasses of the API
 * <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.jobs.Job</code>
 * class.
 */
public abstract class InternalJob extends PlatformObject implements Comparable<InternalJob> {
    ...
    protected boolean join(long timeout, IProgressMonitor joinMonitor)
