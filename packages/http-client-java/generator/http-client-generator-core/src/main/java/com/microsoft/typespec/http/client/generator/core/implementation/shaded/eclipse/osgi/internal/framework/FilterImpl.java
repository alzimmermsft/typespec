            ...
            switch (filterChars[pos]) {
                case '~': {
                    if (filterChars[pos + 1] == '=') {
                        pos += 2;
                        return new Approx(attr, parse_value());
                    }
                    break;
                }
                ...
                case '>': {
                    if (filterChars[pos + 1] == '=') {
                        pos += 2;
                        return new GreaterEqual(attr, parse_value());
                    }
                    break;
                }
                ...
                case '<': {
                    if (filterChars[pos + 1] == '=') {
                        pos += 2;
                        return new LessEqual(attr, parse_value());
                    }
                    break;
                }
                ...
                case '=': {
                    ...
                    if (length == 0) {
                        return new Equal(attr, ""); //$NON-NLS-1$
                    }
                    if (length == 1) {
                ...
                switch (c) {
                    ...
                    case '(': {
                        throw new InvalidSyntaxException(
                            NLS.bind(Msg.FILTER_INVALID_VALUE, filterstring.substring(pos)), filterstring);
                    }
