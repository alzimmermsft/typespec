...
public class ForStatement extends Statement {
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        if (this.condition != null) {
            if (!isConditionTrue) {
                condInfo
                    = this.condition.analyseCode(this.scope,
                        (condLoopContext
                            = new LoopingFlowContext(flowContext, flowInfo, this, null, null, this.scope, true)),
                        condInfo);
        ...
        if (this.action == null) {
            ...
            if (isConditionTrue) {
                ...
                loopingContext = new LoopingFlowContext(flowContext, flowInfo, this, this.breakLabel,
                    this.continueLabel, this.scope, false);
            ...
            loopingContext = new LoopingFlowContext(flowContext, flowInfo, this, this.breakLabel, this.continueLabel,
                this.scope, true);
    ...
    public void generateCode(BlockScope currentScope, CodeStream codeStream) {
        ...
        boolean conditionInjectsBindings
            = this.condition != null ? this.condition.bindingsWhenTrue().length > 0 : false;
        boolean isConditionOptimizedFalse
            = cst != null && (cst != Constant.NotAConstant && cst.booleanValue() == false);
        if (isConditionOptimizedFalse) {
    ...
    public LocalVariableBinding[] bindingsWhenComplete() {
        return this.condition != null && this.action != null && !this.action.breaksOut(null)
            ? this.condition.bindingsWhenFalse()
            : NO_VARIABLES;
    }
