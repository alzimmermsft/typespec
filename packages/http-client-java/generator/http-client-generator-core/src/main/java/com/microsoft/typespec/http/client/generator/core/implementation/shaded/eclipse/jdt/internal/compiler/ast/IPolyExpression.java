...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.InvocationSite;
...
/**
 * Contract to be implemented by all poly expressions and potential poly expressions for uniform integration into
 * overload resolution and type inference.
 * Additional contracts may be imposed by {@link Invocation} and {@link InvocationSite}. For most contracts "default"
 * implementations are furnished by
 * {@link Expression} or {@link Statement} or by {@link ASTNode} and the poly expression should suitably override where
 * required.
 * 
 * @see PolyTypeBinding
...
public interface IPolyExpression {
    ...
    /*
     * Resolution: A poly expression must be prepared to be resolved multiple times and should manage matters in a side
     * effect free fashion.
     * Typically, in invocation contexts, there is an initial resolution, multiple tentative resolutions and then a
     * final resolution against
