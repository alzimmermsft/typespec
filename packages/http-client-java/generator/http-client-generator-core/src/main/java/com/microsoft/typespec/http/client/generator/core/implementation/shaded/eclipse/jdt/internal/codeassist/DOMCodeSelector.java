...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.AnnotatableInfo;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.CompilationUnit;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.DOMToModelPopulator;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.SourceField;
...
public class DOMCodeSelector {
	...
	public IJavaElement[] codeSelect(int offset, int length) throws JavaModelException {
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit currentAST = this.unit.getOrBuildAST(this.owner, this.unit.getBuffer().getLength() < 50000 ? -1 : offset);
		if (currentAST == null) {
		...
		ImportDeclaration importDecl = findImportDeclaration(node);
		...
		if (insideComment) {
			...
			String resolved = ((List<ImportDeclaration>)currentAST.imports()).stream()
	...
	private IJavaElement[] findTypeInIndex(String packageName, String simpleName) throws JavaModelException {
		...
		TypeNameMatchRequestor requestor = new TypeNameMatchRequestor() {
			@Override
			public void acceptTypeNameMatch(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.search.TypeNameMatch match) {
