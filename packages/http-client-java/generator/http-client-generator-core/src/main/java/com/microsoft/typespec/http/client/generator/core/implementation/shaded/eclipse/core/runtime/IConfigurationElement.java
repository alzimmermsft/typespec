 ...
 * plug-in's manifest (<code>plugin.xml</code>) file.
 * <p>
...
public interface IConfigurationElement {
     ...
     * must contain a fully qualified name of a Java class. The class can either
     * refer to a class implementing the executable extension or to a factory
     * capable of returning the executable extension.
     * <p>
     ...
     * this configuration element in the specified locale, or <code>null</code> if
     * none.
     * <p>
     * The locale matching tries to find the best match between available
     * translations and the requested locale, falling back to a more generic locale
