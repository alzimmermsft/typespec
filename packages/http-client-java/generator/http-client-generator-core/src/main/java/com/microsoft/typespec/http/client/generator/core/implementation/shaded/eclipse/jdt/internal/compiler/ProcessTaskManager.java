...
// add unit to the queue - wait if no space is available
    ...
    /**
     * blocks until at least one CompilationUnitDeclaration can be returned or empty when no more elements can be
     * expected
     **/
        ...
        try {
            ...
            while (this.processing) {
                ...
                try {
                    ...
                    try {
                        this.compiler.reportProgress(
                            Messages.bind(Messages.compilation_processing, new String(unitToProcess.getFileName())));
