...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.BoundType.CLOSED;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.BoundType.OPEN;
...
final class GeneralRange<T extends @Nullable Object> implements Serializable {
     ...
     * endpoint behavior.
     */
    static <T extends @Nullable Object> GeneralRange<T> downTo(Comparator<? super T> comparator,
        @ParametricNullness T endpoint, BoundType boundType) {
     ...
     * endpoint behavior.
     */
    static <T extends @Nullable Object> GeneralRange<T> upTo(Comparator<? super T> comparator,
        @ParametricNullness T endpoint, BoundType boundType) {
     ...
     */
    static <T extends @Nullable Object> GeneralRange<T> range(Comparator<? super T> comparator,
        @ParametricNullness T lower, BoundType lowerType, @ParametricNullness T upper, BoundType upperType) {
    ...
    private GeneralRange(Comparator<? super T> comparator, boolean hasLowerBound, @CheckForNull T lowerEndpoint,
        BoundType lowerBoundType, boolean hasUpperBound, @CheckForNull T upperEndpoint, BoundType upperBoundType) {
         ...
         */
        if (hasLowerBound) {
            int unused = comparator.compare(uncheckedCastNullableTToT(lowerEndpoint),
                uncheckedCastNullableTToT(lowerEndpoint));
        }
        if (hasUpperBound) {
            int unused = comparator.compare(uncheckedCastNullableTToT(upperEndpoint),
                uncheckedCastNullableTToT(upperEndpoint));
        }

        if (hasLowerBound && hasUpperBound) {
            int cmp = comparator.compare(uncheckedCastNullableTToT(lowerEndpoint),
                uncheckedCastNullableTToT(upperEndpoint));
