 ...
 * <li><code>"X:QReader;:QSerializable;"</code> denotes <code>X extends Reader &amp; Serializable</code> in source
 * code</li>
 * </ul>
 * <p>
...
public final class Signature {
     ...
     * Value is <code>'['</code>.
     */
    public static final char C_ARRAY = Util.C_ARRAY;

    /**
     * Character constant indicating the primitive type boolean in a signature.
     * Value is <code>'Z'</code>.
     */
    public static final char C_BOOLEAN = Util.C_BOOLEAN;

    /**
     * Character constant indicating the primitive type byte in a signature.
     * Value is <code>'B'</code>.
     */
    public static final char C_BYTE = Util.C_BYTE;
     ...
     * @since 3.1
     */
    public static final char C_CAPTURE = Util.C_CAPTURE;

    /**
     * Character constant indicating the primitive type char in a signature.
     * Value is <code>'C'</code>.
     */
    public static final char C_CHAR = Util.C_CHAR;
     ...
     * @since 3.0
     */
    public static final char C_COLON = Util.C_COLON;

    /**
     * Character constant indicating the dollar in a signature.
     * Value is <code>'$'</code>.
     */
    public static final char C_DOLLAR = Util.C_DOLLAR;

    /**
     * Character constant indicating the dot in a signature.
     * Value is <code>'.'</code>.
     */
    public static final char C_DOT = Util.C_DOT;

    /**
     * Character constant indicating the primitive type double in a signature.
     * Value is <code>'D'</code>.
     */
    public static final char C_DOUBLE = Util.C_DOUBLE;
     ...
     * @since 3.1
     */
    public static final char C_EXCEPTION_START = Util.C_EXCEPTION_START;
     ...
     * @since 3.1
     */
    public static final char C_EXTENDS = Util.C_EXTENDS;

    /**
     * Character constant indicating the primitive type float in a signature.
     * Value is <code>'F'</code>.
     */
    public static final char C_FLOAT = Util.C_FLOAT;
     ...
     * @since 3.0
     */
    public static final char C_GENERIC_END = Util.C_GENERIC_END;
     ...
     * @since 3.0
     */
    public static final char C_GENERIC_START = Util.C_GENERIC_START;

    /**
     * Character constant indicating the primitive type int in a signature.
     * Value is <code>'I'</code>.
     */
    public static final char C_INT = Util.C_INT;
     ...
     */
    public static final char C_LONG = Util.C_LONG;

    /**
     * Character constant indicating the end of a named type in a signature.
     * Value is <code>';'</code>.
     */
    public static final char C_NAME_END = Util.C_NAME_END;

    /**
     * Character constant indicating the end of a parameter type list in a
     * signature. Value is <code>')'</code>.
     */
    public static final char C_PARAM_END = Util.C_PARAM_END;

    /**
     * Character constant indicating the start of a parameter type list in a
     * signature. Value is <code>'('</code>.
     */
    public static final char C_PARAM_START = Util.C_PARAM_START;

    /**
     * Character constant indicating the start of a resolved, named type in a
     * signature. Value is <code>'L'</code>.
     */
    public static final char C_RESOLVED = Util.C_RESOLVED;

    /**
     * Character constant indicating the semicolon in a signature.
     * Value is <code>';'</code>.
     */
    public static final char C_SEMICOLON = Util.C_SEMICOLON;

    /**
     * Character constant indicating the primitive type short in a signature.
     * Value is <code>'S'</code>.
     */
    public static final char C_SHORT = Util.C_SHORT;
     ...
     * @since 3.0
     */
    public static final char C_STAR = Util.C_STAR;
     ...
     * @since 3.1
     */
    public static final char C_SUPER = Util.C_SUPER;
     ...
     * @since 3.0
     */
    public static final char C_TYPE_VARIABLE = Util.C_TYPE_VARIABLE;

    /**
     * Character constant indicating the start of an unresolved, named type in a
     * signature. Value is <code>'Q'</code>.
     */
    public static final char C_UNRESOLVED = Util.C_UNRESOLVED;

    /**
     * Character constant indicating result type void in a signature.
     * Value is <code>'V'</code>.
     */
    public static final char C_VOID = Util.C_VOID;
...
// <x.y.z, a.b<c>.d<e.f>> --> <z,d<f>>
     ...
     * @see Util#scanArrayTypeSignature(char[], int)
     */
    private static int appendIntersectionTypeSignature(char[] string, int start, boolean fullyQualifyTypeNames,
        StringBuilder buffer) {
        // need a minimum 2 char
        if (start >= string.length - 1) {
            throw newIllegalArgumentException(string, start);
    ...
    private static void appendSimpleName(char[] name, int start, int end, StringBuilder buffer) {
        ...
        if (lastGenericStart >= 0) {
            ...
            buffer.append(name, lastGenericEnd + 1, end - lastGenericEnd); // copy trailing portion, may contain
                                                                           // dimensions
        }
    }
    ...
    private static int checkNextChar(char[] typeName, char expectedChar, int pos, int length, boolean isOptional) {
        ...
        if (pos < length && typeName[pos] == expectedChar)
            return pos + 1;
        if (!isOptional)
            throw new IllegalArgumentException(String.valueOf(typeName));
        return -1;
    }
     ...
     * @see #createTypeSignature(String,boolean)
     *
     * @since 2.0
     */
    ...
    public static char[] createTypeParameterSignature(char[] typeParameterName, char[][] boundSignatures) {
        ...
        if (length == 0) {
            return CharOperation.append(typeParameterName, C_COLON); // param signature with no bounds still gets
                                                                     // trailing colon
        }
        int boundsSize = 0;
    ...
    public static int getArrayCount(char[] typeSignature) throws IllegalArgumentException {
        try {
            ...
            return count;
        } catch (ArrayIndexOutOfBoundsException e) { // signature is syntactically incorrect if last character is
                                                     // C_ARRAY
    ...
    public static char[] getQualifier(char[] name) {
        ...
        int lastDot
            = CharOperation.lastIndexOf(C_DOT, name, 0, firstGenericStart == -1 ? name.length - 1 : firstGenericStart);
        if (lastDot == -1) {
    ...
    public static char[] getSimpleName(char[] name) {
        ...
        appendArgumentSimpleNames(name, lastGenericStart, lastGenericEnd, buffer);
        buffer.append(name, lastGenericEnd + 1, length - lastGenericEnd - 1); // copy trailing portion, may contain
                                                                              // dimensions
        char[] result = new char[length = buffer.length()];
        buffer.getChars(0, length, result, 0);
        return result;
    ...
    public static String getSimpleName(String name) {
        ...
        buffer.append(nameChars, lastGenericEnd + 1, length - lastGenericEnd - 1); // copy trailing portion, may contain
                                                                                   // dimensions
    ...
    public static char[][] getTypeParameterBounds(char[] formalTypeParameterSignature) throws IllegalArgumentException {
        ...
        if (p2 < 0) {
            // no interface bounds
            classBound
                = CharOperation.subarray(formalTypeParameterSignature, p1 + 1, formalTypeParameterSignature.length);
        ...
        char[][] interfaceBounds
            = CharOperation.splitOn(C_COLON, formalTypeParameterSignature, p2 + 1, formalTypeParameterSignature.length);
        if (classBound == null) {
    ...
    public static char[] toCharArray(char[] methodSignature, char[] methodName, char[][] parameterNames,
        ...
        return toCharArray(methodSignature, methodName, parameterNames, fullyQualifyTypeNames, includeReturnType,
            false);
    }
    ...
    public static String toString(String methodSignature, String methodName, String[] parameterNames,
        ...
        return new String(
            toCharArray(methodSignature.toCharArray(), methodName == null ? null : methodName.toCharArray(), params,
                fullyQualifyTypeNames, includeReturnType, isVarArgs));
    }
