...
public class ForStatement extends Statement {
     ...
     */
    private final NodeList initializers = new NodeList(INITIALIZERS_PROPERTY);
     ...
     * {@link Expression}). Defaults to an empty list.
     */
    private final NodeList updaters = new NodeList(UPDATERS_PROPERTY);
    ...
    @Override
    int treeSize() {
        return memSize() + this.initializers.listSize() + this.updaters.listSize()
