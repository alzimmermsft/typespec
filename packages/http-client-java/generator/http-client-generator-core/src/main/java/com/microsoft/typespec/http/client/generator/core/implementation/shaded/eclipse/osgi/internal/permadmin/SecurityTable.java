...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi.internal.permadmin.SecurityRow.Decision;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.condpermadmin.Condition;
...
public class SecurityTable extends PermissionCollection {
    ...
    int evaluate(BundlePermissions bundlePermissions, Permission permission) {
        ...
        Integer immediateDecision
            = handlePostponedConditions(evaluationCacheKey, hasMutable, postponed, results, immediateDecisionIdx);
