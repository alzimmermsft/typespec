...
public interface IJavaModelMarker {
     ...
     * <code>"com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.problem"</code>).
     * This can be used to
     ...
     * <code>"com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.transient_problem"</code>).
     * This can be
     ...
     * @see org.eclipse.jdt.core.eval.ICodeSnippetRequestor#acceptProblem(IMarker,String,
     * int)
     */
     ...
     * <code>"com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.task"</code>).
     * This can be used to
     ...
     * <code>"com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.taskTag"</code>.
     *
     * @since 2.1
     */
     ...
     * <code>"com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.buildpath_problem"</code>).
     * This can be
     * used to recognize those markers in the workspace that flag problems
     * detected by the Java tooling during classpath setting.
     */
    String BUILDPATH_PROBLEM_MARKER = JavaCore.PLUGIN_ID + ".buildpath_problem"; //$NON-NLS-1$
