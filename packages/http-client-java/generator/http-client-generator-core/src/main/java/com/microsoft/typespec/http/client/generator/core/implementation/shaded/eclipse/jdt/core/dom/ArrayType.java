...
public class ArrayType extends Type {
     ...
     * 
     * @deprecated In the JLS8 API, this property is replaced by {@link #ELEMENT_TYPE_PROPERTY} and
     * {@link #DIMENSIONS_PROPERTY}.
     * @since 3.0
     */
     ...
     * @since 3.10
     */
    private NodeList dimensions = null;
    ...
    ArrayType(AST ast) {
        ...
        if (ast.apiLevel >= AST.JLS8_INTERNAL) {
            this.dimensions = new NodeList(DIMENSIONS_PROPERTY);
    ...
    @Override
    int treeSize() {
        return memSize() + (this.type == null
            ? 0
            : (this.ast.apiLevel() < AST.JLS8_INTERNAL ? getComponentType().treeSize() : getElementType().treeSize())
