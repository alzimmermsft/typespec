...
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.permissionadmin;
...
public class PermissionInfo {
    ...
    public final String getEncoded() {
        StringBuilder output = new StringBuilder(8 + type.length()
            + ((((name == null) ? 0 : name.length()) + ((actions == null) ? 0 : actions.length())) << 1));
        output.append('(');
        output.append(type);
        if (name != null) {
            output.append(" \"");
