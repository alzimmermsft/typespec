...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.jobs.InternalJobGroup;
...
public class JobGroup extends InternalJobGroup {
     ...
     */
    @Override
    public final boolean join(long timeoutMillis, IProgressMonitor monitor)
