...
public final class Messages {
    ...
    private static final String BUNDLE_NAME
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.messages";//$NON-NLS-1$
    ...
    private static InputStream createInputStream(final ClassLoader loader, String variant) {
        return (loader == null) ? ClassLoader.getSystemResourceAsStream(variant) : loader.getResourceAsStream(variant);
    }
}
