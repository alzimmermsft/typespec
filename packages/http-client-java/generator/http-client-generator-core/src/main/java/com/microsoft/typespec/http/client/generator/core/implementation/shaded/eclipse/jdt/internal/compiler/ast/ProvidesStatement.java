    ...
    public boolean resolve(BlockScope scope) {
        ...
        for (TypeReference implementation : this.implementations) {
            ...
            if (declaringModule != src) {
                ...
                MethodBinding provider
                    = impl.getExactMethod(TypeConstants.PROVIDER, Binding.NO_PARAMETERS, scope.compilationUnitScope());
                ...
                if (provider != null) {
                    ...
                    if (implType instanceof ReferenceBinding && !implType.canBeSeenBy(scope)) {
                        ...
                        scope.problemReporter()
                            .invalidType(implementation, new ProblemReferenceBinding(referenceBinding.compoundName,
                                referenceBinding, ProblemReasons.NotVisible));
                        hasErrors = true;
                    }
                } else {
                    if (impl.isAbstract()) {
