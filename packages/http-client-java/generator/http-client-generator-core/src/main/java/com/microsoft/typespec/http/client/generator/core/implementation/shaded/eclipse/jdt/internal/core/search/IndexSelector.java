...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.builder.ReferenceCollection;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.builder.State;
...
public IndexSelector(
	...
	int result = PROJECT_CAN_NOT_SEE_FOCUS;
        for (IJavaElement focus : focuses) {
            int canSeeFocus = canSeeFocus(focus, javaProject, focusQualifiedNames);
