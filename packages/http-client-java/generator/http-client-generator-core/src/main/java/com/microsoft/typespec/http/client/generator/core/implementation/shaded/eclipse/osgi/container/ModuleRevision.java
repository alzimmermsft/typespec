...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi.container.ModuleRevisionBuilder.GenericInfo;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi.container.namespaces.EquinoxModuleDataNamespace;
...
public final class ModuleRevision implements BundleRevision {
	...
	private NamespaceList<ModuleRequirement> createRequirements(NamespaceList.Builder<GenericInfo> infos) {
		return infos.transformIntoCopy(
            i -> new ModuleRequirement(i.namespace, i.directives, i.attributes, ModuleRevision.this), NamespaceList.REQUIREMENT).build();
	}
