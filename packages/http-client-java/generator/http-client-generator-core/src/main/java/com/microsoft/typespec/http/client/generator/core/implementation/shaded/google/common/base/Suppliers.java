...
public final class Suppliers {
     ...
     */
    public static <F extends @Nullable Object, T extends @Nullable Object> Supplier<T>
    ...
    public static <T extends @Nullable Object> Supplier<T> memoizeWithExpiration(Supplier<T> delegate, long duration,
        TimeUnit unit) {
    ...
    static class ExpiringMemoizingSupplier<T extends @Nullable Object> implements Supplier<T>, Serializable {
        final Supplier<T> delegate;
    ...
    private static class ThreadSafeSupplier<T extends @Nullable Object> implements Supplier<T>, Serializable {
        final Supplier<T> delegate;
