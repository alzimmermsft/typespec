...
//	private static final QualifiedName PROJECT_JAVADOC= new QualifiedName(JavaCore.PLUGIN_ID, "project_javadoc_location"); //$NON-NLS-1$
    ...
    public boolean equals(Object o) {
        ...
        return getElementName().equals(other.getElementName()) && this.parent.equals(other.getParent());
    }
     ...
     */
    protected IElementInfo openWhenClosed(IElementInfo info, boolean forceAdd, IProgressMonitor monitor)
        ...
        try {
            ...
            // Bug 548456: check if some concurrent call already added the info to the manager, do not throw an
            // exception if so
            if (info == null) {
        ...
        try {
            ...
            byte[] contents
                = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util
                    .getInputStreamAsByteArray(stream);
            if (encoding == null) {
                    ...
                    if (end != -1) {
                        ...
                        if (charsetIndex != -1) {
                            ...
                            encoding = new String(contents, charsetIndex, end - charsetIndex,
                                com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util.UTF_8);
                        }
                    }
                }
            }
