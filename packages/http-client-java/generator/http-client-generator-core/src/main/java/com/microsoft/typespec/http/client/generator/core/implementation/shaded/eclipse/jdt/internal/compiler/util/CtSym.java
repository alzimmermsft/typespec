...
public class CtSym {
    ...
    public static final boolean DISABLE_CACHE = Boolean.getBoolean(
        "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.disable_CTSYM_cache"); //$NON-NLS-1$
    ...
    /**
     * Paths of all root directories, per release (versions encoded). e.g. in JDK 11, Java 10 mapping looks like A ->
     * [A,
    ...
    public Path getFullPath(String releaseCode, String qualifiedSignatureFileName, String moduleName) {
        ...
        if (moduleName != null) {
            // Without this,
            // com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.tests.model.ModuleBuilderTests.testConvertToModule()
            // fails on 12+ JRE
