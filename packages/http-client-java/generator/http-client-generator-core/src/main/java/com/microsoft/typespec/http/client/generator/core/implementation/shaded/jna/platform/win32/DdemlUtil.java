...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Ddeml.CONVCONTEXT;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Ddeml.CONVINFO;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Ddeml.HCONV;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Ddeml.HCONVLIST;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Ddeml.HDDEDATA;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Ddeml.HSZ;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Ddeml.HSZPAIR;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.User32Util.MessageLoopThread;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.User32Util.MessageLoopThread.Handler;
...
public abstract class DdemlUtil {
     ...
     * a {@link MessageLoopThread}. The DdeClient needs a running
    ...
    public static class StandaloneDdeClient implements IDdeClient, Closeable {
        ...
        public void nameService(HSZ name, int afCmd) throws DdemlException {
        ...
        @Override
        public void unaccessData(HDDEDATA hData) {
            clientDelegate.unaccessData(hData);
        }

        @Override
        public void postAdvise(HSZ hszTopic, HSZ hszItem) {
        ...
        @Override
        public boolean keepStringHandle(HSZ value) {
        ...
        @Override
        public IDdeConnection connect(String service, String topic, CONVCONTEXT convcontext) {
            return clientDelegate.connect(service, topic, convcontext);
        }
    ...
    public static class DdeConnection implements IDdeConnection {
        ...
        @Override
        public HDDEDATA request(HSZ item, int wFmt, int timeout, WinDef.DWORDByReference result, DWORD_PTR userHandle) {
        ...
        @Override
        public void advstart(HSZ item, int wFmt, int timeout, WinDef.DWORDByReference result, DWORD_PTR userHandle) {
        ...
        @Override
        public void advstop(HSZ item, int wFmt, int timeout, WinDef.DWORDByReference result, DWORD_PTR userHandle) {
    ...
    public static class DdeConnectionList implements IDdeConnectionList {
        ...
        public DdeConnectionList(IDdeClient client, HCONVLIST convList) {
            this.convList = convList;
            this.client = client;
        }

        @Override
        public HCONVLIST getHandle() {
    ...
    public static class DdeClient implements IDdeClient {
        ...
        public void nameService(HSZ name, int afCmd) throws DdemlException {
            HDDEDATA handle = Ddeml.INSTANCE.DdeNameService(idInst, name, new HSZ(), afCmd);
            if (handle == null) {
                throw DdemlException.create(getLastError());
            }
        }
    ...
    public interface ConnectConfirmHandler {
         ...
         * same application instance as the server.
         */
        void onConnectConfirm(int transactionType, HCONV hconv, HSZ topic, HSZ service, boolean sameInstance);
    }
    ...
    public interface ExecuteHandler {
         ...
         *
         */
        int onExecute(int transactionType, HCONV hconv, HSZ topic, HDDEDATA commandString);
    }
    ...
    public static class DdeAdapter implements Ddeml.DdeCallback {
        ...
        private boolean onAdvstart(int transactionType, int dataFormat, HCONV hconv, HSZ topic, HSZ item) {
        ...
        private void onAdvstop(int transactionType, int dataFormat, HCONV hconv, HSZ topic, HSZ item) {
