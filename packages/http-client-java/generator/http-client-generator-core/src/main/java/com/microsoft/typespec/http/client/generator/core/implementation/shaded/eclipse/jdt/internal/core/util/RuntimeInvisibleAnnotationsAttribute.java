...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.IAnnotation;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.IConstantPool;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.IRuntimeInvisibleAnnotationsAttribute;
...
public class RuntimeInvisibleAnnotationsAttribute extends ClassFileAttribute
     ...
     */
    public RuntimeInvisibleAnnotationsAttribute(byte[] classFileBytes, IConstantPool constantPool, int offset)
