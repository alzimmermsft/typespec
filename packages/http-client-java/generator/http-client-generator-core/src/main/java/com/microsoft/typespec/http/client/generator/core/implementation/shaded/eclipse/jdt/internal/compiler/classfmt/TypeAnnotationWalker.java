...
public class TypeAnnotationWalker implements ITypeAnnotationWalker {
    ...
    final protected long matches;								// bit mask of indices into typeAnnotations, 1 means
                                 								// active, 0 is filtered during the walk
    ...
    public ITypeAnnotationWalker toTypeParameter(boolean isClassTypeParameter, int rank) {
        ...
        int targetType = isClassTypeParameter
            ? AnnotationTargetTypeConstants.CLASS_TYPE_PARAMETER
    ...
    public ITypeAnnotationWalker toTypeParameterBounds(boolean isClassTypeParameter, int parameterRank) {
        ...
        int length = this.typeAnnotations.length;
        int targetType = isClassTypeParameter
            ? AnnotationTargetTypeConstants.CLASS_TYPE_PARAMETER_BOUND
