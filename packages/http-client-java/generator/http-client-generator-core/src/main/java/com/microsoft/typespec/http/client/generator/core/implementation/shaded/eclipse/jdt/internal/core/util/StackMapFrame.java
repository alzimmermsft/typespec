...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.IVerificationTypeInfo;
...
public class StackMapFrame extends ClassFileStruct implements IStackMapFrame {
     ...
     */
    public StackMapFrame(byte[] classFileBytes, IConstantPool constantPool, int offset) throws ClassFormatException {
            ...
            case 254:
                ...
                for (int i = 0; i < diffLocals; i++) {
                    VerificationInfo verificationInfo
                        = new VerificationInfo(classFileBytes, constantPool, offset + this.readOffset);
