...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.apt.util.ManyToMany;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.annotation.processing.RoundEnvironment;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.util.ElementFilter;
...
public class RoundEnvImpl implements RoundEnvironment {
    ...
    public RoundEnvImpl(CompilationUnitDeclaration[] units, ReferenceBinding[] binaryTypeBindings, boolean isLastRound,
        ...
        if (binaryTypeBindings != null)
            collectAnnotations(binaryTypeBindings);
    ...
    private void collectAnnotations(ReferenceBinding[] referenceBindings) {
        for (ReferenceBinding referenceBinding : referenceBindings) {
            ...
            AnnotationBinding[] annotationBindings
                = Factory.getPackedAnnotationBindings(referenceBinding.getAnnotations());
        ...
        if (this._rootElements == null) {
                ...
                for (SourceTypeBinding binding : unit.scope.topLevelTypes) {
                    ...
                    if (null == element) {
                        throw new IllegalArgumentException(
                            "Top-level type binding could not be converted to element: " + binding); //$NON-NLS-1$
                    }
            ...
            if (this._binaryTypes != null) {
                for (ReferenceBinding typeBinding : this._binaryTypes) {
                    ...
                    if (null == element) {
                        throw new IllegalArgumentException(
                            "Top-level type binding could not be converted to element: " + typeBinding); //$NON-NLS-1$
                    }
                    elements.add(element);
