...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.hash.BloomFilterStrategies.LockFreeBitArray;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.math.DoubleMath;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.math.LongMath;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.primitives.SignedBytes;
...
public final class BloomFilter<T extends @Nullable Object> implements Predicate<T>, Serializable {
    ...
    interface Strategy extends Serializable {
         ...
         */
        <T extends @Nullable Object> boolean mightContain(@ParametricNullness T object, Funnel<? super T> funnel,
            int numHashFunctions, LockFreeBitArray bits);
    ...
    public void putAll(BloomFilter<T> that) {
        ...
        checkArgument(this.bitSize() == that.bitSize(),
            "BloomFilters must have the same size underlying bit arrays (%s != %s)", this.bitSize(), that.bitSize());
     ...
     * @since 23.0
     */
    public static <T extends @Nullable Object> Collector<T, ?, BloomFilter<T>> toBloomFilter(Funnel<? super T> funnel,
    ...
    @VisibleForTesting
    static <T extends @Nullable Object> BloomFilter<T> create(Funnel<? super T> funnel, long expectedInsertions,
        double fpp, Strategy strategy) {
        checkNotNull(funnel);
        checkArgument(expectedInsertions >= 0, "Expected insertions (%s) must be >= 0", expectedInsertions);
        checkArgument(fpp > 0.0, "False positive probability (%s) must be > 0.0", fpp);
        checkArgument(fpp < 1.0, "False positive probability (%s) must be < 1.0", fpp);
     ...
     * @since 19.0
     */
    public static <T extends @Nullable Object> BloomFilter<T> create(Funnel<? super T> funnel,
        long expectedInsertions) {
     ...
     */
    public static <T extends @Nullable Object> BloomFilter<T> readFrom(InputStream in, Funnel<? super T> funnel)
        throws IOException {
