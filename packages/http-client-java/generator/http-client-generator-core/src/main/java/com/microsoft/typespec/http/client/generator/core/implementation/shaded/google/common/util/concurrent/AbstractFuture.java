...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.NullnessCasts.uncheckedNull;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.j2objc.annotations.ReflectionSupport;
 ...
 * Futures#catching(ListenableFuture, Class, com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Function,
...
public abstract class AbstractFuture<V extends @Nullable Object> extends InternalFutureFailureAccess
     ...
     */
    abstract static class TrustedFuture<V extends @Nullable Object> extends AbstractFuture<V> implements Trusted<V> {
     ...
     */
    @ParametricNullness
    private static <V extends @Nullable Object> V getUninterruptibly(Future<V> future) throws ExecutionException {
    ...
    public String toString() {
        ...
        if (getClass().getName()
            .startsWith(
                "com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.")) {
