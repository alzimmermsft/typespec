...
final class TopKSelector<T extends @Nullable Object> {
     ...
     * @throws IllegalArgumentException if {@code k < 0} or {@code k > Integer.MAX_VALUE / 2}
     */
    public static <T extends @Nullable Object> TopKSelector<T> least(int k, Comparator<? super T> comparator) {
     ...
     * @throws IllegalArgumentException if {@code k < 0} or {@code k > Integer.MAX_VALUE / 2}
     */
    public static <T extends @Nullable Object> TopKSelector<T> greatest(int k, Comparator<? super T> comparator) {
