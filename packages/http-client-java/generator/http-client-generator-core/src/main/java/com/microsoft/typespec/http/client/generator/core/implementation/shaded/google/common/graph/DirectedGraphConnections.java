...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.graph.GraphConstants.INNER_CAPACITY;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.graph.GraphConstants.INNER_LOAD_FACTOR;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.graph.Graphs.checkNonNegative;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.graph.Graphs.checkPositive;
...
final class DirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    static <N, V> DirectedGraphConnections<N, V> ofImmutable(N thisNode, Iterable<EndpointPair<N>> incidentEdges,
    ...
    public Iterator<EndpointPair<N>> incidentEdgeIterator(N thisNode) {
        ...
        if (orderedNodeConnections == null) {
            ...
            resultWithDoubleSelfLoop
                = Iterators.transform(orderedNodeConnections.iterator(), (NodeConnection<N> connection) -> {
