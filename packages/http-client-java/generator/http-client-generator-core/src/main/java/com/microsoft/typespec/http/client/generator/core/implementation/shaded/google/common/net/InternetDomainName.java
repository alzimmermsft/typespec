...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.thirdparty.publicsuffix.PublicSuffixPatterns;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.thirdparty.publicsuffix.PublicSuffixType;
...
public final class InternetDomainName {
    ...
    private int findSuffixOfType(Optional<PublicSuffixType> desiredType) {
        ...
        for (int i = 0; i < partsSize; i++) {
            ...
            if (i > 0
                && matchesType(desiredType, Optional.fromNullable(PublicSuffixPatterns.UNDER.get(ancestorName)))) {
                return i - 1;
            }
