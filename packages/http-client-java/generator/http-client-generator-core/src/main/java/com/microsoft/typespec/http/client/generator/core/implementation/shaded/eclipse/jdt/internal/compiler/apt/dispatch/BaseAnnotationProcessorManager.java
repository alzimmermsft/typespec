...
public abstract class BaseAnnotationProcessorManager extends AbstractAnnotationProcessorManager
     ...
     * 
     * @see
     * org.eclipse.jdt.internal.compiler.AbstractAnnotationProcessorManager#configure(com.microsoft.typespec.http.client
     * .generator.core.implementation.shaded.eclipse.jdt.internal.compiler.batch.Main, java.lang.String[])
     */
    @Override
     ...
     * 
     * @see
     * org.eclipse.jdt.internal.compiler.AbstractAnnotationProcessorManager#configureFromPlatform(com.microsoft.typespec
     * .http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.Compiler, java.lang.Object)
     */
    @Override
     ...
     * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.annotation.processing.Processor}.
     * <p>
     ...
     */
    @Override
    public void processAnnotations(CompilationUnitDeclaration[] units, ReferenceBinding[] referenceBindings,
        boolean isLastRound) {
        if (units != null) {
        ...
        RoundDispatcher dispatcher
            = new RoundDispatcher(this, roundEnv, roundEnv.getRootAnnotations(), traceProcessorInfo, traceRounds);
        dispatcher.round();
