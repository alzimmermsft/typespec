...
public class ASTMatcher {
    ...
    public boolean match(CompilationUnit node, Object other) {
        ...
        return ((node.getAST().apiLevel >= AST.JLS9_INTERNAL ? safeSubtreeMatch(node.getModule(), o.getModule()) : true)
    ...
    public boolean match(ExportsDirective node, Object other) {
        ...
        return (safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.modules(), o.modules()));
    }
    ...
    public boolean match(JavaDocRegion node, Object other) {
        ...
        return safeEquals(node.getTagName(), o.getTagName())
            ...
            && safeSubtreeListMatch(node.fragments(), o.fragments())
            && safeEquals(node.isDummyRegion(),
                o.isDummyRegion() && safeEquals(node.isValidSnippet(), o.isValidSnippet()));
    }
    ...
    public boolean match(RequiresDirective node, Object other) {
        ...
        return safeSubtreeListMatch(node.modifiers(), o.modifiers()) && safeSubtreeMatch(node.getName(), o.getName());
    }
    ...
    public boolean match(SingleVariableDeclaration node, Object other) {
        ...
        return (level >= AST.JLS3_INTERNAL
            ...
            && (level >= AST.JLS8_INTERNAL && node.isVarargs()
                ...
                : true)
            && (level >= AST.JLS3_INTERNAL ? node.isVarargs() == o.isVarargs() : true)
            && safeSubtreeMatch(node.getName(), o.getName())
            && ((level >= AST.JLS8_INTERNAL)
                ? safeSubtreeListMatch(node.extraDimensions(), o.extraDimensions())
                : node.getExtraDimensions() == o.getExtraDimensions())
    ...
    public boolean match(TagElement node, Object other) {
        ...
        return (safeEquals(node.getTagName(), o.getTagName())
            && safeSubtreeListMatch(node.fragments(), o.fragments())
            && (DOMASTUtil.isJavaDocCodeSnippetSupported(node.getAST().apiLevel)
                ? safeSubtreeListMatch(node.tagProperties(), o.tagProperties())
                : true));
    }
    ...
    public boolean match(TagProperty node, Object other) {
        ...
        return (safeEquals(node.getName(), o.getName()) && safeEquals(node.getStringValue(), o.getStringValue()))
     ...
     * @nooverride This method is not intended to be re-implemented or extended by clients as it is a part of Java
     * preview feature.
     * @since 3.20
     */
    ...
    public boolean match(VariableDeclarationExpression node, Object other) {
        ...
        return safeSubtreeMatch(node.getType(), o.getType()) && safeSubtreeListMatch(node.fragments(), o.fragments());
    }
