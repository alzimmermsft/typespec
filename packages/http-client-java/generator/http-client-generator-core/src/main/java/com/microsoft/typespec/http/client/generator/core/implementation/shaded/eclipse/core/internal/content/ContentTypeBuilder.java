...
public class ContentTypeBuilder {
    ...
    public void buildCatalog(IScopeContext context) {
        ...
        for (String id : ContentTypeManager.getUserDefinedContentTypeIds(context)) {
            ...
            catalog.addContentType(ContentType.createContentType(catalog, id,
                node.get(ContentType.PREF_USER_DEFINED__NAME, ContentType.EMPTY_STRING), (byte) 0, new String[0],
                new String[0], new String[0], node.get(ContentType.PREF_USER_DEFINED__BASE_TYPE_ID, null), null,
    ...
    protected IConfigurationElement[] getConfigurationElements() {
        ...
        IConfigurationElement[] allContentTypeCEs
            = new IConfigurationElement[oldConfigElements.length + newConfigElements.length];
