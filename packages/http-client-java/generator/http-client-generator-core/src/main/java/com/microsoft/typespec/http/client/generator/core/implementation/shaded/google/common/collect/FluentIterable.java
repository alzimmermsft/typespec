 ...
 * {
 *     &#64;code
 *     ImmutableList<String> results = FluentIterable.from(database.getClientList())
 ...
 * {
 *     &#64;code
 *     List<String> results = database.getClientList()
 *         .stream()
 *         .filter(Client::isActiveInLastMonth)
 *         .map(Object::toString)
 *         .limit(10)
...
public abstract class FluentIterable<E extends @Nullable Object> implements Iterable<E> {
    ...
    @InlineMe(
        ...
        staticImports = {
            "com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Preconditions.checkNotNull" })
     ...
     * @since 20.0
     */
    public static <T extends @Nullable Object> FluentIterable<T> concat(Iterable<? extends T> a,
     ...
     */
    public static <T extends @Nullable Object> FluentIterable<T> concat(Iterable<? extends T> a,
        Iterable<? extends T> b, Iterable<? extends T> c, Iterable<? extends T> d) {
     ...
     * @since 20.0
     */
    public static <T extends @Nullable Object> FluentIterable<T>
    ...
    private static <T extends @Nullable Object> FluentIterable<T>
        concatNoDefensiveCopy(final Iterable<? extends T>... inputs) {
     ...
     */
    public <T extends @Nullable Object> FluentIterable<T>
