...
public final class NodeFinder {
     ...
     * Otherwise, returns the first node in a preorder traversal of the AST, where the complete node range is covered by
     * the selection.
     * <p>
     * Example: For a {@link SimpleType} whose name is a {@link SimpleName} and a selection that equals both nodes'
     * range,
    ...
    /**
     * Returns the innermost node that fully contains the selection. A node also contains the zero-length selection on
     * either end.
     * <p>
     * If more than one node covers the selection, the returned node is the last covering node found in a preorder
     * traversal of the AST.
     * This implies that for a zero-length selection between two adjacent sibling nodes, the node on the right is
     * returned.
     * </p>
     *
