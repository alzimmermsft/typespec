...
public class ModuleInfo extends ClassFileStruct implements IBinaryModule {
    ...
    class ModuleReferenceInfo implements IModuleReference {
        char[] refName;
        ...
        public boolean equals(Object o) {
            if (this == o)
                return true;
            if (!(o instanceof IModuleReference))
                return false;
            IModuleReference mod = (IModuleReference) o;
    ...
    class PackageExportInfo implements IPackageExport {
        char[] packageName;
        char[][] exportedTo;
        int exportedToCount;
        int modifiers;
    ...
    class ServiceInfo implements IService {
        char[] serviceName;
        char[][] with;
