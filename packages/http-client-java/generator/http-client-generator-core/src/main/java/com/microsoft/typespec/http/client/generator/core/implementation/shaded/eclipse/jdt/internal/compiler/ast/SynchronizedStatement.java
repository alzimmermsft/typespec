...
public class SynchronizedStatement extends StatementWithFinallyBlock { // comes with a hidden finally block that
                                                                       // contains the monitorexit sequence
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        flowInfo = this.block.analyseCode(this.scope, new InsideStatementWithFinallyBlockFlowContext(flowContext, this),
            expressionFlowInfo);
