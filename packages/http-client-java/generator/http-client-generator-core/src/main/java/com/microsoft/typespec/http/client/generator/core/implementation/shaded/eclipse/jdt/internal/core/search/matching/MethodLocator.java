...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.search.MethodDeclarationMatch;
...
public int match(ReferenceExpression node, MatchingNodeSet nodeSet) {
	if (!this.pattern.findReferences) return IMPOSSIBLE_MATCH;
	if (!matchesName(this.pattern.selector, node.selector)) return IMPOSSIBLE_MATCH;
	if (node.selector != null &&  Arrays.equals(node.selector, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.codegen.ConstantPool.Init))
...
/* (non-Javadoc)
 * @see org.eclipse.jdt.internal.core.search.matching.PatternLocator#matchLevelAndReportImportRef(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.ImportReference, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.Binding, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.search.matching.MatchLocator)
...
/**
 * @see org.eclipse.jdt.internal.core.search.matching.PatternLocator#matchReportReference(ASTNode, IJavaElement, Binding, int, MatchLocator)
 */
@Override
...
protected void reportDeclaration(MethodBinding methodBinding, MatchLocator locator, SimpleSet knownMethods) throws CoreException {
	...
	if (type.isBinary()) {
		...
		IBinaryType info = locator.getBinaryInfo((com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.ClassFile)type.getClassFile(), resource);
