...
public interface TagBits {
    ...
    long SealingTypeHierarchy = ASTNode.Bit20; // type, Bit20 used for PauseHierarchyCheck can be re-purposed as
                                               // hierarchy check is complete now
    ...
    long HasTypeVariable = ASTNode.Bit30; // set either for type variables (direct) or parameterized types indirectly
                                          // referencing type variables
    ...
    long AnnotationForDeclarationMASK = AnnotationForModule | AnnotationForPackage | AnnotationForType
        | AnnotationForAnnotationType | AnnotationForField | AnnotationForRecordComponent | AnnotationForMethod
        | AnnotationForConstructor | AnnotationForParameter | AnnotationForTypeParameter | AnnotationForLocalVariable;
    ...
    /** From Java 8 */
    long AnnotationRepeatable = ASTNode.Bit61L; // Only for annotation types and since these cannot have constructors,
                                                // we can overload HasNonPrivateConstructor.
    ...
    long AllStandardAnnotationsMask = AnnotationTargetMASK | AnnotationRetentionMASK | AnnotationDeprecated
        | AnnotationTerminallyDeprecated | AnnotationDocumented | AnnotationInherited | AnnotationOverride
        | AnnotationSuppressWarnings | AnnotationSafeVarargs | AnnotationPolymorphicSignature | AnnotationNullable
        | AnnotationNonNull | AnnotationOwning | AnnotationNotOwning | AnnotationRepeatable;
