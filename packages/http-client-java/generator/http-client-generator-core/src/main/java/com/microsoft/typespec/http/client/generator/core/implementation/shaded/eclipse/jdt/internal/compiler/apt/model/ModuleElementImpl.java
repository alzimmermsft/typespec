...
public class ModuleElementImpl extends ElementImpl implements ModuleElement {
     ...
     * {@link Factory#newElement(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.Binding)}
            ...
            for (String string : restrictions) {
                ...
                if (target != null) {
                    ModuleElement element
                        = ((ModuleElement) ModuleElementImpl.this._env.getFactory().newElement(target));
    ...
    class ExportsDirectiveImpl extends PackageDirectiveImpl implements ModuleElement.ExportsDirective {
        ...
        @Override
        public
            com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.element.ModuleElement.DirectiveKind
            getKind() {
    ...
    class RequiresDirectiveImpl implements ModuleElement.RequiresDirective {
        ...
        public ModuleElement getDependency() {
            return (ModuleElement) ModuleElementImpl.this._env.getFactory()
                .newElement(this.dependency, ElementKind.MODULE);
        }
