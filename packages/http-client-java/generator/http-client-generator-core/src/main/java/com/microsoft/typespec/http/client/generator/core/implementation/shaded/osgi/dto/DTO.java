...
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.dto;
...
public abstract class DTO {
    ...
    private static StringBuilder appendValue(final StringBuilder result, final Map<Object, String> objectRefs,
        ...
        if ("com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.framework.Version"
    ...
    private static CharSequence compress(final CharSequence in) {
        ...
        StringBuilder result = new StringBuilder(MAX_LENGTH).append(in, 0, MAX_LENGTH / 2 - 3)
            .append('.')
            .append('.')
            .append('.')
