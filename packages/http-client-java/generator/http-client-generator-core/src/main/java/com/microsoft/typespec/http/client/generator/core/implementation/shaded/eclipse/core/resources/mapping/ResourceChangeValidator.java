...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.resources.mapping.ChangeDescription;
...
public final class ResourceChangeValidator {
	...
	private IResource[] getRootResources(IResourceDelta root) {
		...
		try {
			root.accept(changeDescription::recordChange);
		} catch (CoreException e) {
