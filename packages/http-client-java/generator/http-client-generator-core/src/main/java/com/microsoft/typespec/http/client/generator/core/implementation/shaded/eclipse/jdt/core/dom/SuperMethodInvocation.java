...
public class SuperMethodInvocation extends Expression {
     ...
     * @since 3.1
     */
    private NodeList typeArguments = null;
     ...
     */
    private final NodeList arguments = new NodeList(ARGUMENTS_PROPERTY);
    ...
    SuperMethodInvocation(AST ast) {
        ...
        if (ast.apiLevel >= AST.JLS3_INTERNAL) {
            this.typeArguments = new NodeList(TYPE_ARGUMENTS_PROPERTY);
        }
    }
    ...
    /**
     * Returns true if the resolved return type has been inferred from the assignment context (JLS3 15.12.2.8), false
     * otherwise.
     * <p>
     * This information is available only when bindings are requested when the AST is being built
     * </p>.
     *
     * @return true if the resolved return type has been inferred from the assignment context (JLS3 15.12.2.8), false
     * otherwise
     * @since 3.3
     */
