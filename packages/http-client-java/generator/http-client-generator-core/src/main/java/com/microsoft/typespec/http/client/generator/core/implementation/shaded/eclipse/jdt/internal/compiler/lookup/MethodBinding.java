...
private TypeBinding makeRawArgument(LookupEnvironment env, TypeVariableBinding var) {
	if (var.boundsCount() <= 1) {
		...
		return env.createWildcard(null, 0, rawFirstBound, rawOtherBounds, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Wildcard.EXTENDS);
	}
}
