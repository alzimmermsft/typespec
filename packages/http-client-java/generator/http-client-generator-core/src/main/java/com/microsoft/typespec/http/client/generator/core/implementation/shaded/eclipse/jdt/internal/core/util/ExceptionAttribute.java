...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.IExceptionAttribute;
...
public class ExceptionAttribute extends ClassFileAttribute implements IExceptionAttribute {
	...
	ExceptionAttribute(byte[] classFileBytes, IConstantPool constantPool, int offset) throws ClassFormatException {
		...
		this.exceptionIndexes = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util.EMPTY_INT_ARRAY;
