...
public class EquinoxLocations {
	...
	private static String getEclipseHomeLocation(String launcher, ConfigValues configValues) {
		...
		String macosx = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi.service.environment.Constants.OS_MACOSX;
	...
	private BasicLocation buildLocation(String property, URL defaultLocation, boolean readOnlyDefault, boolean computeReadOnly, String dataAreaPrefix) {
