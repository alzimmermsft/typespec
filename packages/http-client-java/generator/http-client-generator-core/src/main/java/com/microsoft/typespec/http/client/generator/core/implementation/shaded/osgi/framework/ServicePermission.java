...
public final class ServicePermission extends BasicPermission {
    ...
    private static String createName(ServiceReference<?> reference) {
        ...
        return "(" + Constants.SERVICE_ID + "=" + reference.getProperty(Constants.SERVICE_ID) + ")";
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (action_mask == sp.action_mask)
            ...
            && ((service == sp.service) || ((service != null) && (service.compareTo(sp.service) == 0)));
    }
...
final class ServicePermissionCollection extends PermissionCollection {
    ...
    private synchronized void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        Hashtable<String, ServicePermission> hashtable
            = (Hashtable<String, ServicePermission>) gfields.get("permissions", null);
        permissions = new HashMap<>(hashtable);
        all_allowed = gfields.get("all_allowed", false);
        @SuppressWarnings("unchecked")
        HashMap<String, ServicePermission> fp
            = (HashMap<String, ServicePermission>) gfields.get("filterPermissions", null);
