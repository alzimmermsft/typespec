...
public class JavaSearchParticipant extends SearchParticipant implements IParallelizable {
	...
	public void indexDocument(SearchDocument document, IPath indexPath) {
		...
		if (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(documentPath)) {
		...
		} else if (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util.isClassFileName(documentPath)) {
