...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinDef.LONGLONGByReference;
 ...
 * @see <A HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa373083(v=vs.85).aspx">Performance
 * Counters</A>
 */
public interface Pdh extends StdCallLibrary {
     ...
     * @see <A
     * HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa372578(v=vs.85).aspx">PdhConnectMachine</A>
     */
     ...
     * @return ERROR_SUCCESS if successful
     * @see <A
     * HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa372630(v=vs.85).aspx">PdhGetDllVersion</A>
     */
     ...
     * 
     * @see <A
     * HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa373041(v=vs.85).aspx">PDH_COUNTER_PATH_ELEMENTS</A>
     * @see <A HREF="https://technet.microsoft.com/en-us/library/cc776490(v=ws.10).aspx">Windows Server 2003 Performance
     * Counters Reference</A>
     */
    @FieldOrder({
        "szMachineName",
        "szObjectName",
     ...
     * @see <A
     * HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa372649(v=vs.85).aspx">PdhMakeCounterPath</A>
     */
    int PdhMakeCounterPath(PDH_COUNTER_PATH_ELEMENTS pCounterPathElements, char[] szFullPathBuffer,
        DWORDByReference pcchBufferSize, int dwFlags);
     ...
     * @see <A HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa373193(v=vs.85).aspx">Specifying a
     * Counter Path</A>
     */
     ...
     * @return ERROR_SUCCESS if successful
     * @see <A
     * HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa372665(v=vs.85).aspx">PdhRemoveCounter</A>
     */
     ...
     * 
     * @see <A
     * HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa373060(v=vs.85).aspx">PDH_RAW_COUNTER</A>
     */
     ...
     * @return ERROR_SUCCESS if successful
     * @see <A
     * HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa372644(v=vs.85).aspx">PdhGetRawCounterValue</A>
     */
     ...
     * @return ERROR_SUCCESS if successful
     * @see <A
     * HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa372986(v=vs.85).aspx">PdhValidatePath</A>
     */
     ...
     * @return ERROR_SUCCESS if successful
     * @see <A
     * HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa372563(v=vs.85).aspx">PdhCollectQueryData</A>
     */
     ...
     * {@link Kernel32#CreateEvent(WinBase.SECURITY_ATTRIBUTES, boolean, boolean, String)}
     * function
     * @return ERROR_SUCCESS if successful
     * @see <A
     * HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa372566(v=vs.85).aspx">PdhCollectQueryDataEx</A>
     */
     ...
     * was retrieved. The time is specified as {@link FILETIME}.
     * @return ERROR_SUCCESS if successful
     * @see <A
     * HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa372569(v=vs.85).aspx">PdhCollectQueryDataWithTime</A>
     */
     ...
     * @return ERROR_SUCCESS if successful
     * @see <A
     * HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa372677(v=vs.85).aspx">PdhSetQueryTimeRange</A>
     */
