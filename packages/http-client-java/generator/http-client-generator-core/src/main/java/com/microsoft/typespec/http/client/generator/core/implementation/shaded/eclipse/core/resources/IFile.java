...
public interface IFile extends IResource, IEncodedStorage, IAdaptable {
	 ...
	 * @since 3.21
	 */
	default void create(byte[] content, boolean force, boolean derived, IProgressMonitor monitor)
	 ...
	 * @since 3.21
	 */
	default void create(byte[] content, int createFlags, IProgressMonitor monitor) throws CoreException {
	 ...
	 * @since 3.21
	 */
	default void write(byte[] content, boolean force, boolean derived, boolean keepHistory, IProgressMonitor monitor) throws CoreException {
	 ...
	 * @exception OperationCanceledException if the operation is canceled.
	 * Cancelation can occur even if no progress monitor is provided.
	 * @see #setContents(InputStream,int,IProgressMonitor)
	 */
	 ...
	 * @since 3.21
	 */
	default void setContents(byte[] content, boolean force, boolean keepHistory, IProgressMonitor monitor)
			throws CoreException {
	 ...
	 * @since 3.21
	 */
	default void setContents(byte[] content, int updateFlags, IProgressMonitor monitor) throws CoreException {
