...
public interface Logger
    extends com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.log.Logger {
    /**
     ...
     *
     * @param level The log level or severity of the message.
     * @return <code>boolean</code> True if there a LogListener listening that can handle a log entry for this log
