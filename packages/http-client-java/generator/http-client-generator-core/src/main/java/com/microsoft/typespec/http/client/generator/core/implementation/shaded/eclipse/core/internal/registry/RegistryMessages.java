...
public class RegistryMessages extends NLS {
	 ...
	 */
	public static final String OWNER_NAME = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.equinox.registry"; //$NON-NLS-1$

	private static final String BUNDLE_NAME = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.registry.messages"; //$NON-NLS-1$
