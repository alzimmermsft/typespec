...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.filesystem.*;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.filesystem.local.Convert;
...
public abstract class UnixFileNatives {
    ...
    public static int getSupportedAttributes() {
        ...
        int ret = EFS.ATTRIBUTE_READ_ONLY | EFS.ATTRIBUTE_EXECUTABLE | EFS.ATTRIBUTE_SYMLINK | EFS.ATTRIBUTE_LINK_TARGET
