...
public class CodeSnippetAllocationExpression extends AllocationExpression
    ...
    public void generateCode(BlockScope currentScope, CodeStream codeStream, boolean valueRequired) {
        ...
        if (codegenBinding.canBeSeenBy(allocatedType, this, currentScope)) {
            ...
            if (allocatedType.isNestedType()) {
                codeStream.generateSyntheticEnclosingInstanceValues(currentScope, allocatedType, enclosingInstance(),
                    this);
            }
    ...
    public TypeBinding resolveType(BlockScope scope) {
        ...
        this.resolvedType = this.type.resolveType(scope, true /* check bounds */); // will check for null after args are
                                                                                   // resolved
        ...
        if (isDiamond) {
            ...
            this.resolvedType = this.type.resolvedType = scope.environment()
                .createParameterizedType(((ParameterizedTypeBinding) this.resolvedType).genericType(), inferredTypes,
        ...
        if (!this.binding.isValidBinding()) {
            if (this.binding instanceof ProblemMethodBinding
                ...
                MethodBinding privateBinding
                    = localScope.getConstructor((ReferenceBinding) this.delegateThis.type, this.argumentTypes, this);
        ...
        if (this.arguments != null) {
            ...
            if (this.argsContainCast) {
                CastExpression.checkNeedForArgumentCasts(scope, null, allocatedType, this.binding, this.arguments,
