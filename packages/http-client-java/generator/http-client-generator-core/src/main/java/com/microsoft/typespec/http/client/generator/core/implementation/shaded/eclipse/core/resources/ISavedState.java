...
/**
 * A data structure returned by {@link IWorkspace#addSaveParticipant(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.Plugin, ISaveParticipant)}
 * containing a save number and an optional resource delta.
 *
 * @see IWorkspace#addSaveParticipant(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.Plugin, ISaveParticipant)
