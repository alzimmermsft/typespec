...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi.storage.url.bundleresource.Handler;
...
abstract public class BundleFile {
	...
	/**
	 * Returns a URL to access the contents of the entry specified by the path. This
	 * method first calls {@link #getEntry(String)} to locate the entry at the
	 * specified path. If no entry is found {@code null} is returned; otherwise
	 * {@link #createResourceURL(BundleEntry, Module, int, String)} is called in
	 * order to create the URL. Subclasses should not override this method. Instead
