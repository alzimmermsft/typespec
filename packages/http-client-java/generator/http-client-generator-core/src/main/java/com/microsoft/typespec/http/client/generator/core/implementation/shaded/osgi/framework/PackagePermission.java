...
public final class PackagePermission extends BasicPermission {
    ...
    public boolean equals(Object obj) {
        ...
        return (action_mask == pp.action_mask)
            ...
            && ((bundle == pp.bundle) || ((bundle != null) && bundle.equals(pp.bundle)));
    }
...
final class PackagePermissionCollection extends PermissionCollection {
    ...
    private synchronized void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        Hashtable<String, PackagePermission> hashtable
            = (Hashtable<String, PackagePermission>) gfields.get("permissions", null);
        permissions = new HashMap<String, PackagePermission>(hashtable);
        all_allowed = gfields.get("all_allowed", false);
        @SuppressWarnings("unchecked")
        HashMap<String, PackagePermission> fp
            = (HashMap<String, PackagePermission>) gfields.get("filterPermissions", null);
