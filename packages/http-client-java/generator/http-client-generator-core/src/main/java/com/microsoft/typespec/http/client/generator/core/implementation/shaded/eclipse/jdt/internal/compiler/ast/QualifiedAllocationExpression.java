...
public class QualifiedAllocationExpression extends AllocationExpression {
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        if (this.enclosingInstance != null) {
            ...
            if (this.binding != null && this.binding.declaringClass != null) {
                ...
                if (superclass != null && superclass.isMemberType() && !superclass.isStatic()) {
                    // creating an anonymous type of a non-static member type without an enclosing instance of parent
                    // type
                    currentScope.tagAsAccessingEnclosingInstanceStateOf(superclass.enclosingType(),
        ...
        checkCapturedLocalInitializationIfNecessary((ReferenceBinding) (this.anonymousType == null
            ? this.binding.declaringClass.erasure()
            : this.binding.declaringClass.superclass().erasure()), currentScope, flowInfo);
        ...
        if ((flowInfo.tagBits & FlowInfo.UNREACHABLE_OR_DEAD) == 0) {
            ...
            if (allocatedTypeErasure.isNestedType()
                ...
                if (allocatedTypeErasure.isLocalType()) {
                    ((LocalTypeBinding) allocatedTypeErasure).addInnerEmulationDependent(currentScope,
    ...
    private TypeBinding resolveTypeForQualifiedAllocationExpression(BlockScope scope) {
        ...
        if (this.constant != Constant.NotAConstant) {
            ...
            if (this.enclosingInstance != null) {
                ...
                if ((enclosingInstanceType = this.enclosingInstance.resolveType(scope)) == null) {
                    ...
                    scope.problemReporter()
                        .illegalPrimitiveOrArrayTypeForEnclosingInstance(enclosingInstanceType, this.enclosingInstance);
                    hasError = true;
                    ...
                    enclosingInstanceType = new ProblemReferenceBinding(enclosingInstanceReference.compoundName,
                        enclosingInstanceReference, ProblemReasons.NotVisible);
                    scope.problemReporter().invalidType(this.enclosingInstance, enclosingInstanceType);
                    hasError = true;
                } else {
                    this.resolvedType = receiverType = ((SingleTypeReference) this.type).resolveTypeEnclosing(scope,
                        (ReferenceBinding) enclosingInstanceType);
                    checkIllegalNullAnnotation(scope, receiverType);
                    if (receiverType != null && enclosingInstanceContainsCast) {
                        CastExpression.checkNeedForEnclosingInstanceCast(scope, this.enclosingInstance,
                            enclosingInstanceType, receiverType);
                    }
                }
            } else {
                if (this.type == null) {
            ...
            if (hasError) {
                /*
                 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=345359, if arguments have errors, completely bail out
                 * in the <> case.
            ...
            if (this.anonymousType == null) {
                ...
                if (superType.isTypeVariable()) {
                    superType = new ProblemReferenceBinding(new char[][] { superType.sourceName() }, superType,
        ...
        if (isDiamond) {
            ...
            if (this.anonymousType != null) {
                ...
                if (this.binding.isVarargs()) {
                    TypeBinding lastArg
                        = this.binding.parameters[this.binding.parameters.length - 1].leafComponentType();
            ...
            if (this.anonymousType != null) {
                ...
                this.binding = constructorBinding
                    = findConstructorBinding(scope, this, (ReferenceBinding) receiverType, this.argumentTypes);
            }
        }
        ...
        if (constructorBinding.isValidBinding()) {
            ...
            if (checkInvocationArguments(scope, null, superType, constructorBinding, this.arguments, this.argumentTypes,
                this.argsContainCast, this)) {
                this.bits |= ASTNode.Unchecked;
            }
            if (this.typeArguments != null
                && constructorBinding.original().typeVariables == Binding.NO_TYPE_VARIABLES) {
                scope.problemReporter()
                    .unnecessaryTypeArgumentsForMethodInvocation(constructorBinding, this.genericTypeArguments,
                        this.typeArguments);
            }
        } else {
        ...
        if (this.enclosingInstance != null) {
            ReferenceBinding targetEnclosing
                = !constructorBinding.declaringClass.isNestedType() || constructorBinding.declaringClass.isStatic()
                    ? null
                    : constructorBinding.declaringClass.enclosingType();
            if (targetEnclosing == null) {
                ...
                scope.problemReporter()
                    .typeMismatchError(enclosingInstanceType, targetEnclosing, this.enclosingInstance, null);
                return this.resolvedType;
            }
            this.enclosingInstance.computeConversion(scope, targetEnclosing, enclosingInstanceType);
        }
        if (!isDiamond
            && receiverType.isParameterizedTypeWithActualArguments()
        ...
        if (this.anonymousType != null) {
            ...
            this.binding = this.anonymousType.createDefaultConstructorWithBinding(constructorBinding,
    ...
    private boolean validate(final ParameterizedTypeBinding allocationType, final Scope scope) {
        class ValidityInspector extends TypeBindingVisitor {
            ...
            public boolean visit(IntersectionTypeBinding18 intersectionTypeBinding18) {
                ...
                scope.problemReporter()
                    .anonymousDiamondWithNonDenotableTypeArguments(QualifiedAllocationExpression.this.type,
                        allocationType);
            ...
            public boolean visit(ReferenceBinding ref) {
                if (!ref.canBeSeenBy(scope)) {
                    scope.problemReporter()
                        .invalidType(QualifiedAllocationExpression.this.anonymousType,
                            new ProblemReferenceBinding(ref.compoundName, ref, ProblemReasons.NotVisible));
