...
public class KeyToSignature extends BindingKeyParser {
    ...
    /*
     * Substitutes the type variables referenced in the given parameter (a parameterized type signature) with the
     * corresponding
     * type argument.
    ...
    public void consumeType() {
        ...
        if (length > 0) {
            ...
            for (int i = 0; i < length; i++) {
                char[] typeParameterSig = Signature.createTypeParameterSignature((char[]) this.typeParameters.get(i),
