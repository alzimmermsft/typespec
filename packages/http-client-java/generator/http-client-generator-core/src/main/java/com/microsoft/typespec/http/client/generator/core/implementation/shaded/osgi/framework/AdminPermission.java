 ...
 * 
 * @ThreadSafe
 * @author $Id: 01495a0cc5cce6df4ddf73583bf0bc3d8ddc5a71 $
 */
...
public final class AdminPermission extends BasicPermission {
    ...
    private final static int ACTION_ALL
        = ACTION_CLASS | ACTION_EXECUTE | ACTION_LIFECYCLE | ACTION_LISTENER | ACTION_METADATA | ACTION_RESOLVE
    ...
    public boolean equals(Object obj) {
        ...
        return (action_mask == ap.action_mask)
            && ((bundle == ap.bundle) || ((bundle != null) && bundle.equals(ap.bundle)))
            && (filter == null ? ap.filter == null : filter.equals(ap.filter));
    }
...
final class AdminPermissionCollection extends PermissionCollection {
    ...
    private synchronized void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        Hashtable<String, AdminPermission> hashtable
            = (Hashtable<String, AdminPermission>) gfields.get("permissions", null);
