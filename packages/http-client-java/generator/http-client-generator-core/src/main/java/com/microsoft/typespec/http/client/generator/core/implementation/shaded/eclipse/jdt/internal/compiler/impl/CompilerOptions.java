 ...
 *******************************************************************************/
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.impl;
...
public class CompilerOptions {
    ...
    public static final String OPTION_LocalVariableAttribute
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.debug.localVariable"; //$NON-NLS-1$
    public static final String OPTION_LineNumberAttribute
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.debug.lineNumber"; //$NON-NLS-1$
    public static final String OPTION_SourceFileAttribute
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.debug.sourceFile"; //$NON-NLS-1$
    public static final String OPTION_PreserveUnusedLocal
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.codegen.unusedLocal"; //$NON-NLS-1$
    public static final String OPTION_MethodParametersAttribute
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.codegen.methodParameters"; //$NON-NLS-1$
    public static final String OPTION_LambdaGenericSignature
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.codegen.lambda.genericSignature"; //$NON-NLS-1$
    public static final String OPTION_DocCommentSupport
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.doc.comment.support"; //$NON-NLS-1$
    public static final String OPTION_ReportMethodWithConstructorName
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.methodWithConstructorName"; //$NON-NLS-1$
    public static final String OPTION_ReportOverridingPackageDefaultMethod
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.overridingPackageDefaultMethod"; //$NON-NLS-1$
    public static final String OPTION_ReportDeprecation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.deprecation"; //$NON-NLS-1$
    public static final String OPTION_ReportTerminalDeprecation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.terminalDeprecation"; //$NON-NLS-1$
    public static final String OPTION_ReportDeprecationInDeprecatedCode
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.deprecationInDeprecatedCode"; //$NON-NLS-1$
    public static final String OPTION_ReportDeprecationWhenOverridingDeprecatedMethod
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.deprecationWhenOverridingDeprecatedMethod"; //$NON-NLS-1$
    public static final String OPTION_ReportHiddenCatchBlock
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.hiddenCatchBlock"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedLocal
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedLocal"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedLambdaParameter
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedLambdaParameter"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedParameter
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedParameter"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedExceptionParameter
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedExceptionParameter"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedParameterWhenImplementingAbstract
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedParameterWhenImplementingAbstract"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedParameterWhenOverridingConcrete
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedParameterWhenOverridingConcrete"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedParameterIncludeDocCommentReference
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedParameterIncludeDocCommentReference"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedImport
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedImport"; //$NON-NLS-1$
    public static final String OPTION_ReportSyntheticAccessEmulation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.syntheticAccessEmulation"; //$NON-NLS-1$
    public static final String OPTION_ReportNoEffectAssignment
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.noEffectAssignment"; //$NON-NLS-1$
    public static final String OPTION_ReportLocalVariableHiding
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.localVariableHiding"; //$NON-NLS-1$
    public static final String OPTION_ReportSpecialParameterHidingField
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.specialParameterHidingField"; //$NON-NLS-1$
    public static final String OPTION_ReportFieldHiding
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.fieldHiding"; //$NON-NLS-1$
    public static final String OPTION_ReportTypeParameterHiding
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.typeParameterHiding"; //$NON-NLS-1$
    public static final String OPTION_ReportPossibleAccidentalBooleanAssignment
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.possibleAccidentalBooleanAssignment"; //$NON-NLS-1$
    public static final String OPTION_ReportNonExternalizedStringLiteral
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.nonExternalizedStringLiteral"; //$NON-NLS-1$
    public static final String OPTION_ReportIncompatibleNonInheritedInterfaceMethod
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.incompatibleNonInheritedInterfaceMethod"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedPrivateMember
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedPrivateMember"; //$NON-NLS-1$
    public static final String OPTION_ReportNoImplicitStringConversion
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.noImplicitStringConversion"; //$NON-NLS-1$
    public static final String OPTION_ReportAssertIdentifier
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.assertIdentifier"; //$NON-NLS-1$
    public static final String OPTION_ReportEnumIdentifier
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.enumIdentifier"; //$NON-NLS-1$
    public static final String OPTION_ReportNonStaticAccessToStatic
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.staticAccessReceiver"; //$NON-NLS-1$
    public static final String OPTION_ReportIndirectStaticAccess
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.indirectStaticAccess"; //$NON-NLS-1$
    public static final String OPTION_ReportEmptyStatement
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.emptyStatement"; //$NON-NLS-1$
    public static final String OPTION_ReportUnnecessaryTypeCheck
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unnecessaryTypeCheck"; //$NON-NLS-1$
    public static final String OPTION_ReportUnnecessaryElse
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unnecessaryElse"; //$NON-NLS-1$
    public static final String OPTION_ReportUndocumentedEmptyBlock
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.undocumentedEmptyBlock"; //$NON-NLS-1$
    public static final String OPTION_ReportInvalidJavadoc
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.invalidJavadoc"; //$NON-NLS-1$
    public static final String OPTION_ReportInvalidJavadocTags
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.invalidJavadocTags"; //$NON-NLS-1$
    public static final String OPTION_ReportInvalidJavadocTagsDeprecatedRef
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.invalidJavadocTagsDeprecatedRef"; //$NON-NLS-1$
    public static final String OPTION_ReportInvalidJavadocTagsNotVisibleRef
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.invalidJavadocTagsNotVisibleRef"; //$NON-NLS-1$
    public static final String OPTION_ReportInvalidJavadocTagsVisibility
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.invalidJavadocTagsVisibility"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingJavadocTags
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingJavadocTags"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingJavadocTagsVisibility
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingJavadocTagsVisibility"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingJavadocTagsOverriding
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingJavadocTagsOverriding"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingJavadocTagsMethodTypeParameters
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingJavadocTagsMethodTypeParameters"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingJavadocComments
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingJavadocComments"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingJavadocTagDescription
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingJavadocTagDescription"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingJavadocCommentsVisibility
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingJavadocCommentsVisibility"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingJavadocCommentsOverriding
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingJavadocCommentsOverriding"; //$NON-NLS-1$
    public static final String OPTION_ReportFinallyBlockNotCompletingNormally
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.finallyBlockNotCompletingNormally"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedDeclaredThrownException
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedDeclaredThrownException"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedDeclaredThrownExceptionWhenOverriding
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedDeclaredThrownExceptionWhenOverriding"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedDeclaredThrownExceptionIncludeDocCommentReference
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedDeclaredThrownExceptionIncludeDocCommentReference"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedDeclaredThrownExceptionExemptExceptionAndThrowable
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedDeclaredThrownExceptionExemptExceptionAndThrowable"; //$NON-NLS-1$
    public static final String OPTION_ReportUnqualifiedFieldAccess
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unqualifiedFieldAccess"; //$NON-NLS-1$
    public static final String OPTION_ReportUnavoidableGenericTypeProblems
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unavoidableGenericTypeProblems"; //$NON-NLS-1$
    public static final String OPTION_ReportUncheckedTypeOperation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.uncheckedTypeOperation"; //$NON-NLS-1$
    public static final String OPTION_ReportRawTypeReference
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.rawTypeReference"; //$NON-NLS-1$
    public static final String OPTION_ReportFinalParameterBound
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.finalParameterBound"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingSerialVersion
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingSerialVersion"; //$NON-NLS-1$
    public static final String OPTION_ReportVarargsArgumentNeedCast
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.varargsArgumentNeedCast"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedTypeArgumentsForMethodInvocation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedTypeArgumentsForMethodInvocation"; //$NON-NLS-1$
    public static final String OPTION_Source
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.source"; //$NON-NLS-1$
    public static final String OPTION_TargetPlatform
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.codegen.targetPlatform"; //$NON-NLS-1$
    public static final String OPTION_Compliance
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.compliance"; //$NON-NLS-1$
    public static final String OPTION_Release
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.release"; //$NON-NLS-1$
    public static final String OPTION_Encoding
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.encoding"; //$NON-NLS-1$
    public static final String OPTION_MaxProblemPerUnit
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.maxProblemPerUnit"; //$NON-NLS-1$
    public static final String OPTION_TaskTags
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.taskTags"; //$NON-NLS-1$
    public static final String OPTION_TaskPriorities
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.taskPriorities"; //$NON-NLS-1$
    public static final String OPTION_TaskCaseSensitive
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.taskCaseSensitive"; //$NON-NLS-1$
    public static final String OPTION_ShareCommonFinallyBlocks
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.codegen.shareCommonFinallyBlocks"; //$NON-NLS-1$
    public static final String OPTION_ReportNullReference
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.nullReference"; //$NON-NLS-1$
    public static final String OPTION_ReportPotentialNullReference
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.potentialNullReference"; //$NON-NLS-1$
    public static final String OPTION_ReportRedundantNullCheck
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.redundantNullCheck"; //$NON-NLS-1$
    public static final String OPTION_ReportAutoboxing
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.autoboxing"; //$NON-NLS-1$
    public static final String OPTION_ReportAnnotationSuperInterface
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.annotationSuperInterface"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingOverrideAnnotation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingOverrideAnnotation"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingOverrideAnnotationForInterfaceMethodImplementation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingOverrideAnnotationForInterfaceMethodImplementation"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingDeprecatedAnnotation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingDeprecatedAnnotation"; //$NON-NLS-1$
    public static final String OPTION_ReportIncompleteEnumSwitch
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.incompleteEnumSwitch"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingEnumCaseDespiteDefault
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingEnumCaseDespiteDefault"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingDefaultCase
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingDefaultCase"; //$NON-NLS-1$
    public static final String OPTION_ReportForbiddenReference
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.forbiddenReference"; //$NON-NLS-1$
    public static final String OPTION_ReportDiscouragedReference
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.discouragedReference"; //$NON-NLS-1$
    public static final String OPTION_SuppressWarnings
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.suppressWarnings"; //$NON-NLS-1$
    public static final String OPTION_SuppressOptionalErrors
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.suppressOptionalErrors"; //$NON-NLS-1$
    public static final String OPTION_ReportUnhandledWarningToken
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unhandledWarningToken"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedTypeParameter
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedTypeParameter"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedWarningToken
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedWarningToken"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedLabel
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedLabel"; //$NON-NLS-1$
    public static final String OPTION_FatalOptionalError
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.fatalOptionalError"; //$NON-NLS-1$
    public static final String OPTION_ReportParameterAssignment
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.parameterAssignment"; //$NON-NLS-1$
    public static final String OPTION_ReportFallthroughCase
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.fallthroughCase"; //$NON-NLS-1$
    public static final String OPTION_ReportOverridingMethodWithoutSuperInvocation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.overridingMethodWithoutSuperInvocation"; //$NON-NLS-1$
    public static final String OPTION_GenerateClassFiles
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.generateClassFiles"; //$NON-NLS-1$
    public static final String OPTION_Process_Annotations
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.processAnnotations"; //$NON-NLS-1$
    // OPTION_Store_Annotations: undocumented option for testing purposes
    public static final String OPTION_Store_Annotations
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.storeAnnotations"; //$NON-NLS-1$
    public static final String OPTION_EmulateJavacBug8031744
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.emulateJavacBug8031744"; //$NON-NLS-1$
    public static final String OPTION_ReportRedundantSuperinterface
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.redundantSuperinterface"; //$NON-NLS-1$
    public static final String OPTION_ReportComparingIdentical
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.comparingIdentical"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingSynchronizedOnInheritedMethod
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingSynchronizedOnInheritedMethod"; //$NON-NLS-1$
    public static final String OPTION_ReportMissingHashCodeMethod
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.missingHashCodeMethod"; //$NON-NLS-1$
    public static final String OPTION_ReportDeadCode
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.deadCode"; //$NON-NLS-1$
    public static final String OPTION_ReportDeadCodeInTrivialIfStatement
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.deadCodeInTrivialIfStatement"; //$NON-NLS-1$
    public static final String OPTION_ReportTasks
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.tasks"; //$NON-NLS-1$
    public static final String OPTION_ReportUnusedObjectAllocation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unusedObjectAllocation";  //$NON-NLS-1$
    public static final String OPTION_IncludeNullInfoFromAsserts
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.includeNullInfoFromAsserts";  //$NON-NLS-1$
    public static final String OPTION_ReportMethodCanBeStatic
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.reportMethodCanBeStatic";  //$NON-NLS-1$
    public static final String OPTION_ReportMethodCanBePotentiallyStatic
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.reportMethodCanBePotentiallyStatic";  //$NON-NLS-1$
    public static final String OPTION_ReportRedundantSpecificationOfTypeArguments
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.redundantSpecificationOfTypeArguments"; //$NON-NLS-1$

    // resource leak analysis:
    public static final String OPTION_ReportUnclosedCloseable
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unclosedCloseable"; //$NON-NLS-1$
    public static final String OPTION_ReportPotentiallyUnclosedCloseable
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.potentiallyUnclosedCloseable"; //$NON-NLS-1$
    public static final String OPTION_ReportExplicitlyClosedAutoCloseable
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.explicitlyClosedAutoCloseable"; //$NON-NLS-1$
    public static final String OPTION_ReportInsufficientResourceManagement
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.insufficientResourceAnalysis"; //$NON-NLS-1$
    public static final String OPTION_ReportIncompatibleOwningContract
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.incompatibleOwningContract"; //$NON-NLS-1$
    public static final String OPTION_AnnotationBasedResourceAnalysis
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.annotation.resourceanalysis"; //$NON-NLS-1$
    public static final String OPTION_OwningAnnotationName
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.annotation.owning"; //$NON-NLS-1$
    public static final String OPTION_NotOwningAnnotationName
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.annotation.notowning"; //$NON-NLS-1$
    static final char[][] DEFAULT_OWNING_ANNOTATION_NAME = CharOperation.splitOn('.',
        "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.annotation.Owning" //$NON-NLS-1$
            .toCharArray());
    static final char[][] DEFAULT_NOTOWNING_ANNOTATION_NAME = CharOperation.splitOn('.',
        "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.annotation.NotOwning" //$NON-NLS-1$
            .toCharArray());

    public static final String OPTION_ReportNullSpecViolation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.nullSpecViolation";  //$NON-NLS-1$
    public static final String OPTION_ReportNullAnnotationInferenceConflict
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.nullAnnotationInferenceConflict";  //$NON-NLS-1$
    public static final String OPTION_ReportNullUncheckedConversion
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.nullUncheckedConversion";  //$NON-NLS-1$
    public static final String OPTION_ReportRedundantNullAnnotation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.redundantNullAnnotation";  //$NON-NLS-1$
    public static final String OPTION_AnnotationBasedNullAnalysis
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.annotation.nullanalysis"; //$NON-NLS-1$
    public static final String OPTION_NullableAnnotationName
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.annotation.nullable"; //$NON-NLS-1$
    public static final String OPTION_NonNullAnnotationName
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.annotation.nonnull"; //$NON-NLS-1$
    public static final String OPTION_NonNullByDefaultAnnotationName
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.annotation.nonnullbydefault"; //$NON-NLS-1$
    public static final String OPTION_NullableAnnotationSecondaryNames
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.annotation.nullable.secondary"; //$NON-NLS-1$
    public static final String OPTION_NonNullAnnotationSecondaryNames
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.annotation.nonnull.secondary"; //$NON-NLS-1$
    public static final String OPTION_NonNullByDefaultAnnotationSecondaryNames
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.annotation.nonnullbydefault.secondary"; //$NON-NLS-1$
    public static final String OPTION_ReportUninternedIdentityComparison
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.uninternedIdentityComparison"; //$NON-NLS-1$
    // defaults for the above:
    static final char[][] DEFAULT_NULLABLE_ANNOTATION_NAME = CharOperation.splitOn('.',
        "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.annotation.Nullable" //$NON-NLS-1$
            .toCharArray());
    static final char[][] DEFAULT_NONNULL_ANNOTATION_NAME = CharOperation.splitOn('.',
        "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.annotation.NonNull" //$NON-NLS-1$
            .toCharArray());
    static final char[][] DEFAULT_NONNULLBYDEFAULT_ANNOTATION_NAME = CharOperation.splitOn('.',
        "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.annotation.NonNullByDefault" //$NON-NLS-1$
            .toCharArray());
    public static final String OPTION_ReportMissingNonNullByDefaultAnnotation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.annotation.missingNonNullByDefaultAnnotation";  //$NON-NLS-1$
    public static final String OPTION_SyntacticNullAnalysisForFields
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.syntacticNullAnalysisForFields"; //$NON-NLS-1$
    public static final String OPTION_InheritNullAnnotations
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.annotation.inheritNullAnnotations";  //$NON-NLS-1$
    public static final String OPTION_ReportNonnullParameterAnnotationDropped
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.nonnullParameterAnnotationDropped";  //$NON-NLS-1$
    public static final String OPTION_PessimisticNullAnalysisForFreeTypeVariables
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.pessimisticNullAnalysisForFreeTypeVariables";  //$NON-NLS-1$
    public static final String OPTION_ReportNonNullTypeVariableFromLegacyInvocation
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.nonnullTypeVariableFromLegacyInvocation"; //$NON-NLS-1$
    public static final String OPTION_ReportAnnotatedTypeArgumentToUnannotated
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.annotatedTypeArgumentToUnannotated"; //$NON-NLS-1$

    public static final String OPTION_ReportUnlikelyCollectionMethodArgumentType
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unlikelyCollectionMethodArgumentType"; //$NON-NLS-1$
    public static final String OPTION_ReportUnlikelyCollectionMethodArgumentTypeStrict
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unlikelyCollectionMethodArgumentTypeStrict"; //$NON-NLS-1$
    public static final String OPTION_ReportUnlikelyEqualsArgumentType
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unlikelyEqualsArgumentType"; //$NON-NLS-1$

    public static final String OPTION_ReportAPILeak
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.APILeak"; //$NON-NLS-1$
    public static final String OPTION_ReportUnstableAutoModuleName
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.unstableAutoModuleName";   //$NON-NLS-1$

    public static final String OPTION_EnablePreviews
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.enablePreviewFeatures"; //$NON-NLS-1$
    public static final String OPTION_ReportPreviewFeatures
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.reportPreviewFeatures"; //$NON-NLS-1$

    public static final String OPTION_ReportSuppressWarningNotFullyAnalysed
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.problem.suppressWarningsNotFullyAnalysed";  //$NON-NLS-1$
    ...
    public static final String OPTION_JdtDebugCompileMode
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.debug.compile.mode"; //$NON-NLS-1$

    public static final String OPTION_IgnoreUnnamedModuleForSplitPackage
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.ignoreUnnamedModuleForSplitPackage"; //$NON-NLS-1$

    public static final String OPTION_UseStringConcatFactory
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.codegen.useStringConcatFactory"; //$NON-NLS-1$

    public static final String OPTION_validateOperandStack
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.codegen.validateOperandStack"; //$NON-NLS-1$
    /**
     ...
     */
    public static Set<String> UNSUPPORTED_VERSIONS = Set.of(VERSION_1_1, VERSION_1_2, VERSION_1_3, VERSION_1_4,
        VERSION_JSR14, VERSION_CLDC1_1, VERSION_1_5, VERSION_1_6, VERSION_1_7);
    ...
    /**
     * Specify if need to report missing override annotation for a method implementing an interface method (java 1.6 and
     * above)
     */
    ...
    /**
     * When checking for unlikely argument types of of Map.get() et al, perform strict analysis against the expected
     * type
     */
    ...
    /**
     * Should the compiler ignore the unnamed module when a package is defined in both a named module and the unnamed
     * module?
     */
    ...
    /**
     * Return the most specific option key controlling this irritant. Note that in some case, some irritant is
     * controlled by
    ...
    public static String optionKeyFromIrritant(int irritant) {
        ...
        return switch (irritant) {
            ...
            case UsingTerminallyDeprecatedAPI, (InvalidJavadoc
                | UsingTerminallyDeprecatedAPI) -> OPTION_ReportTerminalDeprecation;
    ...
    public static IrritantSet warningTokenToIrritants(String warningToken) {
        ...
        if (warningToken == null || warningToken.isEmpty())
            return null;
    ...
    public Map<String, String> getMap() {
        ...
        optionsMap.put(OPTION_LocalVariableAttribute,
            (this.produceDebugAttributes & ClassFileConstants.ATTR_VARS) != 0 ? GENERATE : DO_NOT_GENERATE);
        optionsMap.put(OPTION_LineNumberAttribute,
            (this.produceDebugAttributes & ClassFileConstants.ATTR_LINES) != 0 ? GENERATE : DO_NOT_GENERATE);
        optionsMap.put(OPTION_SourceFileAttribute,
            (this.produceDebugAttributes & ClassFileConstants.ATTR_SOURCE) != 0 ? GENERATE : DO_NOT_GENERATE);
        optionsMap.put(OPTION_MethodParametersAttribute, this.produceMethodParameters ? GENERATE : DO_NOT_GENERATE);
        optionsMap.put(OPTION_LambdaGenericSignature,
            this.generateGenericSignatureForLambdaExpressions ? GENERATE : DO_NOT_GENERATE);
        ...
        optionsMap.put(OPTION_ReportDeprecationInDeprecatedCode,
            this.reportDeprecationInsideDeprecatedCode ? ENABLED : DISABLED);
        ...
        optionsMap.put(OPTION_ReportMissingEnumCaseDespiteDefault,
            this.reportMissingEnumCaseDespiteDefault ? ENABLED : DISABLED);
        ...
        optionsMap.put(OPTION_ReportInvalidJavadocTagsDeprecatedRef,
            this.reportInvalidJavadocTagsDeprecatedRef ? ENABLED : DISABLED);
        optionsMap.put(OPTION_ReportInvalidJavadocTagsNotVisibleRef,
            this.reportInvalidJavadocTagsNotVisibleRef ? ENABLED : DISABLED);
        ...
        optionsMap.put(OPTION_ReportMissingJavadocTagsMethodTypeParameters,
        ...
        optionsMap.put(OPTION_ReportMissingJavadocCommentsVisibility,
        ...
        optionsMap.put(OPTION_ReportMissingJavadocCommentsOverriding,
            this.reportMissingJavadocCommentsOverriding ? ENABLED : DISABLED);
        ...
        optionsMap.put(OPTION_ReportUnusedDeclaredThrownExceptionWhenOverriding,
            this.reportUnusedDeclaredThrownExceptionWhenOverriding ? ENABLED : DISABLED);
        optionsMap.put(OPTION_ReportUnusedDeclaredThrownExceptionIncludeDocCommentReference,
            this.reportUnusedDeclaredThrownExceptionIncludeDocCommentReference ? ENABLED : DISABLED);
        optionsMap.put(OPTION_ReportUnusedDeclaredThrownExceptionExemptExceptionAndThrowable,
            this.reportUnusedDeclaredThrownExceptionExemptExceptionAndThrowable ? ENABLED : DISABLED);
        optionsMap.put(OPTION_ReportUnqualifiedFieldAccess, getSeverityString(UnqualifiedFieldAccess));
        optionsMap.put(OPTION_ReportUnavoidableGenericTypeProblems,
            this.reportUnavoidableGenericTypeProblems ? ENABLED : DISABLED);
        ...
        optionsMap.put(OPTION_ReportMissingOverrideAnnotationForInterfaceMethodImplementation,
        ...
        optionsMap.put(OPTION_TaskTags,
            this.taskTags == null ? Util.EMPTY_STRING : new String(CharOperation.concatWith(this.taskTags, ',')));
        optionsMap.put(OPTION_TaskPriorities,
            this.taskPriorities == null
                ? Util.EMPTY_STRING
                : new String(CharOperation.concatWith(this.taskPriorities, ',')));
        ...
        optionsMap.put(OPTION_ReportUnusedParameterIncludeDocCommentReference,
        ...
        optionsMap.put(OPTION_ReportOverridingMethodWithoutSuperInvocation,
            getSeverityString(OverridingMethodWithoutSuperInvocation));
        ...
        optionsMap.put(OPTION_ReportMissingSynchronizedOnInheritedMethod,
            getSeverityString(MissingSynchronizedModifierInInheritedMethod));
        ...
        optionsMap.put(OPTION_ReportDeadCodeInTrivialIfStatement,
            this.reportDeadCodeInTrivialIfStatement ? ENABLED : DISABLED);
        ...
        optionsMap.put(OPTION_ReportRedundantSpecificationOfTypeArguments,
            getSeverityString(RedundantSpecificationOfTypeArguments));
        ...
        optionsMap.put(OPTION_AnnotationBasedResourceAnalysis,
            this.isAnnotationBasedResourceAnalysisEnabled ? ENABLED : DISABLED);
        optionsMap.put(OPTION_OwningAnnotationName,
            String.valueOf(CharOperation.concatWith(this.owningAnnotationName, '.')));
        optionsMap.put(OPTION_NotOwningAnnotationName,
            String.valueOf(CharOperation.concatWith(this.notOwningAnnotationName, '.')));

        // null analysis:
        optionsMap.put(OPTION_AnnotationBasedNullAnalysis,
            this.isAnnotationBasedNullAnalysisEnabled ? ENABLED : DISABLED);
        ...
        optionsMap.put(OPTION_ReportNullAnnotationInferenceConflict,
            getSeverityString(NullAnnotationInferenceConflict));
        ...
        optionsMap.put(OPTION_NullableAnnotationName,
            String.valueOf(CharOperation.concatWith(this.nullableAnnotationName, '.')));
        optionsMap.put(OPTION_NonNullAnnotationName,
            String.valueOf(CharOperation.concatWith(this.nonNullAnnotationName, '.')));
        ...
        optionsMap.put(OPTION_NullableAnnotationSecondaryNames,
            nameListToString(this.nullableAnnotationSecondaryNames));
        optionsMap.put(OPTION_NonNullAnnotationSecondaryNames, nameListToString(this.nonNullAnnotationSecondaryNames));
        optionsMap.put(OPTION_NonNullByDefaultAnnotationSecondaryNames,
            nameListToString(this.nonNullByDefaultAnnotationSecondaryNames));
        optionsMap.put(OPTION_ReportMissingNonNullByDefaultAnnotation,
            getSeverityString(MissingNonNullByDefaultAnnotation));
        optionsMap.put(OPTION_ReportUnusedTypeParameter, getSeverityString(UnusedTypeParameter));
        optionsMap.put(OPTION_SyntacticNullAnalysisForFields,
            this.enableSyntacticNullAnalysisForFields ? ENABLED : DISABLED);
        optionsMap.put(OPTION_InheritNullAnnotations, this.inheritNullAnnotations ? ENABLED : DISABLED);
        optionsMap.put(OPTION_ReportNonnullParameterAnnotationDropped,
            getSeverityString(NonnullParameterAnnotationDropped));
        optionsMap.put(OPTION_ReportUninternedIdentityComparison,
            this.complainOnUninternedIdentityComparison ? ENABLED : DISABLED);
        optionsMap.put(OPTION_PessimisticNullAnalysisForFreeTypeVariables,
        ...
        optionsMap.put(OPTION_ReportNonNullTypeVariableFromLegacyInvocation,
            getSeverityString(NonNullTypeVariableFromLegacyInvocation));
        optionsMap.put(OPTION_ReportAnnotatedTypeArgumentToUnannotated,
            getSeverityString(AnnotatedTypeArgumentToUnannotated));
        optionsMap.put(OPTION_ReportUnlikelyCollectionMethodArgumentType,
            getSeverityString(UnlikelyCollectionMethodArgumentType));
        optionsMap.put(OPTION_ReportUnlikelyCollectionMethodArgumentTypeStrict,
            this.reportUnlikelyCollectionMethodArgumentTypeStrict ? ENABLED : DISABLED);
        ...
        optionsMap.put(OPTION_IgnoreUnnamedModuleForSplitPackage,
            this.ignoreUnnamedModuleForSplitPackage ? ENABLED : DISABLED);
    ...
    public int getSeverity(int irritant) {
        if (this.errorThreshold.isSet(irritant)) {
            if ((irritant & (IrritantSet.GROUP_MASK | UnusedWarningToken)) == UnusedWarningToken) {
                return ProblemSeverities.Error | ProblemSeverities.Optional; // cannot be treated as fatal - codegen
                                                                             // already occurred
            }
    ...
    public boolean isAnyEnabled(IrritantSet irritants) {
        return this.warningThreshold.isAnySet(irritants)
            || this.errorThreshold.isAnySet(irritants)
            ...
            for (int b = 0; b < IrritantSet.GROUP_SHIFT; b++) {
                ...
                if (single > 0) {
                    ...
                    if (single == MissingNonNullByDefaultAnnotation)
                        continue;
                    if (!(this.warningThreshold.isSet(single)
                        || this.errorThreshold.isSet(single)
                        || this.infoThreshold.isSet(single))) {
                        return single;
                    }
                }
            }
    ...
    public void set(Map<String, String> optionsMap) {
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportUnusedDeclaredThrownExceptionIncludeDocCommentReference))
            != null) {
            if (ENABLED.equals(optionValue)) {
                this.reportUnusedDeclaredThrownExceptionIncludeDocCommentReference = true;
            } else if (DISABLED.equals(optionValue)) {
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportUnusedDeclaredThrownExceptionExemptExceptionAndThrowable))
            != null) {
            if (ENABLED.equals(optionValue)) {
                this.reportUnusedDeclaredThrownExceptionExemptExceptionAndThrowable = true;
            } else if (DISABLED.equals(optionValue)) {
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportMissingOverrideAnnotationForInterfaceMethodImplementation))
            != null) {
            if (ENABLED.equals(optionValue)) {
                this.reportMissingOverrideAnnotationForInterfaceMethodImplementation = true;
            } else if (DISABLED.equals(optionValue)) {
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportTerminalDeprecation)) != null)
            updateSeverity(UsingTerminallyDeprecatedAPI, optionValue);
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportUnusedLambdaParameter)) != null)
            updateSeverity(UnusedLambdaParameter, optionValue);
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportUnusedExceptionParameter)) != null)
            updateSeverity(UnusedExceptionParameter, optionValue);
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportTypeParameterHiding)) != null)
            updateSeverity(TypeHiding, optionValue);
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportEmptyStatement)) != null)
            updateSeverity(EmptyStatement, optionValue);
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportAssertIdentifier)) != null)
            updateSeverity(AssertUsedAsAnIdentifier, ERROR);
        if ((optionValue = optionsMap.get(OPTION_ReportEnumIdentifier)) != null)
            updateSeverity(EnumUsedAsAnIdentifier, ERROR);
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportUnnecessaryElse)) != null)
            updateSeverity(UnnecessaryElse, optionValue);
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportUnusedTypeParameter)) != null)
            updateSeverity(UnusedTypeParameter, optionValue);
        if ((optionValue = optionsMap.get(OPTION_ReportUnlikelyCollectionMethodArgumentType)) != null)
            updateSeverity(UnlikelyCollectionMethodArgumentType, optionValue);
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportUnlikelyEqualsArgumentType)) != null)
            updateSeverity(UnlikelyEqualsArgumentType, optionValue);
        if ((optionValue = optionsMap.get(OPTION_ReportAPILeak)) != null)
            updateSeverity(APILeak, optionValue);
        if ((optionValue = optionsMap.get(OPTION_ReportUnstableAutoModuleName)) != null)
            updateSeverity(UnstableAutoModuleName, optionValue);
        ...
        if (this.isAnnotationBasedNullAnalysisEnabled) {
            ...
            if ((optionValue = optionsMap.get(OPTION_ReportNullAnnotationInferenceConflict)) != null)
                updateSeverity(NullAnnotationInferenceConflict, optionValue);
            if ((optionValue = optionsMap.get(OPTION_ReportNullUncheckedConversion)) != null)
                updateSeverity(NullUncheckedConversion, optionValue);
            if ((optionValue = optionsMap.get(OPTION_ReportRedundantNullAnnotation)) != null)
                updateSeverity(RedundantNullAnnotation, optionValue);
            ...
            if ((optionValue = optionsMap.get(OPTION_ReportMissingNonNullByDefaultAnnotation)) != null)
                updateSeverity(MissingNonNullByDefaultAnnotation, optionValue);
            ...
            if ((optionValue = optionsMap.get(OPTION_ReportNonnullParameterAnnotationDropped)) != null)
                updateSeverity(NonnullParameterAnnotationDropped, optionValue);
            if ((optionValue = optionsMap.get(OPTION_ReportAnnotatedTypeArgumentToUnannotated)) != null)
                updateSeverity(AnnotatedTypeArgumentToUnannotated, optionValue);
            if ((optionValue = optionsMap.get(OPTION_PessimisticNullAnalysisForFreeTypeVariables)) != null)
                updateSeverity(PessimisticNullAnalysisForFreeTypeVariables, optionValue);
            ...
            if ((optionValue = optionsMap.get(OPTION_ReportNonNullTypeVariableFromLegacyInvocation)) != null)
                updateSeverity(NonNullTypeVariableFromLegacyInvocation, optionValue);
        }
        ...
        boolean useAnnotationsForAnalysis
            = this.isAnnotationBasedNullAnalysisEnabled || this.isAnnotationBasedResourceAnalysisEnabled;
    ...
    public String toString() {
        ...
        buf.append("\n\t- local variables debug attributes: ") //$NON-NLS-1$
            .append((this.produceDebugAttributes & ClassFileConstants.ATTR_VARS) != 0 ? "ON" : " OFF");  //$NON-NLS-1$ //$NON-NLS-2$
        buf.append("\n\t- line number debug attributes: ") //$NON-NLS-1$
            .append((this.produceDebugAttributes & ClassFileConstants.ATTR_LINES) != 0 ? "ON" : " OFF");  //$NON-NLS-1$ //$NON-NLS-2$
        buf.append("\n\t- source debug attributes: ") //$NON-NLS-1$
            .append((this.produceDebugAttributes & ClassFileConstants.ATTR_SOURCE) != 0 ? "ON" : " OFF");  //$NON-NLS-1$ //$NON-NLS-2$
        buf.append("\n\t- MethodParameters attributes: ") //$NON-NLS-1$
            .append(this.produceMethodParameters ? GENERATE : DO_NOT_GENERATE);
        buf.append("\n\t- Generic signature for lambda expressions: ") //$NON-NLS-1$
            .append(this.generateGenericSignatureForLambdaExpressions ? GENERATE : DO_NOT_GENERATE);
        buf.append("\n\t- preserve all local variables: ").append(this.preserveAllLocalVariables ? "ON" : " OFF"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        buf.append("\n\t- method with constructor name: ").append(getSeverityString(MethodWithConstructorName)); //$NON-NLS-1$
        buf.append("\n\t- overridden package default method: ") //$NON-NLS-1$
            .append(getSeverityString(OverriddenPackageDefaultMethod));
        ...
        buf.append("\n\t- incompatible non inherited interface method: ") //$NON-NLS-1$
            .append(getSeverityString(IncompatibleNonInheritedInterfaceMethod));
        ...
        buf.append("\n\t\t\t* deprecated references: ") //$NON-NLS-1$
            .append(this.reportInvalidJavadocTagsDeprecatedRef ? ENABLED : DISABLED);
        buf.append("\n\t\t\t* not visible references: ") //$NON-NLS-1$
            .append(this.reportInvalidJavadocTagsNotVisibleRef ? ENABLED : DISABLED);
        buf.append("\n\t\t+ visibility level to report invalid javadoc tags: ") //$NON-NLS-1$
            .append(getVisibilityString(this.reportInvalidJavadocTagsVisibility));
        buf.append("\n\t\t+ missing javadoc tags: ").append(getSeverityString(MissingJavadocTags)); //$NON-NLS-1$
        buf.append("\n\t\t+ visibility level to report missing javadoc tags: ") //$NON-NLS-1$
            .append(getVisibilityString(this.reportMissingJavadocTagsVisibility));
        buf.append("\n\t\t+ report missing javadoc tags for method type parameters: ") //$NON-NLS-1$
            .append(this.reportMissingJavadocTagsMethodTypeParameters ? ENABLED : DISABLED);
        buf.append("\n\t\t+ report missing javadoc tags in overriding methods: ") //$NON-NLS-1$
            .append(this.reportMissingJavadocTagsOverriding ? ENABLED : DISABLED);
        ...
        buf.append("\n\t\t+ visibility level to report missing javadoc comments: ") //$NON-NLS-1$
            .append(getVisibilityString(this.reportMissingJavadocCommentsVisibility));
        buf.append("\n\t\t+ report missing javadoc comments in overriding methods: ") //$NON-NLS-1$
            .append(this.reportMissingJavadocCommentsOverriding ? ENABLED : DISABLED);
        buf.append("\n\t- finally block not completing normally: ") //$NON-NLS-1$
            .append(getSeverityString(FinallyBlockNotCompleting));
        buf.append("\n\t- report unused declared thrown exception: ") //$NON-NLS-1$
            .append(getSeverityString(UnusedDeclaredThrownException));
        buf.append("\n\t- report unused declared thrown exception when overriding: ") //$NON-NLS-1$
            .append(this.reportUnusedDeclaredThrownExceptionWhenOverriding ? ENABLED : DISABLED);
        buf.append("\n\t- report unused declared thrown exception include doc comment reference: ") //$NON-NLS-1$
            .append(this.reportUnusedDeclaredThrownExceptionIncludeDocCommentReference ? ENABLED : DISABLED);
        buf.append("\n\t- report unused declared thrown exception exempt exception and throwable: ") //$NON-NLS-1$
        ...
        buf.append("\n\t- parse literal expressions as constants : ") //$NON-NLS-1$
            .append(this.parseLiteralExpressionsAsConstants ? "ON" : "OFF");  //$NON-NLS-1$ //$NON-NLS-2$
        buf.append("\n\t- encoding : ").append(this.defaultEncoding == null ? "<default>" : this.defaultEncoding); //$NON-NLS-1$ //$NON-NLS-2$
        buf.append("\n\t- task tags: ") //$NON-NLS-1$
            .append(
                this.taskTags == null ? Util.EMPTY_STRING : new String(CharOperation.concatWith(this.taskTags, ',')));
        buf.append("\n\t- task priorities : ") //$NON-NLS-1$
            .append(this.taskPriorities == null
                ? Util.EMPTY_STRING
                : new String(CharOperation.concatWith(this.taskPriorities, ',')));
        buf.append("\n\t- report deprecation inside deprecated code : ") //$NON-NLS-1$
            .append(this.reportDeprecationInsideDeprecatedCode ? ENABLED : DISABLED);
        buf.append("\n\t- report deprecation when overriding deprecated method : ") //$NON-NLS-1$
            .append(this.reportDeprecationWhenOverridingDeprecatedMethod ? ENABLED : DISABLED);
        buf.append("\n\t- report unused parameter when implementing abstract method : ") //$NON-NLS-1$
            .append(this.reportUnusedParameterWhenImplementingAbstract ? ENABLED : DISABLED);
        buf.append("\n\t- report unused parameter when overriding concrete method : ") //$NON-NLS-1$
            .append(this.reportUnusedParameterWhenOverridingConcrete ? ENABLED : DISABLED);
        buf.append("\n\t- report unused parameter include doc comment reference : ") //$NON-NLS-1$
            .append(this.reportUnusedParameterIncludeDocCommentReference ? ENABLED : DISABLED);
        buf.append("\n\t- report constructor/setter parameter hiding existing field : ") //$NON-NLS-1$
            .append(this.reportSpecialParameterHidingField ? ENABLED : DISABLED);
        buf.append("\n\t- report unavoidable generic type problems : ") //$NON-NLS-1$
            .append(this.reportUnavoidableGenericTypeProblems ? ENABLED : DISABLED);
        ...
        buf.append("\n\t- forbidden reference to type with access restriction: ") //$NON-NLS-1$
            .append(getSeverityString(ForbiddenReference));
        buf.append("\n\t- discouraged reference to type with access restriction: ") //$NON-NLS-1$
            .append(getSeverityString(DiscouragedReference));
        ...
        buf.append("\n\t- missing @Override annotation for interface method implementation: ") //$NON-NLS-1$
        ...
        buf.append("\n\t- raise null related warnings for variables tainted in assert statements: ") //$NON-NLS-1$
        ...
        buf.append("\n\t- unused type arguments for method/constructor invocation: ") //$NON-NLS-1$
            .append(getSeverityString(UnusedTypeArguments));
        ...
        buf.append("\n\t- missing synchronized on inherited method: ") //$NON-NLS-1$
            .append(getSeverityString(MissingSynchronizedModifierInInheritedMethod));
        ...
        buf.append("\n\t- dead code in trivial if statement: ") //$NON-NLS-1$
            .append(this.reportDeadCodeInTrivialIfStatement ? ENABLED : DISABLED);
        ...
        buf.append("\n\t- redundant specification of type arguments: ") //$NON-NLS-1$
            .append(getSeverityString(RedundantSpecificationOfTypeArguments));
        // resource leak analysis:
        ...
        buf.append("\n\t- resource should be handled by try-with-resources: ") //$NON-NLS-1$
            .append(getSeverityString(ExplicitlyClosedAutoCloseable));
        buf.append("\n\t- resource should be managed explicitly: ") //$NON-NLS-1$
            .append(getSeverityString(InsufficientResourceManagement));

        buf.append("\n\t- Unused Type Parameter: ").append(getSeverityString(UnusedTypeParameter)); //$NON-NLS-1$
        buf.append("\n\t- pessimistic null analysis for free type variables: ") //$NON-NLS-1$
            .append(getSeverityString(PessimisticNullAnalysisForFreeTypeVariables));
        buf.append("\n\t- report unsafe nonnull return from legacy method: ") //$NON-NLS-1$
            .append(getSeverityString(NonNullTypeVariableFromLegacyInvocation));
        buf.append("\n\t- unlikely argument type for collection methods: ") //$NON-NLS-1$
            .append(getSeverityString(UnlikelyCollectionMethodArgumentType));
        buf.append("\n\t- unlikely argument type for collection methods, strict check against expected type: ") //$NON-NLS-1$
            .append(this.reportUnlikelyCollectionMethodArgumentTypeStrict ? ENABLED : DISABLED);
        buf.append("\n\t- unlikely argument types for equals(): ") //$NON-NLS-1$
            .append(getSeverityString(UnlikelyEqualsArgumentType));
        ...
        buf.append("\n\t- SuppressWarnings not fully analysed: ") //$NON-NLS-1$
            .append(getSeverityString(SuppressWarningsNotAnalysed));
        buf.append("\n\t- ignore package from unnamed module: ") //$NON-NLS-1$
            .append(this.ignoreUnnamedModuleForSplitPackage ? ENABLED : DISABLED);
        buf.append("\n\t- use StringConcatFactory for String concatenation expressions: ") //$NON-NLS-1$
            .append(this.useStringConcatFactory ? ENABLED : DISABLED);
        buf.append("\n\t- validate virtual machine's operand stack during code generation: ") //$NON-NLS-1$
            .append(this.validateOperandStack ? ENABLED : DISABLED);
        return buf.toString();
    }
     ...
     * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.LookupEnvironment#usesNullTypeAnnotations()}.
     */
    public boolean usesNullTypeAnnotations() {
        if (this.useNullTypeAnnotations != null)
            return this.useNullTypeAnnotations;
        return this.isAnnotationBasedNullAnalysisEnabled && this.sourceLevel >= ClassFileConstants.JDK1_8;
    }
}
