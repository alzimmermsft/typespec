...
//	public static final int VARIABLE = FIELD | LOCAL | RECORD_COMPONENT;
    ...
    // In the unlikely event you add a new type binding, remember to update TypeBindingVisitor and Scope.substitute
    // methods.
    ...
    public static final ReferenceBinding[] ANY_EXCEPTION = new ReferenceBinding[] { null }; // special handler for all
                                                                                            // exceptions
    ...
    public static final int DefaultLocationsForTrueValue
        = DefaultLocationParameter | DefaultLocationReturnType | DefaultLocationField | DefaultLocationRecordComponent;

    public static final int NullnessDefaultMASK = NULL_UNSPECIFIED_BY_DEFAULT | // included to terminate search up the
                                                                                // parent chain
        DefaultLocationParameter | DefaultLocationReturnType | DefaultLocationField | DefaultLocationTypeArgument
        | DefaultLocationTypeParameter | DefaultLocationTypeBound | DefaultLocationArrayContents
     ...
     * Returns null if binding is not a TypeBinding, a MethodBinding, a FieldBinding, a LocalVariableBinding, a
     * PackageBinding (i.e. an ImportBinding)
     * or a ModuleBinding.
     */
