...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.expressions.StandardElementHandler;
...
public abstract class ElementHandler {
    ...
    public Expression create(ExpressionConverter converter, Element element) throws CoreException {
        throw new CoreException(new Status(IStatus.ERROR, ElementHandler.class, IStatus.ERROR,
            ExpressionMessages.ElementHandler_unsupported_element, null));
    }
    ...
    protected void processChildren(ExpressionConverter converter, IConfigurationElement element,
        CompositeExpression expression) throws CoreException {
     ...
     * @noreference This method is not intended to be referenced by clients.
     */
    protected void processChildren(ExpressionConverter converter, Element element, CompositeExpression expression)
