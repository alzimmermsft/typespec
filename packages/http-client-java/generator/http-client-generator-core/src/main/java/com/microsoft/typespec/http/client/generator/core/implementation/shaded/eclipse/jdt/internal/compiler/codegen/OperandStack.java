...
public class OperandStack {
    ...
    public void xastore() { // ..., arrayref, index, value → ...
        ...
        boolean wellFormed = switch (elementType.id) {
            case TypeIds.T_boolean, TypeIds.T_byte, TypeIds.T_short, TypeIds.T_char -> TypeBinding
                .equalsEquals(valueType, TypeBinding.INT);
    ...
    public void dup2_x2() {
        ...
        if (TypeIds.getCategory(val1.id) == 2) {
            ...
            if (TypeIds.getCategory(val3.id) == 2) { // Form 3: ..., value3, value2, value1 → ..., value2, value1,
