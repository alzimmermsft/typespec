...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.dtree.DataTreeWriter;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.dtree.DeltaDataTree;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.dtree.IDataFlattener;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.resources.SaveManager;
...
public class ElementTreeWriter {
     ...
     */
    public void writeDelta(ElementTree olderTree, ElementTree newerTree, IPath path, int depth, final DataOutput output,
        IElementComparator comparator) throws IOException {
     ...
     * 
     */
    public void writeDeltaChain(ElementTree[] trees, IPath path, int depth, DataOutput output,
        IElementComparator comparator) throws IOException {
