 ...
 * @see org.eclipse.jdt.core.eval.IEvaluationContext
 * @exception org.eclipse.jdt.internal.eval.InstallException if the code snippet class files could not be deployed.
 * @exception IllegalArgumentException if the global has not been installed yet.
 */
...
writer.write(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.eval.EvaluationContext.getCodeSnippetSource());
writer.close();
com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.batch.Main.compile(
...
byte[] bytes = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.Util.readContentsAsBytes(reader);
reader.close();
...
public static String getCodeSnippetSource() {
	return
		"package com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.eval.target;\n" + //$NON-NLS-1$
		"\n" + //$NON-NLS-1$
		"/*\n" + //$NON-NLS-1$
