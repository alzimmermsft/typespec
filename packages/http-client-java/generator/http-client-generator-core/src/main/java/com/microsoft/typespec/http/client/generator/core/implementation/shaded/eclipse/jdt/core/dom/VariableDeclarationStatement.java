...
public class VariableDeclarationStatement extends Statement {
    ...
    public static final ChildListPropertyDescriptor FRAGMENTS_PROPERTY = new ChildListPropertyDescriptor(
        VariableDeclarationStatement.class, "fragments", VariableDeclarationFragment.class, CYCLE_RISK); //$NON-NLS-1$
     ...
     */
    private final NodeList variableDeclarationFragments = new NodeList(FRAGMENTS_PROPERTY);
    ...
    int treeSize() {
        return memSize() + (this.modifiers == null ? 0 : this.modifiers.listSize())
            + (this.baseType == null ? 0 : getType().treeSize()) + this.variableDeclarationFragments.listSize();
    }
}
