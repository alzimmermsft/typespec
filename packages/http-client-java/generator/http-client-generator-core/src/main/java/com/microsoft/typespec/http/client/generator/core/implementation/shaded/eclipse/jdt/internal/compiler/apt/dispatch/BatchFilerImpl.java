...
public class BatchFilerImpl implements Filer {
            ...
            try {
                for (JavaFileObject javaFileObject : this._fileManager.list(StandardLocation.SOURCE_PATH, "", //$NON-NLS-1$
                    ...
                    if (javaFileObject.getName().equals(IModule.MODULE_INFO_JAVA)) {
                        IModule module = ClasspathJsr199.extractModuleFromFileObject(javaFileObject, main::getNewParser,
                            null, this._encoding);
                        if (module != null)
     ...
     * (non-Javadoc)
     * 
     * @see javax.annotation.processing.Filer#createClassFile(java.lang.CharSequence,
    ...
    public JavaFileObject createClassFile(CharSequence name, Element... originatingElements) throws IOException {
        JavaFileObject jfo = this._fileManager.getJavaFileForOutput(StandardLocation.CLASS_OUTPUT, name.toString(),
     ...
     * 
     * @see
     * javax.annotation.processing.Filer#createResource(com.microsoft.typespec.http.client.generator.core.implementation
     * .shaded.javax.tools.JavaFileManager.Location, java.lang.CharSequence, java.lang.CharSequence,
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.element.Element[])
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see javax.annotation.processing.Filer#createSourceFile(java.lang.CharSequence,
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.element.Element[])
     */
    @Override
    public JavaFileObject createSourceFile(CharSequence name, Element... originatingElements) throws IOException {
        ...
        JavaFileObject jfo
            = this._fileManager.getJavaFileForOutput(location, name.toString(), JavaFileObject.Kind.SOURCE, null);
        URI uri = jfo.toUri();
        if (this._createdFiles.contains(uri)) {
     ...
     * 
     * @see
     * javax.annotation.processing.Filer#getResource(com.microsoft.typespec.http.client.generator.core.implementation.
     * shaded.javax.tools.JavaFileManager.Location, java.lang.CharSequence, java.lang.CharSequence)
     */
    @Override
