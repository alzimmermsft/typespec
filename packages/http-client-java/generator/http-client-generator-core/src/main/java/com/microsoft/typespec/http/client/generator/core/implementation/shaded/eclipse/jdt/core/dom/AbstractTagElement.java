...
public abstract class AbstractTagElement extends ASTNode implements IDocElement {
     ...
     */
    NodeList fragments = new NodeList(internalFragmentsPropertyFactory());
    ...
    AbstractTagElement(AST ast) {
        super(ast);
        this.fragments = new NodeList(internalFragmentsPropertyFactory());
    }
     ...
     * including any leading "*"). {@link AbstractTagElement}
     ...
     * {@link AbstractTagElement}, {@link Name},
     ...
     * of this node is of type {@link AbstractTagElement}.
     * </p>
     *
