...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.jobs.IJobChangeListener;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.jobs.JobChangeAdapter;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.jobs.JobGroup;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.jobs.LockListener;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.jobs.MultiRule;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.jobs.ProgressProvider;
...
public class JobManager implements IJobManager {
    ...
    public static final String PI_JOBS
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.jobs"; //$NON-NLS-1$
        ...
        synchronized (lock) {
            ...
            if (suspended && state != Job.RUNNING) {
                ...
                RuntimeLog.log(new Status(IStatus.WARNING, pluginId, 0,
                    NLS.bind(JobMessages.JobManager_suspended_problem, job.getName()), new IllegalStateException()));
                return true;
            }
        ...
        try {
            ...
            while (true) {
                ...
                try {
                    ...
                    long sleepTime
                        = remainingTime != 0 && remainingTime <= MAX_WAIT_INTERVAL ? remainingTime : MAX_WAIT_INTERVAL;
    ...
    boolean join(InternalJobGroup jobGroup, long timeout, IProgressMonitor monitor)
        throws InterruptedException, OperationCanceledException {
        Assert.isLegal(jobGroup != null, "jobGroup should not be null"); //$NON-NLS-1$
        Assert.isLegal(timeout >= 0, "timeout should not be negative"); //$NON-NLS-1$
        long deadline = timeout == 0 ? 0 : now() + timeout;
        ...
        synchronized (lock) {
            ...
            while (job != null) {
                ...
                if (blocker != null) {
                    ...
                    || jobGroup.getMaxThreads() == 0
                    || (jobGroup.getState() != JobGroup.CANCELING
                        && jobGroup.getRunningJobsCount() < jobGroup.getMaxThreads())) {
                    break;
                }
    ...
    final void reportBlocked(IProgressMonitor monitor, Collection<InternalJob> blockingJobs) {
        ...
        InternalJob blockingJob
            = blockingJobs.stream().sorted(Comparator.comparing(InternalJob::isSystem)).findFirst().orElse(null);
    ...
    private boolean shouldRun(Job job) {
        ...
        RuntimeLog.log(new Status(IStatus.ERROR, JobManager.PI_JOBS, JobManager.PLUGIN_ERROR,
            "Error invoking shouldRun() method on: " + job, t)); //$NON-NLS-1$
    ...
    private void updateJobGroup(IJobChangeEvent event) {
        ...
        if (jobGroupState != JobGroup.CANCELING
            && jobGroup.shouldCancel(jobResult, failedJobsCount, canceledJobsCount)) {
