...
public class SingleVariableDeclaration extends VariableDeclaration {
    ...
    public static final ChildListPropertyDescriptor MODIFIERS2_PROPERTY = new ChildListPropertyDescriptor(
        SingleVariableDeclaration.class, "modifiers", IExtendedModifier.class, CYCLE_RISK); //$NON-NLS-1$
    ...
    public static final ChildListPropertyDescriptor VARARGS_ANNOTATIONS_PROPERTY = new ChildListPropertyDescriptor(
        SingleVariableDeclaration.class, "varargsAnnotations", Annotation.class, CYCLE_RISK); //$NON-NLS-1$
     ...
     * @since 3.1
     */
    private NodeList modifiers = null;
     ...
     * @since 3.10
     */
    private NodeList varargsAnnotations = null;
    ...
    SingleVariableDeclaration(AST ast) {
        ...
        if (ast.apiLevel >= AST.JLS3_INTERNAL) {
            this.modifiers = new NodeList(MODIFIERS2_PROPERTY);
            if (ast.apiLevel >= AST.JLS8_INTERNAL) {
                this.varargsAnnotations = new NodeList(VARARGS_ANNOTATIONS_PROPERTY);
            }
        }
    }
    ...
    ASTNode clone0(AST target) {
        ...
        if (this.ast.apiLevel >= AST.JLS8_INTERNAL) {
            result.varargsAnnotations().addAll(ASTNode.copySubtrees(target, varargsAnnotations()));
        }
        ...
        result.setInitializer((Expression) ASTNode.copySubtree(target, getInitializer()));
        return result;
    }
