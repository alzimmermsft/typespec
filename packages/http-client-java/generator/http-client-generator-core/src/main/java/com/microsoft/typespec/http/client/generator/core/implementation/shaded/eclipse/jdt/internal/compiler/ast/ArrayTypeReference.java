...
public class ArrayTypeReference extends SingleTypeReference {
    ...
    protected TypeBinding internalResolveType(Scope scope, int location) {
        ...
        internalResolveType = maybeMarkArrayContentsNonNull(scope, internalResolveType, this.sourceStart,
            this.dimensions, leafType -> this.leafComponentTypeWithoutDefaultNullness = leafType);

        return internalResolveType;
    }

    static TypeBinding maybeMarkArrayContentsNonNull(Scope scope, TypeBinding typeBinding, int sourceStart,
        int dimensions, Consumer<TypeBinding> leafConsumer) {
        ...
        if (environment.usesNullTypeAnnotations()
            ...
            if ((leafComponentType.tagBits & TagBits.AnnotationNullMASK) == 0
                && leafComponentType.acceptsNonNullDefault()) {
                if (leafConsumer != null)
                    leafConsumer.accept(leafComponentType);
                TypeBinding nonNullLeafComponentType
                    = scope.environment().createNonNullAnnotatedType(leafComponentType);
    ...
    static TypeBinding addNonNullToDimensions(Scope scope, TypeBinding typeBinding, AnnotationBinding nonNullAnnotation,
        int dimensions2) {
