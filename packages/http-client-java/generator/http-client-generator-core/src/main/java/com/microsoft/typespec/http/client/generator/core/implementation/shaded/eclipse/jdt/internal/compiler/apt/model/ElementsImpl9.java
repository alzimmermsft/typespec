...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.QualifiedAllocationExpression;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.tool.EclipseFileManager;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.tool.PathFileObject;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.TextBlockUtil;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.AnnotatedConstruct;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.element.VariableElement;
...
public class ElementsImpl9 extends ElementsImpl {
    ...
    public ModuleElement getModuleElement(CharSequence name) {
        ...
        ModuleBinding binding
            = lookup.getModule(name.length() == 0 ? ModuleBinding.UNNAMED : name.toString().toCharArray());
    ...
    @Override
    public com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.tools.JavaFileObject
        getFileObjectOf(Element element) {
        switch (element.getKind()) {
            ...
            case PACKAGE:
                ...
                Binding typeOrPackage
                    = pBinding.getTypeOrPackage(TypeConstants.PACKAGE_INFO_NAME, pBinding.enclosingModule, true);
                ...
                if (variableImpl._binding instanceof FieldBinding field) {
                    ...
                    if (sourceField.initialization instanceof QualifiedAllocationExpression qualAlloc) {
                        ...
                        if (decl.binding == null) {
                            ...
                            BlockScope scope = field.isStatic()
                                ? enumTypeDecl.staticInitializerScope
                                : enumTypeDecl.initializerScope;
                            if (scope != null) {
                        ...
                        return decl.binding == null
                            ? null
                            : (TypeElement) this._env.getFactory().newElement(decl.binding);
                    }
                }
            }
