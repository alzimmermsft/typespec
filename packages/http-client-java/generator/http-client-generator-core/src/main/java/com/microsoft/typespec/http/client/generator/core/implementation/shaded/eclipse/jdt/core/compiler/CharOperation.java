...
public final class CharOperation {
     ...
     * @since 3.2
     */
    public static boolean camelCaseMatch(char[] pattern, int patternStart, int patternEnd, char[] name, int nameStart,
        int nameEnd) {
     ...
     *
     * @return an array of char[], representing the elements in the input list, or {@code null} if the list was
     * {@code null}.
     * @since 3.14
     */
     ...
     */
    public static char[] concat(char[] first, char[] second, char[] third) {
        if (first == null)
     ...
     */
    public static char[] concat(char[] first, char[] second, char separator) {
        if (first == null)
            return second;
        if (second == null)
            return first;
    ...
    /**
     * Answers the concatenation of the two arrays inserting the separator character between the two arrays. Differs
     * from
     ...
     * @since 3.14
     */
    public static char[] concatAll(char[] first, char[] second, char separator) {
        if (first == null)
            return second;
        if (second == null)
            return first;
     ...
     */
    public static char[] concat(char[] first, char sep1, char[] second, char sep2, char[] third) {
        if (first == null)
     ...
     * @since 3.12
     */
    public static char[] concatNonEmpty(char[] first, char[] second, char separator) {
     ...
     * @since 3.12
     */
    public static char[] concatNonEmpty(char[] first, char sep1, char[] second, char sep2, char[] third) {
        if (first == null || first.length == 0)
     ...
     * delimited from position secondStart (inclusive) to secondEnd(exclusive), otherwise false. The equality could be
     * either
     ...
     */
    public static boolean fragmentEquals(char[] fragment, char[] name, int startIndex, boolean isCaseSensitive) {
    ...
    /**
     * Answers true if c is a whitespace according to the JLS (&#92;u0009, &#92;u000a, &#92;u000c, &#92;u000d,
     * &#92;u0020), otherwise false.
     * <br>
     * <br>
     * For example:
     * <ol>
     ...
     * @since 3.2
     */
    public static int indexOf(final char[] toBeFound, final char[] array, final boolean isCaseSensitive,
        final int start) {
     ...
     */
    public static int lastIndexOf(char toBeFound, char[] array, int startIndex) {
     ...
     * @throws NullPointerException if array is null
     * @throws ArrayIndexOutOfBoundsException if endIndex is greater or equals to array length or starting is lower than
     * 0
     */
    public static int lastIndexOf(char toBeFound, char[] array, int startIndex, int endIndex) {
     ...
     * @return true if the pattern matches the given name, false otherwise
     */
    public static boolean match(char[] pattern, char[] name, boolean isCaseSensitive) {
     ...
     */
    public static boolean match(char[] pattern, int patternStart, int patternEnd, char[] name, int nameStart,
     ...
     */
    public static boolean pathMatch(char[] pattern, char[] filepath, boolean isCaseSensitive, char pathSeparator) {
     ...
     * @throws ArrayIndexOutOfBoundsException if start is lower than 0
     */
    public static int occurencesOf(char toBeFound, char[] array, int start) {
        int count = 0;
        for (int i = start; i < array.length; i++)
            if (toBeFound == array[i])
                count++;
     ...
     * @throws NullPointerException if the given name is null or if the given prefix is null
     */
    public static boolean prefixEquals(char[] prefix, char[] name, boolean isCaseSensitive) {
     ...
     * @since 3.7
     */
    public static boolean prefixEquals(char[] prefix, char[] name, boolean isCaseSensitive, int startIndex) {
     ...
     * @throws NullPointerException if the given array is null
     */
    public static char[] replace(char[] array, char[] toBeReplaced, char[] replacementChars) {
     ...
     * @since 3.1
     */
    public static char[] replaceOnCopy(char[] array, char toBeReplaced, char replacementChar) {
    ...
    /**
     * Return a new array which is the split of the given array using the given divider and trimming each subarray to
     * remove
     ...
     */
    public static char[][] splitOn(char divider, char[] array, int start, int end) {
        int length = array == null ? 0 : array.length;
     ...
     * @since 3.12
     */
    public static char[][] splitOnWithEnclosures(char divider, char openEncl, char closeEncl, char[] array, int start,
        int end) {
        int length = array == null ? 0 : array.length;
        if (length == 0 || start > end)
            return NO_CHAR_CHAR;
