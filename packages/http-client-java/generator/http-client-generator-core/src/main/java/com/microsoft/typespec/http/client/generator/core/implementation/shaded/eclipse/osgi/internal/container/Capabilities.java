...
public class Capabilities {
	...
	public static final String SYNTHETIC_REQUIREMENT = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi.container.synthetic"; //$NON-NLS-1$
