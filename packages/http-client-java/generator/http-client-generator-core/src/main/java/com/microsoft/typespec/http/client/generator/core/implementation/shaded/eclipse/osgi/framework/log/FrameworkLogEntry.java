...
public class FrameworkLogEntry {
     ...
     */
    public FrameworkLogEntry(String entry, String message, int stackCode, Throwable throwable,
     ...
     * @since 3.2
     */
    public FrameworkLogEntry(String entry, int severity, int bundleCode, String message, int stackCode,
        Throwable throwable, FrameworkLogEntry[] children) {
     ...
     * @since 3.7
     */
    public FrameworkLogEntry(Object context, String entry, int severity, int bundleCode, String message, int stackCode,
        Throwable throwable, FrameworkLogEntry[] children) {
