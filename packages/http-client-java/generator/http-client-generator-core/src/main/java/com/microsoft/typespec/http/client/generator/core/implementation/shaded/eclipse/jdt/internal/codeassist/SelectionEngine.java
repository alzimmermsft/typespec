...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.search.TypeNameMatch;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.search.TypeNameMatchRequestor;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.codeassist.impl.Engine;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.codeassist.select.*;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.BinaryTypeConverter;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.SelectionRequestor;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.SourceType;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.search.TypeNameMatchRequestorWrapper;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.HashSetOfCharArrayArray;
...
public final class SelectionEngine extends Engine implements ISearchRequestor {
	...
	private void findAllTypes(char[] prefix) {
		try {
			...
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.ICompilationUnit[] workingCopies = this.owner == null ? null : JavaModelManager.getJavaModelManager().getWorkingCopies(this.owner, true/*add primary WCs*/);
	...
	public void selectType(char[] typeName, IType context) throws JavaModelException {
		try {
			...
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.ICompilationUnit cu = context.getCompilationUnit();
			if (cu != null) {
				...
				CompilationResult result = new CompilationResult((ICompilationUnit) cu, 1, 1, this.compilerOptions.maxProblemsPerUnit);
