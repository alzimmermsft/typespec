...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.CompactHashing.UNSET;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Hashing.smearedHash;
...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.NullnessCasts.unsafeNull;
...
class CompactHashMap<K extends @Nullable Object, V extends @Nullable Object> extends AbstractMap<K, V>
    ...
    public static <K extends @Nullable Object, V extends @Nullable Object> CompactHashMap<K, V> create() {
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> CompactHashMap<K, V>
    ...
    final class MapEntry extends AbstractMapEntry<K, V> {
        ...
        private void updateLastKnownIndex() {
            if (lastKnownIndex == -1 || lastKnownIndex >= size() || !Objects.equal(key, key(lastKnownIndex))) {
