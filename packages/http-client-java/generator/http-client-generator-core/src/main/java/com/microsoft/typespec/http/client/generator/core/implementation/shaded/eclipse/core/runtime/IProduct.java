 ...
 * For example, in the standard Eclipse UI, <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.ui.branding.IProductConstants</code>
 * the properties of interest to the UI.  Other clients may specify additional properties.
 * </p><p>
 * Products can be defined directly using extensions to the <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.products</code>
