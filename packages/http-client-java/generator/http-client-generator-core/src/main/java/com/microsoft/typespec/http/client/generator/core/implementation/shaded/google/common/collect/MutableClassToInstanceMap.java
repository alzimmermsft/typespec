...
public final class MutableClassToInstanceMap<B extends @Nullable Object>
    extends ForwardingMap<Class<? extends @NonNull B>, B> implements ClassToInstanceMap<B>, Serializable {
     ...
     */
    public static <B extends @Nullable Object> MutableClassToInstanceMap<B>
     ...
     */
    private static <B extends @Nullable Object> Entry<Class<? extends @NonNull B>, B>
        checkedEntry(final Entry<Class<? extends @NonNull B>, B> entry) {
    ...
    public Set<Entry<Class<? extends @NonNull B>, B>> entrySet() {
        return new ForwardingSet<Entry<Class<? extends @NonNull B>, B>>() {
            ...
            public Iterator<Entry<Class<? extends @NonNull B>, B>> iterator() {
                return new TransformedIterator<Entry<Class<? extends @NonNull B>, B>, Entry<Class<? extends @NonNull B>, B>>(
                    delegate().iterator()) {
                    @Override
