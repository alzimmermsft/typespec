...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.*;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.rewrite.TargetSourceRangeComputer;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.rewrite.TargetSourceRangeComputer.SourceRange;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.parser.ScannerHelper;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.rewrite.ASTRewriteFormatter.BlockContext;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.rewrite.ASTRewriteFormatter.NodeMarker;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.rewrite.ASTRewriteFormatter.Prefix;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.rewrite.NodeInfoStore.CopyPlaceholderData;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.rewrite.NodeInfoStore.StringPlaceholderData;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.rewrite.RewriteEventStore.CopySourceInfo;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.text.edits.*;
...
public final class ASTRewriteAnalyzer extends ASTVisitor {
    ...
    private static final ChildPropertyDescriptor INTERNAL_ARRAY_COMPONENT_TYPE_PROPERTY
        = ArrayType.COMPONENT_TYPE_PROPERTY;

    /** @deprecated using deprecated code */
    private static final SimplePropertyDescriptor INTERNAL_FIELD_MODIFIERS_PROPERTY
        = FieldDeclaration.MODIFIERS_PROPERTY;

    /** @deprecated using deprecated code */
    private static final SimplePropertyDescriptor INTERNAL_INITIALIZER_MODIFIERS_PROPERTY3
        = Initializer.MODIFIERS_PROPERTY;

    /** @deprecated using deprecated code */
    private static final SimplePropertyDescriptor INTERNAL_METHOD_MODIFIERS_PROPERTY2
        = MethodDeclaration.MODIFIERS_PROPERTY;

    /** @deprecated using deprecated code */
    private static final ChildPropertyDescriptor INTERNAL_METHOD_RETURN_TYPE_PROPERTY
        = MethodDeclaration.RETURN_TYPE_PROPERTY;

    /** @deprecated using deprecated code */
    private static final SimplePropertyDescriptor INTERNAL_METHOD_EXTRA_DIMENSIONS_PROPERTY
        = MethodDeclaration.EXTRA_DIMENSIONS_PROPERTY;

    /** @deprecated using deprecated code */
    private static final ChildListPropertyDescriptor INTERNAL_METHOD_THROWN_EXCEPTIONS_PROPERTY
    ...
    /** @deprecated using deprecated code */
    private static final ChildPropertyDescriptor INTERNAL_TYPE_SUPERCLASS_PROPERTY
        = TypeDeclaration.SUPERCLASS_PROPERTY;

    /** @deprecated using deprecated code */
    private static final ChildListPropertyDescriptor INTERNAL_TYPE_SUPER_INTERFACES_PROPERTY
    ...
    /** @deprecated using deprecated code */
    private static final SimplePropertyDescriptor INTERNAL_FRAGMENT_EXTRA_DIMENSIONS_PROPERTY
        = VariableDeclarationFragment.EXTRA_DIMENSIONS_PROPERTY;

    /** @deprecated using deprecated code */
    private static final ChildPropertyDescriptor INTERNAL_TDS_TYPE_DECLARATION_PROPERTY
        = TypeDeclarationStatement.TYPE_DECLARATION_PROPERTY;

    /** @deprecated using deprecated code */
    private static final SimplePropertyDescriptor INTERNAL_VARIABLE_MODIFIERS_PROPERTY
        = SingleVariableDeclaration.MODIFIERS_PROPERTY;

    /** @deprecated using deprecated code */
    private static final SimplePropertyDescriptor INTERNAL_VARIABLE_EXTRA_DIMENSIONS_PROPERTY
        = SingleVariableDeclaration.EXTRA_DIMENSIONS_PROPERTY;

    /** @deprecated using deprecated code */
    private static final SimplePropertyDescriptor INTERNAL_VDE_MODIFIERS_PROPERTY
        = VariableDeclarationExpression.MODIFIERS_PROPERTY;

    /** @deprecated using deprecated code */
    private static final SimplePropertyDescriptor INTERNAL_VDS_MODIFIERS_PROPERTY
        = VariableDeclarationStatement.MODIFIERS_PROPERTY;

    /** @deprecated using deprecated code */
    private static final ChildListPropertyDescriptor INTERNAL_TRY_STATEMENT_RESOURCES_PROPERTY
     ...
     * @param comments list of comments of the compilation unit to rewrite (elements of type <code>Comment</code>) or
     * <code>null</code>.
    ...
    public ASTRewriteAnalyzer(char[] content, LineInformation lineInfo, String lineDelim, TextEdit rootEdit,
        RewriteEventStore eventStore, NodeInfoStore nodeInfos, List comments, Map options,
    ...
    final TokenScanner getScanner() {
        if (this.tokenScanner == null) {
            ...
            if (this.recoveryScannerData == null) {
                scanner = new Scanner(true, /* tokenizeComments */
                ...
                scanner = new RecoveryScanner(false, /* tokenizeWhiteSpace */
                    false, /* checkNonExternalizedStringLiterals */
                    compilerOptions.sourceLevel, compilerOptions.complianceLevel, null/* taskTags */,
                    null/* taskPriorities */, true/* taskCaseSensitive */,
                    compilerOptions.enablePreviewFeatures/* isPreviewEnabled */, this.recoveryScannerData);
            }
    ...
    class ListRewriter {
        ...
        protected int getInitialIndent() {
            return getIndent(this.nodeIndentPos);
        }

        protected int getInitialIndentInSpaces() {
            return getIndentInSpaces(this.nodeIndentPos);
        }
        ...
        private boolean lineCommentSwallowsActualCode(int prevEnd) {
            if (ASTRewriteAnalyzer.this.getLineCommentEndOffsets().isEndOfLineComment(prevEnd)) {
                ...
                try {
                    return lInfo.getLineOfOffset(lastEndOffset)
                        == lInfo.getLineOfOffset(getScanner().getNextStartOffset(lastEndOffset, false));
        ...
        private int rewriteList(ASTNode parent, StructuralPropertyDescriptor property, String keyword,
            String endKeyword, int offset) {
            ...
            if (property == Block.STATEMENTS_PROPERTY
                ...
                || property == TypeDeclaration.BODY_DECLARATIONS_PROPERTY) {
...
//						maintainMinimumIndent= false;
                    ...
                    if (separatorState == NEW || insertAfterSeparator(node)) {
                        ...
                        if (maintainMinimumIndent && separatorState != EXISTING) {
                            doTextInsert(currPos, node, getNodeIndent(i), true, getNodeIndentInSpaces(i), editGroup); // insert
                                                                                                                      // node
                        } else {
                    ...
                    if (i > lastNonDelete && separatorState == EXISTING) {
                        ...
                        if (lineCommentSwallowsActualCode(prevEnd))
                            doTextInsert(currEnd, getLineDelimiter(), editGroup);
                        currPos = currEnd;
                        prevEnd = currEnd;
                    } else {
                        if (i < lastNonDelete) {
                        ...
                        try {
                            TokenScanner scanner = getScanner();
                            TerminalToken nextToken = scanner.readNext(currEnd, false);
                            if (TokenScanner.isComment(nextToken)) {
                                ...
                                if (end != scanner.getNextStartOffset(currEnd, false)) {
                                    // If this condition were true, comments just found as part of the separator
                                    // would've basically been
                                    // part of the extended source range of the next node. So 'end' wud've safely been
                        ...
                        if (mustRemoveEndKeywordWhenEmpty()
                            && nextIndex == total
                            && lastNonDelete == -1
                            && endKeyword != null
                            && endKeyword.length() > 0) {
                    ...
                    if (currMark == RewriteEvent.REPLACED) {
                        ...
                        updateIndent(prevMark, currPos, i, editGroup);
                        // make sure that comments between last modified source position and extended starting position
                        // of
                ...
                case RewriteEvent.REPLACED: {
                    ...
                    if (endPos == -1) {
                        ...
                        if (endPos != previousEnd) {
                            ...
                            TerminalToken token = TerminalToken.TokenNameNotAToken; // Sentinel value - was
                                                                                    // TokenScanner.END_OF_FILE before
                                                                                    // refactor
                            try {
                            ...
                            if (token == TerminalToken.TokenNameCOMMENT_LINE && node instanceof Block) {
                                insertNewLine = true;
                            }
                        }
                    }
                    ...
                    if (insertNewLine) {
                        insertedPrefix = getLineDelimiter() + this.formatter.createIndentString(indent)
                            + insertedPrefix.trim() + ' ';
                    }
                    ...
                    int minimumIndent
                        = this.formatter.computeIndentInSpaces(getIndentOfLine(parent.getStartPosition()));
    ...
    private int rewriteOptionalQualifier(ASTNode parent, StructuralPropertyDescriptor property, int startPos) {
            ...
            switch (event.getChangeKind()) {
                ...
                case RewriteEvent.REMOVED: {
                    try {
                        ASTNode node = (ASTNode) event.getOriginalValue();
                        TextEditGroup editGroup = getEditGroup(event);
                        int dotEnd = getScanner().getTokenEndOffset(TerminalToken.TokenNameDOT,
                ...
                case RewriteEvent.REPLACED: {
                    ...
                    try {
                        return getScanner().getTokenEndOffset(TerminalToken.TokenNameDOT, offset + length);
                    } catch (CoreException e) {
                        handleException(e);
                    }
                    break;
        ...
        try {
            return getScanner().getTokenEndOffset(TerminalToken.TokenNameDOT, pos);
        } catch (CoreException e) {
            handleException(e);
        }
        return pos;
    ...
    private int rewriteExpressionOptionalQualifier(SwitchCase parent, StructuralPropertyDescriptor property,
        int startPos) {
        RewriteEvent event = getEvent(parent, property);
        if (event != null) {
            switch (event.getChangeKind()) {
                ...
                case RewriteEvent.REMOVED: {
                    try {
                        ASTNode node = (ASTNode) event.getOriginalValue();
                        TextEditGroup editGroup = getEditGroup(event);
                        int dotEnd = getScanner().getTokenEndOffset(TerminalToken.TokenNameCOLON,
                            node.getStartPosition() + node.getLength());
                        doTextRemoveAndVisit(startPos, dotEnd - startPos, node, editGroup);
                        return dotEnd;
                    } catch (CoreException e) {
                ...
                case RewriteEvent.REPLACED: {
                    ...
                    doTextInsert(offset, (ASTNode) event.getNewValue(), getIndent(startPos), true, editGroup);
                    try {
                        return getScanner().getTokenEndOffset(TerminalToken.TokenNameCOLON, offset + length);
                    } catch (CoreException e) {
                        handleException(e);
                    }
                    break;
        ...
        int pos = doVisit((ASTNode) node);
        try {
            return getScanner().getTokenEndOffset(TerminalToken.TokenNameCOLON, pos);
        } catch (CoreException e) {
            handleException(e);
        }
        return pos;
    ...
    class ParagraphListRewriter extends ListRewriter {
        ...
        @Override
        protected boolean mustRemoveSeparator(int originalOffset, int nodeIndex) {
            // Do not remove separator if the previous non removed node is on the same line and the next node is on
            // another line
    ...
    private int rewriteOptionalTypeParameters(ASTNode parent, StructuralPropertyDescriptor property, int offset,
        ...
        if (event != null && event.getChangeKind() != RewriteEvent.UNCHANGED) {
            ...
            try {
                ...
                if (isAllRemoved) { // all removed: set start to left bracket
                    int posBeforeOpenBracket = getScanner().getTokenStartOffset(TerminalToken.TokenNameLESS, pos);
                ...
                if (isAllRemoved) { // all removed: remove right and space up to next element
                    int endPos = getScanner().getTokenEndOffset(TerminalToken.TokenNameGREATER, pos); // set pos to '>'
        ...
        if (pos != offset) { // list contained some type -> parse after closing bracket
            try {
                return getScanner().getTokenEndOffset(TerminalToken.TokenNameGREATER, pos);
            } catch (CoreException e) {
                handleException(e);
            }
        }
    ...
    private int rewriteResourcesNodeList(ASTNode parent, StructuralPropertyDescriptor property, int pos, String keyword,
        String endKeyword, String separator) {
        RewriteEvent event = getEvent(parent, property);
        if (event != null && event.getChangeKind() != RewriteEvent.UNCHANGED) {
        ...
        if (oldDim < newDim) {
            ...
            try {
                ...
                for (int i = newDim; i < oldDim; i++) {
                    getScanner().readToToken(TerminalToken.TokenNameRBRACKET);
                }
    ...
    private int getPosAfterToken(int pos, TerminalToken token) {
        try {
            TerminalToken nextToken = getScanner().readNext(pos, true);
            if (nextToken == token) {
    ...
    private int getPosAfterLeftBrace(int pos) {
        try {
            return getPosAfterToken(pos, TerminalToken.TokenNameLBRACE);
    ...
    /*
     * Next token is a right parenthesis. Returns the offset after the parenthesis. For incomplete code, return the
     * start offset.
     */
    private int getPosAfterRightParenthesis(int pos) {
        try {
            return getPosAfterToken(pos, TerminalToken.TokenNameRPAREN);
        } catch (IllegalArgumentException e) {
            return pos;
        }
    }
    ...
    private int getPosAfterTry(int pos) {
        try {
            TerminalToken nextToken = getScanner().readNext(pos, true);
            if (nextToken == TerminalToken.TokenNametry) {
                return getScanner().getCurrentEndOffset();
            }
        } catch (CoreException e) {
            handleException(e);
    ...
    final void doTextInsert(int insertOffset, ASTNode node, int initialIndentLevel, boolean removeLeadingIndent,
        ...
        if (initialIndentLevel * this.formatter.getIndentWidth() < minimumIndentInSpaces) {
            ...
            for (int i = 0; i < markers.size(); i++) {
                ...
                int lineCount = 0;
                int totalPadding = 0;
                while (total <= offset && lineCount < lines.length) {
                    total += lines[lineCount].length() + 1;
                    String indentOfLine = this.formatter.getIndentStringWithSpaces(lines[lineCount]);
                    int indentOfLineInSpaces = this.formatter.computeIndentInSpaces(indentOfLine);
                    if (indentOfLineInSpaces < minimumIndentInSpaces) {
                        int padding = minimumIndentInSpaces - indentOfLineInSpaces;
            ...
            if (data instanceof TextEditGroup) { // tracking a node
                ...
                if (data instanceof CopyPlaceholderData) { // replace with a copy/move target
                    ...
                    if (minimumIndentInSpaces == destIndentStringInSpaces
                        && minimumIndentInSpaces % this.formatter.getIndentWidth() != 0
                        && lines.length > 1) {
                        int modTabWidth
                            = this.formatter.computeIndentInSpaces(destIndentString) % this.formatter.getIndentWidth();
                        String trimmedDestIndentString
                            = destIndentString.substring(0, destIndentString.length() - modTabWidth);
                        StringBuilder b = new StringBuilder();
                        b.append(lines[0] + "\n"); //$NON-NLS-1$
                        for (int j = 1; j < lines.length - 1; ++j) {
                            String line = lines[j];
                            if (!line.isEmpty()) {
                                String indentOfLine = this.formatter.getIndentStringWithSpaces(line);
                                if (this.formatter.computeIndentInSpaces(indentOfLine) < minimumIndentInSpaces) {
                                    line = indentOfLine + destIndentString + line.substring(indentOfLine.length());
                                } else {
                                    line = indentOfLine + trimmedDestIndentString
                                        + line.substring(indentOfLine.length());
                                }
                                b.append(line + "\n"); //$NON-NLS-1$
                            }
                        }
                        ...
                        if (this.formatter.computeIndentInSpaces(indentOfLine) < minimumIndentInSpaces) {
                            ...
                            line = indentOfLine + trimmedDestIndentString + line.substring(indentOfLine.length());
                        }
                        b.append(line);
                        code = b.toString();
                    } else {
    ...
    private String reindent(int minimumIndentInSpaces, String[] lines, int initialIndentLevel) {
        ...
        for (int i = 0; i < lines.length - 1; ++i) {
            ...
            if (!line.isEmpty()) {
                ...
                if (indentOfLineInSpaces < minimumIndentInSpaces) {
                    String indentOfLine = this.formatter.getIndentStringWithSpaces(line);
                    int padding = minimumIndentInSpaces - indentOfLineInSpaces;
                    line = indentOfLine + " ".repeat(padding) + //$NON-NLS-1$
                        line.substring(indentOfLine.length());
                }
            }
            s.append(line + "\n"); //$NON-NLS-1$
    ...
    private void rewriteModifiers(ASTNode parent, StructuralPropertyDescriptor property, int offset) {
        ...
        try {
            ...
            TerminalToken tok = scanner.readNext(offset, false);
            ...
            loop: while (true) {
                ...
                switch (tok) {
                    ...
                    case TokenNameRestrictedIdentifiersealed:
                        keep = Modifier.isSealed(newModifiers);
                        break;

                    case TokenNamenon_sealed:
                        keep = Modifier.isNonSealed(newModifiers);
                        break;
            ...
            if (addedModifiers != 0) {
                if (startPos != nextStart) {
                    int visibilityModifiers
                        = addedModifiers & (Modifier.PUBLIC | Modifier.PRIVATE | Modifier.PROTECTED);
...
//	}
    ...
    private int rewriteModifiers2(ASTNode node, ChildListPropertyDescriptor property, int pos) {
        ...
        if (property == SingleVariableDeclaration.MODIFIERS2_PROPERTY
            ...
            || property == TypeParameter.MODIFIERS_PROPERTY
        ...
        try {
            ...
            if (isAllRemove) {
                ...
                if (lastChild.getNewValue() instanceof Annotation) {
                    separator = formatterPrefix.getPrefix(getIndent(pos));
                    for (int i = 0;
                        i < this.formatter.computeIndentInSpaces(getIndentOfLine(pos)) % this.formatter.getTabWidth();
                        ++i) {
                        separator += " "; //$NON-NLS-1$
                    }
                } else {
    ...
    public boolean visit(TypeDeclaration node) {
        ...
        if (invertType) {
            try {
                TerminalToken typeToken = isInterface ? TerminalToken.TokenNameinterface : TerminalToken.TokenNameclass;
        ...
        if (!isJLS2) {
            pos = rewriteOptionalTypeParameters(node, TypeDeclaration.TYPE_PARAMETERS_PROPERTY, pos, Util.EMPTY_STRING,
                false, true);
        }
        ...
        if (!isInterface || invertType) {
            ChildPropertyDescriptor superClassProperty
                = isJLS2 ? INTERNAL_TYPE_SUPERCLASS_PROPERTY : TypeDeclaration.SUPERCLASS_TYPE_PROPERTY;
        ...
        ChildListPropertyDescriptor superInterfaceProperty
            = isJLS2 ? INTERNAL_TYPE_SUPER_INTERFACES_PROPERTY : TypeDeclaration.SUPER_INTERFACE_TYPES_PROPERTY;
    ...
    private void rewriteReturnType(MethodDeclaration node, boolean isConstructor, boolean isConstructorChange) {
        ChildPropertyDescriptor property = (node.getAST().apiLevel() == JLS2_INTERNAL)
            ? INTERNAL_METHOD_RETURN_TYPE_PROPERTY
    ...
    private int rewriteMethodReceiver(MethodDeclaration method, int offset) throws CoreException {
        offset = getScanner().getTokenEndOffset(TerminalToken.TokenNameLPAREN, offset);
        ...
        if (event != null && event.getChangeKind() != RewriteEvent.UNCHANGED) {
            ...
            if (changeKind == RewriteEvent.INSERTED) {
                ...
                if (changeKind == RewriteEvent.REMOVED) {
                    ...
                    int endPos;
                    if (oldParamCount == 0) {
                        endPos = getScanner().getTokenStartOffset(TerminalToken.TokenNameRPAREN, elemEnd);
                    } else {
                        endPos = getScanner().getTokenEndOffset(TerminalToken.TokenNameCOMMA, elemEnd);
                    }
        ...
        if (rewriteQualifier) {
            if (qualEvent != null) {
                ...
                if (qualChangeKind == RewriteEvent.INSERTED) {
                    int pos = getScanner().getTokenStartOffset(TerminalToken.TokenNamethis, offset);
                    ...
                    int endPos = getScanner().getTokenEndOffset(TerminalToken.TokenNameDOT, qualOffset);
            ...
            offset = getScanner().getTokenEndOffset(TerminalToken.TokenNamethis, offset);
    ...
    private int getPreviousTokenEndOffset(ASTNode node, TerminalToken token) {
        int offset = -1;
    ...
    public boolean visit(Dimension node) {
        ...
        if (parent.getNodeType() == ASTNode.ARRAY_TYPE) {
            ...
            if (oldAnnotationSize > 0 && newAnnotationSize == 0) { /* removed all annotations */
                int delStart = getPreviousTokenEndOffset(node, TerminalToken.TokenNameAT);
        ...
        rewriteNodeList(node, Dimension.ANNOTATIONS_PROPERTY, node.getStartPosition(),
            keywordSpace ? String.valueOf(' ') : Util.EMPTY_STRING, String.valueOf(' '), String.valueOf(' '));
        return false;
    }
    ...
    public boolean visit(MethodDeclaration node) {
        ...
        boolean isConstructor
            = ((Boolean) getOriginalValue(node, MethodDeclaration.CONSTRUCTOR_PROPERTY)).booleanValue();
        ...
        try {
            ...
            pos = getScanner().getTokenEndOffset(TerminalToken.TokenNameRPAREN, pos);
            ChildListPropertyDescriptor exceptionsProperty = apiLevel < JLS8_INTERNAL
                ? INTERNAL_METHOD_THROWN_EXCEPTIONS_PROPERTY
            ...
            if (apiLevel < JLS8_INTERNAL) {
                ...
                if ((extraDims > 0)
                    && (hasExceptionChanges
                        || bodyChangeKind == RewriteEvent.INSERTED
                        || bodyChangeKind == RewriteEvent.REMOVED)) {
                    int dim = ((Integer) getOriginalValue(node, INTERNAL_METHOD_EXTRA_DIMENSIONS_PROPERTY)).intValue();
                    while (dim > 0) {
                        pos = getScanner().getTokenEndOffset(TerminalToken.TokenNameRBRACKET, pos);
                        dim--;
                    }
                }
            } else {
        ...
        if (event != null && event.getChangeKind() != RewriteEvent.UNCHANGED) {
            ...
            try {
                ...
                if (wasOpen) {
                    ...
                    int endPos = getScanner().getTokenStartOffset(TerminalToken.TokenNamemodule, pos);
    ...
    public boolean visit(Block node) {
        ...
        int startIndent = needParentIndent
            ? (getIndent(node.getParent().getStartPosition()) + 1)
            : getIndent(node.getStartPosition()) + 1;
    ...
    public boolean visit(RecordDeclaration node) {
        ...
        pos = rewriteOptionalTypeParameters(node, RecordDeclaration.TYPE_PARAMETERS_PROPERTY, pos, Util.EMPTY_STRING,
            false, true);

        try {
            pos = getScanner().getTokenEndOffset(TerminalToken.TokenNameLPAREN, pos);
    ...
    public boolean visit(ReturnStatement node) {
        try {
            this.beforeRequiredSpaceIndex
                = getScanner().getTokenEndOffset(TerminalToken.TokenNamereturn, node.getStartPosition());
    ...
    public boolean visit(RequiresDirective node) {
        ...
        int pos = getPosAfterToken(node.getStartPosition(), TerminalToken.TokenNamerequires);
    ...
    public boolean visit(ArrayCreation node) {
        ...
        if (typeEvent != null && typeEvent.getChangeKind() == RewriteEvent.REPLACED) { // changed arraytype can have
                                                                                       // different dimension or type
                                                                                       // name
            typeReplaced = true;
        ...
        try {
            ...
            while (currentLevel != null || astLevelGTE8) {
                if (i < dimSize) {
                    ...
                    offset = getScanner().getTokenEndOffset(TerminalToken.TokenNameLBRACKET, offset);
                    if (hasDimensionChanges) {
                        RewriteEvent event = events[i];
                        int changeKind = event.getChangeKind();
                        if (changeKind == RewriteEvent.INSERTED) { // insert new dimension
                            editGroup = getEditGroup(event);
                            int endPos = getScanner().getTokenStartOffset(TerminalToken.TokenNameRBRACKET, offset);
                            doTextRemove(offset, endPos - offset, editGroup);
                            doTextInsert(offset, (ASTNode) event.getNewValue(), 0, false, editGroup);
                        } else {
                            ASTNode elem = (ASTNode) event.getOriginalValue();
                            int elemEnd = elem.getStartPosition() + elem.getLength();
                            int endPos = getScanner().getTokenStartOffset(TerminalToken.TokenNameRBRACKET, elemEnd);
                            if (changeKind == RewriteEvent.REMOVED) {
                                editGroup = getEditGroup(event);
                                doTextRemoveAndVisit(offset, endPos - offset, elem, editGroup);
                            } else if (changeKind == RewriteEvent.REPLACED) {
                ...
                i++;
                if (astLevelGTE8) {
                    if (i == replacingTypeDimensions)
                        break;
                } else {
                    if (currentLevel == replacingType)
                        break;
            ...
            if (kind == RewriteEvent.REMOVED) {
                offset = getScanner().getPreviousTokenEndOffset(TerminalToken.TokenNameLBRACE, offset);
            } else {
    ...
    private void rewriteAnnotationsOnDimension(ArrayType oldArrayType, ArrayType replacingType, int index, int pos,
        boolean typeReplaced, TextEditGroup editGroup) throws CoreException {
        if (typeReplaced) {
            ...
            if (oldDim != null) {
                ...
                if (size > 0) {
                    ...
                    int start
                        = prev != null ? prev.getStartPosition() + prev.getLength() : annotation.getStartPosition();
                    annotation = (Annotation) oldAnnotations.get(size - 1);
                    int end = annotation.getStartPosition() + annotation.getLength();
                    end = getScanner().getTokenEndOffset(TerminalToken.TokenNameLBRACKET, end) - 1;
            ...
            Dimension dim = (Dimension) replacingType.dimensions().get(index);
            rewriteNodeList(dim, Dimension.ANNOTATIONS_PROPERTY, pos, String.valueOf(' '), String.valueOf(' '),
                String.valueOf(' '));
        }
    }
    ...
    protected int retrieveRightBracketEndPosition(int offset, int count, boolean isLeftRead) throws CoreException {
        ...
        while ((token = scanner.readNext(true)) != TerminalToken.TokenNameEOF) {
            switch (token) {
    ...
    public boolean visit(BreakStatement node) {
        ...
        try {
            int offset = getScanner().getTokenEndOffset(TerminalToken.TokenNamebreak, node.getStartPosition());
            rewriteNode(node, BreakStatement.LABEL_PROPERTY, offset, ASTRewriteFormatter.SPACE); // space between break
                                                                                                 // and label
        } catch (CoreException e) {
            handleException(e);
        }
    ...
    public boolean visit(ClassInstanceCreation node) {
        ...
        if (node.getAST().apiLevel() == JLS2_INTERNAL) {
            ...
            if (isChanged(node, ClassInstanceCreation.TYPE_ARGUMENTS_PROPERTY)) {
                try {
                    pos = getScanner().getTokenEndOffset(TerminalToken.TokenNamenew, pos); // after 'new'
        ...
        if (isChanged(node, ClassInstanceCreation.ARGUMENTS_PROPERTY)) {
            try {
                int startpos = getScanner().getTokenEndOffset(TerminalToken.TokenNameLPAREN, pos);
    ...
    public boolean visit(ConstructorInvocation node) {
        ...
        if (node.getAST().apiLevel() >= JLS3_INTERNAL) {
            pos = rewriteOptionalTypeParameters(node, ConstructorInvocation.TYPE_ARGUMENTS_PROPERTY, pos,
    ...
    public boolean visit(ContinueStatement node) {
        ...
        try {
            int offset = getScanner().getTokenEndOffset(TerminalToken.TokenNamecontinue, node.getStartPosition());
            rewriteNode(node, ContinueStatement.LABEL_PROPERTY, offset, ASTRewriteFormatter.SPACE); // space between
                                                                                                    // continue and
                                                                                                    // label
        } catch (CoreException e) {
            handleException(e);
    ...
    private void visitReferenceTypeArguments(ASTNode node, StructuralPropertyDescriptor childProperty, int pos) {
        if (isChanged(node, childProperty)) {
            try {
                pos = getScanner().getTokenEndOffset(TerminalToken.TokenNameCOLON_COLON, pos);
    ...
    public boolean visit(DoStatement node) { // do statement while expression
        ...
        try {
            ...
            if (event != null && event.getChangeKind() == RewriteEvent.REPLACED) {
                int startOffset = getScanner().getTokenEndOffset(TerminalToken.TokenNamedo, pos);
                ASTNode body = (ASTNode) event.getOriginalValue();
                int bodyEnd = body.getStartPosition() + body.getLength();
                int endPos = getScanner().getTokenStartOffset(TerminalToken.TokenNamewhile, bodyEnd);
                rewriteBodyNode(node, DoStatement.BODY_PROPERTY, startOffset, endPos,
                    getIndent(node.getStartPosition()), this.formatter.DO_BLOCK); // body
            } else {
    ...
    @Override
    public boolean visit(FieldDeclaration node) { // { Modifier } Type VariableDeclarationFragment { ','
    ...
    public boolean visit(ForStatement node) {
        ...
        try {
            ...
            if (isChanged(node, ForStatement.INITIALIZERS_PROPERTY)) {
                ...
                int startOffset = getScanner().getTokenEndOffset(TerminalToken.TokenNameLPAREN, pos);
            ...
            pos = getScanner().getTokenEndOffset(TerminalToken.TokenNameSEMICOLON, pos);
            ...
            if (isChanged(node, ForStatement.UPDATERS_PROPERTY)) {
                int startOffset = getScanner().getTokenEndOffset(TerminalToken.TokenNameSEMICOLON, pos);
            ...
            if (bodyEvent != null && bodyEvent.getChangeKind() == RewriteEvent.REPLACED) {
                int startOffset = getScanner().getTokenEndOffset(TerminalToken.TokenNameRPAREN, pos);
    ...
    public boolean visit(IfStatement node) {
        ...
        if (thenEvent != null && thenEvent.getChangeKind() != RewriteEvent.UNCHANGED) {
            try {
                ...
                pos = (tok == TerminalToken.TokenNameRPAREN)
                ...
                if (elseStatement != null) {
                    ...
                    endPos = getScanner().getTokenStartOffset(TerminalToken.TokenNameelse,
                ...
                if (elseStatement == null || elseChange != RewriteEvent.UNCHANGED) {
                    pos = rewriteBodyNode(node, IfStatement.THEN_STATEMENT_PROPERTY, pos, endPos, indent,
    ...
    public boolean visit(ImportDeclaration node) {
        ...
        if (node.getAST().apiLevel() >= JLS3_INTERNAL) {
            ...
            if (event != null && event.getChangeKind() != RewriteEvent.UNCHANGED) {
                try {
                    int pos = getScanner().getTokenEndOffset(TerminalToken.TokenNameimport, node.getStartPosition());
                    boolean wasStatic = ((Boolean) event.getOriginalValue()).booleanValue();
                    if (wasStatic) {
                        int endPos = getScanner().getTokenEndOffset(TerminalToken.TokenNamestatic, pos);
                        doTextRemove(pos, endPos - pos, getEditGroup(event));
                    } else {
        ...
        if (event != null && event.getChangeKind() != RewriteEvent.UNCHANGED) {
            ...
            if (!isOnDemand) {
                ...
                try {
                    int endPos = getScanner().getTokenStartOffset(TerminalToken.TokenNameSEMICOLON, pos);
                    doTextRemove(pos, endPos - pos, getEditGroup(event));
                } catch (CoreException e) {
                    handleException(e);
                }
    ...
    public boolean visit(LambdaExpression node) {
        ...
        if (!hasParentheses) {// Parentheses can be absent if and only if there is one and only one type elided
                              // parameter.
        ...
        if (event != null) {
            ...
            if ((event = getEvent(node, LambdaExpression.PARAMETERS_PROPERTY)) != null) {// a null check though event
                                                                                         // cannot be null here
                editGroup = getEditGroup(event);
                insertParentheses = true;
            }
        ...
        if (insertParentheses) {
            ...
            try {
                int lparensEnd = getScanner().getTokenEndOffset(TerminalToken.TokenNameLPAREN, pos);
        ...
        if (isChanged(node, LambdaExpression.PARAMETERS_PROPERTY)) {
            try {
                pos = oldHasParentheses ? getScanner().getTokenEndOffset(TerminalToken.TokenNameLPAREN, pos) : pos;
        ...
        if (insertParentheses) {
            ...
            try {
                doTextRemove(pos, getScanner().getTokenEndOffset(TerminalToken.TokenNameRPAREN, pos) - pos, editGroup);
            } catch (CoreException e) {
                handleException(e);
            }
        }
    ...
    public boolean visit(MethodInvocation node) {
        ...
        if (node.getAST().apiLevel() >= JLS3_INTERNAL) {
            pos = rewriteOptionalTypeParameters(node, MethodInvocation.TYPE_ARGUMENTS_PROPERTY, pos, Util.EMPTY_STRING,
                false, false);
        }
    ...
    public boolean visit(SingleVariableDeclaration node) {
        ...
        if (apiLevel >= JLS3_INTERNAL) {
            if (isChanged(node, SingleVariableDeclaration.VARARGS_PROPERTY)) {
                ...
                if (getNewValue(node, SingleVariableDeclaration.VARARGS_PROPERTY).equals(Boolean.TRUE)) {
                    if (apiLevel >= JLS8_INTERNAL) {
                        pos = rewriteVarargsAnnotations(node, SingleVariableDeclaration.VARARGS_ANNOTATIONS_PROPERTY,
                            pos);
                    }
                    int indent = getIndent(node.getStartPosition());
        ...
        if (apiLevel < JLS8_INTERNAL) {
            ...
            if (extraDims > 0) {
                ...
                if (kind == RewriteEvent.REMOVED) {
                    try {
                        pos = getScanner().getPreviousTokenEndOffset(TerminalToken.TokenNameEQUAL, pos);
                    } catch (CoreException e) {
                        handleException(e);
                    }
                } else {
    ...
    public boolean visit(SuperConstructorInvocation node) {
        ...
        int pos
            = rewriteOptionalQualifier(node, SuperConstructorInvocation.EXPRESSION_PROPERTY, node.getStartPosition());

        if (node.getAST().apiLevel() >= JLS3_INTERNAL) {
            pos = rewriteOptionalTypeParameters(node, SuperConstructorInvocation.TYPE_ARGUMENTS_PROPERTY, pos,
                Util.EMPTY_STRING, false, false);
        }
    ...
    public boolean visit(SuperMethodInvocation node) {
        ...
        if (node.getAST().apiLevel() >= JLS3_INTERNAL) {
            if (isChanged(node, SuperMethodInvocation.TYPE_ARGUMENTS_PROPERTY)) {
                try {
                    pos = getScanner().getTokenEndOffset(TerminalToken.TokenNameDOT, pos);
    ...
    public boolean visit(SwitchCase node) {
        ...
        if (node.getAST().apiLevel() >= JLS14_INTERNAL) {
            int pos = node.expressions().size() == 0
                ? node.getStartPosition()
                : rewriteNodeList(node, SwitchCase.EXPRESSIONS2_PROPERTY, node.getStartPosition(), Util.EMPTY_STRING,
                    ", "); //$NON-NLS-1$
            if (isChanged(node, SwitchCase.SWITCH_LABELED_RULE_PROPERTY)) {
                ...
                try {
                    int tokenEnd;
                    TerminalToken oldToken;
                    String newVal;
                    if (getNewValue(node, SwitchCase.SWITCH_LABELED_RULE_PROPERTY).equals(Boolean.TRUE)) {
                        oldToken = TerminalToken.TokenNameCOLON;
                        newVal = "->"; //$NON-NLS-1$
                    } else {
                        oldToken = TerminalToken.TokenNameARROW;
                        newVal = ":"; //$NON-NLS-1$
                    }
    ...
    class SwitchListLabeledRuleRewriter extends SwitchListRewriter {
        ...
        protected String getSeparatorString(int nodeIndex, int nextNodeIndex) {
            ...
            String spaceDelim = JavaCore.INSERT.equals(ASTRewriteAnalyzer.this.options
                .get(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_ARROW_IN_SWITCH_CASE)) ? " " : ""; //$NON-NLS-1$ //$NON-NLS-2$
        ...
        protected int getNodeIndent(int nodeIndex) {
            ...
            if (this.indentSwitchStatementsCompareToCases) {
                ...
                if (node.getNodeType() != ASTNode.SWITCH_CASE) {
                    ...
                    if (prevNode.getNodeType() == ASTNode.SWITCH_CASE
                        && ((SwitchCase) prevNode).isSwitchLabeledRule()) {
                        return 0;
                    } else {
                        indent++;
                    }
        ...
        private boolean isSwitchLabeledRule(int nodeIndex, int nextNodeIndex) {
            ...
            ASTNode next = getNode(nodeIndex + 1);
            int currKind = curr.getNodeType();
            if (currKind == ASTNode.SWITCH_CASE
                && next instanceof Statement
                && ((SwitchCase) curr).isSwitchLabeledRule()) {
                return true;
            }
            return false;
        }
    ...
    public boolean visit(ThrowStatement node) {
        try {
            this.beforeRequiredSpaceIndex
                = getScanner().getTokenEndOffset(TerminalToken.TokenNamethrow, node.getStartPosition());
    ...
    public boolean visit(TryStatement node) {
        ...
        if (level >= JLS4_INTERNAL) {
            StructuralPropertyDescriptor desc
                = level < JLS9_INTERNAL ? INTERNAL_TRY_STATEMENT_RESOURCES_PROPERTY : TryStatement.RESOURCES2_PROPERTY;
    ...
    public boolean visit(AnnotationTypeMemberDeclaration node) {
        ...
        try {
            ...
            rewriteNode(node, AnnotationTypeMemberDeclaration.DEFAULT_PROPERTY, pos,
                this.formatter.ANNOT_MEMBER_DEFAULT);
        } catch (CoreException e) {
            handleException(e);
        }
        return false;
    ...
    public boolean visit(EnhancedForStatement node) {
        ...
        if (bodyEvent != null && bodyEvent.getChangeKind() == RewriteEvent.REPLACED) {
            int startOffset;
            try {
                startOffset = getScanner().getTokenEndOffset(TerminalToken.TokenNameRPAREN, pos);
    ...
    public boolean visit(EnumConstantDeclaration node) {
        ...
        if (argsEvent != null && argsEvent.getChangeKind() != RewriteEvent.UNCHANGED) {
            ...
            try {
                TerminalToken nextTok = getScanner().readNext(pos, true);
                boolean hasParents = (nextTok == TerminalToken.TokenNameLPAREN);
    ...
    public boolean visit(EnumDeclaration node) {
        ...
        if (bodyEvent != null && bodyEvent.getChangeKind() != RewriteEvent.UNCHANGED) {
            ...
            try {
                ...
                TerminalToken token = getScanner().readNext(pos, true);
                boolean hasSemicolon = token == TerminalToken.TokenNameSEMICOLON;
                if (!hasSemicolon && isAllOfKind(children, RewriteEvent.INSERTED)) {
                    ...
                    if (token == TerminalToken.TokenNameCOMMA) {
                        ...
                        TerminalToken nextToken = getScanner().readNext(endPos, true);
                        if (nextToken != TerminalToken.TokenNameSEMICOLON) {
    ...
    public boolean visit(ModuleModifier node) {
        ...
        String newText = getNewValue(node, ModuleModifier.KEYWORD_PROPERTY).toString(); // type
    ...
    public boolean visit(ParameterizedType node) {
        ...
        if (isChanged(node, ParameterizedType.TYPE_ARGUMENTS_PROPERTY)) {
            // eval position after opening parent
            try {
                int startOffset = getScanner().getTokenEndOffset(TerminalToken.TokenNameLESS, pos);
        ...
        try {
            ...
            if (boundKindChange != RewriteEvent.UNCHANGED) {
                ...
                if (boundTypeChange != RewriteEvent.INSERTED && boundTypeChange != RewriteEvent.REMOVED) {
                    ...
                    doTextReplace(pos, type.getStartPosition() - pos, str,
                        getEditGroup(node, WildcardType.BOUND_PROPERTY));
                }
            }
    ...
    public boolean visit(YieldStatement node) {
        ...
        try {
            int offset = node.isImplicit()
                ? node.getStartPosition()
                : getScanner().getTokenEndOffset(TerminalToken.TokenNameSEMICOLON, node.getStartPosition());
            if ((node.getAST().apiLevel() >= JLS14_INTERNAL)) {
                rewriteNode(node, YieldStatement.EXPRESSION_PROPERTY, offset, ASTRewriteFormatter.SPACE); // space
                                                                                                          // between
                                                                                                          // yield and
                                                                                                          // label
            }
