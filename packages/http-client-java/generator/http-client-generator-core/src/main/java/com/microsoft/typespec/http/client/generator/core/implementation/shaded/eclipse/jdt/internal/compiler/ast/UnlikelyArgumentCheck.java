...
public class UnlikelyArgumentCheck {
    ...
    public static UnlikelyArgumentCheck createUnlikelyArgumentCheck(DangerousMethod dangerousMethod,
        TypeBinding typeToCheck, TypeBinding expectedType, TypeBinding typeToReport) {
        return typeToCheck == null
            ? null
            : new UnlikelyArgumentCheck(dangerousMethod, typeToCheck, expectedType, typeToReport);
    }
    ...
    public boolean isDangerous(BlockScope currentScope) {
        ...
        if (this.dangerousMethod != DangerousMethod.Equals
            && currentScope.compilerOptions().reportUnlikelyCollectionMethodArgumentTypeStrict) {
        ...
        if (typeToCheck2.isCapture()
            || !typeToCheck2.isTypeVariable()
            || expectedType2.isCapture()
            ...
            if (paramTypeId == TypeIds.T_JavaLangObject) {
                switch (suspect) {
                    ...
                    case Remove:
                        ...
                        ReferenceBinding mapType
                            = actualReceiverType.findSuperTypeOriginatingFrom(TypeIds.T_JavaUtilMap, false);
            ...
            if (paramTypeId == TypeIds.T_JavaLangObject) {
                switch (suspect) {
                    ...
                    case Contains:
                        ...
                        ReferenceBinding collectionType
                            = actualReceiverType.findSuperTypeOriginatingFrom(TypeIds.T_JavaUtilCollection, false);
                ...
                switch (suspect) {
                    ...
                    case RetainAll:
                        ...
                        ReferenceBinding collectionType
                            = actualReceiverType.findSuperTypeOriginatingFrom(TypeIds.T_JavaUtilCollection, false);
                        ReferenceBinding argumentCollectionType
                            = argumentType.findSuperTypeOriginatingFrom(TypeIds.T_JavaUtilCollection, false);
                        if (collectionType != null
                            && argumentCollectionType != null
                    ...
                    switch (suspect) {
                        ...
                        case LastIndexOf:
                            ...
                            ReferenceBinding listType
                                = actualReceiverType.findSuperTypeOriginatingFrom(TypeIds.T_JavaUtilList, false);
    ...
    public static /* @Nullable */ UnlikelyArgumentCheck determineCheckForStaticTwoArgumentMethod(
        TypeBinding secondParameter, Scope scope, char[] selector, TypeBinding firstParameter, TypeBinding[] parameters,
