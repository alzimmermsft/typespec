...
public abstract class FluentFuture<V extends @Nullable Object> extends GwtFluentFutureCatchingSpecialization<V> {
     ...
     */
    abstract static class TrustedFuture<V extends @Nullable Object> extends FluentFuture<V> implements Trusted<V> {
     ...
     * // counters.
     *     ListenableFuture<Integer> faultTolerantFuture
     *         = fetchCounters().catchingAsync(FetchException.class, x -> immediateFuture(0), directExecutor());
     * }
     * </pre>
     *
     ...
     * // TimeoutException.
     *     ListenableFuture<Integer> faultTolerantFuture = fetchCounters().catchingAsync(FetchException.class, e -> {
