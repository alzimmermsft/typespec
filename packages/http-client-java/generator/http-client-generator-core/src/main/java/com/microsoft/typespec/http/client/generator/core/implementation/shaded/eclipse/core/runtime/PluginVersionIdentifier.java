...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.runtime.CommonMessages;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.runtime.IRuntimeConstants;
 ...
 * @deprecated clients should use {@link Version} instead
 */
...
public final class PluginVersionIdentifier {
    ...
    public boolean isGreaterOrEqualTo(PluginVersionIdentifier id) {
        ...
        if ((getMajorComponent() == id.getMajorComponent())
            && (getMinorComponent() == id.getMinorComponent())
    ...
    public boolean isGreaterThan(PluginVersionIdentifier id) {
        ...
        if (id == null) {
            if (getMajorComponent() == 0
                && getMinorComponent() == 0
                && getServiceComponent() == 0
                && getQualifierComponent().isEmpty()) {
                return false;
            }
            return true;
        }
