...
class AnnotationBinding implements IAnnotationBinding {
    ...
    AnnotationBinding(
        com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.AnnotationBinding annotation,
    ...
    public IMemberValuePairBinding[] getAllMemberValuePairs() {
        ...
        for (int i = 0; i < methodLength; i++) {
            ...
            allPairs[i] = pair == null
                ? new DefaultValuePairBinding(methods[i], this.bindingResolver)
                : (IMemberValuePairBinding) pair;
        }
        return allPairs;
    }
        ...
        switch (parent.getNodeType()) {
            ...
            case ASTNode.FIELD_DECLARATION:
                VariableDeclarationFragment fragment
                    = (VariableDeclarationFragment) ((FieldDeclaration) parent).fragments().get(0);
    ...
    private String getRecipientKey() {
        ...
        switch (recipient.getNodeType()) {
            ...
            case ASTNode.FIELD_DECLARATION:
                VariableDeclarationFragment fragment
                    = (VariableDeclarationFragment) ((FieldDeclaration) recipient).fragments().get(0);
