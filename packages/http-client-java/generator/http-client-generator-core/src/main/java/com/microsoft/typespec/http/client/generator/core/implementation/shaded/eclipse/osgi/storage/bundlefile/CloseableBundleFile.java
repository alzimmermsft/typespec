...
public abstract class CloseableBundleFile<E> extends BundleFile {
        ...
        try {
            ...
            if (generation != null) {
                ...
                if (r != null) {
                    ...
                    generation.getBundleInfo()
                        .getStorage()
                        .getAdaptor()
                        .publishContainerEvent(eventType, r.getRevisions().getModule(), e);
                }
            }
        ...
        try {
            ...
            try {
                ...
                generation.getBundleInfo()
                    .getStorage()
                    .getLogServices()
                    .log(EquinoxContainer.NAME, FrameworkLogEntry.ERROR,
    ...
    public boolean containsDir(String dir) {
        ...
        try {
            ...
            if (!dir.isEmpty() && dir.charAt(dir.length() - 1) != '/')
                dir = dir + '/';
