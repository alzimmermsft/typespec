...
public class SourceModuleBinding extends ModuleBinding {
    ...
    public void setImplementations(TypeBinding infBinding, Collection<TypeBinding> resolvedImplementations) {
        ...
        this.implementations.put(infBinding,
            resolvedImplementations.toArray(new TypeBinding[resolvedImplementations.size()]));
    }
    ...
    public PlainPackageBinding[] getExports() {
        // don't rely on "if (this.exportedPackages == Binding.NO_PACKAGES)" - could have been modified by
        // completeIfNeeded()
    ...
    public PlainPackageBinding[] getOpens() {
        // don't rely on "if (this.openedPackages == Binding.NO_PACKAGES)" - could have been modified by
        // completeIfNeeded()
        this.scope.referenceContext.moduleDeclaration.resolvePackageDirectives(this.scope);
