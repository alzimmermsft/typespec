...
public class ClientCoreExceptionTemplate extends ExceptionTemplate {
    ...
    public void write(ClientException exception, JavaFile javaFile) {
        javaFile.declareImport(ClassType.RESPONSE.getFullName(), ClassType.BINARY_DATA.getFullName());
        ...
        javaFile.publicFinalClass(exception.getName() + " extends " + exception.getParentType(), classBlock -> {
            ...
            classBlock.publicConstructor(exception.getName() + "(String message, Response<BinaryData> response)",
                constructorBlock -> constructorBlock.line("super(message, response, null);"));
            ...
            classBlock
                .publicConstructor(
                    String.format("%1$s(String message, Response<BinaryData> response, %2$s value)",
                        exception.getName(), exception.getErrorName()),
