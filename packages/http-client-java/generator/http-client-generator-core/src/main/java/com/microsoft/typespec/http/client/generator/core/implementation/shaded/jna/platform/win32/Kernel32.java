...
public interface Kernel32 extends StdCallLibrary, WinNT, Wincon {
     ...
     */
    boolean ReadFile(HANDLE hFile, byte[] lpBuffer, int nNumberOfBytesToRead, IntByReference lpNumberOfBytesRead,
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms724390(v=vs.85).aspx">GetSystemTime
     * documentation</a>
     */
     ...
     * information.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms724942(v=vs.85).aspx">SetSystemTime
     * documentation</a>
     */
     ...
     * local date and time.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms724338(v=vs.85).aspx">GetLocalTime
     * documentation</a>
     */
     ...
     * If the function fails, call {@link #GetLastError()} to get extended error
     * information.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms724936(v=vs.85).aspx">SetLocalTime
     * documentation</a>
     */
     ...
     * If the function fails, call {@link #GetLastError()} to get extended error
     * information.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms724400(v=vs.85).aspx">GetSystemTimes
     * documentation</a>
     */
     ...
     */
    int FormatMessage(int dwFlags, Pointer lpSource, int dwMessageId, int dwLanguageId, PointerByReference lpBuffer,
     ...
     * call GetLastError.
     */
    HANDLE CreateFile(String lpFileName, int dwDesiredAccess, int dwShareMode, SECURITY_ATTRIBUTES lpSecurityAttributes,
     ...
     */
    HANDLE CreateIoCompletionPort(HANDLE FileHandle, HANDLE ExistingCompletionPort, Pointer CompletionKey,
    ...
    boolean GetQueuedCompletionStatus(HANDLE CompletionPort, IntByReference lpNumberOfBytes,
        ULONG_PTRByReference lpCompletionKey, PointerByReference lpOverlapped, int dwMilliseconds);
     ...
     * information, call GetLastError .
     */
    boolean PostQueuedCompletionStatus(HANDLE CompletionPort, int dwNumberOfBytesTransferred, Pointer dwCompletionKey,
        OVERLAPPED lpOverlapped);
     ...
     * information, call GetLastError.
     */
    boolean DuplicateHandle(HANDLE hSourceProcessHandle, HANDLE hSourceHandle, HANDLE hTargetProcessHandle,
        HANDLEByReference lpTargetHandle, int dwDesiredAccess, boolean bInheritHandle, int dwOptions);
     ...
     */
    public boolean ReadDirectoryChangesW(HANDLE directory, FILE_NOTIFY_INFORMATION info, int length,
        boolean watchSubtree, int notifyFilter, IntByReference bytesReturned, OVERLAPPED overlapped,
     ...
     * the GetLastError function.
     */
    boolean WriteFile(HANDLE hFile, byte[] lpBuffer, int nNumberOfBytesToWrite, IntByReference lpNumberOfBytesWritten,
        OVERLAPPED lpOverlapped);
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364439(v=vs.85).aspx">FlushFileBuffers
     * documentation</a>
     */
     ...
     * information, call GetLastError.
     */
    HANDLE CreateEvent(SECURITY_ATTRIBUTES lpEventAttributes, boolean bManualReset, boolean bInitialState,
        String lpName);
     ...
     * GetLastError.
     */
    HANDLE CreateFileMapping(HANDLE hFile, SECURITY_ATTRIBUTES lpAttributes, int flProtect, int dwMaximumSizeHigh,
     ...
     * @return If the function succeeds, the return value is nonzero.
     */
    boolean CreateProcessW(String lpApplicationName, char[] lpCommandLine, SECURITY_ATTRIBUTES lpProcessAttributes,
        SECURITY_ATTRIBUTES lpThreadAttributes, boolean bInheritHandles, DWORD dwCreationFlags, Pointer lpEnvironment,
        String lpCurrentDirectory, STARTUPINFO lpStartupInfo, PROCESS_INFORMATION lpProcessInformation);
     ...
     * descriptor.</p>
     *
     * @param fInherit If this value is TRUE, processes created by this process will inherit the handle. Otherwise, the
     * processes do not inherit this handle.
     *
     * @param IDProcess
     ...
     * information, call GetLastError.
     */
    boolean GetFileInformationByHandleEx(HANDLE hFile, int FileInformationClass, Pointer lpFileInformation,
        DWORD dwBufferSize);
     ...
     */
    boolean SetFileInformationByHandle(HANDLE hFile, int FileInformationClass, Pointer lpFileInformation,
        DWORD dwBufferSize);
     ...
     * information, call GetLastError.
     */
    boolean GetFileTime(HANDLE hFile, FILETIME lpCreationTime, FILETIME lpLastAccessTime, FILETIME lpLastWriteTime);
     ...
     * information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364935(v=vs.85).aspx">GetDiskFreeSpace</a>
     */
    boolean GetDiskFreeSpace(String lpRootPathName, DWORDByReference lpSectorsPerCluster,
        DWORDByReference lpBytesPerSector, DWORDByReference lpNumberOfFreeClusters,
     ...
     * information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364937(v=vs.85).aspx">GetDiskFreeSpaceEx</a>
     */
    boolean GetDiskFreeSpaceEx(String lpDirectoryName, LARGE_INTEGER lpFreeBytesAvailable,
        LARGE_INTEGER lpTotalNumberOfBytes, LARGE_INTEGER lpTotalNumberOfFreeBytes);
     ...
     * information, call GetLastError.
     */
    public boolean CreatePipe(HANDLEByReference hReadPipe, HANDLEByReference hWritePipe,
     ...
     * @return {@code true} if successful, {@code false} otherwise.
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365144(v=vs.85).aspx">CallNamedPipe
     * documentation</a>
     */
    public boolean CallNamedPipe(String lpNamedPipeName, byte[] lpInBuffer, int nInBufferSize, byte[] lpOutBuffer,
        int nOutBufferSize, IntByReference lpBytesRead, int nTimeOut);
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365146(v=vs.85).aspx">ConnectNamedPipe
     * documentation</a>
     */
     ...
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365150(v=vs.85).aspx">CreateNamedPipe
     * documentation</a>
     */
    public HANDLE CreateNamedPipe(String lpName, int dwOpenMode, int dwPipeMode, int nMaxInstances, int nOutBufferSize,
     ...
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365166(v=vs.85).aspx">DisconnectNamedPipe
     * documentation</a>
     */
     ...
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365437(v=vs.85).aspx">GetNamedPipeClientComputerName
     * documentation</a>
     */
     ...
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365440(v=vs.85).aspx">GetNamedPipeClientProcessId
     * documentation</a>
     */
     ...
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365442(v=vs.85).aspx">GetNamedPipeClientProcessId
     * documentation</a>
     */
     ...
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365443(v=vs.85).aspx">GetNamedPipeHandleState
     * documentation</a>
     */
    public boolean GetNamedPipeHandleState(HANDLE hNamedPipe, IntByReference lpState, IntByReference lpCurInstances,
        IntByReference lpMaxCollectionCount, IntByReference lpCollectDataTimeout, char[] lpUserName,
     ...
     * @return {@code true} if successful, {@code false} otherwise.
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365445(v=vs.85).aspx">GetNamedPipeInfo
     * documentation</a>
     */
    public boolean GetNamedPipeInfo(HANDLE hNamedPipe, IntByReference lpFlags, IntByReference lpOutBufferSize,
        IntByReference lpInBufferSize, IntByReference lpMaxInstances);
     ...
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365446(v=vs.85).aspx">GetNamedPipeServerProcessId
     * documentation</a>
     */
     ...
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365569(v=vs.85).aspx">GetNamedPipeServerSessionId
     * documentation</a>
     */
     ...
     * @return {@code true} if successful, {@code false} otherwise.
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365779(v=vs.85).aspx">PeekNamedPipe
     * documentation</a>
     */
    public boolean PeekNamedPipe(HANDLE hNamedPipe, byte[] lpBuffer, int nBufferSize, IntByReference lpBytesRead,
        IntByReference lpTotalBytesAvail, IntByReference lpBytesLeftThisMessage);
     ...
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365787(v=vs.85).aspx">SetNamedPipeHandleState
     * documentation</a>
     */
     ...
     * @return {@code true} if successful, {@code false} otherwise.
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365790(v=vs.85).aspx">TransactNamedPipe
     * documentation</a>
     */
    public boolean TransactNamedPipe(HANDLE hNamedPipe, byte[] lpInBuffer, int nInBufferSize, byte[] lpOutBuffer,
        int nOutBufferSize, IntByReference lpBytesRead, OVERLAPPED lpOverlapped);
     ...
     * @return {@code true} if successful, {@code false} otherwise.
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365800(v=vs.85).aspx">WaitNamedPipe
     * documentation</a>
     */
     ...
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms683187(v=vs.85).aspx">GetEnvironmentStrings
     * documentation</a>
     */
     ...
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms683151(v=vs.85).aspx">FreeEnvironmentStrings
     * documentation</a>
     */
     ...
     * </p>
     */
    DWORD GetPrivateProfileString(String lpAppName, String lpKeyName, String lpDefault, char[] lpReturnedString,
     ...
     * information, call GetLastError.
     */
    boolean FileTimeToLocalFileTime(FILETIME lpFileTime, FILETIME lpLocalFileTime);
     ...
     * @return status
     */
    boolean SystemTimeToTzSpecificLocalTime(TIME_ZONE_INFORMATION lpTimeZone, SYSTEMTIME lpUniversalTime,
     ...
     * 
     * @param lpFileTime
     * [in] A pointer to a FILETIME structure containing the file time to be converted to system (UTC) date and time
     * format.
     ...
     */
    @Deprecated
    HANDLE CreateRemoteThread(HANDLE hProcess, SECURITY_ATTRIBUTES lpThreadAttributes, int dwStackSize,
        FOREIGN_THREAD_START_ROUTINE lpStartAddress, Pointer lpParameter, DWORD dwCreationFlags, Pointer lpThreadId);
     ...
     * If the function fails, the return value is {@code null}. To get extended
     * error information, call {@link #GetLastError()}.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms682437(v=vs.85).aspx">CreateRemoteThread
     * documentation</a>
     */
    HANDLE CreateRemoteThread(HANDLE hProcess, SECURITY_ATTRIBUTES lpThreadAttributes, int dwStackSize,
        Pointer lpStartAddress, Pointer lpParameter, int dwCreationFlags, DWORDByReference lpThreadId);
     ...
     * @return {@code true} if successful, {@code false} otherwise.
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms681674(v=vs.85).aspx">WriteProcessMemory
     * documentation</a>
     */
    boolean WriteProcessMemory(HANDLE hProcess, Pointer lpBaseAddress, Pointer lpBuffer, int nSize,
     ...
     */
    boolean ReadProcessMemory(HANDLE hProcess, Pointer lpBaseAddress, Pointer lpBuffer, int nSize,
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa366907(v=vs.85).aspx">VirtualQueryEx
     * documentation</a>
     */
     ...
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa363904(v=vs.85).aspx">DefineDosDevice</a>
     */
     ...
     * @return If the function succeeds, the return value is a search handle used in a subsequent call to FindNextFile
     * or FindClose,
    ...
    /**
     * Searches a directory for a file or subdirectory with a name and attributes that match those specified. For the
     * most basic
     ...
     * ERROR_FILE_NOT_FOUND.
     */
    HANDLE FindFirstFileEx(String lpFileName, int fInfoLevelId, Pointer lpFindFileData, int fSearchOp,
        Pointer lpSearchFilter, DWORD dwAdditionalFlags);
     ...
     * To get extended error information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364426(v=vs.85).aspx">FindFirstVolumeMountPoint</a>
     */
     ...
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364432(v=vs.85).aspx">FindNextVolumeMountPoint</a>
     */
     ...
     * to get extended error information
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364435(v=vs.85).aspx">FindVolumeMountPointClose</a>
     */
     ...
     * to get extended error information
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364994(v=vs.85).aspx">GetVolumeNameForVolumeMountPoint</a>
     */
     ...
     * to get extended error information
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365561(v=vs.85).aspx">SetVolumeMountPoint</a>
     */
     ...
     * to get extended error information
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa363927(v=vs.85).aspx">DeleteVolumeMountPoint</a>
     */
     ...
     * to get extended error information
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364993(v=vs.85).aspx">GetVolumeInformation</a>
     */
    boolean GetVolumeInformation(String lpRootPathName, char[] lpVolumeNameBuffer, int nVolumeNameSize,
        IntByReference lpVolumeSerialNumber, IntByReference lpMaximumComponentLength, IntByReference lpFileSystemFlags,
     ...
     * to get extended error information
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364996(v=vs.85).aspx">GetVolumePathName</a>
     */
     ...
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364998(v=vs.85).aspx">GetVolumePathNamesForVolumeName</a>
     */
    boolean GetVolumePathNamesForVolumeName(String lpszVolumeName, char[] lpszVolumePathNames, int cchBufferLength,
     ...
     * extended error information, call {@link #GetLastError()}.
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364425(v=vs.85).aspx">FindFirstVolume</a>
     ...
     * to get extended error information
     * @see <a
     * href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364433(v=vs.85).aspx">FindVolumeClose</a>
     */
     ...
     * The
     * {@link Kernel32#CreateFile(String, int, int, SECURITY_ATTRIBUTES, int, int, HANDLE)}
     ...
     * 
     * <pre>
     * <code>BOOL ProcessIdToSessionId(_In_ DWORD dwProcessId, _Out_ DWORD *pSessionId);</code>
     * </pre>
     * 
     * <br>
     *
     ...
     *
     * <ul>
     * <li>{@link WinBase#ES_AWAYMODE_REQUIRED}</li>
     * <li>{@link WinBase#ES_CONTINUOUS}</li>
     * <li>{@link WinBase#ES_DISPLAY_REQUIRED}</li>
     * <li>{@link WinBase#ES_SYSTEM_REQUIRED}</li>
     * <li>{@link WinBase#ES_USER_PRESENT}</li>
     * </ul>
     *
     ...
     */
    HANDLE CreateMutex(SECURITY_ATTRIBUTES lpMutexAttributes, boolean bInitialOwner, String lpName);
     ...
     */
    HANDLE OpenMutex(int dwDesiredAccess, boolean bInheritHandle, String lpName);
     ...
     * </tr>
     * <tr><td>RESTART_NO_CRASH (1)</td><td>Do not restart the process if it terminates due to an unhandled
     * exception.</td></tr>
     * <tr><td>RESTART_NO_HANG (2)</td><td>Do not restart the process if it terminates due to the application not
     * responding.</td></tr>
     * <tr><td>RESTART_NO_PATCH (4)</td><td>Do not restart the process if it terminates due to the installation of an
     * update.</td></tr>
     * <tr><td>RESTART_NO_REBOOT (8)</td><td>Do not restart the process if the computer is restarted as the result of an
     * update. </td></tr>
     * </table>
     *
     ...
     *
     * @see <A
     * HREF="https://docs.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase-registerapplicationrestart">MSDN
     * Entry</A>
     */
     ...
     *
     * @see <A
     * HREF="https://docs.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase-unregisterapplicationrestart">MSDN
     * Entry</A>
     */
     ...
     *
     * @see <A
     * HREF="https://docs.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase-getapplicationrestartsettings">MSDN
     * Entry</A>
     */
    HRESULT GetApplicationRestartSettings(HANDLE hProcess, char[] pwzCommandline, IntByReference pcchSize,
