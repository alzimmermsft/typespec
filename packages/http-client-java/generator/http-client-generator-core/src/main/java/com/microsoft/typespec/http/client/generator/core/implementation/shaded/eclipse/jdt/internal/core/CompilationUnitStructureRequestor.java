...
protected IAnnotation acceptAnnotation(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Annotation annotation, AnnotatableInfo parentInfo, JavaElement parentHandle) {
...
private SourceMethodElementInfo createMethodInfo(MethodInfo methodInfo, SourceMethod handle) {
	...
	if (methodInfo.annotations != null) {
		...
		for (int i = 0; i < length; i++) {
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Annotation annotation = methodInfo.annotations[i];
			acceptAnnotation(annotation, info, handle);
		}
	}
...
private ModuleDescriptionInfo createModuleInfo(ModuleInfo modInfo, SourceModule handle) {
	...
	if (modInfo.annotations != null) {
		...
		for (int i = 0; i < length; i++) {
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Annotation annotation = modInfo.annotations[i];
			acceptAnnotation(annotation, info, handle);
		}
	}
	this.newElements.put(handle, info);
...
private SourceTypeElementInfo createTypeInfo(TypeInfo typeInfo, SourceType handle) {
	...
	if (typeInfo.annotations != null) {
		...
		this.unitInfo.annotationNumber += length;
		for (int i = 0; i < length; i++) {
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Annotation annotation = typeInfo.annotations[i];
			acceptAnnotation(annotation, info, handle);
		}
	}
...
public void exitField(int initializationStart, int declarationEnd, int declarationSourceEnd) {
	...
	if (fieldInfo.annotations != null) {
		...
		this.unitInfo.annotationNumber += length;
		for (int i = 0; i < length; i++) {
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Annotation annotation = fieldInfo.annotations[i];
			acceptAnnotation(annotation, info, handle);
		}
	}
...
public void exitMethod(int declarationEnd, Expression defaultValue) {
	...
	if (info.isAnnotationMethod() && defaultValue != null) {
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.MemberValuePair defaultMemberValuePair = new org.eclipse.jdt.internal.core.MemberValuePair(element.getElementName());
...
protected IMemberValuePair getMemberValuePair(MemberValuePair memberValuePair) {
	...
	com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.MemberValuePair result = new org.eclipse.jdt.internal.core.MemberValuePair(memberName);
 ...
 */
protected Object getMemberValue(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.MemberValuePair memberValuePair, Expression expression) {
	if (expression instanceof NullLiteral) {
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Annotation annotation = (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Annotation) expression;
