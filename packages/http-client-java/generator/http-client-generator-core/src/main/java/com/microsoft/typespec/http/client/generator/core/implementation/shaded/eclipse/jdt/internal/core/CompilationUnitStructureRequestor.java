...
public class CompilationUnitStructureRequestor extends ReferenceInfoAdapter implements ISourceElementRequestor {
    ...
    protected CompilationUnitStructureRequestor(ICompilationUnit unit, CompilationUnitElementInfo unitInfo,
    ...
    public void acceptPackage(ImportReference importReference) {
        ...
        if (importReference.annotations != null) {
            for (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Annotation annotation : importReference.annotations) {
    ...
    protected IAnnotation acceptAnnotation(
        ...
        Annotation handle = createAnnotation(parentHandle, nameString); // NB: occurenceCount is computed in
                                                                        // resolveDuplicates
        resolveDuplicates(handle);
    ...
    private LocalVariable[] acceptMethodParameters(AbstractVariableDeclaration[] arguments, JavaElement methodHandle,
        ...
        for (int i = 0; i < arguments.length; i++) {
            ...
            String paramTypeSig
                = DeduplicationUtil.intern(Signature.createTypeSignature(methodInfo.parameterTypes[i], false));
            result[i] = new LocalVariable(methodHandle, DeduplicationUtil.toString(argument.name),
                argument.declarationSourceStart, argument.declarationSourceEnd, argument.sourceStart,
                argument.sourceEnd, paramTypeSig, argument.annotations, argument.modifiers, true);
            ...
            if (argument.annotations != null) {
                ...
                for (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Annotation annotation : argument.annotations) {
    ...
    private ModuleDescriptionInfo createModuleInfo(ModuleInfo modInfo, SourceModule handle) {
    ...
    protected void acceptTypeParameter(TypeParameterInfo typeParameterInfo, JavaElementInfo parentInfo) {
        ...
        TypeParameter handle = createTypeParameter(parentHandle, nameString); // NB: occurenceCount is computed in
                                                                              // resolveDuplicates
        resolveDuplicates(handle);
    ...
    public void exitField(int initializationStart, int declarationEnd, int declarationSourceEnd) {
        ...
        SourceFieldElementInfo info
            = elements.length == 0 ? new SourceFieldElementInfo() : new SourceFieldWithChildrenInfo(elements);
    ...
    public void exitInitializer(int declarationEnd) {
        ...
        InitializerElementInfo info
            = elements.length == 0 ? new InitializerElementInfo() : new InitializerWithChildrenInfo(elements);
    ...
    public void exitMethod(int declarationEnd, Expression defaultValue) {
        ...
        if (info.isAnnotationMethod() && defaultValue != null) {
            ...
            com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.MemberValuePair defaultMemberValuePair
                = new org.eclipse.jdt.internal.core.MemberValuePair(element.getElementName());
    ...
    public void exitModule(int declarationEnd) {
        ...
        if (proj != null) {
            try {
                ...
                ModuleDescriptionInfo info = createModuleInfo(moduleInfo, moduleDecl);
                info.setSourceRangeEnd(declarationEnd);
    ...
    protected IMemberValuePair getMemberValuePair(MemberValuePair memberValuePair) {
        ...
        com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.MemberValuePair result
            = new org.eclipse.jdt.internal.core.MemberValuePair(memberName);
