 ...
 * {
 *     &#64;code
 *     ListMultimap<UserId, ErrorResponse> errorsByUser = MultimapBuilder.linkedHashKeys().arrayListValues().build();
...
public abstract class MultimapBuilder<K0 extends @Nullable Object, V0 extends @Nullable Object> {
     ...
     * is not serializable.
     */
    public static <K0 extends @Nullable Object> MultimapBuilderWithKeys<K0> treeKeys(Comparator<K0> comparator) {
    ...
    public abstract static class MultimapBuilderWithKeys<K0 extends @Nullable Object> {
         ...
         */
        public <V0 extends @Nullable Object> SortedSetMultimapBuilder<K0, V0> treeSetValues(Comparator<V0> comparator) {
     ...
     * @since 16.0
     */
    public abstract static class ListMultimapBuilder<K0 extends @Nullable Object, V0 extends @Nullable Object>
     ...
     * @since 16.0
     */
    public abstract static class SetMultimapBuilder<K0 extends @Nullable Object, V0 extends @Nullable Object>
        extends MultimapBuilder<K0, V0> {
        SetMultimapBuilder() {
        }
     ...
     * @since 16.0
     */
    public abstract static class SortedSetMultimapBuilder<K0 extends @Nullable Object, V0 extends @Nullable Object>
