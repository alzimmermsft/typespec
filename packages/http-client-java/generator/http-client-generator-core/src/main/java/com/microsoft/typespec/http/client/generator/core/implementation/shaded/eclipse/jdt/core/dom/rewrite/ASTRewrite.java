...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.ChildPropertyDescriptor;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.SimplePropertyDescriptor;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.StructuralPropertyDescriptor;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.rewrite.ASTRewriteAnalyzer;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.rewrite.LineInformation;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.rewrite.NodeInfoStore;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.rewrite.NodeRewriteEvent;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.rewrite.RewriteEventStore.PropertyLocation;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.rewrite.TrackedNodePosition;
 ...
 * to create {@link #createCopyTarget(ASTNode) copies} or {@link #createStringPlaceholder(String, int) string
 * placeholders},
...
public class ASTRewrite {
    ...
    private ASTNode getRootNode() {
        ...
        if (node != null) {
            ...
            while (parent != null
                && parent.getStartPosition() == node.getStartPosition()
    ...
    private void validatePropertyType(StructuralPropertyDescriptor prop, Object value) {
        ...
        if (value == null) {
            ...
            if (!valueType.isAssignableFrom(value.getClass())) {
                String message
                    = value.getClass().getName() + " is not a valid type for " + prop.getNodeClass().getName() //$NON-NLS-1$
