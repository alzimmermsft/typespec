...
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.dom.util;
...
public class DOMASTUtil {
    ...
    private static final String[] AST_COMPLIANCE_MAP = {
        "-1", //$NON-NLS-1$
        "-1", //$NON-NLS-1$
    ...
    public static String getCompliance(int astLevel) {
        if (!AST.getAllVersions().contains(astLevel))
