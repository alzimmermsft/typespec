...
class TrustedListenableFutureTask<V extends @Nullable Object> extends FluentFuture.TrustedFuture<V>
    ...
    static <V extends @Nullable Object> TrustedListenableFutureTask<V> create(AsyncCallable<V> callable) {
     ...
     */
    static <V extends @Nullable Object> TrustedListenableFutureTask<V> create(Runnable runnable,
