...
public interface IEnumIDList {
     ...
     */
    public final static IID IID_IEnumIDList = new IID("{000214F2-0000-0000-C000-000000000046}");
     ...
     * The count can be smaller than the value specified in the celt parameter. This parameter can be NULL on entry only
     * if celt = 1,
     ...
     * then no entries in the rgelt array are valid on exit. If this method returns a success code (such as S_OK or
     * S_FALSE),
     * then the ULONG pointed to by the pceltFetched parameter determines how many entries in the rgelt array are valid
     * on exit.
     *
     * The distinction is important in the case where celt > 1. For example, if you pass celt=10 and there are only 3
     * elements left,
     ...
     */
    HRESULT Next(int celt, PointerByReference rgelt, IntByReference pceltFetched);
     ...
     * 
     * @param ppenum
     * The address of a pointer to the new enumeration object. The calling application must eventually free the new
     * object by calling its Release member function.
     * @return HRESULT
     * Returns S_OK if successful, or a COM-defined error value otherwise.
     */
