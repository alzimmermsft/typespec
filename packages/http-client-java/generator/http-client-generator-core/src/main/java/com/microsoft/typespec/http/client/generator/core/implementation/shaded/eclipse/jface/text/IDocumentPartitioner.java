 ...
 * exist:
 * <ul>
 * <li> {@link IDocumentPartitionerExtension} since version 2.0 replacing
 ...
 * <li> {@link IDocumentPartitionerExtension2} since version 3.0
 ...
 * <li> {@link IDocumentPartitionerExtension3} since version 3.1 introducing
 *      rewrite session. It also replaces the existing {@link #connect(IDocument)} method with
 *      a new one: {@link IDocumentPartitionerExtension3#connect(IDocument, boolean)}.
 * </ul>
 * <p>
