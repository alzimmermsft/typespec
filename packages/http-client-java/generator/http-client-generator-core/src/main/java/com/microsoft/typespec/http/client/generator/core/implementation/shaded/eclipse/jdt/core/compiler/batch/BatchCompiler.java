 ...
 *******************************************************************************/
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.batch;
 ...
 * 
 * <pre>
 * BatchCompiler.compile("C:\\mySources\\X.java -d C:\\myOutput", new PrintWriter(System.out),
...
public final class BatchCompiler {
     ...
     * @param progress the object to report progress to and to provide cancellation, or <code>null</code> if no progress
     * is needed
