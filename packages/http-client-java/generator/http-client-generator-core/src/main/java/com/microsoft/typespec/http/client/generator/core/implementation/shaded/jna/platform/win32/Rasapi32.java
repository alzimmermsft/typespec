...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinRas.RASCONN;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinRas.RASCONNSTATUS;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinRas.RASCREDENTIALS;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinRas.RASDIALEXTENSIONS;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinRas.RASDIALPARAMS;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinRas.RASENTRY;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinRas.RAS_STATS;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinRas.RasDialFunc2;
...
public interface Rasapi32 extends StdCallLibrary {
     ...
     * The dwNotifierType parameter specifies the nature of lpvNotifier. Please refer to its description preceding for
     * further detail.
     * @param lphRasConn
     ...
     */
    int RasDial(RASDIALEXTENSIONS.ByReference lpRasDialExtensions, String lpszPhonebook,
        RASDIALPARAMS.ByReference lpRasDialParams, int dwNotifierType, RasDialFunc2 lpvNotifier,
        HANDLEByReference lphRasConn);

    /**
     * The RasEnumConnections function lists all active RAS connections. It returns each connection's handle and
     ...
     * On input, an application must set the dwSize member of the first RASCONN structure in the buffer to
     * sizeof(RASCONN)
     ...
     * Pointer to a variable that receives the number of RASCONN structures written to the buffer specified by
     * lprasconn.
     * @return If the function succeeds, the return value is ERROR_SUCCESS.
     */
     ...
     * On input, set the dwSize member of the structure to sizeof(RASCONNSTATUS) in order to identify the version of the
     ...
     * @param lpszPhonebook
     * Pointer to a null-terminated string that specifies the full path and file name of a phone-book (PBK) file.
     * If this parameter is NULL, the function uses the current default phone-book file. The default phone-book file is
     * the
     ...
     * @param lpCredentials
     * Pointer to the RASCREDENTIALS structure that, on output, receives the user credentials associated with the
     * specified
     * phone-book entry.
     * On input, set the dwSize member of the structure to sizeof(RASCREDENTIALS), and set the dwMask member to indicate
     * the
     ...
     * @param lpRasEntry
     * Pointer to a RASENTRY structure followed by additional bytes for the alternate phone number list, if there is
     * one.
     ...
     * @return If the function succeeds, the return value is ERROR_SUCCESS.
     */
    int RasGetEntryProperties(String lpszPhonebook, String lpszEntry, RASENTRY.ByReference lpRasEntry,
        IntByReference lpdwEntryInfoSize, Pointer lpbDeviceInfo, Pointer lpdwDeviceInfoSize);

    /**
     * The RasGetProjectionInfo function obtains information about a remote access projection operation for a specified
     * remote access
     * component protocol.
     *
     * @param hrasconn
     ...
     * @param lpprojection
     * Pointer to a buffer that receives the information specified by the rasprojection parameter. The information is in
     * a
    ...
    /**
     * The RasHangUp function terminates a remote access connection. The connection is specified with a RAS connection
     * handle.
     * The function releases all RASAPI32.DLL resources associated with the handle.
     *
     * @param hrasconn
     * Specifies the remote access connection to terminate. This is a handle returned from a previous call to RasDial or
     * RasEnumConnections.
     * @return If the function succeeds, the return value is ERROR_SUCCESS.
     */
    ...
    /**
     * The RasSetEntryProperties function changes the connection information for an entry in the phone book or creates a
     ...
     * @return If the function succeeds, the return value is ERROR_SUCCESS.
     */
    int RasSetEntryProperties(String lpszPhonebook, String lpszEntry, RASENTRY.ByReference lpRasEntry,
        int dwEntryInfoSize, byte[] lpbDeviceInfo, int dwDeviceInfoSize);

    /**
     * The RasGetEntryDialParams function retrieves the connection information saved by the last successful call to the
     * RasDial or
     ...
     * @return If the function succeeds, the return value is ERROR_SUCCESS.
     */
    int RasGetEntryDialParams(String lpszPhonebook, RASDIALPARAMS.ByReference lprasdialparams,
        BOOLByReference lpfPassword);
