...
public class RecordDeclaration extends AbstractTypeDeclaration {
    ...
    public static final ChildListPropertyDescriptor TYPE_PARAMETERS_PROPERTY = new ChildListPropertyDescriptor(
        RecordDeclaration.class, "typeParameters", TypeParameter.class, NO_CYCLE_RISK); //$NON-NLS-1$

    /**
     * The "recordComponents" structural property of this node type (element type: {@link SingleVariableDeclaration}).
     */
    public static final ChildListPropertyDescriptor RECORD_COMPONENTS_PROPERTY = new ChildListPropertyDescriptor(
        RecordDeclaration.class, "recordComponents", SingleVariableDeclaration.class, NO_CYCLE_RISK); //$NON-NLS-1$
     ...
     */
    private final NodeList typeParameters = new NodeList(TYPE_PARAMETERS_PROPERTY);
     ...
     * (see constructor).
     */
    private final NodeList superInterfaceTypes = new NodeList(SUPER_INTERFACE_TYPES_PROPERTY);
     ...
     * (see constructor).
     */
    private final NodeList recordComponents = new NodeList(RECORD_COMPONENTS_PROPERTY);
    ...
    ASTNode clone0(AST target) {
        ...
        result.recordComponents().addAll(ASTNode.copySubtrees(target, recordComponents()));
    ...
    int treeSize() {
        return memSize() + (this.optionalDocComment == null ? 0 : getJavadoc().treeSize())
            ...
            + (this.recordComponents == null ? 0 : this.recordComponents.listSize()) + this.bodyDeclarations.listSize();
    }
