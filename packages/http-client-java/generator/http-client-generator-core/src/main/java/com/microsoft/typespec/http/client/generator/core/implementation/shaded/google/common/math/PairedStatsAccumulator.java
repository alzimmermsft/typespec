...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.primitives.Doubles;
...
public final class PairedStatsAccumulator {
    ...
    public void addAll(PairedStats values) {
        ...
        if (yStats.count() == 0) {
            ...
            // in NaN naturally.
            sumOfProductsOfDeltas += values.sumOfProductsOfDeltas()
                + (values.xStats().mean() - xStats.mean()) * (values.yStats().mean() - yStats.mean()) * values.count();
        }
