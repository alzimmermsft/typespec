...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.io.CharSink;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.io.CharSource;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.googlejavaformat.DocBuilder;
...
public final class Formatter {
    ...
    static void format(final JavaInput javaInput, JavaOutput javaOutput, JavaFormatterOptions options)
        ...
        if (Runtime.version().feature() >= 21) {
            visitor = createVisitor(
                "com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.googlejavaformat.java.java21.Java21InputAstVisitor",
                builder, options);
        } else {
    ...
    private static JavaInputAstVisitor createVisitor(final String className, final OpsBuilder builder,
