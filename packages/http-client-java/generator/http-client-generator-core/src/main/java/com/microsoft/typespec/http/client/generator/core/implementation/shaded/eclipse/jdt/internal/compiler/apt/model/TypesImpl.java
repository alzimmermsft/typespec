...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.type.ArrayType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.type.DeclaredType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.type.ExecutableType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.type.NoType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.type.NullType;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.util.Types;
...
public class TypesImpl implements Types {
     ...
     * 
     * @see
     * javax.lang.model.util.Types#asElement(com.microsoft.typespec.http.client.generator.core.implementation.shaded.
                ...
                typeMirror = findMemberInHierarchy(referenceBinding, elementImpl._binding, new MemberInTypeFinder() {
                    ...
                    public TypeMirror find(ReferenceBinding typeBinding, Binding memberBinding) {
                        if (typeBinding instanceof ParameterizedTypeBinding) {
                            ...
                            if (variableBinding.declaringElement == binding) { // check in advance avoid looking into
                                                                               // type parameters unnecessarily.
                ...
                typeMirror = findMemberInHierarchy(referenceBinding, elementImpl._binding, new MemberInTypeFinder() {
                    ...
                    public TypeMirror find(ReferenceBinding typeBinding, Binding memberBinding) {
                        ...
                        for (ReferenceBinding memberReferenceBinding : typeBinding.memberTypes()) {
                            if (CharOperation.equals(elementBinding.compoundName,
                                memberReferenceBinding.compoundName)) {
    ...
    public TypeMirror erasure(TypeMirror t) {
        ...
        if (binding instanceof ArrayBinding) {
            ...
            return this._env.getFactory()
                .newTypeMirror(this._env.getLookupEnvironment().createArrayType(leafType, typeBinding.dimensions()));
        }
        return t;
    }
    ...
    public ArrayType getArrayType(TypeMirror componentType) {
        ...
        return (ArrayType) this._env.getFactory()
            .newTypeMirror(this._env.getLookupEnvironment()
                .createArrayType(typeBinding.leafComponentType(), typeBinding.dimensions() + 1));
    }
    ...
    public DeclaredType getDeclaredType(TypeElement typeElem, TypeMirror... typeArgs) {
        ...
        if (typeArgsLength == 0) {
            if (elementBinding.isGenericType()) {
                // per javadoc,
                return (DeclaredType) this._env.getFactory()
                    .newTypeMirror(this._env.getLookupEnvironment().createRawType(elementBinding, null));
            }
            return (DeclaredType) typeElem.asType();
        } else if (typeArgsLength != typeVariablesLength) {
            throw new IllegalArgumentException(
                "Number of typeArguments doesn't match the number of formal parameters of typeElem"); //$NON-NLS-1$
        }
    ...
    public DeclaredType getDeclaredType(DeclaredType containing, TypeElement typeElem, TypeMirror... typeArgs) {
        ...
        if (typeArgsLength == 0) {
            if (elementBinding.isGenericType()) {
                ...
                return (DeclaredType) this._env.getFactory()
                    .newTypeMirror(this._env.getLookupEnvironment().createRawType(elementBinding, enclosingType));
            } else {
                // e.g., Outer<Long>.Inner
                ParameterizedTypeBinding ptb
                    = this._env.getLookupEnvironment().createParameterizedType(elementBinding, null, enclosingType);
    ...
    public WildcardType getWildcardType(TypeMirror extendsBound, TypeMirror superBound) {
        ...
        if (extendsBound != null) {
            ...
            return (WildcardType) this._env.getFactory()
                .newTypeMirror(
                    this._env.getLookupEnvironment().createWildcard(null, 0, typeBinding, null, Wildcard.EXTENDS));
        }
        if (superBound != null) {
            ...
            return new WildcardTypeImpl(this._env,
                this._env.getLookupEnvironment().createWildcard(null, 0, typeBinding, null, Wildcard.SUPER));
        }
        return new WildcardTypeImpl(this._env,
            this._env.getLookupEnvironment().createWildcard(null, 0, null, null, Wildcard.UNBOUND));
    }
    ...
    public boolean isSubsignature(ExecutableType m1, ExecutableType m2) {
        ...
        if (!CharOperation.equals(methodBinding1.selector, methodBinding2.selector))
            return false;
        return methodBinding1.areParameterErasuresEqual(methodBinding2)
            && methodBinding1.areTypeVariableErasuresEqual(methodBinding2);
    }
