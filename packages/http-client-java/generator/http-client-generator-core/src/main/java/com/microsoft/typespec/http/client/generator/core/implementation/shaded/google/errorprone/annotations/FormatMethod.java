...
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.errorprone.annotations;
 ...
 * <pre>
 * &#064;FormatMethod
 * void log(Locale l, &#064;FormatString String logMessage, Object... args) {
 * }
 * 
 * &#064;FormatMethod
 * void log(Locale l, String logMessage, Object... args) {
 * }
 * </pre>
 *
 ...
 * 
 *     &#064;FormatMethod
 *     void log(&#064;FormatString String format, Object... args) {
 *     }
 * 
 *     void validLogs() {
 *         log("String literal");
 ...
 * 
 *     &#064;FormatMethod
 *     void validLog(&#064;FormatString String format, Object... args) {
 *         log(format, args);
 *     }
 * }
 * </pre>
