...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.batch.FileSystem;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.batch.Main.ResourceBundleFactory;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.batch.ModuleFinder;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.tool.JrtFileSystem.JrtFileObject;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.tool.ModuleLocationHandler.LocationContainer;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.tool.ModuleLocationHandler.ModuleLocationWrapper;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.tools.StandardJavaFileManager;
...
public class EclipseFileManager implements StandardJavaFileManager {
    ...
    private void collectAllMatchingFiles(Location location, File file, String normalizedPackageName, Set<Kind> kinds,
        boolean recurse, ArrayList<JavaFileObject> collector) {
        if (file.equals(this.jrtHome)) {
            if (location instanceof ModuleLocationWrapper) {
                List<JrtFileObject> list = this.jrtSystem.list((ModuleLocationWrapper) location, normalizedPackageName,
                    kinds, recurse, this.charset);
            ...
            if (files != null) {
                ...
                for (File f : files) {
                    if (f.isDirectory() && recurse) {
                        ...
                        if (kinds.contains(kind)) {
                            collector.add(new EclipseFileObject(normalizedPackageName + f.getName(), f.toURI(), kind,
                                this.charset));
                        }
                    }
                }
     ...
     * (non-Javadoc)
     * 
     * @see javax.tools.JavaFileManager#getClassLoader(com.microsoft.typespec.http.client.generator.core.implementation.
     * shaded.javax.tools.JavaFileManager.Location)
     */
    @Override
    ...
    private Iterable<? extends File> getPathsFrom(String path) {
        ArrayList<Classpath> paths = new ArrayList<>();
    ...
    Iterable<? extends File> getDefaultBootclasspath() {
        ...
        for (Classpath classpath : org.eclipse.jdt.internal.compiler.util.Util.collectFilesNames()) {
            files.add(new File(classpath.getPath()));
        }
        return files;
    }
     ...
     * 
     * @see
     * javax.tools.JavaFileManager#getFileForInput(com.microsoft.typespec.http.client.generator.core.implementation.
     * shaded.javax.tools.JavaFileManager.Location, java.lang.String, java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * javax.tools.JavaFileManager#getFileForOutput(com.microsoft.typespec.http.client.generator.core.implementation.
     * shaded.javax.tools.JavaFileManager.Location, java.lang.String, java.lang.String,
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.tools.FileObject)
     */
    @Override
     ...
     * 
     * @see
     * javax.tools.JavaFileManager#getJavaFileForInput(com.microsoft.typespec.http.client.generator.core.implementation.
     * shaded.javax.tools.JavaFileManager.Location, java.lang.String,
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.tools.JavaFileObject.Kind)
     */
    @Override
     ...
     * 
     * @see
     * javax.tools.JavaFileManager#getJavaFileForOutput(com.microsoft.typespec.http.client.generator.core.implementation
     * .shaded.javax.tools.JavaFileManager.Location, java.lang.String,
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.tools.JavaFileObject.Kind,
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.tools.FileObject)
     */
     ...
     * 
     * @see
     * javax.tools.StandardJavaFileManager#getLocation(com.microsoft.typespec.http.client.generator.core.implementation.
     * shaded.javax.tools.JavaFileManager.Location)
     */
    @Override
     ...
     * 
     * @see
     * javax.tools.JavaFileManager#hasLocation(com.microsoft.typespec.http.client.generator.core.implementation.shaded.
     ...
     * 
     * @see
     * javax.tools.JavaFileManager#inferBinaryName(com.microsoft.typespec.http.client.generator.core.implementation.
     * shaded.javax.tools.JavaFileManager.Location,
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.tools.JavaFileObject)
     */
    @Override
     ...
     * 
     * @see
     * javax.tools.StandardJavaFileManager#isSameFile(com.microsoft.typespec.http.client.generator.core.implementation.
     * shaded.javax.tools.FileObject,
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.tools.FileObject)
     */
    @Override
     ...
     * 
     * @see
     * javax.tools.JavaFileManager#list(com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.
     * tools.JavaFileManager.Location, java.lang.String, java.util.Set, boolean)
     */
    @Override
     ...
     * 
     * @see
     * javax.tools.StandardJavaFileManager#setLocation(com.microsoft.typespec.http.client.generator.core.implementation.
     * shaded.javax.tools.JavaFileManager.Location, java.lang.Iterable)
     */
    @Override
    ...
    protected void addNewEntry(ArrayList paths, String currentClasspathName, ArrayList currentRuleSpecs,
        ...
        Classpath currentClasspath = FileSystem.getClasspath(currentClasspathName, customEncoding, isSourceOnly,
            accessRuleSet, destPath, null, this.releaseVersion);
    ...
    private <P> void initModules(Location location, Iterable<? extends P> paths, Function<P, File> toFile)
        throws IOException {
        if (location == StandardLocation.MODULE_PATH || location == StandardLocation.MODULE_SOURCE_PATH) {
            ...
            for (P path : paths) {
                ...
                } catch (IllegalArgumentException iae) { // e.g., from ModuleFinder.scanForModule(Classpath, File,
