...
public interface JavadocTagConstants {
    ...
    public static final LevelTags[] BLOCK_TAGS_RAW = {
        new LevelTags(ClassFileConstants.MAJOR_VERSION_0,
            new char[][] {
                TAG_AUTHOR,
                TAG_DEPRECATED,
                TAG_EXCEPTION,
                ...
                TAG_SEE,
                TAG_VERSION,
                TAG_CATEGORY /* 1.6 tag but put here as we support it for all compliances */ }),
        new LevelTags(ClassFileConstants.MAJOR_VERSION_1_1, new char[][] { TAG_SINCE }),
        new LevelTags(ClassFileConstants.MAJOR_VERSION_1_2,
            new char[][] { TAG_SERIAL, TAG_SERIAL_DATA, TAG_SERIAL_FIELD, TAG_THROWS }),
        new LevelTags(ClassFileConstants.MAJOR_VERSION_1_8,
            new char[][] { TAG_API_NOTE, TAG_IMPL_SPEC, TAG_IMPL_NOTE }),
