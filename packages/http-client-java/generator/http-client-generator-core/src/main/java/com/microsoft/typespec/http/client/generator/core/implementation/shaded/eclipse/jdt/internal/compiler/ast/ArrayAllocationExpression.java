...
public class ArrayAllocationExpression extends Expression {
    ...
    public void generateCode(BlockScope currentScope, CodeStream codeStream, boolean valueRequired) {
        ...
        for (Expression dimension : this.dimensions) {
            ...
            if ((dimExpression = dimension) == null)
        ...
        if (referenceType != null) {
            ...
            if (this.initializer != null) {
                ...
                if (lastInitializedDim != -1 && nullTagBitsPerDimension != null) {
                    checkUninitializedNonNullArrayContents(scope, nullTagBitsPerDimension[lastInitializedDim + 1],
                        lastInitializedDim);
                }
            }
    ...
    protected void checkUninitializedNonNullArrayContents(BlockScope scope, long elementNullTagBits, int lastDim) {
        ...
        scope.problemReporter()
            .nonNullArrayContentNotInitialized(this.dimensions[lastDim], scope.environment(), elementType);
    }
        ...
        if (visitor.visit(this, scope)) {
            ...
            for (int i = 0; i < dimensionsLength; i++) {
                Annotation[] annotations
                    = this.annotationsOnDimensions == null ? null : this.annotationsOnDimensions[i];
