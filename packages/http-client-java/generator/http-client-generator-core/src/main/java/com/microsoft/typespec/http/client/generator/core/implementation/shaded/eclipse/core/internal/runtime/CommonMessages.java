...
public class CommonMessages extends NLS {
	private static final String BUNDLE_NAME = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.runtime.commonMessages"; //$NON-NLS-1$
