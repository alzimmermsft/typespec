...
public class AnnotationMemberValue extends AnnotationValueImpl {
     ...
     * <ul>
     * <li>{@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.impl.Constant}
     * for member
     * of primitive type or String</li>
     * <li>{@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding}
     * for a member value of type
     * {@link Class}</li>
     * <li>{@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.FieldBinding}
     * for an enum constant</li>
     * <li>{@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.AnnotationBinding}
     * for an annotation instance</li>
