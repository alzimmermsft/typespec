...
final class Synchronized {
    ...
    private static <E extends @Nullable Object> Collection<E> collection(Collection<E> collection,
    ...
    static class SynchronizedSet<E extends @Nullable Object> extends SynchronizedCollection<E> implements Set<E> {
    ...
    private static <E extends @Nullable Object> SortedSet<E> sortedSet(SortedSet<E> set, @CheckForNull Object mutex) {
        return new SynchronizedSortedSet<E>(set, mutex);
    }

    static class SynchronizedSortedSet<E extends @Nullable Object> extends SynchronizedSet<E> implements SortedSet<E> {
    ...
    private static <E extends @Nullable Object> List<E> list(List<E> list, @CheckForNull Object mutex) {
        return (list instanceof RandomAccess)
            ? new SynchronizedRandomAccessList<E>(list, mutex)
            : new SynchronizedList<E>(list, mutex);
    }

    private static class SynchronizedList<E extends @Nullable Object> extends SynchronizedCollection<E>
        implements List<E> {
    ...
    private static class SynchronizedRandomAccessList<E extends @Nullable Object> extends SynchronizedList<E>
    ...
    static <E extends @Nullable Object> Multiset<E> multiset(Multiset<E> multiset, @CheckForNull Object mutex) {
    ...
    private static class SynchronizedMultiset<E extends @Nullable Object> extends SynchronizedCollection<E>
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> Multimap<K, V> multimap(Multimap<K, V> multimap,
        @CheckForNull Object mutex) {
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> ListMultimap<K, V>
        listMultimap(ListMultimap<K, V> multimap, @CheckForNull Object mutex) {
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> SetMultimap<K, V>
        setMultimap(SetMultimap<K, V> multimap, @CheckForNull Object mutex) {
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> SortedSetMultimap<K, V>
        sortedSetMultimap(SortedSetMultimap<K, V> multimap, @CheckForNull Object mutex) {
    ...
    private static <E extends @Nullable Object> Collection<E> typePreservingCollection(Collection<E> collection,
        @CheckForNull Object mutex) {
    ...
    private static <E extends @Nullable Object> Set<E> typePreservingSet(Set<E> set, @CheckForNull Object mutex) {
    ...
    private static class SynchronizedAsMapEntries<K extends @Nullable Object, V extends @Nullable Object>
    ...
    @VisibleForTesting
    static <K extends @Nullable Object, V extends @Nullable Object> Map<K, V> map(Map<K, V> map,
        @CheckForNull Object mutex) {
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> SortedMap<K, V> sortedMap(SortedMap<K, V> sortedMap,
        @CheckForNull Object mutex) {
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> BiMap<K, V> biMap(BiMap<K, V> bimap,
        @CheckForNull Object mutex) {
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> NavigableMap<K, V>
    ...
    @GwtIncompatible // NavigableMap
    static <K extends @Nullable Object, V extends @Nullable Object> NavigableMap<K, V>
        navigableMap(NavigableMap<K, V> navigableMap, @CheckForNull Object mutex) {
    ...
    @CheckForNull
    private static <K extends @Nullable Object, V extends @Nullable Object> Map.Entry<K, V>
        nullableSynchronizedEntry(@CheckForNull Map.Entry<K, V> entry, @CheckForNull Object mutex) {
        if (entry == null) {
            return null;
        }
    ...
    private static class SynchronizedQueue<E extends @Nullable Object> extends SynchronizedCollection<E>
        implements Queue<E> {
    ...
    private static final class SynchronizedDeque<E extends @Nullable Object> extends SynchronizedQueue<E>
        implements Deque<E> {
    ...
    static <R extends @Nullable Object, C extends @Nullable Object, V extends @Nullable Object> Table<R, C, V>
        table(Table<R, C, V> table, @CheckForNull Object mutex) {
        return new SynchronizedTable<>(table, mutex);
    }

    private static final class SynchronizedTable<R extends @Nullable Object, C extends @Nullable Object, V extends @Nullable Object>
