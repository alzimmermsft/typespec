...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.ImmutableMapEntry.NonTerminalImmutableMapEntry;
...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    private static <K, V> ImmutableMap<K, V> fromEntryArrayCheckingBucketOverflow(int n,
        ...
        if (duplicates != null) {
            ...
            if (newTableSize != tableSize) {
                return fromEntryArrayCheckingBucketOverflow(entries.length, entries, /* throwIfDuplicateKeys= */ true);
            }
        }
    ...
    private RegularImmutableMap(Entry<K, V>[] entries, @CheckForNull @Nullable ImmutableMapEntry<K, V>[] table,
        int mask) {
    ...
    @CheckForNull
    static <K, V> ImmutableMapEntry<K, V> checkNoConflictInKeyBucket(Object key, Object newValue,
        @CheckForNull ImmutableMapEntry<K, V> keyBucketHead, boolean throwIfDuplicateKeys)
