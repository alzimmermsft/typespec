...
public class ModuleFinder {
	...
	public static List<Classpath> findModules(File f, String destinationPath, Parser parser, Map<String, String> options, boolean isModulepath, String release) {
	...
	protected static void scanForModules(String destinationPath, Parser parser, Map<String, String> options, boolean isModulepath,
			boolean thisAnAutomodule, List<Classpath> collector, final File file, String release) {
		Classpath entry = FileSystem.getClasspath(
	...
	protected static IModule scanForModule(Classpath modulePath, final File file, Parser parser, boolean considerAutoModules, String release) {
		IModule module = null;
		if (file.isDirectory()) {
