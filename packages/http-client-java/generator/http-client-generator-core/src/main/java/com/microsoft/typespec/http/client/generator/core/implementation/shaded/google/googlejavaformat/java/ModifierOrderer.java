...
final class ModifierOrderer {
  ...
  /**
   * Returns the given token as a {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.element.Modifier}, or {@code null} if it
   * is not a modifier.
   */
