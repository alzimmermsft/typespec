 ...
 * document is changed. Positions are updated by {@link IPositionUpdater}s. Position
 ...
 * informed exactly once. The extension interface {@link IDocumentExtension3}
 ...
 * delimiter returned by {@link TextUtilities#getDefaultLineDelimiter(IDocument)}.</p>
 * <p>
 ...
 * for searching is to use a {@link FindReplaceDocumentAdapter}.</p>
 * <p>
 * In order to provide backward compatibility for clients of <code>IDocument</code>, extension
 * interfaces are used to provide a means of evolution. The following extension interfaces
 * exist:</p>
 * <ul>
 * <li> {@link IDocumentExtension} since version 2.0 introducing the concept
 ...
 * <li> {@link IDocumentExtension2} since version 2.1 introducing configuration
 * methods for post notification replaces and document change notification. </li>
 * <li> {@link IDocumentExtension3} since version 3.0 replacing the original
 ...
 * <li> {@link IDocumentExtension4} since version 3.1 introducing the
