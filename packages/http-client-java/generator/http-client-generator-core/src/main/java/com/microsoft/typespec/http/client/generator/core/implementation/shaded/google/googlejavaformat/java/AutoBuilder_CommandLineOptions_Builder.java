...
class AutoBuilder_CommandLineOptions_Builder implements CommandLineOptions.Builder {
    ...
    public CommandLineOptions build() {
        ...
        return new CommandLineOptions(this.files, this.inPlace, this.lines, this.offsets, this.lengths, this.aosp,
            this.version, this.help, this.stdin, this.fixImportsOnly, this.sortImports, this.removeUnusedImports,
            this.dryRun, this.setExitIfChanged, this.assumeFilename, this.reflowLongStrings, this.formatJavadoc);
    }
}
