...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Functions.constant;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.MoreObjects.toStringHelper;
...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Lists.asList;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ClosingFuture.State.CLOSED;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ClosingFuture.State.CLOSING;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ClosingFuture.State.OPEN;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ClosingFuture.State.SUBSUMED;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ClosingFuture.State.WILL_CLOSE;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ClosingFuture.State.WILL_CREATE_VALUE_AND_CLOSER;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.Futures.getDone;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.Futures.immediateFuture;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.Futures.nonCancellationPropagating;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.MoreExecutors.directExecutor;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.FluentIterable;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.ImmutableList;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ClosingFuture.Combiner.AsyncCombiningCallable;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ClosingFuture.Combiner.CombiningCallable;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.Futures.FutureCombiner;
 ...
 * {
 *     &#64;code
 *     FluentFuture<UserName> userName = ClosingFuture
 *         .submit(closer -> closer.eventuallyClose(database.newTransaction(), closingExecutor), executor)
...
public final class ClosingFuture<V extends @Nullable Object> {
    ...
    public static final class DeferredCloser {
        ...
        @ParametricNullness
        public <C extends @Nullable Object & @Nullable AutoCloseable> C eventuallyClose(@ParametricNullness C closeable,
     ...
     * execution
     */
    public static <V extends @Nullable Object> ClosingFuture<V> submit(ClosingCallable<V> callable, Executor executor) {
     ...
     * @since 30.1
     */
    public static <V extends @Nullable Object> ClosingFuture<V> submitAsync(AsyncClosingCallable<V> callable,
        Executor executor) {
        return new ClosingFuture<>(callable, executor);
    }
     ...
     */
    @Deprecated
    public static <C extends @Nullable Object & @Nullable AutoCloseable> ClosingFuture<C>
        eventuallyClosing(ListenableFuture<C> future, final Executor closingExecutor) {
        checkNotNull(closingExecutor);
        final ClosingFuture<C> closingFuture = new ClosingFuture<>(nonCancellationPropagating(future));
        Futures.addCallback(future, new FutureCallback<@Nullable AutoCloseable>() {
            @Override
     ...
     * the arguments, or if any has already been {@linkplain #finishToFuture() finished}
     */
    public static <V1 extends @Nullable Object, V2 extends @Nullable Object> Combiner2<V1, V2>
    ...
    public static <V1 extends @Nullable Object, V2 extends @Nullable Object, V3 extends @Nullable Object, V4 extends @Nullable Object>
        Combiner4<V1, V2, V3, V4> whenAllSucceed(ClosingFuture<V1> future1, ClosingFuture<V2> future2,
            ClosingFuture<V3> future3, ClosingFuture<V4> future4) {
    ...
    public static <V1 extends @Nullable Object, V2 extends @Nullable Object, V3 extends @Nullable Object, V4 extends @Nullable Object, V5 extends @Nullable Object>
        Combiner5<V1, V2, V3, V4, V5> whenAllSucceed(ClosingFuture<V1> future1, ClosingFuture<V2> future2,
            ClosingFuture<V3> future3, ClosingFuture<V4> future4, ClosingFuture<V5> future5) {
    ...
    public static Combiner whenAllSucceed(ClosingFuture<?> future1, ClosingFuture<?> future2, ClosingFuture<?> future3,
        ClosingFuture<?> future4, ClosingFuture<?> future5, ClosingFuture<?> future6, ClosingFuture<?>... moreFutures) {
     ...
     * finished}
     */
    public <U extends @Nullable Object> ClosingFuture<U> transform(final ClosingFunction<? super V, U> function,
        Executor executor) {
     ...
     * // Closeable).
     *     ClosingFuture<Integer> rowsFuture2 = queryFuture.transformAsync((closer, result) -> {
     ...
     * finished}
     */
    public <U extends @Nullable Object> ClosingFuture<U>
        transformAsync(final AsyncClosingFunction<? super V, U> function, Executor executor) {
        checkNotNull(function);
        AsyncFunction<V, U> applyFunction = new AsyncFunction<V, U>() {
            @Override
            public ListenableFuture<U> apply(V input) throws Exception {
     ...
     *     ClosingFuture<List<Row>> rowsFuture = queryFuture.transformAsync(withoutCloser(Result::getRowsFuture), executor);
     * }
     * </pre>
     *
     ...
     */
    public static <V extends @Nullable Object, U extends @Nullable Object> AsyncClosingFunction<V, U>
        withoutCloser(final AsyncFunction<V, U> function) {
        checkNotNull(function);
     ...
     *         = queryFuture.catching(QueryException.class, (closer, x) -> Query.emptyQueryResult(), executor);
     * }
     * </pre>
     *
     * <p>When selecting an executor, note that {@code directExecutor} is dangerous in some cases. See
    ...
    private <X extends Throwable, W extends V> ClosingFuture<V> catchingMoreGeneric(Class<X> exceptionType,
        final ClosingFunction<? super X, W> fallback, Executor executor) {
    ...
    private <X extends Throwable, W extends V> ClosingFuture<V> catchingAsyncMoreGeneric(Class<X> exceptionType,
        final AsyncClosingFunction<? super X, W> fallback, Executor executor) {
        checkNotNull(fallback);
    ...
    private static <C extends @Nullable Object, V extends C> void
        provideValueAndCloser(ValueAndCloserConsumer<C> consumer, ClosingFuture<V> closingFuture) {
    ...
    public static final class Peeker {
        ...
        @ParametricNullness
        private <V extends @Nullable Object> V call(CombiningCallable<V> combiner, CloseableList closeables)
            throws Exception {
            beingCalled = true;
            CloseableList newCloseables = new CloseableList();
            try {
        ...
        private <V extends @Nullable Object> FluentFuture<V> callAsync(AsyncCombiningCallable<V> combiner,
    ...
    public static class Combiner {
         ...
         */
        public <V extends @Nullable Object> ClosingFuture<V> call(final CombiningCallable<V> combiningCallable,
            Executor executor) {
         ...
         */
        public <V extends @Nullable Object> ClosingFuture<V>
            callAsync(final AsyncCombiningCallable<V> combiningCallable, Executor executor) {
        ...
        private FutureCombiner<@Nullable Object> futureCombiner() {
            return allMustSucceed ? Futures.whenAllSucceed(inputFutures()) : Futures.whenAllComplete(inputFutures());
        }

        private ImmutableList<FluentFuture<?>> inputFutures() {
            return FluentIterable.from(inputs).<FluentFuture<?>>transform(future -> future.future).toList();
        }
    }
     ...
     */
    public static final class Combiner2<V1 extends @Nullable Object, V2 extends @Nullable Object> extends Combiner {
         ...
         */
        @FunctionalInterface
        public interface ClosingFunction2<V1 extends @Nullable Object, V2 extends @Nullable Object, U extends @Nullable Object> {
         ...
         */
        @FunctionalInterface
        public interface AsyncClosingFunction2<V1 extends @Nullable Object, V2 extends @Nullable Object, U extends @Nullable Object> {
         ...
         */
        public <U extends @Nullable Object> ClosingFuture<U> call(final ClosingFunction2<V1, V2, U> function,
            Executor executor) {
         ...
         * ClosingFuture#transformAsync(AsyncClosingFunction, Executor)} apply here.
         */
        public <U extends @Nullable Object> ClosingFuture<U> callAsync(final AsyncClosingFunction2<V1, V2, U> function,
            Executor executor) {
    ...
    public static final class Combiner3<V1 extends @Nullable Object, V2 extends @Nullable Object, V3 extends @Nullable Object>
         ...
         */
        @FunctionalInterface
        public interface ClosingFunction3<V1 extends @Nullable Object, V2 extends @Nullable Object, V3 extends @Nullable Object, U extends @Nullable Object> {
            /**
         ...
         */
        @FunctionalInterface
        public interface AsyncClosingFunction3<V1 extends @Nullable Object, V2 extends @Nullable Object, V3 extends @Nullable Object, U extends @Nullable Object> {
            /**
             * Applies this function to three inputs, or throws an exception if unable to do so.
             *
             * <p>Any objects that are passed to {@link DeferredCloser#eventuallyClose(Object, Executor)
         ...
         * ExecutionException} will be extracted and used as the failure of the derived step.
         */
        public <U extends @Nullable Object> ClosingFuture<U> call(final ClosingFunction3<V1, V2, V3, U> function,
            Executor executor) {
            return call(new CombiningCallable<U>() {
                @Override
                @ParametricNullness
         ...
         */
        public <U extends @Nullable Object> ClosingFuture<U>
            callAsync(final AsyncClosingFunction3<V1, V2, V3, U> function, Executor executor) {
            return callAsync(new AsyncCombiningCallable<U>() {
                @Override
                public ClosingFuture<U> call(DeferredCloser closer, Peeker peeker) throws Exception {
                    return function.apply(closer, peeker.getDone(future1), peeker.getDone(future2),
    ...
    public static final class Combiner4<V1 extends @Nullable Object, V2 extends @Nullable Object, V3 extends @Nullable Object, V4 extends @Nullable Object>
         ...
         */
        @FunctionalInterface
        public interface ClosingFunction4<V1 extends @Nullable Object, V2 extends @Nullable Object, V3 extends @Nullable Object, V4 extends @Nullable Object, U extends @Nullable Object> {
            /**
         ...
         */
        @FunctionalInterface
        public interface AsyncClosingFunction4<V1 extends @Nullable Object, V2 extends @Nullable Object, V3 extends @Nullable Object, V4 extends @Nullable Object, U extends @Nullable Object> {
            /**
             * Applies this function to four inputs, or throws an exception if unable to do so.
             *
             * <p>Any objects that are passed to {@link DeferredCloser#eventuallyClose(Object, Executor)
         ...
         * ExecutionException} will be extracted and used as the failure of the derived step.
         */
        public <U extends @Nullable Object> ClosingFuture<U> call(final ClosingFunction4<V1, V2, V3, V4, U> function,
            Executor executor) {
            return call(new CombiningCallable<U>() {
                @Override
                @ParametricNullness
         ...
         */
        public <U extends @Nullable Object> ClosingFuture<U>
            callAsync(final AsyncClosingFunction4<V1, V2, V3, V4, U> function, Executor executor) {
            return callAsync(new AsyncCombiningCallable<U>() {
                @Override
                public ClosingFuture<U> call(DeferredCloser closer, Peeker peeker) throws Exception {
                    return function.apply(closer, peeker.getDone(future1), peeker.getDone(future2),
    ...
    public static final class Combiner5<V1 extends @Nullable Object, V2 extends @Nullable Object, V3 extends @Nullable Object, V4 extends @Nullable Object, V5 extends @Nullable Object>
         ...
         */
        @FunctionalInterface
        public interface ClosingFunction5<V1 extends @Nullable Object, V2 extends @Nullable Object, V3 extends @Nullable Object, V4 extends @Nullable Object, V5 extends @Nullable Object, U extends @Nullable Object> {
            /**
         ...
         */
        @FunctionalInterface
        public interface AsyncClosingFunction5<V1 extends @Nullable Object, V2 extends @Nullable Object, V3 extends @Nullable Object, V4 extends @Nullable Object, V5 extends @Nullable Object, U extends @Nullable Object> {
            /**
             * Applies this function to five inputs, or throws an exception if unable to do so.
             *
             * <p>Any objects that are passed to {@link DeferredCloser#eventuallyClose(Object, Executor)
         ...
         */
        public <U extends @Nullable Object> ClosingFuture<U>
            call(final ClosingFunction5<V1, V2, V3, V4, V5, U> function, Executor executor) {
            return call(new CombiningCallable<U>() {
                @Override
                @ParametricNullness
                public U call(DeferredCloser closer, Peeker peeker) throws Exception {
         ...
         */
        public <U extends @Nullable Object> ClosingFuture<U>
            callAsync(final AsyncClosingFunction5<V1, V2, V3, V4, V5, U> function, Executor executor) {
            return callAsync(new AsyncCombiningCallable<U>() {
                @Override
                public ClosingFuture<U> call(DeferredCloser closer, Peeker peeker) throws Exception {
                    return function.apply(closer, peeker.getDone(future1), peeker.getDone(future2),
    ...
    private static final class CloseableList extends IdentityHashMap<AutoCloseable, Executor> implements Closeable {
        ...
        <V extends @Nullable Object, U extends @Nullable Object> ListenableFuture<U> applyClosingFunction(
        ...
        <V extends @Nullable Object, U extends @Nullable Object> FluentFuture<U> applyAsyncClosingFunction(
