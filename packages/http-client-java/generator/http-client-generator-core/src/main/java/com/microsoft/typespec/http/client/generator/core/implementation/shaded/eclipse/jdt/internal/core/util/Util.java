...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.IMemberValuePair;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.ArrayType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.IntersectionType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.NameQualifiedType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.ParameterizedType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.PrimitiveType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.QualifiedType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.SimpleType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.Type;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.UnionType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.WildcardType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.IClassFileAttribute;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.IClassFileReader;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.ICodeAttribute;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.IComponentInfo;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.IFieldInfo;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.IMethodInfo;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.AbstractVariableDeclaration;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.AnnotationMethodDeclaration;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Argument;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.IntersectionCastTypeReference;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.UnionTypeReference;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.env.ClassSignature;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.ClassFile;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.Member;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.MemberValuePair;
...
public class Util {
     ...
     * Returns {@code >0} if a byte in a is greater than the corresponding byte in b, or if a is longer, or if b is
     * null.
     ...
     * part and appending the given name at the end
     */
    public static String concatWith(String[] array, String name, char separator) {
    ...
    private static IFile findFirstClassFile(IFolder folder) {
        try {
            ...
            for (IResource member : members) {
                ...
                } else if (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util
                    .isClassFileName(member.getName())) {
                    return (IFile) member;
                }
            }
    ...
    private static IClassFile getClassFile(char[] fileName) {
        ...
        if (jarSeparator != -1 && pkgEnd < jarSeparator) // if in a jar and no slash, it is a default package -> pkgEnd
        ...
        try {
            ...
            if (targetLibrary instanceof IFolder) {
                ...
                try {
                    ...
                    } else if (targetLibrary instanceof File f) {
                        if (!f.isDirectory()) {
    ...
    public static IPackageFragment getPackageFragment(char[] fileName, int pkgEnd, int jarSeparator) {
        if (jarSeparator != -1) {
            ...
            IContainer folder = path.segmentCount() == 1
                ? workspaceRoot.getProject(path.lastSegment())
            ...
            switch (element.getElementType()) {
                ...
                case IJavaElement.JAVA_PROJECT:
                    PackageFragmentRoot root
                        = (PackageFragmentRoot) ((IJavaProject) element).getPackageFragmentRoot(folder);
                    if (root == null)
                        return null;
                    return root.getPackageFragment(CharOperation.NO_STRINGS);
            }
    ...
    private static String[] decodeArgumentString(int length, String argumentsString) {
        ...
        for (int i = 0, max = argumentsString.length(); i < max; i++) {
            ...
            if (current == ARGUMENTS_DELIMITER) {/*
                                                  * check the next character. If this is also ARGUMENTS_DELIMITER then
                                                  * only put one into the
    ...
    public static String getSignature(Type type) {
        if (type instanceof UnionType union) {
            return Signature.createUnionTypeSignature(
                ((List<Type>) union.types()).stream().map(Util::getSignature).toArray(String[]::new));
        }
        if (type instanceof IntersectionType intersection) {
            return Signature.createIntersectionTypeSignature(
                ((List<Type>) intersection.types()).stream().map(Util::getSignature).toArray(String[]::new));
        }
        StringBuilder buffer = new StringBuilder();
    ...
    public static String getSourceAttachmentProperty(IPath path) throws JavaModelException {
        ...
        if (property == null) {
            try {
                property = ResourcesPlugin.getWorkspace()
                    .getRoot()
    ...
    public static void getFullyQualifiedName(Type type, StringBuilder buffer) {
        switch (type.getNodeType()) {
            ...
            case ASTNode.NAME_QUALIFIED_TYPE:
                ...
                buffer.append(nameQualifiedType.getQualifier().toString())
                    .append('.')
                    .append(nameQualifiedType.getName().toString());
                break;
        }
    }
     ...
     * Return the java element corresponding to the given compiler binding.
     */
    public static JavaElement getUnresolvedJavaElement(RecordComponentBinding binding,
        WorkingCopyOwner workingCopyOwner, BindingsToNodesMap bindingsToNodes) {
        if (binding.declaringRecord == null)
            return null; // array length
        JavaElement unresolvedJavaElement
            = getUnresolvedJavaElement(binding.declaringRecord, workingCopyOwner, bindingsToNodes);
        if (unresolvedJavaElement == null || unresolvedJavaElement.getElementType() != IJavaElement.TYPE) {
            return null;
        }
        return (JavaElement) ((IType) unresolvedJavaElement).getField(String.valueOf(binding.name));
     ...
     * Return the java element corresponding to the given compiler binding.
     */
    public static JavaElement getUnresolvedJavaElement(MethodBinding methodBinding, WorkingCopyOwner workingCopyOwner,
        BindingsToNodesMap bindingsToNodes) {
        JavaElement unresolvedJavaElement
            = getUnresolvedJavaElement(methodBinding.declaringClass, workingCopyOwner, bindingsToNodes);
        if (unresolvedJavaElement == null || unresolvedJavaElement.getElementType() != IJavaElement.TYPE) {
            return null;
        }
        ...
        com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.ASTNode node
            = bindingsToNodes == null ? null : bindingsToNodes.get(methodBinding);
        if (node != null && !declaringType.isBinary()) {
            if (node instanceof AnnotationMethodDeclaration typeMemberDeclaration) {
                ...
                if (arguments != null) {
                    ...
                    for (int i = 0; i < arguments.length; i++) {
                        ...
                        String typeSig = Signature
                            .createTypeSignature(CharOperation.concatWith(typeReference.getTypeName(), '.'), false);
                        if (arrayDim > 0) {
            ...
            String[] parameterSignatures = new String[0];
    ...
    public static JavaElement getUnresolvedJavaElement(TypeBinding typeBinding, WorkingCopyOwner workingCopyOwner,
        ...
        if (referenceBinding.isLocalType() || referenceBinding.isAnonymousType()) {
            ...
            if (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util
                .isClassFileName(fileName)) {
                int jarSeparator = CharOperation.indexOf(IDependent.JAR_FILE_ENTRY_SEPARATOR, fileName);
                int pkgEnd = CharOperation.lastIndexOf('/', fileName); // pkgEnd is exclusive
                if (pkgEnd == -1)
                    pkgEnd = CharOperation.lastIndexOf(File.separatorChar, fileName);
                if (jarSeparator != -1 && pkgEnd < jarSeparator) // if in a jar and no slash, it is a default package ->
                                                                 // pkgEnd should be equal to jarSeparator
                    pkgEnd = jarSeparator;
                if (pkgEnd == -1)
                    return null;
                IPackageFragment pkg = getPackageFragment(fileName, pkgEnd, jarSeparator);
                ...
                ClassFile classFile
                    = (ClassFile) pkg.getClassFile(new String(classFileName) + SuffixConstants.SUFFIX_STRING_class);
                return (JavaElement) classFile.getType();
            }
            ICompilationUnit cu = getCompilationUnit(fileName, workingCopyOwner);
            if (cu == null)
                return null;
            // must use getElementAt(...) as there is no back pointer to the defining method (scope is null after
            // resolution has ended)
            try {
                int sourceStart
                    = ((com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding) referenceBinding).sourceStart;
            ...
            Binding declaringElement
                = ((com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeVariableBinding) referenceBinding).declaringElement;
            if (declaringElement instanceof MethodBinding) {
                ...
                IType declaringType = (IType) getUnresolvedJavaElement((TypeBinding) declaringElement, workingCopyOwner,
                    bindingsToNodes);
            ...
            if (declaringTypeBinding == null) {
                ...
                // member type
                IType declaringType
                    = (IType) getUnresolvedJavaElement(declaringTypeBinding, workingCopyOwner, bindingsToNodes);
                if (declaringType == null)
                    return null;
     ...
     */
    public static boolean isExcluded(IJavaElement element) {
     ...
     */
    public static boolean isExcluded(IPath resourcePath, char[][] inclusionPatterns, char[][] exclusionPatterns,
    ...
    public static boolean isValidCompilationUnitName(String name, String sourceLevel, String complianceLevel) {
        return JavaConventions.validateCompilationUnitName(name, sourceLevel, complianceLevel).getSeverity()
            != IStatus.ERROR;
    }
    ...
    public static boolean isValidFolderNameForPackage(String folderName, String sourceLevel, String complianceLevel) {
        return JavaConventions.validateIdentifier(folderName, sourceLevel, complianceLevel).getSeverity()
            != IStatus.ERROR;
    }
     ...
     */
    public static String[] splitOn(char divider, String string, int start, int end) {
    ...
    public static IJavaElement[] sortCopy(IJavaElement[] elements) {
        ...
        sort(copy,
            (a, b) -> ((JavaElement) a).toStringWithAncestors().compareTo(((JavaElement) b).toStringWithAncestors()));
        return copy;
    }
            ...
            case Signature.C_TYPE_VARIABLE:
                int e
                    = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util
                        .scanTypeVariableSignature(string, start);
    ...
    public static String typeSignature(TypeReference type) {
        ...
        } else if (type instanceof IntersectionCastTypeReference intersection) {
     ...
     */
    public static boolean isJavaLikeFileName(String name) {
        if (name == null)
            return false;
     ...
     * (implementation is not creating extra strings)
     */
    public static boolean isJavaLikeFileName(char[] fileName) {
        if (fileName == null)
            return false;
        int fileNameLength = fileName.length;
        char[][] javaLikeExtensions = getJavaLikeExtensions();
     ...
     */
    public static char[][][] getAllTypeArguments(char[][] typeSignatures) {
    ...
    public static Object getAnnotationMemberValue(JavaElement parent, MemberValuePair memberValuePair,
        ...
        if (binaryValue instanceof Constant) {
            ...
            char[] className = Signature
                .toCharArray(CharOperation.replaceOnCopy(((ClassSignature) binaryValue).getTypeName(), '/', '.'));
            return new String(className);
        } else if (binaryValue instanceof EnumConstantSignature enumConstant) {
        ...
        } else if (binaryValue instanceof Object[] binaryValues) {
    ...
    public static Object getNegativeAnnotationMemberValue(MemberValuePair memberValuePair, Constant constant) {
        ...
        return switch (constant.typeID()) {
            case TypeIds.T_int -> {
                memberValuePair.valueKind = IMemberValuePair.K_INT;
                yield constant.intValue() * -1;
            }
            case TypeIds.T_float -> {
                memberValuePair.valueKind = IMemberValuePair.K_FLOAT;
                yield constant.floatValue() * -1.0f;
            }
            case TypeIds.T_double -> {
                memberValuePair.valueKind = IMemberValuePair.K_DOUBLE;
                yield constant.doubleValue() * -1.0;
            }
            case TypeIds.T_long -> {
                memberValuePair.valueKind = IMemberValuePair.K_LONG;
                yield constant.longValue() * -1L;
            }
            default -> {
                memberValuePair.valueKind = IMemberValuePair.K_UNKNOWN;
                yield null;
     ...
     */
    public static char[][] splitTypeLevelsSignature(String typeSignature) {
...
//		int[] lengthes = new int [10];
    ...
    private static int appendTypeSignatureForAnchor(char[] string, int start, StringBuilder buffer, boolean isVarArgs) {
        ...
        if (isVarArgs) {
            ...
            return switch (c) {
                case Signature.C_ARRAY -> appendArrayTypeSignatureForAnchor(string, start, buffer, true);
                default -> throw newUnexpectedCharacterException(string, start, c);
            };
        } else {
            switch (c) {
                case Signature.C_ARRAY:
    ...
    private static int appendTypeArgumentSignatureForAnchor(char[] string, int start, StringBuilder buffer) {
        ...
        char c = string[start];
        return switch (c) {
            case Signature.C_STAR -> start;
            case Signature.C_EXTENDS -> appendTypeSignatureForAnchor(string, start + 1, buffer, false);
            case Signature.C_SUPER -> appendTypeSignatureForAnchor(string, start + 1, buffer, false);
            default -> appendTypeSignatureForAnchor(string, start, buffer, false);
        };
    }
     ...
     */
    public static IMethod findMethod(IType type, char[] selector, String[] paramTypeSignatures, boolean isConstructor)
    ...
    public static String getEntryName(String zipfileName, ZipEntry entry) throws ZipException {
        ...
        boolean zipSlip;
        try {
            zipSlip = !java.nio.file.Path.of(zipfileName, entryName)
                .normalize()
