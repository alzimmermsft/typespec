...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.googlejavaformat.java.javadoc.JavadocFormatter;
...
public final class JavaCommentsHelper implements CommentsHelper {
    ...
    public String rewrite(Tok tok, int maxWidth, int column0) {
        ...
        return CommentsHelper.reformatParameterComment(tok)
            .orElseGet(
                () -> javadocShaped(lines) ? indentJavadoc(lines, column0) : preserveIndentation(lines, column0));
    }
