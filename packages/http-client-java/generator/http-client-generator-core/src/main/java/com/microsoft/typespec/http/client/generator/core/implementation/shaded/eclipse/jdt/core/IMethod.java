...
public interface IMethod extends IMember, IAnnotatable {
     ...
     * <p>These local variables can be used to retrieve the {@link ILocalVariable#getAnnotations() parameter
     * annotations}.</p>
     *
     ...
     * <li>the actual parameter types and return type for references to signature polymorphic methods from class
     * MethodHandle</li>
     * </ul>
     *
     ...
     * <li>it defines one parameter whose type's simple name is <code>String[]</code></li>
     * </ul>
     * Starting with Java 21 there is "preview feature" that allows <a href="https://openjdk.org/jeps/445">instance main
     * methods</a>.
