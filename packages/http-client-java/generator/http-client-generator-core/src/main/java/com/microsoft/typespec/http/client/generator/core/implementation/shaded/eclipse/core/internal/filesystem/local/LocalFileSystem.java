...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi.service.environment.Constants;
import java.io.File;
import java.net.URI;
...
public class LocalFileSystem extends FileSystem {
     ...
     */
    private static final boolean CASE_SENSITIVE = !MACOSX && new File("a").compareTo(new File("A")) != 0; //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public int attributes() {
        ...
        } else if (Constants.OS_LINUX.equals(os)
            || (Constants.OS_SOLARIS.equals(os) && Constants.ARCH_SPARC.equals(Platform.getOSArch()))) {
