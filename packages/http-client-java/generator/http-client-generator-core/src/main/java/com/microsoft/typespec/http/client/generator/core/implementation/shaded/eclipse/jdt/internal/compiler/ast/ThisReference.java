...
public class ThisReference extends Reference {
    ...
    public boolean checkAccess(BlockScope scope, ReferenceBinding receiverType) {
        ...
        if ((this.bits & ASTNode.IsStrictlyAssigned) == 0) { // checking assignments is deferred to
            ...
            if (JavaFeature.FLEXIBLE_CONSTRUCTOR_BODIES.isSupported(scope.compilerOptions())) {
                if (!this.inFieldReference  // this.f is also covered in
                                            // Reference.checkFieldAccessInEarlyConstructionContext()
    ...
    public TypeBinding resolveType(BlockScope scope) {
        ...
        if (methodScope != null) {
            ...
            if (method != null
                ...
                && TypeBinding.equalsEquals(method.receiver, this.resolvedType))
