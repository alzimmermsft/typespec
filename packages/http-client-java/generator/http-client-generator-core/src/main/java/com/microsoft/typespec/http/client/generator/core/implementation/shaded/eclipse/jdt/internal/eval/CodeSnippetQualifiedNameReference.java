...
public class CodeSnippetQualifiedNameReference extends QualifiedNameReference
    implements EvaluationConstants, ProblemReasons {
     ...
     * @param sourceEnd int
     */
    public CodeSnippetQualifiedNameReference(char[][] sources, long[] positions, int sourceStart, int sourceEnd,
        EvaluationContext evaluationContext) {
    ...
    public void generateCode(BlockScope currentScope, CodeStream codeStream, boolean valueRequired) {
        ...
        FieldBinding lastFieldBinding = this.otherBindings == null
    ...
    public void generateCompoundAssignment(BlockScope currentScope, CodeStream codeStream, Expression expression,
        ...
        FieldBinding lastFieldBinding = this.otherBindings == null
            ...
            : this.otherBindings[this.otherBindings.length - 1];
        if (lastFieldBinding.canBeSeenBy(getFinalReceiverType(), this, currentScope)) {
            super.generateCompoundAssignment(currentScope, codeStream, expression, operator,
    ...
    public void generatePostIncrement(BlockScope currentScope, CodeStream codeStream, CompoundAssignment postIncrement,
        ...
        codeStream.generateEmulationForField(lastFieldBinding);
        if ((TypeBinding.equalsEquals(lastFieldBinding.type, TypeBinding.LONG))
            || (TypeBinding.equalsEquals(lastFieldBinding.type, TypeBinding.DOUBLE))) {
            codeStream.dup_x2();
            codeStream.pop();
            if (lastFieldBinding.isStatic()) {
                codeStream.aconst_null();
    ...
    public void generateReceiver(CodeStream codeStream) {
        ...
        if (this.delegateThis != null) {
            codeStream.fieldAccess(Opcodes.OPC_getfield, this.delegateThis, null /* default declaringClass */); // delegated
                                                                                                                // field
                                                                                                                // access
        }
    }
    ...
    public TypeBinding getOtherFieldBindings(BlockScope scope) {
        ...
        if ((this.bits & Binding.FIELD) != 0) {
            ...
            if (isFieldUseDeprecated((FieldBinding) this.binding, scope,
                this.indexOfFirstFieldBinding == length ? this.bits : 0)) {
            ...
            if (!field.isValidBinding()) {
                ...
                if (this.delegateThis == null) {
                    if (this.evaluationContext.declaringTypeName != null) {
                        ...
                        if (this.delegateThis == null) {  // if not found then internal error, field should have been
                                                          // found
    ...
    public TypeBinding reportError(BlockScope scope) {
        ...
        if (this.binding instanceof ProblemFieldBinding
            ...
            CodeSnippetScope localScope = new CodeSnippetScope(scope);
            if ((this.binding = localScope.getBinding(this.tokens, this.bits & RestrictiveFlagMASK, this,
                (ReferenceBinding) this.delegateThis.type)).isValidBinding()) {
