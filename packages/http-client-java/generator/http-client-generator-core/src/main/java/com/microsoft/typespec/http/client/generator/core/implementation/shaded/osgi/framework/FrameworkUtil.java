...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.framework.connect.FrameworkUtilHelper;
 ...
 * @since 1.3
 * @ThreadSafe
 * @author $Id: 4612858734c13ec1c9cf69f29920e6fa2539810c $
 */
public class FrameworkUtil {
    ...
    public static Optional<Bundle> getBundle(ClassLoader bundleClassLoader) {
        ...
        return Optional.ofNullable(
            (bundleClassLoader instanceof BundleReference) ? ((BundleReference) bundleClassLoader).getBundle() : null);
    }
    ...
    public static Bundle getBundle(Class<?> classFromBundle) {
        ...
        Optional<ClassLoader> cl = Optional
            .ofNullable(AccessController.doPrivileged((PrivilegedAction<ClassLoader>) classFromBundle::getClassLoader));
    ...
    static {
        ...
        try {
            ServiceLoader<FrameworkUtilHelper> helperLoader = AccessController
                .doPrivileged((PrivilegedAction<ServiceLoader<FrameworkUtilHelper>>) () -> ServiceLoader
                    .load(FrameworkUtilHelper.class, FrameworkUtilHelper.class.getClassLoader()));
    ...
    static private final class DNChainMatching {
            ...
            if (dnPattern instanceof String) {
                ...
                if (dnPattern.equals(STAR_WILDCARD)) {
                    ...
                    return dnChainMatch(dnChain, dnChainIndex, dnChainPattern, dnChainPatternIndex)
                        || dnChainMatch(dnChain, dnChainIndex + 1, dnChainPattern, dnChainPatternIndex);
                }
        ...
        static boolean match(String pattern, List<String> dnChain) {
            ...
            try {
                ...
                throw new IllegalArgumentException("Invalid DN chain: " + toString(dnChain), e);
            }
            try {
