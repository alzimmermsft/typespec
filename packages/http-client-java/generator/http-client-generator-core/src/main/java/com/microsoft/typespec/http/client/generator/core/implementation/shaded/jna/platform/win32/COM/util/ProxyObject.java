...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.COM.ConnectionPointContainer;
...
public class ProxyObject implements InvocationHandler,
    ...
    public <T> void setProperty(DISPID dispId, T value) {
        ...
        HRESULT hr = this.oleMethod(OleAuto.DISPATCH_PROPERTYPUT, null, this.getRawDispatch(), dispId, v);
    ...
    private void setProperty(DISPID dispID, Object... args) {
        ...
        HRESULT hr = this.oleMethod(OleAuto.DISPATCH_PROPERTYPUT, null, this.getRawDispatch(), dispID, vargs);
    ...
    public <T> T getProperty(Class<T> returnType, DISPID dispID, Object... args) {
        ...
        HRESULT hr = this.oleMethod(OleAuto.DISPATCH_PROPERTYGET, result, this.getRawDispatch(), dispID, vargs);
    ...
    public <T> T invokeMethod(Class<T> returnType, DISPID dispID, Object... args) {
        ...
        VARIANT.ByReference result = new VARIANT.ByReference();
        HRESULT hr = this.oleMethod(OleAuto.DISPATCH_METHOD, result, this.getRawDispatch(), dispID, vargs);
