    ...
    public void validate() {
        ...
        try {
            ...
            if (resource.isAccessible()) {
                this.project.flushClasspathProblemMarkers(true/* flush cycle markers */,
                    true/* flush classpath format markers */, true /* flush overlapping output markers */);
        ...
        if (rawClasspath != JavaProject.INVALID_CLASSPATH && outputLocation != null) {
            for (IClasspathEntry cpe : rawClasspath) {
                status = ClasspathEntry.validateClasspathEntry(this.project, cpe, false/* src attach */,
