...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Multisets.ImmutableEntry;
...
class RegularImmutableMultiset<E> extends ImmutableMultiset<E> {
    ...
    private RegularImmutableMultiset(ImmutableEntry<E>[] entries, @Nullable ImmutableEntry<?>[] hashTable, int size,
        int hashCode, @CheckForNull ImmutableSet<E> elementSet) {
    ...
    public int count(@CheckForNull Object element) {
        ...
        for (ImmutableEntry<?> entry = hashTable[hash & mask]; entry != null; entry = entry.nextInBucket()) {
