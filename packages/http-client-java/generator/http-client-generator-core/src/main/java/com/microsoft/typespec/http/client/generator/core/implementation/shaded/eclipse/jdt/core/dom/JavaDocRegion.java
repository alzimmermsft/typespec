...
public class JavaDocRegion extends AbstractTagElement {
    ...
    public static final SimplePropertyDescriptor DUMMY_REGION_PROPERTY
        = new SimplePropertyDescriptor(JavaDocRegion.class, "dummyRegion", boolean.class, MANDATORY); //$NON-NLS-1$ );
    ...
    public static final SimplePropertyDescriptor VALID_SNIPPET_PROPERTY
        = new SimplePropertyDescriptor(JavaDocRegion.class, "validSnippet", boolean.class, MANDATORY); //$NON-NLS-1$ );
     ...
     */
    private final NodeList tags = new NodeList(TAGS_PROPERTY);
