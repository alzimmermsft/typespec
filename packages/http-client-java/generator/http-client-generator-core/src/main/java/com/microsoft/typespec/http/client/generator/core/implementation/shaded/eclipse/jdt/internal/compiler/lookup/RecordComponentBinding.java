...
public class RecordComponentBinding extends VariableBinding {
    ...
    public RecordComponentBinding(ReferenceBinding declaringRecord, RecordComponent declaration, TypeBinding type,
        int modifiers) {
    ...
    public long getAnnotationTagBits() {
        ...
        if ((originalRecordComponentBinding.extendedTagBits & ExtendedTagBits.AnnotationResolved) == 0
            ...
            if (recordComponent != null) {
                ASTNode.resolveAnnotations(typeDecl.initializerScope, recordComponent.annotations,
                    originalRecordComponentBinding);
            }
        }
