...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnitResolver.IntArrayList;
...
public class ASTParser {
	...
	private List<Classpath> getClasspath() throws IllegalStateException {
		...
		try {
			if ((this.bits & CompilationUnitResolver.INCLUDE_RUNNING_VM_BOOTCLASSPATH) != 0) {
				com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util.collectRunningVMBootclasspath(allClasspaths);
			}
	 ...
	 * </p>
	 * <p>Note that working copy owners are used only if the <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core</code>
			...
			if (cu != null) {
				...
				try {
					...
					if (element instanceof BinaryMember)
						...
						key = ((com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.TypeParameter) element).getKey(true/*open to get resolved info*/);
		...
		switch(this.astKind) {
				...
				if (this.rawSource == null) {
					if (this.typeRoot != null) {
						...
						if (this.typeRoot instanceof ICompilationUnit) {
							com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.env.ICompilationUnit sourceUnit = (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.env.ICompilationUnit) this.typeRoot;
							...
							try {
								...
								CharSequence stackTrace = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util.getStackTrace(e);
			...
			case K_COMPILATION_UNIT :
				try {
					...
					com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.env.ICompilationUnit sourceUnit = null;
					...
					if (this.typeRoot instanceof ICompilationUnit) {
							 ...
							 */
							sourceUnit = (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.env.ICompilationUnit) this.typeRoot;
							/*
	...
	private ASTNode internalCreateASTForKind() {
		...
		switch(this.astKind) {
			case K_STATEMENTS :
				...
				com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Statement[] statements = constructorDeclaration.statements;
				if (statements != null) {
