...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Table.Cell;
...
public final class Tables {
     ...
     * @since 21.0
     */
    public static <T extends @Nullable Object, R extends @Nullable Object, C extends @Nullable Object, V extends @Nullable Object, I extends Table<R, C, V>>
        Collector<T, ?, I> toTable(java.util.function.Function<? super T, ? extends R> rowFunction,
     ...
     */
    public static <R extends @Nullable Object, C extends @Nullable Object, V extends @Nullable Object> Cell<R, C, V>
        immutableCell(@ParametricNullness R rowKey, @ParametricNullness C columnKey, @ParametricNullness V value) {
        return new ImmutableCell<>(rowKey, columnKey, value);
    }

    static final class ImmutableCell<R extends @Nullable Object, C extends @Nullable Object, V extends @Nullable Object>
    ...
    abstract static class AbstractCell<R extends @Nullable Object, C extends @Nullable Object, V extends @Nullable Object>
     ...
     * way around.
     */
    public static <R extends @Nullable Object, C extends @Nullable Object, V extends @Nullable Object> Table<C, R, V>
    ...
    private static class TransposeTable<C extends @Nullable Object, R extends @Nullable Object, V extends @Nullable Object>
        ...
        private static final Function TRANSPOSE_CELL = new Function<Cell<?, ?, ?>, Cell<?, ?, ?>>() {
            @Override
    ...
    private static class TransformedTable<R extends @Nullable Object, C extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object>
     ...
     * @since 11.0
     */
    public static <R extends @Nullable Object, C extends @Nullable Object, V extends @Nullable Object> Table<R, C, V>
        unmodifiableTable(Table<? extends R, ? extends C, ? extends V> table) {
        return new UnmodifiableTable<>(table);
    }

    private static class UnmodifiableTable<R extends @Nullable Object, C extends @Nullable Object, V extends @Nullable Object>
    ...
    static final class UnmodifiableRowSortedMap<R extends @Nullable Object, C extends @Nullable Object, V extends @Nullable Object>
    ...
    @SuppressWarnings("unchecked")
    private static <K extends @Nullable Object, V extends @Nullable Object> Function<Map<K, V>, Map<K, V>>
        unmodifiableWrapper() {
