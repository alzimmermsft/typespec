...
public class DOMToModelPopulator extends ASTVisitor {
	...
	@Override
	public boolean visit(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit node) {
	...
	public boolean visit(PackageDeclaration node) {
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.PackageDeclaration newElement = new org.eclipse.jdt.internal.core.PackageDeclaration(this.root, node.getName().toString());
	...
	public boolean visit(ImportDeclaration node) {
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.ImportDeclaration newElement = new org.eclipse.jdt.internal.core.ImportDeclaration(this.importContainer, node.getName().toString(), node.isOnDemand());
		this.elements.push(newElement);
	...
	public boolean visit(TypeDeclaration node) {
		...
		if (node.getAST().apiLevel() > 2) {
			((List<com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.TypeParameter>)node.typeParameters())
				.stream()
				.map(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.TypeParameter::getName)
	...
	public void endVisit(TypeDeclaration decl) {
		...
		if (decl.getAST().apiLevel() > 2) {
			((List<com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.TypeParameter>)decl.typeParameters())
				.stream()
				.map(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.TypeParameter::getName)
				.map(Name::getFullyQualifiedName)
	...
	public boolean visit(MethodDeclaration method) {
		if (method.getAST().apiLevel() > 2) {
			((List<com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.TypeParameter>)method.typeParameters())
				.stream()
				.map(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.TypeParameter::getName)
				.map(Name::getFullyQualifiedName)
				.forEach(this.currentTypeParameters::add);
	...
	public boolean visit(AnnotationTypeMemberDeclaration method) {
		...
		if (defaultExpr != null) {
			...
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.MemberValuePair mvp = new org.eclipse.jdt.internal.core.MemberValuePair(newElement.getElementName(), value.getKey(), value.getValue());
	...
	@Override
	public boolean visit(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.TypeParameter node) {
	...
	@Override
	public void endVisit(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.TypeParameter typeParam) {
		this.elements.pop();
		this.infos.pop();
	}
	...
	public boolean visit(NormalAnnotation node) {
		...
		newInfo.members = ((List<MemberValuePair>)node.values())
			.stream()
	...
	private Annotation toModelAnnotation(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.Annotation domAnnotation, JavaElement parent) {
	...
	public boolean visit(FieldDeclaration field) {
		...
		for (VariableDeclarationFragment fragment : (Collection<VariableDeclarationFragment>) field.fragments()) {
			...
			if (field.getAST().apiLevel() >= AST.JLS3) {
				...
				if (modifiers != null) {
					modifiers.stream()
						.filter(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.Annotation.class::isInstance)
						.map(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.Annotation.class::cast)
	...
	public boolean visit(Initializer node) {
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.Initializer newElement = new org.eclipse.jdt.internal.core.Initializer(this.elements.peek(), 1);
		this.elements.push(newElement);
		addAsChild(this.infos.peek(), newElement);
	...
	private static com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit domUnit(ASTNode node) {
	...
	private Javadoc javadoc(ASTNode node) {
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit unit = domUnit(node);
