...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Sspi.CredHandle;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Sspi.CtxtHandle;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Sspi.PSecPkgInfo;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Sspi.SecBufferDesc;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Sspi.TimeStamp;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinNT.LUID;
...
public interface Secur32 extends StdCallLibrary {
     ...
     * @param len On input, the size of the buffer, on output the number of characters copied into the buffer, not
     ...
     * credentials, pass a {@link Sspi.SEC_WINNT_AUTH_IDENTITY}
     ...
     */
    int AcquireCredentialsHandle(String pszPrincipal, String pszPackage, int fCredentialUse, LUID pvLogonID,
     ...
     * If the function fails, the function returns one of the SEC_E_ error codes.
     */
    int InitializeSecurityContext(CredHandle phCredential, CtxtHandle phContext, String pszTargetName, int fContextReq,
        int Reserved1, int TargetDataRep, SecBufferDesc pInput, int Reserved2, CtxtHandle phNewContext,
        SecBufferDesc pOutput, IntByReference pfContextAttr, TimeStamp ptsExpiry);
     ...
     */
    int AcceptSecurityContext(CredHandle phCredential, CtxtHandle phContext, SecBufferDesc pInput, int fContextReq,
        int TargetDataRep, CtxtHandle phNewContext, SecBufferDesc pOutput, IntByReference pfContextAttr,
     ...
     * @param pToken A {@link SecBufferDesc} structure that contains the
     ...
     * <tr><td>SEC_E_OUT_OF_SEQUENCE</td><td>The client's security context was located, but the message number is
     * incorrect. This return value is used with the Digest SSP.</td></tr>
     * <tr><td>SEC_E_MESSAGE_ALTERED</td><td>The client's security context was located, but the client's message has
     * been tampered with. This return value is used with the Digest SSP.</td></tr>
     ...
     */
    int QueryCredentialsAttributes(CredHandle phCredential, int ulAttribute, Structure pBuffer);
     ...
     * If the function fails, the return value is a nonzero error code.
     */
    int QuerySecurityPackageInfo(String pszPackageName, PSecPkgInfo ppPackageInfo);
     ...
     * {@link Sspi#SECQOP_WRAP_NO_ENCRYPT}.
     * @return If the function verifies that the message was received in the correct sequence, the function returns
     * SEC_E_OK.
     * @see <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa375385(v=vs.85).aspx">MSDN Entry</a>
     */
