...
class StandardValueGraph<N, V> extends AbstractValueGraph<N, V> {
    ...
    StandardValueGraph(AbstractGraphBuilder<? super N> builder) {
        this(builder,
            builder.nodeOrder.<N, GraphConnections<N, V>>createMap(builder.expectedNodeCount.or(DEFAULT_NODE_COUNT)),
            0L);
    }
     ...
     * node map.
     */
    StandardValueGraph(AbstractGraphBuilder<? super N> builder, Map<N, GraphConnections<N, V>> nodeConnections,
        long edgeCount) {
