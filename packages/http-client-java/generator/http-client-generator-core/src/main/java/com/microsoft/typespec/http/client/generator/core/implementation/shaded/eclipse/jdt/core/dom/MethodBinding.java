...
class MethodBinding implements IMethodBinding {
	...
	MethodBinding(BindingResolver resolver, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.MethodBinding binding) {
	...
	public IAnnotationBinding[] getParameterAnnotations(int index) {
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[][] bindingAnnotations = this.binding.getParameterAnnotations();
		...
		for (int i = 0; i < length; i++) {
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] paramBindingAnnotations = bindingAnnotations[i];
	...
	protected IAnnotationBinding[] filterTypeAnnotations(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] internalAnnotations) {
	...
	public boolean isEqualTo(IBinding other) {
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.MethodBinding otherBinding = ((MethodBinding) other).binding;
