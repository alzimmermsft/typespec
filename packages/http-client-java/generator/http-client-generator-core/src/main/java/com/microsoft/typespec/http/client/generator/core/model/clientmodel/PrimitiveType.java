...
public class PrimitiveType implements IType {
    ...
    public static final PrimitiveType BYTE = new Builder().name("byte")
    ...
    public static final PrimitiveType INT = new Builder().name("int")
    ...
    public static final PrimitiveType FLOAT = new Builder().name("float")
    ...
    public static final PrimitiveType DOUBLE = new Builder().prototypeAsDouble().build();

    public static final PrimitiveType CHAR = new Builder().name("char")
...
//    }
    ...
    public String jsonSerializationMethodCall(String jsonWriterName, String fieldName, String valueGetter,
        ...
        if (wrapSerializationWithObjectsToString) {
            return fieldName == null
                ? String.format("%s.%s(Objects.toString(%s, null))", jsonWriterName, serializationMethodBase,
                    valueGetter)
    ...
    public String xmlSerializationMethodCall(String xmlWriterName, String attributeOrElementName, String namespaceUri,
        ...
        String value
            = wrapSerializationWithObjectsToString ? "Objects.toString(" + valueGetter + ", null)" : valueGetter;
    ...
    private static class Builder {
        ...
        public Builder prototypeAsDouble() {
            return this.name("double")
                ...
                .defaultValueExpressionConverter(defaultValueExpression -> java.lang.Double
                    .toString(java.lang.Double.parseDouble(defaultValueExpression)))
                .defaultValue("0.0")
                .jsonToken("JsonToken.NUMBER")
        ...
        public Builder defaultValueExpressionConverter(
