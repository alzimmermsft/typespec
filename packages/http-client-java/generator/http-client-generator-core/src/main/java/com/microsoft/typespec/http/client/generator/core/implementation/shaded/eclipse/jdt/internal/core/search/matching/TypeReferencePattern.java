...
public class TypeReferencePattern extends IntersectingPattern {
	...
	public char[] getIndexKey() {
		...
		// Optimization, e.g. type reference is 'com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.*'
	...
	protected boolean hasNextQuery() {
		...
		// redundant (e.g. in 'com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.*' 'com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse' is used all the time)
