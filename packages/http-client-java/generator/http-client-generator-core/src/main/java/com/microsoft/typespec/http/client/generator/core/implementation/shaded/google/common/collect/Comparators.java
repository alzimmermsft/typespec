...
public final class Comparators {
    ...
    public static <T extends @Nullable Object, S extends T> Comparator<Iterable<S>>
     ...
     * @since 22.0
     */
    public static <T extends @Nullable Object> Collector<T, ?, List<T>> greatest(int k,
    ...
    public static <T> Comparator<Optional<T>> emptiesFirst(Comparator<? super T> valueComparator) {
        ...
        return Comparator.<Optional<T>, @Nullable T>comparing(o -> o.orElse(null),
     ...
     */
    @ParametricNullness
    public static <T extends @Nullable Object> T min(@ParametricNullness T a, @ParametricNullness T b,
        Comparator<T> comparator) {
     ...
     */
    @ParametricNullness
    public static <T extends @Nullable Object> T max(@ParametricNullness T a, @ParametricNullness T b,
        Comparator<T> comparator) {
        return (comparator.compare(a, b) >= 0) ? a : b;
    }
}
