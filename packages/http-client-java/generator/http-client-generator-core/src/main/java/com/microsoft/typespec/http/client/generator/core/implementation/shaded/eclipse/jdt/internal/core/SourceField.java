...
public class SourceField extends NamedMember implements IField {
    ...
    public ASTNode findNode(
        com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit ast) {
    ...
    public ResolvedSourceField resolved(Binding binding) {
        return new ResolvedSourceField(this.getParent(), this.name, new String(binding.computeUniqueKey()),
            this.getOccurrenceCount());
    }
