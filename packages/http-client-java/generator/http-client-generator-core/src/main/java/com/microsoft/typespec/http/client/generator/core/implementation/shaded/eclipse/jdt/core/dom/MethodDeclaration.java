...
public class MethodDeclaration extends BodyDeclaration {
    ...
    /**
     * The "modifiers" structural property of this node type (element type: {@link IExtendedModifier}) (added in JLS3
     * API).
     * 
     * @since 3.1
     */
    ...
    /**
     * The "extraDimensions2" structural property of this node type (element type: {@link Dimension}) (added in JLS8
     * API).
     * 
     * @since 3.10
     */
    ...
    /**
     * The "typeParameters" structural property of this node type (element type: {@link TypeParameter}) (added in JLS3
     * API).
     * 
     * @since 3.1
     */
    public static final ChildListPropertyDescriptor TYPE_PARAMETERS_PROPERTY = new ChildListPropertyDescriptor(
        MethodDeclaration.class, "typeParameters", TypeParameter.class, NO_CYCLE_RISK); //$NON-NLS-1$
    ...
    public static final ChildListPropertyDescriptor PARAMETERS_PROPERTY = new ChildListPropertyDescriptor(
        MethodDeclaration.class, "parameters", SingleVariableDeclaration.class, CYCLE_RISK); //$NON-NLS-1$
    ...
    /**
     * The "receiverQualifier" structural property of this node type (child type: {@link SimpleName}) (added in JLS8
     * API).
     * 
     * @since 3.10
     */
    public static final ChildPropertyDescriptor RECEIVER_QUALIFIER_PROPERTY = new ChildPropertyDescriptor(
        MethodDeclaration.class, "receiverQualifier", SimpleName.class, OPTIONAL, NO_CYCLE_RISK); //$NON-NLS-1$
    ...
    /**
     * The "thrownExceptionTypes" structural property of this node type (element type: {@link Type}) (added in JLS8
     * API).
     * 
     * @since 3.10
     */
     ...
     */
    private final NodeList parameters = new NodeList(PARAMETERS_PROPERTY);
     ...
     * @since 3.1
     */
    private NodeList typeParameters = null;
     ...
     * @since 3.10
     */
    private NodeList extraDimensions = null;
     ...
     */
    private NodeList thrownExceptions = null;
     ...
     * @since 3.10
     */
    private NodeList thrownExceptionTypes = null;
    ...
    MethodDeclaration(AST ast) {
        ...
        if (ast.apiLevel >= AST.JLS3_INTERNAL) {
            this.typeParameters = new NodeList(TYPE_PARAMETERS_PROPERTY);
        }
        if (ast.apiLevel < AST.JLS8_INTERNAL) {
            this.thrownExceptions = new NodeList(THROWN_EXCEPTIONS_PROPERTY);
        } else {
            this.extraDimensions = new NodeList(EXTRA_DIMENSIONS2_PROPERTY);
            this.thrownExceptionTypes = new NodeList(THROWN_EXCEPTION_TYPES_PROPERTY);
        }
    }
     ...
     * <p>
     * A receiver type is only legal in Java code if it appears on an instance method or on a constructor of an inner
     * class.
     * </p>
     *
    ...
    /**
     * Returns the qualifying name, if any, for the explicit receiver or <code>null</code> if not used (added in JLS8
     * API).
     * <p>
        ...
        if (this.returnType == null && !this.returnType2Initialized) {
            ...
            synchronized (this) {
                if (this.returnType == null && !this.returnType2Initialized) {
                    preLazyInit();
                    this.returnType
                        = postLazyInit(this.ast.newPrimitiveType(PrimitiveType.VOID), RETURN_TYPE2_PROPERTY);
    ...
    int treeSize() {
        return memSize() + (this.optionalDocComment == null ? 0 : getJavadoc().treeSize())
            ...
            + (this.returnType == null ? 0 : this.returnType.treeSize()) + this.parameters.listSize()
