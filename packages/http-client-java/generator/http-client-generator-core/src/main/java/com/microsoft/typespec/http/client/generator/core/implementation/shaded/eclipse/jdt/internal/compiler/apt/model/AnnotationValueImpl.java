...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.element.AnnotationValueVisitor;
...
public class AnnotationValueImpl implements AnnotationValue, TypeIds {
     ...
     * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.ElementValuePair#getValue()}
     * for possible object types:
     * <ul>
     * <li>{@link Constant} for member
    ...
    private Object convertToMirrorType(Object value, TypeBinding type, int kind[]) {
        if (type == null) {
            ...
            if (value == null) {
                if (type instanceof BaseTypeBinding || type.id == TypeIds.T_JavaLangString) {
