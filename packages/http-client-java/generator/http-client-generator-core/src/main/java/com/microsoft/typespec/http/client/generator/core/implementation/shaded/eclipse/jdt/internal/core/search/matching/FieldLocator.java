...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.search.FieldDeclarationMatch;
 ...
 * @see org.eclipse.jdt.internal.core.search.matching.PatternLocator#updateMatch(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.ParameterizedTypeBinding, char[][][], com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.search.matching.MatchLocator)
 */
@Override
...
protected void reportDeclaration(FieldBinding fieldBinding, MatchLocator locator, SimpleSet knownFields) throws CoreException {
	...
	if (isBinary) {
		...
		info = locator.getBinaryInfo((com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.ClassFile) type.getClassFile(), resource);
