...
public interface ICompletionRequestor {
     ...
     */
    void acceptAnonymousType(char[] superTypePackageName, char[] superTypeName, char[][] parameterPackageNames,
        char[][] parameterTypeNames, char[][] parameterNames, char[] completionName, int modifiers, int completionStart,
     ...
     * @deprecated Use {@link CompletionRequestor#accept(CompletionProposal)} instead.
     */
    void acceptClass(char[] packageName, char[] className, char[] completionName, int modifiers, int completionStart,
        int completionEnd, int relevance);
     ...
     * @deprecated Use {@link CompletionRequestor#accept(CompletionProposal)} instead.
     */
    void acceptLocalVariable(char[] name, char[] typePackageName, char[] typeName, int modifiers, int completionStart,
        int completionEnd, int relevance);
     ...
     * @param completionName The completion for the method. Can include zero, one or two brackets. If the closing
     * bracket is included, then the cursor should be placed before it.
    ...
    void acceptMethod(char[] declaringTypePackageName, char[] declaringTypeName, char[] selector,
        ...
        char[] returnTypePackageName, char[] returnTypeName, char[] completionName, int modifiers, int completionStart,
        int completionEnd, int relevance);
     ...
     * @deprecated Use {@link CompletionRequestor#accept(CompletionProposal)} instead.
     */
    void acceptMethodDeclaration(char[] declaringTypePackageName, char[] declaringTypeName, char[] selector,
        char[][] parameterPackageNames, char[][] parameterTypeNames, char[][] parameterNames,
        char[] returnTypePackageName, char[] returnTypeName, char[] completionName, int modifiers, int completionStart,
        int completionEnd, int relevance);
     ...
     * @deprecated Use {@link CompletionRequestor#accept(CompletionProposal)} instead.
     */
    void acceptVariableName(char[] typePackageName, char[] typeName, char[] name, char[] completionName,
        int completionStart, int completionEnd, int relevance);
}
