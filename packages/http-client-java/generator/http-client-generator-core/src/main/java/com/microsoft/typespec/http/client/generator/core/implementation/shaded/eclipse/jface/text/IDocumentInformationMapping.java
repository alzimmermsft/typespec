 ...
 * exist:
 * <ul>
 * <li> {@link IDocumentInformationMappingExtension} since version 3.0 extending the
 * degree of detail of the mapping information.</li>
 * <li> {@link IDocumentInformationMappingExtension2} since version 3.1, adding lenient
...
public interface IDocumentInformationMapping {
     ...
     * @return the minimal region of the original document comprising the given region of the image document or
     * <code>null</code>
     ...
     * @return the minimal region of the image document comprising the given region of the original document or
     * <code>null</code>
