...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.math.LongMath;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.errorprone.annotations.InlineMe;
...
public final class Streams {
    ...
    public static <T> Stream<T> stream(
        com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Optional<T> optional) {
    ...
    @com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.errorprone.annotations.InlineMeValidationDisabled("Java 9+ API only")
    ...
    public static IntStream concat(IntStream... streams) {
        ...
        return StreamSupport
            .intStream(CollectSpliterators.flatMapToInt(splitrsBuilder.build().spliterator(), splitr -> splitr,
    ...
    public static LongStream concat(LongStream... streams) {
        ...
        return StreamSupport
            .longStream(CollectSpliterators.flatMapToLong(splitrsBuilder.build().spliterator(), splitr -> splitr,
                characteristics, estimatedSize), isParallel)
            .onClose(() -> closeAll(streams));
    }
    ...
    public static DoubleStream concat(DoubleStream... streams) {
        ...
        return StreamSupport
            .doubleStream(CollectSpliterators.flatMapToDouble(splitrsBuilder.build().spliterator(), splitr -> splitr,
                characteristics, estimatedSize), isParallel)
            .onClose(() -> closeAll(streams));
    }
     ...
     */
    @Beta
    public static <A extends @Nullable Object, B extends @Nullable Object, R extends @Nullable Object> Stream<R>
        ...
        return StreamSupport
            .stream(new AbstractSpliterator<R>(min(splitrA.estimateSize(), splitrB.estimateSize()), characteristics) {
                @Override
    ...
    public static <A extends @Nullable Object, B extends @Nullable Object> void forEachPair(Stream<A> streamA,
        Stream<B> streamB, BiConsumer<? super A, ? super B> consumer) {
     ...
     * was defined.
     */
    public static <T extends @Nullable Object, R extends @Nullable Object> Stream<R> mapWithIndex(Stream<T> stream,
     ...
     * was defined.
     */
    public static <R extends @Nullable Object> Stream<R> mapWithIndex(IntStream stream,
     ...
     * was defined.
     */
    public static <R extends @Nullable Object> Stream<R> mapWithIndex(DoubleStream stream,
        DoubleFunctionWithIndex<R> function) {
        checkNotNull(stream);
        checkNotNull(function);
        boolean isParallel = stream.isParallel();
    ...
    private abstract static class MapWithIndexSpliterator<F extends Spliterator<?>, R extends @Nullable Object, S extends MapWithIndexSpliterator<F, R, S>>
