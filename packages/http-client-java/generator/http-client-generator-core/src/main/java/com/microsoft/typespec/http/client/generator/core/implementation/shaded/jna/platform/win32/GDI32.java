...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinDef.HBRUSH;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinDef.HDC;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinDef.HFONT;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinDef.HPALETTE;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinDef.HPEN;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinGDI.PIXELFORMATDESCRIPTOR;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinGDI.RGNDATA;
...
public interface GDI32 extends StdCallLibrary {
     ...
     * 
     * @param lpXform
     * Pointer to an XFORM structure that defines the transformation to be performed on the region. If this pointer is
     * NULL,
     ...
     * To get extended error information, call GetLastError.
     */
    HBITMAP CreateDIBitmap(HDC hDC, BITMAPINFOHEADER lpbmih, int fdwInit, Pointer lpbInit, BITMAPINFO lpbmi,
        int fuUsage);
     ...
     * for the bitmap bit values is to begin.
     */
    HBITMAP CreateDIBSection(HDC hDC, BITMAPINFO pbmi, int iUsage, PointerByReference ppvBits, Pointer hSection,
        int dwOffset);
     ...
     * If the function fails, the return value is zero.
     */
    public int GetObject(final HANDLE hgdiobj, final int cbBuffer, final Pointer lpvObject);
