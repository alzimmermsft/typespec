...
public final class Functions {
     ...
     *
     * <p>Note: if {@code map} is a
     * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.BiMap BiMap}
     * (or can be one), you
     * can use
     * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Maps#asConverter
     * Maps.asConverter} instead to get a
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> Function<K, V>
        forMap(Map<K, ? extends V> map, @ParametricNullness V defaultValue) {
        return new ForMapWithDefault<>(map, defaultValue);
    }

    private static class FunctionForMapNoDefault<K extends @Nullable Object, V extends @Nullable Object>
    ...
    private static class ForMapWithDefault<K extends @Nullable Object, V extends @Nullable Object>
        ...
        public V apply(@ParametricNullness K key) {
            V result = map.get(key);
            // The unchecked cast is safe because of the containsKey check.
            return (result != null || map.containsKey(key)) ? uncheckedCastNullableTToT(result) : defaultValue;
        }
     ...
     */
    public static <A extends @Nullable Object, B extends @Nullable Object, C extends @Nullable Object> Function<A, C>
        compose(Function<B, C> g, Function<A, ? extends B> f) {
        return new FunctionComposition<>(g, f);
    }

    private static class FunctionComposition<A extends @Nullable Object, B extends @Nullable Object, C extends @Nullable Object>
    ...
    private static class PredicateFunction<T extends @Nullable Object> implements Function<T, Boolean>, Serializable {
     ...
     */
    public static <E extends @Nullable Object> Function<@Nullable Object, E> constant(@ParametricNullness E value) {
     ...
     * @since 10.0
     */
    public static <F extends @Nullable Object, T extends @Nullable Object> Function<F, T>
