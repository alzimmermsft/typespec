...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.env.ISourceModule;
...
public class ModuleDescriptionInfo extends AnnotatableInfo implements ISourceModule {
    ...
    static class ModuleReferenceInfo extends MemberElementInfo implements IModuleReference {
        char[] name;
        int modifiers;
    ...
    static class PackageExportInfo extends MemberElementInfo implements IPackageExport {
        char[] pack;
        char[][] target;
    ...
    static class ServiceInfo extends MemberElementInfo implements IService {
        char[] serviceName;
        char[][] implNames;
    ...
    public static ModuleDescriptionInfo createModule(ModuleDeclaration module) {
        ...
        if (module.requiresCount > 0) {
            ...
            for (int i = 0; i < refs.length; i++) {
                ...
                mod.requires[i + 1].name = CharOperation.concatWith(refs[i].module.tokens, '.'); // Check why
                                                                                                 // ModuleReference#tokens
                                                                                                 // must be a char[][]
                                                                                                 // and not a char[] or
                                                                                                 // String;
