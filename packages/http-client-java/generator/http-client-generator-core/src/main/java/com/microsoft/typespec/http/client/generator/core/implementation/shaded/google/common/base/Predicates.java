...
public final class Predicates {
     ...
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Iterables#filter(Iterable, Class)}
     * in preference.
     *
     ...
     */
    public static <A extends @Nullable Object, B extends @Nullable Object> Predicate<A> compose(Predicate<B> predicate,
    ...
    private static class NotPredicate<T extends @Nullable Object> implements Predicate<T>, Serializable {
    ...
    private static class AndPredicate<T extends @Nullable Object> implements Predicate<T>, Serializable {
     ...
     */
    @GwtIncompatible // Class.isInstance
    private static class InstanceOfPredicate<T extends @Nullable Object> implements Predicate<T>, Serializable {
    ...
    private static class InPredicate<T extends @Nullable Object> implements Predicate<T>, Serializable {
    ...
    private static <T extends @Nullable Object> List<Predicate<? super T>> asList(Predicate<? super T> first,
        Predicate<? super T> second) {
