...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.Internal.toNanosSaturated;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.CollectionFuture.ListFuture;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ImmediateFuture.ImmediateCancelledFuture;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ImmediateFuture.ImmediateFailedFuture;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.internal.InternalFutureFailureAccess;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.internal.InternalFutures;
...
public final class Futures extends GwtFuturesCatchingSpecialization {
     ...
     */
    public static <V extends @Nullable Object> ListenableFuture<V> immediateFuture(@ParametricNullness V value) {
        if (value == null) {
     ...
     * @since 23.0
     */
    public static <O extends @Nullable Object> ListenableFuture<O> submitAsync(AsyncCallable<O> callable,
        Executor executor) {
        TrustedListenableFutureTask<O> task = TrustedListenableFutureTask.create(callable);
        executor.execute(task);
        return task;
    ...
    public static <O extends @Nullable Object> ListenableFuture<O> scheduleAsync(AsyncCallable<O> callable,
        Duration delay, ScheduledExecutorService executorService) {
    ...
    // TODO(cpovirk): Return ListenableScheduledFuture?
    public static <O extends @Nullable Object> ListenableFuture<O> scheduleAsync(AsyncCallable<O> callable, long delay,
    ...
    @J2ktIncompatible
    @GwtIncompatible // java.util.concurrent.ScheduledExecutorService
    public static <V extends @Nullable Object> ListenableFuture<V> withTimeout(ListenableFuture<V> delegate,
        Duration time, ScheduledExecutorService scheduledExecutor) {
    ...
    @GwtIncompatible // java.util.concurrent.ScheduledExecutorService
    @SuppressWarnings("GoodTime") // should accept a java.time.Duration
    public static <V extends @Nullable Object> ListenableFuture<V> withTimeout(ListenableFuture<V> delegate, long time,
     ...
     *     ListenableFuture<QueryResult> queryFuture = transformAsync(rowKeyFuture, dataService::readFuture, executor);
     * }
     * </pre>
     *
     * <p>When selecting an executor, note that {@code directExecutor} is dangerous in some cases. See
     ...
     */
    public static <I extends @Nullable Object, O extends @Nullable Object> ListenableFuture<O>
    ...
    public static <I extends @Nullable Object, O extends @Nullable Object> Future<O>
        lazyTransform(final Future<I> input, final Function<? super I, ? extends O> function) {
        checkNotNull(input);
     ...
     */
    @SafeVarargs
    public static <V extends @Nullable Object> ListenableFuture<List<V>>
     ...
     */
    @SafeVarargs
    public static <V extends @Nullable Object> FutureCombiner<V>
     ...
     *     ListenableFuture<UsageHistory> usageFuture = Futures.whenAllSucceed(loginDateFuture, recentCommandsFuture)
     *         .call(() -> new UsageHistory(username, Futures.getDone(loginDateFuture),
     *             Futures.getDone(recentCommandsFuture)), executor);
     * }
     * </pre>
     *
     * @since 20.0
    ...
    public static final class FutureCombiner<V extends @Nullable Object> {
         ...
         */
        public <C extends @Nullable Object> ListenableFuture<C> callAsync(AsyncCallable<C> combiner,
            Executor executor) {
     ...
     * @since 15.0
     */
    public static <V extends @Nullable Object> ListenableFuture<V>
     ...
     */
    @SafeVarargs
    public static <V extends @Nullable Object> ListenableFuture<List<@Nullable V>>
     ...
     * @since 17.0
     */
    public static <T extends @Nullable Object> ImmutableList<ListenableFuture<T>>
    ...
    @SuppressWarnings("unchecked")
    private static <T extends @Nullable Object> ListenableFuture<? extends T>[]
    ...
    // cancelled.
    private static final class InCompletionOrderFuture<T extends @Nullable Object> extends AbstractFuture<T> {
        @CheckForNull
     ...
     * @since 10.0
     */
    public static <V extends @Nullable Object> void addCallback(final ListenableFuture<V> future,
    ...
    @ParametricNullness
    public static <V extends @Nullable Object, X extends Exception> V getChecked(Future<V> future,
        Class<X> exceptionClass, Duration timeout) throws X {
    ...
    @ParametricNullness
    public static <V extends @Nullable Object, X extends Exception> V getChecked(Future<V> future,
        Class<X> exceptionClass, long timeout, TimeUnit unit) throws X {
