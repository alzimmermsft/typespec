...
/**
 * Default implementation of {@link IPositionUpdater}.
 * <p>
...
public class DefaultPositionUpdater implements IPositionUpdater {
     ...
     * First it checks whether the change replaces only a non-zero range inside the range of the position (including the
     * borders).
