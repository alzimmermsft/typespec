 ...
 * {@link IPackageFragmentRoot}.</li>
 * <li>{@link #F_CLOSED} - The underlying
 * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.resources.IProject}
 ...
 * <li>{@link #F_OPENED} - The underlying
 * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.resources.IProject}
 ...
 * the underlying resource was added, removed or changed. For example, if a project P already contains a folder src,
 * then
 ...
 * </p>
 * <p>
 * Note that when a source attachment path or a source attachment root path is changed, then the flags of the delta
 * contain
...
public interface IJavaElementDelta {
    ...
    /**
     * Change flag indicating that a classpath entry corresponding to the element has been added to the project's
     * classpath.
