...
public class CharacterLiteral extends Expression {
    ...
    public char charValue() {
        ...
        Scanner scanner = new Scanner(this.ast.scanner.tokenizeComments, this.ast.scanner.tokenizeWhiteSpace,
            this.ast.scanner.checkNonExternalizedStringLiterals, this.ast.scanner.sourceLevel,
            this.ast.scanner.complianceLevel, this.ast.scanner.taskTags, this.ast.scanner.taskPriorities,
            this.ast.scanner.isTaskCaseSensitive, this.ast.scanner.previewEnabled);
