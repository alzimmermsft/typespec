...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Sets.newConcurrentHashSet;
...
abstract class AggregateFutureState<OutputT extends @Nullable Object> extends AbstractFuture.TrustedFuture<OutputT> {
    ...
    private static final class SafeAtomicHelper extends AtomicHelper {
        ...
        SafeAtomicHelper(AtomicReferenceFieldUpdater seenExceptionsUpdater,
            ...
            this.seenExceptionsUpdater
                = (AtomicReferenceFieldUpdater<AggregateFutureState<?>, @Nullable Set<Throwable>>) seenExceptionsUpdater;
