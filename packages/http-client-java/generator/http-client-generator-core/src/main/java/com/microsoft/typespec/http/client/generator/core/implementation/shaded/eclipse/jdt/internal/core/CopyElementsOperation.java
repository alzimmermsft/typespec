		...
		switch (element.getElementType()) {
			...
			case IJavaElement.TYPE :
				if (isRenamingMainType(element, dest)) {
					...
					String lineSeparator = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.getLineSeparator(source, element.getJavaProject());
			...
			case IJavaElement.FIELD :
				...
				lineSeparator = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.getLineSeparator(source, element.getJavaProject());
...
protected boolean isRenamingMainType(IJavaElement element, IJavaElement dest) throws JavaModelException {
	if ((isRename() || getNewNameFor(element) != null)
		...
		typeName = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.getNameWithoutJavaLikeExtension(typeName);
