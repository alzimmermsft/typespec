 ...
 * type are of type <code>"com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.text.annotation.unknown"</code>.
 */
public class Annotation {

	/**
	 * Constant for unknown annotation types.<p>
	 * Value: <code>"com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.text.annotation.unknown"</code>
	 * @since 3.0
	 */
	public final static String TYPE_UNKNOWN= "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.text.annotation.unknown";  //$NON-NLS-1$
