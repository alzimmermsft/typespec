 ...
 * type are of type
 * <code>"com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.text.annotation.unknown"</code>.
 */
public class Annotation {
    ...
    public final static String TYPE_UNKNOWN
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.text.annotation.unknown";  //$NON-NLS-1$
