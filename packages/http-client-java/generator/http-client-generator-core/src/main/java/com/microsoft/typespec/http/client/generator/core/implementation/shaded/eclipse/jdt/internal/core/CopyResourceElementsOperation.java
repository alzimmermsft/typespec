...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.AbstractTypeDeclaration;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.Name;
...
public class CopyResourceElementsOperation extends MultiOperation implements SuffixConstants {
	...
	private IResource[] collectResourcesOfInterest(IPackageFragment source) throws JavaModelException {
		...
		for (Object res : nonJavaResources) {
			if (res instanceof IResource) actualNonJavaResourceCount++;
		}
	...
	private void processCompilationUnitResource(ICompilationUnit source, PackageFragment dest) throws JavaModelException {
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.CompilationUnit destCU = new org.eclipse.jdt.internal.core.CompilationUnit(dest, destName, DefaultWorkingCopyOwner.PRIMARY);
	...
	protected void processDeltas() {
		for (Object deltta : this.deltasPerProject.values()) {
			addDelta((IJavaElementDelta) deltta);
		}
	}
	/**
	 * @see MultiOperation
		...
		try {
				...
				if (resources.length > 0) {
					if (isRename()) {
						...
						for (IResource resource : resources) {
							IResource destinationResource = ResourcesPlugin.getWorkspace().getRoot().findMember(destPath.append(resource.getName()));
			...
			if (isMove()) {
				...
				if (isEmpty) {
					...
					deleteEmptyPackageFragment(source, rootResource);
				}
	...
	protected void verify(IJavaElement element) throws JavaModelException {
		...
		if (elementType == IJavaElement.COMPILATION_UNIT) {
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.CompilationUnit compilationUnit = (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.CompilationUnit) element;
