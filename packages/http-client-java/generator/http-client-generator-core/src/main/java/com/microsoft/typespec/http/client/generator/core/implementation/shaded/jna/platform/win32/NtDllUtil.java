...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Wdm.KEY_BASIC_INFORMATION;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Wdm.KEY_INFORMATION_CLASS;
...
public abstract class NtDllUtil {
    ...
    public static String getKeyName(HKEY hkey) {
        ...
        rc = NtDll.INSTANCE.ZwQueryKey(hkey, KEY_INFORMATION_CLASS.KeyBasicInformation, keyInformation,
            resultLength.getValue(), resultLength);
