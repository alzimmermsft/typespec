...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.preferences.AbstractPreferenceStorage;
        ...
        ISafeRunnable code = new ISafeRunnable() {
            ...
            public void handleException(Throwable exception) {
                if (exception instanceof BackingStoreException) {
                    ...
                    bse[0]
                        = new BackingStoreException(NLS.bind(PrefsMessages.preferences_loadException, path), exception);
                }
            }
        };
        SafeRunner.run(code);
