...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, @Nullable V> implements Serializable {
    ...
    private abstract static class ArrayMap<K, V extends @Nullable Object> extends IteratorBasedAbstractMap<K, V> {
    ...
    Spliterator<Cell<R, C, @Nullable V>> cellSpliterator() {
        return CollectSpliterators.<Cell<R, C, @Nullable V>>indexed(size(),
