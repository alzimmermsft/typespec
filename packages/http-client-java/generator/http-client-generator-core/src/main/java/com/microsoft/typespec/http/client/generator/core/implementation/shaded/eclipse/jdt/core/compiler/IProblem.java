...
public interface IProblem {
    ...
    @Deprecated
    int SuperclassInheritedNameHidesEnclosingName = TypeRelated + 329 + ProblemReasons.InheritedNameHidesEnclosingName; // TypeRelated
                                                                                                                        // +
                                                                                                                        // 334
    ...
    /** @deprecated - problem is no longer generated, use {@link #InheritedTypeHidesEnclosingName} instead */
    @Deprecated
    int InterfaceInheritedNameHidesEnclosingName = TypeRelated + 334 + ProblemReasons.InheritedNameHidesEnclosingName; // TypeRelated
                                                                                                                       // +
                                                                                                                       // 339
    ...
    /** @deprecated - problem is no longer generated, use {@link #InheritedTypeHidesEnclosingName} instead */
    int FieldTypeInheritedNameHidesEnclosingName = FieldRelated + 349 + ProblemReasons.InheritedNameHidesEnclosingName; // FieldRelated
                                                                                                                        // +
                                                                                                                        // 354
    ...
    /** @deprecated - problem is no longer generated, use {@link #InternalTypeNameProvided} instead */
    @Deprecated
    int ArgumentTypeInternalNameProvided = MethodRelated + 369 + ProblemReasons.InternalNameProvided; // MethodRelated +
                                                                                                      // 373
    /** @deprecated - problem is no longer generated, use {@link #InheritedTypeHidesEnclosingName} instead */
    @Deprecated
    ...
    /** @deprecated - problem is no longer generated, use {@link #InternalTypeNameProvided} instead */
    @Deprecated
    int ExceptionTypeInternalNameProvided = MethodRelated + 374 + ProblemReasons.InternalNameProvided; // MethodRelated
                                                                                                       // + 378
    /** @deprecated - problem is no longer generated, use {@link #InheritedTypeHidesEnclosingName} instead */
    @Deprecated
    ...
    /** @deprecated - problem is no longer generated, use {@link #InternalTypeNameProvided} instead */
    @Deprecated
    int ReturnTypeInternalNameProvided = MethodRelated + 379 + ProblemReasons.InternalNameProvided; // MethodRelated +
                                                                                                    // 383
    /** @deprecated - problem is no longer generated, use {@link #InheritedTypeHidesEnclosingName} instead */
    @Deprecated
    ...
    /** @deprecated - problem is no longer generated, use {@link #InheritedTypeHidesEnclosingName} instead */
    @Deprecated
    int ImportInheritedNameHidesEnclosingName = ImportRelated + 389 + ProblemReasons.InheritedNameHidesEnclosingName; // ImportRelated
                                                                                                                      // +
                                                                                                                      // 394
     ...
     * {@link #RedundantNullCheckOnNullLocalVariable} or {@link #RedundantLocalVariableNullAssignment} instead
     */
    @Deprecated
    int LocalVariableCanOnlyBeNull = Internal + 398; // since 3.3: split with LocalVariableRedundantCheckOnNull
    ...
    /**
     * @deprecated This problem is no longer reported; number Of functional interface is not an issue, number of
     * abstract methods is.
     * @since 3.10
     */
    @Deprecated
    ...
    /** @since 3.14 */
    int VarLocalInitializedToNull = TypeRelated + 1504; // Variable initialized to ''null'' needs an explicit
                                                        // target-type
    /** @since 3.14 */
    int VarLocalInitializedToVoid = TypeRelated + 1505; // Variable initializer is ''void'' -- cannot infer variable
                                                        // type
    /** @since 3.14 */
    ...
    /** @since 3.14 */
    int VarIsReservedInFuture = Syntax + 1510; // ''var'' should not be used as an type name, since it is a reserved
                                               // word from source level 10 on
    /** @since 3.14 */
    int VarIsNotAllowedHere = Syntax + 1511; // ''var'' is not allowed here
    /** @since 3.16 */
    int VarCannotBeMixedWithNonVarParams = Syntax + 1512; // ''var'' cannot be mixed with explicit or implicit
                                                          // parameters
    /** @since 3.35 */
    int VarCannotBeUsedWithTypeArguments = Syntax + 1513; // ''var'' cannot be used with type arguments (e.g. as in
     ...
     * @since 3.26
     */
    int PatternSubtypeOfExpression = Internal + 1782;  // ass backwards naming of API constant :-( It should read
                                                       // ExpressionSubtypeOfPattern
    /**
     * @since 3.26
     */
