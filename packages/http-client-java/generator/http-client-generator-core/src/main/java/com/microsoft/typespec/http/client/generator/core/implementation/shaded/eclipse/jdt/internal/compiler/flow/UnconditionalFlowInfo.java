...
public class UnconditionalFlowInfo extends FlowInfo {
    ...
    public long iDefNBit,	// would an incoming null value definitely reach the current point?
...
//		thisHadNulls = false; // suppress incoming null info, if none shines through in other
        ...
        if (otherHasNulls) {
            if (!thisHadNulls) {
                ...
                // this implements that otherInit does not accept certain bits which are known to be superseded by info
                // in otherInits.
                long acceptNonNull = otherInits.iNNBit;
                long acceptNull = otherInits.iNBit | protNN1111; // for 1111 don't bother suppressing incoming null,
                                                                 // logic operation would produce wrong result
                long dontResetToStart = ~protNN1111 | acceptNonNull; // for 1111 & ~acceptNonNull we reset all bits to
                                                                     // 0000
                ...
                this.nullBit1 = (b1 = otherInits.nullBit1)
                    | a1 & (a3 & a4 & (nb2 = ~(b2 = otherInits.nullBit2)) & (nb4 = ~(b4 = otherInits.nullBit4))
                        | ((na4 = ~a4) | (na3 = ~a3))
                            & ((na2 = ~a2) & nb2 | a2 & (nb3 = ~(b3 = otherInits.nullBit3)) & nb4));
                this.nullBit2 = b2 & (nb4 | nb3) | na3 & na4 & b2
                    | a2 & (nb3 & nb4 | (nb1 = ~b1) & (na3 | (na1 = ~a1)) | a1 & b2);
                this.nullBit3 = b3 & (nb1 & (b2 | a2 | na1) | b1 & (b4 | nb2 | a1 & a3) | na1 & na2 & na4)
                    | a3 & nb2 & nb4 | nb1 & ((na2 & a4 | na1) & a3 | a1 & na2 & na4 & b2);
                this.nullBit4 = nb1
                    & (a4 & (na3 & nb3 | (a3 | na2) & nb2) | a1 & (a3 & nb2 & b4 | a2 & b2 & (b4 | a3 & na4 & nb3)))
                    | b1 & (a3 & a4 & b4 | na2 & na4 & nb3 & b4 | a2 & ((b3 | a4) & b4 | na3 & a4 & b2 & b3)
                        | na1 & (b4 | (a4 | a2) & b2 & b3))
        ...
        if (this.extra != null || otherInits.extra != null) {
            ...
            if (this.extra != null) {
                ...
                if (otherHasNulls) {
                    for (int j = 2; j < extraLength; j++) {
                        System.arraycopy(otherInits.extra[j], 0, (this.extra[j] = new long[otherLength]), 0,
                            otherLength);
                    }
            ...
            for (i = 0; i < mergeLimit; i++) {
                ...
                long acceptNull = otherInits.extra[IN][i] | protNN1111; // for 1111 don't bother suppressing incoming
                                                                        // null, logic operation would produce wrong
                                                                        // result
                long dontResetToStart = ~protNN1111 | acceptNonNull; // for 1111 & ~acceptNonNull we reset all bits to
                                                                     // 0000
                ...
                this.extra[1 + 1][i] = (b1 = otherInits.extra[1 + 1][i]) | a1
                    & (a3 & a4 & (nb2 = ~(b2 = otherInits.extra[2 + 1][i])) & (nb4 = ~(b4 = otherInits.extra[4 + 1][i]))
                        | ((na4 = ~a4) | (na3 = ~a3))
                            & ((na2 = ~a2) & nb2 | a2 & (nb3 = ~(b3 = otherInits.extra[3 + 1][i])) & nb4));
                this.extra[2 + 1][i] = b2 & (nb4 | nb3) | na3 & na4 & b2
                    | a2 & (nb3 & nb4 | (nb1 = ~b1) & (na3 | (na1 = ~a1)) | a1 & b2);
                this.extra[3 + 1][i] = b3 & (nb1 & (b2 | a2 | na1) | b1 & (b4 | nb2 | a1 & a3) | na1 & na2 & na4)
                    | a3 & nb2 & nb4 | nb1 & ((na2 & a4 | na1) & a3 | a1 & na2 & na4 & b2);
                this.extra[4 + 1][i] = nb1
                    & (a4 & (na3 & nb3 | (a3 | na2) & nb2) | a1 & (a3 & nb2 & b4 | a2 & b2 & (b4 | a3 & na4 & nb3)))
                    | b1 & (a3 & a4 & b4 | na2 & na4 & nb3 & b4 | a2 & ((b3 | a4) & b4 | na3 & a4 & b2 & b3)
                        | na1 & (b4 | (a4 | a2) & b2 & b3))
                    | (na1 & (na3 & nb3 | na2 & nb2) | a1 & (nb2 & nb3 | a2 & a3)) & b4;
    ...
    public UnconditionalFlowInfo addPotentialNullInfoFrom(UnconditionalFlowInfo otherInits) {
        ...
        long a1, a2, a3, a4, na1, na2, na3, na4, b1, b2, b3, b4, nb1, nb2, nb3, nb4;
        if (thisHadNulls) {
            this.nullBit1 = (a1 = this.nullBit1) & ((a3 = this.nullBit3) & (a4 = this.nullBit4)
                & ((nb2 = ~(b2 = otherInits.nullBit2)) & (nb4 = ~(b4 = otherInits.nullBit4))
                    | (b1 = otherInits.nullBit1) & (b3 = otherInits.nullBit3))
                | (na2 = ~(a2 = this.nullBit2)) & (b1 & b3 | ((na4 = ~a4) | (na3 = ~a3)) & nb2)
                | a2 & ((na4 | na3) & ((nb3 = ~b3) & nb4 | b1 & b2)));
            this.nullBit2 = b2 & (nb3 | (nb1 = ~b1)) | a2 & (nb3 & nb4 | b2 | na3 | (na1 = ~a1));
            this.nullBit3 = b3 & (nb1 & b2 | a2 & (nb2 | a3) | na1 & nb2 | a1 & na2 & na4 & b1)
                | a3 & (nb2 & nb4 | na2 & a4 | na1) | a1 & na2 & na4 & b2;
            ...
            this.nullBit2 = (b2 = otherInits.nullBit2)
                & ((nb3 = ~(b3 = otherInits.nullBit3)) | (nb1 = ~(b1 = otherInits.nullBit1)));
        ...
        if (otherInits.extra != null) {
            ...
            for (i = 0; i < mergeLimit; i++) {
                this.extra[1 + 1][i]
                    = (a1 = this.extra[1 + 1][i]) & ((a3 = this.extra[3 + 1][i]) & (a4 = this.extra[4 + 1][i])
                        & ((nb2 = ~(b2 = otherInits.extra[2 + 1][i])) & (nb4 = ~(b4 = otherInits.extra[4 + 1][i]))
                            | (b1 = otherInits.extra[1 + 1][i]) & (b3 = otherInits.extra[3 + 1][i]))
                        | (na2 = ~(a2 = this.extra[2 + 1][i])) & (b1 & b3 | ((na4 = ~a4) | (na3 = ~a3)) & nb2)
                        | a2 & ((na4 | na3) & ((nb3 = ~b3) & nb4 | b1 & b2)));
                this.extra[2 + 1][i] = b2 & (nb3 | (nb1 = ~b1)) | a2 & (nb3 & nb4 | b2 | na3 | (na1 = ~a1));
                this.extra[3 + 1][i] = b3 & (nb1 & b2 | a2 & (nb2 | a3) | na1 & nb2 | a1 & na2 & na4 & b1)
                    | a3 & (nb2 & nb4 | na2 & a4 | na1) | a1 & na2 & na4 & b2;
                this.extra[4 + 1][i] = na3 & (nb1 & nb3 & b4 | a4 & (nb3 | b1 & b2))
                    | nb2 & (na3 & b1 & nb3 | na2 & (nb1 & b4 | b1 & nb3 | a4))
                    | a3 & (a4 & (nb2 | b1 & b3) | a1 & a2 & (nb1 & b4 | na4 & (b2 | b1) & nb3));
                // this and then pot.other: leave iNBit & iNNBit untouched
            ...
            for (; i < copyLimit; i++) {
                ...
                this.extra[DEFINN][i] &= nb2 | (b1 & b2 & b3 & b4); // b2 signals possible null, except for 1111
                                                                    // (prot.nn)
                if ((this.extra[2 + 1][i] | this.extra[3 + 1][i] | this.extra[4 + 1][i]) != 0) { // bit1 is redundant
                    thisHasNulls = true;
                }
    ...
    public void acceptIncomingNullnessFrom(UnconditionalFlowInfo other) {
        if (this.iDefNNBit != 0 || this.iDefNBit != 0) {
            long b1 = other.nullBit1, b2 = other.nullBit2, nb2 = ~b2, b3 = other.nullBit3, nb3 = ~b3,
                nb4 = ~other.nullBit4;
    ...
    final public boolean cannotBeDefinitelyNullOrNonNull(LocalVariableBinding local) {
        ...
        if ((position = local.id + this.maxFieldCount) < BitCacheSize) {
            // use bits
            return ((~this.nullBit1 & (this.nullBit2 & this.nullBit3 | this.nullBit4)
                | ~this.nullBit2 & ~this.nullBit3 & this.nullBit4) & (1L << position)) != 0;
        }
        // use extra vector
        if (this.extra == null) {
        ...
        long a2, a3, a4;
        return ((~this.extra[2][vectorIndex] & ((a2 = this.extra[3][vectorIndex]) & (a3 = this.extra[4][vectorIndex])
            | (a4 = this.extra[5][vectorIndex])) | ~a2 & ~a3 & a4) & (1L << (position % BitCacheSize))) != 0;
    }
    ...
    final public boolean cannotBeNull(LocalVariableBinding local) {
        ...
        if ((position = local.id + this.maxFieldCount) < BitCacheSize) {
            // use bits
            return (this.nullBit1 & this.nullBit3 & ((this.nullBit2 & this.nullBit4) | ~this.nullBit2)
                & (1L << position)) != 0;
        }
        // use extra vector
        if (this.extra == null) {
    ...
    final public boolean isDefinitelyNonNull(LocalVariableBinding local) {
        ...
        if ((local.type.tagBits & TagBits.IsBaseType) != 0 || local.constant() != Constant.NotAConstant) { // String
                                                                                                           // instances
            return true;
        }
        ...
        return ((this.extra[2][vectorIndex] & this.extra[4][vectorIndex]
            & (~this.extra[3][vectorIndex] | this.extra[5][vectorIndex])) & (1L << (position % BitCacheSize))) != 0;
    }
    ...
    final public boolean isDefinitelyUnknown(LocalVariableBinding local) {
        ...
        return ((this.extra[2][vectorIndex] & this.extra[5][vectorIndex] & ~this.extra[3][vectorIndex]
            & ~this.extra[4][vectorIndex]) & (1L << (position % BitCacheSize))) != 0;
    }
    ...
    final public boolean hasNullInfoFor(LocalVariableBinding local) {
        ...
        return ((this.extra[2][vectorIndex] | this.extra[3][vectorIndex] | this.extra[4][vectorIndex]
            | this.extra[5][vectorIndex]) & (1L << (position % BitCacheSize))) != 0;
    }
...
// TODO (Ayush) Check why this method does not return true for protected null
    ...
    final public boolean isProtectedNonNull(LocalVariableBinding local) {
        ...
        return (this.extra[2][vectorIndex] & this.extra[4][vectorIndex] & this.extra[5][vectorIndex]
            & (1L << (position % BitCacheSize))) != 0;
    }
    ...
    public void markAsComparedEqualToNonNull(LocalVariableBinding local) {
        ...
        if (this != DEAD_END) {
            ...
            if ((position = local.id + this.maxFieldCount) < BitCacheSize) {
                // use bits
                if (((mask = 1L << position) & (a1 = this.nullBit1) & (na2 = ~(a2 = this.nullBit2))
                    & ~(a3 = this.nullBit3) & (a4 = this.nullBit4)) != 0) {
                    this.nullBit4 &= ~mask;
                ...
                if (((mask = 1L << (position % BitCacheSize)) & (a1 = this.extra[1 + 1][vectorIndex])
                    & (na2 = ~(a2 = this.extra[2 + 1][vectorIndex])) & ~(a3 = this.extra[3 + 1][vectorIndex])
                    & (a4 = this.extra[4 + 1][vectorIndex])) != 0) {
        ...
        if (this != DEAD_END) {
            ...
            if ((position = local.id + this.maxFieldCount) < BitCacheSize) {
                ...
                if ((mask & this.extra[1 + 1][vectorIndex]) != 0) {
                    if ((mask & (~this.extra[2 + 1][vectorIndex] | this.extra[3 + 1][vectorIndex]
...
//			 obvious
    ...
    public void markPotentiallyNonNullBit(LocalVariableBinding local) {
        if (this != DEAD_END) {
            ...
            if ((position = local.id + this.maxFieldCount) < BitCacheSize) {
                ...
                mask = 1L << (position % BitCacheSize);
                isTrue((this.extra[2][vectorIndex] & mask) == 0,
                    "Adding 'potentially non-null' mark in unexpected state"); //$NON-NLS-1$
                this.extra[4][vectorIndex] |= mask;
                if (COVERAGE_TEST_FLAG) {
    ...
    public UnconditionalFlowInfo mergedWith(UnconditionalFlowInfo otherInits) {
        ...
        boolean thisHasNulls = (this.tagBits & NULL_FLAG_MASK) != 0,
            otherHasNulls = (otherInits.tagBits & NULL_FLAG_MASK) != 0, thisWasUnreachable = false,
        ...
        if ((otherInits.tagBits & FlowInfo.UNREACHABLE_BY_NULLANALYSIS) != 0) {
        ...
        } else if ((this.tagBits & FlowInfo.UNREACHABLE_BY_NULLANALYSIS) != 0) { // directly copy if this is unreachable
                                                                                 // by null analysis
            this.nullBit1 = otherInits.nullBit1;
            this.nullBit2 = otherInits.nullBit2;
            this.nullBit3 = otherInits.nullBit3;
            ...
            if (otherHasNulls) {
                this.nullBit1 = (a1 = this.nullBit1) & (b1 = otherInits.nullBit1)
                    & (((a2 = this.nullBit2)
                        & (((b2 = otherInits.nullBit2) & ~(((a3 = this.nullBit3) & (a4 = this.nullBit4))
                            ^ ((b3 = otherInits.nullBit3) & (b4 = otherInits.nullBit4)))) | (a3 & a4 & (nb2 = ~b2))))
                ...
                this.nullBit4 = na3 & (nb1 & nb3 & b4 | b1 & (nb2 & nb3 | a4 & b2 & nb4) | na1 & a4 & (nb3 | b1 & b2))
                    | a3 & a4 & (b3 & b4 | b1 & nb2 | na1 & a2) | na2 & (nb1 & b4 | b1 & nb3 | na1 & a4) & nb2
                    | a1 & (na3 & (nb3 & b4 | b1 & b2 & b3 & nb4 | na2 & (nb3 | nb2)) | na2 & b3 & b4
        ...
        if (this.extra != null || otherInits.extra != null) {
            ...
            if (thisWasUnreachable) {
                ...
                for (; i < mergeLimit; i++) {
                    this.extra[1 + 1][i] = (a1 = this.extra[1 + 1][i]) & (b1 = otherInits.extra[1 + 1][i])
                        & (((a2 = this.extra[2 + 1][i]) & (((b2 = otherInits.extra[2 + 1][i])
                            & ~(((a3 = this.extra[3 + 1][i]) & (a4 = this.extra[4 + 1][i]))
                                ^ ((b3 = otherInits.extra[3 + 1][i]) & (b4 = otherInits.extra[4 + 1][i]))))
                            | (a3 & a4 & (nb2 = ~b2))))
                            | ((na2 = ~a2) & ((b2 & b3 & b4) | (nb2 & ((na3 = ~a3) ^ b3)))));
                    ...
                    this.extra[4 + 1][i]
                        = na3 & (nb1 & nb3 & b4 | b1 & (nb2 & nb3 | a4 & b2 & nb4) | na1 & a4 & (nb3 | b1 & b2))
                            | a3 & a4 & (b3 & b4 | b1 & nb2 | na1 & a2) | na2 & (nb1 & b4 | b1 & nb3 | na1 & a4) & nb2
                            | a1 & (na3 & (nb3 & b4 | b1 & b2 & b3 & nb4 | na2 & (nb3 | nb2)) | na2 & b3 & b4
                                | a2 & (nb1 & b4 | a3 & na4 & b1) & nb3)
                            | nb1 & b2 & b3 & b4;
                    ...
                    this.extra[DEFINN][i] &= otherInits.extra[DEFINN][i];
                    thisHasNulls
                        = thisHasNulls || this.extra[3][i] != 0 || this.extra[4][i] != 0 || this.extra[5][i] != 0;
                    if (COVERAGE_TEST_FLAG) {
                ...
                for (; i < copyLimit; i++) {
                    ...
                    this.extra[2 + 1][i] = (b2 = otherInits.extra[2 + 1][i])
                        & (nb3 = ~(b3 = otherInits.extra[3 + 1][i]) | (nb1 = ~(b1 = otherInits.extra[1 + 1][i])));
                    this.extra[3 + 1][i]
                        = b3 & ((nb2 = ~b2) & (b4 = otherInits.extra[4 + 1][i]) | nb1) | b1 & nb2 & ~b4;
                ...
                for (; i < resetLimit; i++) {
                    ...
                    this.extra[1 + 1][i] = 0;
                    this.extra[2 + 1][i]
                        = (a2 = this.extra[2 + 1][i]) & (na3 = ~(a3 = this.extra[3 + 1][i]) | (na1 = ~a1));
        ...
        if ((this.tagBits & NULL_FLAG_MASK) != 0) {
            if (this.extra == null) {
                return "FlowInfo<def: " + Long.toHexString(this.definiteInits) //$NON-NLS-1$
                    ...
                    + '.' + Long.toHexString(this.nullBit2) + '.' + Long.toHexString(this.nullBit3) + '.'
                    + Long.toHexString(this.nullBit4) + ", incoming: " + Long.toHexString(this.iNBit) + '.' //$NON-NLS-1$
                    + Long.toHexString(this.iNNBit) + ", def-incoming: " + Long.toHexString(this.iDefNBit) + '.' //$NON-NLS-1$
                    + Long.toHexString(this.iDefNNBit) + ">"; //$NON-NLS-1$
            } else {
                String def = "FlowInfo<def:[" + Long.toHexString(this.definiteInits), //$NON-NLS-1$
                    ...
                    nullS = ", null:[" + Long.toHexString(this.nullBit1) //$NON-NLS-1$
                        ...
                        + Long.toHexString(this.nullBit4) + ", incoming: " + Long.toHexString(this.iNBit) + '.' //$NON-NLS-1$
                        + Long.toHexString(this.iNNBit) + ", def-incoming: " + Long.toHexString(this.iDefNBit) + '.' //$NON-NLS-1$
                        + Long.toHexString(this.iDefNNBit);
                int i, ceil;
                for (i = 0, ceil = this.extra[0].length > 3 ? 3 : this.extra[0].length; i < ceil; i++) {
                    ...
                    nullS += "\n\t" + Long.toHexString(this.extra[2][i]) //$NON-NLS-1$
                        + '.' + Long.toHexString(this.extra[3][i]) + '.' + Long.toHexString(this.extra[4][i]) + '.'
                        + Long.toHexString(this.extra[5][i]) + ", incoming: " + Long.toHexString(this.extra[IN][i]) //$NON-NLS-1$
                        + '.' + Long.toHexString(this.extra[INN][i]);
                }
    ...
    public void growSpace(int newLength, int copyStart, int copyLength) {
        for (int j = 0; j < extraLength; j++) {
            System.arraycopy(this.extra[j], copyStart, (this.extra[j] = new long[newLength]), copyStart, copyLength);
        }
        if ((this.tagBits & UNROOTED) != 0) {
