...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.apt.model.AnnotationMemberValue;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.apt.model.AnnotationMirrorImpl;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.apt.model.ExecutableElementImpl;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.apt.model.ModuleElementImpl;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.apt.model.TypeElementImpl;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.apt.model.VariableElementImpl;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.ArrayInitializer;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.AptSourceLocalVariableBinding;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.SourceModuleBinding;
    ...
    public static AptProblem createProblem(Kind kind, CharSequence msg, Element e, AnnotationMirror a,
                ...
                case MODULE:
                    ...
                    if (moduleBinding instanceof SourceModuleBinding) {
                        ...
                        CompilationUnitDeclaration unitDeclaration
                            = (CompilationUnitDeclaration) sourceModuleBinding.scope.referenceContext();
        ...
        if (referenceContext != null) {
            ...
            lineNumber = startPosition >= 0
                ? Util.getLineNumber(startPosition, lineEnds = result.getLineSeparatorPositions(), 0,
                    lineEnds.length - 1)
                : 0;
        ...
        return new AptProblem(referenceContext, fileName, String.valueOf(builder), 0, NO_ARGUMENTS, severity,
