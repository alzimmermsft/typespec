...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Predicates.alwaysTrue;
...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Maps.safeContainsKey;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Maps.safeGet;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Maps.IteratorBasedAbstractMap;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Maps.ViewCachingAbstractMap;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Sets.ImprovedAbstractSet;
...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    Spliterator<Cell<R, C, V>> cellSpliterator() {
        return CollectSpliterators.flatMap(backingMap.entrySet().spliterator(),
            (Entry<R, Map<C, V>> rowEntry) -> CollectSpliterators.map(rowEntry.getValue().entrySet().spliterator(),
                (Entry<C, V> columnEntry) -> Tables.immutableCell(rowEntry.getKey(), columnEntry.getKey(),
                    ...
                    if (entry.getValue().containsKey(columnKey)) {
                        ...
                        class EntryImpl extends AbstractMapEntry<R, V> {
                            ...
                            public V setValue(V value) {
                                 ...
                                 */
                                return uncheckedCastNullableTToT(entry.getValue().put(columnKey, checkNotNull(value)));
                            }
                        }
