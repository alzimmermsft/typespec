...
public class BatchAnnotationProcessorManager extends BaseAnnotationProcessorManager {
    ...
    public void configure(Object batchCompiler, String[] commandLineArguments) {
        ...
        BatchProcessingEnvImpl processingEnv
            = new BatchProcessingEnvImpl(this, (Main) batchCompiler, commandLineArguments);
        ...
        if (fileManager instanceof StandardJavaFileManager) {
            ...
            if (SourceVersion.latest().compareTo(SourceVersion.RELEASE_8) > 0) {
                location = ((StandardJavaFileManager) fileManager)
                    .getLocation(StandardLocation.ANNOTATION_PROCESSOR_MODULE_PATH);
            }
            if (location != null) {
