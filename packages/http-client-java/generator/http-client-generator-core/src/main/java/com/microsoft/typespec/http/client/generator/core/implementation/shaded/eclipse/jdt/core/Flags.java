 ...
 * <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom</code> package.
 * </p>
 *
...
public final class Flags {
     ...
     * AccVarargs flag has the same value as
     * the AccTransient flag (valid for fields only), attempting to get the description of method modifiers with the
     * AccVarargs flag set would result in an
     * unexpected description. Clients should ensure that the AccVarargs is not included in the flags of a method as
     * follows:
     * 
     * <pre>
     * IMethod method = ...
