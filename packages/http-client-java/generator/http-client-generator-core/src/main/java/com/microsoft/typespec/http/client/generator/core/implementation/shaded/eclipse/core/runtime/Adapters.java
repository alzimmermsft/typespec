...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.runtime.*;
...
public class Adapters {
    ...
    public static <T> Optional<T> of(Object sourceObject, Class<T> adapter) {
        ...
        try {
            ...
            RuntimeLog.log(Status.error(NLS.bind(CommonMessages.adapters_internal_error_of,
                sourceObject.getClass().getName(), adapter.getClass().getName(), e.getLocalizedMessage()), e));
            return Optional.empty();
        }
    }
