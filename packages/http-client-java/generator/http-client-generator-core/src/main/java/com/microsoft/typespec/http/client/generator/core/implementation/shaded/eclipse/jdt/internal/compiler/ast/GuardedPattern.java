...
public class GuardedPattern extends Pattern {
    ...
    public TypeBinding resolveType(BlockScope scope) {
        ...
        try {
            scope.resolvingGuardExpression = true; // as guards cannot nest in the same scope, no save & restore called
                                                   // for
            this.condition.resolveTypeExpectingWithBindings(this.primaryPattern.bindingsWhenTrue(), scope,
                TypeBinding.BOOLEAN);
        } finally {
