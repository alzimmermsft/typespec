 ...
 * </p>
 * <ul>
 * <li> {@link IAnnotationModelExtension} since version 3.0 introducing the concept
 * of model piggybacking annotation models, modification time stamps, and enhanced manipulation methods.
 * </li>
 * <li> {@link IAnnotationModelExtension2} since version 3.4 allows to retrieve
...
public interface IAnnotationModel {
     ...
     * nothing happens.
     * <p>
     * <strong>Performance hint:</strong> Use
     * {@link IAnnotationModelExtension#replaceAnnotations(Annotation[], java.util.Map)}
