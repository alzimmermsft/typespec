...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.classfmt.FieldInfo;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.classfmt.MethodInfo;
...
public class BinaryIndexer extends AbstractIndexer implements SuffixConstants {
	...
	private char[] removeFirstSyntheticParameter(char[] descriptor) {
		...
		if (descriptor[1] != ')') {
			...
			int start = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util.scanTypeSignature(descriptor, 1) + 1;
