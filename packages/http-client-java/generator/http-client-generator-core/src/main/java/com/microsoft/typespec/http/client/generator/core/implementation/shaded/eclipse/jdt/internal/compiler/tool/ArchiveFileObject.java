...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.element.NestingKind;
...
public class ArchiveFileObject implements JavaFileObject {
	...
	/* (non-Javadoc)
	 * @see javax.tools.JavaFileObject#isNameCompatible(java.lang.String, com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.tools.JavaFileObject.Kind)
	 */
	@Override
	...
	public CharSequence getCharContent(boolean ignoreEncodingErrors) throws IOException {
		if (getKind() == Kind.SOURCE) {
			try (ZipFile zipFile2 = new ZipFile(this.file)) {
				...
				return Util.getCharContents(this, ignoreEncodingErrors, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util.getZipEntryByteContent(zipEntry, zipFile2), this.charset.name());
			}
		}
		return null;
	}
