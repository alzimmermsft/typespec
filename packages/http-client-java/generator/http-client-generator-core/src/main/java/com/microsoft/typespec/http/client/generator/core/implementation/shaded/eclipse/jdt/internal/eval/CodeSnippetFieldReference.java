...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.FieldReference;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.ProblemFieldBinding;
...
public class CodeSnippetFieldReference extends FieldReference implements ProblemReasons, EvaluationConstants {
    ...
    public void generateAssignment(BlockScope currentScope, CodeStream codeStream, Assignment assignment,
        ...
        if (codegenBinding.canBeSeenBy(this.actualReceiverType, this, currentScope)) {
            ...
            fieldStore(currentScope, codeStream, codegenBinding, null, this.actualReceiverType,
                this.receiver.isImplicitThis(), valueRequired);
        } else {
                ...
                if (fieldConstant == Constant.NotAConstant) {
                    if (codegenBinding.declaringClass == null) { // array length
                        ...
                        if (codegenBinding.canBeSeenBy(this.actualReceiverType, this, currentScope)) {
                            ...
                            if (isStatic) {
                                codeStream.fieldAccess(Opcodes.OPC_getstatic, codegenBinding,
                                    constantPoolDeclaringClass);
                            } else {
                                codeStream.fieldAccess(Opcodes.OPC_getfield, codegenBinding,
                                    constantPoolDeclaringClass);
                            }
                        } else {
                            if (isStatic) {
    ...
    public void generateCompoundAssignment(BlockScope currentScope, CodeStream codeStream, Expression expression,
        ...
        if (codegenBinding.canBeSeenBy(this.actualReceiverType, this, currentScope)) {
            ...
            if (valueRequired) {
                if ((TypeBinding.equalsEquals(codegenBinding.type, TypeBinding.LONG))
                    || (TypeBinding.equalsEquals(codegenBinding.type, TypeBinding.DOUBLE))) {
                    codeStream.dup2_x2();
                } else {
                    codeStream.dup_x2();
                }
