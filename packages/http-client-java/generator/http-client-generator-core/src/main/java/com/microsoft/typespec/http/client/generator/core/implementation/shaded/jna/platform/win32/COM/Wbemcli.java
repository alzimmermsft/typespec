...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.OaIdlUtil;
...
public interface Wbemcli {
    ...
    class IWbemClassObject extends Unknown {
        ...
        public HRESULT Put(String wszName, int lFlags, VARIANT pVal, int Type) {
    ...
    class IWbemContext extends Unknown {
        ...
        public void SetValue(String wszName, int lFlag, VARIANT pValue) {
