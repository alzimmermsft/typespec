...
public class TypePattern extends Pattern {
     ...
     */
    public static final ChildPropertyDescriptor PATTERN_VARIABLE_PROPERTY = new ChildPropertyDescriptor(
        TypePattern.class, "patternVariable", SingleVariableDeclaration.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
     ...
     * @since 3.39
     */
    public static final ChildPropertyDescriptor PATTERN_VARIABLE_PROPERTY2 = new ChildPropertyDescriptor(
        TypePattern.class, "patternVariable2", VariableDeclaration.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
     ...
     * @deprecated In the JLS22 API, this method is replaced by
     * {@link #setPatternVariable(VariableDeclaration patternVariable)}
     * @since 3.38
     */
            ...
            synchronized (this) {
                if (this.patternVariable == null) {
                    ...
                    this.patternVariable
                        = postLazyInit(new SingleVariableDeclaration(this.ast), PATTERN_VARIABLE_PROPERTY);
                }
            }
        }
        ...
        if (this.patternVariable2 == null) {
            ...
            synchronized (this) {
                if (this.patternVariable2 == null) {
                    ...
                    this.patternVariable2
                        = postLazyInit(new SingleVariableDeclaration(this.ast), PATTERN_VARIABLE_PROPERTY2);
                }
            }
        }
