 ...
 * <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.resources.moveDeleteHook</code>
...
public interface IMoveDeleteHook {
     ...
     * Cancelation can occur even if no progress monitor is provided.
     */
    boolean moveFolder(IResourceTree tree, IFolder source, IFolder destination, int updateFlags,
     ...
     * Cancelation can occur even if no progress monitor is provided.
     */
    boolean moveProject(IResourceTree tree, IProject source, IProjectDescription description, int updateFlags,
        IProgressMonitor monitor);
}
