...
public final class CapabilityPermission extends BasicPermission {
    ...
    public boolean equals(Object obj) {
        ...
        return (action_mask == cp.action_mask)
            ...
            && ((attributes == cp.attributes) || ((attributes != null) && (attributes.equals(cp.attributes))))
    ...
    static private final class Properties extends AbstractMap<String, Object> {
        ...
        private transient volatile Set<Entry<String, Object>> entries;
        ...
        public Set<Entry<String, Object>> entrySet() {
            ...
            Set<Entry<String, Object>> all = new HashSet<Entry<String, Object>>(attributes.size() + properties.size());
