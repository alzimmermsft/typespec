 ...
 * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.Flags} also provides the same
...
public final class Modifier extends ASTNode implements IExtendedModifier {
	...
	/**
	 * The "keyword" structural property of this node type (type: {@link ModifierKeyword}).
	 * @since 3.0
	 */
	public static final SimplePropertyDescriptor KEYWORD_PROPERTY =
		new SimplePropertyDescriptor(Modifier.class, "keyword", ModifierKeyword.class, MANDATORY); //$NON-NLS-1$
