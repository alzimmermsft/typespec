        ...
        if (codegenBinding.canBeSeenBy(this.actualReceiverType.original(), this, currentScope)) {
            ...
            if (!isStatic && ((this.bits & DepthMASK) != 0)) {
                ...
                ReferenceBinding targetType
                    = currentScope.enclosingSourceType().enclosingTypeAt((this.bits & DepthMASK) >> DepthSHIFT);
            ...
            if (this.arguments != null) {
                ...
                codeStream
                    .newArray(currentScope.createArrayType(currentScope.getType(TypeConstants.JAVA_LANG_OBJECT, 3), 1));
                codeStream.dup();
        ...
        if ((flowInfo.tagBits & FlowInfo.UNREACHABLE_OR_DEAD) == 0) {
            ...
            if (codegenBinding != this.binding) {
                ...
                if (codegenBinding.returnType.isTypeVariable()) {
                    ...
                    if (TypeBinding.notEquals(variableReturnType.firstBound, this.binding.returnType)) { // no need for
                                                                                                         // extra cast
                                                                                                         // if same as
                                                                                                         // first bound
                                                                                                         // anyway
    ...
    public TypeBinding resolveType(BlockScope scope) {
            ...
            if (this.typeArguments != null) {
                ...
                for (int i = 0; i < length; i++) {
                    if ((this.genericTypeArguments[i]
                        = this.typeArguments[i].resolveType(scope, true /* check bounds */)) == null) {
            ...
            if (this.arguments != null) {
                ...
                if (this.argumentsHaveErrors) {
                    if (this.actualReceiverType instanceof ReferenceBinding) {
                        ...
                        this.binding = scope.findMethod((ReferenceBinding) this.actualReceiverType, this.selector,
                            new TypeBinding[] { }, this, false);
                    }
                    return null;
                }
            }
        ...
        if (!this.binding.isValidBinding()) {
            if (this.binding instanceof ProblemMethodBinding
                ...
                MethodBinding privateBinding = this.receiver instanceof CodeSnippetThisReference
                    && ((CodeSnippetThisReference) this.receiver).isImplicit
                        ? localScope.getImplicitMethod((ReferenceBinding) this.delegateThis.type, this.selector,
        ...
        if (!this.binding.isStatic()) {
            ...
            if (this.receiver instanceof NameReference && (((NameReference) this.receiver).bits & Binding.TYPE) != 0) {
