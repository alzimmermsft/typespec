...
public abstract class ElementImpl
    implements com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.lang.model.element.Element,
    IElementInfo {
    ...
    public <A extends Annotation> A getAnnotation(Class<A> annotationClass) {
        ...
        if (annotation != null
            || this.getKind() != ElementKind.CLASS
            || annotationClass.getAnnotation(Inherited.class) == null)
            return annotation;

        ElementImpl superClass
            = (ElementImpl) this._env.getFactory().newElement(((ReferenceBinding) this._binding).superclass());
    ...
    public <A extends Annotation> A[] getAnnotationsByType(Class<A> annotationType) {
        A[] annotations = this._env.getFactory()
            .getAnnotationsByType(Factory.getUnpackedAnnotationBindings(getPackedAnnotationBindings()), annotationType);
