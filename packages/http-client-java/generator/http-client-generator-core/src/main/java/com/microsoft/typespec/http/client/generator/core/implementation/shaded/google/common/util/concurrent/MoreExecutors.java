...
public final class MoreExecutors {
  ...
  public static ThreadFactory platformThreadFactory() {
    ...
    try {
      return (ThreadFactory)
          Class.forName("com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.appengine.api.ThreadManager")
  ...
  private static boolean isAppEngineWithApiClasses() {
    if (System.getProperty("com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.appengine.runtime.environment") == null) {
      return false;
    }
    try {
      Class.forName("com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.appengine.api.utils.SystemProperty");
    } catch (ClassNotFoundException e) {
      return false;
    }
    try {
      // If the current environment is null, we're not inside AppEngine.
      return Class.forName("com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.apphosting.api.ApiProxy")
