...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Queues;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ForwardingListenableFuture.SimpleForwardingListenableFuture;
...
public final class MoreExecutors {
    ...
    private static final class ScheduledListeningDecorator extends ListeningDecorator
        ...
        public ListenableScheduledFuture<?> schedule(Runnable command, long delay, TimeUnit unit) {
            TrustedListenableFutureTask<@Nullable Void> task = TrustedListenableFutureTask.create(command, null);
            ScheduledFuture<?> scheduled = delegate.schedule(task, delay, unit);
            return new ListenableScheduledTask<@Nullable Void>(task, scheduled);
        }

        @Override
        public <V extends @Nullable Object> ListenableScheduledFuture<V> schedule(Callable<V> callable, long delay,
            TimeUnit unit) {
    ...
    @GwtIncompatible
    @ParametricNullness
    static <T extends @Nullable Object> T invokeAnyImpl(ListeningExecutorService executorService,
        Collection<? extends Callable<T>> tasks, boolean timed, Duration timeout)
    ...
    private static <T extends @Nullable Object> ListenableFuture<T> submitAndAddQueueListener(
        ListeningExecutorService executorService, Callable<T> task, final BlockingQueue<Future<T>> queue) {
    ...
    public static ThreadFactory platformThreadFactory() {
        ...
        try {
            return (ThreadFactory) Class.forName(
                "com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.appengine.api.ThreadManager")
    ...
    private static boolean isAppEngineWithApiClasses() {
        if (System.getProperty(
            "com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.appengine.runtime.environment")
            == null) {
            return false;
        }
        try {
            Class.forName(
                "com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.appengine.api.utils.SystemProperty");
        } catch (ClassNotFoundException e) {
            return false;
        }
        try {
            ...
            return Class.forName(
                "com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.apphosting.api.ApiProxy")
