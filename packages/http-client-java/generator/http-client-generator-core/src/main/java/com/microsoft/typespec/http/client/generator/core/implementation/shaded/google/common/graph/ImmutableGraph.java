...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Functions;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.graph.GraphConstants.Presence;
...
public class ImmutableGraph<N> extends ForwardingGraph<N> {
    ...
    public static <N> ImmutableGraph<N> copyOf(Graph<N> graph) {
        return (graph instanceof ImmutableGraph)
            ...
            : new ImmutableGraph<N>(new StandardValueGraph<N, Presence>(GraphBuilder.from(graph),
    ...
    private static <N> GraphConnections<N, Presence> connectionsOf(Graph<N> graph, N node) {
        Function<N, Presence> edgeValueFn = (Function<N, Presence>) Functions.constant(Presence.EDGE_EXISTS);
     ...
     * {
     *     &#64;code
     *     static final ImmutableGraph<Country> COUNTRY_ADJACENCY_GRAPH = GraphBuilder.undirected()
     *         .<Country>immutable()
