...
public class RuleBasedPartitioner
    implements IDocumentPartitioner, IDocumentPartitionerExtension, IDocumentPartitionerExtension2 {
    ...
    public ITypedRegion[] computePartitioning(int offset, int length, boolean includeZeroLengthPartitions) {
        ...
        try {
            ...
            if (previous != null) {
                ...
                if ((includeZeroLengthPartitions || gap.getLength() > 0)
                    && ((includeZeroLengthPartitions && offset + length == gapOffset && gap.length == 0)
