...
public final class RegistryContributor implements IContributor {
    ...
    /**
     * Actual name of the contributor (e.g.,
     * "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.fragment").
     */
     ...
     * "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime"). If contributor
     ...
     * "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.fragment"). The
     * actual name of the contributor must
