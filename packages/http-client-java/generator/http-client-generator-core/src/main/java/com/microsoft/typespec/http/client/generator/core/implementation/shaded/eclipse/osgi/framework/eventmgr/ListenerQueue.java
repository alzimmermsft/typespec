...
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi.framework.eventmgr;

import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi.framework.eventmgr.EventManager.EventThread;
...
public class ListenerQueue<K, V, E> {
    ...
    public void dispatchEventAsynchronous(int eventAction, E eventObject) {
        ...
        synchronized (eventThread) { /*
                                      * synchronize on the EventThread to ensure no interleaving of posting to the event
                                      * thread
                                      */
            for (Map.Entry<Set<Map.Entry<K, V>>, EventDispatcher<K, V, E>> entry : queue
                .entrySet()) { /* iterate over the list of listener lists */
