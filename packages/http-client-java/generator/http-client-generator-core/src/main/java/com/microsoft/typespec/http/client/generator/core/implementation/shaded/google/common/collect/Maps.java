...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Predicates.compose;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.CollectPreconditions.checkEntryNotNull;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.CollectPreconditions.checkNonnegative;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.NullnessCasts.uncheckedCastNullableTToT;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Converter;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Equivalence;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Predicates;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.MapDifference.ValueDifference;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.j2objc.annotations.Weak;
...
public final class Maps {
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> Iterator<K>
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> Iterator<V>
        valueIterator(Iterator<Entry<K, V>> entryIterator) {
     ...
     */
    @J2ktIncompatible
    public static <T extends @Nullable Object, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>>
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> HashMap<K, V>
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> LinkedHashMap<K, V>
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> TreeMap<K, V>
     ...
     * @return a new, empty {@code TreeMap}
     */
    public static <C extends @Nullable Object, K extends C, V extends @Nullable Object> TreeMap<K, V>
        newTreeMap(@CheckForNull Comparator<C> comparator) {
     ...
     */
    public static <K extends Enum<K>, V extends @Nullable Object> EnumMap<K, V> newEnumMap(Class<K> type) {
     ...
     * no mappings
     */
    public static <K extends Enum<K>, V extends @Nullable Object> EnumMap<K, V> newEnumMap(Map<K, ? extends V> map) {
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> MapDifference<K, V>
     ...
     * @since 10.0
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> MapDifference<K, V> difference(
     ...
     * @since 11.0
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> SortedMapDifference<K, V>
    ...
    private static <K extends @Nullable Object, V extends @Nullable Object> void doDifference(
        Map<? extends K, ? extends V> left, Map<? extends K, ? extends V> right,
        Equivalence<? super @NonNull V> valueEquivalence, Map<K, V> onlyOnLeft, Map<K, V> onlyOnRight, Map<K, V> onBoth,
    ...
    private static <K extends @Nullable Object, V extends @Nullable Object> Map<K, V>
    ...
    static class ValueDifferenceImpl<V extends @Nullable Object> implements ValueDifference<V> {
        @ParametricNullness
        private final V left;
        @ParametricNullness
        private final V right;

        static <V extends @Nullable Object> ValueDifference<V> create(@ParametricNullness V left,
            @ParametricNullness V right) {
     ...
     */
    @SuppressWarnings("unchecked")
    static <E extends @Nullable Object> Comparator<? super E>
        orNaturalOrder(@CheckForNull Comparator<? super E> comparator) {
     ...
     * @since 14.0
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> Map<K, V> asMap(Set<K> set,
     ...
     * @since 14.0
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> SortedMap<K, V> asMap(SortedSet<K> set,
        Function<? super K, V> function) {
    ...
    public static <K extends @Nullable Object, V extends @Nullable Object> NavigableMap<K, V> asMap(NavigableSet<K> set,
        Function<? super K, V> function) {
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> Iterator<Entry<K, V>> asMapEntryIterator(Set<K> set,
        final Function<? super K, V> function) {
    ...
    private static class SortedAsMapView<K extends @Nullable Object, V extends @Nullable Object> extends AsMapView<K, V>
    ...
    private static <E extends @Nullable Object> SortedSet<E> removeOnlySortedSet(final SortedSet<E> set) {
    ...
    private static <E extends @Nullable Object> NavigableSet<E> removeOnlyNavigableSet(final NavigableSet<E> set) {
     ...
     * <pre>
     * {@code
     * import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.ImmutableMap.toImmutableMap;
     * ...
     * ImmutableMap<String, Color> colorForName =
    ...
    private static <K, V> ImmutableMap<K, V> uniqueIndex(Iterator<V> values, Function<? super V, K> keyFunction,
     ...
     */
    @GwtCompatible(serializable = true)
    public static <K extends @Nullable Object, V extends @Nullable Object> Entry<K, V>
     ...
     */
    static <K extends @Nullable Object, V extends @Nullable Object> Set<Entry<K, V>>
     ...
     */
    static <K extends @Nullable Object, V extends @Nullable Object> Entry<K, V>
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> UnmodifiableIterator<Entry<K, V>>
        unmodifiableEntryIterator(final Iterator<Entry<K, V>> entryIterator) {
     ...
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Functions#forMap(Map)}
     * or {@link
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Functions#forMap(Map, Object)}.
     *
     * @since 16.0
     */
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> BiMap<K, V>
     ...
     */
    public static <K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object> Map<K, V2>
     ...
     */
    public static <K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object> Map<K, V2>
        transformEntries(Map<K, V1> fromMap, EntryTransformer<? super K, ? super V1, V2> transformer) {
    ...
    public static <K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object>
        SortedMap<K, V2>
        transformEntries(SortedMap<K, V1> fromMap, EntryTransformer<? super K, ? super V1, V2> transformer) {
    ...
    public static <K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object>
        NavigableMap<K, V2>
        transformEntries(NavigableMap<K, V1> fromMap, EntryTransformer<? super K, ? super V1, V2> transformer) {
     ...
     */
    @FunctionalInterface
    public interface EntryTransformer<K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object> {
        /**
    ...
    static <K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object> Function<V1, V2>
        asValueToValueFunction(final EntryTransformer<? super K, V1, V2> transformer, @ParametricNullness final K key) {
    ...
    static <K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object>
        Function<Entry<K, V1>, V2>
        asEntryToValueFunction(final EntryTransformer<? super K, ? super V1, V2> transformer) {
        checkNotNull(transformer);
    ...
    static <V2 extends @Nullable Object, K extends @Nullable Object, V1 extends @Nullable Object> Entry<K, V2>
        transformEntry(final EntryTransformer<? super K, ? super V1, V2> transformer, final Entry<K, V1> entry) {
        checkNotNull(transformer);
        checkNotNull(entry);
    ...
    static <K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object>
        Function<Entry<K, V1>, Entry<K, V2>>
        asEntryToEntryFunction(final EntryTransformer<? super K, ? super V1, V2> transformer) {
        checkNotNull(transformer);
    ...
    static <K extends @Nullable Object> Predicate<Entry<K, ?>>
        keyPredicateOnEntries(Predicate<? super K> keyPredicate) {
        return compose(keyPredicate, Maps.<K>keyFunction());
    }

    static <V extends @Nullable Object> Predicate<Entry<?, V>>
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> Map<K, V> filterKeys(Map<K, V> unfiltered,
     ...
     * @since 11.0
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> SortedMap<K, V>
        filterKeys(SortedMap<K, V> unfiltered, final Predicate<? super K> keyPredicate) {
     ...
     */
    @GwtIncompatible // NavigableMap
    public static <K extends @Nullable Object, V extends @Nullable Object> NavigableMap<K, V>
        filterKeys(NavigableMap<K, V> unfiltered, final Predicate<? super K> keyPredicate) {
        // TODO(lowasser): Return a subclass of Maps.FilteredKeyMap for slightly better
        // performance.
        return filterEntries(unfiltered, Maps.<K>keyPredicateOnEntries(keyPredicate));
    }
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> BiMap<K, V>
        filterKeys(BiMap<K, V> unfiltered, final Predicate<? super K> keyPredicate) {
        checkNotNull(keyPredicate);
        return filterEntries(unfiltered, Maps.<K>keyPredicateOnEntries(keyPredicate));
    }
     ...
     * Predicates.instanceOf(ArrayList.class)}, which is inconsistent with equals.
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> Map<K, V> filterValues(Map<K, V> unfiltered,
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> SortedMap<K, V>
        filterValues(SortedMap<K, V> unfiltered, final Predicate<? super V> valuePredicate) {
        return filterEntries(unfiltered, Maps.<V>valuePredicateOnEntries(valuePredicate));
    }
    ...
    @GwtIncompatible // NavigableMap
    public static <K extends @Nullable Object, V extends @Nullable Object> NavigableMap<K, V>
        filterValues(NavigableMap<K, V> unfiltered, final Predicate<? super V> valuePredicate) {
        return filterEntries(unfiltered, Maps.<V>valuePredicateOnEntries(valuePredicate));
    }
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> BiMap<K, V>
        filterValues(BiMap<K, V> unfiltered, final Predicate<? super V> valuePredicate) {
        return filterEntries(unfiltered, Maps.<V>valuePredicateOnEntries(valuePredicate));
    }
     ...
     * at {@link Predicate#apply}.
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> Map<K, V> filterEntries(Map<K, V> unfiltered,
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> SortedMap<K, V>
        filterEntries(SortedMap<K, V> unfiltered, Predicate<? super Entry<K, V>> entryPredicate) {
        checkNotNull(entryPredicate);
    ...
    @GwtIncompatible // NavigableMap
    public static <K extends @Nullable Object, V extends @Nullable Object> NavigableMap<K, V>
        filterEntries(NavigableMap<K, V> unfiltered, Predicate<? super Entry<K, V>> entryPredicate) {
        checkNotNull(entryPredicate);
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> BiMap<K, V>
        filterEntries(BiMap<K, V> unfiltered, Predicate<? super Entry<K, V>> entryPredicate) {
     ...
     */
    private static <K extends @Nullable Object, V extends @Nullable Object> Map<K, V>
        filterFiltered(AbstractFilteredMap<K, V> map, Predicate<? super Entry<K, V>> entryPredicate) {
     ...
     * sorted map.
     */
    private static <K extends @Nullable Object, V extends @Nullable Object> SortedMap<K, V>
        filterFiltered(FilteredEntrySortedMap<K, V> map, Predicate<? super Entry<K, V>> entryPredicate) {
     ...
     */
    @GwtIncompatible // NavigableMap
    private static <K extends @Nullable Object, V extends @Nullable Object> NavigableMap<K, V>
        filterFiltered(FilteredEntryNavigableMap<K, V> map, Predicate<? super Entry<K, V>> entryPredicate) {
     ...
     * map.
     */
    private static <K extends @Nullable Object, V extends @Nullable Object> BiMap<K, V>
        filterFiltered(FilteredEntryBiMap<K, V> map, Predicate<? super Entry<K, V>> entryPredicate) {
        Predicate<Entry<K, V>> predicate = Predicates.<Entry<K, V>>and(map.predicate, entryPredicate);
        return new FilteredEntryBiMap<>(map.unfiltered(), predicate);
    }

    private abstract static class AbstractFilteredMap<K extends @Nullable Object, V extends @Nullable Object>
        extends ViewCachingAbstractMap<K, V> {
    ...
    static class FilteredEntryMap<K extends @Nullable Object, V extends @Nullable Object>
        ...
        static <K extends @Nullable Object, V extends @Nullable Object> boolean removeAllKeys(Map<K, V> map,
        ...
        static <K extends @Nullable Object, V extends @Nullable Object> boolean retainAllKeys(Map<K, V> map,
            Predicate<? super Entry<K, V>> entryPredicate, Collection<?> keyCollection) {
            Iterator<Entry<K, V>> entryItr = map.entrySet().iterator();
            boolean result = false;
            while (entryItr.hasNext()) {
    ...
    static final class FilteredEntryBiMap<K extends @Nullable Object, V extends @Nullable Object>
        ...
        private static <K extends @Nullable Object, V extends @Nullable Object> Predicate<Entry<V, K>>
            inversePredicate(final Predicate<? super Entry<K, V>> forwardPredicate) {
        ...
        @Override
        public void replaceAll(BiFunction<? super K, ? super V, ? extends V> function) {
            unfiltered().replaceAll(
                (key, value) -> predicate.apply(Maps.immutableEntry(key, value)) ? function.apply(key, value) : value);
        }
    ...
    @CheckForNull
    private static <K extends @Nullable Object, V extends @Nullable Object> Entry<K, V>
        unmodifiableOrNull(@CheckForNull Entry<K, ? extends V> entry) {
     ...
     */
    @GwtCompatible
    abstract static class ViewCachingAbstractMap<K extends @Nullable Object, V extends @Nullable Object>
    ...
    abstract static class IteratorBasedAbstractMap<K extends @Nullable Object, V extends @Nullable Object>
        extends AbstractMap<K, V> {
        @Override
     ...
     */
    static <K extends @Nullable Object, V extends @Nullable Object> boolean containsEntryImpl(Collection<Entry<K, V>> c,
     ...
     */
    static <K extends @Nullable Object, V extends @Nullable Object> boolean removeEntryImpl(Collection<Entry<K, V>> c,
        @CheckForNull Object o) {
        if (!(o instanceof Entry)) {
            return false;
        }
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> void putAllImpl(Map<K, V> self,
    ...
    static class KeySet<K extends @Nullable Object, V extends @Nullable Object> extends Sets.ImprovedAbstractSet<K> {
        @Weak
        final Map<K, V> map;
    ...
    static class SortedKeySet<K extends @Nullable Object, V extends @Nullable Object> extends KeySet<K, V>
    ...
    @GwtIncompatible // NavigableMap
    static class NavigableKeySet<K extends @Nullable Object, V extends @Nullable Object> extends SortedKeySet<K, V>
    ...
    static class Values<K extends @Nullable Object, V extends @Nullable Object> extends AbstractCollection<V> {
        @Weak
        final Map<K, V> map;
     ...
     */
    @GwtIncompatible // NavigableMap
    public static <K extends Comparable<? super K>, V extends @Nullable Object> NavigableMap<K, V>
