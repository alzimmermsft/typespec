...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.DiscreteDomain;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.ImmutableRangeMap;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.googlejavaformat.java.JavacTokens.RawTok;
...
public final class JavaInput extends Input {
    ...
    private static final Constructor<DeferredDiagnosticHandler> DEFERRED_DIAGNOSTIC_HANDLER_CONSTRUCTOR
     ...
     */
    Range<Integer> characterRangeToTokenRange(Range<Integer> characterRange) throws FormatterException {
        if (characterRange.upperEndpoint() > text.length()) {
            throw new FormatterException(
                String.format("error: invalid offset (%d) or length (%d); offset + length (%d) > file length (%d)",
                    characterRange.lowerEndpoint(), characterRange.upperEndpoint() - characterRange.lowerEndpoint(),
                    characterRange.upperEndpoint(), text.length()));
        }
        // empty range stands for "format the line under the cursor"
        Range<Integer> nonEmptyRange = characterRange.isEmpty()
