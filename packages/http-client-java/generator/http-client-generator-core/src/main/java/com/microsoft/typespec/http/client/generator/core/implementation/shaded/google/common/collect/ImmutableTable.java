...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
     ...
     * @since 21.0
     */
    public static <T extends @Nullable Object, R, C, V> Collector<T, ?, ImmutableTable<R, C, V>> toImmutableTable(
    ...
    static <R, C, V> ImmutableTable<R, C, V>
        copyOf(Iterable<? extends Cell<? extends R, ? extends C, ? extends V>> cells) {
    ...
    static <R, C, V> Cell<R, C, V> cellOf(R rowKey, C columnKey, V value) {
        return Tables.immutableCell(checkNotNull(rowKey, "rowKey"), checkNotNull(columnKey, "columnKey"),
     ...
     *         = new ImmutableTable.Builder<Integer, Character, String>().put(1, 'A', "foo")
     *             .put(1, 'B', "bar")
     *             .put(2, 'A', "baz")
     *             .buildOrThrow();
     * }
