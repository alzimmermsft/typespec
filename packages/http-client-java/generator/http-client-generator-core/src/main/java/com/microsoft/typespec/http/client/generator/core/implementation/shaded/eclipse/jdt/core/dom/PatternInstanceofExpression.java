...
public class PatternInstanceofExpression extends Expression {
    ...
    public static final ChildPropertyDescriptor LEFT_OPERAND_PROPERTY = new ChildPropertyDescriptor(
        PatternInstanceofExpression.class, "leftOperand", Expression.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
    ...
    public static final ChildPropertyDescriptor RIGHT_OPERAND_PROPERTY = new ChildPropertyDescriptor(
        PatternInstanceofExpression.class, "rightOperand", SingleVariableDeclaration.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
    /**
     * The "pattern" structural property of this node type (child type: {@link Pattern}).
     * 
     * @since 3.34
     */
    public static final ChildPropertyDescriptor PATTERN_PROPERTY = new ChildPropertyDescriptor(
        PatternInstanceofExpression.class, "pattern", Pattern.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
