...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.resources.IMarkerSetElement;
            ...
            switch (kind) {
                ...
                case ADDED:
                    ...
                    if (oldPath != null && !oldPath.equals(path)) {
                        ...
                        status = (status & KIND_MASK)
                            | (deltaInfo.getComparator().compare(actualOldInfo, newInfo) & ~KIND_MASK);
                        status |= MOVED_FROM;
