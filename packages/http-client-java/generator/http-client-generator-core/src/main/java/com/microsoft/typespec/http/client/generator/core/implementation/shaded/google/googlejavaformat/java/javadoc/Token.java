...
final class Token {
    ...
    enum Type {
        ...
        <pre>
         * } or {@code <table>} section. Whitespace includes
        ...
        <pre>
         * } or {@code <table>} section. We preserve user formatting in these
         ...
         *
         * <p>This also includes whitespace in a {@code 
         * 
         * 
        
        <pre>
         * } or {@code <table>} section. We preserve
