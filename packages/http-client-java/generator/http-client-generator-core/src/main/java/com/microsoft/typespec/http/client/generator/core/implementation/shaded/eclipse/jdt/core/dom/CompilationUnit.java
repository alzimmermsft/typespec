...
public class CompilationUnit extends ASTNode {
     ...
     * @since 3.14
     */
    public static final ChildPropertyDescriptor MODULE_PROPERTY = new ChildPropertyDescriptor(CompilationUnit.class,
        "module", ModuleDeclaration.class, OPTIONAL, NO_CYCLE_RISK); //$NON-NLS-1$
    ...
    /**
     * The Java type root (an
     * <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.ICompilationUnit</code>
     * or an
     * <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.IClassFile</code>)
     ...
     */
    private final NodeList imports = new NodeList(IMPORTS_PROPERTY);
     ...
     */
    private final NodeList types = new NodeList(TYPES_PROPERTY);
     ...
     * <p>
     * Each call to
     * {@link ASTParser#createAST(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor)}
     ...
     * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.ICompilationUnit
     * compilation unit} or a
     * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.IClassFile class
     * file})
     * this compilation unit was created from, or <code>null</code> if it was not created from a Java type root.
     *
     ...
     * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.JavaCore#getOptions()
     * JavaCore.getOptions()}.
