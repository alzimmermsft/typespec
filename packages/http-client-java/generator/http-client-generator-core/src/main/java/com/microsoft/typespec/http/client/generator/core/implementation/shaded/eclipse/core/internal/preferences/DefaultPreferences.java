...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.preferences.exchange.IProductPreferencesService;
...
public class DefaultPreferences extends EclipsePreferences {
    ...
    private void applyBundleDefaults() {
        ...
        URL transURL
            = FileLocator.find(bundle, NL_DIR.append(IPreferencesConstants.PREFERENCES_DEFAULT_OVERRIDE_BASE_NAME)
                .addFileExtension(PROPERTIES_FILE_EXTENSION), null);
    ...
    private static void initializeCustomizations() {
        ...
        if (productCustomization == null) {
            ...
            if (context != null) {
                ServiceTracker<?, IProductPreferencesService> productTracker
                    = new ServiceTracker<>(context, IProductPreferencesService.class, null);
                productTracker.open();
