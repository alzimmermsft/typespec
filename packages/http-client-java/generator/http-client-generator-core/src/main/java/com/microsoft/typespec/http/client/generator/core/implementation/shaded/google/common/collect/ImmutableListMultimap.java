...
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V> implements ListMultimap<K, V> {
     ...
     * @since 21.0
     */
    public static <T extends @Nullable Object, K, V> Collector<T, ?, ImmutableListMultimap<K, V>>
        toImmutableListMultimap(Function<? super T, ? extends K> keyFunction,
     ...
     *         = new ImmutableListMultimap.Builder<String, Integer>().put("one", 1)
    ...
    static <K, V> ImmutableListMultimap<K, V> fromMapEntries(
        ...
        for (Entry<? extends K, ? extends Collection<? extends V>> entry : mapEntries) {
            ...
            ImmutableList<V> list = (valueComparator == null)
