...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.FloatUtil;
...
public class DoubleLiteral extends NumberLiteral {
    ...
    public void computeConstant() {
        ...
        if (doubleValue < Double.MIN_VALUE) {
            ...
            label: for (int i = 0; i < this.source.length; i++) { // it is welled formated so just test against '0' and
                                                                  // potential . D d
