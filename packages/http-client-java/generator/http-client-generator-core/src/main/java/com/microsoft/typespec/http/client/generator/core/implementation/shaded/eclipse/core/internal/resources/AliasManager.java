 ...
 */
public class AliasManager implements ILifecycleListener, IResourceChangeListener {
     ...
     */
    public void updateAliases(IResource resource, IFileStore location, int depth, IProgressMonitor monitor)
