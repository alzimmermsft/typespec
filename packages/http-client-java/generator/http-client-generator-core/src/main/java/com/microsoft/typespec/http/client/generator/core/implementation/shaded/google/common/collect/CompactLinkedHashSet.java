...
class CompactLinkedHashSet<E extends @Nullable Object> extends CompactHashSet<E> {
     ...
     */
    public static <E extends @Nullable Object> CompactLinkedHashSet<E> create(Collection<? extends E> collection) {
     ...
     */
    public static <E extends @Nullable Object> CompactLinkedHashSet<E> createWithExpectedSize(int expectedSize) {
