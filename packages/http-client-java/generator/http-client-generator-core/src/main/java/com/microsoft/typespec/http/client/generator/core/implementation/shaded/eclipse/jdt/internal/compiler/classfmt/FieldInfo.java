...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.impl.*;
...
public class FieldInfo extends ClassFileStruct implements IBinaryField, Comparable {
                    ...
                    case 'S':
                        if (CharOperation.equals(AttributeNamesConstants.SignatureName, attributeName))
                            fieldInfo.signatureUtf8Offset
                                = fieldInfo.constantPoolOffsets[fieldInfo.u2At(readOffset + 6)]
                    ...
                    case 'R':
                        ...
                        if (decodedAnnotations != null) {
                            ...
                            if (typeAnnotations == null) {
                                ...
                                TypeAnnotationInfo[] combined
                                    = new TypeAnnotationInfo[length + decodedTypeAnnotations.length];
                                System.arraycopy(typeAnnotations, 0, combined, 0, length);
                                System.arraycopy(decodedTypeAnnotations, 0, combined, length,
                                    decodedTypeAnnotations.length);
            ...
            if (CharOperation.equals(attributeName, AttributeNamesConstants.ConstantValueName)) {
                ...
                switch (u1At(relativeOffset)) {
                    ...
                    case ClassFileConstants.StringTag:
                        ...
                        this.constant
                            = StringConstant.fromValue(String.valueOf(utf8At(utf8Offset + 3, u2At(utf8Offset + 1))));
                        break;
                }
            }
    ...
    protected void toStringContent(StringBuilder buffer) {
        ...
        buffer.append('{')
            .append(((modifiers & ClassFileConstants.AccDeprecated) != 0 ? "deprecated " : Util.EMPTY_STRING) //$NON-NLS-1$
