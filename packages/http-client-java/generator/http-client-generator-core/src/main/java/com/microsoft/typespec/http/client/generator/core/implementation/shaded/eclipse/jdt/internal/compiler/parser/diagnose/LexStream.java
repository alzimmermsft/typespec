...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.parser.TerminalToken.TokenNameCOLON_COLON;
...
public class LexStream {
    ...
    public LexStream(int size, Scanner scanner, int[] intervalStartToSkip, int[] intervalEndToSkip,
        int[] intervalFlagsToSkip, TerminalToken firstToken, int init, int eof) {
            ...
            try {
                ...
                if (tokenKind != TokenNameEOF) {
                    ...
                    if (this.intervalStartToSkip.length == 0
                        ...
                        this.scanner.resetTo(this.intervalEndToSkip[++this.currentInterval] + 1,
