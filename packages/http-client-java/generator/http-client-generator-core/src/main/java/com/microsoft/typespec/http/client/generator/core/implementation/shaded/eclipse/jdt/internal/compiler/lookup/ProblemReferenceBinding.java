...
// NOTE: must only answer the subset of the name related to the problem
    ...
    public char[] sourceName() {
        return this.compoundName.length == 0 ? null : this.compoundName[this.compoundName.length - 1]; // last segment
                                                                                                       // of
                                                                                                       // [java][util][Map$Entry]
    }
    ...
    public String toString() {
        ...
        buffer.append(
            this.compoundName == null ? "<null>" : new String(CharOperation.concatWith(this.compoundName, '.'))); //$NON-NLS-1$
