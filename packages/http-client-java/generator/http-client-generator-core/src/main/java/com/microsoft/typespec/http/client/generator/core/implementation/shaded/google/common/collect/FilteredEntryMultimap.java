...
class FilteredEntryMultimap<K extends @Nullable Object, V extends @Nullable Object> extends AbstractMultimap<K, V>
    ...
    static <E extends @Nullable Object> Collection<E> filterCollection(Collection<E> collection,
    ...
    class Keys extends Multimaps.Keys<K, V> {
        ...
        public Set<Entry<K>> entrySet() {
            return new Multisets.EntrySet<K>() {
                ...
                private boolean removeEntriesIf(Predicate<? super Entry<K>> predicate) {
