...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.ForwardingMap;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.ForwardingMapEntry;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.ForwardingSet;
...
public final class MutableTypeToInstanceMap<B extends @Nullable Object>
    ...
    private static final class UnmodifiableEntry<K, V extends @Nullable Object> extends ForwardingMapEntry<K, V> {

        private final Entry<K, V> delegate;

        static <K, V extends @Nullable Object> Set<Entry<K, V>> transformEntries(Set<Entry<K, V>> entries) {
        ...
        private static <K, V extends @Nullable Object> Iterator<Entry<K, V>>
