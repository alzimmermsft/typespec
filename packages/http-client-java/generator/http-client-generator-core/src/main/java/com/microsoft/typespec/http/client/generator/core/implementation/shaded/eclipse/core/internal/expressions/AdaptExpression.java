...
public class AdaptExpression extends CompositeExpression {
	...
	private static final String PREFERENCE_NAMESPACE = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.expressions"; //$NON-NLS-1$
