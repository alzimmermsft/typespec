...
public class SourceTypeBinding extends ReferenceBinding {
    ...
    private Map<Binding, AnnotationHolder> storedAnnotations = null; // keys are this ReferenceBinding & its fields and
                                                                     // methods, value is an AnnotationHolder
    ...
    public boolean supertypeAnnotationsUpdated = false; // have any supertype annotations been updated during
                                                        // CompleteTypeBindingsSteps.INTEGRATE_ANNOTATIONS_IN_HIERARCHY?
    ...
    public FieldBinding addSyntheticFieldForInnerclass(LocalVariableBinding actualOuterLocalVariable) {
        ...
        FieldBinding synthField
            = (FieldBinding) this.synthetics[SourceTypeBinding.FIELD_EMUL].get(actualOuterLocalVariable);
        if (synthField == null) {
            synthField = new SyntheticFieldBinding(
                CharOperation.concat(TypeConstants.SYNTHETIC_OUTER_LOCAL_PREFIX, actualOuterLocalVariable.name),
                actualOuterLocalVariable.type,
                ClassFileConstants.AccPrivate | ClassFileConstants.AccFinal | ClassFileConstants.AccSynthetic, this,
    ...
    public FieldBinding addSyntheticFieldForInnerclass(ReferenceBinding enclosingType) {
        ...
        if (synthField == null) {
            synthField = new SyntheticFieldBinding(
                ...
                enclosingType,
                ClassFileConstants.AccDefault | ClassFileConstants.AccFinal | ClassFileConstants.AccSynthetic, this,
                Constant.NotAConstant);
    ...
    public FieldBinding addSyntheticFieldForAssert(BlockScope blockScope) {
        ...
        FieldBinding synthField
            = (FieldBinding) this.synthetics[SourceTypeBinding.FIELD_EMUL].get("assertionEmulation"); //$NON-NLS-1$
        if (synthField == null) {
            synthField = new SyntheticFieldBinding(TypeConstants.SYNTHETIC_ASSERT_DISABLED, TypeBinding.BOOLEAN,
                (isInterface() ? ClassFileConstants.AccPublic : ClassFileConstants.AccDefault)
                    | ClassFileConstants.AccStatic | ClassFileConstants.AccSynthetic | ClassFileConstants.AccFinal,
    ...
    public FieldBinding addSyntheticFieldForEnumValues() {
        ...
        FieldBinding synthField
            = (FieldBinding) this.synthetics[SourceTypeBinding.FIELD_EMUL].get("enumConstantValues"); //$NON-NLS-1$
        if (synthField == null) {
            synthField = new SyntheticFieldBinding(
                TypeConstants.SYNTHETIC_ENUM_VALUES, this.scope.createArrayType(this, 1), ClassFileConstants.AccPrivate
                    | ClassFileConstants.AccStatic | ClassFileConstants.AccSynthetic | ClassFileConstants.AccFinal,
                this, Constant.NotAConstant);
    ...
    public SyntheticMethodBinding addSyntheticMethod(FieldBinding targetField, boolean isReadAccess,
        ...
        SyntheticMethodBinding[] accessors
            = (SyntheticMethodBinding[]) this.synthetics[SourceTypeBinding.METHOD_EMUL].get(targetField);
        if (accessors == null) {
    ...
    public SyntheticMethodBinding addSyntheticEnumMethod(char[] selector) {
        ...
        SyntheticMethodBinding accessMethod = null;
        SyntheticMethodBinding[] accessors
            = (SyntheticMethodBinding[]) this.synthetics[SourceTypeBinding.METHOD_EMUL].get(selector);
        if (accessors == null) {
    ...
    public SyntheticFieldBinding addSyntheticFieldForSwitchEnum(char[] fieldName, String key) {
        ...
        SyntheticFieldBinding synthField
            = (SyntheticFieldBinding) this.synthetics[SourceTypeBinding.FIELD_EMUL].get(key);
        if (synthField == null) {
            synthField = new SyntheticFieldBinding(fieldName, this.scope.createArrayType(TypeBinding.INT, 1),
                (isInterface()
                    ? (ClassFileConstants.AccPublic | ClassFileConstants.AccFinal)
                    : ClassFileConstants.AccPrivate | ClassFileConstants.AccVolatile) | ClassFileConstants.AccStatic
        ...
        do {
            ...
            if ((existingField = getField(synthField.name, true /* resolve */)) != null) {
                ...
                for (int i = 0; i < max; i++) {
                    ...
                    if (fieldDecl.binding == existingField) {
                        synthField.name
                            = CharOperation.concat(fieldName, ("_" + String.valueOf(index++)).toCharArray()); //$NON-NLS-1$
                        needRecheck = true;
                        break;
                    }
                }
    ...
    public SyntheticMethodBinding addSyntheticMethodForSwitchEnum(TypeBinding enumBinding,
        ...
        SyntheticMethodBinding accessMethod = null;
        char[] selector
            = CharOperation.concat(TypeConstants.SYNTHETIC_SWITCH_ENUM_TABLE, enumBinding.constantPoolName());
        CharOperation.replace(selector, '/', '$');
        final String key = new String(selector);
        SyntheticMethodBinding[] accessors
            = (SyntheticMethodBinding[]) this.synthetics[SourceTypeBinding.METHOD_EMUL].get(key);
    ...
    public SyntheticMethodBinding addSyntheticMethod(LambdaExpression lambda) {
        ...
        SyntheticMethodBinding[] lambdaMethods
            = (SyntheticMethodBinding[]) this.synthetics[SourceTypeBinding.METHOD_EMUL].get(lambda);
        if (lambdaMethods == null) {
            lambdaMethod = new SyntheticMethodBinding(lambda,
                CharOperation.concat(TypeConstants.ANONYMOUS_METHOD, Integer.toString(lambda.ordinal).toCharArray()),
                this);
    ...
    public SyntheticMethodBinding addSyntheticMethod(ReferenceExpression ref) {
        ...
        SyntheticMethodBinding lambdaMethod = null;
        SyntheticMethodBinding[] lambdaMethods
            = (SyntheticMethodBinding[]) this.synthetics[SourceTypeBinding.METHOD_EMUL].get(ref);
        if (lambdaMethods == null) {
    ...
    private void addDeserializeLambdaMethod() {
        SyntheticMethodBinding[] deserializeLambdaMethods
            = (SyntheticMethodBinding[]) this.synthetics[SourceTypeBinding.METHOD_EMUL]
                .get(TypeConstants.DESERIALIZE_LAMBDA);
        if (deserializeLambdaMethods == null) {
            SyntheticMethodBinding deserializeLambdaMethod = new SyntheticMethodBinding(this);
            this.synthetics[SourceTypeBinding.METHOD_EMUL].put(TypeConstants.DESERIALIZE_LAMBDA,
    ...
    public SyntheticMethodBinding addSyntheticMethod(MethodBinding targetMethod, boolean isSuperAccess) {
        ...
        SyntheticMethodBinding accessMethod = null;
        SyntheticMethodBinding[] accessors
            = (SyntheticMethodBinding[]) this.synthetics[SourceTypeBinding.METHOD_EMUL].get(targetMethod);
        if (accessors == null) {
    ...
    public SyntheticMethodBinding addSyntheticArrayMethod(ArrayBinding arrayType, int purpose, char[] selector) {
        ...
        SyntheticMethodBinding[] arrayMethods
            = (SyntheticMethodBinding[]) this.synthetics[SourceTypeBinding.METHOD_EMUL].get(arrayType);
    ...
    public SyntheticMethodBinding addSyntheticFactoryMethod(MethodBinding privateConstructor,
        MethodBinding publicConstructor, TypeBinding[] enclosingInstances, char[] selector) {
        if (!isPrototype())
            throw new IllegalStateException();
        if (this.synthetics == null)
            this.synthetics = new LinkedHashMap[MAX_SYNTHETICS];
        ...
        SyntheticMethodBinding factory
            = new SyntheticMethodBinding(privateConstructor, publicConstructor, selector, enclosingInstances, this);
    ...
    public SyntheticMethodBinding addSyntheticBridgeMethod(MethodBinding inheritedMethodToBridge,
            ...
            while (synthMethods.hasNext()) {
                ...
                if (synthetic instanceof MethodBinding) {
                    ...
                    if (CharOperation.equals(inheritedMethodToBridge.selector, method.selector)
                        && TypeBinding.equalsEquals(inheritedMethodToBridge.returnType.erasure(),
        ...
        SyntheticMethodBinding accessMethod = null;
        SyntheticMethodBinding[] accessors
            = (SyntheticMethodBinding[]) this.synthetics[SourceTypeBinding.METHOD_EMUL].get(inheritedMethodToBridge);
        if (accessors == null) {
    ...
    public SyntheticMethodBinding addSyntheticBridgeMethod(MethodBinding inheritedMethodToBridge) {
        if (!isPrototype())
            throw new IllegalStateException();
        if (isInterface() && !inheritedMethodToBridge.isDefaultMethod())
            return null;
        if (inheritedMethodToBridge.isAbstract()
            || inheritedMethodToBridge.isFinal()
    ...
    void faultInTypesForFieldsAndMethods() {
        if (!isPrototype())
            throw new IllegalStateException();
        if (!this.isLocalType())
            complainIfUnpermittedSubtyping();  // this has nothing to do with fields and methods but time is ripe for
                                               // this check.
    ...
    private void complainIfUnpermittedSubtyping() {
        ...
        // Diagnose unauthorized subtyping: This cannot be correctly hoisted into ClassScope.{ connectSuperclass() |
        // connectSuperInterfaces() | connectPermittedTypes() }
    ...
    private VariableBinding resolveTypeFor(VariableBinding variable) {
        ...
        try {
            ...
            AbstractVariableDeclaration variableDeclaration = variable instanceof FieldBinding field
                ? field.sourceField()
                : ((RecordComponentBinding) variable).sourceRecordComponent();
            TypeBinding variableType = variableDeclaration.getKind() == AbstractVariableDeclaration.ENUM_CONSTANT
                ? initializationScope.environment().convertToRawType(this, false /*
                                                                                  * do not force conversion of enclosing
                                                                                  * types
                                                                                  */) // enum constant is implicitly of
                                                                                      // declaring enum type
            ...
            if (leafType instanceof ReferenceBinding
                && (((ReferenceBinding) leafType).modifiers & ExtraCompilerModifiers.AccGenericSignature) != 0) {
            ...
            if (variableDeclaration instanceof RecordComponent componentDeclaration) {
                ...
                if (TypeDeclaration.disallowedComponentNames.contains(new String(componentDeclaration.name))) {
                    this.scope.problemReporter()
                        .illegalComponentNameInRecord(componentDeclaration, this.scope.referenceContext);
                    componentDeclaration.setBinding(null);
                    return null;
                }
                if (componentDeclaration.isUnnamed(this.scope)) {
                    this.scope.problemReporter()
                        .illegalUseOfUnderscoreAsAnIdentifier(componentDeclaration.sourceStart,
                            componentDeclaration.sourceEnd, true, true);
                    componentDeclaration.setBinding(null);
                    return null;
                }
                RecordComponent[] recordComponents = this.scope.referenceContext.recordComponents;
                if (componentDeclaration.isVarArgs()
                    && recordComponents[recordComponents.length - 1] != componentDeclaration)
                    this.scope.problemReporter()
                        .onlyLastRecordComponentMaybeVararg(componentDeclaration, this.scope.referenceContext);
            ...
            if (annotations != null && annotations.length != 0) {
                ASTNode.copySE8AnnotationsToType(initializationScope, variable, annotations,
                    variableDeclaration.getKind() == AbstractVariableDeclaration.ENUM_CONSTANT); // type annotation is
                                                                                                 // illegal on enum
                                                                                                 // constant
            }
            ...
            if (this.environment.globalOptions.isAnnotationBasedNullAnalysisEnabled) {
                ...
                if (variableDeclaration.getKind() == AbstractVariableDeclaration.ENUM_CONSTANT) {
                    ...
                    int location = variable.kind() == Binding.RECORD_COMPONENT
                        ? DefaultLocationRecordComponent
                    ...
                    if (!this.scope.validateNullAnnotation(variable.tagBits, variableDeclaration.type,
                        variableDeclaration.annotations))
                        variable.tagBits &= ~TagBits.AnnotationNullMASK;
                }
            }
            if (initializationScope.shouldCheckAPILeaks(this, variable.isPublic()) && variableDeclaration.type != null) // variableDeclaration.type
                                                                                                                        // is
                                                                                                                        // null
                                                                                                                        // for
                                                                                                                        // enum
        ...
        if (this.externalAnnotationProvider != null) {
            if (variable instanceof FieldBinding field)
                ExternalAnnotationSuperimposer.annotateFieldBinding(field, this.externalAnnotationProvider,
                    this.environment);
            else if (variable instanceof RecordComponentBinding component)
                ExternalAnnotationSuperimposer.annotateComponentBinding(component, this.externalAnnotationProvider,
                    this.environment);
        }
        return variable;
    }
                ...
                if (resolveTypeFor(fieldsSnapshot[i]) == null) {
                    ...
                    if (this.isRecord() && !fieldsSnapshot[i].isStatic()) {
                        Iterator<Map.Entry<?, ?>> iterator
                            = this.synthetics[SourceTypeBinding.FIELD_EMUL].entrySet().iterator();
...
// NOTE: the return type, arg & exception types of each method of a source type are resolved when needed
    ...
    public MethodBinding getExactConstructor(TypeBinding[] argumentTypes) {
        ...
        if ((this.tagBits & TagBits.AreMethodsComplete) != 0) { // have resolved all arg types & return type of the
                                                                // methods
            long range;
            ...
            if ((range = ReferenceBinding.binarySearch(TypeConstants.INIT, this.methods)) >= 0) {
                nextMethod: for (int imethod = (int) range, end = (int) (range >> 32); imethod <= end; imethod++) {
                    ...
                    if (resolveTypesFor(method) == null || method.returnType == null) {
                        methods();
                        return getExactConstructor(argumentTypes);  // try again since the problem methods have been
                                                                    // removed
                    }
                    if (method.parameters.length == argCount) {
                        TypeBinding[] toMatch = method.parameters;
        ...
        if ((this.tagBits & TagBits.AreMethodsComplete) != 0) { // have resolved all arg types & return type of the
            ...
            if ((range = ReferenceBinding.binarySearch(selector, this.methods)) >= 0) {
                ...
                for (int imethod = start; imethod <= end; imethod++) {
                    ...
                    if (resolveTypesFor(method) == null || method.returnType == null) {
                        methods();
                        return getExactMethod(selector, argumentTypes, refScope); // try again since the problem methods
                                                                                  // have been removed
                    }
                }
                ...
                for (int i = start; i <= end; i++) {
                    ...
                    for (int j = end; j > i; j--) {
                        ...
                        if (paramsMatch) {
                            methods();
                            return getExactMethod(selector, argumentTypes, refScope); // try again since the problem
            ...
            if (this.isRecord()) {
                methods();
                return getExactMethod(selector, argumentTypes, refScope); // try again with special record methods
                                                                          // synthesized
            }
        }
...
// NOTE: the return type, arg & exception types of each method of a source type are resolved when needed
        ...
        for (FieldBinding field : syntheticFields) {
            if (CharOperation.prefixEquals(TypeConstants.SYNTHETIC_SWITCH_ENUM_TABLE, field.name) && field.isFinal()) {
                MethodBinding[] accessors
                    = (MethodBinding[]) this.synthetics[SourceTypeBinding.METHOD_EMUL].get(new String(field.name));
    ...
    public FieldBinding getSyntheticField(ReferenceBinding targetEnclosingType, boolean onlyExactMatch) {
        ...
        // class T { class M{}}
        // class S extends T { class N extends M {}} --> need to use S as a default enclosing instance for the super
        // constructor call in N().
        if (!onlyExactMatch) {
...
// NOTE: the return type, arg & exception types of each method of a source type are resolved when needed
        ...
        try {
            ...
            for (int i = 0, length = this.methods.length; i < length; i++) {
                ...
                nextSibling: for (int j = i + 1; j < length; j++) {
                    ...
                    // report duplicate
                    boolean removeMethod2 = (severity == ProblemSeverities.Error) ? true : false; // do not remove if in
                                                                                                  // 1.6 and just a
                                                                                                  // warning given
                    if (methodDecl == null) {
                        methodDecl = method.sourceMethod(); // cannot be retrieved after binding is lost & may still be
                                                            // null if method is special
                        if (methodDecl != null && methodDecl.binding != null) { // ensure its a valid user defined
                                                                                // method
                            ...
                            if (isEnumSpecialMethod) {
                                ...
                                this.scope.problemReporter()
                                    .duplicateMethodInType(methodDecl, method.areParametersEqual(method2), severity);
                            }
                            if (removeMethod) {
                                removeMethod2 = false;
                                methodDecl.binding = null;
                                // do not alter original method array until resolution is over, due to reentrance
                                // (143259)
                                if (resolvedMethods == this.methods)
                    ...
                    if (method2Decl != null && method2Decl.binding != null) { // ensure its a valid user defined method
                        if (isEnumSpecialMethod) {
                            ...
                            this.scope.problemReporter()
                                .duplicateMethodInType(method2Decl, method.areParametersEqual(method2), severity);
                        }
                        if (removeMethod2) {
                ...
                if (method.returnType == null && resolvedMethods[i] != null) { // forget method with invalid return
                                                                               // type... was kept to detect possible
                                                                               // collisions
    ...
    private void addRequiredSpecialRecordMethods() {
        ...
        nextMethod: for (int i = 0, length = this.methods.length; i < length; i++) {
            ...
            if (CharOperation.equals(method.selector, TypeConstants.EQUALS)) {
                if (method.parameters != null
                    ...
                    && TypeBinding.equalsEquals(method.parameters[0], this.scope.getJavaLangObject()))
                    needEquals = false;
                // fall through and check if method is an accessor; Unlike toString and hashCode, equals is a valid
                // component name.
            }

            for (int j = 0; j < rcLength; j++) {
                RecordComponentBinding rcb = rcbs[j];
                if (CharOperation.equals(method.selector, rcb.name)
                    && (method.parameterNames == null || method.parameterNames.length == 0)) {
        ...
        if (newOnes > 0) {
            ...
            if (length > 1)
                ReferenceBinding.sortMethods(this.methods, 0, length); // TagBits.AreMethodsSorted; -- already set in
                                                                       // #methods()
        }
    }
    ...
    public ReferenceBinding containerAnnotationType() {
        ...
        if (this.containerAnnotationType instanceof UnresolvedReferenceBinding) {
            this.containerAnnotationType = (ReferenceBinding) BinaryTypeBinding
                .resolveType(this.containerAnnotationType, this.scope.environment(), false);
        }
    ...
    private MethodBinding resolveTypesWithSuspendedTempErrorHandlingPolicy(MethodBinding method) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (resolvedExceptionType.isBoundParameterizedType()) {
                    methodDecl.scope.problemReporter()
                        .invalidParameterizedExceptionType(resolvedExceptionType, exceptionTypes[i]);
                    continue;
                }
        ...
        final boolean reportUnavoidableGenericTypeProblems
            = this.scope.compilerOptions().reportUnavoidableGenericTypeProblems;
        ...
        if (arguments != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                try {
                    ...
                    // don't pass optional 'location' arg, to avoid applying @NNBD before ImplicitNullAnnotationVerifier
                    // has run:
            ...
            for (int i = 0; i < length; i++) {
                ...
                implicitArgument.tagBits
                    |= rcbs[i].tagBits & (TagBits.AnnotationNullMASK | TagBits.AnnotationOwningMASK);
                methodDecl.scope.addLocalVariable(implicitArgument);
                List<AnnotationBinding> propagatedAnnotations = new ArrayList<>();
                ASTNode.getRelevantAnnotations(rcbs[i].sourceRecordComponent().annotations,
                    TagBits.AnnotationForParameter, propagatedAnnotations);
        ...
        if (!method.isConstructor()) {
            TypeReference returnType
                = methodDecl instanceof MethodDeclaration ? ((MethodDeclaration) methodDecl).returnType : null;
            if (returnType == null) {
                ...
                boolean deferRawTypeCheck
                    = !reportUnavoidableGenericTypeProblems && (returnType.bits & ASTNode.IgnoreRawTypeCheck) == 0;
        ...
        if (this.externalAnnotationProvider != null)
            ExternalAnnotationSuperimposer.annotateMethodBinding(method, arguments, this.externalAnnotationProvider,
                this.environment);
        ...
        if (foundReturnTypeProblem)
            return method; // but its still unresolved with a null return type & is still connected to its method
                           // declaration
...
// https://bugs.eclipse.org/bugs/show_bug.cgi?id=391108
    ...
    private void createArgumentBindings(MethodBinding method, CompilerOptions compilerOptions) {
        ...
        if (methodDecl != null) {
            ...
            if (compilerOptions.isAnnotationBasedNullAnalysisEnabled) {
                new ImplicitNullAnnotationVerifier(this.scope.environment()).checkImplicitNullAnnotations(method,
                    methodDecl, true, this.scope);
            }
        }
    }
    ...
    public void evaluateNullAnnotations() {
        ...
        if (!isPackageInfo) {
            ...
            if (pkg.getDefaultNullness() == NO_NULL_DEFAULT
                && !isInDefaultPkg
                && !isInNullnessAnnotationPackage
                && !(this instanceof NestedTypeBinding)) {
        ...
        if (this.defaultNullness != 0) {
            ...
            if (isPackageInfo) {
                if (pkg.enclosingModule.getDefaultNullness() == this.defaultNullness) {
                    this.scope.problemReporter()
                        .nullDefaultAnnotationIsRedundant(typeDecl, typeDecl.annotations, pkg.enclosingModule);
                } else {
                    pkg.setDefaultNullness(this.defaultNullness);
                }
            } else {
                Binding target = this.scope.parent.checkRedundantDefaultNullness(this.defaultNullness,
                    typeDecl.declarationSourceStart);
                if (target != null) {
                    this.scope.problemReporter()
                        .nullDefaultAnnotationIsRedundant(typeDecl, typeDecl.annotations, target);
                }
            }
    ...
    private void maybeMarkTypeParametersNonNull() {
        if (this.typeVariables != null && this.typeVariables.length > 0) {
            ...
            if (this.scope == null
                || !this.scope.hasDefaultNullnessFor(DefaultLocationTypeParameter, this.sourceStart()))
                return;
            ...
            for (int i = 0; i < this.typeVariables.length; i++) {
                ...
                if (typeParameter.annotations != null
                    && (tvb.extendedTagBits & ExtendedTagBits.AnnotationResolved) == 0)
    ...
    public RecordComponentBinding[] setComponents(RecordComponentBinding[] components) {
        ...
        for (RecordComponentBinding component : components) {
            for (FieldBinding field : this.fields) {
                if (CharOperation.equals(field.name, component.name) && field.type == null) { // field got built before
                                                                                              // record component
                                                                                              // resolution
...
// Propagate writes to all annotated variants so the clones evolve along.
    public ReferenceBinding setSuperClass(ReferenceBinding superClass) {
        ...
        if (superClass != null
            && superClass.actualType()instanceof SourceTypeBinding sourceSuperType
            && sourceSuperType.isSealed()
            && sourceSuperType.scope.referenceContext.permittedTypes == null) {
...
// Propagate writes to all annotated variants so the clones evolve along.
    public ReferenceBinding[] setSuperInterfaces(ReferenceBinding[] superInterfaces) {
        ...
        for (int i = 0, length = superInterfaces == null ? 0 : superInterfaces.length; i < length; i++) {
            ...
            if (superInterface.actualType()instanceof SourceTypeBinding sourceSuperType
                && sourceSuperType.isSealed()
                && sourceSuperType.scope.referenceContext.permittedTypes == null) {
                sourceSuperType.setImplicitPermittedType(this);
            }
...
// Propagate writes to all annotated variants so the clones evolve along.
    ...
    Map<Binding, AnnotationHolder> storedAnnotations(boolean forceInitialize, boolean forceStore) {
        ...
        if (forceInitialize && this.storedAnnotations == null && this.scope != null) { // scope null when no annotation
                                                                                       // cached, and type got processed
                                                                                       // fully (159631)
    ...
    public void tagIndirectlyAccessibleMembers() {
        ...
        if (this.superclass.isPrivate())
            if (this.superclass instanceof SourceTypeBinding)  // should always be true because private super type can
                                                               // only be accessed in same CU
