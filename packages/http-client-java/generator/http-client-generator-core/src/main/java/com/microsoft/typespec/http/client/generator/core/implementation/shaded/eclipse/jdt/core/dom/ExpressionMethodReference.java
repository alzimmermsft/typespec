...
public class ExpressionMethodReference extends MethodReference {
    ...
    public static final ChildPropertyDescriptor EXPRESSION_PROPERTY = new ChildPropertyDescriptor(
        ExpressionMethodReference.class, "expression", Expression.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
    ...
    public static final ChildPropertyDescriptor NAME_PROPERTY = new ChildPropertyDescriptor(
        ExpressionMethodReference.class, "name", SimpleName.class, MANDATORY, NO_CYCLE_RISK); //$NON-NLS-1$
