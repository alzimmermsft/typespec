...
//	public static final int INVALID_COMPILER_OPTION = 1007;
    ...
    /**
     * Status constant indicating that a source folder marked to contain test sources has no separate output location,
     * but the project also contains main sources.
     * preference settings.
     * 
    ...
    /**
     * Status constant indicating that the output folder of a source folder marked to contain test sources is not
     * separate from the output folders of main sources.
     * 
     * @see IClasspathAttribute#TEST
     * @since 3.14
     */
