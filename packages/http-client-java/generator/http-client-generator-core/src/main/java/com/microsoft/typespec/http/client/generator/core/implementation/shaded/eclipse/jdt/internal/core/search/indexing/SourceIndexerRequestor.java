...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.JavaModelManager.traceDumpStack;
...
public void enterModule(ModuleInfo moduleInfo) {
	...
	if (moduleInfo.requires != null) {
		for (RequiresInfo req : moduleInfo.requires) {
...
private void enterPackageVisibilityInfo(PackageExportInfo[] packInfos) {
	if (packInfos == null)
		return;
	for (PackageExportInfo packInfo : packInfos) {
