...
public class CompletionOnJavadocQualifiedTypeReference extends JavadocQualifiedTypeReference
    implements CompletionOnJavadoc {
    public int completionFlags = JAVADOC;
    public char[] completionIdentifier;

    public CompletionOnJavadocQualifiedTypeReference(char[][] sources, char[] identifier, long[] pos, int tagStart,
        int tagEnd) {
