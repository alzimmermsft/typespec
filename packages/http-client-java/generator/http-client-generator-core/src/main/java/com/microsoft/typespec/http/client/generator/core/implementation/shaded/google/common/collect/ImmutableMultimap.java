...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Maps.immutableEntry;
...
public abstract class ImmutableMultimap<K, V> extends BaseImmutableMultimap<K, V> implements Serializable {
     ...
     *         = new ImmutableMultimap.Builder<String, Integer>().put("one", 1)
