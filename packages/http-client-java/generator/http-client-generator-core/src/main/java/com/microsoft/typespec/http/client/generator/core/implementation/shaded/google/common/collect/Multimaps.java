...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.CollectPreconditions.checkRemove;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Maps.EntryTransformer;
...
public final class Multimaps {
     ...
     * @since 21.0
     */
    public static <T extends @Nullable Object, K extends @Nullable Object, V extends @Nullable Object, M extends Multimap<K, V>>
        Collector<T, ?, M> toMultimap(java.util.function.Function<? super T, ? extends K> keyFunction,
     ...
     */
    public static <T extends @Nullable Object, K extends @Nullable Object, V extends @Nullable Object, M extends Multimap<K, V>>
        Collector<T, ?, M> flatteningToMultimap(java.util.function.Function<? super T, ? extends K> keyFunction,
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> Multimap<K, V>
        newMultimap(Map<K, Collection<V>> map, final Supplier<? extends Collection<V>> factory) {
    ...
    private static class CustomMultimap<K extends @Nullable Object, V extends @Nullable Object>
        ...
        @Override
        <E extends @Nullable Object> Collection<E> unmodifiableCollectionSubclass(Collection<E> collection) {
     ...
     * @throws IllegalArgumentException if {@code map} is not empty
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> ListMultimap<K, V>
        newListMultimap(Map<K, Collection<V>> map, final Supplier<? extends List<V>> factory) {
     ...
     * @throws IllegalArgumentException if {@code map} is not empty
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> SetMultimap<K, V>
        newSetMultimap(Map<K, Collection<V>> map, final Supplier<? extends Set<V>> factory) {
    ...
    public static <K extends @Nullable Object, V extends @Nullable Object> SortedSetMultimap<K, V>
        newSortedSetMultimap(Map<K, Collection<V>> map, final Supplier<? extends SortedSet<V>> factory) {
        return new CustomSortedSetMultimap<>(map, factory);
    }

    private static class CustomSortedSetMultimap<K extends @Nullable Object, V extends @Nullable Object>
    ...
    public static <K extends @Nullable Object, V extends @Nullable Object, M extends Multimap<K, V>> M
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            if (result == null) {
                result = map = Collections.unmodifiableMap(
                    Maps.transformValues(delegate.asMap(), collection -> unmodifiableValueCollection(collection)));
            }
            return result;
        }
    ...
    private static class UnmodifiableSetMultimap<K extends @Nullable Object, V extends @Nullable Object>
     ...
     */
    private static <V extends @Nullable Object> Collection<V> unmodifiableValueCollection(Collection<V> collection) {
     ...
     */
    private static <K extends @Nullable Object, V extends @Nullable Object> Collection<Entry<K, V>>
    ...
    public static <K extends @Nullable Object, V extends @Nullable Object> Map<K, List<V>>
    ...
    public static <K extends @Nullable Object, V extends @Nullable Object> Map<K, Set<V>>
    ...
    public static <K extends @Nullable Object, V extends @Nullable Object> Map<K, SortedSet<V>>
     ...
     * @since 15.0
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> Map<K, Collection<V>>
     ...
     * @since 7.0
     */
    public static <K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object> Multimap<K, V2>
        transformValues(Multimap<K, V1> fromMultimap, final Function<? super V1, V2> function) {
    ...
    public static <K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object>
        ListMultimap<K, V2> transformValues(ListMultimap<K, V1> fromMultimap, final Function<? super V1, V2> function) {
        checkNotNull(function);
        EntryTransformer<K, V1, V2> transformer = Maps.asEntryTransformer(function);
        return transformEntries(fromMultimap, transformer);
    }
     ...
     */
    public static <K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object> Multimap<K, V2>
        transformEntries(Multimap<K, V1> fromMap, EntryTransformer<? super K, ? super V1, V2> transformer) {
    ...
    public static <K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object>
        ListMultimap<K, V2>
        transformEntries(ListMultimap<K, V1> fromMap, EntryTransformer<? super K, ? super V1, V2> transformer) {
        return new TransformedEntriesListMultimap<>(fromMap, transformer);
    }

    private static class TransformedEntriesMultimap<K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object>
    ...
    private static final class TransformedEntriesListMultimap<K extends @Nullable Object, V1 extends @Nullable Object, V2 extends @Nullable Object>
    ...
    static class Keys<K extends @Nullable Object, V extends @Nullable Object> extends AbstractMultiset<K> {
        @Weak
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> Multimap<K, V>
        filterKeys(Multimap<K, V> unfiltered, final Predicate<? super K> keyPredicate) {
        if (unfiltered instanceof SetMultimap) {
            ...
            return new FilteredKeyMultimap<>(prev.unfiltered, Predicates.<K>and(prev.keyPredicate, keyPredicate));
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> SetMultimap<K, V>
        filterKeys(SetMultimap<K, V> unfiltered, final Predicate<? super K> keyPredicate) {
        if (unfiltered instanceof FilteredKeySetMultimap) {
            FilteredKeySetMultimap<K, V> prev = (FilteredKeySetMultimap<K, V>) unfiltered;
            return new FilteredKeySetMultimap<>(prev.unfiltered(), Predicates.<K>and(prev.keyPredicate, keyPredicate));
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> ListMultimap<K, V>
        filterKeys(ListMultimap<K, V> unfiltered, final Predicate<? super K> keyPredicate) {
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> Multimap<K, V>
        filterValues(Multimap<K, V> unfiltered, final Predicate<? super V> valuePredicate) {
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> SetMultimap<K, V>
        filterValues(SetMultimap<K, V> unfiltered, final Predicate<? super V> valuePredicate) {
        return filterEntries(unfiltered, Maps.<V>valuePredicateOnEntries(valuePredicate));
    }
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> Multimap<K, V>
        filterEntries(Multimap<K, V> unfiltered, Predicate<? super Entry<K, V>> entryPredicate) {
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> SetMultimap<K, V>
        filterEntries(SetMultimap<K, V> unfiltered, Predicate<? super Entry<K, V>> entryPredicate) {
        checkNotNull(entryPredicate);
     ...
     * avoid that problem.
     */
    private static <K extends @Nullable Object, V extends @Nullable Object> Multimap<K, V>
        filterFiltered(FilteredMultimap<K, V> multimap, Predicate<? super Entry<K, V>> entryPredicate) {
     ...
     * avoid that problem.
     */
    private static <K extends @Nullable Object, V extends @Nullable Object> SetMultimap<K, V>
        filterFiltered(FilteredSetMultimap<K, V> multimap, Predicate<? super Entry<K, V>> entryPredicate) {
        Predicate<Entry<K, V>> predicate = Predicates.<Entry<K, V>>and(multimap.entryPredicate(), entryPredicate);
