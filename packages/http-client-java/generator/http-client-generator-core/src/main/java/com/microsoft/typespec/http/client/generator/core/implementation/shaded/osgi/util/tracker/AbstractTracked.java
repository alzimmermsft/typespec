 ...
 * @ThreadSafe
 * @author $Id: e1f5ef44c35b5959835d3ebfb7d6115cd979f12a $
 * @since 1.4
 */
abstract class AbstractTracked<S, T, R> {
     ...
     */
	private void trackAdding(final S item) {
		if (DEBUG) {
     ...
     */
	abstract T customizerAdding(final S item);
     ...
     */
	abstract void customizerRemoved(final S item, final T object);
}
