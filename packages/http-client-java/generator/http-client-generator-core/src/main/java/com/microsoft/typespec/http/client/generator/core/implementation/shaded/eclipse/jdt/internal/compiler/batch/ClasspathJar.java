                ...
                if (calledFileNames != null) {
                    ...
                    while (calledFilesIterator.hasNext()) {
                        ...
                        if (linkedFile.isFile()) {
                            result.add(new ClasspathJar(linkedFile, this.closeZipFileAtEnd, this.accessRuleSet,
        ...
        nextEntry: for (Enumeration<? extends ZipEntry> e = this.zipFile.entries(); e.hasMoreElements();) {
            ...
            if (last > 0) {
                ...
                if (indexOfDot != -1) {
                    ...
                    answers.add(
                        CharOperation.arrayConcat(CharOperation.splitOn('/', packageArray), typeName.toCharArray()));
                }
            }
        }
