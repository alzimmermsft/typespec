...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.PublicScanner;
...
public class ToolFactory {
	 ...
	 * extension point "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.codeFormatter". If unable to find a registered extension, the factory
	 ...
	 * point "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.javaFormatter". The formatter id specified in the
	 * "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.javaFormatter" is instantiated. If unable to find a registered extension, the factory will
	...
	public static CodeFormatter createCodeFormatter(Map options, int mode) {
		...
		if (formatterId != null) {
					...
					for (IConfigurationElement configElement : configElements) {
						...
						if (initializerID != null && initializerID.equals(formatterId)) {
							try {
								...
								com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.log(e.getStatus());
								break;
							}
						}
					}
			...
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.log(IStatus.WARNING,
	 ...
	 */
	public static com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.IClassFileDisassembler createDefaultClassFileDisassembler(){
		class DeprecatedDisassembler extends Disassembler implements com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.IClassFileDisassembler {
		...
		if (root != null){
			try {
				if (root instanceof JarPackageFragmentRoot) {
					...
					String entryName = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.concatWith(packageFragment.names, classFileName, '/');
	 ...
	 * or 1.8 if running from outside of a headless eclipse.
	 * </p>
	 *
	 * @param tokenizeComments if set to <code>false</code>, comments will be silently consumed
	 * @param tokenizeWhiteSpace if set to <code>false</code>, white spaces will be silently consumed,
	 * @param assertMode unused
	...
	public static IScanner createScanner(boolean tokenizeComments, boolean tokenizeWhiteSpace, boolean assertMode, boolean recordLineSeparator){
		...
		if (complianceLevelValue == 0) complianceLevelValue = CompilerOptions.getFirstSupportedJdkLevel(); // fault-tolerance
		PublicScanner scanner =
			new PublicScanner(
				tokenizeComments,
				tokenizeWhiteSpace,
				false/*nls*/,
				CompilerOptions.getFirstSupportedJdkLevel()/*sourceLevel*/,
	...
	public static IScanner createScanner(boolean tokenizeComments, boolean tokenizeWhiteSpace, boolean recordLineSeparator, String sourceLevel) {
		...
		if (sourceLevelValue == 0) sourceLevelValue = CompilerOptions.getFirstSupportedJdkLevel(); // fault-tolerance
		PublicScanner scanner =
			new PublicScanner(
				tokenizeComments,
				tokenizeWhiteSpace,
