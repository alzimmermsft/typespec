...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.primitives.Booleans.trueFirst;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.googlejavaformat.java.JavaFormatterOptions.Style;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.googlejavaformat.java.JavaInput.Tok;
...
public class ImportOrderer {
  ...
  class Import {
    ...
    boolean isJava() {
      switch (topLevel()) {
        case "java":
        case "com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax":
          return true;
        default:
          return false;
      }
