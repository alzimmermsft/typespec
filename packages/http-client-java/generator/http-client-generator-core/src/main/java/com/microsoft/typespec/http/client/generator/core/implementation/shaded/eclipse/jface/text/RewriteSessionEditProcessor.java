...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.text.edits.CopyTargetEdit;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.text.edits.TextEditProcessor;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.text.edits.TextEditVisitor;
...
public final class RewriteSessionEditProcessor extends TextEditProcessor {
    ...
    public UndoEdit performEdits() throws MalformedTreeException, BadLocationException {
        ...
        DocumentRewriteSessionType type
            = isLargeEdit ? DocumentRewriteSessionType.UNRESTRICTED : DocumentRewriteSessionType.UNRESTRICTED_SMALL;
