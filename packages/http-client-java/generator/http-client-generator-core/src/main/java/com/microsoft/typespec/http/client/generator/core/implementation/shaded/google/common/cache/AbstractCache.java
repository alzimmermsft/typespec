...
public abstract class AbstractCache<K, V> implements Cache<K, V> {
    ...
    public static final class SimpleStatsCounter implements StatsCounter {
        ...
        public CacheStats snapshot() {
            return new CacheStats(negativeToMaxValue(hitCount.sum()), negativeToMaxValue(missCount.sum()),
                negativeToMaxValue(loadSuccessCount.sum()), negativeToMaxValue(loadExceptionCount.sum()),
                negativeToMaxValue(totalLoadTime.sum()), negativeToMaxValue(evictionCount.sum()));
        }
