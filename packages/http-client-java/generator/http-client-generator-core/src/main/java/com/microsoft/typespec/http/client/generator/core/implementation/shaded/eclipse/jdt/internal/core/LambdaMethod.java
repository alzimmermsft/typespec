...
public class LambdaMethod extends SourceMethod {
    ...
    LambdaMethod(JavaElement parent, String name, String key, int sourceStart, String[] parameterTypes,
        String[] parameterNames, String returnType, SourceMethodElementInfo elementInfo) {
        super(parent, name, parameterTypes);
        this.sourceStart = sourceStart;
        this.parameterNameStrings
            = (parameterNames == null || parameterNames.length == 0) ? CharOperation.NO_STRINGS : parameterNames;
    ...
    public boolean equals(Object o) {
        if (!(o instanceof LambdaMethod that))
            return false;
