...
final class Serialization {
     ...
     */
    static <K extends @Nullable Object, V extends @Nullable Object> void writeMap(Map<K, V> map,
     ...
     * for the data format.
     */
    static <K extends @Nullable Object, V extends @Nullable Object> void populateMap(Map<K, V> map,
     ...
     */
    static <K extends @Nullable Object, V extends @Nullable Object> void populateMap(Map<K, V> map,
        ObjectInputStream stream, int size) throws IOException, ClassNotFoundException {
     ...
     */
    static <E extends @Nullable Object> void writeMultiset(Multiset<E> multiset, ObjectOutputStream stream)
        throws IOException {
     ...
     */
    static <E extends @Nullable Object> void populateMultiset(Multiset<E> multiset, ObjectInputStream stream)
     ...
     */
    static <K extends @Nullable Object, V extends @Nullable Object> void writeMultimap(Multimap<K, V> multimap,
        ObjectOutputStream stream) throws IOException {
     ...
     */
    static <K extends @Nullable Object, V extends @Nullable Object> void populateMultimap(Multimap<K, V> multimap,
        ObjectInputStream stream) throws IOException, ClassNotFoundException {
     ...
     */
    static <K extends @Nullable Object, V extends @Nullable Object> void populateMultimap(Multimap<K, V> multimap,
        ObjectInputStream stream, int distinctKeys) throws IOException, ClassNotFoundException {
