...
public class EclipseCompiler implements JavaCompiler {
    ...
    public static final RuntimeException UNEXPECTED_CONTROL_FLOW = new RuntimeException() {
        private static final long serialVersionUID = 1L;
    };
    public static final RuntimeException UNSUPPORTED_OPERATION = new RuntimeException() {
        private static final long serialVersionUID = 1L;
    };
     ...
     *
     * @see
     * javax.tools.JavaCompiler#getStandardFileManager(com.microsoft.typespec.http.client.generator.core.implementation.
     * shaded.javax.tools.DiagnosticListener,
     * java.util.Locale, java.nio.charset.Charset)
     */
    @Override
    public StandardJavaFileManager getStandardFileManager(
        DiagnosticListener<? super JavaFileObject> someDiagnosticListener, Locale locale, Charset charset) {
     ...
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.tools.DiagnosticListener,
    ...
    public CompilationTask getTask(Writer out, JavaFileManager fileManager,
        DiagnosticListener<? super JavaFileObject> someDiagnosticListener, Iterable<String> options,
    ...
    public int run(InputStream in, OutputStream out, OutputStream err, String... arguments) {
        boolean succeed = new Main(new PrintWriter(new OutputStreamWriter(out != null ? out : System.out)),
            new PrintWriter(new OutputStreamWriter(err != null ? err : System.err)), true/* systemExit */,
            null/* options */, null/* progress */).compile(arguments);
        return succeed ? 0 : -1;
    }
