...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.expressions.ICountable;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.expressions.IIterable;
...
public class Expressions {
    ...
    public static void checkAttribute(String name, String value, String[] validValues) throws CoreException {
        ...
        throw new CoreException(new ExpressionStatus(ExpressionStatus.WRONG_ATTRIBUTE_VALUE,
    ...
    public static void checkCollection(Object var, Expression expression) throws CoreException {
        ...
        throw new CoreException(new ExpressionStatus(ExpressionStatus.VARIABLE_IS_NOT_A_COLLECTION,
    ...
    public static void checkList(Object var, Expression expression) throws CoreException {
        ...
        throw new CoreException(new ExpressionStatus(ExpressionStatus.VARIABLE_IS_NOT_A_LIST,
