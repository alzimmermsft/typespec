...
public class AnnotationMethodInfo extends MethodInfo {
    ...
    public static MethodInfo createAnnotationMethod(byte classFileBytes[], int offsets[], int offset, long version) {
                ...
                switch (attributeName[0]) {
                    case 'A':
                        if (CharOperation.equals(attributeName, AttributeNamesConstants.AnnotationDefaultName)) {
                            ...
                            AnnotationInfo info = new AnnotationInfo(methodInfo.reference,
                                methodInfo.constantPoolOffsets, readOffset + 6 + methodInfo.structOffset);
        ...
        if (defaultValue != null) {
            if (typeAnnotations != null)
                return new AnnotationMethodInfoWithTypeAnnotations(methodInfo, defaultValue, annotations,
                    typeAnnotations);
            if (annotations != null) {
