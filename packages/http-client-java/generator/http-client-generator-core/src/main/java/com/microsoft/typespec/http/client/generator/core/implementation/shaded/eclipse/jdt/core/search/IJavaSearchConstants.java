...
public interface IJavaSearchConstants {
	...
	/**
	 * The search operation throws an <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.OperationCanceledException</code>
