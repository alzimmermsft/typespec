...
public class Disassembler extends ClassFileBytesDisassembler {
	...
	static String decodeStringValue(char[] chars) {
		...
		for (char c : chars) {
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util.appendEscapedChar(buffer, c, true);
		}
		return buffer.toString();
	}

	private static void escapeChar(StringBuilder buffer, char c) {
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Util.appendEscapedChar(buffer, c, false);
	}
	...
	/**
	 * @see org.eclipse.jdt.core.util.ClassFileBytesDisassembler#disassemble(byte[], String)
	 */
	@Override
