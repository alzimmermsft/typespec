...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.mac.CoreFoundation.CFAllocatorRef;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.mac.CoreFoundation.CFArrayRef;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.mac.CoreFoundation.CFBooleanRef;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.mac.CoreFoundation.CFDataRef;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.mac.CoreFoundation.CFDictionaryRef;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.mac.CoreFoundation.CFMutableDictionaryRef;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.mac.CoreFoundation.CFNumberRef;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.mac.CoreFoundation.CFStringRef;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.mac.CoreFoundation.CFTypeRef;
...
public interface IOKit extends Library {
    ...
    class IORegistryEntry extends IOObject {
        ...
        /**
         * Convenience method to get a {@link String} value from this IO
         * Registry Entry.
         *
         * @param key
        ...
        /**
         * Convenience method to get a {@link Long} value from this IO
         * Registry Entry.
         *
         * @param key
         *            The string name of the key to retrieve
        ...
        /**
         * Convenience method to get an {@link Integer} value from this IO
         * Registry Entry.
         *
         * @param key
         *            The string name of the key to retrieve
        ...
        /**
         * Convenience method to get a {@link Double} value from this IO
         * Registry Entry.
         *
         * @param key
         *            The string name of the key to retrieve
        ...
        /**
         * Convenience method to get a {@link Boolean} value from this IO
         * Registry Entry.
         *
         * @param key
         *            The string name of the key to retrieve
