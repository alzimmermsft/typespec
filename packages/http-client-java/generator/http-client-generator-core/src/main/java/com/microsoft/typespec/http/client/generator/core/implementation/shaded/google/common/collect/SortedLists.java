...
final class SortedLists {
    ...
    enum KeyPresentBehavior {
        ...
        ANY_PRESENT {
            @Override
            <E extends @Nullable Object> int resultIndex(Comparator<? super E> comparator, @ParametricNullness E key,
        ...
        FIRST_AFTER {
            @Override
            public <E extends @Nullable Object> int resultIndex(Comparator<? super E> comparator,
                @ParametricNullness E key, List<? extends E> list, int foundIndex) {
        ...
        abstract <E extends @Nullable Object> int resultIndex(Comparator<? super E> comparator,
            @ParametricNullness E key, List<? extends E> list, int foundIndex);
    }
     ...
     * KeyAbsentBehavior)} using {@link Ordering#natural}.
     */
    public static <E extends @Nullable Object, K extends Comparable> int binarySearch(List<E> list,
     ...
     * keyFunction)}.
     */
    public static <E extends @Nullable Object, K extends @Nullable Object> int binarySearch(List<E> list,
     ...
     */
    public static <E extends @Nullable Object> int binarySearch(List<? extends E> list, @ParametricNullness E key,
