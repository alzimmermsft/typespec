...
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache;
...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache.CacheBuilder.NULL_TICKER;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache.CacheBuilder.UNSET_INT;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.Futures.transform;
...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.Uninterruptibles.getUninterruptibly;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Stopwatch;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Ticker;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache.AbstractCache.SimpleStatsCounter;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache.AbstractCache.StatsCounter;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache.CacheBuilder.NullListener;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache.CacheBuilder.OneWeigher;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache.CacheLoader.InvalidCacheLoadException;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache.CacheLoader.UnsupportedLoadingOperationException;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.AbstractSequentialIterator;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Maps;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ExecutionError;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.Futures;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ListenableFuture;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.SettableFuture;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.UncheckedExecutionException;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.Uninterruptibles;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.errorprone.annotations.concurrent.GuardedBy;
...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    enum EntryFactory {
        STRONG {
            ...
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K key, int hash,
                @CheckForNull ReferenceEntry<K, V> next) {
        ...
        STRONG_ACCESS {
            ...
            <K, V> ReferenceEntry<K, V> copyEntry(Segment<K, V> segment, ReferenceEntry<K, V> original,
                ReferenceEntry<K, V> newNext, K key) {
    ...
    static final ValueReference<Object, Object> UNSET = new ValueReference<Object, Object>() {
        ...
        @Override
        public ValueReference<Object, Object> copyFor(ReferenceQueue<Object> queue, @CheckForNull Object value,
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        ReferenceEntry<K, V> removeValueFromChain(ReferenceEntry<K, V> first, ReferenceEntry<K, V> entry,
            @CheckForNull K key, int hash, V value, ValueReference<K, V> valueReference, RemovalCause cause) {
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        @Override
        public ValueReference<K, V> copyFor(ReferenceQueue<V> queue, @CheckForNull V value,
