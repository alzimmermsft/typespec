 ...
 * 'com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.eval.target.CodeSnippet'
...
public class CodeSnippetSkeleton implements IBinaryType, EvaluationConstants {
    ...
    IBinaryMethod[] methods = new IBinaryMethod[] {
        new BinaryMethodSkeleton("<init>".toCharArray(), //$NON-NLS-1$
