...
public interface SetupApi extends StdCallLibrary {
     ...
     */
    boolean SetupDiEnumDeviceInterfaces(HANDLE hDevInfo, Pointer devInfo,
           GUID interfaceClassGuid, int memberIndex,
     ...
     *   with an error, FALSE is returned and the error code for the failure can be retrieved by calling GetLastError.
     */
    boolean SetupDiGetDeviceInterfaceDetail(HANDLE hDevInfo,
