...
public interface SetupApi extends StdCallLibrary {
     ...
     */
    HANDLE SetupDiGetClassDevs(GUID classGuid, Pointer enumerator, Pointer hwndParent, int flags);
     ...
     */
    boolean SetupDiDestroyDeviceInfoList(HANDLE hDevInfo);
     ...
     */
    boolean SetupDiEnumDeviceInterfaces(HANDLE hDevInfo, Pointer devInfo, GUID interfaceClassGuid, int memberIndex,
     ...
     * with an error, FALSE is returned and the error code for the failure can be retrieved by calling GetLastError.
     */
    boolean SetupDiGetDeviceInterfaceDetail(HANDLE hDevInfo, SP_DEVICE_INTERFACE_DATA deviceInterfaceData,
        Pointer deviceInterfaceDetailData, int deviceInterfaceDetailDataSize, IntByReference requiredSize,
     ...
     * not valid.
     */
    boolean SetupDiGetDeviceRegistryProperty(HANDLE DeviceInfoSet, SP_DEVINFO_DATA DeviceInfoData, int Property,
     ...
     * GetLastError.
     */
    HKEY SetupDiOpenDevRegKey(HANDLE deviceInfoSet, SP_DEVINFO_DATA deviceInfoData, int scope, int hwProfile,
