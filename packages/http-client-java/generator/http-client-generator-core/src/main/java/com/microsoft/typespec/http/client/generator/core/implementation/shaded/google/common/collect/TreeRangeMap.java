...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
    ...
    private static final RangeMap<Comparable<?>, Object> EMPTY_SUB_RANGE_MAP = new RangeMap<Comparable<?>, Object>() {
        ...
        public void merge(Range<Comparable<?>> range, @CheckForNull Object value,
            BiFunction<? super Object, ? super @Nullable Object, ? extends @Nullable Object> remappingFunction) {
            checkNotNull(range);
    ...
    private class SubRangeMap implements RangeMap<K, V> {
        ...
        public void merge(Range<K> range, @CheckForNull V value,
            BiFunction<? super V, ? super @Nullable V, ? extends @Nullable V> remappingFunction) {
            checkArgument(subRange.encloses(range), "Cannot merge range %s into a subRangeMap(%s)", range, subRange);
        ...
        class SubRangeMapAsMap extends AbstractMap<Range<K>, V> {
            ...
            Iterator<Entry<Range<K>, V>> entryIterator() {
                ...
                Cut<K> cutToStart
                    = MoreObjects.firstNonNull(entriesByLowerBound.floorKey(subRange.lowerBound), subRange.lowerBound);
                final Iterator<RangeMapEntry<K, V>> backingItr
