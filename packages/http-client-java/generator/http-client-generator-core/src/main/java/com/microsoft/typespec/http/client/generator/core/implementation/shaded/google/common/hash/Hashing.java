...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.crypto.spec.SecretKeySpec;
...
public final class Hashing {
     ...
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.primitives.UnsignedLongs}'s
     * encoding of 64-bit unsigned numbers).
     *
     * <p>This function is best understood as a <a
     ...
     * that this uses unsigned integers (see
     * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.primitives.UnsignedInts}).
        ...
        private ConcatenatedHashFunction(HashFunction... functions) {
            ...
            for (HashFunction function : functions) {
                checkArgument(function.bits() % 8 == 0,
                    "the number of bits (%s) in hashFunction (%s) must be divisible by 8", function.bits(), function);
            }
        }
