...
public interface ClassFileConstants {
    ...
    long JDK1_1 = ((long) ClassFileConstants.MAJOR_VERSION_1_1 << 16) + ClassFileConstants.MINOR_VERSION_3; // 1.1. is
                                                                                                            // 45.3
    ...
    // jdk level used to denote future releases: optional behavior is not enabled for now, but may become so. In order
    // to enable these,
