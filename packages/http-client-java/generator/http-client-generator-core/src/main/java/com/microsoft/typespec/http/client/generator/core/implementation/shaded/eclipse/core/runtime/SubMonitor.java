 ...
 *
 * <pre>
 * // {@literal @}param monitor the progress monitor to use for reporting progress to the user. It is the caller's
 * // responsibility
...
public final class SubMonitor implements IProgressMonitorWithBlocking {
     ...
     *
     * @see org.eclipse.core.runtime.IProgressMonitor#beginTask(String,
     * int)
     */
    @Override
