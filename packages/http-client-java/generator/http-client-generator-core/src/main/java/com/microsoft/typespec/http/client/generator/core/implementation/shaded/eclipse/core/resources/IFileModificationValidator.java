 ...
 * "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.resources.fileModificationValidator"
...
public interface IFileModificationValidator {
	 ...
	 * @param context the <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.swt.widgets.Shell</code> that is to be used to
	 ...
	 *
	 * @see IFile#setContents(java.io.InputStream, int, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor)
	 * @see IFile#appendContents(java.io.InputStream, int, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor)
	 */
