 ...
 * for each referenced container (through the extension point "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.ClasspathContainerInitializer").
 * </p>
 * @see IClasspathEntry
 * @since 2.0
 */
...
public interface IClasspathContainer {
	 ...
	 * registered on the extension point "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.classpathContainerInitializer", which can
