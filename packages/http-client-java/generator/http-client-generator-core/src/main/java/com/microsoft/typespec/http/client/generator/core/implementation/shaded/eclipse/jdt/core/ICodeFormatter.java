 ...
 * an implementation for an ICodeFormatter, through the extension point
 * "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.codeFormatter".
 * In case none is found, a default formatter can be provided through the ToolFactory.
 *
 * @since 2.0
 * @deprecated Use
 * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.formatter.CodeFormatter}
 * instead (note: options have changed)
 */
