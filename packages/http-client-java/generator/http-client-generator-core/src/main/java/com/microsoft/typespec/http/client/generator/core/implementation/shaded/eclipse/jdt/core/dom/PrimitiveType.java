...
public class PrimitiveType extends AnnotatableType {
    ...
    /**
     * The "primitiveTypeCode" structural property of this node type (type: {@link Code}).
     * 
     * @since 3.0
     */
    public static final SimplePropertyDescriptor PRIMITIVE_TYPE_CODE_PROPERTY
        = new SimplePropertyDescriptor(PrimitiveType.class, "primitiveTypeCode", Code.class, MANDATORY); //$NON-NLS-1$
