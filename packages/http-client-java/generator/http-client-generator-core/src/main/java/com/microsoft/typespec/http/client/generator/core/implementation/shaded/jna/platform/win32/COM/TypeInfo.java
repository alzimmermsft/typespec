...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.OaIdl.HREFTYPEByReference;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.WinDef.WORDByReference;
...
public class TypeInfo extends Unknown implements ITypeInfo {
    ...
    public/* [local] */HRESULT GetFuncDesc(/* [in] */UINT index, /* [out] */PointerByReference ppFuncDesc) {
        ...
        return (HRESULT) this._invokeNativeObject(5, new Object[] { this.getPointer(), index, ppFuncDesc },
            HRESULT.class);
    }
    ...
    public/* [local] */HRESULT GetVarDesc(/* [in] */UINT index, /* [out] */PointerByReference ppVarDesc) {
        ...
        return (HRESULT) this._invokeNativeObject(6, new Object[] { this.getPointer(), index, ppVarDesc },
            HRESULT.class);
    }
     ...
     * @return the hresult
     */
    public/* [local] */ HRESULT GetNames(/* [in] */MEMBERID memid, /* [length_is][size_is][out] */ BSTR[] rgBstrNames,
        /* [in] */ UINT cMaxNames, /* [out] */ UINTByReference pcNames) {

        return (HRESULT) this._invokeNativeObject(7,
            new Object[] { this.getPointer(), memid, rgBstrNames, cMaxNames, pcNames }, HRESULT.class);
    }
    ...
    public HRESULT GetRefTypeOfImplType(/* [in] */UINT index, /* [out] */HREFTYPEByReference pRefType) {
        ...
        return (HRESULT) this._invokeNativeObject(8, new Object[] { this.getPointer(), index, pRefType },
            HRESULT.class);
    }
    ...
    public HRESULT GetImplTypeFlags(/* [in] */UINT index, /* [out] */IntByReference pImplTypeFlags) {
        ...
        return (HRESULT) this._invokeNativeObject(9, new Object[] { this.getPointer(), index, pImplTypeFlags },
            HRESULT.class);
    }
     ...
     * @return the hresult
     */
    public/* [local] */HRESULT GetIDsOfNames(/* [size_is][in] */LPOLESTR[] rgszNames, /* [in] */UINT cNames,
        /* [size_is][out] */MEMBERID[] pMemId) {

        return (HRESULT) this._invokeNativeObject(10, new Object[] { this.getPointer(), rgszNames, cNames, pMemId },
            HRESULT.class);
    }
     ...
     * @return the hresult
     */
    public/* [local] */ HRESULT Invoke(/* [in] */PVOID pvInstance, /* [in] */ MEMBERID memid, /* [in] */ WORD wFlags,
        /* [out][in] */ DISPPARAMS.ByReference pDispParams, /* [out] */ VARIANT.ByReference pVarResult,
        /* [out] */ EXCEPINFO.ByReference pExcepInfo, /* [out] */ UINTByReference puArgErr) {
     ...
     * @return the hresult
     */
    public/* [local] */ HRESULT GetDocumentation(/* [in] */MEMBERID memid, /* [out] */ BSTRByReference pBstrName,
        ...
        return (HRESULT) this._invokeNativeObject(12,
            new Object[] { this.getPointer(), memid, pBstrName, pBstrDocString, pdwHelpContext, pBstrHelpFile },
            HRESULT.class);
    }
    ...
    public/* [local] */ HRESULT GetDllEntry(/* [in] */MEMBERID memid, /* [in] */ INVOKEKIND invKind,
        ...
        return (HRESULT) this._invokeNativeObject(13,
            new Object[] { this.getPointer(), memid, invKind, pBstrDllName, pBstrName, pwOrdinal }, HRESULT.class);
    }
    ...
    public HRESULT GetRefTypeInfo(/* [in] */HREFTYPE hRefType, /* [out] */PointerByReference ppTInfo) {
        ...
        return (HRESULT) this._invokeNativeObject(14, new Object[] { this.getPointer(), hRefType, ppTInfo },
            HRESULT.class);
    }
     ...
     * @return the hresult
     */
    public/* [local] */HRESULT AddressOfMember(/* [in] */MEMBERID memid, /* [in] */INVOKEKIND invKind,
        /* [out] */PointerByReference ppv) {

        return (HRESULT) this._invokeNativeObject(15, new Object[] { this.getPointer(), memid, invKind, ppv },
            HRESULT.class);
    }
     ...
     * @return the hresult
     */
    public/* [local] */HRESULT CreateInstance(/* [in] */IUnknown pUnkOuter, /* [in] */REFIID riid,
        /* [iid_is][out] */PointerByReference ppvObj) {

        return (HRESULT) this._invokeNativeObject(16, new Object[] { this.getPointer(), pUnkOuter, riid, ppvObj },
            HRESULT.class);
    }
    ...
    public HRESULT GetMops(/* [in] */MEMBERID memid, /* [out] */BSTRByReference pBstrMops) {
        ...
        return (HRESULT) this._invokeNativeObject(17, new Object[] { this.getPointer(), memid, pBstrMops },
            HRESULT.class);
    }
    ...
    public/* [local] */HRESULT GetContainingTypeLib(/* [out] */PointerByReference ppTLib,
        ...
        return (HRESULT) this._invokeNativeObject(18, new Object[] { this.getPointer(), ppTLib, pIndex },
            HRESULT.class);
    }
