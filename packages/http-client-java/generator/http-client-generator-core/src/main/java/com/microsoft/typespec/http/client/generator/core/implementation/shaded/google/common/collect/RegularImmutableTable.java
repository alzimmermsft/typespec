...
abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
    ...
    static <R, C, V> RegularImmutableTable<R, C, V> forCells(List<Cell<R, C, V>> cells,
        ...
        if (rowComparator != null || columnComparator != null) {
             ...
             */
            Comparator<Cell<R, C, V>> comparator = (Cell<R, C, V> cell1, Cell<R, C, V> cell2) -> {
                int rowCompare
    ...
    final void checkNoDuplicate(R rowKey, C columnKey, @CheckForNull V existingValue, V newValue) {
        checkArgument(existingValue == null, "Duplicate key: (row=%s, column=%s), values: [%s, %s].", rowKey, columnKey,
