...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.cache.LocalCache.Strength;
 ...
 * com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.util.concurrent.ListenableFuture}
 * can adapt between the two {@code Future}
...
public final class CacheBuilder<K, V> {
    ...
    public <K1 extends K, V1 extends V> CacheBuilder<K1, V1> weigher(Weigher<? super K1, ? super V1> weigher) {
        ...
        if (strictParsing) {
            checkState(this.maximumSize == UNSET_INT, "weigher can not be combined with maximum size (%s provided)",
                this.maximumSize);
        }
     ...
     */
    public <K1 extends K, V1 extends V> CacheBuilder<K1, V1>
