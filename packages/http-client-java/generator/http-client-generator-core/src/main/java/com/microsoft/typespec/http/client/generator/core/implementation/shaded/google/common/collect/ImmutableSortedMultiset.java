...
public abstract class ImmutableSortedMultiset<E> extends ImmutableSortedMultisetFauxverideShim<E>
     ...
     * @since 21.0
     */
    public static <E> Collector<E, ?, ImmutableSortedMultiset<E>>
     ...
     * @since 22.0
     */
    public static <T extends @Nullable Object, E> Collector<T, ?, ImmutableSortedMultiset<E>> toImmutableSortedMultiset(
    ...
    private static <E> ImmutableSortedMultiset<E> copyOfSortedEntries(Comparator<? super E> comparator,
        ...
        return new RegularImmutableSortedMultiset<E>(
            new RegularImmutableSortedSet<E>(elementsBuilder.build(), comparator), cumulativeCounts, 0, entries.size());
    }
