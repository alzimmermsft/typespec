...
public class CaptureBinding18 extends CaptureBinding {
    ...
    public CaptureBinding18(ReferenceBinding contextType, char[] sourceName, char[] originalName, int start, int end,
        int captureID, LookupEnvironment environment) {
        ...
        try {
            if (this.upperBounds != null) {
                ...
                if (rightIntersectingTypes != null) {
                    nextRequired: for (TypeBinding required : rightIntersectingTypes) {
                    ...
                    if (currentBound != null) {
                        ...
                        if (TypeBinding.notEquals(currentBound, this.upperBounds[i])) {
                            if (currentUpperBounds == null)
                                System.arraycopy(this.upperBounds, 0, currentUpperBounds = new TypeBinding[length], 0,
                                    length);
