...
public class PrefsMessages extends NLS {
	 ...
	 */
	public static final String OWNER_NAME = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.equinox.preferences"; //$NON-NLS-1$

	private static final String BUNDLE_NAME = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.preferences.messages"; //$NON-NLS-1$
