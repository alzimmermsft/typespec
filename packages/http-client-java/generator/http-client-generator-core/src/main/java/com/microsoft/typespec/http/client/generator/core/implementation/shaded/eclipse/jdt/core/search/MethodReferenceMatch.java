...
public class MethodReferenceMatch extends ReferenceMatch {
     ...
     */
    public MethodReferenceMatch(IJavaElement enclosingElement, int accuracy, int offset, int length,
        boolean constructor, boolean synthetic, boolean insideDocComment, SearchParticipant participant,
        IResource resource) {
    ...
    public MethodReferenceMatch(IJavaElement enclosingElement, int accuracy, int offset, int length,
        ...
        this(enclosingElement, accuracy, offset, length, constructor, synthetic, insideDocComment, participant,
            resource);
