...
final class FuturesGetChecked {
    ...
    @ParametricNullness
    static <V extends @Nullable Object, X extends Exception> V getChecked(Future<V> future, Class<X> exceptionClass)
        throws X {
    ...
    @VisibleForTesting
    @ParametricNullness
    static <V extends @Nullable Object, X extends Exception> V getChecked(GetCheckedTypeValidator validator,
    ...
    static class GetCheckedTypeValidatorHolder {
        ...
        static GetCheckedTypeValidator getBestValidator() {
            ...
            } catch (ClassNotFoundException | RuntimeException | Error t) { // ensure we really catch *everything*
    ...
    private static <X extends Exception> X newWithCause(Class<X> exceptionClass, Throwable cause) {
        ...
        throw new IllegalArgumentException(
            "No appropriate constructor for exception of type " + exceptionClass + " in response to chained exception",
            cause);
    }
    ...
    private static final Ordering<List<Class<?>>> ORDERING_BY_CONSTRUCTOR_PARAMETER_LIST = Ordering.natural()
        ...
        .compound(Ordering.natural().onResultOf((List<Class<?>> params) -> params.contains(Throwable.class)))
        .reverse();
    private static final Ordering<Constructor<?>> WITH_STRING_PARAM_THEN_WITH_THROWABLE_PARAM
        = ORDERING_BY_CONSTRUCTOR_PARAMETER_LIST.onResultOf(constructor -> asList(constructor.getParameterTypes()));
