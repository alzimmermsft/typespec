...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.jdom.DOMException;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.jdom.IDOMField;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.jdom.IDOMMember;
...
class DOMField extends DOMMember implements IDOMField {
     ...
     */
    DOMField(char[] document, int[] sourceRange, String name, int[] nameRange, int[] commentRange, int flags,
        int[] modifierRange, int[] typeRange, String type, boolean hasInitializer, int[] initRange,
     ...
     * for a previous field declaration.
     */
    DOMField(char[] document, int[] sourceRange, String name, int[] nameRange, int flags, String type,
        boolean isVariableDeclarator) {
        this(document, sourceRange, name, nameRange, new int[] { -1, -1 }, flags, new int[] { -1, -1 },
            new int[] { -1, -1 }, type, false, new int[] { -1, -1 }, isVariableDeclarator);
        ...
        if (hasInitializer()) {
            if (this.fInitializerRange[0] < 0) {
                ...
                buffer
                    ...
                    .append(this.fDocument, this.fInitializerRange[1] + 1,
                        this.fSourceRange[1] - this.fInitializerRange[1]);
            }
        } else {
            if (this.fInitializerRange[0] < 0) {
                buffer.append(this.fDocument, this.fNameRange[1] + 1, this.fSourceRange[1] - this.fNameRange[1]);
            } else {
                buffer.append(this.fDocument, this.fInitializerRange[1] + 1,
                    this.fSourceRange[1] - this.fInitializerRange[1]);
            }
        }
    ...
    public String getInitializer() {
        ...
        if (hasInitializer()) {
            if (this.fInitializer != null) {
                ...
                return new String(this.fDocument, this.fInitializerRange[0],
                    this.fInitializerRange[1] + 1 - this.fInitializerRange[0]);
            }
        } else {
            return null;
        }
    ...
    protected boolean hasMultipleVariableDeclarators() {
        return this.fNextNode != null
            && (this.fNextNode instanceof DOMField)
