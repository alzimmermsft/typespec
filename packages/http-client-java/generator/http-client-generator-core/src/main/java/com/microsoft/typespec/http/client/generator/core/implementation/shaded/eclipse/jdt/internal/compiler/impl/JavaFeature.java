...
public enum JavaFeature {
    ...
    SWITCH_EXPRESSIONS(ClassFileConstants.JDK14, Messages.bind(Messages.switch_expression),
        new char[][] { TypeConstants.YIELD }, false),

    TEXT_BLOCKS(ClassFileConstants.JDK15, Messages.bind(Messages.text_block), new char[][] { }, false),

    PATTERN_MATCHING_IN_INSTANCEOF(ClassFileConstants.JDK16, Messages.bind(Messages.pattern_matching_instanceof),
        new char[][] { }, false),

    RECORDS(ClassFileConstants.JDK16, Messages.bind(Messages.records),
        new char[][] { TypeConstants.RECORD_RESTRICTED_IDENTIFIER }, false),

    SEALED_CLASSES(ClassFileConstants.JDK17, Messages.bind(Messages.sealed_types),
        new char[][] { TypeConstants.SEALED, TypeConstants.NON_SEALED, TypeConstants.PERMITS }, false),
    PATTERN_MATCHING_IN_SWITCH(ClassFileConstants.JDK21, Messages.bind(Messages.pattern_matching_switch),
        new char[][] { }, false),
    RECORD_PATTERNS(ClassFileConstants.JDK21, Messages.bind(Messages.record_patterns), new char[][] { }, false),
    UNNAMMED_PATTERNS_AND_VARS(ClassFileConstants.JDK22, Messages.bind(Messages.unnamed_patterns_and_vars),
        new char[][] { }, false),
    IMPLICIT_CLASSES_AND_INSTANCE_MAIN_METHODS(ClassFileConstants.JDK24,
        Messages.bind(Messages.implicit_classes_and_instance_main_methods), new char[][] { }, true),
    /**
     ...
     * </dl>
     */
    FLEXIBLE_CONSTRUCTOR_BODIES(ClassFileConstants.JDK24, Messages.bind(Messages.flexible_constructor_bodies),
        new char[][] { }, true),
    PRIMITIVES_IN_PATTERNS(ClassFileConstants.JDK24, Messages.bind(Messages.primitives_in_patterns), new char[][] { },
        true),
    MODULE_IMPORTS(ClassFileConstants.JDK24, Messages.bind(Messages.module_imports), CharOperation.NO_CHAR_CHAR, true),
    MARKDOWN_COMMENTS(ClassFileConstants.JDK23, Messages.bind(Messages.markdown_comments), CharOperation.NO_CHAR_CHAR,
        false),;
