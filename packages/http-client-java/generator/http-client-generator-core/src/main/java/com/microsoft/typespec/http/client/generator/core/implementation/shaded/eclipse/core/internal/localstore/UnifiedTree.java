...
public class UnifiedTree {
	...
	private static boolean disable_advanced_recursive_link_checks = System.getProperty("com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.resources.disable_advanced_recursive_link_checks") != null; //$NON-NLS-1$
