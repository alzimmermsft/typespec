...
public abstract class AbstractURLStreamHandlerService extends URLStreamHandler implements URLStreamHandlerService {
     ...
     */
    @Override
    public void parseURL(@SuppressWarnings("hiding") URLStreamHandlerSetter realHandler, URL u, String spec, int start,
        int limit) {
     ...
     */
    @Override
    protected void setURL(URL u, String proto, String host, int port, String auth, String user, String path,
