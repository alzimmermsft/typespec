 ...
 * </p>
 *
 * @see IEvaluationContext#evaluateCodeSnippet(String, ICodeSnippetRequestor,
 * com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor)
 * @see IEvaluationContext#evaluateCodeSnippet(String, String[], String[], int[],
 * com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.IType, boolean, boolean,
