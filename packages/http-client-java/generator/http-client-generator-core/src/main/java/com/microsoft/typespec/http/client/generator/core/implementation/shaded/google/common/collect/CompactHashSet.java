...
class CompactHashSet<E extends @Nullable Object> extends AbstractSet<E> implements Serializable {
     ...
     */
    public static <E extends @Nullable Object> CompactHashSet<E> create(Collection<? extends E> collection) {
     ...
     */
    public static <E extends @Nullable Object> CompactHashSet<E> createWithExpectedSize(int expectedSize) {
