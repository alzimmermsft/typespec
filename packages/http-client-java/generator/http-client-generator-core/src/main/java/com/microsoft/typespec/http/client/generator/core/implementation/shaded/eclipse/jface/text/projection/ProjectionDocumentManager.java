...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jface.text.ISlaveDocumentManager;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jface.text.ISlaveDocumentManagerExtension;


/**
 * A <code>ProjectionDocumentManager</code> is one particular implementation
 * of {@link ISlaveDocumentManager}. This manager
 * creates so called projection documents (see
 * {@link ProjectionDocument}as slave
 ...
 * but utilizes mechanisms given by {@link IDocument}
