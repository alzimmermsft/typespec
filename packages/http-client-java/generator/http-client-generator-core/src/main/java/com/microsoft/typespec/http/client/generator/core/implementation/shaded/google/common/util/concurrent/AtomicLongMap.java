 ...
 * {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Multiset} such
 * as {@link
 * com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.ConcurrentHashMultiset}
 * instead.
 *
...
public final class AtomicLongMap<K> implements Serializable {
    ...
    public long updateAndGet(K key, LongUnaryOperator updaterFunction) {
        ...
        Long result
            = map.compute(key, (k, value) -> updaterFunction.applyAsLong((value == null) ? 0L : value.longValue()));
