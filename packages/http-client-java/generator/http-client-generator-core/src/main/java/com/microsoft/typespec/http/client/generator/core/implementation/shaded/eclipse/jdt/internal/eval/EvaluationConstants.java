...
public interface EvaluationConstants {
	...
	public static final char[] PACKAGE_NAME = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.eval.target".toCharArray(); //$NON-NLS-1$
	public static final char[] CODE_SNIPPET_NAME = "com/microsoft/typespec/http/client/generator/core/implementation/shaded/eclipse/jdt/internal/eval/target/CodeSnippet".toCharArray(); //$NON-NLS-1$
