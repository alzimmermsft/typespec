...
public interface EvaluationConstants {
    ...
    public static final char[] PACKAGE_NAME
        = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.eval.target" //$NON-NLS-1$
            .toCharArray();
    public static final char[] CODE_SNIPPET_NAME
        = "com/microsoft/typespec/http/client/generator/core/implementation/shaded/eclipse/jdt/internal/eval/target/CodeSnippet" //$NON-NLS-1$
            .toCharArray();
    ...
    public static final char[][] ROOT_COMPOUND_NAME
        = CharOperation.arrayConcat(CharOperation.splitOn('.', PACKAGE_NAME), ROOT_CLASS_NAME);
