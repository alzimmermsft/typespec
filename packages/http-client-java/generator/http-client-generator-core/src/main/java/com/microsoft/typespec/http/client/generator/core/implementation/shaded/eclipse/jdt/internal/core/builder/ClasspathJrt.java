...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.JRTUtil.JrtFileVisitor;
...
public class ClasspathJrt extends ClasspathLocation implements IMultiModuleEntry {
            ...
            try {
                JRTUtil.walkModuleImage(jrt.jrtFileSystem, new JrtFileVisitor<Path>() {
                    ...
                    public FileVisitResult visitModule(Path path, String name) throws IOException {
                        jrt.acceptModule(
                            JRTUtil.getClassfileContent(jrt.jrtFileSystem, IModule.MODULE_INFO_CLASS, name), name,
                            newCache);
    ...
    public NameEnvironmentAnswer findClass(String binaryFileName, String qualifiedPackageName, String moduleName,
        ...
        try {
            ...
            IBinaryType reader
                = JRTUtil.getClassfile(this.jrtFileSystem, qualifiedBinaryFileName, moduleName, moduleNameFilter);
            if (reader == null) {
                return null;
            }
