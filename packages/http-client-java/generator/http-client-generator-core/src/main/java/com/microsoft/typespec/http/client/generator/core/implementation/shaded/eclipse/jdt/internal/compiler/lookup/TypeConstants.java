...
public interface TypeConstants {
    ...
    char[] JAVAX = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax".toCharArray(); //$NON-NLS-1$
    ...
    char[][] JAVA_NIO_FILE_FILES
        = new char[][] { JAVA, "nio".toCharArray(), "file".toCharArray(), "Files".toCharArray() };   //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
    ...
    char[] PRIMITIVE_CLASS__SIGNATURE
        = "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Class;".toCharArray(); //$NON-NLS-1$
    char[] GET_STATIC_FINAL = "getStaticFinal".toCharArray(); //$NON-NLS-1$
    char[] GET_STATIC_FINAL__SIGNATURE
        = "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;" //$NON-NLS-1$
            .toCharArray();
    ...
    char[][] ORG_ECLIPSE_JDT_INTERNAL_COMPILER_LOOKUP_TYPEBINDING
        = new char[][] { ORG, ECLIPSE, JDT, INTERNAL, COMPILER, LOOKUP, TYPEBINDING };
    ...
    char[][] COM_GOOGLE_COMMON_BASE_PRECONDITIONS
        = new char[][] { COM, GOOGLE, "common".toCharArray(), "base".toCharArray(), "Preconditions".toCharArray() }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    // ... methods:
