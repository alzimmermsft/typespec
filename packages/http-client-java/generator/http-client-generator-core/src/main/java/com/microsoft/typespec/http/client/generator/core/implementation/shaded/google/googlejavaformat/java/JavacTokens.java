...
final class JavacTokens {
    ...
    public static ImmutableList<RawTok> getTokens(String source, Context context, Set<TokenKind> stopTokens) {
        ...
        do {
            ...
            tokens.add(new RawTok(t.kind == TokenKind.STRINGLITERAL ? "\"" + t.stringVal() + "\"" : null, t.kind, t.pos,
                t.endPos));
            last = t.endPos;
    ...
    private static ImmutableList<CommentWithTextAndPosition> getComments(Token token,
