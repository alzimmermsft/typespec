...
public final class ModuleModifier extends ASTNode {
    ...
    public static class ModuleModifierKeyword {
        ...
        public static final ModuleModifierKeyword TRANSITIVE_KEYWORD
            = new ModuleModifierKeyword("transitive", TRANSITIVE);//$NON-NLS-1$
        ...
        static {
            ...
            ModuleModifierKeyword[] ops = { STATIC_KEYWORD, TRANSITIVE_KEYWORD, };
    ...
    /**
     * The "keyword" structural property of this node type (type: {@link ModuleModifierKeyword}).
     */
    public static final SimplePropertyDescriptor KEYWORD_PROPERTY
        = new SimplePropertyDescriptor(ModuleModifier.class, "keyword", ModuleModifierKeyword.class, MANDATORY); //$NON-NLS-1$
