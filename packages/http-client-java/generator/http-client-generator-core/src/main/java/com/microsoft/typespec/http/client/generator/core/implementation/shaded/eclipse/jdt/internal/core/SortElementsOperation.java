...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.rewrite.ListRewrite;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.util.CompilationUnitSorter;
...
public class SortElementsOperation extends JavaModelOperation {
	 ...
	 */
	public TextEdit calculateEdit(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit unit, TextEditGroup group) throws JavaModelException {
	...
	private String processElement(ICompilationUnit unit, char[] source) {
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit ast = (com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit) parser.createAST(null);
	...
	private ASTRewrite sortCompilationUnit(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit ast, final TextEditGroup group) {
		ast.accept(new ASTVisitor() {
			@Override
			public boolean visit(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit compilationUnit) {
		...
		ast.accept(new ASTVisitor() {
			...
			public boolean visit(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit compilationUnit) {
				...
				sortElements(compilationUnit.types(), rewriter.getListRewrite(compilationUnit, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.CompilationUnit.TYPES_PROPERTY));
				return true;
			}
