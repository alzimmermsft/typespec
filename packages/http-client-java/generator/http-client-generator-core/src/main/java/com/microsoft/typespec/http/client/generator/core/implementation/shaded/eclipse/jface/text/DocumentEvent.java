...
public class DocumentEvent {
     ...
     * If the
     * <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.text/debug/DocumentEvent/assertTextNotNull</code>
     * system property is <code>true</code>
     *
     * @since 3.3
     */
    private static final boolean ASSERT_TEXT_NOT_NULL = Boolean.getBoolean(
        "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.text/debug/DocumentEvent/assertTextNotNull"); //$NON-NLS-1$
