...
private static final int millisecondsBeforeCancelAutoBuild = Integer
		.getInteger("com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.MillisecondsBeforeCancelAutoBuild", 1000); //$NON-NLS-1$
private static final int millisecondsBeforeInterruptAutoBuild = Integer
		.getInteger("com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.MillisecondsBeforeInterruptAutoBuild", 3000); //$NON-NLS-1$
