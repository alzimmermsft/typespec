 ...
 * {@link JavaCore#setClasspathVariable(String, IPath, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor)},
 ...
 * container ID onto the extension point
...
public interface IClasspathEntry {
    ...
    /**
     * Returns whether the access rules of the project's exported entries should be combined with this entry's access
     * rules.
     * Returns true for container entries.
     * Returns false otherwise.
     *
     * @return whether the access rules of the project's exported entries should be combined with this entry's access
     * rules
     * @since 3.1
     */
     ...
     * </p>
     * <p>
     * Example patterns in source entries (assuming that "java" is the only {@link JavaCore#getJavaLikeExtensions()
     * Java-like extension}):
     * <ul>
     * <li>
    ...
    /**
     * This is a convience method, that returns <code>true</code> if the extra attributes contain an attribute whose
     * name
