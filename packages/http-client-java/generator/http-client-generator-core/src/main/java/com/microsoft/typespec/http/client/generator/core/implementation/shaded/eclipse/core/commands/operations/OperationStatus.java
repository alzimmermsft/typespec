...
public final class OperationStatus extends Status {
	 ...
	 *
	 * (value is "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.commands").
	 */
	static String DEFAULT_PLUGIN_ID = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.commands"; //$NON-NLS-1$
