...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Preconditions.checkElementIndex;
...
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Preconditions.checkPositionIndex;
...
public final class Lists {
     ...
     */
    @GwtCompatible(serializable = true)
    public static <E extends @Nullable Object> ArrayList<E> newArrayList(Iterable<? extends E> elements) {
        checkNotNull(elements); // for GWT
     ...
     */
    @GwtCompatible(serializable = true)
    public static <E extends @Nullable Object> ArrayList<E> newArrayListWithCapacity(int initialArraySize) {
     ...
     */
    @GwtCompatible(serializable = true)
    public static <E extends @Nullable Object> ArrayList<E> newArrayListWithExpectedSize(int estimatedSize) {
     ...
     */
    @GwtCompatible(serializable = true)
    public static <E extends @Nullable Object> LinkedList<E> newLinkedList(Iterable<? extends E> elements) {
    ...
    @J2ktIncompatible
    @GwtIncompatible // CopyOnWriteArrayList
    public static <E extends @Nullable Object> CopyOnWriteArrayList<E>
     ...
     * @return an unmodifiable list containing the specified elements
     */
    public static <E extends @Nullable Object> List<E> asList(@ParametricNullness E first, @ParametricNullness E second,
        E[] rest) {
     ...
     */
    public static <F extends @Nullable Object, T extends @Nullable Object> List<T> transform(List<F> fromList,
     ...
     * @see Lists#transform
     */
    private static class TransformingSequentialList<F extends @Nullable Object, T extends @Nullable Object>
     ...
     * @see Lists#transform
     */
    private static class TransformingRandomAccessList<F extends @Nullable Object, T extends @Nullable Object>
    ...
    static <E extends @Nullable Object> boolean addAllImpl(List<E> list, int index, Iterable<? extends E> elements) {
    ...
    static <E extends @Nullable Object> List<E> subListImpl(final List<E> list, int fromIndex, int toIndex) {
        List<E> wrapper;
        if (list instanceof RandomAccess) {
    ...
    private static class RandomAccessListWrapper<E extends @Nullable Object> extends AbstractListWrapper<E>
        implements RandomAccess {
