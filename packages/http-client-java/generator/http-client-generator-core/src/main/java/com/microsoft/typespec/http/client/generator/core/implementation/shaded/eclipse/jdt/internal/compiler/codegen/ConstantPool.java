...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.HashtableOfInteger;
...
public class ConstantPool implements ClassFileConstants, TypeIds {
    ...
    public static final char[][] JAVA_LANG_REFLECT_ACCESSIBLEOBJECT = new char[][] {
        TypeConstants.JAVA,
        TypeConstants.LANG,
        TypeConstants.REFLECT,
        "AccessibleObject".toCharArray() }; //$NON-NLS-1$
    ...
    public static final char[] JavaLangClassNotFoundExceptionConstantPoolName
        = "java/lang/ClassNotFoundException".toCharArray(); //$NON-NLS-1$
    ...
    public static final char[] JavaLangIncompatibleClassChangeErrorConstantPoolName
        = "java/lang/IncompatibleClassChangeError".toCharArray(); //$NON-NLS-1$
    ...
    public static final char[] JavaLangMatchExceptionNewInstanceSignature
        = "(Ljava/lang/String;Ljava/lang/Throwable;)V".toCharArray(); //$NON-NLS-1$
    ...
    public static final char[] JavaLangNoClassDefFoundErrorConstantPoolName
        = "java/lang/NoClassDefFoundError".toCharArray(); //$NON-NLS-1$
    ...
    public static final char[] JAVALANGREFLECTACCESSIBLEOBJECT_CONSTANTPOOLNAME
        = "java/lang/reflect/AccessibleObject".toCharArray(); //$NON-NLS-1$
    ...
    public static final char[] JavaLangReflectConstructorConstantPoolName
        = "java/lang/reflect/Constructor".toCharArray();   //$NON-NLS-1$
    ...
    public static final char[] JavaLangIllegalArgumentExceptionConstantPoolName
        = "java/lang/IllegalArgumentException".toCharArray(); //$NON-NLS-1$
    ...
    public static final char[] JAVA_LANG_INVOKE_LAMBDAMETAFACTORY_METAFACTORY_SIGNATURE
        = "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;" //$NON-NLS-1$
            .toCharArray();
    ...
    public static final char[] JAVA_LANG_INVOKE_LAMBDAMETAFACTORY_ALTMETAFACTORY_SIGNATURE
        = "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;" //$NON-NLS-1$
            .toCharArray();
    ...
    public static final char[] JavaLangInvokeSerializedLambdaConstantPoolName
        = "java/lang/invoke/SerializedLambda".toCharArray(); //$NON-NLS-1$
    ...
    public static final char[] GetFunctionalInterfaceMethodSignature
        = "getFunctionalInterfaceMethodSignature".toCharArray(); //$NON-NLS-1$
    ...
    public static final char[] JAVA_LANG_RUNTIME_OBJECTMETHOD_BOOTSTRAP_SIGNATURE
        = "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/TypeDescriptor;Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/invoke/MethodHandle;)Ljava/lang/Object;" //$NON-NLS-1$
            .toCharArray();
    ...
    public static final char[] JAVA_LANG_INVOKE_STRING_CONCAT_FACTORY_SIGNATURE
        = "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;" //$NON-NLS-1$
            .toCharArray();
    ...
    public static final char[] JAVA_LANG_INVOKE_CONSTANTBOOTSTRAP_SIGNATURE
        = "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/invoke/MethodHandle;[Ljava/lang/Object;)Ljava/lang/Object;" //$NON-NLS-1$
            .toCharArray();
    public static final char[] JAVA_LANG_ENUMDESC_OF_SIGNATURE
        = "(Ljava/lang/constant/ClassDesc;Ljava/lang/String;)Ljava/lang/Enum$EnumDesc;".toCharArray(); //$NON-NLS-1$
    public static final char[] JAVA_LANG_CLASSDESC_OF_SIGNATURE
        = "(Ljava/lang/String;)Ljava/lang/constant/ClassDesc;".toCharArray(); //$NON-NLS-1$
    public static final char[] JAVA_LANG_RUNTIME_STRING_TEMPLATE_SIGNATURE
        = "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;[Ljava/lang/String;)Ljava/lang/invoke/CallSite;" //$NON-NLS-1$
            .toCharArray();

    public static final char[] PROCESS = "process".toCharArray(); //$NON-NLS-1$

    public static final char[] JAVA_LANG_RUNTIME_EXACTCONVERSIONSSUPPORT
        = "java/lang/runtime/ExactConversionsSupport".toCharArray(); //$NON-NLS-1$
    ...
    public int literalIndexForMethod(TypeBinding declaringClass, char[] selector, char[] signature,
        boolean isInterface) {
    ...
    public int literalIndexForMethodHandle(MethodBinding binding) {
        ...
        int referenceKind = isInterface
            ? binding.isStatic()
                ...
                : binding.isPrivate() ? MethodHandleRefKindInvokeSpecial : MethodHandleRefKindInvokeInterface
            : binding.isConstructor()
                ? MethodHandleRefKindNewInvokeSpecial
                : binding.isStatic()
                    ? MethodHandleRefKindInvokeStatic
                    : binding.isPrivate() ? MethodHandleRefKindInvokeSpecial : MethodHandleRefKindInvokeVirtual;

        return literalIndexForMethodHandle(referenceKind, binding.declaringClass, binding.selector, binding.signature(),
            isInterface);
    }

    public int literalIndexForMethodHandle(int referenceKind, TypeBinding declaringClass, char[] selector,
        char[] signature, boolean isInterface) {
    ...
    public int literalIndexForMethodHandleFieldRef(int referenceKind, char[] declaringClass, char[] name,
        char[] signature) {
            ...
            if ((stringIndex = this.UTF8Cache.putIfAbsent(stringCharArray, this.currentIndex)) < 0) {
                ...
                for (char current : stringCharArray) {
                    if ((current >= 0x0001) && (current <= 0x007F)) {
                        ...
                        this.poolContent[this.currentOffset++] = (byte) (0xE0 | ((current >> 12) & 0x0F)); // 0xE0 =
                                                                                                           // 1110 0000
                        this.poolContent[this.currentOffset++] = (byte) (0x80 | ((current >> 6) & 0x3F)); // 0x80 = 1000
                                                                                                          // 0000
                        ...
                        // In that case we only need 2 bytes
                        length += 2;
                        this.poolContent[this.currentOffset++] = (byte) (0xC0 | ((current >> 6) & 0x1F)); // 0xC0 = 1100
                                                                                                          // 0000
                        this.poolContent[this.currentOffset++] = (byte) (0x80 | (current & 0x3F)); // 0x80 = 1000 0000
                    }
                }
