...
public abstract class NLS {
     ...
     * <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.example.nls.messages</code>
     * is used as the base name then
    ...
    static void load(final String bundleName, Class<?> clazz) {
        ...
        for (String variant : variants) {
            ...
            final InputStream input
                = loader == null ? ClassLoader.getSystemResourceAsStream(variant) : loader.getResourceAsStream(variant);
            if (input == null)
                continue;
            try {
    ...
    static void log(int severity, String message, Exception e) {
        ...
        if (frameworkLog != null) {
            frameworkLog.log(new FrameworkLogEntry(
                "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi", severity, 1, //$NON-NLS-1$
                message, 0, e, null));
            return;
        }
        String statusMsg;
