...
public abstract class NLS {
	 ...
	 * <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.example.nls.messages</code> is used as the base name then
	...
	static void log(int severity, String message, Exception e) {
		...
		if (frameworkLog != null) {
			frameworkLog.log(new FrameworkLogEntry("com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi", severity, 1, message, 0, e, null)); //$NON-NLS-1$
			return;
		}
		String statusMsg;
		switch (severity) {
