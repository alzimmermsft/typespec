...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Winevt.EVT_HANDLE;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Winevt.EVT_VARIANT;
...
public interface Wevtapi extends StdCallLibrary {
    ...
    /**
     * Establishes a connection to a remote computer that you can use when calling the other Windows Event Log
     * functions.
     ...
     */
    EVT_HANDLE EvtSubscribe(EVT_HANDLE Session, EVT_HANDLE SignalEvent, String ChannelPath, String Query,
        EVT_HANDLE Bookmark, Pointer Context, Callback Callback, int Flags);
     ...
     * the {@link Kernel32#GetLastError} function.
     */
    boolean EvtFormatMessage(EVT_HANDLE PublisherMetadata, EVT_HANDLE Event, int MessageId, int ValueCount,
        EVT_VARIANT[] Values, int Flags, int BufferSize, char[] Buffer, IntByReference BufferUsed);
     ...
     * call the {@link Kernel32#GetLastError} function.
     */
    boolean EvtGetChannelConfigProperty(EVT_HANDLE ChannelConfig, int PropertyId, int Flags,
     ...
     * otherwise, NULL. If NULL, call {@link Kernel32#GetLastError} function to get the error code.
     */
    EVT_HANDLE EvtOpenPublisherMetadata(EVT_HANDLE EvtHandleSession, String PublisherIdentity, String LogFilePath,
        int Locale, int Flags);
    ...
    boolean EvtGetPublisherMetadataProperty(EVT_HANDLE PublisherMetadata, int PropertyId, int Flags,
        int PublisherMetadataPropertyBufferSize, Pointer PublisherMetadataPropertyBuffer,
