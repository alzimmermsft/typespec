...
public final class HashMultimap<K extends @Nullable Object, V extends @Nullable Object>
     ...
     * negative
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> HashMultimap<K, V> create(int expectedKeys,
     ...
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> HashMultimap<K, V>
