...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.FunctionalExpression;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.jdom.CompilationUnit;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.search.matching.JavaSearchNameEnvironment;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.search.matching.MethodPattern;
...
public class SourceIndexer extends AbstractIndexer implements ITypeRequestor, SuffixConstants {
	...
	private com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.ASTNode dom;
	...
	private void resolveDocumentDomImpl(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.CompilationUnit unit) {
	...
	private String reduceDOM(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.ASTNode domParam) {
		domParam.accept(new ASTVisitor(false) {
			private boolean requiresBinding = false;
			@Override
			public boolean visit(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.TypeDeclaration node) {
			...
			@Override
			public boolean visit(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.LambdaExpression methodRef) {
				this.requiresBinding = true;
				return false;
			}
		});
	...
	private com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.ICompilationUnit getUnit() {
	...
	boolean indexDocumentFromDOM() {
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.ASTNode domLocal = astParser.createAST(null);
		if (domLocal != null) {
			domLocal.accept(new DOMToIndexVisitor(this));
			domLocal.accept(
					new ASTVisitor() {
						@Override
						public boolean preVisit2(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.ASTNode node) {
