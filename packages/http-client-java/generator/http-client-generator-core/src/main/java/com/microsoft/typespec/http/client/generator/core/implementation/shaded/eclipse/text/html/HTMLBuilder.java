 ...
 *******************************************************************************/
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.text.html;
 ...
 * <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jface.internal.text.revisions</code>.</p>
 *
 * @since 3.14
 */
public class HTMLBuilder {

    private static volatile RGB DEFAULT_BG_COLOR_RGB = new RGB(255, 255, 225); // CoreRGB value of info bg color on
                                                                               // WindowsXP
    ...
    public static String convertTopLevelFont(String styles, boolean bold, boolean italic, int height, String fontName) {
        ...
        styles = styles.replaceFirst("(html\\s*\\{.*(?:\\s|;)font-weight:\\s*)\\w+(\\;?.*\\})", //$NON-NLS-1$
            "$1" + (bold ? "bold" : "normal") + "$2");  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        styles = styles.replaceFirst("(html\\s*\\{.*(?:\\s|;)font-style:\\s*)\\w+(\\;?.*\\})", //$NON-NLS-1$
            "$1" + (italic ? "italic" : "normal") + "$2");  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
