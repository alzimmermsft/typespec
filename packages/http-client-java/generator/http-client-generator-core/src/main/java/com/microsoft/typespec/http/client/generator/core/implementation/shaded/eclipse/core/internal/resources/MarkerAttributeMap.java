...
public class MarkerAttributeMap implements IStringPoolParticipant {
     ...
     */
    public MarkerAttributeMap(Map<String, ?> map, boolean validate) {
     ...
     */
    public void setAttributes(Map<String, ?> map, boolean validate) {
        mapRef.set(copy(map, validate));
    }

    private Map<String, Object> copy(Map<String, ?> map, boolean validate) {
     ...
     */
    public void putAll(Map<String, ?> map, boolean validate) {
    ...
    private void putAll(Map<String, Object> target, Map<String, ?> source, boolean validate) {
        if (source == null) {
            return;
        }
    ...
    private Map<String, Object> copy(Map<String, ?> map) {
    ...
    /**
     * like {@link Map#put(Object, Object)} but null keys or values are
     * not allowed
     */
    ...
    public void shareStrings(StringPool set) {
        ...
        for (Entry<String, Object> e : getMap().entrySet()) {
            Object o = e.getValue();
