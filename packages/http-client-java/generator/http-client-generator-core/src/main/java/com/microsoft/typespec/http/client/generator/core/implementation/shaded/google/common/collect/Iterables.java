...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Optional;
...
public final class Iterables {
    ...
    private static final class UnmodifiableIterable<T extends @Nullable Object> extends FluentIterable<T> {
    ...
    @CheckForNull
    static <T extends @Nullable Object> T removeFirstMatching(Iterable<T> removeFrom, Predicate<? super T> predicate) {
    ...
    public static <T extends @Nullable Object> T getOnlyElement(Iterable<? extends T> iterable,
        @ParametricNullness T defaultValue) {
    ...
    public static <T extends @Nullable Object> T[] toArray(Iterable<? extends T> iterable, Class<@NonNull T> type) {
     ...
     */
    private static <E extends @Nullable Object> Collection<E> castOrCopyToCollection(Iterable<E> iterable) {
     ...
     */
    @CanIgnoreReturnValue
    public static <T extends @Nullable Object> boolean addAll(Collection<T> addTo,
     ...
     * b)}.
     */
    public static <T extends @Nullable Object> Iterable<T> concat(Iterable<? extends T> a, Iterable<? extends T> b) {
     ...
     */
    public static <T extends @Nullable Object> Iterable<T> concat(Iterable<? extends Iterable<? extends T>> inputs) {
        return FluentIterable.concat(inputs);
    }
     ...
     */
    public static <T extends @Nullable Object> Iterable<List<T>> partition(final Iterable<T> iterable, final int size) {
        checkNotNull(iterable);
     ...
     * @throws IllegalArgumentException if {@code size} is nonpositive
     */
    public static <T extends @Nullable Object> Iterable<List<@Nullable T>> paddedPartition(final Iterable<T> iterable,
        final int size) {
        checkNotNull(iterable);
        checkArgument(size > 0);
     ...
     */
    public static <T extends @Nullable Object> Iterable<T> filter(final Iterable<T> unfiltered,
     ...
     */
    public static <T extends @Nullable Object> boolean any(Iterable<T> iterable, Predicate<? super T> predicate) {
     ...
     */
    public static <T extends @Nullable Object> boolean all(Iterable<T> iterable, Predicate<? super T> predicate) {
     ...
     */
    @ParametricNullness
    public static <T extends @Nullable Object> T find(Iterable<T> iterable, Predicate<? super T> predicate) {
    ...
    @CheckForNull
    public static <T extends @Nullable Object> T find(Iterable<? extends T> iterable, Predicate<? super T> predicate,
     ...
     * @since 2.0
     */
    public static <T extends @Nullable Object> int indexOf(Iterable<T> iterable, Predicate<? super T> predicate) {
     ...
     */
    public static <F extends @Nullable Object, T extends @Nullable Object> Iterable<T>
        transform(final Iterable<F> fromIterable, final Function<? super F, ? extends T> function) {
     ...
     */
    @ParametricNullness
    public static <T extends @Nullable Object> T get(Iterable<? extends T> iterable, int position,
        @ParametricNullness T defaultValue) {
        checkNotNull(iterable);
     ...
     */
    @ParametricNullness
    public static <T extends @Nullable Object> T getFirst(Iterable<? extends T> iterable,
        @ParametricNullness T defaultValue) {
     ...
     * @since 3.0
     */
    public static <T extends @Nullable Object> Iterable<T> skip(final Iterable<T> iterable, final int numberToSkip) {
        checkNotNull(iterable);
     ...
     * @since 3.0
     */
    public static <T extends @Nullable Object> Iterable<T> limit(final Iterable<T> iterable, final int limitSize) {
        checkNotNull(iterable);
     ...
     * @since 2.0
     */
    public static <T extends @Nullable Object> Iterable<T> consumingIterable(final Iterable<T> iterable) {
        checkNotNull(iterable);
     ...
     * @since 11.0
     */
    public static <T extends @Nullable Object> Iterable<T>
        mergeSorted(final Iterable<? extends Iterable<? extends T>> iterables, final Comparator<? super T> comparator) {
