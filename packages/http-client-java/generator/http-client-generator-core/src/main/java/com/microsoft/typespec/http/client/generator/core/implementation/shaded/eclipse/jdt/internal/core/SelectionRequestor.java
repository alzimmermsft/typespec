...
public void acceptLocalVariable(LocalVariableBinding binding, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.env.ICompilationUnit unit) {
...
public void acceptLambdaMethod(MethodBinding binding, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.env.ICompilationUnit unit) {
...
protected IJavaElement findLocalElement(int pos, MethodScope scope) {
	if (scope != null && scope.isLambdaScope()) {
		...
		if (expression != null && expression.resolvedType != null && expression.resolvedType.isValidBinding()) {
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.LambdaExpression lambdaElement = LambdaFactory.createLambdaExpression((JavaElement) parent, expression);
