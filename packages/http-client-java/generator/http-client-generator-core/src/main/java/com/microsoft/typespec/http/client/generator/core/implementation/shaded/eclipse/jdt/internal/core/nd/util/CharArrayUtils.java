 ...
 *******************************************************************************/
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.nd.util;
...
public class CharArrayUtils {
    ...
    public static int hash(char[] str, int start, int length) {
        int h = 0;
    ...
    public static boolean equals(char[][] strarr1, char[][] strarr2) {
        if (strarr1 == strarr2) {
            return true;
        }
     ...
     * @since 5.5
     */
    public static boolean equals(char[] str1, int start1, int length1, String str2) {
     ...
     * @since 5.4
     */
    public static boolean startsWith(char[] str1, String str2) {
        int len = str2.length();
        if (str1.length < len)
            return false;
        for (int i = 0; i < len; i++) {
     ...
     */
    public static boolean equals(char[] str1, int start1, int length1, char[] str2) {
        if (length1 != str2.length || str1.length < length1 + start1)
            return false;
    ...
    public static boolean equals(char[] str1, int start1, int length1, char[] str2, boolean ignoreCase) {
        if (!ignoreCase)
    ...
    public static char[] extract(char[] str, int start, int length) {
    ...
    public static char[] concat(char[] first, char[] second, char[] third, char[] fourth) {
        if (first == null)
