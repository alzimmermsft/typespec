...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.log.FormatterLogger;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.log.LoggerConsumer;
...
public class ExtendedLogServiceImpl implements ExtendedLogService {
	...
	public Logger getLogger(String name) {
		return (Logger) getLogger(name, com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.log.Logger.class);
	}
	...
	@Override
	public <L extends com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.log.Logger> L getLogger(Bundle logBundle, String name, Class<L> loggerType) {
	...
	@Override
	public com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.log.Logger getLogger(Class<?> clazz) {
		return getLogger(clazz.getName());
	}

	@Override
	public <L extends com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.log.Logger> L getLogger(String name, Class<L> loggerType) {
		if (name == null) {
		...
		try {
			if (com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.log.Logger.class.equals(loggerType)) {
				loggers = loggerClassLoggers;
			} else if (FormatterLogger.class.equals(loggerType)) {
		...
		if (logger == null) {
			...
			} else if (loggerType == com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.log.Logger.class) {
	...
	@Override
	public <L extends com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.log.Logger> L getLogger(Class<?> clazz, Class<L> loggerType) {
