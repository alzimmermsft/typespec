...
public class JRTUtil {
	...
	public static final boolean DISABLE_CACHE = Boolean.getBoolean("com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.disable_JRT_cache"); //$NON-NLS-1$
