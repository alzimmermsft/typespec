...
public class JRTUtil {
    ...
    public static final boolean DISABLE_CACHE = Boolean.getBoolean(
        "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.disable_JRT_cache"); //$NON-NLS-1$
    public static final boolean PROPAGATE_IO_ERRORS = Boolean.getBoolean(
        "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.propagate_io_errors"); //$NON-NLS-1$
    ...
    public static void walkModuleImage(JrtFileSystem system, JrtFileVisitor<Path> visitor, int notify)
        throws IOException {
        if (system == null) {
            return;
        }
    ...
    public static byte[] getClassfileContent(JrtFileSystem system, String fileName, String module) throws IOException {
        return system.getClassfileContent(fileName, module);
    }

    public static ClassFileReader getClassfile(File jrt, String fileName, String module)
            ...
            Files.walkFileTree(p, new SimpleFileVisitor<>() {
                ...
                public FileVisitResult preVisitDirectory(Path dir, BasicFileAttributes attrs) throws IOException {
                    ...
                    if (count == 2) {
                        ...
                        if ((JRTUtil.MODULE_TO_LOAD != null
                            && JRTUtil.MODULE_TO_LOAD.length() > 0
