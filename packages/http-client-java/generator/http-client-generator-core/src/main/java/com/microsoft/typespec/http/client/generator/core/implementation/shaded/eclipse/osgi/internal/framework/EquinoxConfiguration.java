...
public class EquinoxConfiguration implements EnvironmentInfo {
    ...
    public static final class ConfigValues {
         ...
         */
        private final static String NULL_CONFIG
            = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.equinox.configuration.null.value"; //$NON-NLS-1$
        ...
        public ConfigValues(Map<String, ?> initialConfiguration) {
            Map<String, Object> initialConfig
                = initialConfiguration == null ? new HashMap<>(0) : new HashMap<>(initialConfiguration);
            Object useSystemPropsValue = initialConfig.get(PROP_USE_SYSTEM_PROPERTIES);
            this.useSystemProperties
                = useSystemPropsValue != null && Boolean.parseBoolean(useSystemPropsValue.toString());
            Properties tempConfiguration
                = useSystemProperties ? EquinoxContainer.secureAction.getProperties() : new Properties();
