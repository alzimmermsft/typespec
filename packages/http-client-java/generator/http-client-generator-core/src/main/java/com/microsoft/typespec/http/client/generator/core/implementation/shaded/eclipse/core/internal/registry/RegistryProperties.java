...
public class RegistryProperties {
	...
	private static String getContextProperty(final String propertyName) {
		...
		try {
			...
			Runnable innerClass = () -> {
				com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.framework.BundleContext bundleContext = (com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.framework.BundleContext) context;
