...
public interface IResourceDelta extends IAdaptable {
    ...
    /**
     * Change constant (bit mask) indicating that the underlying file or folder of the linked resource has been added or
     * removed.
     *
     * @see IResourceDelta#getFlags()
     * @since 3.4
     ...
     * </ul>
     * <ul>
     * <li><code>COPIED_FROM</code> - Change constant (bit mask) indicating that the resource was copied from another
     * location.
