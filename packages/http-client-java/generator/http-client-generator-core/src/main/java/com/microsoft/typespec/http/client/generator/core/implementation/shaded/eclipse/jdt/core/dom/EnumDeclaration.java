...
public class EnumDeclaration extends AbstractTypeDeclaration {
	 ...
	 */
	private final NodeList superInterfaceTypes =
		new NodeList(SUPER_INTERFACE_TYPES_PROPERTY);
	 ...
	 * Defaults to an empty list.
	 */
	private final NodeList enumConstants =
		new NodeList(ENUM_CONSTANTS_PROPERTY);
