...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.env.IBinaryInfo;
...
public class JavaModelCache {
	...
	public static final String RATIO_PROPERTY = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.javamodelcache.ratio"; //$NON-NLS-1$
	public static final String JAR_TYPE_RATIO_PROPERTY = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.javamodelcache.jartyperatio"; //$NON-NLS-1$
