...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi.internal.serviceregistry.ServiceRegistrationImpl.FrameworkHookRegistration;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi.internal.serviceregistry.ServiceUse.ServiceUseLock;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.framework.hooks.service.EventListenerHook;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.framework.hooks.service.FindHook;
...
public class ServiceRegistry {
    ...
    static Map<String, FrameworkHookHolder> createFrameworkHooksMap() {
        ...
        Class<?>[] hookClasses = {
            com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.framework.hooks.bundle.CollisionHook.class, //
    ...
    static class FrameworkHookHolder {
        ...
        void setHooks(List<ServiceRegistrationImpl<?>> hooks) {
            this.hooks = hooks == null || hooks.isEmpty()
    ...
    public ServiceRegistrationImpl<?> registerService(BundleContextImpl context, String[] clazzes, Object service,
        ...
        ServiceRegistrationImpl<?> registration = hookTypes != null
            ? new FrameworkHookRegistration<>(this, context, clazzes, service, systemBundleContext, hookTypes)
    ...
    public void addServiceListener(BundleContextImpl context, ServiceListener listener, String filter)
        ...
        synchronized (serviceEventListeners) {
            CopyOnWriteIdentityMap<ServiceListener, FilteredServiceListener> listeners
                = serviceEventListeners.computeIfAbsent(context, k -> new CopyOnWriteIdentityMap<>());
    ...
    void publishServiceEventPrivileged(final ServiceEvent event) {
        ...
        if (!listenerSnapshot.isEmpty()) {
            Map<BundleContext, Collection<ListenerInfo>> listeners
                = new ShrinkableValueCollectionMap<>(listenerSnapshot);
        ...
        for (Map.Entry<BundleContextImpl, Set<Map.Entry<ServiceListener, FilteredServiceListener>>> entry : listenerSnapshot
            ...
            EventDispatcher<ServiceListener, FilteredServiceListener, ServiceEvent> dispatcher
    ...
    void addServiceRegistration(BundleContextImpl context, ServiceRegistrationImpl<?> registration) {
        ...
        // BundleContextImpl.
        List<ServiceRegistrationImpl<?>> contextServices
            = publishedServicesByContext.computeIfAbsent(context, k -> new ArrayList<>(initialSubCapacity));
        ...
        for (String clazz : registration.getClasses()) {
            List<ServiceRegistrationImpl<?>> services
                = publishedServicesByClass.computeIfAbsent(clazz, k -> new ArrayList<>(initialSubCapacity));
    ...
    static String checkServiceClass(final String[] clazzes, final Object serviceObject) {
        ClassLoader cl = AccessController
            .doPrivileged((PrivilegedAction<ClassLoader>) () -> serviceObject.getClass().getClassLoader());
    ...
    private void notifyEventHooksPrivileged(final ServiceEvent event, final Collection<BundleContext> result) {
        notifyHooksPrivileged(
            com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.framework.hooks.service.EventHook.class,
            "event", //$NON-NLS-1$
