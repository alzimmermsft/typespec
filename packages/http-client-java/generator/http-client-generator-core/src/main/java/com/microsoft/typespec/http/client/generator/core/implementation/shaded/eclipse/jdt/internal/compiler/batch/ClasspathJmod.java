    ...
    public NameEnvironmentAnswer findClass(char[] typeName, String qualifiedPackageName, String moduleName,
        ...
        try {
            qualifiedBinaryFileName
                = new String(CharOperation.append(CLASSES_FOLDER, qualifiedBinaryFileName.toCharArray()));
        ...
        for (Enumeration<? extends ZipEntry> e = this.zipFile.entries(); e.hasMoreElements();) {
            ...
            if (index != -1) {
                ...
                if (CharOperation.equals(CLASSES, folder)) {
                    ...
                    if (fileName.startsWith(qualifiedPackageName)
                        && fileName.length() > qualifiedPackageName.length()) {
