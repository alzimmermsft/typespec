...
@Generated("com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.auto.value.processor.AutoOneOfProcessor")
final class AutoOneOf_JavaInputAstVisitor_AnnotationOrModifier {
  private AutoOneOf_JavaInputAstVisitor_AnnotationOrModifier() {} // There are no instances of this type.
  ...
  private static final class Impl_annotation extends Parent_ {
    ...
    public boolean equals(Object x) {
      if (x instanceof JavaInputAstVisitor.AnnotationOrModifier) {
        JavaInputAstVisitor.AnnotationOrModifier that = (JavaInputAstVisitor.AnnotationOrModifier) x;
