...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Winnetwk.*;
...
public interface Mpr extends StdCallLibrary {
     ...
     * (v=vs.85).aspx
     */
    public int WNetOpenEnum(int dwScope, int dwType, int dwUsage, NETRESOURCE.ByReference lpNETRESOURCE,
     ...
     * (v=vs.85).aspx
     */
    public int WNetUseConnection(HWND hwndOwner, NETRESOURCE lpNETRESOURCE, String lpPassword, String lpUserID,
        int dwFlags, Pointer lpAccessName, IntByReference lpBufferSize, IntByReference lpResult);
     ...
     * parameter can be any combination of the values in ConnectFlag.
     */
    public int WNetAddConnection3(HWND hwndOwner, NETRESOURCE lpNETRESOURCE, String lpPassword, String lpUserID,
        int dwFlags);
