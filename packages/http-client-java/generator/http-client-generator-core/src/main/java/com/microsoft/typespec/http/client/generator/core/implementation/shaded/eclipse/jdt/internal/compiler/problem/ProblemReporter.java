...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.codegen.ConstantPool;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.env.EnumConstantSignature;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.env.IBinaryElementValuePair;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.impl.BooleanConstant;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.impl.IrritantSet;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.impl.StringConstant;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.*;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeConstants.DangerousMethod;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.parser.JavadocTagConstants;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.util.Messages;
...
public class ProblemReporter extends ProblemHandler {
    ...
    // TYPE_ACCESS = 0x0,
    FIELD_ACCESS = 0x4, CONSTRUCTOR_ACCESS = 0x8, METHOD_ACCESS = 0xC;
    ...
    public static int getIrritant(int problemID) {
        switch (problemID) {
            ...
            case IProblem.MissingEnumConstantCaseDespiteDefault:	// this one is further protected by
                                                                	// CompilerOptions.reportMissingEnumCaseDespiteDefault
    ...
    public void abortDueToInternalError(String errorMessage, ASTNode location) {
        ...
        this.handle(IProblem.Unclassified, arguments, arguments,
            ProblemSeverities.Error | ProblemSeverities.Abort | ProblemSeverities.Fatal,
            location == null ? 0 : location.sourceStart, location == null ? 0 : location.sourceEnd);
    }
    ...
    public void abortDueToPreviewEnablingNotAllowed(String sourceLevel, String expectedSourceLevel) {
        ...
        this.handle(IProblem.PreviewFeaturesNotAllowed, args, args,
            ProblemSeverities.Error | ProblemSeverities.Abort | ProblemSeverities.Fatal, 0, 0);
    }
    ...
    public void abortDueToNotSupportedJavaVersion(String notSupportedVersion, String firstSupportedVersion) {
        ...
        this.handle(IProblem.JavaVersionNotSupported, args, args,
            ProblemSeverities.Error | ProblemSeverities.Abort | ProblemSeverities.Fatal, 0, 0);
    }

    public void tooRecentJavaVersion(String notSupportedVersion, String firstSupportedVersion) {
        String[] args = new String[] { notSupportedVersion, firstSupportedVersion };
        this.handle(IProblem.JavaVersionTooRecent, args, args, ProblemSeverities.Warning, 0, 0);
    }
    ...
    public void abstractMethodCannotBeOverridden(SourceTypeBinding type, MethodBinding concreteMethod) {
        ...
        this.handle(
            ...
            new String[] {
                ...
                new String(CharOperation.concat(concreteMethod.declaringClass.readableName(),
                    concreteMethod.readableName(), '.')) },
            new String[] {
                new String(type.sourceName()),
                new String(CharOperation.concat(concreteMethod.declaringClass.shortReadableName(),
    ...
    public void abstractMethodInAbstractClass(SourceTypeBinding type, AbstractMethodDeclaration methodDecl) {
        if (type.isEnum() && type.isLocalType() && type.isAnonymousType()) {
            ...
            this.handle(IProblem.AbstractMethodInEnum, arguments, arguments, methodDecl.sourceStart,
                methodDecl.sourceEnd);
        } else {
            String[] arguments = new String[] { new String(type.sourceName()), new String(methodDecl.selector) };
            this.handle(IProblem.AbstractMethodInAbstractClass, arguments, arguments, methodDecl.sourceStart,
                methodDecl.sourceEnd);
        }
    }
    ...
    public void abstractMethodInConcreteClass(SourceTypeBinding type) {
        if (type.isEnum() && type.isLocalType() && type.isAnonymousType()) {
            ...
            this.handle(IProblem.EnumConstantCannotDefineAbstractMethod, arguments, arguments, decl.sourceStart(),
                decl.sourceEnd());
        } else {
            String[] arguments = new String[] { new String(type.sourceName()) };
            this.handle(IProblem.AbstractMethodsInConcreteClass, arguments, arguments, type.sourceStart(),
                type.sourceEnd());
        }
    }
    ...
    public void abstractMethodMustBeImplemented(SourceTypeBinding type, MethodBinding abstractMethod) {
        if (type.isEnum() && type.isLocalType() && type.isAnonymousType()) {
            ...
            this.handle(
                ...
                // 8.4.3 - Every non-abstract subclass of an abstract type, A, must provide a concrete implementation of
                // all of A's methods.
                ...
                new String[] {
                    ...
                    new String(decl.name), },
                decl.sourceStart(), decl.sourceEnd());
        } else {
            this.handle(
                // Must implement the inherited abstract method %1
                // 8.4.3 - Every non-abstract subclass of an abstract type, A, must provide a concrete implementation of
    ...
    public void abstractMethodMustBeImplemented(SourceTypeBinding type, MethodBinding abstractMethod,
        ...
        this.handle(
            // Must implement the inherited abstract method %1
            // 8.4.3 - Every non-abstract subclass of an abstract type, A, must provide a concrete implementation of all
            // of A's methods.
    ...
    public void abstractMethodNeedingNoBody(AbstractMethodDeclaration method) {
        this.handle(IProblem.BodyForAbstractMethod, NoArgument, NoArgument, method.sourceStart, method.sourceEnd,
            method, method.compilationResult());
    }
    ...
    public void annotationCannotOverrideMethod(MethodBinding overrideMethod, MethodBinding inheritedMethod) {
        ...
        this.handle(IProblem.AnnotationCannotOverrideMethod,
            new String[] {
    ...
    public void annotationCircularity(TypeBinding sourceType, TypeBinding otherType, TypeReference reference) {
        if (TypeBinding.equalsEquals(sourceType, otherType))
            this.handle(IProblem.AnnotationCircularitySelfReference,
                new String[] { new String(sourceType.readableName()) },
                new String[] { new String(sourceType.shortReadableName()) }, reference.sourceStart,
                reference.sourceEnd);
        else
            this.handle(IProblem.AnnotationCircularity,
    ...
    public void annotationMembersCannotHaveParameters(AnnotationMethodDeclaration annotationMethodDeclaration) {
        this.handle(IProblem.AnnotationMembersCannotHaveParameters, NoArgument, NoArgument,
            annotationMethodDeclaration.sourceStart, annotationMethodDeclaration.sourceEnd);
    }

    public void annotationMembersCannotHaveTypeParameters(AnnotationMethodDeclaration annotationMethodDeclaration) {
        this.handle(IProblem.AnnotationMembersCannotHaveTypeParameters, NoArgument, NoArgument,
            annotationMethodDeclaration.sourceStart, annotationMethodDeclaration.sourceEnd);
    }

    public void annotationTypeDeclarationCannotHaveConstructor(ConstructorDeclaration constructorDeclaration) {
        this.handle(IProblem.AnnotationTypeDeclarationCannotHaveConstructor, NoArgument, NoArgument,
            constructorDeclaration.sourceStart, constructorDeclaration.sourceEnd);
    }

    public void annotationTypeDeclarationCannotHaveSuperclass(TypeDeclaration typeDeclaration) {
        this.handle(IProblem.AnnotationTypeDeclarationCannotHaveSuperclass, NoArgument, NoArgument,
    ...
    public void annotationTypeDeclarationCannotHaveSuperinterfaces(TypeDeclaration typeDeclaration) {
        this.handle(IProblem.AnnotationTypeDeclarationCannotHaveSuperinterfaces, NoArgument, NoArgument,
            typeDeclaration.sourceStart, typeDeclaration.sourceEnd);
    }

    public void annotationTypeUsedAsSuperinterface(SourceTypeBinding type, TypeReference superInterfaceRef,
        ReferenceBinding superType) {
        this.handle(IProblem.AnnotationTypeUsedAsSuperInterface,
            ...
            superInterfaceRef.sourceStart, superInterfaceRef.sourceEnd);
    }

    public void annotationValueMustBeAnnotation(TypeBinding annotationType, char[] name, Expression value,
        TypeBinding expectedType) {
        String str = new String(name);
        this.handle(IProblem.AnnotationValueMustBeAnnotation,
    ...
    public void annotationValueMustBeArrayInitializer(TypeBinding annotationType, char[] name, Expression value) {
        String str = new String(name);
        this.handle(IProblem.AnnotationValueMustBeArrayInitializer,
            new String[] { new String(annotationType.readableName()), str },
            new String[] { new String(annotationType.shortReadableName()), str }, value.sourceStart, value.sourceEnd);
    }

    public void annotationValueMustBeClassLiteral(TypeBinding annotationType, char[] name, Expression value) {
        String str = new String(name);
        this.handle(IProblem.AnnotationValueMustBeClassLiteral,
            new String[] { new String(annotationType.readableName()), str },
            new String[] { new String(annotationType.shortReadableName()), str }, value.sourceStart, value.sourceEnd);
    }
    ...
    public void annotationValueMustBeConstant(TypeBinding annotationType, char[] name, Expression value,
        ...
        String str = new String(name);
        if (isEnum) {
            this.handle(IProblem.AnnotationValueMustBeAnEnumConstant,
                new String[] { new String(annotationType.readableName()), str },
                new String[] { new String(annotationType.shortReadableName()), str }, value.sourceStart,
                value.sourceEnd);
        } else {
            this.handle(IProblem.AnnotationValueMustBeConstant,
                new String[] { new String(annotationType.readableName()), str },
                new String[] { new String(annotationType.shortReadableName()), str }, value.sourceStart,
                value.sourceEnd);
        }
    ...
    public void anonymousClassCannotExtendFinalClass(TypeReference reference, TypeBinding type) {
        this.handle(IProblem.AnonymousClassCannotExtendFinalClass, new String[] { new String(type.readableName()) },
            new String[] { new String(type.shortReadableName()) }, reference.sourceStart, reference.sourceEnd);
    }

    public void argumentTypeCannotBeVoid(ASTNode methodDecl, Argument arg) {
        String[] arguments = new String[] { new String(arg.name) };
        this.handle(IProblem.ArgumentTypeCannotBeVoid, arguments, arguments, methodDecl.sourceStart,
            methodDecl.sourceEnd);
    }

    public void argumentTypeCannotBeVoidArray(Argument arg) {
        this.handle(IProblem.CannotAllocateVoidArray, NoArgument, NoArgument, arg.type.sourceStart, arg.type.sourceEnd);
    }
    ...
    public void assignmentHasNoEffect(AbstractVariableDeclaration location, char[] name) {
        ...
        this.handle(IProblem.AssignmentHasNoEffect, arguments, arguments, severity, start, end);
    }
    ...
    public void assignmentHasNoEffect(Assignment location, char[] name) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { new String(name) };
        this.handle(IProblem.AssignmentHasNoEffect, arguments, arguments, severity, location.sourceStart,
            location.sourceEnd);
    }

    public void attemptToReturnNonVoidExpression(ReturnStatement returnStatement, TypeBinding expectedType) {
        this.handle(IProblem.VoidMethodReturnsValue, new String[] { new String(expectedType.readableName()) },
            new String[] { new String(expectedType.shortReadableName()) }, returnStatement.sourceStart,
            returnStatement.sourceEnd);
    }

    public void attemptToReturnVoidValue(ReturnStatement returnStatement) {
        this.handle(IProblem.MethodReturnsVoid, NoArgument, NoArgument, returnStatement.sourceStart,
            returnStatement.sourceEnd);
    }
    ...
    public void autoboxing(Expression expression, TypeBinding originalType, TypeBinding convertedType) {
        if (this.options.getSeverity(CompilerOptions.AutoBoxing) == ProblemSeverities.Ignore)
            return;
        this.handle(originalType.isBaseType() ? IProblem.BoxingConversion : IProblem.UnboxingConversion,
            new String[] { new String(originalType.readableName()), new String(convertedType.readableName()), },
            new String[] {
                new String(originalType.shortReadableName()),
                new String(convertedType.shortReadableName()), },
            expression.sourceStart, expression.sourceEnd);
    }

    public void boundCannotBeArray(ASTNode location, TypeBinding type) {
        this.handle(IProblem.BoundCannotBeArray, new String[] { new String(type.readableName()) },
    ...
    public void boundMustBeAnInterface(ASTNode location, TypeBinding type) {
        this.handle(IProblem.BoundMustBeAnInterface, new String[] { new String(type.readableName()) },
            new String[] { new String(type.shortReadableName()) }, location.sourceStart, location.sourceEnd);
    }
    ...
    public void bytecodeExceeds64KLimit(SwitchStatement switchStatement) {
        ...
        this.handle(IProblem.BytecodeExceeds64KLimitForSwitchTable,
            new String[] { new String(enumType.readableName()) },
            new String[] { new String(enumType.shortReadableName()) },
            ProblemSeverities.Error | ProblemSeverities.Abort | ProblemSeverities.Fatal, switchStatement.sourceStart(),
    ...
    public void bytecodeExceeds64KLimit(MethodBinding method, int start, int end) {
        this.handle(IProblem.BytecodeExceeds64KLimit,
            ...
            ProblemSeverities.Error | ProblemSeverities.Abort | ProblemSeverities.Fatal, start, end);
    }
    ...
    public void operandStackExceeds64KLimit(ASTNode location) {
        this.handle(IProblem.OperandStackExceeds64KLimit, NoArgument, NoArgument,
            ProblemSeverities.Error | ProblemSeverities.Abort | ProblemSeverities.Fatal, location.sourceStart,
            location.sourceEnd);
    }

    public void operandStackSizeInappropriate(ASTNode location) {
        this.handle(IProblem.OperandStackSizeInappropriate, NoArgument, NoArgument, ProblemSeverities.Warning,
            location.sourceStart, location.sourceEnd);
    }
    ...
    public void bytecodeExceeds64KLimit(TypeDeclaration location) {
        this.handle(IProblem.BytecodeExceeds64KLimitForClinit, NoArgument, NoArgument,
            ProblemSeverities.Error | ProblemSeverities.Abort | ProblemSeverities.Fatal, location.sourceStart,
            location.sourceEnd);
    }
    ...
    public void cannotAssignToFinalField(FieldBinding field, ASTNode location) {
        this.handle(IProblem.FinalFieldAssignment,
            new String[] {
    ...
    public void cannotAssignToFinalLocal(LocalVariableBinding local, ASTNode location) {
        ...
        this.handle(problemId, arguments, arguments, nodeSourceStart(local, location), nodeSourceEnd(local, location));
    }

    public void cannotAssignToFinalOuterLocal(LocalVariableBinding local, ASTNode location) {
        String[] arguments = new String[] { new String(local.readableName()) };
        this.handle(IProblem.FinalOuterLocalAssignment, arguments, arguments, nodeSourceStart(local, location),
    ...
    public void cannotDireclyInvokeAbstractMethod(ASTNode invocationSite, MethodBinding method) {
        this.handle(IProblem.DirectInvocationOfAbstractMethod,
            new String[] {
    ...
    public void cannotExtendEnum(SourceTypeBinding type, TypeReference superclass, TypeBinding superTypeBinding) {
        ...
        this.handle(IProblem.CannotExtendEnum, new String[] { superTypeFullName, name },
            new String[] { superTypeShortName, name }, superclass.sourceStart, superclass.sourceEnd);
    }

    public void cannotImportPackage(ImportReference importRef) {
        String[] arguments = new String[] { CharOperation.toString(importRef.tokens) };
        this.handleUntagged(IProblem.CannotImportPackage, arguments, arguments, importRef.sourceStart,
            importRef.sourceEnd);
    }

    public void cannotInstantiate(Expression typeRef, TypeBinding type) {
        this.handle(IProblem.InvalidClassInstantiation, new String[] { new String(type.readableName()) },
            new String[] { new String(type.shortReadableName()) }, typeRef.sourceStart, typeRef.sourceEnd);
    }

    public void cannotInvokeSuperConstructorInEnum(ExplicitConstructorCall constructorCall,
        MethodBinding enumConstructor) {
        this.handle(IProblem.CannotInvokeSuperConstructorInEnum,
            new String[] {
    ...
    public void cannotReadSource(CompilationUnitDeclaration unit, AbortCompilationUnit abortException,
        ...
        if (abortException.exception instanceof CharConversionException) {
            ...
            this.handle(IProblem.InvalidEncoding, arguments, arguments, 0, 0);
            return;
        }
        if (verbose) {
        ...
        String exceptionTrace
            = abortException.exception.getClass().getName() + ':' + abortException.exception.getMessage();
        String[] arguments = new String[] { fileName, exceptionTrace };
        this.handle(IProblem.CannotReadSource, arguments, arguments, 0, 0);
    }

    public void localMustBeEffectivelyFinal(VariableBinding local, ASTNode location, boolean isResource,
        boolean isOuterLocal) {
        String[] arguments = new String[] { new String(local.readableName()) };
        this.handle(
            isResource
                ? IProblem.ResourceLocalMustBeEffectivelyFinal
                : isOuterLocal ? IProblem.OuterLocalMustBeEffectivelyFinal : IProblem.LocalMustBeEffectivelyFinal,
            arguments, arguments, nodeSourceStart(local, location), nodeSourceEnd(local, location));
    }

    public void cannotReferToNonFinalField(VariableBinding local, ASTNode location) {
        String[] arguments = new String[] { new String(local.readableName()) };
        this.handle(IProblem.FieldMustBeFinal, arguments, arguments, nodeSourceStart(local, location),
            nodeSourceEnd(local, location));
    }

    public void cannotReferToNonFinalLocalInGuard(VariableBinding local, ASTNode location) {
        String[] arguments = new String[] { new String(local.readableName()) };
        this.handle(IProblem.LocalReferencedInGuardMustBeEffectivelyFinal, arguments, arguments,
            nodeSourceStart(local, location), nodeSourceEnd(local, location));
    }

    public void cannotReturnInInitializer(ASTNode location) {
        this.handle(IProblem.CannotReturnInInitializer, NoArgument, NoArgument, location.sourceStart,
            location.sourceEnd);
    }

    public void cannotThrowNull(ASTNode expression) {
        this.handle(IProblem.CannotThrowNull, NoArgument, NoArgument, expression.sourceStart, expression.sourceEnd);
    }

    public void cannotThrowType(ASTNode exception, TypeBinding expectedType) {
        this.handle(IProblem.CannotThrowType, new String[] { new String(expectedType.readableName()) },
            new String[] { new String(expectedType.shortReadableName()) }, exception.sourceStart, exception.sourceEnd);
    }
...
// https://bugs.eclipse.org/bugs/show_bug.cgi?id=391092
    public void illegalArrayOfUnionType(char[] identifierName, TypeReference typeReference) {
        this.handle(IProblem.IllegalArrayOfUnionType, NoArgument, NoArgument, typeReference.sourceStart,
            typeReference.sourceEnd);
    }

    public void cannotUseQualifiedEnumConstantInCaseLabel(Reference location, FieldBinding field) {
        this.handle(IProblem.IllegalQualifiedEnumConstantLabel,
    ...
    public void targetTypeIsNotAFunctionalInterface(FunctionalExpression target) {
        this.handle(IProblem.TargetTypeNotAFunctionalInterface, NoArgument, NoArgument, target.sourceStart,
            target.diagnosticsSourceEnd());
    }

    public void illFormedParameterizationOfFunctionalInterface(FunctionalExpression target) {
        this.handle(IProblem.illFormedParameterizationOfFunctionalInterface, NoArgument, NoArgument, target.sourceStart,
            target.diagnosticsSourceEnd());
    }

    public void lambdaSignatureMismatched(LambdaExpression target) {
        this.handle(IProblem.lambdaSignatureMismatched, new String[] { new String(target.descriptor.readableName()) },
            new String[] { new String(target.descriptor.shortReadableName()) }, target.sourceStart,
            target.diagnosticsSourceEnd());
    }

    public void lambdaParameterTypeMismatched(Argument argument, TypeReference type,
        ...
        this.handle(
            expectedParameterType.isTypeVariable()
                ? IProblem.IncompatibleLambdaParameterType
                : IProblem.lambdaParameterTypeMismatched,
            new String[] { name, expectedTypeFullName }, new String[] { name, expectedTypeShortName }, type.sourceStart,
            type.sourceEnd);
    }
    ...
    public void lambdaExpressionCannotImplementGenericMethod(LambdaExpression lambda, MethodBinding sam) {
        ...
        this.handle(IProblem.NoGenericLambda, new String[] { selector, new String(sam.declaringClass.readableName()) },
            new String[] { selector, new String(sam.declaringClass.shortReadableName()) }, lambda.sourceStart,
            lambda.diagnosticsSourceEnd());
    }

    public void missingValueFromLambda(LambdaExpression lambda, TypeBinding returnType) {
        this.handle(IProblem.MissingValueFromLambda, new String[] { new String(returnType.readableName()) },
            new String[] { new String(returnType.shortReadableName()) }, lambda.sourceStart,
            lambda.diagnosticsSourceEnd());
    }

    public void caseExpressionMustBeConstant(Expression expression) {
        this.handle(IProblem.NonConstantExpression, NoArgument, NoArgument, expression.sourceStart,
            expression.sourceEnd);
    }

    public void caseExpressionWrongType(Expression expression, TypeBinding switchBinding, TypeBinding selectorBinding) {
        this.handle(IProblem.WrongCaseType,
            new String[] {
                String.valueOf(switchBinding.readableName()),
                String.valueOf(selectorBinding.readableName()) },
            new String[] {
                String.valueOf(switchBinding.shortReadableName()),
                String.valueOf(selectorBinding.shortReadableName()) },
            expression.sourceStart, expression.sourceEnd);
    }

    public void caseConstantIncompatible(TypeBinding resolvedType, TypeBinding switchType, Expression expression) {
        this.handle(IProblem.IncompatibleCaseType,
            new String[] { String.valueOf(resolvedType.readableName()), String.valueOf(switchType.readableName()) },
            new String[] {
                String.valueOf(resolvedType.shortReadableName()),
                String.valueOf(switchType.shortReadableName()) },
            expression.sourceStart, expression.sourceEnd);
    }

    public void caseDefaultPlusTrueAndFalse(ASTNode location) {
        this.handle(IProblem.DefaultTrueAndFalseCases, NoArgument, NoArgument, location.sourceStart,
            location.sourceEnd);
    }
    ...
    public void classExtendFinalClass(SourceTypeBinding type, TypeReference superclass, TypeBinding superTypeBinding) {
        ...
        if (superTypeShortName.equals(name))
            superTypeShortName = superTypeFullName;
        this.handle(IProblem.ClassExtendFinalClass, new String[] { superTypeFullName, name },
            new String[] { superTypeShortName, name }, superclass.sourceStart, superclass.sourceEnd);
    }
    ...
    public void classExtendFinalRecord(SourceTypeBinding type, TypeReference superclass, TypeBinding superTypeBinding) {
        ...
        if (superTypeShortName.equals(name))
            superTypeShortName = superTypeFullName;
        this.handle(IProblem.ClassExtendFinalRecord, new String[] { superTypeFullName, name },
            new String[] { superTypeShortName, name }, superclass.sourceStart, superclass.sourceEnd);
    }
    ...
    public void erasureIncompatibilityInCanonicalConstructor(TypeReference type) {
        ...
        this.handle(IProblem.RecordErasureIncompatibilityInCanonicalConstructor, arguments, arguments, type.sourceStart,
            type.sourceEnd);
    }
    ...
    public void codeSnippetMissingMethod(String className, String missingMethod, String argumentTypes, int start,
        int end) {
    ...
    public void comparingIdenticalExpressions(Expression comparison) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        this.handle(IProblem.ComparingIdentical, NoArgument, NoArgument, severity, comparison.sourceStart,
    ...
    public void conditionalArgumentsIncompatibleTypes(ConditionalExpression expression, TypeBinding trueType,
    ...
    public void conflictingImport(ImportReference importRef) {
        String[] arguments = new String[] { CharOperation.toString(importRef.tokens) };
        this.handleUntagged(IProblem.ConflictingImport, arguments, arguments, importRef.sourceStart,
            importRef.sourceEnd);
    }
    ...
    public void constantOutOfRange(Literal literal, TypeBinding literalType) {
        ...
        this.handle(IProblem.NumericValueOutOfRange, arguments, arguments, literal.sourceStart, literal.sourceEnd);
    }

    public void corruptedSignature(TypeBinding enclosingType, char[] signature, int position) {
        this.handle(IProblem.CorruptedSignature,
    ...
    public void defaultMethodOverridesObjectMethod(MethodBinding currentMethod) {
        ...
        this.handle(IProblem.DefaultMethodOverridesObjectMethod, NoArgument, NoArgument, sourceStart, sourceEnd);
    }

    public void defaultModifierIllegallySpecified(int sourceStart, int sourceEnd) {
        this.handle(IProblem.IllegalDefaultModifierSpecification, NoArgument, NoArgument, sourceStart, sourceEnd);
    }
    ...
    public void deprecatedField(final FieldBinding field, ASTNode location) {
        ...
        if (sinceValue != null) {
            this.handle(
                (field.tagBits & TagBits.AnnotationTerminallyDeprecated) == 0
                    ? IProblem.UsingDeprecatedSinceVersionField
                    : IProblem.UsingTerminallyDeprecatedSinceVersionField,
            ...
            this.handle(
                (field.tagBits & TagBits.AnnotationTerminallyDeprecated) == 0
                    ...
                    : IProblem.UsingTerminallyDeprecatedField,
                new String[] { new String(field.declaringClass.readableName()), fieldName },
                new String[] { new String(field.declaringClass.shortReadableName()), fieldName }, sourceStart,
                sourceEnd);
        }
    }
    ...
    public void deprecatedMethod(final MethodBinding method, ASTNode location) {
        ...
        if (sinceValue != null) {
            if (isConstructor) {
                this.handle(
                    terminally
                        ? IProblem.UsingTerminallyDeprecatedSinceVersionConstructor
                        : IProblem.UsingDeprecatedSinceVersionConstructor,
                    new String[] { readableClassName, signature, sinceValue },
                    new String[] { shortReadableClassName, shortSignature, sinceValue }, sourceStart, sourceEnd);
            } else {
                this.handle(
                    terminally
                        ? IProblem.UsingTerminallyDeprecatedSinceVersionMethod
                        : IProblem.UsingDeprecatedSinceVersionMethod,
                    new String[] { readableClassName, selector, signature, sinceValue },
                    new String[] { shortReadableClassName, selector, shortSignature, sinceValue }, sourceStart,
                    sourceEnd);
            }
        } else {
            if (isConstructor) {
                this.handle(
                    ...
                    new String[] { shortReadableClassName, shortSignature }, sourceStart, sourceEnd);
            } else {
                this.handle(terminally ? IProblem.UsingTerminallyDeprecatedMethod : IProblem.UsingDeprecatedMethod,
                    new String[] { readableClassName, selector, signature },
                    new String[] { shortReadableClassName, selector, shortSignature }, sourceStart, sourceEnd);
            }
        }
    }
...
// a deprecated type in a qualified reference (see bug 292510)
    public void deprecatedType(TypeBinding type, ASTNode location, int index) {
        ...
        String sinceValue
            = deprecatedSinceValue(() -> leafType.getAnnotations(ExtendedTagBits.DeprecatedAnnotationResolved));
        if (sinceValue != null) {
            this.handle(
                ((leafType.tagBits & TagBits.AnnotationTerminallyDeprecated) == 0)
                    ? IProblem.UsingDeprecatedSinceVersionType
                    : IProblem.UsingTerminallyDeprecatedSinceVersionType,
                new String[] { new String(leafType.readableName()), sinceValue },
                new String[] { new String(leafType.shortReadableName()), sinceValue },
                (sourceStart == -1) ? location.sourceStart : sourceStart, nodeSourceEnd(null, location, index));
        } else {
            this.handle(
                ((leafType.tagBits & TagBits.AnnotationTerminallyDeprecated) == 0)
                    ? IProblem.UsingDeprecatedType
                    : IProblem.UsingTerminallyDeprecatedType,
    ...
    public void deprecatedModule(ModuleReference moduleReference, ModuleBinding requiredModule) {
        ...
        if (sinceValue != null) {
            ...
            handle(
                isTerminally
                    ? IProblem.UsingTerminallyDeprecatedSinceVersionModule
                    : IProblem.UsingDeprecatedSinceVersionModule,
                args, args, moduleReference.sourceStart, moduleReference.sourceEnd);
        } else {
            String[] args = { String.valueOf(requiredModule.name()) };
            handle(isTerminally ? IProblem.UsingTerminallyDeprecatedModule : IProblem.UsingDeprecatedModule, args, args,
                moduleReference.sourceStart, moduleReference.sourceEnd);
        }
    }
                ...
                for (AnnotationBinding annotationBinding : annotations.get()) {
                    ...
                    if (annotationBinding.getAnnotationType().id == TypeIds.T_JavaLangDeprecated) {
                        for (ElementValuePair elementValuePair : annotationBinding.getElementValuePairs()) {
                            if (CharOperation.equals(elementValuePair.getName(), TypeConstants.SINCE)
    ...
    public void disallowedTargetForAnnotation(Annotation annotation) {
        this.handle(IProblem.DisallowedTargetForAnnotation,
            new String[] { new String(annotation.resolvedType.readableName()) },
            new String[] { new String(annotation.resolvedType.shortReadableName()) }, annotation.sourceStart,
            annotation.sourceEnd);
    }

    public void explitAnnotationTargetRequired(Annotation annotation) {
        this.handle(IProblem.ExplicitAnnotationTargetRequired, NoArgument, NoArgument, annotation.sourceStart,
            annotation.sourceEnd);
    }

    public void duplicateAnnotation(Annotation annotation, long sourceLevel) {
        this.handle(IProblem.DuplicateAnnotationNotMarkedRepeatable,
            new String[] { new String(annotation.resolvedType.readableName()) },
            new String[] { new String(annotation.resolvedType.shortReadableName()) }, annotation.sourceStart,
            annotation.sourceEnd);
    }
    ...
    public void duplicateAnnotationValue(TypeBinding annotationType, MemberValuePair memberValuePair) {
        ...
        this.handle(IProblem.DuplicateAnnotationMember,
            new String[] { name, new String(annotationType.readableName()) },
            new String[] { name, new String(annotationType.shortReadableName()) }, memberValuePair.sourceStart,
            memberValuePair.sourceEnd);
    }

    public void duplicateBounds(ASTNode location, TypeBinding type) {
        this.handle(IProblem.DuplicateBounds, new String[] { new String(type.readableName()) },
            new String[] { new String(type.shortReadableName()) }, location.sourceStart, location.sourceEnd);
    }

    public void duplicateCase(Statement caseStatement) {
        this.handle(IProblem.DuplicateCase, NoArgument, NoArgument, caseStatement.sourceStart, caseStatement.sourceEnd);
    }
    ...
    public void duplicateEnumSpecialMethod(SourceTypeBinding type, AbstractMethodDeclaration methodDecl) {
        ...
        this.handle(IProblem.CannotDeclareEnumSpecialMethod,
            new String[] {
    ...
    public void duplicateFieldInType(SourceTypeBinding type, AbstractVariableDeclaration variableDeclaration) {
        this.handle(IProblem.DuplicateField,
    ...
    public void duplicateImport(ImportReference importRef) {
        String[] arguments = new String[] { CharOperation.toString(importRef.tokens) };
        this.handleUntagged(IProblem.DuplicateImport, arguments, arguments, importRef.sourceStart, importRef.sourceEnd);
    }

    public void duplicateInheritedMethods(SourceTypeBinding type, MethodBinding inheritedMethod1,
        MethodBinding inheritedMethod2, boolean isJava8) {
        ...
        this.handle(IProblem.DuplicateParameterizedMethods,
            new String[] {
                new String(inheritedMethod1.selector),
                new String(inheritedMethod1.declaringClass.readableName()),
                typesAsString(inheritedMethod1, inheritedMethod1.original().parameters, false),
    ...
    public void duplicateInitializationOfBlankFinalField(FieldBinding field, Reference reference) {
        ...
        this.handle(IProblem.DuplicateBlankFinalFieldInitialization, arguments, arguments,
            nodeSourceStart(field, reference), nodeSourceEnd(field, reference));
    }

    public void duplicateInitializationOfFinalLocal(LocalVariableBinding local, ASTNode location) {
        int problemId = local.isPatternVariable()
            ? IProblem.PatternVariableRedefined
    ...
    public void illegalRedeclarationOfPatternVar(LocalVariableBinding local, ASTNode location) {
        this.handle(IProblem.PatternVariableRedeclared, NoArgument, NoArgument, nodeSourceStart(local, location),
            nodeSourceEnd(local, location));
    }

    public void expressionTypeCannotBeSubtypeOfPatternType(ASTNode location) {
        this.handle(IProblem.PatternSubtypeOfExpression,  // ass backwards naming of API constant :-(
            NoArgument, NoArgument, location.sourceStart, location.sourceEnd);
    }

    public void duplicateMethodInType(AbstractMethodDeclaration methodDecl, boolean equalParameters, int severity) {
        MethodBinding method = methodDecl.binding;
        if (equalParameters) {
            this.handle(IProblem.DuplicateMethod,
                new String[] {
                    new String(methodDecl.selector),
                    new String(method.declaringClass.readableName()),
                    typesAsString(method, false) },
                new String[] {
                    ...
                    new String(method.declaringClass.shortReadableName()),
                    typesAsString(method, true) },
                severity, methodDecl.sourceStart, methodDecl.sourceEnd);
        } else {
            this.handle(IProblem.DuplicateMethodErasure,
                new String[] {
                    new String(methodDecl.selector),
                    new String(method.declaringClass.readableName()),
                    typesAsString(method, false) },
    ...
    public void duplicateModifierForField(ReferenceBinding type, FieldDeclaration fieldDecl) {
        ...
        this.handle(IProblem.DuplicateModifierForField, arguments, arguments, fieldDecl.sourceStart,
            fieldDecl.sourceEnd);
    }
    ...
    public void duplicateModifierForVariable(AbstractVariableDeclaration localDecl, boolean complainForArgument) {
        ...
        this.handle(complainForArgument ? IProblem.DuplicateModifierForArgument : IProblem.DuplicateModifierForVariable,
            arguments, arguments, localDecl.sourceStart, localDecl.sourceEnd);
    }
    ...
    public void duplicateSuperinterface(SourceTypeBinding type, TypeReference reference, ReferenceBinding superType) {
        this.handle(IProblem.DuplicateSuperInterface,
            new String[] { new String(superType.readableName()), new String(type.sourceName()) },
            new String[] { new String(superType.shortReadableName()), new String(type.sourceName()) },
            reference.sourceStart, reference.sourceEnd);
    }
    ...
    public void duplicateTargetInTargetAnnotation(TypeBinding annotationType, NameReference reference) {
        ...
        this.handle(IProblem.DuplicateTargetInTargetAnnotation,
            new String[] { name, new String(annotationType.readableName()) },
            new String[] { name, new String(annotationType.shortReadableName()) }, nodeSourceStart(field, reference),
            nodeSourceEnd(field, reference));
    }

    public void duplicateTypeParameterInType(TypeParameter typeParameter) {
        this.handle(IProblem.DuplicateTypeVariable, new String[] { new String(typeParameter.name) },
            new String[] { new String(typeParameter.name) }, typeParameter.sourceStart, typeParameter.sourceEnd);
    }
    ...
    public void duplicateTypes(CompilationUnitDeclaration compUnitDecl, TypeDeclaration typeDecl) {
        ...
        this.handle(IProblem.DuplicateTypes, arguments, arguments, typeDecl.sourceStart, end,
            compUnitDecl.compilationResult);
    }

    public void emptyControlFlowStatement(int sourceStart, int sourceEnd) {
        this.handle(IProblem.EmptyControlFlowStatement, NoArgument, NoArgument, sourceStart, sourceEnd);
    }
    ...
    public void enumConstantMustImplementAbstractMethod(AbstractMethodDeclaration method, FieldDeclaration field) {
        MethodBinding abstractMethod = method.binding;
        this.handle(IProblem.EnumConstantMustImplementAbstractMethod,
            new String[] {
                new String(abstractMethod.selector),
                typesAsString(abstractMethod, false),
            ...
            new String[] {
                ...
                typesAsString(abstractMethod, true),
                new String(field.name), },
            field.sourceStart(), field.sourceEnd());
    }

    public void enumConstantsCannotBeSurroundedByParenthesis(Expression expression) {
        this.handle(IProblem.EnumConstantsCannotBeSurroundedByParenthesis, NoArgument, NoArgument,
            expression.sourceStart, expression.sourceEnd);
    }

    public void enumStaticFieldUsedDuringInitialization(FieldBinding field, ASTNode location) {
        this.handle(IProblem.EnumStaticFieldInInInitializerContext,
    ...
    public void enumSwitchCannotTargetField(Reference reference, FieldBinding field) {
        this.handle(IProblem.EnumSwitchCannotTargetField,
            new String[] { String.valueOf(field.declaringClass.readableName()), String.valueOf(field.name) },
            new String[] { String.valueOf(field.declaringClass.shortReadableName()), String.valueOf(field.name) },
            nodeSourceStart(field, reference), nodeSourceEnd(field, reference));
    }
    ...
    public void errorNoMethodFor(Expression expression, TypeBinding recType, char[] selector, TypeBinding[] params) {
        ...
        int id = recType.isArrayType() ? IProblem.NoMessageSendOnArrayType : IProblem.NoMessageSendOnBaseType;
        this.handle(id, new String[] { new String(recType.readableName()), new String(selector), buffer.toString() },
    ...
    public void errorNoSuperInInterface(ASTNode reference) {
        this.handle(IProblem.NoSuperInInterfaceContext, NoArgument, NoArgument, reference.sourceStart,
            reference.sourceEnd);
    }

    public void expressionShouldBeAVariable(Expression expression) {
        this.handle(IProblem.ExpressionShouldBeAVariable, NoArgument, NoArgument, expression.sourceStart,
            expression.sourceEnd);
    }
    ...
    public void fakeReachable(ASTNode location) {
        ...
        this.handle(IProblem.DeadCode, NoArgument, NoArgument, sourceStart, sourceEnd);
    }
    ...
    public void fieldHiding(FieldDeclaration fieldDecl, Binding hiddenVariable) {
        ...
        if (CharOperation.equals(TypeConstants.SERIALVERSIONUID, field.name)
            ...
            if (referenceBinding != null) {
                if (referenceBinding.findSuperTypeOriginatingFrom(TypeIds.T_JavaIoSerializable,
                    false /* Serializable is not a class */) != null) {
                    return; // do not report field hiding for serialVersionUID field for class that implements
                            // Serializable
                }
            }
        }
        if (CharOperation.equals(TypeConstants.SERIALPERSISTENTFIELDS, field.name)
            ...
            && CharOperation.equals(TypeConstants.CharArray_JAVA_IO_OBJECTSTREAMFIELD,
                field.type.leafComponentType().readableName())) {
            ReferenceBinding referenceBinding = field.declaringClass;
            if (referenceBinding != null) {
                if (referenceBinding.findSuperTypeOriginatingFrom(TypeIds.T_JavaIoSerializable,
                    false /* Serializable is not a class */) != null) {
                    return; // do not report field hiding for serialPersistenFields field for class that implements
                            // Serializable
                }
            }
        }
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        if (isLocal) {
            this.handle(IProblem.FieldHidingLocalVariable,
                new String[] { new String(field.declaringClass.readableName()), new String(field.name) },
                new String[] { new String(field.declaringClass.shortReadableName()), new String(field.name) }, severity,
                nodeSourceStart(hiddenVariable, fieldDecl), nodeSourceEnd(hiddenVariable, fieldDecl));
        } else if (hiddenVariable instanceof FieldBinding) {
            FieldBinding hiddenField = (FieldBinding) hiddenVariable;
            this.handle(IProblem.FieldHidingField,
                new String[] {
                    new String(field.declaringClass.readableName()),
                    new String(field.name),
                    new String(hiddenField.declaringClass.readableName()) },
                new String[] {
                    new String(field.declaringClass.shortReadableName()),
                    new String(field.name),
                    new String(hiddenField.declaringClass.shortReadableName()) },
                severity, nodeSourceStart(hiddenField, fieldDecl), nodeSourceEnd(hiddenField, fieldDecl));
        }
    }

    public void fieldsOrThisBeforeConstructorInvocation(ASTNode reference) {
        this.handle(IProblem.ThisSuperDuringConstructorInvocation, NoArgument, NoArgument, reference.sourceStart,
            reference instanceof LambdaExpression
                ? ((LambdaExpression) reference).diagnosticsSourceEnd()
                : reference.sourceEnd);
    }

    public void finallyMustCompleteNormally(Block finallyBlock) {
        this.handle(IProblem.FinallyMustCompleteNormally, NoArgument, NoArgument, finallyBlock.sourceStart,
    ...
    public void finalVariableBound(TypeVariableBinding typeVariable, TypeReference typeRef) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        this.handle(IProblem.FinalBoundForTypeVariable,
            ...
            new String[] {
                ...
                new String(typeRef.resolvedType.shortReadableName()) },
            severity, typeRef.sourceStart, typeRef.sourceEnd);
    }
    ...
    public void forbiddenReference(FieldBinding field, ASTNode location, byte classpathEntryType,
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        this.handle(problemId, new String[] { new String(field.readableName()) }, // distinct from msg arg for quickfix
                                                                                  // purpose
            ...
            new String[] {
                ...
                new String(field.shortReadableName()),
                new String(field.declaringClass.shortReadableName()) },
            severity, nodeSourceStart(field, location), nodeSourceEnd(field, location));
    }
     ...
     * {@link AccessRestriction#LIBRARY}, {@link AccessRestriction#PROJECT}
     */
    public void forbiddenReference(MethodBinding method, InvocationSite location, byte classpathEntryType,
        String classpathEntryName, int problemId) {
        int severity = computeSeverity(problemId);
        if (severity == ProblemSeverities.Ignore)
            return;
        if (method.isConstructor())
            this.handle(problemId, new String[] { new String(method.readableName()) }, // distinct from msg arg for
                                                                                       // quickfix purpose
                getElaborationId(IProblem.ForbiddenReference, (byte) (CONSTRUCTOR_ACCESS | classpathEntryType)),
                new String[] { classpathEntryName, new String(method.shortReadableName()) }, severity,
                location.nameSourceStart(), location.nameSourceEnd());
        else
            this.handle(problemId, new String[] { new String(method.readableName()) }, // distinct from msg arg for
                                                                                       // quickfix purpose
                ...
                new String[] {
                    ...
                    new String(method.declaringClass.shortReadableName()) },
                severity, location.nameSourceStart(), location.nameSourceEnd());
    }
    ...
    public void forbiddenReference(TypeBinding type, ASTNode location, byte classpathEntryType,
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        this.handle(problemId, new String[] { new String(type.readableName()) }, // distinct from msg arg for quickfix
                                                                                 // purpose
            getElaborationId(IProblem.ForbiddenReference, /* TYPE_ACCESS | */ classpathEntryType), // TYPE_ACCESS values
                                                                                                   // to 0
            new String[] { classpathEntryName, new String(type.shortReadableName()) }, severity, location.sourceStart,
            location.sourceEnd);
    }
    ...
    public void forwardTypeVariableReference(ASTNode location, TypeVariableBinding type) {
        this.handle(IProblem.ReferenceToForwardTypeVariable, new String[] { new String(type.readableName()) },
            new String[] { new String(type.shortReadableName()) }, location.sourceStart, location.sourceEnd);
    }
    ...
    public void genericTypeCannotExtendThrowable(TypeDeclaration typeDecl) {
        ...
        this.handle(IProblem.GenericTypeCannotExtendThrowable,
            new String[] { new String(typeDecl.binding.readableName()) },
            new String[] { new String(typeDecl.binding.shortReadableName()) }, location.sourceStart,
            location.sourceEnd);
    }
...
// as arguments
    private void handle(int problemId, String[] problemArguments, int elaborationId, String[] messageArguments,
        int severity, int problemStartPosition, int problemEndPosition) {
        this.handle(problemId, problemArguments, elaborationId, messageArguments, severity, problemStartPosition,
            problemEndPosition, this.referenceContext,
...
// reference context. Otherwise, use the other API taking a problem and a compilation result
// as arguments
    private void handle(int problemId, String[] problemArguments, String[] messageArguments, int severity,
        int problemStartPosition, int problemEndPosition) {

        this.handle(problemId, problemArguments, 0, // no elaboration
            messageArguments, severity, problemStartPosition, problemEndPosition);
    }

    protected void handleUntagged(int problemId, String[] problemArguments, String[] messageArguments,
        int problemStartPosition, int problemEndPosition) {
    ...
    public void hiddenCatchBlock(ReferenceBinding exceptionType, ASTNode location) {
        this.handle(IProblem.MaskedCatch, new String[] { new String(exceptionType.readableName()), },
            new String[] { new String(exceptionType.shortReadableName()), }, location.sourceStart, location.sourceEnd);
    }

    public void hierarchyCircularity(SourceTypeBinding sourceType, ReferenceBinding superType,
        ...
        if (TypeBinding.equalsEquals(sourceType, superType))
            this.handle(IProblem.HierarchyCircularitySelfReference,
                new String[] { new String(sourceType.readableName()) },
                new String[] { new String(sourceType.shortReadableName()) }, start, end);
        else
            this.handle(IProblem.HierarchyCircularity,
    ...
    public void hierarchyCircularity(TypeVariableBinding type, ReferenceBinding superType, TypeReference reference) {
        ...
        if (TypeBinding.equalsEquals(type, superType))
            this.handle(IProblem.HierarchyCircularitySelfReference, new String[] { new String(type.readableName()) },
                new String[] { new String(type.shortReadableName()) }, start, end);
        else
            this.handle(IProblem.HierarchyCircularity,
                new String[] { new String(type.readableName()), new String(superType.readableName()) },
                new String[] { new String(type.shortReadableName()), new String(superType.shortReadableName()) }, start,
                end);
    }
    ...
    public void illegalAbstractModifierCombinationForMethod(AbstractMethodDeclaration methodDecl) {
        ...
        this.handle(IProblem.IllegalStrictfpForAbstractInterfaceMethod, arguments, arguments, methodDecl.sourceStart,
            methodDecl.sourceEnd);
    }
    ...
    public void illegalAccessFromTypeVariable(TypeVariableBinding variable, ASTNode location) {
        if ((location.bits & ASTNode.InsideJavadoc) != 0) {
            ...
            this.handle(IProblem.IllegalAccessFromTypeVariable, arguments, arguments, location.sourceStart,
                location.sourceEnd);
        }
    }
    ...
    public void illegalClassLiteralForTypeVariable(TypeVariableBinding variable, ASTNode location) {
        String[] arguments = new String[] { new String(variable.sourceName) };
        this.handle(IProblem.IllegalClassLiteralForTypeVariable, arguments, arguments, location.sourceStart,
            location.sourceEnd);
    }

    public void discouragedExtendedDimensions(AnnotationMethodDeclaration annotationTypeMemberDeclaration) {
        this.handle(IProblem.IllegalExtendedDimensions, NoArgument, NoArgument,
            annotationTypeMemberDeclaration.sourceStart, annotationTypeMemberDeclaration.sourceEnd);
    }

    public void illegalExtendedDimensions(AbstractVariableDeclaration aVarDecl) {
        this.handle(IProblem.IllegalExtendedDimensionsForVarArgs, NoArgument, NoArgument, aVarDecl.sourceStart,
            aVarDecl.sourceEnd);
    }

    public void illegalGenericArray(TypeBinding leafComponentType, ASTNode location) {
        this.handle(IProblem.IllegalGenericArray, new String[] { new String(leafComponentType.readableName()) },
            new String[] { new String(leafComponentType.shortReadableName()) }, location.sourceStart,
            location.sourceEnd);
    }
    ...
    public void illegalInstanceOfGenericType(TypeBinding checkedType, ASTNode location) {
        ...
        if (checkedType.leafComponentType().isTypeVariable()) {
            this.handle(IProblem.IllegalInstanceofTypeParameter,
                new String[] { new String(checkedType.readableName()), recommendedForm, },
                new String[] { new String(checkedType.shortReadableName()), recommendedForm, }, location.sourceStart,
                location.sourceEnd);
            return;
        }
        this.handle(IProblem.IllegalInstanceofParameterizedType,
            new String[] { new String(checkedType.readableName()), recommendedForm, },
            new String[] { new String(checkedType.shortReadableName()), recommendedForm, }, location.sourceStart,
            location.sourceEnd);
    }
    ...
    public void illegalModifierCombinationFinalAbstractForClass(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.IllegalModifierCombinationFinalAbstractForClass, arguments, arguments, type.sourceStart(),
            type.sourceEnd());
    }
    ...
    public void illegalModifierCombinationFinalVolatileForField(ReferenceBinding type, FieldDeclaration fieldDecl) {
        ...
        this.handle(IProblem.IllegalModifierCombinationFinalVolatileForField, arguments, arguments,
    ...
    public void illegalModifierCombinationForInterfaceMethod(AbstractMethodDeclaration methodDecl) {
        String[] arguments = new String[] { new String(methodDecl.selector) };
        this.handle(IProblem.IllegalModifierCombinationForInterfaceMethod, arguments, arguments, methodDecl.sourceStart,
            methodDecl.sourceEnd);
    }

    public void illegalModifierCombinationForPrivateInterfaceMethod(AbstractMethodDeclaration methodDecl) {
        String[] arguments = new String[] { new String(methodDecl.selector) };
        this.handle(IProblem.IllegalModifierCombinationForPrivateInterfaceMethod9, arguments, arguments,
            methodDecl.sourceStart, methodDecl.sourceEnd);
    }

    public void illegalModifierForAnnotationField(FieldDeclaration fieldDecl) {
        String name = new String(fieldDecl.name);
        this.handle(IProblem.IllegalModifierForAnnotationField,
    ...
    public void illegalModifierForAnnotationMember(AbstractMethodDeclaration methodDecl) {
        this.handle(IProblem.IllegalModifierForAnnotationMethod,
            new String[] {
    ...
    public void illegalModifierForAnnotationMemberType(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.IllegalModifierForAnnotationMemberType, arguments, arguments, type.sourceStart(),
            type.sourceEnd());
    }

    public void illegalModifierForAnnotationType(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.IllegalModifierForAnnotationType, arguments, arguments, type.sourceStart(),
            type.sourceEnd());
    }
    ...
    public void illegalModifierForModule(ModuleDeclaration module) {
        ...
        this.handle(IProblem.IllegalModifierForModule, arguments, arguments, module.sourceStart(), module.sourceEnd());
    }

    public void illegalModifierForEnum(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.IllegalModifierForEnum, arguments, arguments, type.sourceStart(), type.sourceEnd());
    }

    public void illegalModifierForEnumConstant(ReferenceBinding type, FieldDeclaration fieldDecl) {
        String[] arguments = new String[] { new String(fieldDecl.name) };
        this.handle(IProblem.IllegalModifierForEnumConstant, arguments, arguments, fieldDecl.sourceStart,
            fieldDecl.sourceEnd);
    }

    public void illegalModifierForEnumConstructor(AbstractMethodDeclaration constructor) {
        this.handle(IProblem.IllegalModifierForEnumConstructor, NoArgument, NoArgument, constructor.sourceStart,
    ...
    public void illegalModifierForInterfaceField(FieldDeclaration fieldDecl) {
        String name = new String(fieldDecl.name);
        this.handle(IProblem.IllegalModifierForInterfaceField,
            new String[] { new String(fieldDecl.binding.declaringClass.readableName()), name, },
            new String[] { new String(fieldDecl.binding.declaringClass.shortReadableName()), name, },
            fieldDecl.sourceStart, fieldDecl.sourceEnd);
    }
    ...
    public void illegalModifierForInterfaceMethod(AbstractMethodDeclaration methodDecl, long level) {
        ...
        int problem = level < ClassFileConstants.JDK9
            ? IProblem.IllegalModifierForInterfaceMethod18
            : IProblem.IllegalModifierForInterfaceMethod9;
        // cannot include parameter types since they are not resolved yet
        // and the error message would be too long
        this.handle(problem, new String[] { new String(methodDecl.selector) },
            new String[] { new String(methodDecl.selector) }, methodDecl.sourceStart, methodDecl.sourceEnd);
    }
    ...
    public void illegalModifierForMemberEnum(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.IllegalModifierForMemberEnum, arguments, arguments, type.sourceStart(), type.sourceEnd());
    }

    public void illegalModifierForMemberInterface(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.IllegalModifierForMemberInterface, arguments, arguments, type.sourceStart(),
            type.sourceEnd());
    }
    ...
    public void illegalModifierForMethod(AbstractMethodDeclaration methodDecl) {
        ...
        this.handle(
            ...
            new String[] { new String(methodDecl.selector) }, new String[] { new String(methodDecl.selector) },
            methodDecl.sourceStart, methodDecl.sourceEnd);
    }
    ...
    public void illegalModifierForVariable(AbstractVariableDeclaration localDecl, boolean complainAsArgument) {
        ...
        int problemId = localDecl.getBinding().isPatternVariable()
            ...
            : (complainAsArgument ? IProblem.IllegalModifierForArgument : IProblem.IllegalModifierForVariable);
    ...
    public void illegalPrimitiveOrArrayTypeForEnclosingInstance(TypeBinding enclosingType, ASTNode location) {
        this.handle(IProblem.IllegalPrimitiveOrArrayTypeForEnclosingInstance,
            ...
            new String[] { new String(enclosingType.shortReadableName()) }, location.sourceStart, location.sourceEnd);
    }

    public void illegalQualifiedParameterizedTypeAllocation(TypeReference qualifiedTypeReference,
        TypeBinding allocatedType) {
        this.handle(IProblem.IllegalQualifiedParameterizedTypeAllocation,
            new String[] {
                new String(allocatedType.readableName()),
                new String(allocatedType.enclosingType().readableName()), },
            new String[] {
                new String(allocatedType.shortReadableName()),
                new String(allocatedType.enclosingType().shortReadableName()), },
            qualifiedTypeReference.sourceStart, qualifiedTypeReference.sourceEnd);
    }

    public void illegalStaticModifierForMemberType(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.IllegalStaticModifierForMemberType, arguments, arguments, type.sourceStart(),
            type.sourceEnd());
    }
    ...
    public void illegalUsageOfQualifiedTypeReference(QualifiedTypeReference qualifiedTypeReference) {
        ...
        this.handle(IProblem.IllegalUsageOfQualifiedTypeReference, arguments, arguments,
            qualifiedTypeReference.sourceStart, qualifiedTypeReference.sourceEnd);
    }

    public void illegalUsageOfWildcard(TypeReference wildcard) {
        this.handle(IProblem.InvalidUsageOfWildcard, NoArgument, NoArgument, wildcard.sourceStart, wildcard.sourceEnd);
    }

    public void illegalVararg(AbstractVariableDeclaration argType, AbstractMethodDeclaration methodDecl) {
        String[] arguments
            = new String[] { CharOperation.toString(argType.type.getTypeName()), new String(methodDecl.selector) };
        this.handle(IProblem.IllegalVararg, arguments, arguments, argType.sourceStart, argType.sourceEnd);
    }
    ...
    public void illegalVarargInLambda(Argument argType) {
        ...
        this.handle(IProblem.IllegalVarargInLambda, arguments, arguments, argType.sourceStart, argType.sourceEnd);
    }

    public void illegalThisDeclaration(AbstractVariableDeclaration argument) {
        String[] arguments = NoArgument;
        this.handle(IProblem.IllegalDeclarationOfThisParameter, arguments, arguments, argument.sourceStart,
            argument.sourceEnd);
    }

    public void disallowedThisParameter(Receiver receiver) {
        String[] arguments = NoArgument;
        this.handle(IProblem.DisallowedExplicitThisParameter, arguments, arguments, receiver.sourceStart,
            receiver.sourceEnd);
    }
    ...
    public void illegalQualifierForExplicitThis(Receiver receiver, TypeBinding expectedType) {
        ...
        this.handle(IProblem.IllegalQualifierForExplicitThis, problemArguments, problemArguments,
    ...
    public void illegalQualifierForExplicitThis2(Receiver receiver) {
        this.handle(IProblem.IllegalQualifierForExplicitThis2, NoArgument, NoArgument,
            receiver.qualifyingName.sourceStart, receiver.sourceEnd);
    }

    public void illegalTypeForExplicitThis(Receiver receiver, TypeBinding expectedType) {
        this.handle(IProblem.IllegalTypeForExplicitThis, new String[] { new String(expectedType.readableName()) },
            new String[] { new String(expectedType.shortReadableName()) }, receiver.type.sourceStart,
            receiver.type.sourceEnd);
    }

    public void illegalThis(Argument argument) {
        String[] arguments = NoArgument;
        this.handle(IProblem.ExplicitThisParameterNotInLambda, arguments, arguments, argument.sourceStart,
            argument.sourceEnd);
    }
    ...
    public void illegalModifierCombinationForType(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.IllegalModifierCombinationForType, arguments, arguments, type.sourceStart(),
            type.sourceEnd());
    }

    public void illegalVisibilityModifierCombinationForMemberType(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.IllegalVisibilityModifierCombinationForMemberType, arguments, arguments,
            type.sourceStart(), type.sourceEnd());
    }
    ...
    public void illegalVisibilityModifierCombinationForMethod(ReferenceBinding type,
        AbstractMethodDeclaration methodDecl) {
        String[] arguments = new String[] { new String(type.sourceName()), new String(methodDecl.selector) };
        this.handle(IProblem.IllegalVisibilityModifierCombinationForMethod, arguments, arguments,
            methodDecl.sourceStart, methodDecl.sourceEnd);
    }

    public void illegalVisibilityModifierForInterfaceMemberType(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.IllegalVisibilityModifierForInterfaceMemberType, arguments, arguments, type.sourceStart(),
            type.sourceEnd());
    }
    ...
    public void importProblem(ImportReference importRef, Binding expectedImport) {
        if ((importRef.modifiers & ClassFileConstants.AccModule) != 0 && expectedImport == null) {
            String[] arguments = new String[] { CharOperation.toString(importRef.tokens) };
            this.handleUntagged(IProblem.ImportNotFound, arguments, arguments, importRef.sourceStart,
                importRef.sourceEnd);
            return;
        }
        if (expectedImport instanceof FieldBinding) {
            ...
            switch (expectedImport.problemId()) {
                ...
                case ProblemReasons.NotAccessible:
                    id = (expectedImport.problemId() == ProblemReasons.NotVisible)
            ...
            this.handleUntagged(id, readableArguments, shortArguments, nodeSourceStart(field, importRef),
        ...
        if (expectedImport instanceof PackageBinding && expectedImport.problemId() == ProblemReasons.NotAccessible) {
            ...
            this.handleUntagged(IProblem.NotAccessiblePackage, arguments, arguments, importRef.sourceStart,
        ...
        if (expectedImport.problemId() == ProblemReasons.InvalidTypeForStaticImport) {
            ...
            String[] arguments = new String[] { CharOperation.toString(tokens) };
            this.handleUntagged(IProblem.InvalidTypeForStaticImport, arguments, arguments, importRef.sourceStart,
                (int) importRef.sourcePositions[tokens.length - 1]);
            return;
        }
    ...
    public void conflictingPackagesFromModules(SplitPackageBinding splitPackage, ModuleBinding focusModule,
        ...
        this.handle(IProblem.ConflictingPackageFromModules, arguments, arguments, sourceStart, sourceEnd);
    }

    public void conflictingPackagesFromModules(PackageBinding pack, Set<ModuleBinding> modules, int sourceStart,
        int sourceEnd) {
        String moduleNames
            = modules.stream().map(p -> String.valueOf(p.name())).sorted().collect(Collectors.joining(", ")); //$NON-NLS-1$
        String[] arguments = new String[] { CharOperation.toString(pack.compoundName), moduleNames };
        this.handle(IProblem.ConflictingPackageFromModules, arguments, arguments, sourceStart, sourceEnd);
    }

    public void conflictingPackagesFromOtherModules(ImportReference currentPackage,
        Set<ModuleBinding> declaringModules) {
        String moduleNames
            = declaringModules.stream().map(p -> String.valueOf(p.name())).sorted().collect(Collectors.joining(", ")); //$NON-NLS-1$
        String[] arguments = new String[] { CharOperation.toString(currentPackage.tokens), moduleNames };
        this.handle(IProblem.ConflictingPackageFromOtherModules, arguments, arguments, currentPackage.sourceStart,
        ...
        if (TypeBinding.equalsEquals(type, currentMethod.declaringClass)) {
            ...
            this.handle(
                ...
                new String[] {
                    ...
                    new String(CharOperation.concat(inheritedMethod.declaringClass.readableName(),
                        inheritedMethod.readableName(), '.')) },
                new String[] {
                    new String(exceptionType.sourceName()),
                    new String(CharOperation.concat(inheritedMethod.declaringClass.shortReadableName(),
            ...
            this.handle(
                ...
                new String[] {
                    new String(exceptionType.sourceName()),
                    new String(CharOperation.concat(currentMethod.declaringClass.sourceName(),
    ...
    public void incompatibleReturnType(MethodBinding currentMethod, MethodBinding inheritedMethod) {
        ...
        if (declaringClass.isInterface() && !inheritedMethod.isPublic()) { // interface inheriting Object protected
                                                                           // method
        ...
        this.handle(id, new String[] { methodSignature.toString() }, new String[] { shortSignature.toString() },
            sourceStart, sourceEnd);
    }
    ...
    public void incorrectArityForParameterizedType(ASTNode location, TypeBinding type, TypeBinding[] argumentTypes,
        int index) {
        if (location == null) {
            this.handle(IProblem.IncorrectArityForParameterizedType,
                ...
                ProblemSeverities.AbortCompilation | ProblemSeverities.Error | ProblemSeverities.Fatal, 0, 0);
            return; // not reached since aborted above
        }
        this.handle(IProblem.IncorrectArityForParameterizedType,
            new String[] { new String(type.readableName()), typesAsString(argumentTypes, false) },
            new String[] { new String(type.shortReadableName()), typesAsString(argumentTypes, true) },
            location.sourceStart, nodeSourceEnd(null, location, index));
    }

    public void incorrectLocationForNonEmptyDimension(ArrayAllocationExpression expression, int index) {
        this.handle(IProblem.IllegalDimension, NoArgument, NoArgument, expression.dimensions[index].sourceStart,
            expression.dimensions[index].sourceEnd);
    }

    public void incorrectSwitchType(Expression expression, TypeBinding testType) {
        this.handle(IProblem.IncorrectSwitchType17, new String[] { new String(testType.readableName()) },
            new String[] { new String(testType.shortReadableName()) }, expression.sourceStart, expression.sourceEnd);
    }
    ...
    public void indirectAccessToStaticField(ASTNode location, FieldBinding field) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        this.handle(IProblem.IndirectAccessToStaticField,
            new String[] { new String(field.declaringClass.readableName()), new String(field.name) },
            new String[] { new String(field.declaringClass.shortReadableName()), new String(field.name) }, severity,
            nodeSourceStart(field, location), nodeSourceEnd(field, location));
    }
    ...
    public void indirectAccessToStaticMethod(ASTNode location, MethodBinding method) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        this.handle(IProblem.IndirectAccessToStaticMethod,
            new String[] {
                new String(method.declaringClass.readableName()),
                new String(method.selector),
                typesAsString(method, false) },
    ...
    public void inheritedDefaultMethodConflictsWithOtherInherited(SourceTypeBinding type, MethodBinding defaultMethod,
        ...
        this.handle(IProblem.InheritedDefaultMethodConflictsWithOtherInherited, problemArguments, messageArguments,
            typeDecl.sourceStart, typeDecl.sourceEnd);
    }

    private void inheritedMethodReducesVisibility(int sourceStart, int sourceEnd, MethodBinding concreteMethod,
    ...
    public void inheritedMethodReducesVisibility(TypeParameter typeParameter, MethodBinding concreteMethod,
        MethodBinding[] abstractMethods) {
        inheritedMethodReducesVisibility(typeParameter.sourceStart(), typeParameter.sourceEnd(), concreteMethod,
            abstractMethods);
    }

    public void inheritedMethodsHaveIncompatibleReturnTypes(ASTNode location, MethodBinding[] inheritedMethods,
        int length) {
        StringBuilder methodSignatures = new StringBuilder();
        StringBuilder shortSignatures = new StringBuilder();
        for (int i = length; --i >= 0;) {
            methodSignatures.append(inheritedMethods[i].declaringClass.readableName())
                .append('.')
                .append(inheritedMethods[i].readableName());
            shortSignatures.append(inheritedMethods[i].declaringClass.shortReadableName())
                .append('.')
        ...
        this.handle(
            ...
            IProblem.InheritedIncompatibleReturnType, new String[] { methodSignatures.toString() },
            new String[] { shortSignatures.toString() }, location.sourceStart, location.sourceEnd);
    }

    public void inheritedMethodsHaveIncompatibleReturnTypes(SourceTypeBinding type, MethodBinding[] inheritedMethods,
        int length, boolean[] isOverridden) {
        StringBuilder methodSignatures = new StringBuilder();
        StringBuilder shortSignatures = new StringBuilder();
        for (int i = length; --i >= 0;) {
            if (isOverridden[i])
        ...
        this.handle(
            ...
            // 9.4.2 - The return type from the method is incompatible with the declaration.
            IProblem.InheritedIncompatibleReturnType, new String[] { methodSignatures.toString() },
            new String[] { shortSignatures.toString() }, type.sourceStart(), type.sourceEnd());
    }

    public void inheritedMethodsHaveNameClash(SourceTypeBinding type, MethodBinding oneMethod,
        MethodBinding twoMethod) {
        this.handle(IProblem.MethodNameClash,
            new String[] {
    ...
    public void initializerMustCompleteNormally(FieldDeclaration fieldDecl) {
        this.handle(IProblem.InitializerMustCompleteNormally, NoArgument, NoArgument, fieldDecl.sourceStart,
            fieldDecl.sourceEnd);
    }
    ...
    public void innerTypesCannotDeclareStaticInitializers(ReferenceBinding innerType, Initializer initializer) {
        this.handle(IProblem.CannotDefineStaticInitializerInLocalType,
            ...
            new String[] { new String(innerType.shortReadableName()) }, initializer.sourceStart,
            initializer.sourceStart);
    }

    public void interfaceCannotHaveConstructors(ConstructorDeclaration constructor) {
        this.handle(IProblem.InterfaceCannotHaveConstructors, NoArgument, NoArgument, constructor.sourceStart,
            constructor.sourceEnd, constructor, constructor.compilationResult());
    }
    ...
    public void interfaceCannotHaveInitializers(char[] sourceName, FieldDeclaration fieldDecl) {
        ...
        this.handle(IProblem.InterfaceCannotHaveInitializers, arguments, arguments, fieldDecl.sourceStart,
            fieldDecl.sourceEnd);
    }

    public void invalidAnnotationMemberType(MethodDeclaration methodDecl) {
        this.handle(IProblem.InvalidAnnotationMemberType,
            new String[] {
    ...
    public void invalidConstructor(Statement statement, MethodBinding targetConstructor) {
        ...
        switch (targetConstructor.problemId()) {
            ...
            case ProblemReasons.ParameterBoundMismatch:
                problemConstructor = (ProblemMethodBinding) targetConstructor;
                ParameterizedGenericMethodBinding substitutedConstructor
                    = (ParameterizedGenericMethodBinding) problemConstructor.closestMatch;
                ...
                TypeVariableBinding typeParameter
                    = (TypeVariableBinding) problemConstructor.parameters[augmentedLength - 1];
                TypeBinding[] invocationArguments = new TypeBinding[augmentedLength - 2]; // remove extra info from the
                                                                                          // end
                System.arraycopy(problemConstructor.parameters, 0, invocationArguments, 0, augmentedLength - 2);
                this.handle(IProblem.GenericConstructorTypeArgumentMismatch,
                    new String[] {
            ...
            case ProblemReasons.TypeParameterArityMismatch:
                ...
                if (shownConstructor.typeVariables == Binding.NO_TYPE_VARIABLES) {
                    ...
                    this.handle(IProblem.IncorrectArityForParameterizedConstructor,
                        new String[] {
                            new String(shownConstructor.declaringClass.sourceName()),
                            typesAsString(shownConstructor, false),
                            new String(shownConstructor.declaringClass.readableName()),
            ...
            case ProblemReasons.ParameterizedMethodTypeMismatch:
                problemConstructor = (ProblemMethodBinding) targetConstructor;
                shownConstructor = problemConstructor.closestMatch;
                this.handle(IProblem.ParameterizedConstructorArgumentTypeMismatch,
                    new String[] {
                        new String(shownConstructor.declaringClass.sourceName()),
                        typesAsString(shownConstructor, false),
                        new String(shownConstructor.declaringClass.readableName()),
            ...
            case ProblemReasons.TypeArgumentsForRawGenericMethod:
                problemConstructor = (ProblemMethodBinding) targetConstructor;
                shownConstructor = problemConstructor.closestMatch;
                this.handle(IProblem.TypeArgumentsForRawGenericConstructor,
                    new String[] {
                        new String(shownConstructor.declaringClass.sourceName()),
                        typesAsString(shownConstructor, false),
                        new String(shownConstructor.declaringClass.readableName()),
            ...
            case ProblemReasons.VarargsElementTypeNotVisible:
                problemConstructor = (ProblemMethodBinding) targetConstructor;
                shownConstructor = problemConstructor.closestMatch;
                TypeBinding varargsElementType
                    = shownConstructor.parameters[shownConstructor.parameters.length - 1].leafComponentType();
            ...
            case ProblemReasons.InvocationTypeInferenceFailure:
                ...
                this.handle(IProblem.TypeMismatch,
                    new String[] {
                        ...
                        (problemConstructor.returnType != null
                            ? String.valueOf(problemConstructor.returnType.readableName())
                            : "<unknown>") }, //$NON-NLS-1$
                    new String[] {
                        String.valueOf(shownConstructor.returnType.shortReadableName()),
                        (problemConstructor.returnType != null
                            ? String.valueOf(problemConstructor.returnType.shortReadableName())
                            : "<unknown>") }, //$NON-NLS-1$
    ...
    public void invalidExplicitConstructorCall(ASTNode location) {
        ...
        this.handle(IProblem.InvalidExplicitConstructorCall, NoArgument, NoArgument, location.sourceStart,
            location.sourceEnd);
    }

    public void duplicateExplicitConstructorCall(ASTNode location) {
        this.handle(IProblem.DuplicateExplicitConstructorCall, NoArgument, NoArgument, location.sourceStart,
            location.sourceEnd);
    }

    public void misplacedConstructorCall(ASTNode location) {
        this.handle(IProblem.ConstructorCallNotAllowedHere, NoArgument, NoArgument, location.sourceStart,
            location.sourceEnd);
    }

    public void invalidExpressionAsStatement(Expression expression) {
        this.handle(IProblem.InvalidExpressionAsStatement, NoArgument, NoArgument, expression.sourceStart,
            expression.sourceEnd);
    }
    ...
    public void invalidField(FieldReference fieldRef, TypeBinding searchedType) {
        ...
        switch (field.problemId()) {
            case ProblemReasons.NotFound:
                if ((searchedType.tagBits & TagBits.HasMissingType) != 0) {
                    this.handle(IProblem.UndefinedType,
            ...
            case ProblemReasons.NotAccessible:
                this.handle(
                    (field.problemId() == ProblemReasons.NotVisible)
                        ? IProblem.NotVisibleField
                        : IProblem.NotAccessibleField,
                    ...
                    nodeSourceStart(field, fieldRef), nodeSourceEnd(field, fieldRef));
                return;
        ...
        String[] arguments = new String[] { new String(field.readableName()) };
        this.handle(id, arguments, arguments, nodeSourceStart(field, fieldRef), nodeSourceEnd(field, fieldRef));
    }
        ...
        switch (field.problemId()) {
            case ProblemReasons.NotFound:
                ...
                if (declaringClass != null && (declaringClass.tagBits & TagBits.HasMissingType) != 0) {
                    this.handle(IProblem.UndefinedType,
                        ...
                        new String[] { new String(field.declaringClass.shortReadableName()) }, nameRef.sourceStart,
                        nameRef.sourceEnd);
                    return;
                }
                String[] arguments = new String[] { new String(field.readableName()) };
                this.handle(id, arguments, arguments, nodeSourceStart(field, nameRef), nodeSourceEnd(field, nameRef));
                return;
            ...
            case ProblemReasons.NotAccessible:
                ...
                this.handle(
                    ...
                    nodeSourceStart(field, nameRef), nodeSourceEnd(field, nameRef));
                return;
            ...
            case ProblemReasons.ReceiverTypeNotVisible:
                this.handle(IProblem.NotVisibleType, new String[] { new String(field.declaringClass.readableName()) },
                    new String[] { new String(field.declaringClass.shortReadableName()) }, nameRef.sourceStart,
                    nameRef.sourceEnd);
                return;
    ...
    public void invalidField(QualifiedNameReference nameRef, FieldBinding field, int index, TypeBinding searchedType) {
        ...
        if (searchedType.isBaseType()) {
            this.handle(IProblem.NoFieldOnBaseType,
                new String[] {
                ...
                new String[] {
                    ...
                    CharOperation.toString(CharOperation.subarray(nameRef.tokens, 0, index)),
                    new String(nameRef.tokens[index]) },
                nameRef.sourceStart, (int) nameRef.sourcePositions[index]);
            return;
        }
            ...
            case ProblemReasons.NotFound:
                if ((searchedType.tagBits & TagBits.HasMissingType) != 0) {
                    this.handle(IProblem.UndefinedType,
                        new String[] { new String(searchedType.leafComponentType().readableName()) },
                        new String[] { new String(searchedType.leafComponentType().shortReadableName()) },
                        nameRef.sourceStart, (int) nameRef.sourcePositions[index - 1]);
                    return;
                }
    ...
    public void invalidFileNameForPackageAnnotations(Annotation annotation) {
        this.handle(IProblem.InvalidFileNameForPackageAnnotations, NoArgument, NoArgument, annotation.sourceStart,
            annotation.sourceEnd);
    }
    ...
    public void invalidMethod(MessageSend messageSend, MethodBinding method, Scope scope) {
        ...
        switch (method.problemId()) {
            ...
            case ProblemReasons.NotVisible:
            case ProblemReasons.NotAccessible:
                id = (method.problemId() == ProblemReasons.NotVisible)
            ...
            case ProblemReasons.ParameterBoundMismatch:
                problemMethod = (ProblemMethodBinding) method;
                ParameterizedGenericMethodBinding substitutedMethod
                    = (ParameterizedGenericMethodBinding) problemMethod.closestMatch;
                ...
                this.handle(IProblem.GenericMethodTypeArgumentMismatch,
                    new String[] {
                        new String(shownMethod.selector),
            ...
            case ProblemReasons.TypeParameterArityMismatch:
                ...
                if (shownMethod.typeVariables == Binding.NO_TYPE_VARIABLES) {
                    this.handle(IProblem.NonGenericMethod,
                        new String[] {
                            new String(shownMethod.selector),
                            typesAsString(shownMethod, false),
                            new String(shownMethod.declaringClass.readableName()),
                    ...
                    this.handle(IProblem.IncorrectArityForParameterizedMethod,
                        new String[] {
                            new String(shownMethod.selector),
                            typesAsString(shownMethod, false),
                            new String(shownMethod.declaringClass.readableName()),
            ...
            case ProblemReasons.ParameterizedMethodTypeMismatch:
                problemMethod = (ProblemMethodBinding) method;
                shownMethod = problemMethod.closestMatch;
                this.handle(IProblem.ParameterizedMethodArgumentTypeMismatch,
                    new String[] {
                        new String(shownMethod.selector),
                        typesAsString(shownMethod, false),
                        new String(shownMethod.declaringClass.readableName()),
            ...
            case ProblemReasons.TypeArgumentsForRawGenericMethod:
                problemMethod = (ProblemMethodBinding) method;
                shownMethod = problemMethod.closestMatch;
                this.handle(IProblem.TypeArgumentsForRawGenericMethod,
                    new String[] {
                        new String(shownMethod.selector),
                        typesAsString(shownMethod, false),
                        new String(shownMethod.declaringClass.readableName()),
                ...
                if (problemMethod.returnType == shownMethod.returnType) { //$IDENTITY-COMPARISON$
                    if (messageSend.expressionContext == ExpressionContext.VANILLA_CONTEXT) {
                        ...
                        this.handle(IProblem.GenericInferenceError,
                            new String[] {
                                "Unknown error at invocation of " + String.valueOf(shownMethod.readableName()) }, //$NON-NLS-1$
                            new String[] {
                                "Unknown error at invocation of " + String.valueOf(shownMethod.shortReadableName()) }, //$NON-NLS-1$
                            messageSend.sourceStart, messageSend.sourceEnd);
                    }
                    return;
                }
                TypeBinding shownMethodReturnType
                    = shownMethod.returnType.capture(scope, messageSend.sourceStart, messageSend.sourceEnd);
                this.handle(IProblem.TypeMismatch,
                    new String[] {
                        String.valueOf(shownMethodReturnType.readableName()),
                        (problemMethod.returnType != null
            ...
            case ProblemReasons.VarargsElementTypeNotVisible: // https://bugs.eclipse.org/bugs/show_bug.cgi?id=346042
                ...
                TypeBinding varargsElementType
                    = shownMethod.parameters[shownMethod.parameters.length - 1].leafComponentType();
                this.handle(IProblem.VarargsElementTypeNotVisible,
                    new String[] {
                        new String(shownMethod.selector),
                        typesAsString(shownMethod, false),
                        new String(shownMethod.declaringClass.readableName()),
            ...
            case ProblemReasons.ApplicableMethodOverriddenByInapplicable:
                ...
                this.handle(IProblem.ApplicableMethodOverriddenByInapplicable,
                    new String[] {
                        new String(shownMethod.selector),
                        typesAsString(shownMethod, false),
                        new String(shownMethod.declaringClass.readableName()), },
    ...
    public void invalidNullToSynchronize(Expression expression) {
        this.handle(IProblem.InvalidNullToSynchronized, NoArgument, NoArgument, expression.sourceStart,
            expression.sourceEnd);
    }
    ...
    public void invalidOperator(BinaryExpression expression, TypeBinding leftType, TypeBinding rightType) {
        ...
        this.handle(IProblem.InvalidOperator,
            new String[] { expression.operatorToString(), leftName + ", " + rightName }, //$NON-NLS-1$
    ...
    public void invalidParameterizedExceptionType(TypeBinding exceptionType, ASTNode location) {
        this.handle(IProblem.InvalidParameterizedExceptionType,
            new String[] { new String(exceptionType.readableName()) },
            new String[] { new String(exceptionType.shortReadableName()) }, location.sourceStart, location.sourceEnd);
    }

    public void invalidParenthesizedExpression(ASTNode reference) {
        this.handle(IProblem.InvalidParenthesizedExpression, NoArgument, NoArgument, reference.sourceStart,
            reference.sourceEnd);
    }
    ...
    public void invalidType(ASTNode location, TypeBinding type) {
        try { // ensure clean-up despite the many exits without calling handle(..)
            ...
            if (location instanceof QualifiedNameReference) {
                ...
                if (leafType instanceof ReferenceBinding) {
                    char[][] name = ((ReferenceBinding) leafType).compoundName; // problem type will tell how much got
                                                                                // resolved
            ...
            this.handle(id, new String[] { new String(type.leafComponentType().readableName()) },
                new String[] { new String(type.leafComponentType().shortReadableName()) }, start, end);
        } finally {
            close();
        }
    }
    ...
    public void invalidTypeForCollection(Expression expression) {
        this.handle(IProblem.InvalidTypeForCollection, NoArgument, NoArgument, expression.sourceStart,
            expression.sourceEnd);
    }

    public void invalidTypeForCollectionTarget14(Expression expression) {
        this.handle(IProblem.InvalidTypeForCollectionTarget14, NoArgument, NoArgument, expression.sourceStart,
            expression.sourceEnd);
    }

    public void invalidTypeToSynchronize(Expression expression, TypeBinding type) {
        this.handle(IProblem.InvalidTypeToSynchronized, new String[] { new String(type.readableName()) },
    ...
    public void invalidTypeVariableAsException(TypeBinding exceptionType, ASTNode location) {
        this.handle(IProblem.InvalidTypeVariableExceptionType,
            new String[] { new String(exceptionType.readableName()) },
            new String[] { new String(exceptionType.shortReadableName()) }, location.sourceStart, location.sourceEnd);
    }

    public void invalidUnaryExpression(Expression expression) {
        this.handle(IProblem.InvalidUnaryExpression, NoArgument, NoArgument, expression.sourceStart,
            expression.sourceEnd);
    }
    ...
    public void invalidUsageOfTypeParametersForAnnotationDeclaration(TypeDeclaration annotationTypeDeclaration) {
        ...
        this.handle(IProblem.InvalidUsageOfTypeParametersForAnnotationDeclaration, NoArgument, NoArgument,
            parameters[0].declarationSourceStart, parameters[length - 1].declarationSourceEnd);
    }

    public void invalidUsageOfTypeParametersForEnumDeclaration(TypeDeclaration annotationTypeDeclaration) {
        TypeParameter[] parameters = annotationTypeDeclaration.typeParameters;
        int length = parameters.length;
        this.handle(IProblem.InvalidUsageOfTypeParametersForEnumDeclaration, NoArgument, NoArgument,
            parameters[0].declarationSourceStart, parameters[length - 1].declarationSourceEnd);
    }

    public void invalidUsageOfTypeAnnotations(Annotation annotation) {
        this.handle(IProblem.InvalidUsageOfTypeAnnotations, NoArgument, NoArgument, annotation.sourceStart,
            annotation.sourceEnd);
    }

    public void misplacedTypeAnnotations(Annotation first, Annotation last) {
        this.handle(IProblem.MisplacedTypeAnnotations, NoArgument, NoArgument, first.sourceStart, last.sourceEnd);
    }

    public void illegalUsageOfTypeAnnotations(Annotation annotation) {
        this.handle(IProblem.IllegalUsageOfTypeAnnotations, NoArgument, NoArgument, annotation.sourceStart,
            annotation.sourceEnd);
    }

    public void illegalTypeAnnotationsInStaticMemberAccess(Annotation first, Annotation last) {
        this.handle(IProblem.IllegalTypeAnnotationsInStaticMemberAccess, NoArgument, NoArgument, first.sourceStart,
            last.sourceEnd);
    }
    ...
    public void discouragedValueBasedTypeToSynchronize(Expression expression, TypeBinding type) {
        ...
        this.handle(IProblem.DiscouragedValueBasedTypeSynchronization, new String[] { new String(type.readableName()) },
            new String[] { new String(type.shortReadableName()) }, expression.sourceStart, expression.sourceEnd);
    }

    public void isClassPathCorrect(char[][] wellKnownTypeName, CompilationUnitDeclaration compUnitDecl, Object location,
        boolean implicitAnnotationUse, ReferenceBinding referencingType) {
        // ProblemReporter is not designed to be reentrant. Just in case, we discovered a build path problem while we
        // are already
        ...
        try {
            ...
            if (implicitAnnotationUse) {
                ...
                if (referencingType != null) {
                    // avoid readableName() which might cause reentrant "isClassPathCorrect" when resolving type
                    // variables
                    char[] fullyQualifiedtypeName = CharOperation.concatWith(referencingType.fPackage.compoundName,
                        referencingType.qualifiedSourceName(), '.');
                    arguments = new String[] { arguments[0], new String(fullyQualifiedtypeName) };
                    pId = IProblem.IsClassPathCorrectWithReferencingType;
                }
            }
            this.handle(pId, arguments, arguments, start, end);
        } finally {
    ...
    private boolean isRecoveredName(char[][] qualifiedName) {
        ...
        for (char[] segment : qualifiedName) {
            if (segment == RecoveryScanner.FAKE_IDENTIFIER)
                return true;
        }
        return false;
    }
    ...
    public void javadocAmbiguousMethodReference(int sourceStart, int sourceEnd, Binding fieldBinding, int modifiers) {
        ...
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            ...
            handle(IProblem.JavadocAmbiguousMethodReference, arguments, arguments, severity, sourceStart, sourceEnd);
        }
    }
    ...
    public void javadocDeprecatedField(FieldBinding field, ASTNode location, int modifiers) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            this.handle(IProblem.JavadocUsingDeprecatedField,
                new String[] { new String(field.declaringClass.readableName()), new String(field.name) },
                new String[] { new String(field.declaringClass.shortReadableName()), new String(field.name) }, severity,
                nodeSourceStart(field, location), nodeSourceEnd(field, location));
        }
    ...
    public void javadocDeprecatedMethod(MethodBinding method, ASTNode location, int modifiers) {
        boolean isConstructor = method.isConstructor();
        int severity = computeSeverity(
            isConstructor ? IProblem.JavadocUsingDeprecatedConstructor : IProblem.JavadocUsingDeprecatedMethod);
        if (severity == ProblemSeverities.Ignore)
            return;
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            if (isConstructor) {
                this.handle(IProblem.JavadocUsingDeprecatedConstructor,
                ...
                this.handle(IProblem.JavadocUsingDeprecatedMethod,
                    new String[] {
                        new String(method.declaringClass.readableName()),
                        new String(method.selector),
                        typesAsString(method, false) },
    ...
    public void javadocDeprecatedType(TypeBinding type, ASTNode location, int modifiers, int index) {
        ...
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            if (type.isMemberType()
                ...
                && !javadocVisibility(this.options.reportInvalidJavadocTagsVisibility,
                    ((ReferenceBinding) type).modifiers)) {
                this.handle(IProblem.JavadocHiddenReference, NoArgument, NoArgument, location.sourceStart,
                    location.sourceEnd);
            } else {
                this.handle(IProblem.JavadocUsingDeprecatedType, new String[] { new String(type.readableName()) },
                    new String[] { new String(type.shortReadableName()) }, severity, location.sourceStart,
    ...
    public void javadocDuplicatedParamTag(char[] token, int sourceStart, int sourceEnd, int modifiers) {
        ...
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            ...
            this.handle(IProblem.JavadocDuplicateParamName, arguments, arguments, severity, sourceStart, sourceEnd);
        }
    }
    ...
    public void javadocDuplicatedTag(char[] tagName, int sourceStart, int sourceEnd) {
        ...
        this.handle(IProblem.JavadocDuplicateTag, arguments, arguments, sourceStart, sourceEnd);
    }
    ...
    public void javadocDuplicatedThrowsClassName(TypeReference typeReference, int modifiers) {
        ...
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            ...
            this.handle(IProblem.JavadocDuplicateThrowsClassName, arguments, arguments, severity,
    ...
    public void javadocErrorNoMethodFor(MessageSend messageSend, TypeBinding recType, TypeBinding[] params,
        int modifiers) {
        int id = recType.isArrayType()
            ? IProblem.JavadocNoMessageSendOnArrayType
        ...
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            this.handle(id,
                ...
                new String[] {
                    ...
                    new String(messageSend.selector),
                    shortBuffer.toString() },
                severity, messageSend.sourceStart, messageSend.sourceEnd);
        }
    }
    ...
    public void javadocHiddenReference(int sourceStart, int sourceEnd, Scope scope, int modifiers) {
        ...
        while (currentScope.parent.kind != Scope.COMPILATION_UNIT_SCOPE) {
            if (!javadocVisibility(this.options.reportInvalidJavadocTagsVisibility,
                currentScope.getDeclarationModifiers())) {
                return;
            }
            currentScope = currentScope.parent;
        }
        String[] arguments = new String[] {
            this.options.getVisibilityString(this.options.reportInvalidJavadocTagsVisibility),
            this.options.getVisibilityString(modifiers) };
    ...
    public void javadocInvalidConstructor(Statement statement, MethodBinding targetConstructor, int modifiers) {
        ...
        switch (targetConstructor.problemId()) {
            ...
            case ProblemReasons.ParameterBoundMismatch:
                ...
                this.handle(IProblem.JavadocGenericConstructorTypeArgumentMismatch,
                    ...
                    new String[] {
                        ...
                        new String(typeParameter.sourceName()),
                        parameterBoundAsString(typeParameter, true) },
                    severity, sourceStart, sourceEnd);
                return;
            ...
            case ProblemReasons.TypeParameterArityMismatch:
                ...
                if (noTypeVariables) {
                    ...
                    this.handle(IProblem.JavadocIncorrectArityForParameterizedConstructor,
                        new String[] {
                            new String(shownConstructor.declaringClass.sourceName()),
                            typesAsString(shownConstructor, false),
                            new String(shownConstructor.declaringClass.readableName()),
            ...
            case ProblemReasons.ParameterizedMethodTypeMismatch:
                ...
                problemConstructor = (ProblemMethodBinding) targetConstructor;
                shownConstructor = problemConstructor.closestMatch;
                this.handle(IProblem.JavadocParameterizedConstructorArgumentTypeMismatch,
                    new String[] {
                        new String(shownConstructor.declaringClass.sourceName()),
                        typesAsString(shownConstructor, false),
                        new String(shownConstructor.declaringClass.readableName()),
        ...
        this.handle(id,
            ...
            new String[] {
                new String(targetConstructor.declaringClass.shortReadableName()),
                typesAsString(targetConstructor, true) },
            severity, statement.sourceStart, statement.sourceEnd);
    }
    ...
    public void javadocInvalidField(FieldReference fieldRef, Binding fieldBinding, TypeBinding searchedType,
        ...
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            String[] arguments = new String[] { new String(fieldBinding.readableName()) };
            handle(id, arguments, arguments, severity, fieldRef.sourceStart, fieldRef.sourceEnd);
        }
    }
    ...
    public void javadocInvalidModule(ModuleReference ref) {
        this.handle(IProblem.JavadocInvalidModule, NoArgument,
            new String[] { CharOperation.charToString(ref.moduleName) }, ref.sourceStart, ref.sourceEnd);
    }
        ...
        switch (method.problemId()) {
            case ProblemReasons.NotFound:
                ...
                if (problemMethod.closestMatch != null) {
                    ...
                    this.handle(IProblem.JavadocParameterMismatch,
                        new String[] {
                        ...
                        new String[] {
                            ...
                            closestParameterTypeShortNames,
                            parameterTypeShortNames },
                        severity, (int) (messageSend.nameSourcePosition >>> 32), (int) messageSend.nameSourcePosition);
                    return;
                }
                break;
            ...
            case ProblemReasons.ParameterBoundMismatch:
                ...
                TypeBinding[] invocationArguments = new TypeBinding[augmentedLength - 2]; // remove extra info from the
                                                                                          // end
                System.arraycopy(problemMethod.parameters, 0, invocationArguments, 0, augmentedLength - 2);
                this.handle(IProblem.JavadocGenericMethodTypeArgumentMismatch,
                    new String[] {
                        new String(shownMethod.selector),
                        typesAsString(shownMethod, false),
                        new String(shownMethod.declaringClass.readableName()),
            ...
            case ProblemReasons.TypeParameterArityMismatch:
                ...
                if (severity == ProblemSeverities.Ignore)
                    return;
                if (noTypeVariables) {
                    this.handle(IProblem.JavadocNonGenericMethod,
                        new String[] {
                            new String(shownMethod.selector),
                            typesAsString(shownMethod, false),
                            new String(shownMethod.declaringClass.readableName()),
                    ...
                    this.handle(IProblem.JavadocIncorrectArityForParameterizedMethod,
                        new String[] {
                            new String(shownMethod.selector),
                            typesAsString(shownMethod, false),
                            new String(shownMethod.declaringClass.readableName()),
            ...
            case ProblemReasons.ParameterizedMethodTypeMismatch:
                ...
                problemMethod = (ProblemMethodBinding) method;
                shownMethod = problemMethod.closestMatch;
                this.handle(IProblem.JavadocParameterizedMethodArgumentTypeMismatch,
                    new String[] {
                        new String(shownMethod.selector),
                        typesAsString(shownMethod, false),
                        new String(shownMethod.declaringClass.readableName()),
            ...
            case ProblemReasons.TypeArgumentsForRawGenericMethod:
                ...
                problemMethod = (ProblemMethodBinding) method;
                shownMethod = problemMethod.closestMatch;
                this.handle(IProblem.JavadocTypeArgumentsForRawGenericMethod,
                    new String[] {
                        new String(shownMethod.selector),
                        typesAsString(shownMethod, false),
                        new String(shownMethod.declaringClass.readableName()),
    ...
    public void javadocInvalidProvidesClassName(TypeReference typeReference, int modifiers) {
        ...
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            String[] arguments = new String[] { String.valueOf(typeReference.resolvedType.sourceName()) };
            this.handle(IProblem.JavadocInvalidProvidesClassName, arguments, arguments, severity,
                typeReference.sourceStart, typeReference.sourceEnd);
        }
    }
    ...
    public void javadocInvalidSnippetRegexSubstringTogether(int sourceStart, int sourceEnd) {
        this.handle(IProblem.JavadocInvalidSnippetRegexSubstringTogether, NoArgument, NoArgument, sourceStart,
            sourceEnd);
    }
    ...
    public void javadocInvalidThrowsClassName(TypeReference typeReference, int modifiers) {
        ...
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            String[] arguments = new String[] { String.valueOf(typeReference.resolvedType.sourceName()) };
            this.handle(IProblem.JavadocInvalidThrowsClassName, arguments, arguments, severity,
                typeReference.sourceStart, typeReference.sourceEnd);
        }
    }
    ...
    public void javadocInvalidUsesClassName(TypeReference typeReference, int modifiers) {
        ...
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            String[] arguments = new String[] { String.valueOf(typeReference.resolvedType.sourceName()) };
            this.handle(IProblem.JavadocInvalidUsesClassName, arguments, arguments, severity, typeReference.sourceStart,
                typeReference.sourceEnd);
        }
    }
    ...
    public void javadocMissing(int sourceStart, int sourceEnd, int severity, int modifiers) {
        if (severity == ProblemSeverities.Ignore)
            return;
        boolean overriding
            = (modifiers & (ExtraCompilerModifiers.AccImplementing | ExtraCompilerModifiers.AccOverriding)) != 0;
        ...
        if (report) {
            ...
            if (arg != null) {
                ...
                this.handle(IProblem.JavadocMissing, arguments, arguments, severity, sourceStart, sourceEnd);
            }
        }
    }
    ...
    public void javadocMissingHashCharacter(int sourceStart, int sourceEnd, String ref) {
        ...
        this.handle(IProblem.JavadocMissingHashCharacter, arguments, arguments, severity, sourceStart, sourceEnd);
    }
    ...
    public void javadocMissingParamTag(char[] name, int sourceStart, int sourceEnd, int modifiers) {
        ...
        if (report && javadocVisibility(this.options.reportMissingJavadocTagsVisibility, modifiers)) {
            ...
            this.handle(IProblem.JavadocMissingParamTag, arguments, arguments, severity, sourceStart, sourceEnd);
        }
    }
    ...
    public void javadocMissingProvidesTag(TypeReference typeRef, int sourceStart, int sourceEnd, int modifiers) {
        ...
        if (report) {
            ...
            this.handle(IProblem.JavadocMissingProvidesTag, arguments, arguments, severity, sourceStart, sourceEnd);
        }
    }
    ...
    public void javadocMissingTagDescriptionAfterReference(int sourceStart, int sourceEnd, int modifiers) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            this.handle(IProblem.JavadocMissingTagDescription, NoArgument, NoArgument, severity, sourceStart,
                sourceEnd);
        }
    }
    ...
    public void javadocMissingThrowsTag(TypeReference typeRef, int modifiers) {
        ...
        if (report && javadocVisibility(this.options.reportMissingJavadocTagsVisibility, modifiers)) {
            String[] arguments = new String[] { String.valueOf(typeRef.resolvedType.sourceName()) };
            this.handle(IProblem.JavadocMissingThrowsTag, arguments, arguments, severity, typeRef.sourceStart,
                typeRef.sourceEnd);
        }
    }
    ...
    public void javadocMissingUsesTag(TypeReference typeRef, int sourceStart, int sourceEnd, int modifiers) {
        ...
        if (report) {
            String[] arguments = new String[] { String.valueOf(typeRef.resolvedType.sourceName()) };
            this.handle(IProblem.JavadocMissingUsesTag, arguments, arguments, severity, sourceStart, sourceEnd);
        }
    }
    ...
    public void javadocUndeclaredParamTagName(char[] token, int sourceStart, int sourceEnd, int modifiers) {
        ...
        if (javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) {
            String[] arguments = new String[] { String.valueOf(token) };
            this.handle(IProblem.JavadocInvalidParamName, arguments, arguments, severity, sourceStart, sourceEnd);
        }
    }
    ...
    public void localVariableHiding(LocalDeclaration local, Binding hiddenVariable, boolean isSpecialArgHidingField) {
        if (hiddenVariable instanceof LocalVariableBinding) {
            ...
            this.handle(id, arguments, arguments, severity, nodeSourceStart(hiddenVariable, local),
            ...
            int id = (local instanceof Argument) ? IProblem.ArgumentHidingField : IProblem.LocalVariableHidingField;
            int severity = computeSeverity(id);
            if (severity == ProblemSeverities.Ignore)
                return;
            FieldBinding field = (FieldBinding) hiddenVariable;
            this.handle(id, new String[] { new String(local.name), new String(field.declaringClass.readableName()) },
                new String[] { new String(local.name), new String(field.declaringClass.shortReadableName()) }, severity,
                local.sourceStart, local.sourceEnd);
        }
    }
    ...
    public void localVariableNonNullComparedToNull(LocalVariableBinding local, ASTNode location) {
        ...
        int problemId;
        if (local.isNonNull()) {
            char[][] annotationName = this.options.nonNullAnnotationName; // cannot be null if local is declared
                                                                          // @NonNull
        ...
        this.handle(problemId, arguments, arguments, severity, nodeSourceStart(local, location),
            nodeSourceEnd(local, location));
    }
    ...
    public void localVariableNullComparedToNonNull(LocalVariableBinding local, ASTNode location) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { new String(local.name) };
        this.handle(IProblem.NullLocalVariableComparisonYieldsFalse, arguments, arguments, severity,
            nodeSourceStart(local, location), nodeSourceEnd(local, location));
    }
    ...
    public boolean expressionNonNullComparison(Expression expr, boolean checkForNull) {
        ...
        if (expr.resolvedType != null) {
            ...
            if (tagBits == TagBits.AnnotationNonNull) {
                ...
                arguments
                    = new String[] { String.valueOf(expr.resolvedType.nullAnnotatedReadableName(this.options, true)) };
        ...
        if (expr instanceof MessageSend) {
            ...
            if (field.isNonNull()) {
                ...
                problemId = checkForNull
                    ? IProblem.ConstNonNullFieldComparisonYieldsFalse
                    : IProblem.RedundantNullCheckOnConstNonNullField;
                char[][] nonNullName = this.options.nonNullAnnotationName;
                arguments = new String[] { new String(field.name), new String(nonNullName[nonNullName.length - 1]) };
            } else {
    ...
    public void unnecessaryNullCaseInSwitchOverNonNull(CaseStatement caseStmt) {
        this.handle(IProblem.UnnecessaryNullCaseInSwitchOverNonNull, NoArgument, NoArgument, caseStmt.sourceStart,
            caseStmt.sourceEnd);
    }
    ...
    public void nullAnnotationUnsupportedLocation(Annotation annotation) {
        ...
        handle(IProblem.NullAnnotationUnsupportedLocation, arguments, shortArguments, severity, annotation.sourceStart,
            annotation.sourceEnd);
    }
    ...
    public void nullAnnotationAtQualifyingType(Annotation annotation) {
        ...
        String[] shortArguments = new String[] { String.valueOf(annotation.resolvedType.shortReadableName()) };
        int severity = ProblemSeverities.Error | ProblemSeverities.Fatal;
        handle(IProblem.NullAnnotationAtQualifyingType, arguments, shortArguments, severity, annotation.sourceStart,
            annotation.sourceEnd);
    }
    ...
    public void nullAnnotationUnsupportedLocation(TypeReference type) {
        ...
        handle(IProblem.NullAnnotationUnsupportedLocationAtType, NoArgument, NoArgument, type.sourceStart, sourceEnd);
    }
    ...
    public void messageWithUnresolvedOwningAnnotation(MessageSend send, LookupEnvironment environment) {
        ...
        handle(IProblem.MessageSendWithUnresolvedOwningAnnotation,
            ...
            new String[] { selector, String.valueOf(compoundName[compoundName.length - 1]) }, ProblemSeverities.Warning,
            send.sourceStart, send.nameSourceEnd());
    }

    public void parameterWithUnresolvedOwningAnnotation(ASTNode location, MethodBinding method, int rank,
        ...
        String parameterName = method.parameterNames != Binding.NO_PARAMETER_NAMES
            ...
            : "arg" + rank;  //$NON-NLS-1$
        String[] args
            = { String.valueOf(parameterName), String.valueOf(method.selector), CharOperation.toString(compoundName) };
        handle(IProblem.ParameterWithUnresolvedOwningAnnotation, args, args, ProblemSeverities.Warning,
            location.sourceStart, location.sourceEnd);
    }

    public void fieldWithUnresolvedOwningAnnotation(ASTNode location, FieldBinding fieldBinding,
        LookupEnvironment environment) {
    ...
    public void localVariableNullInstanceof(LocalVariableBinding local, ASTNode location) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { new String(local.name) };
        this.handle(IProblem.NullLocalVariableInstanceofYieldsFalse, arguments, arguments, severity,
            nodeSourceStart(local, location), nodeSourceEnd(local, location));
    }
    ...
    public void localVariableNullReference(LocalVariableBinding local, ASTNode location) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { new String(local.name) };
        this.handle(IProblem.NullLocalVariableReference, arguments, arguments, severity,
            nodeSourceStart(local, location), nodeSourceEnd(local, location));
    }
    ...
    public void fieldFreeTypeVariableReference(FieldBinding variable, long position) {
        ...
        String[] arguments = new String[] {
            new String(variable.type.readableName()),
            new String(nullableName[nullableName.length - 1]) };
        this.handle(IProblem.UncheckedAccessOfValueOfFreeTypeVariable, arguments, arguments, (int) (position >>> 32),
            (int) position);
    }
    ...
    public void localVariableFreeTypeVariableReference(LocalVariableBinding local, ASTNode location) {
        ...
        char[][] nullableName = this.options.nullableAnnotationName;
        String[] arguments
            = new String[] { new String(local.type.readableName()), new String(nullableName[nullableName.length - 1]) };
        this.handle(IProblem.UncheckedAccessOfValueOfFreeTypeVariable, arguments, arguments, severity,
            nodeSourceStart(local, location), nodeSourceEnd(local, location));
    }
    ...
    public void methodReturnTypeFreeTypeVariableReference(MethodBinding method, ASTNode location) {
        ...
        String[] arguments = new String[] {
            ...
            new String(nullableName[nullableName.length - 1]) };
        this.handle(IProblem.UncheckedAccessOfValueOfFreeTypeVariable, arguments, arguments, location.sourceStart,
            location.sourceEnd);
    }
    ...
    public void localVariablePotentialNullReference(LocalVariableBinding local, ASTNode location) {
        ...
        if ((local.type.tagBits & TagBits.AnnotationNullable) != 0
            && location instanceof Expression
            && ((Expression) location).isTrulyExpression()) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { new String(local.name) };
        this.handle(IProblem.PotentialNullLocalVariableReference, arguments, arguments, severity,
            nodeSourceStart(local, location), nodeSourceEnd(local, location));
    }
    ...
    public void potentialNullUnboxing(ASTNode expression, TypeBinding boxType) {
        ...
        this.handle(IProblem.PotentialNullUnboxing, arguments, argumentsShort, expression.sourceStart,
            expression.sourceEnd);
    }
    ...
    public void nullableFieldDereference(FieldBinding variable, long position) {
        char[][] nullableName = this.options.nullableAnnotationName;
        String[] arguments
            = new String[] { new String(variable.name), new String(nullableName[nullableName.length - 1]) };
        this.handle(IProblem.NullableFieldReference, arguments, arguments, (int) (position >>> 32), (int) position);
    }
    ...
    public void localVariableRedundantCheckOnNull(LocalVariableBinding local, ASTNode location) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { new String(local.name) };
        this.handle(IProblem.RedundantNullCheckOnNullLocalVariable, arguments, arguments, severity,
            nodeSourceStart(local, location), nodeSourceEnd(local, location));
    }

    public void localVariableRedundantNullAssignment(LocalVariableBinding local, ASTNode location) {
        if ((location.bits & ASTNode.FirstAssignmentToLocal) != 0) // https://bugs.eclipse.org/338303 - Warning about
                                                                   // Redundant assignment conflicts with definite
                                                                   // assignment
            return;
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { new String(local.name) };
        this.handle(IProblem.RedundantLocalVariableNullAssignment, arguments, arguments, severity,
            nodeSourceStart(local, location), nodeSourceEnd(local, location));
    }

    public void methodMustOverride(AbstractMethodDeclaration method, long complianceLevel) {
        MethodBinding binding = method.binding;
        this.handle(IProblem.MethodMustOverrideOrImplement,
            new String[] {
            ...
            new String[] {
                ...
                new String(binding.declaringClass.shortReadableName()), },
            method.sourceStart, method.sourceEnd);
    }
    ...
    public void methodNameClash(MethodBinding currentMethod, MethodBinding inheritedMethod, int severity) {
        this.handle(IProblem.MethodNameClash,
            ...
            new String[] {
                ...
                typesAsString(inheritedMethod, true),
                new String(inheritedMethod.declaringClass.shortReadableName()), },
            severity, currentMethod.sourceStart(), currentMethod.sourceEnd());
    }

    public void methodNameClashHidden(MethodBinding currentMethod, MethodBinding inheritedMethod) {
        this.handle(IProblem.MethodNameClashHidden,
            new String[] {
                new String(currentMethod.selector),
    ...
    public void methodNeedingNoBody(MethodDeclaration methodDecl) {
        this.handle(((methodDecl.modifiers & ClassFileConstants.AccNative) != 0)
    ...
    public void methodWithConstructorName(MethodDeclaration methodDecl) {
        this.handle(IProblem.MethodButWithConstructorName, NoArgument, NoArgument, methodDecl.sourceStart,
            methodDecl.sourceEnd);
    }
    ...
    public void methodCanBeDeclaredStatic(MethodDeclaration methodDecl) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        MethodBinding method = methodDecl.binding;
        this.handle(IProblem.MethodCanBeStatic,
            new String[] {
                new String(method.declaringClass.readableName()),
                new String(method.selector),
                typesAsString(method, false) },
    ...
    public void methodCanBePotentiallyDeclaredStatic(MethodDeclaration methodDecl) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        MethodBinding method = methodDecl.binding;
        this.handle(IProblem.MethodCanBePotentiallyStatic,
            new String[] {
                new String(method.declaringClass.readableName()),
                new String(method.selector),
                typesAsString(method, false) },
    ...
    public void missingDeprecatedAnnotationForField(FieldDeclaration field) {
        ...
        this.handle(IProblem.FieldMissingDeprecatedAnnotation,
            ...
            severity, nodeSourceStart(binding, field), nodeSourceEnd(binding, field));
    }
    ...
    public void missingDeprecatedAnnotationForMethod(AbstractMethodDeclaration method) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        MethodBinding binding = method.binding;
        this.handle(IProblem.MethodMissingDeprecatedAnnotation,
            new String[] {
                new String(binding.selector),
                typesAsString(binding, false),
                new String(binding.declaringClass.readableName()), },
            new String[] {
                ...
                typesAsString(binding, true),
                new String(binding.declaringClass.shortReadableName()), },
            severity, method.sourceStart, method.sourceEnd);
    }
    ...
    public void missingDeprecatedAnnotationForType(TypeDeclaration type) {
        ...
        this.handle(IProblem.TypeMissingDeprecatedAnnotation, new String[] { new String(binding.readableName()), },
    ...
    public void notAFunctionalInterface(TypeDeclaration type) {
        TypeBinding binding = type.binding;
        this.handle(IProblem.InterfaceNotFunctionalInterface, new String[] { new String(binding.readableName()), },
            new String[] { new String(binding.shortReadableName()), }, type.sourceStart, type.sourceEnd);
    }
    ...
    public void missingEnumConstantCase(SwitchExpression switchExpression, FieldBinding enumConstant) {
        missingSwitchExpressionEnumConstantCase(switchExpression.defaultCase, enumConstant,
            switchExpression.expression);
    }

    private void missingSwitchExpressionEnumConstantCase(CaseStatement defaultCase, FieldBinding enumConstant,
        ASTNode expression) {
        this.handle(IProblem.SwitchExpressionsYieldMissingEnumConstantCase,
    ...
    public void missingDefaultCase(SwitchStatement switchStatement, boolean isEnumSwitch, TypeBinding expressionType) {
        if (isEnumSwitch) {
            this.handle(IProblem.MissingEnumDefaultCase, new String[] { new String(expressionType.readableName()) },
                new String[] { new String(expressionType.shortReadableName()) }, switchStatement.expression.sourceStart,
            ...
            this.handle(
                ...
                NoArgument, NoArgument, switchStatement.expression.sourceStart, switchStatement.expression.sourceEnd);
        }
    }
    ...
    public void missingOverrideAnnotation(AbstractMethodDeclaration method) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        MethodBinding binding = method.binding;
        this.handle(IProblem.MissingOverrideAnnotation,
            new String[] {
                new String(binding.selector),
                typesAsString(binding, false),
                new String(binding.declaringClass.readableName()), },
    ...
    public void componentAccessorMissingOverrideAnnotation(AbstractMethodDeclaration method) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        MethodBinding binding = method.binding;
        this.handle(IProblem.RecordAccessorMissingOverrideAnnotation,
            new String[] {
                new String(binding.selector),
                typesAsString(binding, false),
                new String(binding.declaringClass.readableName()), },
    ...
    public void missingSerialVersion(TypeDeclaration typeDecl) {
        String[] arguments = new String[] { new String(typeDecl.name) };
        this.handle(IProblem.MissingSerialVersion, arguments, arguments, typeDecl.sourceStart, typeDecl.sourceEnd);
    }

    public void missingSynchronizedOnInheritedMethod(MethodBinding currentMethod, MethodBinding inheritedMethod) {
        this.handle(IProblem.MissingSynchronizedModifierInInheritedMethod,
            new String[] {
                new String(currentMethod.declaringClass.readableName()),
                new String(currentMethod.selector),
                typesAsString(currentMethod, false), },
    ...
    public void missingTypeInConstructor(ASTNode location, MethodBinding constructor) {
        ...
        this.handle(IProblem.MissingTypeInConstructor,
            new String[] {
    ...
    public void missingTypeInLambda(LambdaExpression lambda, MethodBinding method) {
        ...
        TypeBinding missingType = missingTypes.get(0);
        this.handle(IProblem.MissingTypeInLambda, new String[] { new String(missingType.readableName()), },
    ...
    public void missingValueForAnnotationMember(Annotation annotation, char[] memberName) {
        ...
        this.handle(IProblem.MissingValueForAnnotationMember,
    ...
    public void mustDefineDimensionsOrInitializer(ArrayAllocationExpression expression) {
        this.handle(IProblem.MustDefineEitherDimensionExpressionsOrInitializer, NoArgument, NoArgument,
            expression.sourceStart, expression.sourceEnd);
    }

    public void mustUseAStaticMethod(MessageSend messageSend, MethodBinding method) {
        this.handle(IProblem.StaticMethodRequested,
            new String[] {
                new String(method.declaringClass.readableName()),
                new String(method.selector),
                typesAsString(method, false) },
    ...
    public void nativeMethodsCannotBeStrictfp(ReferenceBinding type, AbstractMethodDeclaration methodDecl) {
        String[] arguments = new String[] { new String(type.sourceName()), new String(methodDecl.selector) };
        this.handle(IProblem.NativeMethodsCannotBeStrictfp, arguments, arguments, methodDecl.sourceStart,
            methodDecl.sourceEnd);
    }
    ...
    public void needToEmulateFieldAccess(FieldBinding field, ASTNode location, boolean isReadAccess) {
        int id = isReadAccess ? IProblem.NeedToEmulateFieldReadAccess : IProblem.NeedToEmulateFieldWriteAccess;
        int severity = computeSeverity(id);
        if (severity == ProblemSeverities.Ignore)
            return;
        this.handle(id, new String[] { new String(field.declaringClass.readableName()), new String(field.name) },
            new String[] { new String(field.declaringClass.shortReadableName()), new String(field.name) }, severity,
            nodeSourceStart(field, location), nodeSourceEnd(field, location));
    }
    ...
    public void needToEmulateMethodAccess(MethodBinding method, ASTNode location) {
        ...
        if (method.isConstructor()) {
            ...
            this.handle(IProblem.NeedToEmulateConstructorAccess,
                new String[] { new String(method.declaringClass.readableName()), typesAsString(method, false) },
                new String[] { new String(method.declaringClass.shortReadableName()), typesAsString(method, true) },
                severity, location.sourceStart, location.sourceEnd);
            return;
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        this.handle(IProblem.NeedToEmulateMethodAccess,
            new String[] {
                new String(method.declaringClass.readableName()),
                new String(method.selector),
                typesAsString(method, false) },
    ...
    public void checkSyntheticAccessor(MethodBinding method, ASTNode location) {
        if (!method.isSynthetic()) {
            ...
            if (severity == ProblemSeverities.Ignore)
                return;
            this.handle(IProblem.SyntheticAccessorNotEnclosingMethod,
                new String[] {
                    new String(method.declaringClass.readableName()),
                    new String(method.selector),
                    typesAsString(method, false) },
    ...
    public void noAdditionalBoundAfterTypeVariable(TypeReference boundReference) {
        this.handle(IProblem.NoAdditionalBoundAfterTypeVariable,
            new String[] { new String(boundReference.resolvedType.readableName()) },
            new String[] { new String(boundReference.resolvedType.shortReadableName()) }, boundReference.sourceStart,
    ...
    public void noMoreAvailableSpaceForArgument(LocalVariableBinding local, ASTNode location) {
        ...
        this.handle(
            ...
            arguments, arguments, ProblemSeverities.Abort | ProblemSeverities.Error | ProblemSeverities.Fatal,
            nodeSourceStart(local, location), nodeSourceEnd(local, location));
    }
    ...
    public void noMoreAvailableSpaceForConstant(TypeDeclaration typeDeclaration) {
        this.handle(IProblem.TooManyBytesForStringConstant,
            ...
            ProblemSeverities.Abort | ProblemSeverities.Error | ProblemSeverities.Fatal, typeDeclaration.sourceStart,
    ...
    public void nonExternalizedStringLiteral(ASTNode location) {
        this.handle(IProblem.NonExternalizedStringLiteral, NoArgument, NoArgument, location.sourceStart,
            location.sourceEnd);
    }

    public void nonGenericTypeCannotBeParameterized(int index, ASTNode location, TypeBinding type,
        TypeBinding[] argumentTypes) {
        if (location == null) { // binary case
            this.handle(IProblem.NonGenericType,
                new String[] { new String(type.readableName()), typesAsString(argumentTypes, false) },
                new String[] { new String(type.shortReadableName()), typesAsString(argumentTypes, true) },
                ProblemSeverities.AbortCompilation | ProblemSeverities.Error | ProblemSeverities.Fatal, 0, 0);
            return;
        ...
        this.handle(IProblem.NonGenericType,
            new String[] { new String(type.readableName()), typesAsString(argumentTypes, false) },
            new String[] { new String(type.shortReadableName()), typesAsString(argumentTypes, true) },
            nodeSourceStart(null, location), nodeSourceEnd(null, location, index));
    }
    ...
    public void nonStaticAccessToStaticField(ASTNode location, FieldBinding field, int index) {
        ...
        this.handle(IProblem.NonStaticAccessToStaticField,
            new String[] { new String(field.declaringClass.readableName()), new String(field.name) },
            new String[] { new String(field.declaringClass.shortReadableName()), new String(field.name) }, severity,
            nodeSourceStart(field, location, index), nodeSourceEnd(field, location, index));
    }

    public void nonStaticAccessToStaticMethod(ASTNode location, MethodBinding method) {
        this.handle(IProblem.NonStaticAccessToStaticMethod,
            new String[] {
                new String(method.declaringClass.readableName()),
                new String(method.selector),
                typesAsString(method, false) },
    ...
    public void nonStaticContextForEnumMemberType(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.NonStaticContextForEnumMemberType, arguments, arguments, type.sourceStart(),
            type.sourceEnd());
    }
    ...
    public void noSuchEnclosingInstance(TypeBinding targetType, ASTNode location, boolean isConstructorCall) {
        ...
        if (isConstructorCall) {
            ...
            // 20 = No enclosing instance of type {0} is accessible to invoke the super constructor. Must define a
            // constructor and explicitly qualify its super constructor invocation with an instance of {0} (e.g.
            // x.super() where x is an instance of {0}).
            ...
            // 21 = No enclosing instance of type {0} is accessible. Must qualify the allocation with an enclosing
            // instance of type {0} (e.g. x.new A() where x is an instance of {0}).
        ...
        this.handle(id, new String[] { new String(targetType.readableName()) },
            new String[] { new String(targetType.shortReadableName()) }, location.sourceStart, end);
    }
    ...
    public void notCompatibleTypesError(ASTNode location, TypeBinding leftType, TypeBinding rightType) {
        ...
        this.handle(problemId, new String[] { leftName, rightName }, new String[] { leftShortName, rightShortName },
            location.sourceStart, location.sourceEnd);
    }
    ...
    public void notCompatibleTypesErrorInForeach(Expression expression, TypeBinding leftType, TypeBinding rightType) {
        ...
        this.handle(IProblem.IncompatibleTypesInForeach, new String[] { leftName, rightName },
            new String[] { leftShortName, rightShortName }, expression.sourceStart, expression.sourceEnd);
    }

    public void objectCannotBeGeneric(TypeDeclaration typeDecl) {
        this.handle(IProblem.ObjectCannotBeGeneric, NoArgument, NoArgument, typeDecl.typeParameters[0].sourceStart,
    ...
    public void objectMustBeClass(SourceTypeBinding type) {
        this.handle(IProblem.ObjectMustBeClass, NoArgument, NoArgument, type.sourceStart(), type.sourceEnd());
    }

    public void operatorOnlyValidOnNumericType(CompoundAssignment assignment, TypeBinding leftType,
        ...
        this.handle(IProblem.TypeMismatch, new String[] { leftName, rightName },
            new String[] { leftShortName, rightShortName }, assignment.sourceStart, assignment.sourceEnd);
    }
    ...
    public void overridesDeprecatedMethod(MethodBinding localMethod, MethodBinding inheritedMethod) {
        String localMethodName = new String(
            CharOperation.concat(localMethod.declaringClass.readableName(), localMethod.readableName(), '.'));
        String localMethodShortName = new String(
            CharOperation.concat(localMethod.declaringClass.shortReadableName(), localMethod.shortReadableName(), '.'));
        ...
        if (sinceValue != null) {
            this.handle(
                (inheritedMethod.tagBits & TagBits.AnnotationTerminallyDeprecated) != 0
                    ? IProblem.OverridingTerminallyDeprecatedSinceVersionMethod
                    : IProblem.OverridingDeprecatedSinceVersionMethod,
                new String[] { localMethodName, new String(inheritedMethod.declaringClass.readableName()), sinceValue },
                new String[] {
            ...
            this.handle(
                (inheritedMethod.tagBits & TagBits.AnnotationTerminallyDeprecated) != 0
                    ? IProblem.OverridingTerminallyDeprecatedMethod
                    : IProblem.OverridingDeprecatedMethod,
                new String[] { localMethodName, new String(inheritedMethod.declaringClass.readableName()) },
                new String[] { localMethodShortName, new String(inheritedMethod.declaringClass.shortReadableName()) },
                localMethod.sourceStart(), localMethod.sourceEnd());
        }
    }

    public void overridesMethodWithoutSuperInvocation(MethodBinding localMethod) {
        this.handle(IProblem.OverridingMethodWithoutSuperInvocation,
            new String[] {
                new String(
                    CharOperation.concat(localMethod.declaringClass.readableName(), localMethod.readableName(), '.')) },
            new String[] {
                new String(CharOperation.concat(localMethod.declaringClass.shortReadableName(),
                    localMethod.shortReadableName(), '.')) },
            localMethod.sourceStart(), localMethod.sourceEnd());
    }

    public void overridesPackageDefaultMethod(MethodBinding localMethod, MethodBinding inheritedMethod) {
        this.handle(IProblem.OverridingNonVisibleMethod,
            new String[] {
                new String(
                    CharOperation.concat(localMethod.declaringClass.readableName(), localMethod.readableName(), '.')),
                new String(inheritedMethod.declaringClass.readableName()) },
    ...
    public void packageCollidesWithType(CompilationUnitDeclaration compUnitDecl) {
        ...
        this.handle(IProblem.PackageCollidesWithType, arguments, arguments, compUnitDecl.currentPackage.sourceStart,
    ...
    public void packageIsNotExpectedPackage(CompilationUnitDeclaration compUnitDecl) {
        ...
        this.handle(IProblem.PackageIsNotExpectedPackage, arguments, arguments,
            hasPackageDeclaration ? 0 : compUnitDecl.currentPackage.sourceStart, end);
    }
    ...
    public void parameterAssignment(LocalVariableBinding local, ASTNode location) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { new String(local.readableName()) };
        this.handle(IProblem.ParameterAssignment, arguments, arguments, severity, nodeSourceStart(local, location),
    ...
    private String parameterBoundAsString(TypeVariableBinding typeVariable, boolean makeShort) {
        ...
        if (TypeBinding.equalsEquals(typeVariable.firstBound, typeVariable.superclass)) {
            nameBuffer.append(
                makeShort ? typeVariable.superclass.shortReadableName() : typeVariable.superclass.readableName());
        }
        int length;
        if ((length = typeVariable.superInterfaces.length) > 0) {
            for (int i = 0; i < length; i++) {
                ...
                nameBuffer.append(makeShort
                    ? typeVariable.superInterfaces[i].shortReadableName()
                    : typeVariable.superInterfaces[i].readableName());
            }
        }
    ...
    public void parameterizedMemberTypeMissingArguments(ASTNode location, TypeBinding type, int index) {
        if (location == null) { // binary case
            this.handle(IProblem.MissingArgumentsForParameterizedMemberType,
                new String[] { new String(type.readableName()) }, new String[] { new String(type.shortReadableName()) },
                ProblemSeverities.AbortCompilation | ProblemSeverities.Error | ProblemSeverities.Fatal, 0, 0);
            return;
        }
        this.handle(IProblem.MissingArgumentsForParameterizedMemberType,
    ...
    public void parseError(int startPosition, int endPosition, TerminalToken currentToken, char[] currentTokenSource,
        String errorTokenName, String[] possibleTokens) {
    ...
    public void parseErrorDeleteToken(int start, int end, TerminalToken currentKind, char[] errorTokenSource,
        String errorTokenName) {
        syntaxError(IProblem.ParsingErrorDeleteToken, start, end, currentKind, errorTokenSource, errorTokenName, null);
    }

    public void parseErrorDeleteTokens(int start, int end) {
        this.handle(IProblem.ParsingErrorDeleteTokens, NoArgument, NoArgument, start, end);
    }

    public void parseErrorInsertAfterToken(int start, int end, TerminalToken currentKind, char[] errorTokenSource,
        String errorTokenName, String expectedToken) {
        syntaxError(IProblem.ParsingErrorInsertTokenAfter, start, end, currentKind, errorTokenSource, errorTokenName,
            expectedToken);
    }

    public void parseErrorInsertBeforeToken(int start, int end, TerminalToken currentKind, char[] errorTokenSource,
        String errorTokenName, String expectedToken) {
        syntaxError(IProblem.ParsingErrorInsertTokenBefore, start, end, currentKind, errorTokenSource, errorTokenName,
            expectedToken);
    }
    ...
    public void parseErrorInvalidToken(int start, int end, TerminalToken currentKind, char[] errorTokenSource,
        String errorTokenName, String expectedToken) {
        syntaxError(IProblem.ParsingErrorInvalidToken, start, end, currentKind, errorTokenSource, errorTokenName,
            expectedToken);
    }
    ...
    public void parseErrorMisplacedConstruct(int start, int end) {
        this.handle(IProblem.ParsingErrorMisplacedConstruct, NoArgument, NoArgument, start, end);
    }

    public void parseErrorNoSuggestion(int start, int end, TerminalToken currentKind, char[] errorTokenSource,
        String errorTokenName) {
        syntaxError(IProblem.ParsingErrorNoSuggestion, start, end, currentKind, errorTokenSource, errorTokenName, null);
    }

    public void parseErrorNoSuggestionForTokens(int start, int end) {
        this.handle(IProblem.ParsingErrorNoSuggestionForTokens, NoArgument, NoArgument, start, end);
    }

    public void parseErrorReplaceToken(int start, int end, TerminalToken currentKind, char[] errorTokenSource,
        String errorTokenName, String expectedToken) {
        handleSyntaxError(IProblem.ParsingError, start, end, currentKind, errorTokenSource, errorTokenName,
            expectedToken);
    }
    ...
    public void possibleAccidentalBooleanAssignment(Assignment assignment) {
        this.handle(IProblem.PossibleAccidentalBooleanAssignment, NoArgument, NoArgument, assignment.sourceStart,
    ...
    public void possibleFallThroughCase(CaseStatement caseStatement) {
        ...
        this.handle(IProblem.FallthroughCase, NoArgument, NoArgument, caseStatement.sourceStart,
    ...
    public void publicClassMustMatchFileName(CompilationUnitDeclaration compUnitDecl, TypeDeclaration typeDecl) {
        this.referenceContext = typeDecl; // report the problem against the type not the entire compilation unit
        String[] arguments = new String[] { new String(compUnitDecl.getFileName()), new String(typeDecl.name) };
        this.handle(IProblem.PublicClassMustMatchFileName, arguments, arguments, typeDecl.sourceStart,
            typeDecl.sourceEnd, compUnitDecl.compilationResult);
    }

    public void rawMemberTypeCannotBeParameterized(ASTNode location, ReferenceBinding type,
        TypeBinding[] argumentTypes) {
        if (location == null) { // binary case
            this.handle(IProblem.RawMemberTypeCannotBeParameterized,
                new String[] {
                    new String(type.readableName()),
                    typesAsString(argumentTypes, false),
                    new String(type.enclosingType().readableName()) },
                new String[] {
                    new String(type.shortReadableName()),
                    typesAsString(argumentTypes, true),
                    new String(type.enclosingType().shortReadableName()) },
                ProblemSeverities.AbortCompilation | ProblemSeverities.Error | ProblemSeverities.Fatal, 0, 0);
            return;
        }
        this.handle(IProblem.RawMemberTypeCannotBeParameterized,
    ...
    public void rawTypeReference(ASTNode location, TypeBinding type) {
        ...
        this.handle(IProblem.RawTypeReference,
            ...
            location.sourceStart, nodeSourceEnd(null, location, Integer.MAX_VALUE));
    }

    public void recursiveConstructorInvocation(ExplicitConstructorCall constructorCall) {
        this.handle(IProblem.RecursiveConstructorInvocation,
            new String[] {
    ...
    public void redundantSuperInterface(SourceTypeBinding type, TypeReference reference,
        ReferenceBinding superinterface, ReferenceBinding declaringType) {
        int severity = computeSeverity(IProblem.RedundantSuperinterface);
        if (severity != ProblemSeverities.Ignore) {
            this.handle(IProblem.RedundantSuperinterface,
                new String[] {
                ...
                severity, reference.sourceStart, reference.sourceEnd);
        }
    }

    public void referenceMustBeArrayTypeAt(TypeBinding arrayType, ArrayReference arrayRef) {
        this.handle(IProblem.ArrayReferenceRequired, new String[] { new String(arrayType.readableName()) },
            new String[] { new String(arrayType.shortReadableName()) }, arrayRef.sourceStart, arrayRef.sourceEnd);
    }

    public void repeatedAnnotationWithContainer(Annotation annotation, Annotation container) {
        this.handle(IProblem.RepeatedAnnotationWithContainerAnnotation,
            new String[] {
                new String(annotation.resolvedType.readableName()),
                new String(container.resolvedType.readableName()) },
            new String[] {
                new String(annotation.resolvedType.shortReadableName()),
                new String(container.resolvedType.shortReadableName()) },
            annotation.sourceStart, annotation.sourceEnd);
    }

    public void containerAnnotationTypeMustHaveValue(ASTNode markerNode, ReferenceBinding containerAnnotationType) {
        this.handle(IProblem.ContainerAnnotationTypeMustHaveValue,
            new String[] { new String(containerAnnotationType.readableName()) },
            new String[] { new String(containerAnnotationType.shortReadableName()) }, markerNode.sourceStart,
            markerNode.sourceEnd);
    }

    public void containerAnnotationTypeHasWrongValueType(ASTNode markerNode, ReferenceBinding containerAnnotationType,
        ReferenceBinding annotationType, TypeBinding returnType) {
        this.handle(IProblem.ContainerAnnotationTypeHasWrongValueType,
            new String[] {
                new String(containerAnnotationType.readableName()),
            ...
            markerNode.sourceStart, markerNode.sourceEnd);
    }

    public void containerAnnotationTypeHasNonDefaultMembers(ASTNode markerNode,
        ReferenceBinding containerAnnotationType, char[] selector) {
        this.handle(IProblem.ContainerAnnotationTypeHasNonDefaultMembers,
    ...
    public void containerAnnotationTypeHasShorterRetention(ASTNode markerNode, ReferenceBinding annotationType,
        String annotationRetention, ReferenceBinding containerAnnotationType, String containerRetention) {
        this.handle(IProblem.ContainerAnnotationTypeHasShorterRetention,
            new String[] {
                new String(annotationType.readableName()),
                annotationRetention,
                new String(containerAnnotationType.readableName()),
    ...
    public void repeatableAnnotationTypeTargetMismatch(ASTNode markerNode, ReferenceBinding annotationType,
        ReferenceBinding containerAnnotationType, String unmetTargets) {
        this.handle(IProblem.RepeatableAnnotationTypeTargetMismatch,
            new String[] {
                new String(annotationType.readableName()),
                new String(containerAnnotationType.readableName()),
                unmetTargets },
    ...
    public void repeatableAnnotationTypeIsDocumented(ASTNode markerNode, ReferenceBinding annotationType,
        ReferenceBinding containerAnnotationType) {
        this.handle(IProblem.RepeatableAnnotationTypeIsDocumented,
            new String[] {
                new String(annotationType.readableName()),
                new String(containerAnnotationType.readableName()) },
            new String[] {
    ...
    public void repeatableAnnotationTypeIsInherited(ASTNode markerNode, ReferenceBinding annotationType,
        ReferenceBinding containerAnnotationType) {
        this.handle(IProblem.RepeatableAnnotationTypeIsInherited,
            new String[] {
                new String(annotationType.readableName()),
                new String(containerAnnotationType.readableName()) },
            new String[] {
    ...
    public void repeatableAnnotationWithRepeatingContainer(Annotation annotation, ReferenceBinding containerType) {
        this.handle(IProblem.RepeatableAnnotationWithRepeatingContainerAnnotation,
            new String[] {
                new String(annotation.resolvedType.readableName()),
                new String(containerType.readableName()) },
            new String[] {
                new String(annotation.resolvedType.shortReadableName()),
                new String(containerType.shortReadableName()) },
            annotation.sourceStart, annotation.sourceEnd);
    }
    ...
    public void resourceHasToImplementAutoCloseable(TypeBinding binding, ASTNode reference) {
        this.handle(IProblem.ResourceHasToImplementAutoCloseable, new String[] { new String(binding.readableName()) },
            new String[] { new String(binding.shortReadableName()) }, reference.sourceStart, reference.sourceEnd);
    }

    public void resourceNotAValue(NameReference node) {
        String[] arguments = { node.toString() };
        this.handle(IProblem.ResourceIsNotAValue, arguments, arguments, node.sourceStart, node.sourceEnd);
    }
    ...
    private int retrieveClosingAngleBracketPosition(int start) {
        ...
        if (this.positionScanner == null) {
            this.positionScanner = new Scanner(false, false, false, this.options.sourceLevel,
                this.options.complianceLevel, null, null, false, this.options.enablePreviewFeatures);
    ...
    public void scannerError(Parser parser, String errorTokenName) {
        ...
        this.handle(flag, arguments, arguments,
            // this is the current -invalid- token position
            startPos, endPos, parser.compilationUnit.compilationResult);
    }

    public void shouldImplementHashcode(SourceTypeBinding type) {
        this.handle(IProblem.ShouldImplementHashcode, new String[] { new String(type.readableName()) },
            new String[] { new String(type.shortReadableName()) }, type.sourceStart(), type.sourceEnd());
    }
    ...
    public void shouldReturn(TypeBinding returnType, ASTNode location) {
        ...
        this.handle(
            ...
            new String[] { new String(returnType.shortReadableName()) }, sourceStart, sourceEnd);
    }

    public void signalNoImplicitStringConversionForCharArrayExpression(Expression expression) {
        this.handle(IProblem.NoImplicitStringConversionForCharArrayExpression, NoArgument, NoArgument,
            expression.sourceStart, expression.sourceEnd);
    }
    ...
    public void staticAndInstanceConflict(MethodBinding currentMethod, MethodBinding inheritedMethod) {
        if (currentMethod.isStatic())
            this.handle(
                ...
                // 8.4.6.4 - If a class inherits more than one method with the same signature a static (non-abstract)
                // method cannot hide an instance method.
            ...
            this.handle(
                ...
                // 8.4.6.4 - If a class inherits more than one method with the same signature an instance (non-abstract)
                // method cannot override a static method.
    ...
    public void staticFieldAccessToNonStaticVariable(ASTNode location, FieldBinding field) {
        String[] arguments = new String[] { new String(field.readableName()) };
        this.handle(IProblem.NonStaticFieldFromStaticInvocation, arguments, arguments, nodeSourceStart(field, location),
            nodeSourceEnd(field, location));
    }

    public void staticInheritedMethodConflicts(SourceTypeBinding type, MethodBinding concreteMethod,
        MethodBinding[] abstractMethods) {
        this.handle(
            // The static method %1 conflicts with the abstract method in %2
            // 8.4.6.4 - If a class inherits more than one method with the same signature it is an error for one to be
            // static (non-abstract) and the other abstract.
    ...
    public void staticMemberOfParameterizedType(ASTNode location, ReferenceBinding type,
        ReferenceBinding qualifyingType, int index) {
        if (location == null) { // binary case
            this.handle(IProblem.StaticMemberOfParameterizedType,
    ...
    public void stringConstantIsExceedingUtf8Limit(ASTNode location) {
        this.handle(IProblem.StringConstantIsExceedingUtf8Limit, NoArgument, NoArgument, location.sourceStart,
            location.sourceEnd);
    }

    public void superclassMustBeAClass(SourceTypeBinding type, TypeReference superclassRef,
        ReferenceBinding superType) {
        this.handle(IProblem.SuperclassMustBeAClass,
            new String[] { new String(superType.readableName()), new String(type.sourceName()) },
            new String[] { new String(superType.shortReadableName()), new String(type.sourceName()) },
            superclassRef.sourceStart, superclassRef.sourceEnd);
    }

    public void superfluousSemicolon(int sourceStart, int sourceEnd) {
        this.handle(IProblem.SuperfluousSemicolon, NoArgument, NoArgument, sourceStart, sourceEnd);
    }

    public void superinterfaceMustBeAnInterface(SourceTypeBinding type, TypeReference superInterfaceRef,
        ReferenceBinding superType) {
        this.handle(IProblem.SuperInterfaceMustBeAnInterface,
            new String[] { new String(superType.readableName()), new String(type.sourceName()) },
            new String[] { new String(superType.shortReadableName()), new String(type.sourceName()) },
            superInterfaceRef.sourceStart, superInterfaceRef.sourceEnd);
    }

    public void superinterfacesCollide(TypeBinding type, ASTNode decl, TypeBinding superType,
        TypeBinding inheritedSuperType) {
        this.handle(IProblem.SuperInterfacesCollide,
            new String[] {
                new String(superType.readableName()),
                new String(inheritedSuperType.readableName()),
                new String(type.sourceName()) },
            new String[] {
                new String(superType.shortReadableName()),
                new String(inheritedSuperType.shortReadableName()),
                new String(type.sourceName()) },
            decl.sourceStart, decl.sourceEnd);
    }

    public void superTypeCannotUseWildcard(SourceTypeBinding type, TypeReference superclass,
        ...
        if (superTypeShortName.equals(name))
            superTypeShortName = superTypeFullName;
        this.handle(IProblem.SuperTypeUsingWildcard, new String[] { superTypeFullName, name },
            new String[] { superTypeShortName, name }, superclass.sourceStart, superclass.sourceEnd);
    }

    private boolean handleSyntaxErrorOnNewTokens(int id, int start, int end, TerminalToken currentKind,
        char[] errorTokenSource, String errorTokenName, String expectedToken) {
    ...
    private void handleSyntaxError(int id, int start, int end, TerminalToken currentKind, char[] errorTokenSource,
        String errorTokenName, String expectedToken) {
        if (!handleSyntaxErrorOnNewTokens(IProblem.ParsingError, start, end, currentKind, errorTokenSource,
            errorTokenName, expectedToken)) {
            syntaxError(IProblem.ParsingError, start, end, currentKind, errorTokenSource, errorTokenName,
                expectedToken);
        }
    }

    private void syntaxError(int id, int startPosition, int endPosition, TerminalToken currentKind,
        char[] currentTokenSource, String errorTokenName, String expectedToken) {

        if (currentKind == TerminalToken.TokenNameAT && expectedToken != null && expectedToken.equals("@")) { //$NON-NLS-1$
            // In the diagnose parser case, we don't have the wherewithal to discriminate when we should hand out @308
            // vs @. So we always answer @.
        ...
        if (currentKind == TerminalToken.TokenNameARROW && expectedToken != null && expectedToken.equals("CaseArrow")) { //$NON-NLS-1$
            /*
             * Silently swallow the error: "Syntax error on token "->", CaseArrow expected": Diagnose Parser will apply
             * this repair and chug along on its way ...
             * This can never be the only error in a program, so we are good suppressing this. In fact, this means there
             * is NO penalty in the Scanner having to
        ...
        String eTokenName;
        if (Scanner.isKeyword(currentKind) || isLiteral(currentKind) || isIdentifier(currentKind)) {
    ...
    private String replaceIfSynthetic(String token) {
        /*
         * Java 8 grammar changes use some synthetic tokens to make the grammar LALR(1). These tokens should not be
         * exposed in messages
         * as it would make no sense to the programmer whatsoever. Replace such artificial tokens with some "suitable"
         * alternative. At
         * the moment, there are two synthetic tokens that need such massaging viz : "BeginLambda" and
         * "BeginTypeArguments". There is a
         * third synthetic token "ElidedSemicolonAndRightBrace" that we don't expect to show up in messages since it is
         * manufactured by
    ...
    public void task(String tag, String message, String priority, int start, int end) {
        this.handle(IProblem.Task,
            ...
            new String[] { tag, message, priority/* secret argument that is not surfaced in getMessage() */ }, start,
            end);
    }

    public void tooManyDimensions(ASTNode expression) {
        this.handle(IProblem.TooManyArrayDimensions, NoArgument, NoArgument, expression.sourceStart,
            expression.sourceEnd);
    }
    ...
    public void tooManyParametersForSyntheticMethod(AbstractMethodDeclaration method) {
        ...
        this.handle(IProblem.TooManyParametersForSyntheticMethod,
            new String[] {
                selector,
                typesAsString(binding, false),
                new String(binding.declaringClass.readableName()), },
            new String[] {
                ...
                typesAsString(binding, true),
                new String(binding.declaringClass.shortReadableName()), },
            ProblemSeverities.AbortMethod | ProblemSeverities.Error | ProblemSeverities.Fatal, method.sourceStart,
            method.sourceEnd);
    }
    ...
    public void typeCastError(CastExpression expression, TypeBinding leftType, TypeBinding rightType) {
        ...
        this.handle(IProblem.IllegalCast, new String[] { rightName, leftName },
            new String[] { rightShortName, leftShortName }, expression.sourceStart, expression.sourceEnd);
    }
    ...
    public void unsafeCastInTestingContext(ASTNode location, TypeBinding castType, TypeBinding expressionType) {
        ...
        this.handle(IProblem.UnsafeCast, new String[] { exprName, castName },
            new String[] { exprShortName, castShortName }, location.sourceStart, location.sourceEnd);
    }
    ...
    public void typeHiding(TypeDeclaration typeDecl, TypeBinding hiddenType) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        this.handle(IProblem.TypeHidingType,
            new String[] { new String(typeDecl.name), new String(hiddenType.shortReadableName()) },
            new String[] { new String(typeDecl.name), new String(hiddenType.readableName()) }, severity,
            typeDecl.sourceStart, typeDecl.sourceEnd);
    }
    ...
    public void typeHiding(TypeParameter typeParam, Binding hidden) {
        ...
        this.handle(IProblem.TypeParameterHidingType,
            new String[] { new String(typeParam.name), new String(hiddenType.readableName()) },
            new String[] { new String(typeParam.name), new String(hiddenType.shortReadableName()) }, severity,
            typeParam.sourceStart, typeParam.sourceEnd);
    }

    public void notAnnotationType(TypeBinding actualType, ASTNode location) {
        this.handle(IProblem.NotAnnotationType,
            new String[] { new String(actualType.leafComponentType().readableName()) },
            new String[] { new String(actualType.leafComponentType().shortReadableName()) }, location.sourceStart,
            location.sourceEnd);
    }
    ...
    public void typeMismatchError(TypeBinding actualType, TypeBinding expectedType, ASTNode location,
        ...
        if (expectingLocation != null && (expectedType.tagBits & TagBits.HasMissingType) != 0) { // improve secondary
                                                                                                 // error
            this.handle(IProblem.UndefinedType,
                ...
                expectingLocation.sourceStart, expectingLocation.sourceEnd);
            return;
        }
        ...
        this.handle(expectingLocation instanceof ReturnStatement ? IProblem.ReturnTypeMismatch : IProblem.TypeMismatch,
    ...
    public void typeMismatchError(TypeBinding typeArgument, TypeVariableBinding typeParameter,
        ReferenceBinding genericType, ASTNode location) {
        if (location == null) { // binary case
            this.handle(IProblem.TypeArgumentMismatch,
                new String[] {
    ...
    public void undefinedAnnotationValue(TypeBinding annotationType, MemberValuePair memberValuePair) {
        if (isRecoveredName(memberValuePair.name))
            return;
        String name = new String(memberValuePair.name);
        this.handle(IProblem.UndefinedAnnotationMember,
            new String[] { name, new String(annotationType.readableName()) },
            new String[] { name, new String(annotationType.shortReadableName()) }, memberValuePair.sourceStart,
            memberValuePair.sourceEnd);
    }
...
// can only occur inside binaries
    public void undefinedTypeVariableSignature(char[] variableName, ReferenceBinding binaryType) {
        this.handle(IProblem.UndefinedTypeVariable,
    ...
    public void undocumentedEmptyBlock(int blockStart, int blockEnd) {
        this.handle(IProblem.UndocumentedEmptyBlock, NoArgument, NoArgument, blockStart, blockEnd);
    }

    public void unexpectedStaticModifierForField(SourceTypeBinding type, FieldDeclaration fieldDecl) {
        String[] arguments = new String[] { new String(fieldDecl.name) };
        this.handle(IProblem.UnexpectedStaticModifierForField, arguments, arguments, fieldDecl.sourceStart,
            fieldDecl.sourceEnd);
    }

    public void unexpectedStaticModifierForMethod(ReferenceBinding type, AbstractMethodDeclaration methodDecl) {
        String[] arguments = new String[] { new String(type.sourceName()), new String(methodDecl.selector) };
        this.handle(IProblem.UnexpectedStaticModifierForMethod, arguments, arguments, methodDecl.sourceStart,
            methodDecl.sourceEnd);
    }
    ...
    public void unhandledException(TypeBinding exceptionType, ASTNode location) {
        ...
        this.handle(
            ...
            new String[] { new String(exceptionType.readableName()) },
            new String[] { new String(exceptionType.shortReadableName()) }, location.sourceStart, sourceEnd);
    }
    ...
    public void unhandledExceptionFromAutoClose(TypeBinding exceptionType, ASTNode location) {
        ...
        if (binding != null) {
            this.handle(IProblem.UnhandledExceptionOnAutoClose,
                new String[] { new String(exceptionType.readableName()), new String(binding.readableName()) },
                new String[] { new String(exceptionType.shortReadableName()), new String(binding.shortReadableName()) },
                location.sourceStart, location.sourceEnd);
        }
    }
    ...
    public void unhandledWarningToken(Expression token) {
        ...
        this.handle(IProblem.UnhandledWarningToken, arguments, arguments, token.sourceStart, token.sourceEnd);
    }

    public void uninitializedBlankFinalField(FieldBinding field, ASTNode location) {
        String[] arguments = new String[] { new String(field.readableName()) };
        this.handle(
            methodHasMissingSwitchDefault()
                ? IProblem.UninitializedBlankFinalFieldHintMissingDefault
                : IProblem.UninitializedBlankFinalField,
            arguments, arguments, nodeSourceStart(field, location), nodeSourceEnd(field, location));
    }
    ...
    public void uninitializedNonNullField(FieldBinding field, ASTNode location) {
        ...
        if (!field.isNonNull()) {
            ...
            this.handle(
                methodHasMissingSwitchDefault()
                    ? IProblem.UninitializedFreeTypeVariableFieldHintMissingDefault
                    : IProblem.UninitializedFreeTypeVariableField,
                arguments, arguments, nodeSourceStart(field, location), nodeSourceEnd(field, location));
            return;
        }
        String[] arguments = new String[] {
        ...
        this.handle(
            methodHasMissingSwitchDefault()
                ? IProblem.UninitializedNonNullFieldHintMissingDefault
    ...
    public void uninitializedLocalVariable(LocalVariableBinding binding, ASTNode location, Scope scope) {
        ...
        this.handle(
            methodHasMissingSwitchDefault()
                ? IProblem.UninitializedLocalVariableHintMissingDefault
                : IProblem.UninitializedLocalVariable,
            arguments, arguments, nodeSourceStart(binding, location), nodeSourceEnd(binding, location));
    }
    ...
    public void unnecessaryCast(CastExpression castExpression) {
        ...
        this.handle(IProblem.UnnecessaryCast,
            new String[] {
                new String(castedExpressionType.readableName()),
                new String(castExpression.type.resolvedType.readableName()) },
            new String[] {
                new String(castedExpressionType.shortReadableName()),
                new String(castExpression.type.resolvedType.shortReadableName()) },
            severity, castExpression.sourceStart, castExpression.sourceEnd);
    }

    public void unnecessaryElse(ASTNode location) {
        this.handle(IProblem.UnnecessaryElse, NoArgument, NoArgument, location.sourceStart, location.sourceEnd);
    }
    ...
    public void unnecessaryInstanceof(InstanceOfExpression instanceofExpression, TypeBinding checkType) {
        ...
        this.handle(IProblem.UnnecessaryInstanceof,
            ...
            severity, instanceofExpression.sourceStart, instanceofExpression.sourceEnd);
    }

    public void unnecessaryNLSTags(int sourceStart, int sourceEnd) {
        this.handle(IProblem.UnnecessaryNLSTag, NoArgument, NoArgument, sourceStart, sourceEnd);
    }
    ...
    public void unqualifiedFieldAccess(NameReference reference, FieldBinding field) {
        ...
        this.handle(IProblem.UnqualifiedFieldAccess,
            new String[] { new String(field.declaringClass.readableName()), new String(field.name) },
            new String[] { new String(field.declaringClass.shortReadableName()), new String(field.name) }, sourceStart,
            sourceEnd);
    }

    public void unreachableCatchBlock(ReferenceBinding exceptionType, ASTNode location) {
        this.handle(IProblem.UnreachableCatch, new String[] { new String(exceptionType.readableName()), },
            new String[] { new String(exceptionType.shortReadableName()), }, location.sourceStart, location.sourceEnd);
    }
    ...
    public void unreachableCode(Statement statement) {
        ...
        this.handle(IProblem.CodeCannotBeReached, NoArgument, NoArgument, sourceStart, sourceEnd);
    }
    ...
    public void unsafeCast(CastExpression castExpression, Scope scope) {
        ...
        this.handle(IProblem.UnsafeGenericCast,
            new String[] {
                new String(castedExpressionType.readableName()),
    ...
    public void unsafeNullnessCast(CastExpression castExpression, Scope scope) {
        TypeBinding castedExpressionType = castExpression.expression.resolvedType;
        TypeBinding castExpressionResolvedType = castExpression.resolvedType;
        this.handle(IProblem.UnsafeNullnessCast,
            new String[] {
            ...
            castExpression.sourceStart, castExpression.sourceEnd);
    }
    ...
    public void unsafeGenericArrayForVarargs(TypeBinding leafComponentType, ASTNode location) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        this.handle(IProblem.UnsafeGenericArrayForVarargs,
            new String[] { new String(leafComponentType.readableName()) },
            new String[] { new String(leafComponentType.shortReadableName()) }, severity, location.sourceStart,
            location.sourceEnd);
    }
    ...
    public void unsafeRawFieldAssignment(FieldBinding field, TypeBinding expressionType, ASTNode location) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        this.handle(IProblem.UnsafeRawFieldAssignment,
            new String[] {
    ...
    public void unsafeRawGenericMethodInvocation(ASTNode location, MethodBinding rawMethod,
        ...
        int severity = computeSeverity(
            isConstructor ? IProblem.UnsafeRawGenericConstructorInvocation : IProblem.UnsafeRawGenericMethodInvocation);
        if (severity == ProblemSeverities.Ignore)
            return;
        if (isConstructor) {
            this.handle(IProblem.UnsafeRawGenericConstructorInvocation, // The generic constructor {0}({1}) of type {2}
                                                                        // is applied to non-parameterized type
                                                                        // arguments ({3})
                new String[] {
            ...
            this.handle(IProblem.UnsafeRawGenericMethodInvocation,
                new String[] {
    ...
    public void unsafeRawInvocation(ASTNode location, MethodBinding rawMethod) {
        boolean isConstructor = rawMethod.isConstructor();
        int severity = computeSeverity(
            isConstructor ? IProblem.UnsafeRawConstructorInvocation : IProblem.UnsafeRawMethodInvocation);
        if (severity == ProblemSeverities.Ignore)
            return;
        if (isConstructor) {
            this.handle(IProblem.UnsafeRawConstructorInvocation,
                new String[] {
                    new String(rawMethod.declaringClass.readableName()),
            ...
            this.handle(IProblem.UnsafeRawMethodInvocation,
                new String[] {
                    new String(rawMethod.selector),
                    typesAsString(rawMethod.original(), rawMethod.parameters, false),
                    new String(rawMethod.declaringClass.readableName()),
    ...
    public void unsafeReturnTypeOverride(MethodBinding currentMethod, MethodBinding inheritedMethod,
        ...
        this.handle(IProblem.UnsafeReturnTypeOverride,
            new String[] {
    ...
    public void unsafeTypeConversion(Expression expression, TypeBinding expressionType, TypeBinding expectedType) {
        ...
        this.handle(IProblem.UnsafeTypeConversion,
            new String[] {
                new String(expressionType.readableName()),
                new String(expectedType.readableName()),
                new String(expectedType.erasure().readableName()) },
            new String[] {
                new String(expressionType.shortReadableName()),
                new String(expectedType.shortReadableName()),
                new String(expectedType.erasure().shortReadableName()) },
            severity, expression.sourceStart, expression.sourceEnd);
    }

    public void unsafeElementTypeConversion(Expression expression, TypeBinding expressionType,
        TypeBinding expectedType) {
        ...
        this.handle(IProblem.UnsafeElementTypeConversion,
            new String[] {
                new String(expressionType.readableName()),
                new String(expectedType.readableName()),
                new String(expectedType.erasure().readableName()) },
    ...
    public void unusedArgument(LocalDeclaration localDecl) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { new String(localDecl.name) };
        this.handle(IProblem.ArgumentIsNeverUsed, arguments, arguments, severity, localDecl.sourceStart,
            localDecl.sourceEnd);
    }
    ...
    public void unusedExceptionParameter(LocalDeclaration exceptionParameter) {
        ...
        this.handle(IProblem.ExceptionParameterIsNeverUsed, arguments, arguments, severity,
            exceptionParameter.sourceStart, exceptionParameter.sourceEnd);
    }

    public void unusedDeclaredThrownException(ReferenceBinding exceptionType, AbstractMethodDeclaration method,
        ASTNode location) {
        boolean isConstructor = method.isConstructor();
        int severity = computeSeverity(isConstructor
            ? IProblem.UnusedConstructorDeclaredThrownException
            : IProblem.UnusedMethodDeclaredThrownException);
        if (severity == ProblemSeverities.Ignore)
            return;
        if (isConstructor) {
            this.handle(IProblem.UnusedConstructorDeclaredThrownException,
                new String[] {
            ...
            this.handle(IProblem.UnusedMethodDeclaredThrownException,
                new String[] {
                    new String(method.binding.declaringClass.readableName()),
                    new String(method.selector),
                    typesAsString(method.binding, false),
    ...
    public void unusedImport(ImportReference importRef) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { CharOperation.toString(importRef.tokens) };
        this.handle(IProblem.UnusedImport, arguments, arguments, severity, importRef.sourceStart, importRef.sourceEnd);
    }
    ...
    public void unusedLabel(LabeledStatement statement) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { new String(statement.label) };
        this.handle(IProblem.UnusedLabel, arguments, arguments, severity, statement.sourceStart, statement.labelEnd);
    }
    ...
    public void unusedLocalVariable(LocalDeclaration localDecl) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { new String(localDecl.name) };
        this.handle(IProblem.LocalVariableIsNeverUsed, arguments, arguments, severity, localDecl.sourceStart,
            localDecl.sourceEnd);
    }
    ...
    public void unusedLambdaParameter(LocalDeclaration localDecl) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        String[] arguments = new String[] { new String(localDecl.name) };
        this.handle(IProblem.LambdaParameterIsNeverUsed, arguments, arguments, severity, localDecl.sourceStart,
            localDecl.sourceEnd);
    }

    public void unusedObjectAllocation(AllocationExpression allocationExpression) {
        this.handle(IProblem.UnusedObjectAllocation, NoArgument, NoArgument, allocationExpression.sourceStart,
    ...
    public void unusedPrivateConstructor(ConstructorDeclaration constructorDecl) {
        ...
        if (excludeDueToAnnotation(constructorDecl.annotations, IProblem.UnusedPrivateConstructor))
            return;

        MethodBinding constructor = constructorDecl.binding;
        this.handle(IProblem.UnusedPrivateConstructor,
            new String[] { new String(constructor.declaringClass.readableName()), typesAsString(constructor, false) },
            new String[] {
                new String(constructor.declaringClass.shortReadableName()),
                typesAsString(constructor, true) },
            severity, constructorDecl.sourceStart, constructorDecl.sourceEnd);
    }
    ...
    public void unusedPrivateField(FieldDeclaration fieldDecl) {
        ...
        if (excludeDueToAnnotation(fieldDecl.annotations, IProblem.UnusedPrivateField))
            return;
        this.handle(IProblem.UnusedPrivateField,
            new String[] { new String(field.declaringClass.readableName()), new String(field.name), },
            new String[] { new String(field.declaringClass.shortReadableName()), new String(field.name), }, severity,
            nodeSourceStart(field, fieldDecl), nodeSourceEnd(field, fieldDecl));
    }
    ...
    public void unusedPrivateMethod(AbstractMethodDeclaration methodDecl) {
        ...
        if (!method.isStatic()
            ...
            && CharOperation.equals(TypeConstants.CharArray_JAVA_IO_OBJECTINPUTSTREAM,
        ...
        if (!method.isStatic()
            ...
            && CharOperation.equals(TypeConstants.CharArray_JAVA_IO_OBJECTOUTPUTSTREAM,
                method.parameters[0].readableName())) {
            return;
        }
        ...
        if (excludeDueToAnnotation(methodDecl.annotations, IProblem.UnusedPrivateMethod))
            return;

        this.handle(IProblem.UnusedPrivateMethod,
            new String[] {
                new String(method.declaringClass.readableName()),
                new String(method.selector),
                typesAsString(method, false) },
                ...
                switch (resolvedType.id) {
                    ...
                    case TypeIds.T_OrgSpringframeworkBeansFactoryAnnotationAutowired:
                        if (problemId != IProblem.UnusedPrivateField)
                            return true; // @Inject on method/ctor does constitute a relevant use, just on fields it
                                         // doesn't
                        break;

                    default:
                        if (resolvedType instanceof ReferenceBinding)
                            if (((ReferenceBinding) resolvedType).hasNullBit(TypeIds.BitNullableAnnotation
                                | TypeIds.BitNonNullAnnotation | TypeIds.BitNonNullByDefaultAnnotation))
                                break;
    ...
    public void unusedPrivateType(TypeDeclaration typeDecl) {
        ...
        if (severity == ProblemSeverities.Ignore)
            return;
        if (excludeDueToAnnotation(typeDecl.annotations, IProblem.UnusedPrivateType))
            return;
        ReferenceBinding type = typeDecl.binding;
        this.handle(IProblem.UnusedPrivateType, new String[] { new String(type.readableName()), },
            new String[] { new String(type.shortReadableName()), }, severity, typeDecl.sourceStart, typeDecl.sourceEnd);
    }
    ...
    public void unusedTypeParameter(TypeParameter typeParameter) {
        ...
        this.handle(IProblem.UnusedTypeParameter, arguments, arguments, typeParameter.sourceStart,
            typeParameter.sourceEnd);
    }

    public void unusedWarningToken(Expression token) {
        String[] arguments = new String[] { token.constant.stringValue() };
        this.handle(IProblem.UnusedWarningToken, arguments, arguments, token.sourceStart, token.sourceEnd);
    }

    public void problemNotAnalysed(Expression token, String optionKey) {
        this.handle(IProblem.ProblemNotAnalysed, optionKey != null ? new String[] { optionKey } : new String[] { },
            new String[] { token.constant.stringValue() }, token.sourceStart, token.sourceEnd);
    }
...
// validateJavaFeatureSupport()
    public void previewFeatureUsed(int sourceStart, int sourceEnd) {
        ...
        this.handle(IProblem.PreviewFeatureUsed, NoArgument, NoArgument, sourceStart, sourceEnd);
    }
        ...
        for (IBinaryElementValuePair valuePair : previewAnnotation.getElementValuePairs()) {
            if (valuePair.getValue()instanceof EnumConstantSignature enumSig) {
                ...
                ReferenceBinding enumType
                    = scope.environment().getTypeFromConstantPoolName(typeName, 1, typeName.length - 1, false, null);
                ...
                for (AnnotationBinding annotationBinding : field.getAnnotations()) {
                    if (CharOperation.equals(annotationBinding.getAnnotationType().constantPoolName(),
                        ConstantPool.PREVIEW_FEATURE_JEP, 1, ConstantPool.PREVIEW_FEATURE_JEP.length - 1)) { // skip 'L'
                                                                                                             // and ';'
                        for (ElementValuePair elementValuePair : annotationBinding.getElementValuePairs()) {
            ...
            } else if (CharOperation.equals(valuePair.getName(), ConstantPool.REFLECTIVE)) {
                ...
                if (CharOperation.equals(name, k)) {
                    if (reportSyntaxError) {
                        ...
                        if (feature.isPreview()) {
                            int severity = isPreviewEnabled
                                ? ProblemSeverities.Error | ProblemSeverities.Fatal
                                : ProblemSeverities.Warning;
                            restrictedTypeName(name, CompilerOptions.versionFromJdkLevel(feature.getCompliance()),
                                start, end, severity);
                            ...
                            restrictedTypeName(name, CompilerOptions.versionFromJdkLevel(compliance), start, end,
                                severity);
                            return true;
                        }
                    }
...
// Returns true if the problem is handled and reported (only errors considered and not warnings)
    ...
    public void useEnumAsAnIdentifier(int sourceStart, int sourceEnd) {
        this.handle(IProblem.UseEnumAsAnIdentifier, NoArgument, NoArgument, sourceStart, sourceEnd);
    }

    public void illegalUseOfUnderscoreAsAnIdentifier(int sourceStart, int sourceEnd, boolean reportError,
        boolean unusedVariablesSupported) {
        int problemId = (reportError)
            ? IProblem.ErrorUseOfUnderscoreAsAnIdentifier
    ...
    public void varargsArgumentNeedCast(MethodBinding method, TypeBinding argumentType, InvocationSite location) {
        ...
        if (method.isConstructor()) {
            this.handle(IProblem.ConstructorVarargsArgumentNeedCast,
                new String[] {
            ...
            this.handle(IProblem.MethodVarargsArgumentNeedCast,
                new String[] {
                    new String(argumentType.readableName()),
                    new String(varargsType.readableName()),
                    new String(method.selector),
    ...
    public void varargsConflict(MethodBinding method1, MethodBinding method2, SourceTypeBinding type) {
        this.handle(IProblem.VarargsConflict,
            new String[] {
    ...
    public void safeVarargsOnFixedArityMethod(MethodBinding method) {
        String[] arguments = new String[] {
            new String(method.isConstructor() ? method.declaringClass.shortReadableName() : method.selector) };
        this.handle(IProblem.SafeVarargsOnFixedArityMethod, arguments, arguments, method.sourceStart(),
            method.sourceEnd());
    }
    ...
    public void safeVarargsOnNonFinalInstanceMethod(MethodBinding method) {
        String[] arguments = new String[] {
            new String(method.isConstructor() ? method.declaringClass.shortReadableName() : method.selector) };
        this.handle(IProblem.SafeVarargsOnNonFinalInstanceMethod, arguments, arguments, method.sourceStart(),
            method.sourceEnd());
    }
    ...
    public void possibleHeapPollutionFromVararg(AbstractVariableDeclaration vararg) {
        ...
        this.handle(IProblem.PotentialHeapPollutionFromVararg, arguments, arguments, vararg.sourceStart,
            vararg.sourceEnd);
    }

    public void safeVarargsOnOnSyntheticRecordAccessor(RecordComponent comp) {
        String[] arguments = new String[] { new String(comp.name) };
        this.handle(IProblem.SafeVarargsOnSyntheticRecordAccessor, arguments, arguments, comp.sourceStart,
            comp.sourceEnd);
    }
    ...
    public void varLocalMultipleDeclarators(AbstractVariableDeclaration varDecl) {
        this.handle(IProblem.VarLocalMultipleDeclarators, NoArgument, NoArgument, varDecl.sourceStart,
            varDecl.sourceEnd);
    }

    public void varLocalCannotBeArray(ASTNode varDecl) {
        this.handle(IProblem.VarLocalCannotBeArray, NoArgument, NoArgument, varDecl.sourceStart, varDecl.sourceEnd);
    }

    public void varLocalReferencesItself(SingleNameReference reference) {
        this.handle(IProblem.VarLocalReferencesItself, NoArgument, NoArgument, reference.sourceStart,
            reference.sourceEnd);
    }

    public void varLocalWithoutInitizalier(AbstractVariableDeclaration varDecl) {
        this.handle(IProblem.VarLocalWithoutInitizalier, NoArgument, NoArgument, varDecl.sourceStart,
            varDecl.sourceEnd);
    }

    public void varLocalInitializedToNull(AbstractVariableDeclaration varDecl) {
        this.handle(IProblem.VarLocalInitializedToNull, NoArgument, NoArgument, varDecl.sourceStart, varDecl.sourceEnd);
    }

    public void varLocalInitializedToVoid(AbstractVariableDeclaration varDecl) {
        this.handle(IProblem.VarLocalInitializedToVoid, NoArgument, NoArgument, varDecl.sourceStart, varDecl.sourceEnd);
    }

    public void varLocalCannotBeArrayInitalizers(AbstractVariableDeclaration varDecl) {
        this.handle(IProblem.VarLocalCannotBeArrayInitalizers, NoArgument, NoArgument, varDecl.sourceStart,
            varDecl.sourceEnd);
    }

    public void varIsReservedTypeName(TypeDeclaration decl) {
        this.handle(IProblem.VarIsReserved, NoArgument, NoArgument, decl.sourceStart, decl.sourceEnd);
    }

    public void varIsReservedTypeNameInFuture(ASTNode decl) {
        this.handle(IProblem.VarIsReservedInFuture, NoArgument, NoArgument, ProblemSeverities.Warning, decl.sourceStart,
            decl.sourceEnd);
    }

    public void varIsNotAllowedHere(ASTNode astNode) {
        this.handle(IProblem.VarIsNotAllowedHere, NoArgument, NoArgument, astNode.sourceStart, astNode.sourceEnd);
    }

    public void varCannotBeMixedWithNonVarParams(ASTNode astNode) {
        this.handle(IProblem.VarCannotBeMixedWithNonVarParams, NoArgument, NoArgument, astNode.sourceStart,
            astNode.sourceEnd);
    }

    public void varCannotBeUsedWithTypeArguments(ASTNode astNode) {
        this.handle(IProblem.VarCannotBeUsedWithTypeArguments, NoArgument, NoArgument, astNode.sourceStart,
            astNode.sourceEnd);
    }

    public void variableTypeCannotBeVoidArray(AbstractVariableDeclaration varDecl) {
        this.handle(IProblem.CannotAllocateVoidArray, NoArgument, NoArgument, varDecl.type.sourceStart,
    ...
    public void visibilityConflict(MethodBinding currentMethod, MethodBinding inheritedMethod) {
        this.handle(
            ...
            // 8.4.6.3 - The access modifier of an hiding method must provide at least as much access as the hidden
            // method.
            // 8.4.6.3 - The access modifier of an overiding method must provide at least as much access as the
            // overriden method.
    ...
    public void wildcardAssignment(TypeBinding variableType, TypeBinding expressionType, ASTNode location) {
        this.handle(IProblem.WildcardFieldAssignment,
            new String[] { new String(expressionType.readableName()), new String(variableType.readableName()) },
            new String[] {
                new String(expressionType.shortReadableName()),
                new String(variableType.shortReadableName()) },
            location.sourceStart, location.sourceEnd);
    }

    public void wildcardInvocation(ASTNode location, TypeBinding receiverType, MethodBinding method,
        ...
        if (method.isConstructor()) {
            this.handle(IProblem.WildcardConstructorInvocation,
                new String[] {
            ...
            this.handle(IProblem.WildcardMethodInvocation,
                new String[] {
                    new String(method.selector),
                    typesAsString(method, false),
                    new String(receiverType.readableName()),
    ...
    public void wrongSequenceOfExceptionTypesError(TypeReference typeRef, TypeBinding exceptionType,
        ...
        this.handle(IProblem.InvalidCatchBlockSequence,
    ...
    public void wrongSequenceOfExceptionTypes(TypeReference typeRef, TypeBinding exceptionType,
        TypeBinding hidingExceptionType) {
        // type references inside a multi-catch block are not of union type
        this.handle(IProblem.InvalidUnionTypeReferenceSequence,
            new String[] { new String(exceptionType.readableName()), new String(hidingExceptionType.readableName()), },
            new String[] {
                new String(exceptionType.shortReadableName()),
                new String(hidingExceptionType.shortReadableName()), },
    ...
    public void autoManagedVariableResourcesNotBelow9(Expression resource) {
        this.handle(IProblem.AutoManagedVariableResourceNotBelow9, NoArgument, NoArgument, resource.sourceStart,
            resource.sourceEnd);
    }
    ...
    public void cannotInferElidedTypes(AllocationExpression allocationExpression) {
        ...
        this.handle(IProblem.CannotInferElidedTypes, arguments, arguments, allocationExpression.sourceStart,
            allocationExpression.sourceEnd);
    }

    public void diamondNotWithExplicitTypeArguments(TypeReference[] typeArguments) {
        this.handle(IProblem.CannotUseDiamondWithExplicitTypeArguments, NoArgument, NoArgument,
            typeArguments[0].sourceStart, typeArguments[typeArguments.length - 1].sourceEnd);
    }

    public void rawConstructorReferenceNotWithExplicitTypeArguments(TypeReference[] typeArguments) {
        this.handle(IProblem.IllegalTypeArgumentsInRawConstructorReference, NoArgument, NoArgument,
            typeArguments[0].sourceStart, typeArguments[typeArguments.length - 1].sourceEnd);
    }

    public void diamondNotWithAnoymousClasses(TypeReference type) {
        this.handle(IProblem.CannotUseDiamondWithAnonymousClasses, NoArgument, NoArgument, type.sourceStart,
            type.sourceEnd);
    }

    public void anonymousDiamondWithNonDenotableTypeArguments(TypeReference type, TypeBinding tb) {
        this.handle(IProblem.NonDenotableTypeArgumentForAnonymousDiamond,
            new String[] { new String(tb.leafComponentType().shortReadableName()), type.toString() },
            new String[] { new String(tb.leafComponentType().shortReadableName()), type.toString() }, type.sourceStart,
            type.sourceEnd);
    }
    ...
    public void redundantSpecificationOfTypeArguments(ASTNode location, TypeBinding[] argumentTypes) {
        ...
        if (severity != ProblemSeverities.Ignore) {
            ...
            this.handle(IProblem.RedundantSpecificationOfTypeArguments,
                new String[] { typesAsString(argumentTypes, false) },
                new String[] { typesAsString(argumentTypes, true) }, severity, sourceStart, location.sourceEnd);
        }
    }
    ...
    public void potentiallyUnclosedCloseable(FakedTrackingVariable trackVar, ASTNode location) {
        ...
        if (location == null || trackVar.originalBinding == null) {
            ...
            this.handle(IProblem.PotentiallyUnclosedCloseable, args, args, trackVar.sourceStart, trackVar.sourceEnd);
        } else {
            this.handle(IProblem.PotentiallyUnclosedCloseableAtExit, args, args, location.sourceStart,
                location.sourceEnd);
        }
    }
    ...
    public void unclosedCloseable(FakedTrackingVariable trackVar, ASTNode location) {
        ...
        if (location == null || trackVar.originalBinding == null) { // unassigned has no doubt about location
            this.handle(shared ? IProblem.MandatoryCloseNotShown : IProblem.UnclosedCloseable, args, args,
                trackVar.sourceStart, trackVar.sourceEnd);
        } else {
            this.handle(shared ? IProblem.MandatoryCloseNotShownAtExit : IProblem.UnclosedCloseableAtExit, args, args,
                location.sourceStart, location.sourceEnd);
        }
    }
    ...
    public void explicitlyClosedAutoCloseable(FakedTrackingVariable trackVar) {
        ...
        this.handle(IProblem.ExplicitlyClosedAutoCloseable, args, args, trackVar.sourceStart, trackVar.sourceEnd);
    }
    ...
    public void shouldMarkMethodAsOwning(ASTNode location) {
        ...
        this.handle(IProblem.ShouldMarkMethodAsOwning, args, args, location.sourceStart, location.sourceEnd);
    }

    public void shouldMarkFieldAsOwning(ASTNode location) {
        char[] name = this.options.owningAnnotationName[this.options.owningAnnotationName.length - 1];
        String[] args = { String.valueOf(name) };
        this.handle(IProblem.NotOwningResourceField, args, args, location.sourceStart, location.sourceEnd);
    }

    public void staticResourceField(FieldDeclaration fieldDeclaration) {
        this.handle(IProblem.StaticResourceField, NoArgument, NoArgument, fieldDeclaration.sourceStart,
    ...
    public void shouldImplementAutoCloseable(ASTNode location) {
        char[] name = this.options.owningAnnotationName[this.options.owningAnnotationName.length - 1];
        String[] args = { String.valueOf(name) };
        this.handle(IProblem.OwningFieldInNonResourceClass, args, args, location.sourceStart, location.sourceEnd);
    }

    public void missingImplementationOfClose(FieldDeclaration fieldDeclaration) {
        char[] name = this.options.owningAnnotationName[this.options.owningAnnotationName.length - 1];
        String[] args = { String.valueOf(name) };
        this.handle(IProblem.OwningFieldShouldImplementClose, args, args, fieldDeclaration.sourceStart,
            fieldDeclaration.sourceEnd);
    }
    ...
    public void overrideReducingParamterOwning(Argument argument) {
        char[] name = this.options.owningAnnotationName[this.options.owningAnnotationName.length - 1];
        String[] args = { String.valueOf(name) };
        this.handle(IProblem.OverrideReducingParamterOwning, args, args, argument.sourceStart, argument.sourceEnd);
    }
    ...
    public void overrideAddingReturnOwning(AbstractMethodDeclaration method) {
        ...
        String[] args = { String.valueOf(name) };
        this.handle(IProblem.OverrideAddingReturnOwning, args, args, location.sourceStart, location.sourceEnd);
    }

    public void nullityMismatch(Expression expression, TypeBinding providedType, TypeBinding requiredType,
        int nullStatus, char[][] annotationName) {
        ...
        if ((nullStatus & FlowInfo.POTENTIALLY_NULL) != 0) {
            ...
            if (expression instanceof ArrayReference && expression.resolvedType.isFreeTypeVariable()) {
                nullityMismatchingTypeAnnotation(expression, providedType, requiredType,
    ...
    public void nullityMismatchIsNull(Expression expression, TypeBinding requiredType) {
        ...
        if (!useNullTypeAnnotations) {
            ...
            if (problemId == IProblem.NullNotCompatibleToFreeTypeVariable) {
                ...
                argumentsShort
                    = new String[] { new String(requiredType.nullAnnotatedReadableName(this.options, true)) };
            }
        }
    ...
    public void nullityMismatchPotentiallyNull(Expression expression, TypeBinding requiredType,
        char[][] annotationName) {
    ...
    public void nullityMismatchIsUnknown(Expression expression, TypeBinding providedType, TypeBinding requiredType,
        char[][] annotationName) {
    ...
    public void illegalRedefinitionToNonNullParameter(Argument argument, ReferenceBinding declaringClass,
        ...
        if (inheritedAnnotationName == null) {
            this.handle(IProblem.IllegalDefinitionToNonNullParameter,
                new String[] { new String(argument.name), new String(declaringClass.readableName()) },
                new String[] { new String(argument.name), new String(declaringClass.shortReadableName()) }, sourceStart,
                argument.type.sourceEnd);
        } else {
            this.handle(IProblem.IllegalRedefinitionToNonNullParameter,
                new String[] {
                    new String(argument.name),
                    new String(declaringClass.readableName()),
                    CharOperation.toString(inheritedAnnotationName) },
                new String[] {
                    new String(argument.name),
                    new String(declaringClass.shortReadableName()),
                    new String(inheritedAnnotationName[inheritedAnnotationName.length - 1]) },
                sourceStart, argument.type.sourceEnd);
        }
    }

    public void parameterLackingNullableAnnotation(Argument argument, ReferenceBinding declaringClass,
        char[][] inheritedAnnotationName) {
        this.handle(IProblem.ParameterLackingNullableAnnotation,
            new String[] { new String(declaringClass.readableName()), CharOperation.toString(inheritedAnnotationName) },
            new String[] {
                new String(declaringClass.shortReadableName()),
                new String(inheritedAnnotationName[inheritedAnnotationName.length - 1]) },
            argument.type.sourceStart, argument.type.sourceEnd);
    }

    public void parameterLackingNonnullAnnotation(Argument argument, ReferenceBinding declaringClass,
        char[][] inheritedAnnotationName) {
        this.handle(IProblem.ParameterLackingNonNullAnnotation,
            new String[] { new String(declaringClass.readableName()), CharOperation.toString(inheritedAnnotationName) },
            new String[] {
                new String(declaringClass.shortReadableName()),
                new String(inheritedAnnotationName[inheritedAnnotationName.length - 1]) },
    ...
    public void inheritedParameterLackingNonnullAnnotation(MethodBinding currentMethod, int paramRank,
        ReferenceBinding specificationType, ASTNode location, char[][] annotationName) {
        this.handle(IProblem.InheritedParameterLackingNonNullAnnotation,
            new String[] {
                String.valueOf(paramRank),
                new String(currentMethod.readableName()),
                new String(specificationType.readableName()),
                CharOperation.toString(annotationName) },
            new String[] {
                String.valueOf(paramRank),
                new String(currentMethod.shortReadableName()),
                new String(specificationType.shortReadableName()),
                new String(annotationName[annotationName.length - 1]) },
            location.sourceStart, location.sourceEnd);
    }

    public void illegalParameterRedefinition(Argument argument, ReferenceBinding declaringClass,
        ...
        this.handle(IProblem.IllegalParameterNullityRedefinition,
            new String[] {
                new String(argument.name),
                new String(declaringClass.readableName()),
    ...
    public void illegalReturnRedefinition(AbstractMethodDeclaration abstractMethodDecl, MethodBinding inheritedMethod,
        ...
        if (this.options.usesNullTypeAnnotations()) {
            // 1.8+
            if (inheritedReturnType.isTypeVariable()
                && (inheritedReturnType.tagBits & TagBits.AnnotationNullMASK) == 0) {
    ...
    public void referenceExpressionArgumentNullityMismatch(ReferenceExpression location, TypeBinding requiredType,
        TypeBinding providedType, MethodBinding descriptorMethod, int idx, NullAnnotationMatching status) {
        StringBuilder methodSignature = new StringBuilder();
        methodSignature.append(descriptorMethod.declaringClass.readableName())
            .append('.')
            .append(descriptorMethod.readableName());
        StringBuilder shortSignature = new StringBuilder();
        shortSignature.append(descriptorMethod.declaringClass.shortReadableName())
            .append('.')
            .append(descriptorMethod.shortReadableName());
        this.handle(
            status.isUnchecked()
                ? IProblem.ReferenceExpressionParameterNullityUnchecked
                : IProblem.ReferenceExpressionParameterNullityMismatch,
            new String[] {
                idx == -1 ? "'this'" : String.valueOf(idx + 1), //$NON-NLS-1$
    ...
    public void illegalReturnRedefinition(ASTNode location, MethodBinding descriptorMethod, boolean isUnchecked,
        TypeBinding providedType) {
        StringBuilder methodSignature = new StringBuilder().append(descriptorMethod.declaringClass.readableName())
            .append('.')
            .append(descriptorMethod.readableName());
        StringBuilder shortSignature = new StringBuilder().append(descriptorMethod.declaringClass.shortReadableName())
            .append('.')
            .append(descriptorMethod.shortReadableName());
        this.handle(
            isUnchecked
    ...
    public void messageSendPotentialNullReference(MethodBinding method, ASTNode location) {
        ...
        this.handle(IProblem.PotentialNullMessageSendReference, arguments, arguments, location.sourceStart,
            location.sourceEnd);
    }

    public void messageSendRedundantCheckOnNonNull(MethodBinding method, ASTNode location) {
        String[] arguments = new String[] { new String(method.readableName()) };
        this.handle(IProblem.RedundantNullCheckOnNonNullMessageSend, arguments, arguments, location.sourceStart,
            location.sourceEnd);
    }

    public void expressionNullReference(ASTNode location) {
        this.handle(IProblem.NullExpressionReference, NoArgument, NoArgument, location.sourceStart, location.sourceEnd);
    }

    public void expressionPotentialNullReference(ASTNode location) {
        this.handle(IProblem.PotentialNullExpressionReference, NoArgument, NoArgument, location.sourceStart,
            location.sourceEnd);
    }

    public void cannotImplementIncompatibleNullness(ReferenceContext context, MethodBinding currentMethod,
        MethodBinding inheritedMethod, boolean showReturn) {
        if (currentMethod instanceof SyntheticMethodBinding synth
            && synth.purpose == SyntheticMethodBinding.RecordComponentReadAccess) {
            recordComponentOverrideIncompatibleNullness(synth.sourceRecordComponent(), inheritedMethod,
        ...
        String[] problemArguments = {
            showReturn ? new String(currentMethod.returnType.nullAnnotatedReadableName(this.options, false)) + ' ' : "", //$NON-NLS-1$
            new String(currentMethod.selector),
            typesAsString(currentMethod, false, true),
            new String(currentMethod.declaringClass.readableName()),
            new String(inheritedMethod.declaringClass.readableName()) };
        String[] messageArguments = {
            showReturn ? new String(currentMethod.returnType.nullAnnotatedReadableName(this.options, true)) + ' ' : "", //$NON-NLS-1$
            new String(currentMethod.selector),
            typesAsString(currentMethod, true, true),
            new String(currentMethod.declaringClass.shortReadableName()),
            new String(inheritedMethod.declaringClass.shortReadableName()) };
        this.handle(IProblem.CannotImplementIncompatibleNullness, problemArguments, messageArguments, sourceStart,
            sourceEnd);
    }

    public void recordComponentOverrideIncompatibleNullness(AbstractVariableDeclaration component,
        MethodBinding inheritedMethod, ReferenceBinding declaringClass) {
        Expression type = component.type;
        if (type.resolvedType == null || inheritedMethod.returnType == null)
            return;
        this.handle(IProblem.RecordComponentIncompatibleNullnessVsInheritedAccessor,
            new String[] {
    ...
    public void nullAnnotationIsRedundant(AbstractMethodDeclaration sourceMethod, int i) {
        ...
        this.handle(IProblem.RedundantNullAnnotation, ProblemHandler.NoArgument, ProblemHandler.NoArgument, sourceStart,
            sourceEnd);
    }
    ...
    public void contradictoryNullAnnotationsInferred(MethodBinding inferredMethod, int sourceStart, int sourceEnd,
        ...
        this.handle(isFunctionalExpression
            ? IProblem.ContradictoryNullAnnotationsInferredFunctionType
            : IProblem.ContradictoryNullAnnotationsInferred, arguments, shortArguments, sourceStart, sourceEnd);
    }

    public void contradictoryNullAnnotationsOnBounds(Annotation annotation, long previousTagBit) {
        char[][] annotationName = previousTagBit == TagBits.AnnotationNonNull
            ? this.options.nonNullAnnotationName
            : this.options.nullableAnnotationName;
        String[] arguments = { new String(CharOperation.concatWith(annotationName, '.')), };
        String[] shortArguments = { new String(annotationName[annotationName.length - 1]), };
        this.handle(IProblem.ContradictoryNullAnnotationsOnBound, arguments, shortArguments, annotation.sourceStart,
            annotation.sourceEnd);
    }

// conflict default <-> inherited
    public void conflictingNullAnnotations(MethodBinding currentMethod, ASTNode location,
        ...
        String[] shortArguments = {
            ...
            new String(nullableAnnotationName[nullableAnnotationName.length - 1]),
            new String(inheritedMethod.declaringClass.shortReadableName()) };
        this.handle(IProblem.ConflictingNullAnnotations, arguments, shortArguments, location.sourceStart,
            location.sourceEnd);
    }

// conflict between different inheriteds
    public void conflictingInheritedNullAnnotations(ASTNode location, boolean previousIsNonNull,
        MethodBinding previousInherited, boolean isNonNull, MethodBinding inheritedMethod) {
        char[][] previousAnnotationName
            = previousIsNonNull ? this.options.nonNullAnnotationName : this.options.nullableAnnotationName;
        ...
        String[] shortArguments = {
            ...
            new String(annotationName[annotationName.length - 1]),
            new String(inheritedMethod.declaringClass.shortReadableName()) };
        this.handle(IProblem.ConflictingInheritedNullAnnotations, arguments, shortArguments, location.sourceStart,
            location.sourceEnd);
    }
    ...
    public void illegalAnnotationForBaseType(TypeReference type, Annotation[] annotations, long nullAnnotationTagBit) {
        int typeBit = (nullAnnotationTagBit == TagBits.AnnotationNullable)
            ? TypeIds.BitNullableAnnotation
            : TypeIds.BitNonNullAnnotation;
        char[][] annotationNames = (nullAnnotationTagBit == TagBits.AnnotationNonNull)
            ? this.options.nonNullAnnotationName
            : this.options.nullableAnnotationName;
        String typeName = new String(type.resolvedType.leafComponentType().readableName()); // use the actual name
                                                                                            // (accounting for 'var')
        ...
        this.handle(IProblem.IllegalAnnotationForBaseType, args, args, start, end);
    }

    public void illegalAnnotationForBaseType(Annotation annotation, TypeBinding type) {
        String[] args
            = new String[] { new String(annotation.resolvedType.shortReadableName()), new String(type.readableName()) };
        this.handle(IProblem.IllegalAnnotationForBaseType, args, args, annotation.sourceStart, annotation.sourceEnd);
    }
...
// https://bugs.eclipse.org/bugs/show_bug.cgi?id=372012
    public void missingNonNullByDefaultAnnotation(TypeDeclaration type) {
        ...
        if (compUnitDecl.currentPackage == null) {
            ...
            // Default package
            TypeBinding binding = type.binding;
            this.handle(IProblem.MissingNonNullByDefaultAnnotationOnType,
            ...
            this.handle(IProblem.MissingNonNullByDefaultAnnotationOnPackage, arguments, arguments, severity,
                compUnitDecl.currentPackage.sourceStart, compUnitDecl.currentPackage.sourceEnd);
        }
    }

    public void illegalModifiersForElidedType(Argument argument) {
        String[] arg = new String[] { new String(argument.name) };
        this.handle(IProblem.IllegalModifiersForElidedType, arg, arg, argument.declarationSourceStart,
            argument.declarationSourceEnd);
    }

    public void illegalModifiers(int modifierSourceStart, int modifiersSourceEnd) {
        this.handle(IProblem.IllegalModifiers, NoArgument, NoArgument, modifierSourceStart, modifiersSourceEnd);
    }

    public void arrayReferencePotentialNullReference(ArrayReference arrayReference) {
        // TODO(stephan): merge with other expressions
        this.handle(IProblem.ArrayReferencePotentialNullReference, NoArgument, NoArgument, arrayReference.sourceStart,
            arrayReference.sourceEnd);

    }

    public void nonNullArrayContentNotInitialized(Expression dimension, LookupEnvironment lookupEnvironment,
        TypeBinding elementType) {
        this.handle(IProblem.NonNullArrayContentNotInitialized,
            ...
            ProblemSeverities.Info, dimension.sourceStart - 1, // optimistically try to include '[' and ']'
            dimension.sourceEnd + 1);
    }

    public void nullityMismatchingTypeAnnotation(Expression expression, TypeBinding providedType,
        TypeBinding requiredType, NullAnnotationMatching status) {
        ...
        if ((requiredType.tagBits & TagBits.AnnotationNonNull) != 0) { // some problems need a closer look to report the
            ...
            if (status.isPotentiallyNullMismatch() && (providedType.tagBits & TagBits.AnnotationNullable) == 0) {
                if (this.options.pessimisticNullAnalysisForFreeTypeVariablesEnabled
                    && providedType.isTypeVariable()
                    && !providedType.hasNullTypeAnnotations()) {
        ...
        if (status.superTypeHint != null && requiredType.isParameterizedType()) {
            ...
            if (problemId == IProblem.NullityMismatchAgainstFreeTypeVariable) {
                arguments = new String[] { null, null, new String(requiredType.sourceName()) }; // don't show bounds
                                                                                                // here
    ...
    public void nullityMismatchTypeArgument(TypeBinding typeVariable, TypeBinding typeArgument, ASTNode location) {
        ...
        this.handle(IProblem.NullityMismatchTypeArgument, arguments, shortArguments, location.sourceStart,
            location.sourceEnd);
    }
    ...
    public void cannotRedefineTypeArgumentNullity(TypeBinding typeVariable, Binding superElement, ASTNode location) {
        ...
        if (superElement instanceof MethodBinding) {
            ...
            arguments[1] = String
                .valueOf(CharOperation.concat(declaringClass.readableName(), superElement.shortReadableName(), '.'));
            shortArguments[1] = String.valueOf(
                CharOperation.concat(declaringClass.shortReadableName(), superElement.shortReadableName(), '.'));
        } else {
            arguments[1] = String.valueOf(superElement.readableName());
            shortArguments[1] = String.valueOf(superElement.shortReadableName());
        }
        this.handle(IProblem.IllegalRedefinitionOfTypeVariable, arguments, shortArguments, location.sourceStart,
            location.sourceEnd);
    }

    public void implicitObjectBoundNoNullDefault(TypeReference reference) {
        this.handle(IProblem.ImplicitObjectBoundNoNullDefault, NoArgument, NoArgument, ProblemSeverities.Warning,
            reference.sourceStart, reference.sourceEnd);
    }

    public void nonNullTypeVariableInUnannotatedBinary(LookupEnvironment environment, MethodBinding method,
        Expression expression, int providedSeverity) {
        ...
        if (declaredReturnType instanceof TypeVariableBinding) { // paranoia check
            ...
            if (typeVariable.declaringElement instanceof ReferenceBinding) {
                ...
                this.handle(IProblem.NonNullTypeVariableFromLegacyMethod, arguments, shortArguments, severity,
                    expression.sourceStart, expression.sourceEnd);
            } else if (typeVariable.declaringElement instanceof MethodBinding
                && method instanceof ParameterizedGenericMethodBinding) {
                TypeBinding substitution
                    = ((ParameterizedGenericMethodBinding) method).typeArguments[typeVariable.rank];
                String[] arguments = new String[] {
                    shortNonNullName,
                ...
                String[] shortArguments = {
                    ...
                    String.valueOf(declaringClass.original().shortReadableName()) };
                this.handle(IProblem.NonNullMethodTypeVariableFromLegacyMethod, arguments, shortArguments, severity,
                    expression.sourceStart, expression.sourceEnd);
            }
        }
    }
    ...
    public void dereferencingNullableExpression(long positions, LookupEnvironment env) {
        ...
        char[] nullableShort = nullableName[nullableName.length - 1];
        String[] arguments = { String.valueOf(nullableShort) };
        this.handle(IProblem.DereferencingNullableExpression, arguments, arguments, (int) (positions >>> 32),
            (int) (positions));
    }

    public void onlyReferenceTypesInIntersectionCast(TypeReference typeReference) {
        this.handle(IProblem.IllegalBasetypeInIntersectionCast, NoArgument, NoArgument, typeReference.sourceStart,
            typeReference.sourceEnd);
    }

    public void illegalArrayTypeInIntersectionCast(TypeReference typeReference) {
        this.handle(IProblem.IllegalArrayTypeInIntersectionCast, NoArgument, NoArgument, typeReference.sourceStart,
            typeReference.sourceEnd);
    }

    public void duplicateBoundInIntersectionCast(TypeReference typeReference) {
        this.handle(IProblem.DuplicateBoundInIntersectionCast, NoArgument, NoArgument, typeReference.sourceStart,
            typeReference.sourceEnd);
    }

    public void lambdaRedeclaresArgument(Argument argument) {
        String[] arguments = new String[] { new String(argument.name) };
        this.handle(IProblem.LambdaRedeclaresArgument, arguments, arguments, argument.sourceStart, argument.sourceEnd);
    }

    public void lambdaRedeclaresLocal(LocalDeclaration local) {
        String[] arguments = new String[] { new String(local.name) };
        this.handle(IProblem.LambdaRedeclaresLocal, arguments, arguments, local.sourceStart, local.sourceEnd);
    }

    public void descriptorHasInvisibleType(FunctionalExpression expression, ReferenceBinding referenceBinding) {
        this.handle(IProblem.LambdaDescriptorMentionsUnmentionable,
            new String[] { new String(referenceBinding.readableName()) },
            new String[] { new String(referenceBinding.shortReadableName()) }, expression.sourceStart,
            expression.diagnosticsSourceEnd());
    }

    public void methodReferenceSwingsBothWays(ReferenceExpression expression, MethodBinding instanceMethod,
    ...
    public void invalidArrayConstructorReference(ReferenceExpression expression, TypeBinding lhsType,
        ...
        this.handle(id, new String[] { new String(lhsType.readableName()), buffer.toString() },
            new String[] { new String(lhsType.shortReadableName()), shortBuffer.toString() }, expression.sourceStart,
            expression.sourceEnd);
    }

    public void constructedArrayIncompatible(ReferenceExpression expression, TypeBinding receiverType,
        TypeBinding returnType) {
        this.handle(IProblem.ConstructedArrayIncompatible,
    ...
    public void danglingReference(ReferenceExpression expression, TypeBinding receiverType, char[] selector,
    ...
    public void unhandledException(TypeBinding exceptionType, ReferenceExpression location) {
        this.handle(IProblem.UnhandledException, new String[] { new String(exceptionType.readableName()) },
            new String[] { new String(exceptionType.shortReadableName()) }, location.sourceStart, location.sourceEnd);
    }
    ...
    public void illegalSuperAccess(TypeBinding superType, TypeBinding directSuperType, ASTNode location) {
        ...
        handle(IProblem.SuperAccessCannotBypassDirectSuper,
            ...
            new String[] {
                String.valueOf(superType.shortReadableName()),
                String.valueOf(directSuperType.shortReadableName()) },
            location.sourceStart, location.sourceEnd);
    }

    public void illegalSuperCallBypassingOverride(InvocationSite location, MethodBinding targetMethod,
        ReferenceBinding overrider) {
        this.handle(IProblem.SuperCallCannotBypassOverride,
            new String[] {
                String.valueOf(targetMethod.readableName()),
    ...
    public void disallowedTargetForContainerAnnotation(Annotation annotation, TypeBinding containerAnnotationType) {
        this.handle(IProblem.DisallowedTargetForContainerAnnotationType,
            new String[] {
                new String(annotation.resolvedType.readableName()),
                new String(containerAnnotationType.readableName()) },
            new String[] {
    ...
    public void uninternedIdentityComparison(EqualExpression expr, TypeBinding lhs, TypeBinding rhs,
        ...
        if (validIdentityComparisonLines != null) {
            ...
            int lineNumber = problemStartPosition >= 0
                ? Util.getLineNumber(problemStartPosition,
                    lineEnds = unit.compilationResult().getLineSeparatorPositions(), 0, lineEnds.length - 1)
                : 0;
            if (lineNumber <= validIdentityComparisonLines.length && validIdentityComparisonLines[lineNumber - 1])
                return;
        }

        this.handle(IProblem.UninternedIdentityComparison,
            new String[] { new String(lhs.readableName()), new String(rhs.readableName()) },
            new String[] { new String(lhs.shortReadableName()), new String(rhs.shortReadableName()) }, expr.sourceStart,
            expr.sourceEnd);
    }

    public void invalidTypeArguments(TypeReference[] typeReference) {
        this.handle(IProblem.InvalidTypeArguments, NoArgument, NoArgument, typeReference[0].sourceStart,
    ...
    public void moduleNotFound(CompilationUnitDeclaration compilationUnitDeclaration, char[] moduleName) {
        ...
        ASTNode location = (compilationUnitDeclaration.currentPackage != null)
    ...
    public void invalidOpensStatement(OpensStatement statement, ModuleDeclaration module) {
        this.handle(IProblem.InvalidOpensStatement, NoArgument,
            new String[] { CharOperation.charToString(module.moduleName) }, statement.declarationSourceStart,
            statement.declarationSourceEnd);
    }
    ...
    public void invalidPackageReference(int problem, PackageVisibilityStatement ref) {
        ...
        this.handle(problem, arguments, arguments, ref.computeSeverity(problem), ref.pkgRef.sourceStart,
            ref.pkgRef.sourceEnd);
    }

    public void exportingForeignPackage(PackageVisibilityStatement ref, ModuleBinding enclosingModule) {
        String[] arguments = new String[] {
            CharOperation.charToString(ref.pkgName),
            CharOperation.charToString(enclosingModule.moduleName) };
        this.handle(IProblem.ExportingForeignPackage, arguments, arguments, ref.pkgRef.sourceStart,
            ref.pkgRef.sourceEnd);
    }

    public void duplicateModuleReference(int problem, ModuleReference ref) {
        this.handle(problem, NoArgument, new String[] { CharOperation.charToString(ref.moduleName) }, ref.sourceStart,
            ref.sourceEnd);
    }
    ...
    public void duplicateTypeReference(int problem, TypeReference ref1, TypeReference ref2) {
        this.handle(problem, NoArgument, new String[] { ref1.toString(), ref2.toString() }, ref1.sourceStart,
            ref2.sourceEnd);
    }

    public void duplicateResourceReference(Reference ref) {
        this.handle(IProblem.DuplicateResource, NoArgument, new String[] { ref.toString() }, ProblemSeverities.Warning,
            ref.sourceStart, ref.sourceEnd);
    }

    public void cyclicModuleDependency(ModuleBinding binding, ModuleReference ref) {
        this.handle(IProblem.CyclicModuleDependency, NoArgument,
            new String[] { CharOperation.charToString(binding.moduleName), CharOperation.charToString(ref.moduleName) },
            ref.sourceStart, ref.sourceEnd);
    }

    public void invalidServiceRef(int problem, TypeReference type) {
        this.handle(problem, NoArgument, new String[] { CharOperation.charToString(type.resolvedType.readableName()) },
            type.sourceStart, type.sourceEnd);
    }
    ...
    public void modifierRequiresJavaBase(RequiresStatement stat, JavaFeature moduleImports) {
        if (moduleImports != null) {
            ...
            if (moduleImports.matchesCompliance(this.options)) {
                this.handle(IProblem.ModifierOnRequiresJavaBasePreview, NoArgument, NoArgument,
                    stat.modifiersSourceStart, stat.sourceEnd);
                return;
            }
        }
        this.handle(IProblem.ModifierOnRequiresJavaBase, NoArgument, NoArgument, stat.modifiersSourceStart,
            stat.sourceEnd);
    }
    ...
    public void unlikelyArgumentType(Expression argument, MethodBinding method, TypeBinding argumentType,
        ...
        this.handle(
            dangerousMethod == DangerousMethod.Equals
                ? IProblem.UnlikelyEqualsArgumentType
                : IProblem.UnlikelyCollectionMethodArgumentType,
            new String[] {
                new String(argumentType.readableName()),
    ...
    public void nonPublicTypeInAPI(TypeBinding type, int sourceStart, int sourceEnd) {
        handle(IProblem.NonPublicTypeInAPI, new String[] { new String(type.readableName()) },
            new String[] { new String(type.shortReadableName()) }, sourceStart, sourceEnd);
    }

    public void notExportedTypeInAPI(TypeBinding type, int sourceStart, int sourceEnd) {
        handle(IProblem.NotExportedTypeInAPI, new String[] { new String(type.readableName()) },
            new String[] { new String(type.shortReadableName()) }, sourceStart, sourceEnd);
    }

    public void missingRequiresTransitiveForTypeInAPI(ReferenceBinding referenceBinding, int sourceStart,
        int sourceEnd) {
        ...
        handle(IProblem.MissingRequiresTransitiveForTypeInAPI,
            ...
            new String[] { new String(referenceBinding.shortReadableName()), moduleName }, sourceStart, sourceEnd);
    }

    public void unnamedPackageInNamedModule(ModuleBinding module) {
        String[] args = { new String(module.readableName()) };
        handle(IProblem.UnnamedPackageInNamedModule, args, args, 0, 0);
    }

    public void autoModuleWithUnstableName(ModuleReference moduleReference) {
        String[] args = { new String(moduleReference.moduleName) };
        handle(IProblem.UnstableAutoModuleName, args, args, moduleReference.sourceStart, moduleReference.sourceEnd);
    }

    public void conflictingPackageInModules(char[][] wellKnownTypeName, CompilationUnitDeclaration compUnitDecl,
        Object location, char[] packageName, char[] expectedModuleName, char[] conflictingModuleName) {
        ReferenceContext savedContext = this.referenceContext;
        this.referenceContext = compUnitDecl;
        String[] arguments = new String[] {
            CharOperation.toString(wellKnownTypeName),
        ...
        try {
            ...
            this.referenceContext = savedContext; // unsure from which phase we are called, so better to reset to
                                                  // previous
        }
    }

    public void moduleDoesNotReadOther(ImportReference importReference, ModuleBinding currentModule,
        ModuleBinding otherModule) {
        String[] arguments
            = new String[] { String.valueOf(currentModule.moduleName), String.valueOf(otherModule.moduleName) };
        this.handle(IProblem.ModuleNotRead, arguments, arguments, importReference.sourceStart,
            importReference.sourceEnd);
    }

    public void incompatibleSwitchExpressionResults(ASTNode expression) {
        this.handle(IProblem.SwitchExpressionsYieldIncompatibleResultExpressionTypes, NoArgument, NoArgument,
            expression.sourceStart, expression.sourceEnd);
    }

    public void unyieldingSwitchExpression(ASTNode expression) {
        this.handle(IProblem.SwitchExpressionsYieldNoResultExpression, NoArgument, NoArgument, expression.sourceStart,
            expression.sourceEnd);
    }

    public void switchExpressionBlockCompletesNormally(Statement stmt) {
        this.handle(IProblem.SwitchExpressionaYieldSwitchLabeledBlockCompletesNormally, NoArgument, NoArgument,
            stmt.sourceEnd - 1, stmt.sourceEnd);
    }
    ...
    public void arrowColonMixup(ASTNode statement) {
        ...
        if (result != null && result.hasSyntaxError)
            return;  // Diagnose parser's "repair" can cause this mixup where there is none in source, CU is rejected
                     // anyway
        this.handle(IProblem.SwitchPreviewMixedCase, NoArgument, NoArgument, statement.sourceStart,
            statement.sourceEnd);
    }

    public void unqualifiedYieldMethod(ASTNode statement) {
        this.handle(IProblem.SwitchExpressionsYieldUnqualifiedMethodError, NoArgument, NoArgument,
            statement.sourceStart, statement.sourceEnd);
    }

    public void yieldOutsideSwitchExpression(ASTNode statement) {
        this.handle(IProblem.SwitchExpressionsYieldOutsideSwitchExpression, NoArgument, NoArgument,
            statement.sourceStart, statement.sourceEnd);
    }

    public void multiConstantCaseLabelsNotSupported(ASTNode statement) {
        this.handle(IProblem.MultiConstantCaseLabelsNotSupported, NoArgument, NoArgument, statement.sourceStart,
            statement.sourceEnd);
    }

    public void arrowInCaseStatementsNotSupported(ASTNode statement) {
        this.handle(IProblem.ArrowInCaseStatementsNotSupported, NoArgument, NoArgument, statement.sourceStart,
            statement.sourceEnd);
    }

    public void switchExpressionsNotSupported(ASTNode statement) {
        this.handle(IProblem.SwitchExpressionsNotSupported, NoArgument, NoArgument, statement.sourceStart,
            statement.sourceEnd);
    }

    public void breakOutOfSwitchExpression(ASTNode statement) {
        this.handle(IProblem.SwitchExpressionsBreakOutOfSwitchExpression, NoArgument, NoArgument, statement.sourceStart,
            statement.sourceEnd);
    }

    public void continueOutOfSwitchExpression(ASTNode statement) {
        this.handle(IProblem.SwitchExpressionsContinueOutOfSwitchExpression, NoArgument, NoArgument,
            statement.sourceStart, statement.sourceEnd);
    }

    public void returnOutOfSwitchExpression(ASTNode statement) {
        this.handle(IProblem.SwitchExpressionsReturnWithinSwitchExpression, NoArgument, NoArgument,
            statement.sourceStart, statement.sourceEnd);
    }

    public void illegalModifierForLocalRecord(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.RecordIllegalModifierForLocalRecord, arguments, arguments, type.sourceStart(),
            type.sourceEnd());
    }

    public void illegalModifierForInnerRecord(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.RecordIllegalModifierForInnerRecord, arguments, arguments, type.sourceStart(),
            type.sourceEnd());
    }

    public void illegalModifierForRecord(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.RecordIllegalModifierForRecord, arguments, arguments, type.sourceStart(),
            type.sourceEnd());
    }

    public void nonStaticFieldDeclarationInRecord(FieldDeclaration field) {
        this.handle(IProblem.RecordNonStaticFieldDeclarationInRecord, new String[] { new String(field.name) },
            new String[] { new String(field.name) }, field.sourceStart, field.sourceEnd);
    }

    public void componentAccessorMethodHasThrowsClause(ASTNode methodDeclaration) {
        this.handle(IProblem.RecordAccessorMethodHasThrowsClause, NoArgument, NoArgument, methodDeclaration.sourceStart,
            methodDeclaration.sourceEnd);
    }

    public void canonicalConstructorVisibilityReduced(AbstractMethodDeclaration methodDecl) {
        this.handle(IProblem.RecordCanonicalConstructorVisibilityReduced,
            new String[] { new String(methodDecl.selector) }, new String[] { new String(methodDecl.selector) },
            methodDecl.sourceStart, methodDecl.sourceEnd);
    }

    public void compactConstructorHasReturnStatement(ReturnStatement stmt) {
        this.handle(IProblem.RecordCompactConstructorHasReturnStatement, NoArgument, NoArgument, stmt.sourceStart,
            stmt.sourceEnd);
    }

    public void compactConstructorsOnlyInRecords(AbstractMethodDeclaration ccd) {
        this.handle(IProblem.CompactConstructorOnlyInRecords, NoArgument, NoArgument, ccd.sourceStart, ccd.sourceEnd);
    }

    public void illegalComponentNameInRecord(RecordComponent recComp, TypeDeclaration typeDecl) {
        this.handle(IProblem.RecordIllegalComponentNameInRecord,
            new String[] { new String(recComp.name), new String(typeDecl.name) },
            new String[] { new String(recComp.name), new String(typeDecl.name) }, recComp.sourceStart,
            recComp.sourceEnd);
    }

    public void duplicateRecordComponent(RecordComponent recordComponent) {
        this.handle(IProblem.RecordDuplicateComponent, new String[] { new String(recordComponent.name) },
            new String[] { new String(recordComponent.name) }, recordComponent.sourceStart, recordComponent.sourceEnd);
    }

    public void nativeMethodIllegalInRecord(AbstractMethodDeclaration method) {
        this.handle(IProblem.RecordIllegalNativeModifierInRecord, new String[] { new String(method.selector) },
            new String[] { new String(method.selector) }, method.sourceStart, method.sourceEnd);
    }

    public void instanceInitializerBlockIllegalInRecord(Initializer initializer) {
        this.handle(IProblem.RecordInstanceInitializerBlockInRecord, NoArgument, NoArgument, initializer.sourceStart,
            initializer.sourceEnd);
    }

    public void restrictedTypeName(char[] name, String compliance, int start, int end, int severity) {
        this.handle(IProblem.RestrictedTypeName, new String[] { new String(name), compliance },
            new String[] { new String(name), compliance }, severity, start, end);
    }

    public void componentAccessorReturnTypeMismatch(ASTNode returnType, TypeBinding type) {
        this.handle(IProblem.RecordIllegalAccessorReturnType, new String[] { new String(type.readableName()) },
            new String[] { new String(type.shortReadableName()) }, returnType.sourceStart, returnType.sourceEnd);
    }

    public void componentAccessorMethodShouldNotBeGeneric(ASTNode methodDecl) {
        this.handle(IProblem.RecordAccessorMethodShouldNotBeGeneric, NoArgument, NoArgument, methodDecl.sourceStart,
            methodDecl.sourceEnd);
    }

    public void componentAccessorMethodShouldBePublic(ASTNode methodDecl) {
        this.handle(IProblem.RecordAccessorMethodShouldBePublic, NoArgument, NoArgument, methodDecl.sourceStart,
            methodDecl.sourceEnd);
    }

    public void canonicalConstructorShouldNotBeGeneric(AbstractMethodDeclaration methodDecl) {
        this.handle(IProblem.RecordCanonicalConstructorShouldNotBeGeneric,
            new String[] { new String(methodDecl.selector) }, new String[] { new String(methodDecl.selector) },
            methodDecl.sourceStart, methodDecl.sourceEnd);
    }

    public void canonicalConstructorHasThrowsClause(AbstractMethodDeclaration methodDecl) {
        this.handle(IProblem.RecordCanonicalConstructorHasThrowsClause,
            new String[] { new String(methodDecl.selector) }, new String[] { new String(methodDecl.selector) },
            methodDecl.sourceStart, methodDecl.sourceEnd);
    }

    public void canonicalConstructorHasExplicitConstructorCall(ASTNode methodDecl) {
        this.handle(IProblem.RecordCanonicalConstructorHasExplicitConstructorCall, NoArgument, NoArgument,
            methodDecl.sourceStart, methodDecl.sourceEnd);
    }

    public void compactConstructorHasExplicitConstructorCall(ASTNode methodDecl) {
        this.handle(IProblem.RecordCompactConstructorHasExplicitConstructorCall, NoArgument, NoArgument,
            methodDecl.sourceStart, methodDecl.sourceEnd);
    }

    public void componentAccessorMethodShouldNotBeStatic(ASTNode methodDecl) {
        this.handle(IProblem.RecordAccessorMethodShouldNotBeStatic, NoArgument, NoArgument, methodDecl.sourceStart,
            methodDecl.sourceEnd);
    }
    ...
    public void cannotExtendRecord(SourceTypeBinding type, TypeReference superclass, TypeBinding superTypeBinding) {
        ...
        if (superTypeShortName.equals(name))
            superTypeShortName = superTypeFullName;
        this.handle(IProblem.RecordCannotExtendRecord, new String[] { superTypeFullName, name },
            new String[] { superTypeShortName, name }, superclass.sourceStart, superclass.sourceEnd);
    }

    public void onlyLastRecordComponentMaybeVararg(RecordComponent argType, TypeDeclaration typeDecl) {
        String[] arguments
            = new String[] { CharOperation.toString(argType.type.getTypeName()), new String(typeDecl.name) };
        this.handle(IProblem.RecordIllegalVararg, arguments, arguments, argType.sourceStart, argType.sourceEnd);
    }

    public void recordStaticReferenceToOuterLocalVariable(LocalVariableBinding local, ASTNode node) {
        String[] arguments = new String[] { new String(local.readableName()) };
        this.handle(IProblem.RecordStaticReferenceToOuterLocalVariable, arguments, arguments, node.sourceStart,
            node.sourceEnd);
    }

    public void recordComponentsCannotHaveModifiers(RecordComponent comp) {
        String[] arguments = new String[] { new String(comp.name) };
        this.handle(IProblem.RecordComponentsCannotHaveModifiers, arguments, arguments, comp.sourceStart,
            comp.sourceEnd);
    }

    public void mismatchedParameterNameInCanonicalConstructor(RecordComponentBinding comp, Argument arg) {
        this.handle(IProblem.RecordIllegalParameterNameInCanonicalConstructor,
            new String[] { new String(arg.name), new String(comp.name) },
            new String[] { new String(arg.name), new String(comp.name) }, arg.sourceStart, arg.sourceEnd);
    }
    ...
    public void illegalExplicitAssignmentInCompactConstructor(FieldBinding field, FieldReference fieldRef) {
        ...
        this.handle(IProblem.RecordIllegalExplicitFinalFieldAssignInCompactConstructor, arguments, arguments,
    ...
    public void missingExplicitConstructorCallInNonCanonicalConstructor(ASTNode location) {
        this.handle(IProblem.RecordMissingExplicitConstructorCallInNonCanonicalConstructor, NoArgument, NoArgument,
            location.sourceStart, location.sourceEnd);
    }

    public void recordIllegalStaticModifierForLocalClassOrInterface(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.RecordIllegalStaticModifierForLocalClassOrInterface, arguments, arguments,
            type.sourceStart(), type.sourceEnd());
    }

    public void illegalExtendedDimensionsForRecordComponent(AbstractVariableDeclaration aVarDecl) {
        this.handle(IProblem.RecordIllegalExtendedDimensionsForRecordComponent, NoArgument, NoArgument,
            aVarDecl.sourceStart, aVarDecl.sourceEnd);
    }

    public void localStaticsIllegalVisibilityModifierForInterfaceLocalType(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.LocalStaticsIllegalVisibilityModifierForInterfaceLocalType, arguments, arguments,
            type.sourceStart(), type.sourceEnd());
    }

    public void illegalModifierForLocalEnumDeclaration(SourceTypeBinding type) {
        String[] arguments = new String[] { new String(type.sourceName()) };
        this.handle(IProblem.IllegalModifierForLocalEnumDeclaration, arguments, arguments, type.sourceStart(),
            type.sourceEnd());
    }

    public void permittedTypeNeedsModifier(SourceTypeBinding type, TypeDeclaration typeDecl,
        TypeBinding superTypeBinding) {
        String name = new String(type.sourceName());
        String superTypeFullName = new String(superTypeBinding.readableName());
        String superTypeShortName = new String(superTypeBinding.shortReadableName());
        if (superTypeShortName.equals(name))
            superTypeShortName = superTypeFullName;
        this.handle(type.isClass() ? IProblem.SealedMissingClassModifier : IProblem.SealedMissingInterfaceModifier,
            new String[] { superTypeFullName, name }, new String[] { superTypeShortName, name }, typeDecl.sourceStart,
            typeDecl.sourceEnd);
    }
    ...
    public void disallowedNonSealedModifier(SourceTypeBinding type, TypeDeclaration typeDecl) {
        ...
        this.handle(
            ...
            new String[] { name }, new String[] { name }, typeDecl.sourceStart, typeDecl.sourceEnd);
    }

    public void sealedSupertypeDoesNotPermit(SourceTypeBinding type, TypeReference superType,
        TypeBinding superTypeBinding) {
        String name = new String(type.sourceName());
        String superTypeFullName = new String(superTypeBinding.readableName());
        String superTypeShortName = new String(superTypeBinding.shortReadableName());
        ...
        if (superTypeBinding.isClass()) {
            this.handle(IProblem.SealedSuperClassDoesNotPermit, new String[] { name, superTypeFullName },
                new String[] { name, superTypeShortName }, superType.sourceStart, superType.sourceEnd);
        } else {
            String keyword
                = type.isClass() ? new String(TypeConstants.IMPLEMENTS) : new String(TypeConstants.KEYWORD_EXTENDS);
            this.handle(IProblem.SealedSuperInterfaceDoesNotPermit, new String[] { name, superTypeFullName, keyword },
                new String[] { name, superTypeShortName, keyword }, superType.sourceStart, superType.sourceEnd);
        }
    }

    public void missingSealedModifier(SourceTypeBinding type, ASTNode node) {
        String name = new String(type.sourceName());
        this.handle(IProblem.SealedMissingSealedModifier, new String[] { name }, new String[] { name },
            node.sourceStart, node.sourceEnd);
    }

    public void duplicatePermittedType(TypeReference reference, ReferenceBinding superType) {
        this.handle(IProblem.SealedDuplicateTypeInPermits, new String[] { new String(superType.readableName()) },
            new String[] { new String(superType.shortReadableName()) }, reference.sourceStart, reference.sourceEnd);
    }

    public void sealedClassNotDirectSuperClassOf(ReferenceBinding type, TypeReference reference,
        SourceTypeBinding superType) {
        if ((type.tagBits & TagBits.HierarchyHasProblems) == 0
            && (superType.tagBits & TagBits.HierarchyHasProblems) == 0) {
    ...
    public void permittedTypeOutsideOfModule(ReferenceBinding permType, ReferenceBinding sealedType, ASTNode node,
        ...
        this.handle(IProblem.SealedPermittedTypeOutsideOfModule, arguments, arguments, node.sourceStart,
            node.sourceEnd);
    }

    public void permittedTypeOutsideOfPackage(ReferenceBinding permType, ReferenceBinding sealedType, ASTNode node,
        ...
        this.handle(IProblem.SealedPermittedTypeOutsideOfPackage, arguments, arguments, node.sourceStart,
            node.sourceEnd);
    }

    public void missingPermitsClause(SourceTypeBinding type, ASTNode node) {
        String name = new String(type.sourceName());
        this.handle(IProblem.SealedSealedTypeMissingPermits, new String[] { name }, new String[] { name },
            node.sourceStart, node.sourceEnd);
    }

    public void sealedInterfaceNotDirectSuperInterfaceOf(ReferenceBinding type, TypeReference reference,
        SourceTypeBinding superType) {
        if ((type.tagBits & TagBits.HierarchyHasProblems) == 0
            && (superType.tagBits & TagBits.HierarchyHasProblems) == 0) {
    ...
    public void localTypeMayNotBePermittedType(SourceTypeBinding type, TypeReference superclass,
        TypeBinding superTypeBinding) {
        String name = new String(type.sourceName());
        String superTypeFullName = new String(superTypeBinding.readableName());
        String superTypeShortName = new String(superTypeBinding.shortReadableName());
        if (superTypeShortName.equals(name))
            superTypeShortName = superTypeFullName;
        this.handle(IProblem.SealedLocalDirectSuperTypeSealed, new String[] { superTypeFullName, name },
            new String[] { superTypeShortName, name }, superclass.sourceStart, superclass.sourceEnd);
    }

    public void anonymousClassCannotExtendSealedType(TypeReference reference, TypeBinding type) {
        this.handle(IProblem.SealedAnonymousClassCannotExtendSealedType,
            new String[] { new String(type.readableName()) }, new String[] { new String(type.shortReadableName()) },
            reference.sourceStart, reference.sourceEnd);
    }
    ...
    public void functionalInterfaceMayNotBeSealed(TypeDeclaration type) {
        TypeBinding binding = type.binding;
        this.handle(IProblem.FunctionalInterfaceMayNotbeSealed, new String[] { new String(binding.readableName()), },
            new String[] { new String(binding.shortReadableName()), }, type.sourceStart, type.sourceEnd);
    }

    public void StrictfpNotRequired(int sourceStart, int sourceEnd) {
        this.handle(IProblem.StrictfpNotRequired, NoArgument, NoArgument, sourceStart, sourceEnd);
    }

    public void IllegalFallThroughToPattern(Statement statement) {
        this.handle(IProblem.IllegalFallthroughToPattern, NoArgument, NoArgument, statement.sourceStart,
            statement.sourceEnd);
    }

    public void illegalFallthroughFromAPattern(Statement statement) {
        this.handle(IProblem.IllegalFallthroughFromAPattern, NoArgument, NoArgument, statement.sourceStart,
            statement.sourceEnd);
    }

    public void namedPatternVariablesDisallowedHere(LocalDeclaration variableDeclaration) {
        this.handle(IProblem.NamedPatternVariablesDisallowedHere, NoArgument, NoArgument,
            variableDeclaration.sourceStart, variableDeclaration.sourceEnd);
    }

    public void illegalCaseConstantCombination(Expression element) {
        this.handle(IProblem.ConstantWithPatternIncompatible, NoArgument, NoArgument, element.sourceStart,
            element.sourceEnd);
    }

    public void patternSwitchNullOnlyOrFirstWithDefault(Expression element) {
        this.handle(IProblem.PatternSwitchNullOnlyOrFirstWithDefault, NoArgument, NoArgument, element.sourceStart,
            element.sourceEnd);
    }

    public void patternSwitchCaseDefaultOnlyAsSecond(Expression element) {
        this.handle(IProblem.PatternSwitchCaseDefaultOnlyAsSecond, NoArgument, NoArgument, element.sourceStart,
            element.sourceEnd);
    }

    public void patternDominatedByAnother(Expression element) {
        this.handle(IProblem.PatternDominated, NoArgument, NoArgument, element.sourceStart, element.sourceEnd);
    }

    public void illegalTotalPatternWithDefault(Statement element) {
        this.handle(IProblem.IllegalTotalPatternWithDefault, NoArgument, NoArgument, element.sourceStart,
            element.sourceEnd);
    }

    public void enhancedSwitchMissingDefaultCase(ASTNode element) {
        this.handle(IProblem.EnhancedSwitchMissingDefault, NoArgument, NoArgument, element.sourceStart,
            element.sourceEnd);
    }

    public void unexpectedTypeinSwitchPattern(TypeBinding type, ASTNode element) {
        this.handle(IProblem.UnexpectedTypeinSwitchPattern, new String[] { new String(type.readableName()) },
            new String[] { new String(type.shortReadableName()) }, element.sourceStart, element.sourceEnd);
    }

    public void unexpectedTypeinRecordPattern(ASTNode element) {
        this.handle(IProblem.UnexpectedTypeinRecordPattern, NoArgument, NoArgument, element.sourceStart,
            element.sourceEnd);
    }

    public void recordPatternSignatureMismatch(TypeBinding type, ASTNode element) {
        this.handle(IProblem.RecordPatternMismatch, new String[] { new String(type.readableName()) },
            new String[] { new String(type.shortReadableName()) }, element.sourceStart, element.sourceEnd);
    }

    public void cannotInferRecordPatternTypes(RecordPattern pattern) {
        String arguments[] = new String[] { pattern.toString() };
        this.handle(IProblem.CannotInferRecordPatternTypes, arguments, arguments, pattern.sourceStart,
            pattern.sourceEnd);
    }

    public void falseLiteralInGuard(Expression exp) {
        this.handle(IProblem.FalseConstantInGuard, NoArgument, NoArgument, exp.sourceStart, exp.sourceEnd);
    }

    public void unnamedVariableMustHaveInitializer(LocalDeclaration variableDeclaration) {
        this.handle(IProblem.UnnamedVariableMustHaveInitializer, NoArgument, NoArgument,
            variableDeclaration.sourceStart, variableDeclaration.sourceEnd);
    }
    ...
    public void errorExpressionInEarlyConstructionContext(Expression expr) {
        ...
        this.handle(
            ...
            arguments, arguments, expr.sourceStart, expr.sourceEnd);
    }
    ...
    public void messageSendInEarlyConstructionContext(MessageSend location) {
        ...
        this.handle(IProblem.MessageSendInEarlyConstructionContext, arguments, arguments, location.sourceStart,
            location.sourceEnd);
    }

    public void allocationInEarlyConstructionContext(Expression expr, TypeBinding allocatedType,
        TypeBinding uninitializedType) {
        this.handle(IProblem.AllocationInEarlyConstructionContext,
            new String[] {
                String.valueOf(allocatedType.readableName()),
                String.valueOf(uninitializedType.readableName()) },
            new String[] {
                String.valueOf(allocatedType.shortReadableName()),
                String.valueOf(uninitializedType.shortReadableName()) },
            expr.sourceStart, expr.sourceEnd);
    }

    public void allocationInStaticContext(ASTNode location, LocalTypeBinding allocatedType) {
        this.handle(IProblem.AllocatingLocalInStaticContext,
            new String[] { String.valueOf(allocatedType.readableName()) },
            new String[] { String.valueOf(allocatedType.shortReadableName()) }, location.sourceStart,
            location.sourceEnd);
    }

    public void fieldReadInEarlyConstructionContext(char[] token, int sourceStart, int sourceEnd) {
        String[] arguments = new String[] { String.valueOf(token) };
        this.handle(IProblem.FieldReadInEarlyConstructionContext, arguments, arguments, sourceStart, sourceEnd);
    }

    public void superFieldAssignInEarlyConstructionContext(ASTNode location, FieldBinding field) {
        this.handle(IProblem.SuperFieldAssignInEarlyConstructionContext,
    ...
    public void assignFieldWithInitializerInEarlyConstructionContext(char[] token, int sourceStart, int sourceEnd) {
        String[] arguments = new String[] { String.valueOf(token) };
        this.handle(IProblem.AssignFieldWithInitializerInEarlyConstructionContext, arguments, arguments, sourceStart,
            sourceEnd);
    }

    public void fieldAssignInEarlyConstructionContextInLambda(ASTNode location, FieldBinding field) {
        this.handle(IProblem.SuperFieldAssignInEarlyConstructionContextLambda,
            new String[] { String.valueOf(field.name), String.valueOf(field.declaringClass.readableName()) },
            new String[] { String.valueOf(field.name), String.valueOf(field.declaringClass.shortReadableName()) },
            location.sourceStart, location.sourceEnd);
    }
    ...
    public void errorReturnInEarlyConstructionContext(Statement stmt) {
        ...
        this.handle(IProblem.DisallowedStatementInEarlyConstructionContext, arguments, arguments, stmt.sourceStart,
            stmt.sourceEnd);
    }

    public void implicitClassMissingMainMethod(TypeDeclaration typeDeclaration) {
        this.handle(IProblem.ImplicitClassMissingMainMethod, NoArgument, NoArgument, typeDeclaration.sourceStart,
            typeDeclaration.sourceStart);
    }

    public void dimensionsIllegalOnRecordPattern(int sourceStart, int sourceEnd) {
        this.handle(IProblem.DimensionsIllegalOnRecordPattern, NoArgument, NoArgument, sourceStart, sourceEnd);
    }
