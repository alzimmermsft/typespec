...
final class AutoValue_JavaFormatterOptions extends JavaFormatterOptions {
    ...
    private AutoValue_JavaFormatterOptions(boolean formatJavadoc, boolean reorderModifiers, Style style) {
    ...
    public String toString() {
        return "JavaFormatterOptions{" + "formatJavadoc=" + formatJavadoc + ", " + "reorderModifiers="
            + reorderModifiers + ", " + "style=" + style + "}";
    }
    ...
    static final class Builder extends JavaFormatterOptions.Builder {
        ...
        public JavaFormatterOptions build() {
            if (this.formatJavadoc == null || this.reorderModifiers == null || this.style == null) {
            ...
            return new AutoValue_JavaFormatterOptions(this.formatJavadoc, this.reorderModifiers, this.style);
        }
    }
