...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Multiset.Entry;
...
public final class Multisets {
     ...
     * @since 22.0
     */
    public static <T extends @Nullable Object, E extends @Nullable Object, M extends Multiset<E>> Collector<T, ?, M>
        toMultiset(Function<? super T, E> elementFunction, ToIntFunction<? super T> countFunction,
     ...
     * @since 11.0
     */
    public static <E extends @Nullable Object> SortedMultiset<E>
     ...
     */
    public static <E extends @Nullable Object> Entry<E> immutableEntry(@ParametricNullness E e, int n) {
        return new ImmutableEntry<E>(e, n);
    }

    static class ImmutableEntry<E extends @Nullable Object> extends AbstractEntry<E> implements Serializable {
        @ParametricNullness
     ...
     * @since 14.0
     */
    public static <E extends @Nullable Object> Multiset<E> filter(Multiset<E> unfiltered,
     ...
     * @since 14.0
     */
    public static <E extends @Nullable Object> Multiset<E> union(final Multiset<? extends E> multiset1,
     ...
     * @since 2.0
     */
    public static <E extends @Nullable Object> Multiset<E> intersection(final Multiset<E> multiset1,
     ...
     * @since 14.0
     */
    public static <E extends @Nullable Object> Multiset<E> sum(final Multiset<? extends E> multiset1,
        final Multiset<? extends E> multiset2) {
        checkNotNull(multiset1);
        checkNotNull(multiset2);
     ...
     * @since 14.0
     */
    public static <E extends @Nullable Object> Multiset<E> difference(final Multiset<E> multiset1,
        final Multiset<?> multiset2) {
        checkNotNull(multiset1);
        checkNotNull(multiset2);
    ...
    private static <E extends @Nullable Object> boolean retainOccurrencesImpl(Multiset<E> multisetToModify,
     ...
     * Entry}.
     */
    abstract static class AbstractEntry<E extends @Nullable Object> implements Entry<E> {
        /**
    ...
    static <E extends @Nullable Object> boolean addAllImpl(Multiset<E> self, Collection<? extends E> elements) {
        checkNotNull(self);
    ...
    static boolean removeAllImpl(Multiset<?> self, Collection<?> elementsToRemove) {
        Collection<?> collection
            = (elementsToRemove instanceof Multiset) ? ((Multiset<?>) elementsToRemove).elementSet() : elementsToRemove;
    ...
    static boolean retainAllImpl(Multiset<?> self, Collection<?> elementsToRetain) {
        ...
        Collection<?> collection
            = (elementsToRetain instanceof Multiset) ? ((Multiset<?>) elementsToRetain).elementSet() : elementsToRetain;
    ...
    static <E extends @Nullable Object> boolean setCountImpl(Multiset<E> self, @ParametricNullness E element,
    ...
    abstract static class EntrySet<E extends @Nullable Object> extends Sets.ImprovedAbstractSet<Entry<E>> {
        abstract Multiset<E> multiset();
    ...
    static <E extends @Nullable Object> Spliterator<E> spliteratorImpl(Multiset<E> multiset) {
        ...
        return CollectSpliterators.flatMap(entrySpliterator,
     ...
     */
    private abstract static class ViewMultiset<E extends @Nullable Object> extends AbstractMultiset<E> {
        @Override
        public int size() {
