...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.DsGetDC.DS_DOMAIN_TRUSTS;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.LMAccess.GROUP_USERS_INFO_0;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.LMAccess.LOCALGROUP_INFO_1;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.LMAccess.LOCALGROUP_USERS_INFO_0;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.LMAccess.USER_INFO_23;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.jna.platform.win32.Secur32.EXTENDED_NAME_FORMAT;
...
public abstract class Netapi32Util {
    ...
    public static LocalGroup[] getLocalGroups(String serverName) {
        ...
        try {
            int rc = Netapi32.INSTANCE.NetLocalGroupEnum(serverName, 1, bufptr, LMCons.MAX_PREFERRED_LENGTH,
            ...
            if (entriesRead.getValue() > 0) {
                LOCALGROUP_INFO_1 group = new LOCALGROUP_INFO_1(bufptr.getValue());
                LOCALGROUP_INFO_1[] groups = (LOCALGROUP_INFO_1[]) group.toArray(entriesRead.getValue());
    ...
    public static Group[] getGlobalGroups(String serverName) {
        ...
        IntByReference totalEntries = new IntByReference();
        try {
            int rc = Netapi32.INSTANCE.NetGroupEnum(serverName, 1, bufptr, LMCons.MAX_PREFERRED_LENGTH, entriesRead,
                totalEntries, null);
            if (LMErr.NERR_Success != rc || bufptr.getValue() == Pointer.NULL) {
                throw new Win32Exception(rc);
            }
    ...
    public static User[] getUsers(String serverName) {
        ...
        IntByReference totalEntries = new IntByReference();
        try {
            int rc = Netapi32.INSTANCE.NetUserEnum(serverName, 1, 0, bufptr, LMCons.MAX_PREFERRED_LENGTH, entriesRead,
                totalEntries, null);
            if (LMErr.NERR_Success != rc || bufptr.getValue() == Pointer.NULL) {
                throw new Win32Exception(rc);
            }
    ...
    public static Group[] getUserLocalGroups(String userName, String serverName) {
        ...
        IntByReference totalentries = new IntByReference();
        try {
            int rc = Netapi32.INSTANCE.NetUserGetLocalGroups(serverName, userName, 0, 0, bufptr,
                LMCons.MAX_PREFERRED_LENGTH, entriesread, totalentries);
    ...
    public static Group[] getUserGroups(String userName, String serverName) {
        ...
        IntByReference totalentries = new IntByReference();
        try {
            int rc = Netapi32.INSTANCE.NetUserGetGroups(serverName, userName, 0, bufptr, LMCons.MAX_PREFERRED_LENGTH,
    ...
    public static DomainTrust[] getDomainTrusts(String serverName) {
        ...
        int rc = Netapi32.INSTANCE.DsEnumerateDomainTrusts(serverName, DsGetDC.DS_DOMAIN_VALID_FLAGS, domainsPointerRef,
            domainTrustCount);
        ...
        try {
            ...
            if (domainTrustCount.getValue() > 0) {
                ...
                DS_DOMAIN_TRUSTS[] domainTrusts
                    = (DS_DOMAIN_TRUSTS[]) domainTrustRefs.toArray(new DS_DOMAIN_TRUSTS[domainTrustCount.getValue()]);
