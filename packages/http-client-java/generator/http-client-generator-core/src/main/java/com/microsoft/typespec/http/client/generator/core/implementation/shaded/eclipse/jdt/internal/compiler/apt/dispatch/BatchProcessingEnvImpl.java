...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.apt.util.EclipseFileManager;
...
public class BatchProcessingEnvImpl extends BaseProcessingEnvImpl {
			...
			String[] commandLineArguments)
	{
		...
		Class<?> c = null;
		try {
			c = Class.forName("com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.tool.EclipseCompilerImpl"); //$NON-NLS-1$
	 ...
	 * processors with {@link com.microsoft.typespec.http.client.generator.core.implementation.shaded.javax.annotation.processing.ProcessingEnvironment#getOptions()}.  In Sun's Java 6
