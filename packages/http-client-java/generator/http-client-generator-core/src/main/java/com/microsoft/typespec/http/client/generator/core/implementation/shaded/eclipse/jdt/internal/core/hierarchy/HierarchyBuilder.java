...
public abstract class HierarchyBuilder {
	...
	public HierarchyBuilder(TypeHierarchy hierarchy) throws JavaModelException {
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.ICompilationUnit unitToLookInside = focusType == null ? null : focusType.getCompilationUnit();
		...
		com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.ICompilationUnit[] unitsToLookInside;
...
protected IBinaryType createInfoFromClassFile(Openable handle, IResource file) {
	...
	} catch (ClassFormatException | java.io.IOException | CoreException e) {
		if (TypeHierarchy.DEBUG) {
			trace("", e); //$NON-NLS-1$
		}
		return null;
