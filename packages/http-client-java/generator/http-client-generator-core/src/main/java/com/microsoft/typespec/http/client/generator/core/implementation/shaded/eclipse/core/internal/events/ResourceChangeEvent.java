...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.resources.*;
    ...
    public IMarkerDelta[] findMarkerDeltas(String findType, boolean includeSubtypes) {
        ...
        while (deltaSets.hasNext()) {
            ...
            for (IMarkerSetElement element : elements) {
                ...
                if (findType == null
                    || (includeSubtypes ? markerDelta.isSubtypeOf(findType) : markerDelta.getType().equals(findType))) {
