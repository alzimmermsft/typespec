...
public class UserLibraryClasspathContainerInitializer extends ClasspathContainerInitializer {
	...
	/**
	 * @see org.eclipse.jdt.core.ClasspathContainerInitializer#getDescription(IPath, IJavaProject)
	 */
	@Override
	...
	/**
	 * @see org.eclipse.jdt.core.ClasspathContainerInitializer#requestClasspathContainerUpdate(IPath, IJavaProject, IClasspathContainer)
	 */
	@Override
