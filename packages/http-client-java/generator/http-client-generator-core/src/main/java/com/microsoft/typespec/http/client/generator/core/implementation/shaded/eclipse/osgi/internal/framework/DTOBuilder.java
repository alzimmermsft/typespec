...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.framework.wiring.dto.BundleWireDTO;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.resource.dto.CapabilityDTO;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.resource.dto.CapabilityRefDTO;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.resource.dto.RequirementDTO;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.resource.dto.RequirementRefDTO;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.resource.dto.WireDTO;
...
public class DTOBuilder {
	...
	public static ServiceReferenceDTO[] newArrayServiceReferenceDTO(ServiceReference<?>[] references) {
        ...
        for (ServiceReference<?> reference : references) {
            ServiceReferenceDTO dto = newServiceReferenceDTO(reference);
            if (dto != null) {
                refDTOs.add(dto);
            }
        }
		return refDTOs.toArray(new ServiceReferenceDTO[0]);
	}
