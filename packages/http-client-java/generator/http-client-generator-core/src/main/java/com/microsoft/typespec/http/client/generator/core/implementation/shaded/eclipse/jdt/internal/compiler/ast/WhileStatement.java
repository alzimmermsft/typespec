...
public class WhileStatement extends Statement {
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        // or catch blocks
        condInfo = this.condition.analyseCode(currentScope,
        ...
        if (this.action == null) {
            ...
            if (this.action.complainIfUnreachable(actionInfo, currentScope, initialComplaintLevel, true)
            ...
            if (loopingContext.hasEscapingExceptions()) { // https://bugs.eclipse.org/bugs/show_bug.cgi?id=321926
                ...
                if (this.continueLabel != null) {  // we do get to the bottom
                    ...
                    loopbackFlowInfo = loopbackFlowInfo.mergedWith(
                        loopbackFlowInfo.unconditionalCopy().addNullInfoFrom(actionInfo).unconditionalInits());
                }
