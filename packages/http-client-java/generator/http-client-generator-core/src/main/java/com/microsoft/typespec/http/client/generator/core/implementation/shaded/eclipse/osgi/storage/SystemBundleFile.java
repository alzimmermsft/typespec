...
public class SystemBundleFile extends BundleFile {
    ...
    URL getManifestURL() {
        ...
        try {
            ...
            Enumeration<URL> manifests = cl != null
                ? cl.getResources(BundleInfo.OSGI_BUNDLE_MANIFEST)
            ...
            while (manifests.hasMoreElements()) {
                ...
                try {
                    ...
                    Map<String, String> headers
                        = ManifestElement.parseBundleManifest(url.openStream(), new CaseInsensitiveDictionaryMap<>());
