...
public class LocalVariable extends SourceRefElement implements ILocalVariable {
    ...
    public LocalVariable(JavaElement parent, String name, int declarationSourceStart, int declarationSourceEnd,
        ...
        this(parent, name, declarationSourceStart, declarationSourceEnd, nameStart, nameEnd, typeSignature,
            astAnnotations, flags, isParameter);
    ...
    public boolean equals(Object o) {
        if (!(o instanceof LocalVariable other))
            return false;
    ...
    private IAnnotation[] getAnnotations(
        com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Annotation[] astAnnotations) {
        int length;
    ...
    private IAnnotation getAnnotation(
        final com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.Annotation annotation,
        ...
        com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.MemberValuePair[] astMemberValuePairs
        ...
        if (astMemberValuePairs == null || (length = astMemberValuePairs.length) == 0) {
            ...
            for (int i = 0; i < length; i++) {
                com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.MemberValuePair astMemberValuePair
            ...
            if (this.isParameter) {
                ...
                for (int i = 0; i < parameters.length; i++) {
                    if (this.equals(parameters[i])) {
                        buf.append("#0#").append(i); // always first occurrence, followed by parameter //$NON-NLS-1$
                                                     // rank
                        break;
                    }
                }
