 ...
 *******************************************************************************/
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.dynamichelpers;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.runtime.ReferenceHashSet;
...
public class ExtensionTracker implements IExtensionTracker, IRegistryChangeListener {
    ...
    public ExtensionTracker(IExtensionRegistry theRegistry) {
        ...
        if (registry != null) {
            ...
            RuntimeLog.log(
                new Status(IStatus.ERROR, RegistryMessages.OWNER_NAME, 0, RegistryMessages.registry_no_default, null));
        }
    }
