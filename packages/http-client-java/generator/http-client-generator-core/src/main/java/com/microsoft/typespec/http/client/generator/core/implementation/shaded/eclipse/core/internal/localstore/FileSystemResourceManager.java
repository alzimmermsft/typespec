...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.filesystem.IFileTree;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.filesystem.URIUtil;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.resources.File;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.resources.Folder;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.resources.ModelObjectWriter;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.resources.ProjectDescriptionReader;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.resources.WorkspaceDescription;
...
public class FileSystemResourceManager implements ICoreConstants {
    ...
    public void delete(IResource target, int flags, IProgressMonitor monitor) throws CoreException {
        ...
        MultiStatus status = new MultiStatus(ResourcesPlugin.PI_RESOURCES, IResourceStatus.FAILED_DELETE_LOCAL,
            Messages.localstore_deleteProblem, null);
        List<Resource> skipList = null;
        UnifiedTree tree = new UnifiedTree(target);
        if (!force) {
            CollectSyncStatusVisitor refreshVisitor
                = new CollectSyncStatusVisitor(Messages.localstore_deleteProblem, subMonitor.split(refreshWork));
     ...
     */
    public boolean internalWrite(IProject target, IProjectDescription description, boolean hasPublicChanges,
        boolean hasPrivateChanges) throws CoreException {
        ...
        workspace.getAliasManager()
            .updateAliases(descriptionFile, getStore(descriptionFile), IResource.DEPTH_ZERO, null);
    ...
    public void move(IResource source, IFileStore destination, IProgressMonitor monitor) throws CoreException {
    ...
    public ProjectDescription read(IProject target, boolean creation) throws CoreException {
        ...
        IFileStore descriptionStore
            = descFile.exists() ? getStore(descFile) : projectStore.getChild(IProjectDescription.DESCRIPTION_FILE_NAME);
    ...
    public boolean refresh(IResource target, int depth, boolean updateAliases, IProgressMonitor monitor)
        throws CoreException {
        switch (target.getType()) {
            case IResource.ROOT:
    ...
    protected boolean refreshResource(IResource target, int depth, boolean updateAliases, IProgressMonitor monitor)
        throws CoreException {
        ...
        // If there can be more than one resource to refresh, try to get the whole tree in one shot, if the file system
        // supports it.
        if (depth != IResource.DEPTH_ZERO) {
        ...
        RefreshLocalVisitor visitor
            = updateAliases ? new RefreshLocalAliasVisitor(refreshMonitor) : new RefreshLocalVisitor(refreshMonitor);
        tree.accept(visitor, depth);
     ...
     * be possible.
     */
    protected boolean refreshRoot(IWorkspaceRoot target, int depth, boolean updateAliases, IProgressMonitor monitor)
        throws CoreException {
     ...
     */
    public void write(IFile target, InputStream content, IFileInfo fileInfo, int updateFlags, boolean append,
        ...
        try (content) {
            ...
            try {
                ...
                throw new ResourceException(IResourceStatus.FAILED_WRITE_LOCAL, IPath.fromOSString(store.toString()),
                    msg, e);
            }
    ...
    private void prepareWrite(IFile target, IFileInfo fileInfo, int updateFlags, boolean append,
        ...
        if (BitMask.isSet(updateFlags, IResource.KEEP_HISTORY)
            && fileInfo.exists()
