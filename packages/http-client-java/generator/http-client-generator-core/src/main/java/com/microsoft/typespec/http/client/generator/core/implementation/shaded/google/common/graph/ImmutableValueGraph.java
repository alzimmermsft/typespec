...
public final class ImmutableValueGraph<N, V> extends StandardValueGraph<N, V> {
     ...
     * {
     *     &#64;code
     *     static final ImmutableValueGraph<City, Distance> CITY_ROAD_DISTANCE_GRAPH = ValueGraphBuilder.undirected()
    ...
    public static class Builder<N, V> {
        ...
        Builder(ValueGraphBuilder<N, V> graphBuilder) {
            ...
            this.mutableValueGraph = graphBuilder.copy().incidentEdgeOrder(ElementOrder.<N>stable()).build();
        }
