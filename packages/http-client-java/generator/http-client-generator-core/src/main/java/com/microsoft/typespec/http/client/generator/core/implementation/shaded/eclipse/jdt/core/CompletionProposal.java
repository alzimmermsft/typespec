...
public class CompletionProposal {
     ...
     * </ul>
     * <p>
     * This kind of proposal could require a long computation, so they are computed only if completion operation is
     * called with a {@link IProgressMonitor}
     * (e.g. {@link ICodeAssist#codeComplete(int, CompletionRequestor, IProgressMonitor)}).<br>
     * This kind of proposal is always is only proposals with a {@link #TYPE_REF} required proposal, so this kind of
     * required proposal must be allowed:
     ...
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.ASTRequestor,
     * IProgressMonitor)
     * @since 3.1
     */
