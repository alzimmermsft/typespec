...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.ast.ClassLiteralAccess;
...
public class ElementValuePair {
    ...
    public static class UnresolvedEnumConstant {
        ...
        FieldBinding getResolved() {
            if (this.enumType.isUnresolvedType())
                this.enumType = (ReferenceBinding) BinaryTypeBinding.resolveType(this.enumType, this.environment,
                    false /* no raw conversion */);
    ...
    /**
     * Return {@link TypeBinding} for member value of type {@link Class}
     * Return {@link Constant} for member of primitive type or String
