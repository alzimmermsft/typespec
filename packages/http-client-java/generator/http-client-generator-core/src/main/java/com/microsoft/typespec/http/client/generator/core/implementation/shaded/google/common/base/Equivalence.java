...
public abstract class Equivalence<T> implements BiPredicate<@Nullable T, @Nullable T> {
     ...
     * com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Ordering#lexicographical}
     * does for orderings.
     *
    ...
    private static final class EquivalentToPredicate<T> implements Predicate<@Nullable T>, Serializable {
