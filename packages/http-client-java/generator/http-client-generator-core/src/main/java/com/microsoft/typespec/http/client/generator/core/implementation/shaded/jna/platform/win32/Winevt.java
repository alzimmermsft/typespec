...
public interface Winevt {
    ...
    public static class EVT_VARIANT extends Structure {
         ...
         * the {@link EVT_VARIANT_TYPE} enumeration.
            ...
            switch (type) {
                ...
                case EvtVarTypeBoolean:
                    if (isArray()) {
                        ...
                        BOOL[] result = new BOOL[rawValue.length];
                        for (int i = 0; i < result.length; i++) {
                            result[i] = new BOOL(rawValue[i]);
                        }
                        return result;
                    } else {
                        return new BOOL(field1.getPointer().getInt(0));
                    }
                case EvtVarTypeString:
                case EvtVarTypeEvtXml:
                    return isArray()
                ...
                case EvtVarTypeEvtHandle:
                    if (isArray()) {
                        ...
                        HANDLE[] result = new HANDLE[rawValue.length];
                        for (int i = 0; i < result.length; i++) {
                            result[i] = new HANDLE(rawValue[i]);
                        }
                        return result;
                    } else {
    ...
    public class EVT_RPC_LOGIN extends Structure {
         ...
         * For possible authentication methods, see the {@link EVT_RPC_LOGIN_FLAGS} enumeration.
         */
        public int Flags;
    ...
    public static interface EVT_CHANNEL_CONFIG_PROPERTY_ID {
         ...
         * For possible isolation values, see the {@link EVT_CHANNEL_ISOLATION_TYPE} enumeration.
         * You cannot set this property for the Application, System, and Security channels.
         */
         ...
         * For possible isolation values, see the {@link EVT_CHANNEL_TYPE} enumeration.
         ...
         * EvtVarTypeUInt32. For possible clock type values, see the {@link EVT_CHANNEL_CLOCK_TYPE} enumeration.
         * You cannot set this property.
         */
         ...
         * EvtVarTypeUInt32. For possible SID type values, see the {@link EVT_CHANNEL_SID_TYPE} enumeration.
         * You cannot set this property.
         */
