...
public final class LinkedHashMultimap<K extends @Nullable Object, V extends @Nullable Object>
    ...
    public static <K extends @Nullable Object, V extends @Nullable Object> LinkedHashMultimap<K, V> create() {
     ...
     * negative
     */
    public static <K extends @Nullable Object, V extends @Nullable Object> LinkedHashMultimap<K, V>
    ...
    private static <K extends @Nullable Object, V extends @Nullable Object> void
        succeedsInValueSet(ValueSetLink<K, V> pred, ValueSetLink<K, V> succ) {
        pred.setSuccessorInValueSet(succ);
        succ.setPredecessorInValueSet(pred);
    }

    private static <K extends @Nullable Object, V extends @Nullable Object> void
        succeedsInMultimap(ValueEntry<K, V> pred, ValueEntry<K, V> succ) {
        pred.setSuccessorInMultimap(succ);
        succ.setPredecessorInMultimap(pred);
    }

    private static <K extends @Nullable Object, V extends @Nullable Object> void
        deleteFromValueSet(ValueSetLink<K, V> entry) {
        succeedsInValueSet(entry.getPredecessorInValueSet(), entry.getSuccessorInValueSet());
    }

    private static <K extends @Nullable Object, V extends @Nullable Object> void
        deleteFromMultimap(ValueEntry<K, V> entry) {
     ...
     */
    @VisibleForTesting
    static final class ValueEntry<K extends @Nullable Object, V extends @Nullable Object> extends ImmutableEntry<K, V>
    ...
    final class ValueSet extends Sets.ImprovedAbstractSet<V> implements ValueSetLink<K, V> {
        ...
        public void forEach(Consumer<? super V> action) {
            checkNotNull(action);
            for (ValueSetLink<K, V> entry = firstEntry; entry != ValueSet.this;
