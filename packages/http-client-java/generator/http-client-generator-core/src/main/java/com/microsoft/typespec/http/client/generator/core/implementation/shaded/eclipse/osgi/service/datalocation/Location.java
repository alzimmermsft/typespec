 ...
 *******************************************************************************/
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.osgi.service.datalocation;
...
public interface Location {
     ...
     * @since 3.18
     */
    String ECLIPSE_HOME_LOCATION_TYPE = "eclipse.home.location"; //$NON-NLS-1$
     ...
     * @since 3.18
     */
    String USER_AREA_TYPE = "osgi.user.area"; //$NON-NLS-1$
     ...
     * @since 3.18
     */
    String CONFIGURATION_AREA_TYPE = "osgi.configuration.area"; //$NON-NLS-1$
     ...
     * @since 3.18
     */
    String INSTALL_AREA_TYPE = "osgi.install.area"; //$NON-NLS-1$
     ...
     * @since 3.18
     */
    String INSTANCE_AREA_TYPE = "osgi.instance.area"; //$NON-NLS-1$
     ...
     * @since 3.18
     */
    String SERVICE_PROPERTY_TYPE = "type"; //$NON-NLS-1$
     ...
     * @since 3.18
     */
    String SERVICE_PROPERTY_URL = "url"; //$NON-NLS-1$
     ...
     * @since 3.18
     */
    String SERVICE_PROPERTY_DEFAULT_URL = "defaultUrl"; //$NON-NLS-1$
    ...
    String INSTANCE_FILTER
        = "(&(objectClass=" + Location.class.getName() + ")(" + SERVICE_PROPERTY_TYPE + "=" + INSTANCE_AREA_TYPE + "))"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    ...
    String INSTALL_FILTER
        = "(&(objectClass=" + Location.class.getName() + ")(" + SERVICE_PROPERTY_TYPE + "=" + INSTALL_AREA_TYPE + "))"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
     ...
     * @since 3.2
     */
    String CONFIGURATION_FILTER = "(&(objectClass=" + Location.class.getName() + ")(" + SERVICE_PROPERTY_TYPE + "=" //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        + CONFIGURATION_AREA_TYPE + "))";  //$NON-NLS-1$
     ...
     */
    String USER_FILTER
        = "(&(objectClass=" + Location.class.getName() + ")(" + SERVICE_PROPERTY_TYPE + "=" + USER_AREA_TYPE + "))"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
     ...
     * @since 3.4
     */
    String ECLIPSE_HOME_FILTER = "(&(objectClass=" + Location.class.getName() + ")(" + SERVICE_PROPERTY_TYPE + "=" //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        + ECLIPSE_HOME_LOCATION_TYPE + "))";  //$NON-NLS-1$
    ...
    /**
     * Sets and optionally locks the location's value to the given {@link URL} using the given lock file. If the
     * location
     * already has a value an exception is thrown. If locking is requested and fails, <code>false</code>
     * is returned and the {@link URL} of this location is not set.
     *
