		...
		try {
			...
			try {
				...
				if (this.resource != null) {
					...
					File file = null;
					try {
						file = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.toLocalFile(location, progressMonitor);
			...
			if (e instanceof NoSuchFileException) {
				com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.log(Status.info("Can not index not existing zip " + this.containerPath)); //$NON-NLS-1$
				...
				com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.core.util.Util.log(e, "Failed to index " + this.containerPath); //$NON-NLS-1$
			}
			this.manager.removeIndex(this.containerPath);
			return false;
		}
