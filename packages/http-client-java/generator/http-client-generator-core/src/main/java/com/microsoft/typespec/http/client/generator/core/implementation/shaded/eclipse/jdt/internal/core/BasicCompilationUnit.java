...
public class BasicCompilationUnit implements ICompilationUnit {
    ...
    // Note that if this compiler ICompilationUnit's content is known in advance, the fileName is not used to retrieve
    // this content.
    // Instead it is used to keep enough information to recreate the IJavaElement corresponding to this compiler
    // ICompilationUnit.
    // Thus the fileName can be a path to a .class file, or even a path in a .jar to a .class file.
    // (e.g.
    // /P/lib/mylib.jar|com/microsoft/typespec/http/client/generator/core/implementation/shaded/eclipse/test/X.class)
                ...
                search: while (javaElement != null) {
                    switch (javaElement.getElementType()) {
                        ...
                        case IJavaElement.COMPILATION_UNIT:
                            ...
                            module
                                = ((com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.ICompilationUnit) javaElement)
                                    .getModule();
                            if (module != null)
                                break search;
                            break;
