...
public class BasicCompilationUnit implements ICompilationUnit {
	...
	// (e.g. /P/lib/mylib.jar|com/microsoft/typespec/http/client/generator/core/implementation/shaded/eclipse/test/X.class)
				...
				search: while (javaElement != null) {
					switch (javaElement.getElementType()) {
						...
						case IJavaElement.COMPILATION_UNIT:
							...
							module = ((com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.ICompilationUnit) javaElement).getModule();
							if (module != null)
								break search;
							break;
						default:
