 ...
 * must be subclasses of the API
 * <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.jobs.JobGroup</code>
 * class.
 */
public class InternalJobGroup {
    ...
    protected boolean join(long timeout, IProgressMonitor monitor)
    ...
    final void jobStateChanged(InternalJob job, int oldState, int newState) {
         ...
         */
        if (job.internalGetState() == InternalJob.ABOUT_TO_SCHEDULE
            && getGroupOfCurrentlyRunningJob() != job.getJobGroup()) {
    ...
    protected MultiStatus computeGroupResult(List<IStatus> jobResults) {
        ...
        if (importantResults.isEmpty()) {
            return new MultiStatus(
                "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.jobs", 0, name, //$NON-NLS-1$
                null);
        }
