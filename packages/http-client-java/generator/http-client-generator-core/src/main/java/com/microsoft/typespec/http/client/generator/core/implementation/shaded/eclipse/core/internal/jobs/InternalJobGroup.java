 ...
 * must be subclasses of the API <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.jobs.JobGroup</code> class.
 */
public class InternalJobGroup {
	...
	protected MultiStatus computeGroupResult(List<IStatus> jobResults) {
		...
		if (importantResults.isEmpty()) {
			return new MultiStatus("com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.jobs", 0, name, null); //$NON-NLS-1$
		}
