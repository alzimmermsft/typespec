...
public class SingleNameReference extends NameReference implements OperatorIds {
    ...
    public boolean isLabel;// flagging for break expression when expression is SwitchExpression - java 12
                           // preview-feature
            ...
            switch (this.bits & ASTNode.RestrictiveFlagMASK) {
                ...
                case Binding.LOCAL: // reading a local variable
                    ...
                    if (!flowInfo.isDefinitelyAssigned(localBinding = (LocalVariableBinding) this.binding)) {
                        ...
                        // we could improve error msg here telling "cannot use compound assignment on final local
                        // variable"
                    }
        ...
        switch (this.bits & ASTNode.RestrictiveFlagMASK) {
            case Binding.FIELD: // assigning to a field
                ...
                if (fieldBinding.isFinal()) {
                    ...
                    && (fieldBinding.isNonNull() || fieldBinding.type.isTypeVariable())
                    && TypeBinding.equalsEquals(fieldBinding.declaringClass, currentScope.enclosingReceiverType())) { // inherited
                                                                                                                      // fields
                                                                                                                      // are
                                                                                                                      // not
                                                                                                                      // tracked
            ...
            case Binding.LOCAL: // assigning to a local variable
                ...
                if (flowInfo.isPotentiallyAssigned(localBinding)
                    || (this.bits & (IsCapturedOuterLocal | IsUsedInPatternGuard)) != 0) {
                    localBinding.clearEffectiveFinality(currentScope, this, !isFinal);
                }
                if (!isFinal
                    && (localBinding.tagBits & TagBits.IsEffectivelyFinal) != 0
                    && (localBinding.tagBits & TagBits.IsArgument) == 0) {
        ...
        if (!super.checkNPE(scope, flowContext, flowInfo, ttlForFieldCheck)) {
            ...
            if (compilerOptions.isAnnotationBasedNullAnalysisEnabled) {
                if (this.binding instanceof FieldBinding) {
                    return checkNullableFieldDereference(scope, (FieldBinding) this.binding,
                        ((long) this.sourceStart << 32) + this.sourceEnd, flowContext, ttlForFieldCheck);
                }
            }
        }
        return false;
    ...
    public void computeConversion(Scope scope, TypeBinding runtimeTimeType, TypeBinding compileTimeType) {
        ...
        if (this.binding != null && this.binding.isValidBinding()) {
            ...
            if ((this.bits & Binding.FIELD) != 0) {
                // set the generic cast after the fact, once the type expectation is fully known (no need for strict
                // cast)
                        ...
                        scope.problemReporter()
                            .invalidType(this,
                                new ProblemReferenceBinding(
                                    CharOperation.splitOn('.', referenceCast.shortReadableName()), referenceCast,
    ...
    public void generateAssignment(BlockScope currentScope, CodeStream codeStream, Assignment assignment,
        ...
        if (assignment.expression.isCompactableOperation()) {
            ...
            if ((operation.left instanceof SingleNameReference)
                ...
                // i = i + value, then use the variable on the right hand side, since it has the correct implicit
                // conversion
                variableReference.generateCompoundAssignment(currentScope, codeStream,
                    ...
                    operation.right, operator, operation.implicitConversion, valueRequired);
                if (valueRequired) {
            ...
            if ((operation.right instanceof SingleNameReference)
                ...
                && (operation.left.constant != Constant.NotAConstant) // exclude non constant expressions, since could
                                                                      // have side-effect
                && (((operation.left.implicitConversion & TypeIds.IMPLICIT_CONVERSION_MASK) >> 4)
                ...
                && (((operation.right.implicitConversion & TypeIds.IMPLICIT_CONVERSION_MASK) >> 4)
                    != TypeIds.T_JavaLangString)) { // exclude string concatenation which would occur backwards
                // i = value + i, then use the variable on the right hand side, since it has the correct implicit
                // conversion
                variableReference.generateCompoundAssignment(currentScope, codeStream,
                    this.syntheticAccessors == null ? null : this.syntheticAccessors[SingleNameReference.WRITE],
                    operation.left, operator, operation.implicitConversion, valueRequired);
                if (valueRequired) {
                    codeStream.generateImplicitConversion(assignment.implicitConversion);
                }
                return;
        ...
        switch (this.bits & ASTNode.RestrictiveFlagMASK) {
            case Binding.FIELD: // assigning to a field
                ...
                fieldStore(currentScope, codeStream, codegenBinding,
                    this.syntheticAccessors == null ? null : this.syntheticAccessors[SingleNameReference.WRITE],
                    this.actualReceiverType, true /* implicit this */, valueRequired);
                if (valueRequired) {
                    codeStream.generateImplicitConversion(assignment.implicitConversion);
                }
                ...
                case Binding.FIELD: // reading a field
                    ...
                    if (codegenField.isStatic()) {
                        if (!valueRequired
                            ...
                            && TypeBinding.equalsEquals(((FieldBinding) this.binding).original().declaringClass,
                        ...
                        if ((this.syntheticAccessors == null)
                            || (this.syntheticAccessors[SingleNameReference.READ] == null)) {
                            TypeBinding constantPoolDeclaringClass = CodeStream.getConstantPoolDeclaringClass(
                                currentScope, codegenField, this.actualReceiverType, true /* implicit this */);
                            ...
                            codeStream.invoke(Opcodes.OPC_invokestatic,
                                this.syntheticAccessors[SingleNameReference.READ], null /* default declaringClass */);
                        }
                    } else {
                        if (!valueRequired
                            && (this.implicitConversion & TypeIds.UNBOXING) == 0
                        ...
                        if ((this.bits & ASTNode.DepthMASK) != 0) {
                            ReferenceBinding targetType = currentScope.enclosingSourceType()
                                .enclosingTypeAt((this.bits & ASTNode.DepthMASK) >> ASTNode.DepthSHIFT);
                            Object[] emulationPath = currentScope.getEmulationPath(targetType,
    ...
    public void generateCompoundAssignment(BlockScope currentScope, CodeStream codeStream, Expression expression,
        ...
        this.generateCompoundAssignment(currentScope, codeStream,
            this.syntheticAccessors == null ? null : this.syntheticAccessors[SingleNameReference.WRITE], expression,
            operator, assignmentImplicitConversion, valueRequired);
    }
     ...
     * are optimized in one access: e.g "a = a + 1" optimized into "a++".
     */
    public void generateCompoundAssignment(BlockScope currentScope, CodeStream codeStream, MethodBinding writeAccessor,
                ...
                if (codegenField.isStatic()) {
                    if ((this.syntheticAccessors == null)
                        ...
                        TypeBinding constantPoolDeclaringClass = CodeStream.getConstantPoolDeclaringClass(currentScope,
                            codegenField, this.actualReceiverType, true /* implicit this */);
                        codeStream.fieldAccess(Opcodes.OPC_getstatic, codegenField, constantPoolDeclaringClass);
                    } else {
                        codeStream.invoke(Opcodes.OPC_invokestatic, this.syntheticAccessors[SingleNameReference.READ],
        ...
        switch (this.bits & ASTNode.RestrictiveFlagMASK) {
            case Binding.FIELD: // assigning to a field
                FieldBinding codegenField = ((FieldBinding) this.binding).original();
                fieldStore(currentScope, codeStream, codegenField, writeAccessor, this.actualReceiverType,
                    true /* implicit this */, valueRequired);
                // no need for generic cast as value got dupped
                return;
    ...
    public void generatePostIncrement(BlockScope currentScope, CodeStream codeStream, CompoundAssignment postIncrement,
        ...
        switch (this.bits & ASTNode.RestrictiveFlagMASK) {
            case Binding.FIELD: // assigning to a field
                ...
                fieldStore(currentScope, codeStream, codegenField,
                    this.syntheticAccessors == null ? null : this.syntheticAccessors[SingleNameReference.WRITE],
                    this.actualReceiverType, true /* implicit this */, false);
                ...
                case Binding.VARIABLE | Binding.TYPE: // ====both variable and type============
                    if (this.binding instanceof VariableBinding variable) {
                        ...
                        if (this.binding instanceof LocalVariableBinding localVariable) {
                            ...
                            this.constant = (this.bits & ASTNode.IsStrictlyAssigned) == 0
    ...
    private void checkLocalStaticClassVariables(BlockScope scope, VariableBinding variable) {
        if (this.actualReceiverType.isStatic() && this.actualReceiverType.isLocalType()) {
            if ((variable.modifiers & ClassFileConstants.AccStatic) == 0
                ...
                MethodScope declaringMethodScope = declaringScope instanceof MethodScope
                ...
                ClassScope declaringClassScope
                    = declaringMethodScope != null ? declaringMethodScope.classScope() : null;
                ...
                if (declaringClassScope != currentClassScope)
                    scope.problemReporter()
                        .recordStaticReferenceToOuterLocalVariable((LocalVariableBinding) variable, this);
            }
        }
    }
