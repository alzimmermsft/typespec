...
final class OrderPreservingImportAdder implements ImportAdder {
    ...
    public List<ImportName> addImports(Collection<ImportName> existingImports, Collection<ImportName> importsToAdd) {
        ...
        List<ImportName> importsWithAdditions = new ArrayList<>(existingImports.size() + sortedNewImports.size());
     ...
     */
    private Map<ImportName, AdjacentImports> determineAdjacentNewImports(Collection<ImportName> existingImports,
     ...
     */
    private boolean shouldGroupWithSucceeding(ImportName newImport, ImportName precedingExistingImport,
