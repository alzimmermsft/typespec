...
class RecoveredTypeBinding implements ITypeBinding {
	...
	RecoveredTypeBinding(BindingResolver resolver, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding) {
		this.resolver = resolver;
