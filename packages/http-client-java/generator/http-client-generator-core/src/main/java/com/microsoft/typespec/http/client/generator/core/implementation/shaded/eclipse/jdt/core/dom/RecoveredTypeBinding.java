...
class RecoveredTypeBinding implements ITypeBinding {
    ...
    private com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.TypeBinding binding;
    ...
    RecoveredTypeBinding(BindingResolver resolver,
        ...
        if (packageBinding != null) {
            ...
            if (javaElement != null && javaElement.getElementType() == IJavaElement.PACKAGE_FRAGMENT) {
                ...
                return ((PackageFragment) javaElement)
                    .getCompilationUnit(getInternalName() + SuffixConstants.SUFFIX_STRING_java)
        ...
        switch (this.variableDeclaration.getNodeType()) {
            case ASTNode.SINGLE_VARIABLE_DECLARATION:
                SingleVariableDeclaration singleVariableDeclaration
                    = (SingleVariableDeclaration) this.variableDeclaration;
                ...
                switch (parent.getNodeType()) {
                    case ASTNode.VARIABLE_DECLARATION_EXPRESSION:
                        VariableDeclarationExpression variableDeclarationExpression
                            = (VariableDeclarationExpression) parent;
