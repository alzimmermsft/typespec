...
class OnDemandComputer {
     ...
     * imports and not reduced into on-demand imports
     */
    Collection<OnDemandReduction> identifyPossibleReductions(Set<ImportName> imports, Set<ImportName> touchedContainers,
        Set<String> typeExplicitSimpleNames, Set<String> staticExplicitSimpleNames) {
    ...
    private OnDemandReduction maybeReduce(ImportName containerOnDemand, Collection<ImportName> containerImports,
        int onDemandThreshold, Set<String> explicitSimpleNames) {
