...
public class VersionRange {
    ...
    public VersionRange intersection(VersionRange... ranges) {
        ...
        return new VersionRange(closedLeft ? LEFT_CLOSED : LEFT_OPEN, endpointLeft, endpointRight,
            closedRight ? RIGHT_CLOSED : RIGHT_OPEN);
    }
    ...
    public boolean isExact() {
        ...
        if (leftClosed) {
            if (rightClosed) {
                ...
                // [l,r): exact if l++ >= r
                Version adjacent1
                    = new Version(left.getMajor(), left.getMinor(), left.getMicro(), left.getQualifier() + "-");
    ...
    public String toString() {
        ...
        if (right == null) {
            return versionRangeString = left.toString0();
        }

        String result = (leftClosed ? LEFT_CLOSED : LEFT_OPEN) + left.toString0() + ENDPOINT_DELIMITER
            + right.toString0() + (rightClosed ? RIGHT_CLOSED : RIGHT_OPEN);
        return versionRangeString = result;
    }
