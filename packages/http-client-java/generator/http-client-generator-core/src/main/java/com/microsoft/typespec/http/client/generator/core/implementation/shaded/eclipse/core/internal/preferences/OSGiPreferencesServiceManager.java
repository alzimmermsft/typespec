...
public class OSGiPreferencesServiceManager
		implements ServiceFactory<com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.prefs.PreferencesService>, BundleListener {

	private static final String ORG_ECLIPSE_CORE_INTERNAL_PREFERENCES_OSGI = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.preferences.osgi"; //$NON-NLS-1$
	 ...
	 */
	@Override
	public com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.prefs.PreferencesService getService(Bundle bundle,
			ServiceRegistration<com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.prefs.PreferencesService> registration) {
	...
	private String getQualifier(Bundle bundle) {
		String qualifier = "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.preferences.OSGiPreferences." + bundle.getBundleId(); //$NON-NLS-1$
		return qualifier;
	}
	 ...
	 */
	@Override
	public void ungetService(Bundle bundle, ServiceRegistration<com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.prefs.PreferencesService> registration,
			com.microsoft.typespec.http.client.generator.core.implementation.shaded.osgi.service.prefs.PreferencesService service) {
		try {
