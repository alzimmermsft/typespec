...
public class DefinitionRegistry implements IRegistryChangeListener {
	...
	public DefinitionRegistry() {
		Platform.getExtensionRegistry().addRegistryChangeListener(this, "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.expressions"); //$NON-NLS-1$
	}
	...
	public Expression getExpression(String id) throws CoreException {
		...
		IConfigurationElement[] ces= registry.getConfigurationElementsFor("com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.expressions", "definitions"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void registryChanged(IRegistryChangeEvent event) {
		IExtensionDelta[] extensionDeltas= event.getExtensionDeltas("com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.expressions", "definitions"); //$NON-NLS-1$//$NON-NLS-2$
