...
public class SourceMethod extends NamedMember implements IMethod {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof SourceMethod other))
            return false;
    ...
    public JavaElement resolved(Binding binding) {
        return new ResolvedSourceMethod(this.getParent(), this.name, this.parameterTypes,
            new String(binding.computeUniqueKey()), this.getOccurrenceCount());
    }
