...
public final class Options {
    ...
    public static int processOptions(String option) {
        ...
        if (option.startsWith("-g")) { //$NON-NLS-1$
            ...
            if (length > 3) {
                StringTokenizer tokenizer = new StringTokenizer(option.substring(3, option.length()), ",");//$NON-NLS-1$
        ...
        if (option.startsWith("-warn")) {//$NON-NLS-1$
            ...
            StringTokenizer tokenizer = new StringTokenizer(option.substring(warnTokenStart, option.length()), ","); //$NON-NLS-1$
            int tokenCounter = 0;
