...
public final class Iterators {
    ...
    public static <T extends @Nullable Object> UnmodifiableIterator<T>
     ...
     */
    @CanIgnoreReturnValue
    public static <T extends @Nullable Object> boolean removeIf(Iterator<T> removeFrom,
     ...
     */
    @ParametricNullness
    public static <T extends @Nullable Object> T getOnlyElement(Iterator<? extends T> iterator,
    ...
    public static <T extends @Nullable Object> T[] toArray(Iterator<? extends T> iterator, Class<@NonNull T> type) {
     ...
     */
    public static <T extends @Nullable Object> Iterator<T> concat(Iterator<? extends T> a, Iterator<? extends T> b,
        Iterator<? extends T> c, Iterator<? extends T> d) {
        checkNotNull(a);
        checkNotNull(b);
        checkNotNull(c);
        checkNotNull(d);
    ...
    static <T extends @Nullable Object> Iterator<T> concatNoDefensiveCopy(Iterator<? extends T>... inputs) {
     ...
     * @throws IllegalArgumentException if {@code size} is nonpositive
     */
    public static <T extends @Nullable Object> UnmodifiableIterator<List<@Nullable T>>
        paddedPartition(Iterator<T> iterator, int size) {
        return partitionImpl(iterator, size, true);
    }

    private static <T extends @Nullable Object> UnmodifiableIterator<List<@Nullable T>>
    ...
    @CheckForNull
    public static <T extends @Nullable Object> T find(Iterator<? extends T> iterator, Predicate<? super T> predicate,
     ...
     * element.
     */
    public static <F extends @Nullable Object, T extends @Nullable Object> Iterator<T>
     ...
     */
    @ParametricNullness
    public static <T extends @Nullable Object> T get(Iterator<? extends T> iterator, int position,
        @ParametricNullness T defaultValue) {
        checkNonnegative(position);
     ...
     */
    @ParametricNullness
    public static <T extends @Nullable Object> T getNext(Iterator<? extends T> iterator,
        @ParametricNullness T defaultValue) {
     ...
     */
    @ParametricNullness
    public static <T extends @Nullable Object> T getLast(Iterator<? extends T> iterator,
        @ParametricNullness T defaultValue) {
     ...
     */
    static <T extends @Nullable Object> UnmodifiableListIterator<T> forArray(T[] array, int offset, int length,
        int index) {
    ...
    private static final class ArrayItr<T extends @Nullable Object> extends AbstractIndexedListIterator<T> {
     ...
     */
    public static <T extends @Nullable Object> UnmodifiableIterator<T> singletonIterator(@ParametricNullness T value) {
        return new UnmodifiableIterator<T>() {
            boolean done;
     ...
     */
    @Deprecated
    public static <T extends @Nullable Object> PeekingIterator<T> peekingIterator(PeekingIterator<T> iterator) {
        return checkNotNull(iterator);
    }
    ...
    private static class MergingIterator<T extends @Nullable Object> extends UnmodifiableIterator<T> {
        ...
        public MergingIterator(Iterable<? extends Iterator<? extends T>> iterators,
            ...
            Comparator<PeekingIterator<T>> heapComparator
                = (PeekingIterator<T> o1, PeekingIterator<T> o2) -> itemComparator.compare(o1.peek(), o2.peek());
