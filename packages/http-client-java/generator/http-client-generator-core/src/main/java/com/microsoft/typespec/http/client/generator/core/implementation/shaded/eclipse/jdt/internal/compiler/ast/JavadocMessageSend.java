...
public class JavadocMessageSend extends MessageSend {
    ...
    private TypeBinding internalResolveType(Scope scope) {
        ...
        this.actualReceiverType = scope.environment()
        ...
        if (this.actualReceiverType.isBaseType()) {
            scope.problemReporter()
                .javadocErrorNoMethodFor(this, this.actualReceiverType, this.argumentTypes,
        ...
        if (!this.binding.isValidBinding()) {
            ...
            while (!methodBinding.isValidBinding()
            ...
            if (methodBinding.isValidBinding()) {
                ...
                if (!contructorBinding.isValidBinding()
                    && CharOperation.equals(this.selector, enclosingTypeBinding.shortReadableName())) {
                    contructorBinding
                        = scope.getConstructor((ReferenceBinding) enclosingTypeBinding, this.argumentTypes, this);
                }
        ...
        if (!this.binding.isValidBinding()) {
            ...
            MethodBinding problem
                = new ProblemMethodBinding(this.binding, this.selector, this.argumentTypes, ProblemReasons.NotFound);
            ...
            if (!(this.binding.parameters.length == length && this.argumentTypes[length - 1].isArrayType())) {
                MethodBinding problem = new ProblemMethodBinding(this.binding, this.selector, this.argumentTypes,
