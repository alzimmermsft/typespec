...
public class ASTRewriteFlattener extends ASTVisitor {
    ...
    /** @deprecated using deprecated code */
    private static final SimplePropertyDescriptor INTERNAL_INITIALIZER_MODIFIERS_PROPERTY
        = Initializer.MODIFIERS_PROPERTY;

    /** @deprecated using deprecated code */
    private static final SimplePropertyDescriptor INTERNAL_METHOD_MODIFIERS_PROPERTY
    ...
    private void internalVisitDimensionAnnotations(ArrayType arrayType, int index, boolean astLevelGTE8) {
        if (astLevelGTE8) {
            ...
            visitList(dimension, Dimension.ANNOTATIONS_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
    }
    ...
    public boolean visit(ClassInstanceCreation node) {
        ...
        if (node.getAST().apiLevel() == JLS2_INTERNAL) {
            ...
            visitList(node, ClassInstanceCreation.TYPE_ARGUMENTS_PROPERTY, String.valueOf(','), String.valueOf('<'),
                String.valueOf('>'));
    ...
    public boolean visit(ConstructorInvocation node) {
        if (node.getAST().apiLevel() >= JLS3_INTERNAL) {
            visitList(node, ConstructorInvocation.TYPE_ARGUMENTS_PROPERTY, String.valueOf(','), String.valueOf('<'),
                String.valueOf('>'));
        }
    ...
    public boolean visit(CreationReference node) {
        ...
        this.result.append("::"); //$NON-NLS-1$
        visitList(node, CreationReference.TYPE_ARGUMENTS_PROPERTY, Util.EMPTY_STRING, String.valueOf('<'),
            String.valueOf('>'));
        this.result.append("new"); //$NON-NLS-1$
        return false;
    }
    ...
    public boolean visit(ExportsDirective node) {
        ...
        if (modules.size() > 0) {
            ...
            visitList(node, ExportsDirective.MODULES_PROPERTY, Util.COMMA_SEPARATOR, Util.EMPTY_STRING,
                Util.EMPTY_STRING);
        }
        this.result.append(';');
        return false;
    ...
    public boolean visit(FieldDeclaration node) {
        ...
        if (node.getAST().apiLevel() == JLS2_INTERNAL) {
            ...
            visitList(node, FieldDeclaration.MODIFIERS2_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
    ...
    public boolean visit(Initializer node) {
        ...
        if (node.getAST().apiLevel() == JLS2_INTERNAL) {
            ...
            visitList(node, Initializer.MODIFIERS2_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
    ...
    public boolean visit(MethodDeclaration node) {
        ...
        if (node.getAST().apiLevel() == JLS2_INTERNAL) {
            ...
            visitList(node, MethodDeclaration.MODIFIERS2_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
            visitList(node, MethodDeclaration.TYPE_PARAMETERS_PROPERTY, String.valueOf(','), String.valueOf('<'),
                String.valueOf('>'));
        }
        ...
        if (!(DOMASTUtil.isRecordDeclarationSupported(node.getAST())
            && getBooleanAttribute(node, MethodDeclaration.COMPACT_CONSTRUCTOR_PROPERTY))) {
            this.result.append('(');
            // receiver parameter
            if (node.getAST().apiLevel() >= JLS8_INTERNAL) {
    ...
    public boolean visit(ModuleDeclaration node) {
        ...
        visitList(node, ModuleDeclaration.ANNOTATIONS_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
            String.valueOf(' '));
    ...
    public boolean visit(MethodInvocation node) {
        ...
        if (node.getAST().apiLevel() >= JLS3_INTERNAL) {
            visitList(node, MethodInvocation.TYPE_ARGUMENTS_PROPERTY, String.valueOf(','), String.valueOf('<'),
                String.valueOf('>'));
        }
    ...
    public boolean visit(ProvidesDirective node) {
        ...
        visitList(node, ProvidesDirective.IMPLEMENTATIONS_PROPERTY, Util.EMPTY_STRING, Util.COMMA_SEPARATOR,
            Util.EMPTY_STRING);
        this.result.append(';');
        return false;
    }
    ...
    public boolean visit(PrimitiveType node) {
        if (node.getAST().apiLevel() >= JLS8_INTERNAL) {
            visitList(node, PrimitiveType.ANNOTATIONS_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
    ...
    public boolean visit(RecordDeclaration node) {
        ...
        visitList(node, RecordDeclaration.MODIFIERS2_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
            String.valueOf(' '));
        this.result.append("record ");//$NON-NLS-1$
        getChildNode(node, RecordDeclaration.NAME_PROPERTY).accept(this);
        this.result.append(' ');

        visitList(node, RecordDeclaration.TYPE_PARAMETERS_PROPERTY, String.valueOf(','), String.valueOf('<'),
            String.valueOf('>'));
        ...
        this.result.append(' ');
        visitList(node, RecordDeclaration.SUPER_INTERFACE_TYPES_PROPERTY, String.valueOf(','), "implements ", //$NON-NLS-1$
            Util.EMPTY_STRING);
    ...
    public boolean visit(RequiresDirective node) {
        ...
        visitList(node, RequiresDirective.MODIFIERS_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
            String.valueOf(' '));
    ...
    public boolean visit(SimpleType node) {
        if (node.getAST().apiLevel() >= JLS8_INTERNAL) {
            visitList(node, SimpleType.ANNOTATIONS_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
    ...
    public boolean visit(SingleVariableDeclaration node) {
        if (node.getAST().apiLevel() == JLS2_INTERNAL) {
            ...
            visitList(node, SingleVariableDeclaration.MODIFIERS2_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
        ...
        if (node.getAST().apiLevel() >= JLS8_INTERNAL && node.isVarargs()) {
            visitList(node, SingleVariableDeclaration.VARARGS_ANNOTATIONS_PROPERTY, String.valueOf(' '),
                Util.EMPTY_STRING, String.valueOf(' '));
        }
        if (node.getAST().apiLevel() >= JLS3_INTERNAL) {
        ...
        visitExtraDimensions(node, INTERNAL_VARIABLE_EXTRA_DIMENSIONS_PROPERTY,
    ...
    public boolean visit(SuperConstructorInvocation node) {
        ...
        if (node.getAST().apiLevel() >= JLS3_INTERNAL) {
            visitList(node, SuperConstructorInvocation.TYPE_ARGUMENTS_PROPERTY, String.valueOf(','),
    ...
    public boolean visit(SuperMethodInvocation node) {
        ...
        this.result.append("super."); //$NON-NLS-1$
        if (node.getAST().apiLevel() >= JLS3_INTERNAL) {
            visitList(node, SuperMethodInvocation.TYPE_ARGUMENTS_PROPERTY, String.valueOf(','), String.valueOf('<'),
                String.valueOf('>'));
        }
    ...
    public boolean visit(TypeDeclaration node) {
        ...
        if (apiLevel == JLS2_INTERNAL) {
            ...
            visitList(node, TypeDeclaration.MODIFIERS2_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
        ...
        if (apiLevel >= JLS3_INTERNAL) {
            visitList(node, TypeDeclaration.TYPE_PARAMETERS_PROPERTY, String.valueOf(','), String.valueOf('<'),
                String.valueOf('>'));
        }
        ...
        ChildPropertyDescriptor superClassProperty = (apiLevel == JLS2_INTERNAL)
            ? INTERNAL_TYPE_SUPERCLASS_PROPERTY
    ...
    public boolean visit(VariableDeclarationExpression node) {
        if (node.getAST().apiLevel() == JLS2_INTERNAL) {
            ...
            visitList(node, VariableDeclarationExpression.MODIFIERS2_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
    ...
    public boolean visit(VariableDeclarationFragment node) {
        ...
        visitExtraDimensions(node, INTERNAL_FRAGMENT_EXTRA_DIMENSIONS_PROPERTY,
    ...
    public boolean visit(VariableDeclarationStatement node) {
        if (node.getAST().apiLevel() == JLS2_INTERNAL) {
            ...
            visitList(node, VariableDeclarationStatement.MODIFIERS2_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
    ...
    public boolean visit(AnnotationTypeDeclaration node) {
        ...
        visitList(node, AnnotationTypeDeclaration.MODIFIERS2_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
            String.valueOf(' '));
    ...
    public boolean visit(AnnotationTypeMemberDeclaration node) {
        ...
        visitList(node, AnnotationTypeMemberDeclaration.MODIFIERS2_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
            String.valueOf(' '));
    ...
    public boolean visit(EnumConstantDeclaration node) {
        ...
        visitList(node, EnumConstantDeclaration.MODIFIERS2_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
            String.valueOf(' '));
        getChildNode(node, EnumConstantDeclaration.NAME_PROPERTY).accept(this);
        visitList(node, EnumConstantDeclaration.ARGUMENTS_PROPERTY, String.valueOf(','), String.valueOf('('),
            String.valueOf(')'));
    ...
    public boolean visit(EnumDeclaration node) {
        ...
        visitList(node, EnumDeclaration.MODIFIERS2_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
            String.valueOf(' '));
        this.result.append("enum ");//$NON-NLS-1$
        getChildNode(node, EnumDeclaration.NAME_PROPERTY).accept(this);
        this.result.append(' ');
        visitList(node, EnumDeclaration.SUPER_INTERFACE_TYPES_PROPERTY, String.valueOf(','), "implements ", //$NON-NLS-1$
            Util.EMPTY_STRING);

        this.result.append('{');
        visitList(node, EnumDeclaration.ENUM_CONSTANTS_PROPERTY, String.valueOf(','), Util.EMPTY_STRING,
            Util.EMPTY_STRING);
        visitList(node, EnumDeclaration.BODY_DECLARATIONS_PROPERTY, Util.EMPTY_STRING, String.valueOf(';'),
            Util.EMPTY_STRING);
        this.result.append('}');
        return false;
    }
    ...
    public boolean visit(ExpressionMethodReference node) {
        ...
        this.result.append("::"); //$NON-NLS-1$
        visitList(node, ExpressionMethodReference.TYPE_ARGUMENTS_PROPERTY, Util.EMPTY_STRING, String.valueOf('<'),
            String.valueOf('>'));
        node.getName().accept(this);
        return false;
    }
    ...
    public boolean visit(NameQualifiedType node) {
        ...
        this.result.append('.');
        if (node.getAST().apiLevel() >= JLS8_INTERNAL) {
            visitList(node, NameQualifiedType.ANNOTATIONS_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
    ...
    public boolean visit(QualifiedType node) {
        ...
        this.result.append('.');
        if (node.getAST().apiLevel() >= JLS8_INTERNAL) {
            visitList(node, QualifiedType.ANNOTATIONS_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
    ...
    public boolean visit(SuperMethodReference node) {
        ...
        this.result.append("super ::"); //$NON-NLS-1$
        visitList(node, SuperMethodReference.TYPE_ARGUMENTS_PROPERTY, Util.EMPTY_STRING, String.valueOf('<'),
            String.valueOf('>'));
        node.getName().accept(this);
        return false;
    }
    ...
    public boolean visit(TypeMethodReference node) {
        ...
        this.result.append("::"); //$NON-NLS-1$
        visitList(node, TypeMethodReference.TYPE_ARGUMENTS_PROPERTY, Util.EMPTY_STRING, String.valueOf('<'),
            String.valueOf('>'));
        node.getName().accept(this);
        return false;
    }
    ...
    public boolean visit(TypeParameter node) {
        if (node.getAST().apiLevel() >= JLS8_INTERNAL) {
            visitList(node, TypeParameter.MODIFIERS_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
    ...
    public boolean visit(WildcardType node) {
        if (node.getAST().apiLevel() >= JLS8_INTERNAL) {
            visitList(node, WildcardType.ANNOTATIONS_PROPERTY, String.valueOf(' '), Util.EMPTY_STRING,
                String.valueOf(' '));
        }
        this.result.append('?');
