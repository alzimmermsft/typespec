		...
		public void acceptResult(CompilationResult result) {
			...
			if (result.hasErrors()) {
				...
				for (ClassFile classFile : classFiles) {
					...
					System.out.println(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.tools.classfmt.disassembler.ClassFileDisassembler.disassemble(str));
 */
