 ...
 ******************************************************************************/
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.adapter;

import java.util.*;
import java.util.concurrent.Callable;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.registry.Handle;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.runtime.IAdapterFactoryExt;
...
class AdapterFactoryProxy implements IAdapterFactory, IAdapterFactoryExt {
	...
	public synchronized IAdapterFactory loadFactory(boolean force) {
		if (factory == null) {
			...
			try {
				isActive = com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.internal.registry.osgi.EquinoxUtils.isActive(contributorName);
