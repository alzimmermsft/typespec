...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.FieldDeclaration;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.Modifier;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.ParameterizedType;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.TryStatement;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.VariableDeclarationExpression;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.dom.VariableDeclarationStatement;
        ...
        try {
            ...
            switch (node.getNodeType()) {
                ...
                case ASTNode.TRY_STATEMENT:
                    ((TryStatement) node).setFinally(this.ast.newBlock()); // have to set at least a finally block to be
                                                                           // legal code
                    break;
