 ...
 * {@link ASTParser#createASTs(String[], String[], String[], FileASTRequestor, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor) ASTParser.createASTs}.
 * <p>
 * {@link FileASTRequestor#acceptAST(String, CompilationUnit) FileASTRequestor.acceptAST} is called for each of the
 * compilation units passed to {@link ASTParser#createASTs(String[], String[], String[], FileASTRequestor, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor) ASTParser.createASTs}.
 ...
 * of the binding keys passed to {@link ASTParser#createASTs(String[], String[], String[], FileASTRequestor, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor) ASTParser.createASTs}.
 * </p>
 * <p>
 ...
 * </p>
 *
 * @see ASTParser#createASTs(String[], String[], String[], FileASTRequestor, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor)
 * @since 3.6
 */
