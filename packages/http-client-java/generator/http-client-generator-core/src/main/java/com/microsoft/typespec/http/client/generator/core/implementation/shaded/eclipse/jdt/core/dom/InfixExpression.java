...
public class InfixExpression extends Expression {
	...
	/**
	 * The "operator" structural property of this node type (type: {@link Operator}).
	 * @since 3.0
	 */
	public static final SimplePropertyDescriptor OPERATOR_PROPERTY =
		new SimplePropertyDescriptor(InfixExpression.class, "operator", Operator.class, MANDATORY); //$NON-NLS-1$
	 ...
	 */
	private NodeList extendedOperands = null;
	...
	public List extendedOperands() {
		if (this.extendedOperands == null) {
			// lazily initialize
			this.extendedOperands = new NodeList(EXTENDED_OPERANDS_PROPERTY);
		}
