...
package com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.net;

import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.CharMatcher.ascii;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.CharMatcher.javaIsoControl;
import static com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Charsets.UTF_8;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Ascii;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.CharMatcher;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Joiner;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.base.Joiner.MapJoiner;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.ImmutableListMultimap;
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.ImmutableMultiset;
...
import com.microsoft.typespec.http.client.generator.core.implementation.shaded.google.common.collect.Multimap;
    ...
    private String computeToString() {
        ...
        if (!parameters.isEmpty()) {
            ...
            Multimap<String, String> quotedParameters = Multimaps.transformValues(parameters,
                (String value) -> (TOKEN_MATCHER.matchesAllOf(value) && !value.isEmpty())
                    ? value
