 ...
 * <code>com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.compiler.CompilationParticipant</code>,
 ...
 * type "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.problem"). </li>
...
public abstract class CategorizedProblem implements IProblem {
     ...
     * marker type.
     * Standard Java problem markers (i.e. marker type is
     * "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.problem") carry an
     ...
     * Standard Java problems are associated to marker type
     * "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.core.problem").
     * Note: problem markers are expected to extend
     * "com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.resources.problemmarker"
     * marker type.
     * 
     ...
     * markers. By default, no EXTRA attributes is persisted, and a categorized problem only persists the following
     * attributes:
     * <ul>
     * <li> <code>IMarker#MESSAGE</code> -&gt; {@link IProblem#getMessage()}</li>
     * <li> <code>IMarker#SEVERITY</code> -&gt;
     * <code> IMarker#SEVERITY_ERROR</code>, <code>IMarker#SEVERITY_WARNING</code>, or
     * <code>IMarker#SEVERITY_INFO</code>,
     ...
     * </ul>
     * The names must be eligible for marker creation, as defined by <code>IMarker#setAttributes(String[],
     * Object[])</code>,
     * and there must be as many names as values according to {@link #getExtraMarkerAttributeValues()}.
     * Note that extra marker attributes will be inserted after default ones (as described in
     * {@link CategorizedProblem#getMarkerType()},
     ...
     * The values must be eligible for marker creation, as defined by <code> IMarker#setAttributes(String[],
     * Object[])}</code>.
     * 
