...
final class SortedMultisets {
    ...
    static class ElementSet<E extends @Nullable Object> extends Multisets.ElementSet<E> implements SortedSet<E> {
        @Weak
    ...
    static class NavigableElementSet<E extends @Nullable Object> extends ElementSet<E> implements NavigableSet<E> {
        ...
        public NavigableSet<E> subSet(@ParametricNullness E fromElement, boolean fromInclusive,
            ...
            return new NavigableElementSet<>(multiset().subMultiset(fromElement, BoundType.forBoolean(fromInclusive),
