...
public class AnnotationMethodDeclaration extends MethodDeclaration {
    ...
    public void resolveStatements() {
        ...
        if (returnTypeBinding != null) {
            ...
            // annotation methods can only return base types, String, Class, enum type, annotation types and arrays of
            // these
            ...
            if (this.defaultValue != null) {
                ...
                this.binding.setDefaultValue(
                    com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.ElementValuePair
