	...
	public void resolveStatements() {
		...
		if (returnTypeBinding != null) {
			...
			if (this.defaultValue != null) {
				...
				this.binding.setDefaultValue(com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.jdt.internal.compiler.lookup.ElementValuePair.getValue(this.defaultValue));
