...
/**
 * A jar entry corresponding to a non-Java resource in an archive {@link IPackageFragment} or
 ...
 * Jar entry resources are either files ({@link #isFile()} returns true) or directories ({@link #isFile()} returns
 * false).
...
public interface IJarEntryResource extends IStorage {
    ...
    /**
     * Returns the parent of this jar entry resource. This is either an {@link IJarEntryResource}, an
