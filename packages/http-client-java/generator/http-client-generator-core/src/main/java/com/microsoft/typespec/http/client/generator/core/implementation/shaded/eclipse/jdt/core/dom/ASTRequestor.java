 ...
 * {@link ASTParser#createASTs(ICompilationUnit[], String[], ASTRequestor, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor) ASTParser.createASTs}.
 * <p>
 * {@link #acceptAST(ICompilationUnit, CompilationUnit) ASTRequestor.acceptAST} is called for each of the
 * compilation units passed to {@link ASTParser#createASTs(ICompilationUnit[], String[], ASTRequestor, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor) ASTParser.createASTs}.
 ...
 * of the binding keys passed to {@link ASTParser#createASTs(ICompilationUnit[], String[], ASTRequestor, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor) ASTParser.createASTs}.
 * </p>
 * <p>
 ...
 * </p>
 *
 * @see ASTParser#createASTs(ICompilationUnit[], String[], ASTRequestor, com.microsoft.typespec.http.client.generator.core.implementation.shaded.eclipse.core.runtime.IProgressMonitor)
 * @since 3.1
 */
