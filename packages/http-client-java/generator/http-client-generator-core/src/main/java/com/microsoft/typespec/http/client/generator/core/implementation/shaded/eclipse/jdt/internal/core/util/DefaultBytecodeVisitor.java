...
public class DefaultBytecodeVisitor implements IBytecodeVisitor {
    ...
    public DefaultBytecodeVisitor(ICodeAttribute codeAttribute, char[][] parameterNames, char[] methodDescriptor,
        boolean isStatic, StringBuilder buffer, String lineSeparator, int tabNumber, int mode) {
        ILocalVariableAttribute localVariableAttribute = codeAttribute.getLocalVariableAttribute();
        this.localVariableAttributeLength
        ...
        if (parameterNames != null) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                this.argumentSizes[i]
                    = parameterType.length == 1 && (parameterType[0] == 'D' || parameterType[0] == 'J') ? 2 : 1;
            }
        }
    }
    ...
    public void _aload_0(int pc) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ALOAD_0], getLocalVariableName(pc, 0) }));
        writeNewLine();
    }
    ...
    public void _aload_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ALOAD_1], getLocalVariableName(pc, 1) }));
        writeNewLine();
    }
    ...
    public void _aload_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ALOAD_2], getLocalVariableName(pc, 2) }));
        writeNewLine();
    }
    ...
    public void _aload_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ALOAD_3], getLocalVariableName(pc, 3) }));
        writeNewLine();
    }
    ...
    public void _anewarray(int pc, int index, IConstantPoolEntry constantClass) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_anewarray,
            new String[] {
    ...
    public void _astore_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
            new String[] {
    ...
    public void _checkcast(int pc, int index, IConstantPoolEntry constantClass) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_checkcast,
            new String[] {
    ...
    public void _dload_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DLOAD_0], getLocalVariableName(pc, 0) }));
        writeNewLine();
    }
    ...
    public void _dload_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DLOAD_1], getLocalVariableName(pc, 1) }));
        writeNewLine();
    }
    ...
    public void _dload_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DLOAD_2], getLocalVariableName(pc, 2) }));
        writeNewLine();
    }
    ...
    public void _dload_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DLOAD_3], getLocalVariableName(pc, 3) }));
        writeNewLine();
    }
    ...
    public void _fload_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FLOAD_0], getLocalVariableName(pc, 0) }));
        writeNewLine();
    }
    ...
    public void _fload_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FLOAD_1], getLocalVariableName(pc, 1) }));
        writeNewLine();
    }
    ...
    public void _fload_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FLOAD_2], getLocalVariableName(pc, 2) }));
        writeNewLine();
    }
    ...
    public void _fload_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FLOAD_3], getLocalVariableName(pc, 3) }));
        writeNewLine();
    }
    ...
    public void _getfield(int pc, int index, IConstantPoolEntry constantFieldref) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_getfield,
            new String[] {
    ...
    public void _getstatic(int pc, int index, IConstantPoolEntry constantFieldref) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_getstatic,
            new String[] {
    ...
    public void _iinc(int pc, int index, int _const) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_iinc,
            new String[] {
    ...
    public void _iload_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ILOAD_0], getLocalVariableName(pc, 0) }));
        writeNewLine();
    }
    ...
    public void _iload_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ILOAD_1], getLocalVariableName(pc, 1) }));
        writeNewLine();
    }
    ...
    public void _iload_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ILOAD_2], getLocalVariableName(pc, 2) }));
        writeNewLine();
    }
    ...
    public void _iload_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ILOAD_3], getLocalVariableName(pc, 3) }));
        writeNewLine();
    }
    ...
    public void _instanceof(int pc, int index, IConstantPoolEntry constantClass) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_instanceof,
            new String[] {
    ...
    public void _invokedynamic(int pc, int index, IConstantPoolEntry nameEntry, IConstantPoolEntry descriptorEntry) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_invokedynamic,
            new String[] {
                ...
                Integer.toString(index),
                Util.toString(null, nameEntry.getUtf8Value(), descriptorEntry.getUtf8Value(), true, isCompact()) }));
        writeNewLine();
    }
    ...
    public void _invokedynamic(int pc, int index, IConstantPoolEntry invokeDynamicEntry) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_invokedynamic,
            new String[] {
                ...
                Util.toString(null, entry.getMethodName(), entry.getMethodDescriptor(), true, isCompact()) }));
        writeNewLine();
    }
    ...
    public void _invokeinterface(int pc, int index, byte nargs, IConstantPoolEntry constantInterfaceMethodref) {
        ...
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_invokeinterface,
            new String[] {
                OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.INVOKEINTERFACE],
                Integer.toString(index),
                Integer.toString(nargs),
                Util.toString(constantInterfaceMethodref.getClassName(), constantInterfaceMethodref.getMethodName(),
                    constantInterfaceMethodref.getMethodDescriptor(), true, isCompact()) }));
        writeNewLine();
    }
    ...
    public void _invokespecial(int pc, int index, IConstantPoolEntry constantMethodref) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_invokespecial,
            new String[] {
    ...
    public void _invokestatic(int pc, int index, IConstantPoolEntry constantMethodref) {
        dumpPcNumber(pc);
        final String signature = returnMethodSignature(constantMethodref);
        this.buffer.append(Messages.bind(Messages.classformat_invokestatic,
            new String[] {
    ...
    public void _invokevirtual(int pc, int index, IConstantPoolEntry constantMethodref) {
        dumpPcNumber(pc);
        final String signature = returnMethodSignature(constantMethodref);
        this.buffer.append(Messages.bind(Messages.classformat_invokevirtual,
            new String[] {
    ...
    public void _ldc_w(int pc, int index, IConstantPoolEntry constantPoolEntry) {
        ...
        switch (constantPoolEntry.getKind()) {
            case IConstantPoolConstant.CONSTANT_Float:
                this.buffer.append(Messages.bind(Messages.classformat_ldc_w_float,
                    new String[] {
            ...
            case IConstantPoolConstant.CONSTANT_Integer:
                this.buffer.append(Messages.bind(Messages.classformat_ldc_w_integer,
                    new String[] {
                        OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LDC_W],
                        Integer.toString(index),
            ...
            case IConstantPoolConstant.CONSTANT_String:
                this.buffer.append(Messages.bind(Messages.classformat_ldc_w_string,
                    new String[] {
                        OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LDC_W],
                        Integer.toString(index),
            ...
            case IConstantPoolConstant.CONSTANT_Class:
                this.buffer.append(Messages.bind(Messages.classformat_ldc_w_class,
                    new String[] {
                        OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LDC_W],
                        Integer.toString(index),
            ...
            case IConstantPoolConstant.CONSTANT_MethodType:
                appendConstantMethodType(this.buffer, Messages.classformat_ldc_w_methodhandle, IOpcodeMnemonics.LDC_W,
                    index, constantPoolEntry);
                break;

            case IConstantPoolConstant.CONSTANT_MethodHandle:
                appendConstantMethodHandle(this.buffer, Messages.classformat_ldc_w_methodhandle, IOpcodeMnemonics.LDC_W,
                    index, constantPoolEntry);
                break;
        }
        writeNewLine();
    ...
    public void _ldc(int pc, int index, IConstantPoolEntry constantPoolEntry) {
        ...
        switch (constantPoolEntry.getKind()) {
            ...
            case IConstantPoolConstant.CONSTANT_MethodType:
                appendConstantMethodType(this.buffer, Messages.classformat_ldc_w_methodhandle, IOpcodeMnemonics.LDC,
                    index, constantPoolEntry);
                break;

            case IConstantPoolConstant.CONSTANT_MethodHandle:
                appendConstantMethodHandle(this.buffer, Messages.classformat_ldc_w_methodhandle, IOpcodeMnemonics.LDC,
                    index, constantPoolEntry);
                break;

            case IConstantPoolConstant.CONSTANT_Dynamic:
                appendConstantDynamic(this.buffer, Messages.classformat_ldc_w_dynamic, IOpcodeMnemonics.LDC, index,
                    constantPoolEntry);
                break;
        }
        writeNewLine();
    ...
    private StringBuilder appendConstantMethodType(StringBuilder s, String messageKind, int opcode, int index,
        IConstantPoolEntry constantPoolEntry) {
        return s.append(Messages.bind(messageKind,
            new String[] {
    ...
    private StringBuilder appendConstantMethodHandle(StringBuilder s, String messageKind, int opcode, int index,
        IConstantPoolEntry constantPoolEntry) {
        return s.append(Messages.bind(messageKind,
            new String[] {
                OpcodeStringValues.BYTECODE_NAMES[opcode],
    ...
    private StringBuilder appendConstantDynamic(StringBuilder s, String messageKind, int opcode, int index,
    ...
    public void _ldc2_w(int pc, int index, IConstantPoolEntry constantPoolEntry) {
        ...
        switch (constantPoolEntry.getKind()) {
            case IConstantPoolConstant.CONSTANT_Long:
                this.buffer.append(Messages.bind(Messages.classformat_ldc2_w_long,
                    new String[] {
            ...
            case IConstantPoolConstant.CONSTANT_Double:
                this.buffer.append(Messages.bind(Messages.classformat_ldc2_w_double,
                    new String[] {
                        OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LDC2_W],
                        Integer.toString(index),
            ...
            case IConstantPoolConstant.CONSTANT_MethodType:
                appendConstantMethodType(this.buffer, Messages.classformat_ldc_w_methodhandle, IOpcodeMnemonics.LDC2_W,
                    index, constantPoolEntry);
                break;
            ...
            case IConstantPoolConstant.CONSTANT_Dynamic:
                appendConstantDynamic(this.buffer, Messages.classformat_ldc_w_dynamic, IOpcodeMnemonics.LDC2_W, index,
                    constantPoolEntry);
                break;
        }
        writeNewLine();
    ...
    public void _lload_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LLOAD_0], getLocalVariableName(pc, 0) }));
        writeNewLine();
    }
    ...
    public void _lload_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LLOAD_1], getLocalVariableName(pc, 1) }));
        writeNewLine();
    }
    ...
    public void _lload_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LLOAD_2], getLocalVariableName(pc, 2) }));
        writeNewLine();
    }
    ...
    public void _lload_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
            new String[] { OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LLOAD_3], getLocalVariableName(pc, 3) }));
        writeNewLine();
    }
    ...
    public void _multianewarray(int pc, int index, int dimensions, IConstantPoolEntry constantClass) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_multianewarray,
            new String[] {
    ...
    public void _new(int pc, int index, IConstantPoolEntry constantClass) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_new,
            new String[] {
    ...
    public void _newarray(int pc, int atype) {
        ...
        switch (atype) {
            case T_BOOLEAN:
                this.buffer.append(Messages.bind(Messages.classformat_newarray_boolean,
                    new String[] {
            ...
            case T_CHAR:
                this.buffer.append(Messages.bind(Messages.classformat_newarray_char,
                    new String[] {
                        OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.NEWARRAY],
                        Integer.toString(atype) }));
                break;
            ...
            case T_FLOAT:
                this.buffer.append(Messages.bind(Messages.classformat_newarray_float,
                    new String[] {
                        OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.NEWARRAY],
                        Integer.toString(atype) }));
                break;
            ...
            case T_DOUBLE:
                this.buffer.append(Messages.bind(Messages.classformat_newarray_double,
                    new String[] {
                        OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.NEWARRAY],
                        Integer.toString(atype) }));
                break;
            ...
            case T_BYTE:
                this.buffer.append(Messages.bind(Messages.classformat_newarray_byte,
                    new String[] {
                        OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.NEWARRAY],
                        Integer.toString(atype) }));
                break;
            ...
            case T_SHORT:
                this.buffer.append(Messages.bind(Messages.classformat_newarray_short,
                    new String[] {
                        OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.NEWARRAY],
                        Integer.toString(atype) }));
                break;
            ...
            case T_INT:
                this.buffer.append(Messages.bind(Messages.classformat_newarray_int,
                    new String[] {
                        OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.NEWARRAY],
                        Integer.toString(atype) }));
                break;
            ...
            case T_LONG:
                this.buffer.append(Messages.bind(Messages.classformat_newarray_long,
                    new String[] {
                        OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.NEWARRAY],
                        Integer.toString(atype) }));
        }
    ...
    public void _putstatic(int pc, int index, IConstantPoolEntry constantFieldref) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_putstatic,
            new String[] {
    ...
    private String returnMethodSignature(IConstantPoolEntry constantMethodref) {
        ...
        final char[] signature
            = Util
                .toString(constantMethodref.getClassName(), constantMethodref.getMethodName(), methodDescriptor, true,
                    isCompact())
                .toCharArray();
