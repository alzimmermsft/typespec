...
public class FluentMethodParameterMethod extends FluentMethod {
    ...
    public FluentMethodParameterMethod(FluentResourceModel model, FluentMethodType type, FluentInterfaceStage stage,
        ...
        this.description = String.format("Specifies the %1$s property: %2$s.", methodParameter.getName(),
            methodParameter.getDescription());
    ...
    public FluentMethodParameterMethod(FluentResourceModel model, FluentMethodType type, FluentInterfaceStage stage,
        ClientMethodParameter methodParameter, LocalVariable localVariable, String methodName) {
        super(model, type);
    ...
    protected String getBaseMethodSignature() {
        return String.format("%1$s(%2$s %3$s)", this.name, methodParameter.getClientType().toString(),
